...
```ts
import { provide, inject } from 'rues'
import type { InjectionKey } from 'rues'
...
```vue{6,7} [App.vue]
<script setup lang="ts">
import { useTemplateRef } from 'rues'
...
```ts
import { useTemplateRef } from 'rues'
import type { ComponentPublicInstance } from 'rues'
...
import type { Directive } from 'rues'
