...
我们可以使用 [Import Maps](https://caniuse.com/import-maps) 告诉浏览器在哪里找到 `rues` 导入：

```html{1-7,12}
<script type="importmap">
  {
    "imports": {
      "rues": "https://unpkg.com/rue@latest/dist/rue.esm-browser.js"
    }
  }
</script>
