...
```tsx
import { useState, type FC } from 'rues'
...
```tsx
import { useEffect, useRef, type FC } from 'rues'
...
```tsx
import { useImperativeHandle, forwardRef, type FC } from 'rues'
...
export const MyComponent: FC<{}, {}, MyComponentRef> = forwardRef(
  (props, ref) => {
    const a = 1
...
```tsx
import { type FC, type ReactNode } from 'rues'
