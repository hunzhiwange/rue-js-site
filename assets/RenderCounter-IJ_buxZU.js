import{F as e,K as t,L as n,N as r,_t as i,d as a,ht as o,l as s,mt as c,ut as l,v as u}from"./vapor-runtime-Dfq7aA8z.js";import{a as d}from"./vapor-helpers-vapor-CpxsbTjB.js";import{t as f}from"./createHomeSplitExamplePage-DJ9ZPmKq.js";var p=`rounded-lg border px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all`,m=o=>a(a=>{let c=n(`div`,a);t(c,`text-3xl font-bold mb-3`);let u=e(`rue:slot:anchor`);return r(c,u),i(()=>{let e=o.count.value;l(()=>s(e,c,u))}),c}),h=f({title:`渲染函数计数器`,source:`import { type FC, h, useSetup, useState, watchEffect } from '@rue-js/rue'
