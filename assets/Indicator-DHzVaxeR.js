...
</Indicator>`});p(()=>l(e,u,pe))});let Z=r(`h2`,u);i(u,Z),n(Z,`mt-10`),i(Z,a(`API`));let Q=r(`p`,u);i(u,Q),n(Q,`text-sm text-base-content/70`),i(Q,a(`Indicator 仍然是一个纯布局组件，不接管 Badge、Status 或 Button 的视觉，只负责悬挂与定位。`));let me=r(`h3`,u);i(u,me),i(me,a(`Indicator`));let he=e(`rue:component:anchor`);i(u,he),s(()=>{let e=f(I,{rows:te});p(()=>l(e,u,he))});let $=r(`h3`,u);i(u,$),n($,`mt-8`),i($,a(`Indicator.Item`));let ge=e(`rue:component:anchor`);return i(u,ge),s(()=>{let e=f(I,{rows:ne});p(()=>l(e,u,ge))}),c})}),d,m),d})};export{L as default};