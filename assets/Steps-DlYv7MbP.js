...
</Steps>`});h(()=>d(e,f,le))});let ue=e(`rue:component:anchor`);i(f,ue),c(()=>{let e=m(S,{title:`Vertical`,tab:u.vertical,preview:b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(N,{direction:`vertical`,children:[b(N.Step,{color:`primary`,children:`Register`}),b(N.Step,{color:`primary`,children:`Choose plan`}),b(N.Step,{children:`Purchase`}),b(N.Step,{children:`Receive Product`})]})})}),code:`<Steps direction="vertical">
  <Steps.Step color="primary">Register</Steps.Step>
  <Steps.Step color="primary">Choose plan</Steps.Step>
  <Steps.Step>Purchase</Steps.Step>
  <Steps.Step>Receive Product</Steps.Step>
</Steps>`});h(()=>d(e,f,ue))});let Q=e(`rue:component:anchor`);i(f,Q),c(()=>{let e=m(S,{title:`Responsive`,tab:u.responsive,preview:b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(N,{direction:`vertical`,className:`lg:steps-horizontal`,children:[b(N.Step,{color:`primary`,children:`Register`}),b(N.Step,{color:`primary`,children:`Choose plan`}),b(N.Step,{children:`Purchase`}),b(N.Step,{children:`Receive Product`})]})})}),code:`<Steps direction="vertical" className="lg:steps-horizontal">
  <Steps.Step color="primary">Register</Steps.Step>
  <Steps.Step color="primary">Choose plan</Steps.Step>
  <Steps.Step>Purchase</Steps.Step>
  <Steps.Step>Receive Product</Steps.Step>
</Steps>`});h(()=>d(e,f,Q))});let de=r(`h2`,f);i(f,de),i(de,o(`视觉定制`));let fe=r(`p`,f);i(f,fe),i(fe,o(`这一组仍然保留当前 Rue 的静态能力，包括自定义 icon、data-content、语义色和滚动容器。`));let pe=e(`rue:component:anchor`);i(f,pe),c(()=>{let e=m(S,{title:`With custom content in step-icon`,tab:u.icons,preview:b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(N,{"data-testid":`steps-icons`,children:[y(N.Step,{color:`neutral`,children:[b(N.Icon,{children:`1`}),`Step 1`]}),y(N.Step,{color:`neutral`,children:[b(N.Icon,{children:`2`}),`Step 2`]}),y(N.Step,{children:[b(N.Icon,{children:`3`}),`Step 3`]})]})})}),code:`<Steps>
...
</Steps>`});h(()=>d(e,f,me))});let he=e(`rue:component:anchor`);i(f,he),c(()=>{let e=m(S,{title:`Custom colors`,tab:u.colors,preview:b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(N,{children:[b(N.Step,{color:`info`,children:`Fly to moon`}),b(N.Step,{color:`info`,children:`Shrink the moon`}),b(N.Step,{color:`info`,children:`Grab the moon`}),b(N.Step,{color:`error`,"data-content":`?`,children:`Sit on toilet`})]})})}),code:`<Steps>
...
</Steps>`});h(()=>d(e,f,he))});let ge=e(`rue:component:anchor`);i(f,ge),c(()=>{let e=m(S,{title:`With scrollable wrapper`,tab:u.scrollable,preview:b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(re,{})})}),code:`<div className="grid gap-5">
...
/>`});h(()=>d(e,f,be))});let xe=e(`rue:component:anchor`);i(f,xe),c(()=>{let e=m(S,{title:`Clickable items`,tab:u.clickable,preview:b(ie,{}),code:`const ClickableStepsDemo: FC = () => {
  const current = ref(0)
...
/>`});h(()=>d(e,f,Se))});let Ce=r(`h2`,f);i(f,Ce),i(Ce,o(`API`));let $=r(`p`,f);i(f,$);let we=r(`code`,$);i($,we),i(we,o(`Steps`)),i($,o(`负责布局、状态推导与点击切换；`));let Te=r(`code`,$);i($,Te),i(Te,o(`Steps.Step`)),i($,o(`和`));let Ee=g($);i($,Ee),a(Ee,` `);let De=r(`code`,$);i($,De),i(De,o(`StepItem`)),i($,o(`共享同一组单步属性。`));let Oe=r(`h3`,f);i(f,Oe),i(Oe,o(`Steps`));let ke=e(`rue:component:anchor`);i(f,ke),c(()=>{let e=m(P,{rows:ae});h(()=>d(e,f,ke))});let Ae=r(`h3`,f);i(f,Ae),i(Ae,o(`Steps.Step / StepItem`));let je=e(`rue:component:anchor`);return i(f,je),c(()=>{let e=m(P,{rows:oe});h(()=>d(e,f,je))}),l})}),p,_),p})};export{I as default};