...
}`,We=()=>{let{tabBasic:e,tabNotice:a,tabCard:s,tabHeader:m,tabCallyCalendar:g,tabCallyDatePicker:_,tabPikaday:b}=x(`useSetup:0:0:dup7`,()=>p(()=>({tabBasic:x(`ref:1:27`,()=>h(`preview`)),tabNotice:x(`ref:1:28`,()=>h(`preview`)),tabCard:x(`ref:1:29`,()=>h(`preview`)),tabHeader:x(`ref:1:30`,()=>h(`preview`)),tabCallyCalendar:x(`ref:1:31`,()=>h(`preview`)),tabCallyDatePicker:x(`ref:1:32`,()=>h(`preview`)),tabPikaday:x(`ref:1:33`,()=>h(`preview`))})));return d(p=>{let h=n(),x=t(`rue:component:anchor`);return o(h,x),f(v(E,{children:d(()=>{let d=n(),p=i(`div`,d);o(d,p),r(p,`prose prose-sm max-w-none md:prose-base`);let h=i(`h1`,p);o(p,h),o(h,c(`Calendar 日历`));let x=i(`p`,p);o(p,x),r(x,`mt-3 mb-3 text-sm`),o(x,c(`Calendar 现在同时覆盖 Rue 原生月历面板、事项渲染、卡片式日历，以及 Cally、Pikaday 两条旧接入链路。`));let S=i(`div`,p);o(p,S),r(S,`not-prose grid gap-3 rounded-[1.75rem] border border-base-300 bg-gradient-to-br from-base-100 via-base-100 to-base-200/75 p-4 shadow-sm md:grid-cols-3`);let C=t(`rue:component:anchor`);o(S,C),f(v(Oe,{badge:`Native Panel`,title:`Month / Year 两种面板`,detail:`新增默认 Calendar 面板，支持 value、mode、validRange、showWeek 与 headerRender。`}),S,C);let w=t(`rue:component:anchor`);o(S,w),f(v(Oe,{badge:`Render Hooks`,title:`细胞级渲染能力`,detail:`cellRender 和 fullCellRender 可以把普通日期格升级为事项列表、容量卡或数据看板。`}),S,w);let E=t(`rue:component:anchor`);o(S,E),f(v(Oe,{badge:`Legacy Friendly`,title:`旧 demo 全部保留`,detail:`Calendar.Cally、Calendar.Month、Calendar.PikaSingle 仍然可用，老接入方式不需要拆。`}),S,E);let D=i(`div`,p);o(p,D),r(D,`mt-4 text-sm`);let O=i(`a`,D);o(D,O),l(O,`href`,`https://daisyui.com/components/calendar/`),l(O,`target`,`_blank`),o(O,c(`查看 Calendar 静态样式`));let k=t(`rue:component:anchor`);o(p,k),u(()=>{let t=v($,{title:`Basic calendar`,summary:`默认面板，覆盖受控日期、范围限制、禁用规则与周序号。`,tab:e,preview:()=>T(ke,{}),code:Re});y(()=>f(t,p,k))});let ee=t(`rue:component:anchor`);o(p,ee),u(()=>{let e=v($,{title:`Notice calendar`,summary:`使用 cellRender 在日期格展示事项，在年视图展示月份 backlog。`,tab:a,preview:()=>T(Ae,{}),code:ze});y(()=>f(e,p,ee))});let A=t(`rue:component:anchor`);o(p,A),u(()=>{let e=v($,{title:`Card mode`,summary:`缩成仪表盘卡片，再用 fullCellRender 为少量日期挂上负载进度。`,tab:s,preview:()=>T(je,{}),code:Be});y(()=>f(e,p,A))});let j=t(`rue:component:anchor`);o(p,j),u(()=>{let e=v($,{title:`Custom header`,summary:`接管顶部工具条，自定义模式切换、年份与月份选择器。`,tab:m,preview:()=>T(Me,{}),code:Ve});y(()=>f(e,p,j))});let M=t(`rue:component:anchor`);o(p,M),u(()=>{let e=v($,{title:`Cally calendar example`,summary:`旧的 Cally web component 日历壳层仍然原样可用。`,tab:g,preview:()=>T(Ne,{}),code:He});y(()=>f(e,p,M))});let N=t(`rue:component:anchor`);o(p,N),u(()=>{let e=v($,{title:`Cally date picker example`,summary:`旧的日期输入弹层 demo 继续保留，只把交互说明和布局重新编排。`,tab:_,preview:()=>T(Pe,{}),code:Ue});y(()=>f(e,p,N))});let P=t(`rue:component:anchor`);o(p,P),u(()=>{let e=v($,{title:`Pikaday input example`,summary:`保留原有 pika-single 输入壳层，让第三方实例继续挂载在 Rue 组件树里。`,tab:b,preview:()=>T(Fe,{testId:`pikaday-cdn-input`,note:`输入框已挂上真实 Pikaday 实例，点击即可弹出日期面板。`}),lang:`html`,code:`<script src="https://cdn.jsdelivr.net/npm/pikaday/pikaday.js"><\/script>
<input type="text" class="input pika-single" id="myDatepicker">
<script>
  var picker = new Pikaday({ field: document.getElementById('myDatepicker') });
<\/script>`});y(()=>f(e,p,P))});let F=i(`section`,p);o(p,F),r(F,`my-12 space-y-6`);let I=i(`div`,F);o(F,I);let L=i(`h2`,I);o(I,L),r(L,`mb-2`),o(L,c(`API`));let R=i(`p`,I);o(I,R),r(R,`m-0 text-sm text-base-content/70`),o(R,c(`默认 Calendar 面板聚焦于日历组件常见的核心交互能力，同时保留 Rue 自己的视觉和旧导出方式。`));let z=t(`rue:component:anchor`);o(F,z),u(()=>{let e=v(Te,{rows:me});y(()=>f(e,F,z))});let B=i(`div`,F);o(F,B);let V=i(`h2`,B);o(B,V),r(V,`mb-2`),o(V,c(`附属导出`));let H=i(`p`,B);o(B,H),r(H,`m-0 text-sm text-base-content/70`),o(H,c(`历史上的 Cally 与 Pikaday 接口没有删除，而是并列保留为复合导出，便于渐进迁移。`));let U=t(`rue:component:anchor`);return o(F,U),u(()=>{let e=v(Ee,{rows:he});y(()=>f(e,F,U))}),d})}),h,x),h})};export{We as default};