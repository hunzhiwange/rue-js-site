...
/>`});p(()=>l(e,u,L))});let R=e(`rue:component:anchor`);i(u,R),s(()=>{let e=f(H,{title:`Accordion`,summary:`使用 accordion 改成一次只展开一项，并结合受控 key 管理当前面板。`,tab:y,preview:()=>g(`div`,{className:`space-y-4`,children:[g(`div`,{className:`flex flex-wrap gap-2`,children:[_(`button`,{className:`btn btn-sm`,onClick:()=>N.value=`guide`,children:`打开 Guide`}),_(`button`,{className:`btn btn-sm`,onClick:()=>N.value=`api`,children:`打开 API`}),_(`button`,{className:`btn btn-sm btn-ghost`,onClick:()=>N.value=null,children:`全部收起`})]}),_(V,{accordion:!0,plus:!0,activeKey:N.value,onChange:e=>N.value=e??null,items:[{key:`guide`,label:`Migration Guide`,children:`梳理 breaking changes、默认行为差异与升级建议。`},{key:`api`,label:`API Delta`,children:`列出新增属性、弃用写法与向后兼容策略。`},{key:`qa`,label:`QA Notes`,children:`补充测试范围、回归清单和已知限制。`}]})]}),code:`const activeKey = ref<string | null>('guide')
...
/>`});p(()=>l(e,u,R))});let z=e(`rue:component:anchor`);i(u,z),s(()=>{let e=f(H,{title:`描述与额外操作`,summary:`每一项可带 description、extra 和独立禁用状态，extra 区域点击不会触发展开。`,tab:b,preview:()=>_(V,{arrow:!0,defaultActiveKey:[`ops`],items:[{key:`ops`,label:`Ops Console`,description:`控制发布节奏、灰度范围与告警阈值。`,extra:_(`span`,{className:`badge badge-soft badge-info`,children:`Beta`}),children:`适合放置运维策略、SLA 约束和异常回滚说明。`},{key:`billing`,label:`Billing Center`,description:`当前模块仍在迁移，暂不开放编辑。`,extra:_(`span`,{className:`badge badge-soft`,children:`Read only`}),disabled:!0,children:`禁用项会保留信息展示，但不响应交互。`}]}),code:`<Collapse
  arrow
...
/>`});p(()=>l(e,u,z))});let B=e(`rue:component:anchor`);i(u,B),s(()=>{let e=f(H,{title:`图标位置与触发区域`,summary:`支持把图标放在左侧，并限制只有图标本身可触发开合。`,tab:x,preview:()=>_(V,{arrow:!0,expandIconPlacement:`start`,items:[{key:`deployment`,label:`Deployment Window`,description:`只有左侧图标可点击，标题区更适合放长文本说明。`,collapsible:`icon`,children:`当标题里还有链接、状态或操作说明时，这个模式会更稳妥。`},{key:`security`,label:`Security Review`,description:`保持默认 header 触发，图标只是视觉反馈。`,children:`适合和 icon-only 模式混合使用。`}]}),code:`<Collapse
  arrow
...
/>`});p(()=>l(e,u,B))});let G=e(`rue:component:anchor`);i(u,G),s(()=>{let e=f(H,{title:`Ghost 与无边框`,summary:`不想用分组边框时，可以关闭 bordered，再按需开启 ghost。`,tab:S,preview:()=>_(V,{arrow:!0,bordered:!1,ghost:!0,className:`space-y-3`,defaultActiveKey:[`design`],items:[{key:`design`,label:`Design Tokens`,children:`透明背景更适合嵌在卡片、侧栏或深色容器中。`},{key:`theme`,label:`Theme Sync`,children:`可继续叠加自定义类名，让容器完全交给外层布局控制。`}]}),code:`<Collapse
  arrow
  bordered={false}
  ghost
  className="space-y-3"
...
/>`});p(()=>l(e,u,K))});let q=e(`rue:component:anchor`);i(u,q),s(()=>{let e=f(H,{title:`Collapse with focus`,summary:`聚焦时展开、失焦时关闭，同时也支持重复点击标题切换开合。`,tab:w,preview:()=>g(V,{tabIndex:0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} className="bg-base-100 border border-base-300">
...
</Collapse>`});p(()=>l(e,u,Y))});let X=e(`rue:component:anchor`);i(u,X),s(()=>{let e=f(H,{title:`Without border and background color`,tab:te,preview:()=>g(V,{tabIndex:0,children:[_(V.Title,{className:`font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0}>
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>l(e,u,X))});let Z=e(`rue:component:anchor`);i(u,Z),s(()=>{let e=f(H,{title:`With arrow icon`,tab:E,preview:()=>g(V,{tabIndex:0,arrow:!0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} arrow className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>l(e,u,Z))});let Q=e(`rue:component:anchor`);i(u,Q),s(()=>{let e=f(H,{title:`With plus/minus icon`,tab:D,preview:()=>g(V,{tabIndex:0,plus:!0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} plus className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>l(e,u,Q))});let ie=e(`rue:component:anchor`);i(u,ie),s(()=>{let e=f(H,{title:`Moving collapse icon to the start`,summary:`通过 utility 类移动图标位置，并保留标题区重复点击切换能力。`,tab:O,preview:()=>g(V,{tabIndex:0,arrow:!0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold after:start-5 after:end-auto pe-4 ps-12`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} arrow className="bg-base-100 border border-base-300">
...
</Collapse>`});p(()=>l(e,u,ie))});let ae=e(`rue:component:anchor`);i(u,ae),s(()=>{let e=f(H,{title:`Force open`,tab:k,preview:()=>g(V,{tabIndex:0,open:!0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold`,children:`I have collapse-open class`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} open className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">I have collapse-open class</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>l(e,u,ae))});let oe=e(`rue:component:anchor`);i(u,oe),s(()=>{let e=f(H,{title:`Force close`,tab:A,preview:()=>g(V,{tabIndex:0,close:!0,className:`bg-base-100 border border-base-300`,children:[_(V.Title,{className:`font-semibold`,children:`I have collapse-close class`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} close className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">I have collapse-close class</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>l(e,u,oe))});let se=e(`rue:component:anchor`);i(u,se),s(()=>{let e=f(H,{title:`Custom colors for collapse that works with focus`,summary:`通过 focus 触发颜色变化。`,tab:j,preview:()=>g(V,{tabIndex:0,className:`bg-primary text-primary-content focus:bg-secondary focus:text-secondary-content`,children:[_(V.Title,{className:`font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse
  tabIndex={0}
...
</Collapse>`});p(()=>l(e,u,se))});let ce=e(`rue:component:anchor`);i(u,ce),s(()=>{let e=f(H,{title:`Custom colors for collapse that works with checkbox`,summary:`通过 peer/peer-checked 触发颜色变化，并支持重复点击标题切换。`,tab:ne,preview:()=>g(V,{className:`bg-base-100 border border-base-300`,children:[_(`input`,{type:`checkbox`,className:`peer`}),_(V.Title,{className:`bg-primary text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content font-semibold`,children:`How do I create an account?`}),_(V.Content,{className:`bg-primary text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse className="bg-base-100 border border-base-300">
...
</Collapse>`});p(()=>l(e,u,ce))});let $=r(`h2`,u);i(u,$),i($,a(`API`));let le=r(`h3`,u);i(u,le),i(le,a(`Collapse`));let ue=e(`rue:component:anchor`);i(u,ue),s(()=>{let e=f(U,{rows:W});p(()=>l(e,u,ue))});let de=r(`h3`,u);i(u,de),i(de,a(`CollapseItem`));let fe=e(`rue:component:anchor`);return i(u,fe),s(()=>{let e=f(U,{rows:re});p(()=>l(e,u,fe))}),c})}),d,m),d})};export{G as default};