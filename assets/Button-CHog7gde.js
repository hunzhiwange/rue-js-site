...
<Button color="accent" shape="circle" icon={<span>♥</span>} aria-label="收藏" />`});m(()=>u(e,d,Te))});let Ee=e(`rue:component:anchor`);i(d,Ee),c(()=>{let e=p(w,{title:`加载状态`,summary:`loading 会锁定按钮；对象写法可以替换默认加载图标。`,tab:ue,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-row flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,loading:!0,children:`Saving`}),y(S,{type:`outlined`,loading:{icon:y(`span`,{className:`loading loading-dots loading-xs`})},children:`Syncing`}),y(S,{color:`success`,icon:y(O,{}),children:`Ready to publish`})]})}),code:`<Button color="primary" loading>Saving</Button>
...
</div>`});m(()=>u(e,d,De))});let Oe=e(`rue:component:anchor`);i(d,Oe),c(()=>{let e=p(w,{title:`尺寸与形状`,summary:`size 管尺寸，shape 管轮廓形态。`,tab:fe,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body gap-5`,children:[v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Sizes`}),v(`div`,{className:`flex flex-wrap items-center gap-2`,children:[y(S,{size:`small`,children:`Small`}),y(S,{children:`Default`}),y(S,{size:`large`,color:`primary`,children:`Large`}),y(S,{size:`xs`,type:`outlined`,children:`XS`}),y(S,{size:`xl`,color:`secondary`,children:`XL`})]})]}),v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Shapes`}),v(`div`,{className:`flex flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,shape:`round`,children:`Round action`}),y(S,{color:`secondary`,shape:`square`,icon:y(k,{}),"aria-label":`square`}),y(S,{color:`accent`,shape:`circle`,icon:y(D,{}),"aria-label":`circle`})]})]})]})}),code:`<Button size="small">Small</Button>
...
</div>`});m(()=>u(e,d,ke))});let Ae=e(`rue:component:anchor`);i(d,Ae),c(()=>{let e=p(w,{title:`状态与布局`,summary:`把原来的 active、disabled、wide、block 示例也融合到当前页面。`,tab:me,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body gap-5`,children:[v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`States`}),v(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{active:!0,children:`Active`}),y(S,{color:`primary`,active:!0,children:`Primary active`}),y(S,{disabled:!0,children:`Disabled`}),y(S,{href:`#button-api`,disabled:!0,children:`Disabled link`})]})]}),v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Layout`}),v(`div`,{className:`flex flex-col gap-2 sm:max-w-sm`,children:[y(S,{wide:!0,children:`Wide button`}),y(S,{block:!0,color:`primary`,children:`Block button`})]})]})]})}),code:`<div className="flex flex-wrap gap-2">
...
</form>`});m(()=>u(e,d,je))});let Me=e(`rue:component:anchor`);i(d,Me),c(()=>{let e=p(w,{title:`场景组合`,summary:`把图标、变体、布局属性组合在一起，可以很快搭出操作条。`,tab:ge,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body gap-4`,children:[v(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{color:`primary`,icon:y(O,{}),children:`Publish`}),y(S,{type:`outlined`,icon:y(E,{}),iconPlacement:`end`,children:`Preview`}),y(S,{type:`text`,icon:y(k,{}),children:`Save draft`})]}),v(`div`,{className:`grid gap-2 md:grid-cols-2`,children:[y(S,{block:!0,className:`justify-start bg-white text-base-content border-base-300`,icon:y(te,{}),children:`Continue with Email`}),y(S,{block:!0,color:`primary`,className:`justify-start`,icon:y(k,{}),children:`Continue with Rue ID`})]})]})}),code:`<div className="flex flex-wrap gap-2">
...
</div>`});m(()=>u(e,d,Ne))});let G=r(`h2`,d);i(d,G),s(G,`id`,`button-api`),i(G,o(`API`));let Pe=r(`p`,d);i(d,Pe),i(Pe,o(`当前页面展示的是 Button 与 Button.Group 的完整可用 API。`));let K=r(`p`,d);i(d,K),i(K,o(`推荐使用顺序：`));let Fe=r(`code`,K);i(K,Fe),i(Fe,o(`type`)),i(K,o(`->`));let Ie=r(`code`,K);i(K,Ie),i(Ie,o(`color`)),i(K,o(`->`));let Le=r(`code`,K);i(K,Le),i(Le,o(`shape`)),i(K,o(`->`));let Re=h(K);i(K,Re),a(Re,` `);let ze=r(`code`,K);i(K,ze),i(ze,o(`size`)),i(K,o(`->`));let Be=r(`code`,K);i(K,Be),i(Be,o(`loading`)),i(K,o(`->`));let Ve=r(`code`,K);i(K,Ve),i(Ve,o(`disabled`)),i(K,o(`。`));let He=r(`h3`,d);i(d,He),i(He,o(`Button`));let Ue=e(`rue:component:anchor`);i(d,Ue),c(()=>{let e=p(T,{rows:ae});m(()=>u(e,d,Ue))});let We=r(`h3`,d);i(d,We),i(We,o(`Button.Group`));let Ge=e(`rue:component:anchor`);i(d,Ge),c(()=>{let e=p(T,{rows:oe});m(()=>u(e,d,Ge))});let Ke=r(`h2`,d);i(d,Ke),i(Ke,o(`FAQ`));let qe=r(`h3`,d);i(d,qe),i(qe,o(`为什么有 type 还需要 htmlType？`));let q=r(`p`,d);i(d,q);let Je=r(`code`,q);i(q,Je),i(Je,o(`type`)),i(q,o(`负责按钮视觉类型，`));let Ye=r(`code`,q);i(q,Ye),i(Ye,o(`htmlType`)),i(q,o(`负责原生 button 行为。视觉和提交语义拆开之后， 表单场景会更直接。`));let Xe=r(`h3`,d);i(d,Xe),i(Xe,o(`type 和 color 应该怎么分工？`));let J=r(`p`,d);i(d,J);let Ze=r(`code`,J);i(J,Ze),i(Ze,o(`type`)),i(J,o(`负责视觉类型，比如`));let Qe=r(`code`,J);i(J,Qe),i(Qe,o(`outlined`)),i(J,o(`、`));let $e=r(`code`,J);i(J,$e),i($e,o(`filled`)),i(J,o(`、`));let et=r(`code`,J);i(J,et),i(et,o(`text`)),i(J,o(`。`));let tt=r(`code`,J);i(J,tt),i(tt,o(`color`)),i(J,o(`负责主题色，比如`));let nt=r(`code`,J);i(J,nt),i(nt,o(`primary`)),i(J,o(`、`));let rt=r(`code`,J);i(J,rt),i(rt,o(`secondary`)),i(J,o(`、`));let it=r(`code`,J);i(J,it),i(it,o(`danger`)),i(J,o(`。`));let Y=r(`p`,d);i(d,Y),i(Y,o(`大多数场景可以先定颜色， 再根据密度和层级选择`));let X=r(`code`,Y);i(Y,X),i(X,o(`solid`)),i(Y,o(`、`));let at=r(`code`,Y);i(Y,at),i(at,o(`outlined`)),i(Y,o(`、`));let ot=r(`code`,Y);i(Y,ot),i(ot,o(`filled`)),i(Y,o(`或`));let st=r(`code`,Y);i(Y,st),i(st,o(`text`)),i(Y,o(`。`));let ct=r(`h3`,d);i(d,ct),i(ct,o(`loading 对象里的 delay 会生效吗？`));let Z=r(`p`,d);i(d,Z),i(Z,o(`当前版本已经支持`));let lt=r(`code`,Z);i(Z,lt),i(lt,o(`loading`)),i(Z,o(`的对象写法和自定义`));let ut=r(`code`,Z);i(Z,ut),i(ut,o(`icon`)),i(Z,o(`。`));let dt=r(`code`,Z);i(Z,dt),i(dt,o(`delay`)),i(Z,o(`字段已保留在配置结构里，后续如果补充延迟显示策略，可以直接在现有接口上继续扩展。`));let ft=r(`h3`,d);i(d,ft),i(ft,o(`Button.Group 会覆盖子按钮哪些属性？`));let Q=r(`p`,d);i(d,Q),i(Q,o(`组级只会统一同步`));let pt=r(`code`,Q);i(Q,pt),i(pt,o(`size`)),i(Q,o(`和`));let mt=r(`code`,Q);i(Q,mt),i(mt,o(`shape`)),i(Q,o(`，方便在一组按钮上集中控制尺寸和轮廓。 每个子按钮自己的`));let ht=r(`code`,Q);i(Q,ht),i(ht,o(`color`)),i(Q,o(`、`));let gt=r(`code`,Q);i(Q,gt),i(gt,o(`type`)),i(Q,o(`、`));let _t=r(`code`,Q);i(Q,_t),i(_t,o(`disabled`)),i(Q,o(`、`));let vt=r(`code`,Q);i(Q,vt),i(vt,o(`onClick`)),i(Q,o(`仍然在各自的`));let $=r(`code`,Q);return i(Q,$),i($,o(`Button`)),i(Q,o(`上配置。`)),l})}),f,g),f})};export{se as default};