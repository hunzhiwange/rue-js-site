...
`});f(()=>l(e,c,w))});let T=r(`h2`,c);i(c,T),n(T,`mt-10`),i(T,a(`API`));let E=e(`rue:component:anchor`);i(c,E),s(()=>{let e=d(V,{rows:ee});f(()=>l(e,c,E))});let D=r(`p`,c);return i(c,D),n(D,`text-sm opacity-70 mt-4`),i(D,a(`除了上表 props，组件还暴露了 Result.PRESENTED_IMAGE_403、Result.PRESENTED_IMAGE_404 和 Result.PRESENTED_IMAGE_500 三个静态插画组件，便于你在更复杂的空壳页面里单独复用。`)),o})}),u,p),u});export{te as default};