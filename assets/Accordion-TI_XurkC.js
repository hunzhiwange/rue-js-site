...
]`})));return c(d=>{let f=t(),g=e(`rue:component:anchor`);return i(f,g),u(p(b,{children:c(()=>{let d=t(),f=r(`div`,d);i(d,f),n(f,`max-w-none prose prose-sm md:prose-base`);let g=r(`h1`,f);i(f,g),i(g,a(`Accordion 手风琴`));let b=r(`p`,f);i(f,b),n(b,`text-sm mt-3 mb-3`),i(b,a(`Accordion 现在保留 Rue 原本的轻量视觉风格，但 API 不再只是静态包装。你可以继续用`));let M=r(`code`,b);i(b,M),i(M,a(`Accordion.Title`)),i(b,a(`和`));let N=r(`code`,b);i(b,N),i(N,a(`Accordion.Content`)),i(b,a(`组合单个面板，也可以直接用`));let P=r(`code`,b);i(b,P),i(P,a(`items`)),i(b,a(`走数据驱动，接入受控 key、多开、禁用和富标题信息。`));let F=r(`div`,f);i(f,F),n(F,`text-sm flex flex-wrap gap-4`);let I=r(`a`,F);i(F,I),o(I,`href`,`https://daisyui.com/components/accordion/`),o(I,`target`,`_blank`),i(I,a(`查看 Accordion 静态样式`));let G=r(`h2`,f);i(f,G),i(G,a(`何时使用`));let K=r(`ul`,f);i(f,K);let q=r(`li`,K);i(K,q),i(q,a(`需要 FAQ、设置说明、任务面板这类“标题 + 可折叠内容”的信息组织方式。`));let J=r(`li`,K);i(K,J),i(J,a(`需要在单开和多开之间切换，或把当前展开项接到页面状态里。`));let Y=r(`li`,K);i(K,Y),i(Y,a(`需要在标题里补充状态、说明、标签，而不想为每个面板手写结构。`));let X=r(`li`,K);i(K,X),i(X,a(`需要让浏览器能搜索折叠内容时，使用`));let te=r(`code`,X);i(X,te),i(te,a(`use="details"`)),i(X,a(`。`));let Z=r(`div`,f);i(f,Z),n(Z,`not-prose my-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4`);let ne=e(`rue:list:start`),re=e(`rue:list:end`);i(Z,ne),i(Z,re);let ie=new Map;s(()=>{ie=_({items:V||[],getKey:(e,t)=>e.title,elements:ie,parent:Z,before:re,singleRoot:!0,trackIndex:!1,start:ne,renderItem:(l,d,f,p,m)=>{u(c(()=>{let c=t(),d=r(`div`,c);i(c,d),s(()=>{o(d,`key`,String(l.title))}),n(d,`card border border-base-300 bg-base-100 shadow-sm`);let f=r(`div`,d);i(d,f),n(f,`card-body gap-2 p-4`);let p=r(`div`,f);i(f,p),n(p,`text-xs uppercase tracking-[0.2em] text-base-content/50`),i(p,a(`Capability`));let m=r(`div`,f);i(f,m),n(m,`text-sm font-semibold`);let g=e(`rue:slot:anchor`);i(m,g),s(()=>{let e=l.title;h(()=>u(e,m,g))});let _=r(`p`,f);i(f,_),n(_,`m-0 text-sm opacity-70`);let v=e(`rue:slot:anchor`);return i(_,v),s(()=>{let e=l.desc;h(()=>u(e,_,v))}),c}),d,f)}})});let ae=e(`rue:component:anchor`);i(f,ae),s(()=>{let e=p(R,{title:`Accordion using radio inputs`,summary:`保留单开分组，同时额外开启 collapsible，方便在文档页里反复点按查看开合状态。`,tab:l,preview:()=>W(`accordion-radio-demo`,{collapsible:!0}),code:`<Accordion className="bg-base-100 border border-base-300" name="accordion-radio-demo" defaultOpen collapsible>
...
</Accordion>`});h(()=>u(e,f,ue))});let de=e(`rue:component:anchor`);i(f,de),s(()=>{let e=p(R,{title:`Accordion with plus/minus icon`,summary:`保留 plus/minus 方案，并开启 collapsible，方便直接验证开合反馈。`,tab:T,preview:()=>W(`accordion-plus-demo`,{icon:`plus`,collapsible:!0}),code:`<Accordion icon="plus" className="bg-base-100 border border-base-300" name="accordion-plus-demo" defaultOpen collapsible>
  <Accordion.Title className="font-semibold">How do I create an account?</Accordion.Title>
  <Accordion.Content className="text-sm opacity-80">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Accordion.Content>
...
</Accordion>`});h(()=>u(e,f,de))});let fe=e(`rue:component:anchor`);i(f,fe),s(()=>{let e=p(R,{title:`Using Accordion and Join together`,summary:`保留 join 组合方式，并开启 collapsible，方便连续边框场景下反复验证开合。`,tab:E,preview:()=>y(`div`,{className:`join join-vertical bg-base-100`,children:B.map((e,t)=>v(L,{icon:`arrow`,collapsible:!0,className:`join-item border border-base-300`,name:`accordion-join-demo`,defaultOpen:t===0,children:[y(L.Title,{className:`font-semibold`,children:e.title}),y(L.Content,{className:`text-sm opacity-80`,children:e.content})]},`join-${e.key}`))}),code:`<div className="join join-vertical bg-base-100">
...
</div>`});h(()=>u(e,f,fe))});let pe=e(`rue:component:anchor`);i(f,pe),s(()=>{let e=p(R,{title:`Accordion using items array (radio)`,summary:`保留 items 数组写法，并开启 collapsible，方便直接验证数据驱动下的收起逻辑。`,tab:D,preview:()=>y(L,{collapsible:!0,className:`bg-base-100 border border-base-300`,name:`accordion-array-radio-demo`,items:B.map((e,t)=>({key:e.key,title:e.title,content:e.content,open:t===0}))}),code:`${j}
...
<Accordion
  ...
  items={items}
/>`});h(()=>u(e,f,me))});let Q=r(`h2`,f);i(f,Q),o(Q,`id`,`accordion-api`),i(Q,a(`API`));let he=r(`p`,f);i(f,he),i(he,a(`Accordion 现在分成两套用法：children 模式适合局部排版，items 模式适合数据驱动和受控状态。 两套模式共用同一套视觉类名，因此迁移旧示例时通常只需要把结构收敛到更清晰的语义层。`));let ge=r(`h3`,f);i(f,ge),i(ge,a(`Accordion Props`));let _e=e(`rue:component:anchor`);i(f,_e),s(()=>{let e=p(z,{rows:H});h(()=>u(e,f,_e))});let $=r(`h3`,f);i(f,$),n($,`mt-6`),i($,a(`AccordionDataItem`));let ve=e(`rue:component:anchor`);return i(f,ve),s(()=>{let e=p(z,{rows:U});h(()=>u(e,f,ve))}),d})}),f,g),f})};export{G as default};