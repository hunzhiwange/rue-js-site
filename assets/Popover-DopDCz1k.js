...
</div>`});b(()=>m(e,p,T))});let O=e(`rue:component:anchor`);a(p,O),u(()=>{let e=y(k,{title:`Controlled visibility`,tab:l,preview:()=>D(B,{}),code:`const controlledOpen = ref(false)
...
</div>`});b(()=>m(e,p,A))});let j=r(`h2`,p);a(p,j),n(j,`mt-12`),a(j,s(`API`));let M=e(`rue:component:anchor`);return a(p,M),u(()=>{let e=y(R,{rows:z});b(()=>m(e,p,M))}),d})}),h,g),h})};export{se as default};