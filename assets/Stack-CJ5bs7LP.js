import{F as e,I as t,K as n,L as r,N as i,Q as a,R as o,W as s,_t as c,d as l,l as u,mt as d,ot as f,t as p,ut as m,z as h}from"./vapor-runtime-Dfq7aA8z.js";import{a as g,n as _}from"./vapor-helpers-vapor-CpxsbTjB.js";import{n as v,t as y}from"./src-BaNG2YQR.js";import{n as b}from"./SidebarPlaygroundDesign-CGhyvgx7.js";import{t as x}from"./Code-CLTo4rRM.js";import{t as S}from"./tabs-CxVJfyAw.js";import{t as C}from"./stack-B_nZijRu.js";var w=a=>l(s=>{let d=r(`div`,s);n(d,`component-preview not-prose text-base-content my-6 lg:my-12`);let f=r(`div`,d);i(d,f),n(f,`flex flex-wrap items-start justify-between gap-3`);let h=r(`div`,f);i(f,h);let g=r(`h2`,h);i(h,g),n(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(g,o(`# `));let _=e(`rue:slot:anchor`);i(g,_),c(()=>{let e=a.title;m(()=>u(e,g,_))});let v=e(`rue:slot:anchor`);i(h,v),c(()=>{let o=a.summary?l(()=>{let o=t(),s=r(`p`,o);i(o,s),n(s,`m-0 text-sm opacity-70`);let l=e(`rue:slot:anchor`);return i(s,l),c(()=>{let e=a.summary;m(()=>u(e,s,l))}),o}):``;m(()=>u(o,h,v))});let y=e(`rue:component:anchor`);i(d,y),c(()=>{let e=p(S,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:a.tab.value,onChange:e=>a.tab.value=e,className:`mb-3 mt-4`});m(()=>u(e,d,y))});let b=e(`rue:slot:anchor`);return i(d,b),c(()=>{let n=a.tab.value===`preview`?a.preview():l(()=>{let n=t(),r=e(`rue:component:anchor`);return i(n,r),c(()=>{let e=p(x,{className:`mt-2`,lang:`tsx`,code:a.code});m(()=>u(e,n,r))}),n});m(()=>u(n,d,b))}),d}),T=a=>l(d=>{let f=r(`div`,d);n(f,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let p=r(`table`,f);i(f,p),n(p,`table table-zebra`);let h=r(`thead`,p);i(p,h);let g=r(`tr`,h);i(h,g);let v=r(`th`,g);i(g,v),i(v,o(`属性`));let y=r(`th`,g);i(g,y),i(y,o(`说明`));let b=r(`th`,g);i(g,b),i(b,o(`类型`));let x=r(`th`,g);i(g,x),i(x,o(`默认值`));let S=r(`tbody`,p);i(p,S);let C=e(`rue:list:start`),w=e(`rue:list:end`);i(S,C),i(S,w);let T=new Map;return c(()=>{T=_({items:a.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(n,a,o,d,f)=>{u(l(()=>{let a=t(),o=r(`tr`,a);i(a,o),c(()=>{s(o,`key`,String(n.prop))});let l=r(`td`,o);i(o,l);let d=r(`code`,l);i(l,d);let f=e(`rue:slot:anchor`);i(d,f),c(()=>{let e=n.prop;m(()=>u(e,d,f))});let p=r(`td`,o);i(o,p);let h=e(`rue:slot:anchor`);i(p,h),c(()=>{let e=n.description;m(()=>u(e,p,h))});let g=r(`td`,o);i(o,g);let _=r(`code`,g);i(g,_);let v=e(`rue:slot:anchor`);i(_,v),c(()=>{let e=n.type;m(()=>u(e,_,v))});let y=r(`td`,o);i(o,y);let b=r(`code`,y);i(y,b);let x=e(`rue:slot:anchor`);return i(b,x),c(()=>{let e=n.defaultValue;m(()=>u(e,b,x))}),a}),a,o)}})}),f}),ee=[{prop:`as`,description:`指定根节点标签或组件，适合 section、article 等语义容器。`,type:`any`,defaultValue:`'div'`},{prop:`className`,description:`补充容器尺寸、圆角、边框、背景等样式。`,type:`string`,defaultValue:`-`},{prop:`horizontal`,description:`水平方向定位；显式传入时会覆盖 placement 里的水平预设。`,type:`'center' | 'start' | 'end'`,defaultValue:`'center'`},{prop:`placement`,description:`组合定位快捷写法，用一条属性同时声明 vertical 和 horizontal。`,type:`'center' | 'top' | 'bottom' | 'start' | 'end' | 'top-start' | 'top-end' | 'bottom-start' | 'bottom-end'`,defaultValue:`'center'`},{prop:`reverse`,description:`反转子节点渲染顺序，适合把最新项放在最上层。`,type:`boolean`,defaultValue:`false`},{prop:`vertical`,description:`垂直方向定位；显式传入时会覆盖 placement 里的垂直预设。`,type:`'center' | 'top' | 'bottom'`,defaultValue:`'center'`}],E=()=>{let{tabs:_}=g(`useSetup:0:0`,()=>d(()=>({tabs:{basic:g(`ref:1:0`,()=>f(`preview`)),images:g(`ref:1:1`,()=>f(`preview`)),cards:g(`ref:1:2`,()=>f(`preview`)),alignment:g(`ref:1:3`,()=>f(`preview`)),reverse:g(`ref:1:4`,()=>f(`preview`)),shadow:g(`ref:1:5`,()=>f(`preview`)),notifications:g(`ref:1:6`,()=>f(`preview`)),scene:g(`ref:1:7`,()=>f(`preview`))}})));return l(d=>{let f=t(),g=e(`rue:component:anchor`);return i(f,g),u(p(b,{children:l(()=>{let l=t(),d=r(`div`,l);i(l,d),n(d,`max-w-none prose prose-sm md:prose-base`);let f=r(`h1`,d);i(d,f),i(f,o(`Stack 堆叠容器`));let g=r(`p`,d);i(d,g),n(g,`text-sm mt-3 mb-3`),i(g,o(`Stack 保留 Rue 当前的 stack 视觉风格，同时把 API 补成更清晰的语义层。除了原有的`));let b=r(`code`,g);i(g,b),i(b,o(`vertical`)),i(g,o(`和`));let x=r(`code`,g);i(g,x),i(x,o(`horizontal`)),i(g,o(`，现在还支持`));let S=r(`code`,g);i(g,S),i(S,o(`placement`));let E=h(g);i(g,E),a(E,` `),i(g,o(`组合定位，以及`));let D=r(`code`,g);i(g,D),i(D,o(`reverse`)),i(g,o(`反向层级。`));let O=r(`div`,d);i(d,O),n(O,`text-sm flex flex-wrap gap-4`);let k=r(`a`,O);i(O,k),s(k,`href`,`https://daisyui.com/components/stack/`),s(k,`target`,`_blank`),i(k,o(`查看 Stack 静态样式`));let A=r(`h2`,d);i(d,A),i(A,o(`何时使用`));let j=r(`ul`,d);i(d,j);let te=r(`li`,j);i(j,te),i(te,o(`需要把多张卡片、图片、文件封面或通知面板做成同一视觉堆叠。`));let ne=r(`li`,j);i(j,ne),i(ne,o(`需要用一条属性快速切换堆叠朝向和落点，而不想反复记忆底层 class。`));let re=r(`li`,j);i(j,re),i(re,o(`需要保留已有堆叠视觉，但希望额外控制最新项是否位于最上层。`));let ie=e(`rue:component:anchor`);i(d,ie),c(()=>{let e=p(w,{title:`基础堆叠`,summary:`保留原来的 3 div stack demo，作为最小可用写法。`,tab:_.basic,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body`,children:v(C,{className:`h-20 w-32`,"data-testid":`stack-basic`,children:[y(`div`,{className:`grid place-content-center rounded-box bg-primary text-primary-content`,children:`1`}),y(`div`,{className:`grid place-content-center rounded-box bg-accent text-accent-content`,children:`2`}),y(`div`,{className:`grid place-content-center rounded-box bg-secondary text-secondary-content`,children:`3`})]})})}),code:`<Stack className="h-20 w-32">
  ...
  <img
    ...
    className="rounded-box"
  />
</Stack>`});m(()=>u(e,d,ae))});let oe=e(`rue:component:anchor`);i(d,oe),c(()=>{let e=p(w,{title:`卡片堆叠`,summary:`保留原来的 stacked cards，适合做 deck、ticket 或文件层。`,tab:_.cards,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body`,children:v(C,{className:`size-28`,"data-testid":`stack-cards`,children:[y(`div`,{className:`card border border-base-content bg-base-100 text-center`,children:y(`div`,{className:`card-body`,children:`A`})}),y(`div`,{className:`card border border-base-content bg-base-100 text-center`,children:y(`div`,{className:`card-body`,children:`B`})}),y(`div`,{className:`card border border-base-content bg-base-100 text-center`,children:y(`div`,{className:`card-body`,children:`C`})})]})})}),code:`<Stack className="size-28">
...
</Stack>`});m(()=>u(e,d,se))});let ce=e(`rue:component:anchor`);i(d,ce),c(()=>{let e=p(w,{title:`反向层级`,summary:`reverse 适合把最新版本、最新消息或最新封面放在最上层。`,tab:_.reverse,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body gap-5 md:grid md:grid-cols-2`,children:[v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Default order`}),v(C,{className:`w-44`,children:[y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:`v1 Initial draft`}),y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:`v2 Review notes`}),y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:`v3 Final copy`})]})]}),v(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`reverse`}),v(C,{className:`w-44`,reverse:!0,children:[y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:`v1 Initial draft`}),y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:`v2 Review notes`}),y(`div`,{className:`rounded-box border border-primary/30 bg-primary/5 p-4 text-primary`,children:`v3 Final copy`})]})]})]})}),code:`<Stack className="w-44" reverse>
...
</Stack>`});m(()=>u(e,d,ce))});let le=e(`rue:component:anchor`);i(d,le),c(()=>{let e=p(w,{title:`阴影层次`,summary:`保留原来的 shadow 示例，适合强调卡片深度和层级关系。`,tab:_.shadow,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body`,children:v(C,{children:[y(`div`,{className:`card bg-base-200 text-center shadow-md`,children:y(`div`,{className:`card-body`,children:`A`})}),y(`div`,{className:`card bg-base-200 text-center shadow`,children:y(`div`,{className:`card-body`,children:`B`})}),y(`div`,{className:`card bg-base-200 text-center shadow-sm`,children:y(`div`,{className:`card-body`,children:`C`})})]})})}),code:`<Stack>
...
</Stack>`});m(()=>u(e,d,N))});let P=r(`h2`,d);i(d,P),s(P,`id`,`stack-api`),i(P,o(`API`));let F=r(`p`,d);i(d,F),i(F,o(`当前页面展示的是 Stack 的完整可用 API，旧属性保留，新属性作为语义增强层补充进来。`));let I=e(`rue:component:anchor`);i(d,I),c(()=>{let e=p(T,{rows:ee});m(()=>u(e,d,I))});let L=r(`div`,d);i(d,L),n(L,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let R=r(`h3`,L);i(L,R),n(R,`mt-0 mb-3 text-base font-semibold`),i(R,o(`placement 快捷映射`));let z=r(`div`,L);i(L,z),n(z,`grid gap-2 text-sm md:grid-cols-2`);let B=r(`div`,z);i(z,B);let V=r(`code`,B);i(B,V),i(V,o(`placement="top"`)),i(B,o(`→`));let H=r(`code`,B);i(B,H),i(H,o(`vertical="top"`));let U=r(`div`,z);i(z,U);let W=r(`code`,U);i(U,W),i(W,o(`placement="bottom"`)),i(U,o(`→`));let G=r(`code`,U);i(U,G),i(G,o(`vertical="bottom"`));let K=r(`div`,z);i(z,K);let ue=r(`code`,K);i(K,ue),i(ue,o(`placement="start"`)),i(K,o(`→`));let de=r(`code`,K);i(K,de),i(de,o(`horizontal="start"`));let q=r(`div`,z);i(z,q);let J=r(`code`,q);i(q,J),i(J,o(`placement="end"`)),i(q,o(`→`));let fe=r(`code`,q);i(q,fe),i(fe,o(`horizontal="end"`));let Y=r(`div`,z);i(z,Y);let pe=r(`code`,Y);i(Y,pe),i(pe,o(`placement="top-start"`)),i(Y,o(`→`));let me=r(`code`,Y);i(Y,me),i(me,o(`vertical="top" + horizontal="start"`));let X=r(`div`,z);i(z,X);let he=r(`code`,X);i(X,he),i(he,o(`placement="bottom-end"`)),i(X,o(`→`));let ge=h(X);i(X,ge),a(ge,` `);let _e=r(`code`,X);i(X,_e),i(_e,o(`vertical="bottom" + horizontal="end"`));let ve=r(`h2`,d);i(d,ve),i(ve,o(`FAQ`));let ye=r(`h3`,d);i(d,ye),i(ye,o(`已经有 vertical 和 horizontal，为什么还要加 placement？`));let Z=r(`p`,d);i(d,Z);let be=r(`code`,Z);i(Z,be),i(be,o(`placement`)),i(Z,o(`适合快速写组合定位，尤其是`));let xe=r(`code`,Z);i(Z,xe),i(xe,o(`top-end`)),i(Z,o(`、`));let Se=r(`code`,Z);i(Z,Se),i(Se,o(`bottom-start`)),i(Z,o(`这类常见场景。 如果你已经在用旧 API，也可以继续沿用原来的`));let Ce=h(Z);i(Z,Ce),a(Ce,` `);let we=r(`code`,Z);i(Z,we),i(we,o(`vertical`)),i(Z,o(`和`));let Te=r(`code`,Z);i(Z,Te),i(Te,o(`horizontal`)),i(Z,o(`。`));let Ee=r(`h3`,d);i(d,Ee),i(Ee,o(`placement 和 vertical / horizontal 同时传会怎样？`));let Q=r(`p`,d);i(d,Q),i(Q,o(`显式传入的`));let De=r(`code`,Q);i(Q,De),i(De,o(`vertical`)),i(Q,o(`、`));let Oe=r(`code`,Q);i(Q,Oe),i(Oe,o(`horizontal`)),i(Q,o(`优先级更高。也就是说，`));let ke=r(`code`,Q);i(Q,ke),i(ke,o(`placement`)),i(Q,o(`更像一个快捷预设，而不是强制覆盖层。`));let Ae=r(`h3`,d);i(d,Ae),i(Ae,o(`reverse 会改变样式还是改变 DOM 顺序？`));let $=r(`p`,d);i(d,$);let je=r(`code`,$);i($,je),i(je,o(`reverse`));let Me=h($);return i($,Me),a(Me,` `),i($,o(`会反转子节点渲染顺序，因此最适合“最新项在最上层”的内容流场景，比如通知、版本封面、设计稿堆叠。`)),l})}),f,g),f})};export{E as default};