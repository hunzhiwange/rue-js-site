...
</div>`}),p,U)});let W=i(`rue:component:anchor`);l(p,W),u(()=>{c(f(j,{title:`Vertical Orientation API`,summary:`新增 ant-design 风格的 orientation / vertical API，适合行内分隔，不展示 children。`,tab:E,preview:()=>_(`div`,{className:`flex flex-wrap items-center gap-3 rounded-box border border-base-300 bg-base-100 px-4 py-5`,children:[v(`span`,{children:`Profile`}),v(A,{orientation:`vertical`,className:`h-6`}),v(`span`,{children:`Team`}),v(A,{vertical:!0,className:`h-6`}),v(`span`,{children:`Billing`}),v(A,{type:`vertical`,className:`h-6`}),v(`span`,{children:`Logs`})]}),code:`<div className="flex flex-wrap items-center gap-3">
  <span>Profile</span>
