...
/>`});p(()=>d(e,f,P))});let F=a(`rue:component:anchor`);i(f,F),u(()=>{let e=m(z,{title:`图片对比`,summary:`组合式写法示例。`,tab:C,preview:()=>v(R,{className:`rounded-field aspect-16/9`,tabIndex:0,children:[y(R.Item1,{role:`img`,tabIndex:0,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a.webp`})}),y(R.Item2,{role:`img`,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a-blur.webp`})}),y(R.Resizer,{})]}),code:`<Diff className="aspect-16/9" tabIndex={0}>
  ...
  <Diff.Resizer />
</Diff>`});p(()=>d(e,f,I))});let L=n(`h2`);i(f,L),s(L,`id`,`diff-api`),i(L,r(`API`));let H=n(`p`);i(f,H),i(H,r(`Diff 现在同时支持快捷模式和组合式模式，下面按根组件和子组件拆开列出。`));let U=a(`rue:component:anchor`);i(f,U),u(()=>{let e=m(B,{rows:ne});p(()=>d(e,f,U))});let W=n(`div`);i(f,W),t(W,`not-prose mt-6`);let G=a(`rue:component:anchor`);i(f,G),u(()=>{let e=m(B,{rows:V});p(()=>d(e,f,G))});let K=n(`div`);i(f,K),t(K,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4 text-sm`);let q=n(`div`);i(K,q),t(q,`font-semibold`),i(q,r(`模式选择建议`));let J=n(`div`);i(K,J),t(J,`mt-2 grid gap-2 md:grid-cols-2`);let Y=n(`div`);i(J,Y);let re=n(`code`);i(Y,re),i(re,r(`item1 / item2`)),i(Y,r(`适合快速搭 demo、做受控联动、补标签和默认手柄内容。`));let X=n(`div`);i(J,X);let ie=n(`code`);i(X,ie),i(ie,r(`children + Diff.Item1 / Item2 / Resizer`));let ae=o(X);i(X,ae),c(ae,` `),i(X,r(`适合保留旧结构，或自己完全掌控内部布局。`));let oe=n(`h2`);i(f,oe),i(oe,r(`FAQ`));let se=n(`h3`);i(f,se),i(se,r(`快捷模式和组合式模式怎么选？`));let Z=n(`p`);i(f,Z),i(Z,r(`如果你只是想比较两个内容块，优先用`));let ce=n(`code`);i(Z,ce),i(ce,r(`item1`)),i(Z,r(`和`));let le=n(`code`);i(Z,le),i(le,r(`item2`)),i(Z,r(`。如果你已经有现成结构， 或者需要完全接管内部节点顺序，就继续用旧的组合式写法。`));let ue=n(`h3`);i(f,ue),i(ue,r(`value 和 defaultValue 有什么区别？`));let Q=n(`p`);i(f,Q);let de=n(`code`);i(Q,de),i(de,r(`value`)),i(Q,r(`是受控值，外部状态说了算；`));let fe=n(`code`);i(Q,fe),i(fe,r(`defaultValue`));let pe=o(Q);i(Q,pe),c(pe,` `),i(Q,r(`只决定初始位置，之后由组件内部维护。`));let me=n(`h3`);i(f,me),i(me,r(`传了 children 之后 value 还会生效吗？`));let $=n(`p`);i(f,$),i($,r(`当前版本里，`));let he=n(`code`);i($,he),i(he,r(`children`)),i($,r(`会切换到组合式模式，因此`));let ge=n(`code`);i($,ge),i(ge,r(`value`)),i($,r(`、`));let _e=n(`code`);i($,_e),i(_e,r(`defaultValue`)),i($,r(`这些快捷模式能力不会接管内部布局。需要受控拖动时，优先使用`));let ve=n(`code`);i($,ve),i(ve,r(`item1`)),i($,r(`/`));let ye=o($);i($,ye),c(ye,` `);let be=n(`code`);return i($,be),i(be,r(`item2`)),i($,r(`。`)),l})}),l,f),l})};export{H as default};