...
</Grid>`,de=()=>{let{tabBasic:e,tabResponsive:s,tabAlignment:c,tabFlex:m,tabDashboard:v}=_(`useSetup:0:0`,()=>f(()=>({tabBasic:_(`ref:1:0`,()=>p(`preview`)),tabResponsive:_(`ref:1:1`,()=>p(`preview`)),tabAlignment:_(`ref:1:2`,()=>p(`preview`)),tabFlex:_(`ref:1:3`,()=>p(`preview`)),tabDashboard:_(`ref:1:4`,()=>p(`preview`))})));return u(f=>{let p=n(),_=t(`rue:component:anchor`);return a(p,_),d(h(x,{children:u(()=>{let u=n(),f=i(`div`,u);a(u,f),r(f,`max-w-none prose prose-sm md:prose-base`);let p=i(`h1`,f);a(f,p),a(p,o(`Grid 栅格`));let _=i(`p`,f);a(f,_),r(_,`mt-3 mb-3 text-sm`),a(_,o(`Grid 提供接近成熟组件库的 24 栅格 API，用来组织页面骨架、卡片矩阵和左右混排布局。`));let x=i(`p`,f);a(f,x),r(x,`my-3 text-sm opacity-75`),a(x,o(`这一版不照搬 Ant Design 的视觉，而是把它的核心布局能力迁到 Rue 当前的轻量表面体系里：支持 Row / Col、响应式断点、gutter、偏移、顺序和 flex 混排。`));let S=i(`div`,f);a(f,S),r(S,`not-prose mt-4 flex flex-wrap gap-2`);let T=t(`rue:component:anchor`);a(S,T),l(()=>{let e=h(E,{outline:!0,children:`24 Columns`});g(()=>d(e,S,T))});let D=t(`rue:component:anchor`);a(S,D),l(()=>{let e=h(E,{outline:!0,children:`Responsive`});g(()=>d(e,S,D))});let O=t(`rue:component:anchor`);a(S,O),l(()=>{let e=h(E,{outline:!0,children:`Offset & Order`});g(()=>d(e,S,O))});let k=t(`rue:component:anchor`);a(S,k),l(()=>{let e=h(E,{outline:!0,children:`Flex Mix`});g(()=>d(e,S,k))});let A=t(`rue:component:anchor`);a(f,A),l(()=>{let t=h(Z,{title:`基础 24 栅格`,summary:`先用最直接的 span 心智搭建信息密度，再往上叠加响应式与语义卡片。`,tab:e,code:oe,preview:()=>y(`div`,{className:`space-y-5`,children:[b(w,{className:`overflow-hidden bg-base-100 shadow-sm`,children:b(w.Body,{className:`gap-4`,children:y(X,{gutter:[16,16],children:[b(X.Col,{span:6,children:b($,{title:`span 6`,detail:`季度销售`,tag:`25%`})}),b(X.Col,{span:6,children:b($,{title:`span 6`,detail:`新增用户`,tag:`25%`,className:`from-info/8 to-base-100`})}),b(X.Col,{span:6,children:b($,{title:`span 6`,detail:`留存趋势`,tag:`25%`,className:`from-success/8 to-base-100`})}),b(X.Col,{span:6,children:b($,{title:`span 6`,detail:`投放效率`,tag:`25%`,className:`from-warning/10 to-base-100`})})]})})}),y(X,{gutter:[16,16],children:[b(X.Col,{span:8,children:b($,{title:`span 8`,detail:`三栏内容区`,tag:`33%`})}),b(X.Col,{span:8,children:b($,{title:`span 8`,detail:`更适合导航+内容+侧栏`,tag:`33%`,className:`from-primary/8 to-base-100`})}),b(X.Col,{span:8,children:b($,{title:`span 8`,detail:`与 Card、Stat 组合最常用`,tag:`33%`,className:`from-secondary/8 to-base-100`})})]})]})});g(()=>d(t,f,A))});let j=t(`rue:component:anchor`);a(f,j),l(()=>{let e=h(Z,{title:`响应式 gutter 与断点覆盖`,summary:`gutter 可以按断点变化，Col 也可以在 xs~xxl 分别覆盖 span 和布局参数。`,tab:s,code:se,preview:()=>y(`div`,{className:`space-y-4`,children:[b(`div`,{className:`not-prose rounded-[1.5rem] border border-dashed border-base-300 bg-base-100/80 p-4 text-sm opacity-75`,children:`缩放窗口时，这组三列会从一列堆叠，逐步过渡到两列和三列，同时间距从紧凑切到宽松。`}),y(X,{gutter:[{xs:8,md:24},{xs:8,md:24}],children:[b(X.Col,{xs:24,sm:12,lg:8,children:b($,{title:`Hero 模块`,detail:`xs=24, sm=12, lg=8`,tag:`adaptive`,className:`from-primary/10 via-base-100 to-base-200`})}),b(X.Col,{xs:24,sm:12,lg:8,children:b($,{title:`Insights`,detail:`xs=24, sm=12, lg=8`,tag:`adaptive`,className:`from-info/10 via-base-100 to-base-200`})}),b(X.Col,{xs:24,lg:8,children:b($,{title:`Ops Panel`,detail:`xs=24, lg=8`,tag:`adaptive`,className:`from-success/10 via-base-100 to-base-200`})})]})]})});g(()=>d(e,f,j))});let M=t(`rue:component:anchor`);a(f,M),l(()=>{let e=h(Z,{title:`对齐、偏移与顺序`,summary:`同一套 Grid 既能做规则矩阵，也能做营销位或时间线这种非对称排布。`,tab:c,code:ce,preview:()=>y(`div`,{className:`space-y-6`,children:[b(w,{className:`bg-base-100 shadow-sm`,children:b(w.Body,{className:`gap-4`,children:y(X,{gutter:[16,16],justify:`space-between`,align:`bottom`,children:[b(X.Col,{span:5,children:b($,{title:`Top`,detail:`高度较小`,tag:`A`,className:`h-28`})}),b(X.Col,{span:5,children:b($,{title:`Middle`,detail:`通过 align=bottom 对齐底边`,tag:`B`,className:`h-40 from-warning/10 to-base-100`})}),b(X.Col,{span:5,children:b($,{title:`Bottom`,detail:`适合比较型面板`,tag:`C`,className:`h-32 from-secondary/8 to-base-100`})})]})})}),y(X,{gutter:[16,16],children:[b(X.Col,{span:6,offset:6,children:b($,{title:`offset 6`,detail:`给主内容留白`,tag:`offset`})}),b(X.Col,{span:6,order:3,children:b($,{title:`order 3`,detail:`视觉顺序后移`,tag:`order`,className:`from-info/8 to-base-100`})}),b(X.Col,{span:6,order:2,children:b($,{title:`order 2`,detail:`视觉顺序前置`,tag:`order`,className:`from-success/8 to-base-100`})})]})]})});g(()=>d(e,f,M))});let N=t(`rue:component:anchor`);a(f,N),l(()=>{let e=h(Z,{title:`Flex 混排与不换行轨道`,summary:`当 24 栅格不足以表达固定边栏 + 弹性主内容时，直接切到 flex 语义。`,tab:m,code:le,preview:()=>y(`div`,{className:`space-y-6`,children:[y(X,{gutter:16,align:`stretch`,children:[b(X.Col,{flex:`280px`,children:b($,{title:`Fixed rail`,detail:`280px 固定宽度，适合过滤器与导航`,tag:`280px`,className:`h-full from-base-200 to-base-100`})}),b(X.Col,{flex:`auto`,children:b($,{title:`Fluid canvas`,detail:`auto 吃掉剩余空间，适合主编辑区`,tag:`auto`,className:`h-full from-primary/8 to-base-100`})}),b(X.Col,{flex:`120px`,children:b($,{title:`Ops`,detail:`固定操作条`,tag:`120px`,className:`h-full from-warning/10 to-base-100`})})]}),y(X,{gutter:12,wrap:!1,children:[b(X.Col,{flex:`180px`,children:b($,{title:`No wrap`,detail:`水平工具带`,tag:`rail`})}),b(X.Col,{flex:`180px`,children:b($,{title:`Keep inline`,detail:`不允许自动换行`,tag:`rail`,className:`from-info/8 to-base-100`})}),b(X.Col,{flex:`180px`,children:b($,{title:`Sticky group`,detail:`适合顶部命令条`,tag:`rail`,className:`from-secondary/8 to-base-100`})})]})]})});g(()=>d(e,f,N))});let P=t(`rue:component:anchor`);a(f,P),l(()=>{let e=h(Z,{title:`仪表盘实战布局`,summary:`Grid 不是只用来排彩色方块，更适合和 Card、Badge、Button 组合成真实页面骨架。`,tab:v,code:ue,preview:()=>y(X,{gutter:[20,20],children:[b(X.Col,{xs:24,xl:16,children:b(w,{className:`overflow-hidden bg-base-100 shadow-sm`,children:y(w.Body,{className:`gap-5`,children:[y(`div`,{className:`flex flex-wrap items-center justify-between gap-3`,children:[y(`div`,{children:[b(`div`,{className:`text-sm font-semibold`,children:`Growth cockpit`}),b(`div`,{className:`mt-1 text-sm opacity-70`,children:`一块主画布里继续嵌套 Grid，拆出指标和趋势卡。`})]}),y(`div`,{className:`flex flex-wrap gap-2`,children:[b(E,{outline:!0,children:`Live`}),b(E,{outline:!0,children:`Q2`})]})]}),y(X,{gutter:[16,16],children:[b(X.Col,{xs:24,md:12,children:b($,{title:`GMV`,detail:`¥ 4,230,000`,tag:`+18%`,className:`from-primary/10 via-base-100 to-base-200 h-full`})}),b(X.Col,{xs:24,md:12,children:b($,{title:`Retention`,detail:`71.4%`,tag:`+4.8pt`,className:`from-success/10 via-base-100 to-base-200 h-full`})}),b(X.Col,{xs:24,children:y(`div`,{className:`rounded-[1.25rem] border border-base-300/70 bg-gradient-to-br from-base-100 via-base-100 to-base-200/80 p-5 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.55)]`,children:[y(`div`,{className:`flex flex-wrap items-center justify-between gap-3`,children:[y(`div`,{children:[b(`div`,{className:`text-sm font-semibold`,children:`Campaign timeline`}),b(`div`,{className:`mt-1 text-xs leading-5 opacity-70`,children:`用整行展示跨模块趋势和长内容。`})]}),b(C,{color:`primary`,size:`sm`,children:`查看明细`})]}),y(`div`,{className:`mt-4 grid gap-3 md:grid-cols-3`,children:[b(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`启动 6 个投放实验`}),b(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`完成落地页 AB 版本替换`}),b(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`同步 CRM 标签到投放人群`})]})]})})]})]})})}),b(X.Col,{xs:24,xl:8,children:b(w,{className:`bg-base-100 shadow-sm`,children:y(w.Body,{className:`gap-4`,children:[y(`div`,{className:`flex items-center justify-between gap-3`,children:[y(`div`,{children:[b(`div`,{className:`text-sm font-semibold`,children:`Ops queue`}),b(`div`,{className:`mt-1 text-xs opacity-70`,children:`右侧侧栏保持更紧凑的信息节奏。`})]}),b(E,{outline:!0,children:`7 items`})]}),y(`div`,{className:`space-y-3`,children:[b($,{title:`素材审批`,detail:`还剩 2 项待确认`,tag:`Today`,className:`from-warning/10 to-base-100`}),b($,{title:`会员分层`,detail:`等待 CRM 回传标签`,tag:`Sync`,className:`from-info/10 to-base-100`}),b($,{title:`报表快照`,detail:`18:00 自动归档`,tag:`Auto`,className:`from-secondary/10 to-base-100`})]})]})})})]})});g(()=>d(e,f,P))});let F=i(`div`,f);a(f,F),r(F,`component-preview not-prose text-base-content my-8 lg:my-12`);let I=i(`h2`,F);a(F,I),r(I,`component-preview-title mt-2 mb-1 text-lg font-semibold`),a(I,o(`# API`));let L=i(`p`,F);a(F,L),r(L,`m-0 text-sm opacity-70`),a(L,o(`默认导出的 Grid 可直接当作 Row 使用，也可以通过 Grid.Row / Grid.Col 显式书写。`));let R=i(`div`,f);a(f,R),r(R,`not-prose space-y-8`);let z=i(`div`,R);a(R,z);let B=i(`h3`,z);a(z,B),r(B,`mb-3 text-base font-semibold`),a(B,o(`Grid / Grid.Row`));let V=t(`rue:component:anchor`);a(z,V),l(()=>{let e=h(Q,{rows:ie});g(()=>d(e,z,V))});let H=i(`div`,R);a(R,H);let U=i(`h3`,H);a(H,U),r(U,`mb-3 text-base font-semibold`),a(U,o(`Grid.Col`));let W=t(`rue:component:anchor`);return a(H,W),l(()=>{let e=h(Q,{rows:ae});g(()=>d(e,H,W))}),u})}),p,_),p})};export{de as default};