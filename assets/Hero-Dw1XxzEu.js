...
</div>`});p(()=>l(e,u,me))});let G=r(`div`,u);i(u,G),n(G,`not-prose my-12 space-y-8`);let K=r(`section`,G);i(G,K),n(K,`space-y-2`);let q=r(`h2`,K);i(K,q),n(q,`text-2xl font-semibold`),i(q,a(`API`));let J=r(`p`,K);i(K,J),n(J,`text-sm opacity-70`),i(J,a(`推荐把外层背景和高度交给 Hero Root，把布局交给 Hero.Content，把标题、描述和 CTA 交给语义子组件。这样页面里仍然可以继续用 className 微调，但不会反复重写同一套结构。`));let Y=r(`section`,G);i(G,Y),n(Y,`space-y-3`);let X=r(`h3`,Y);i(Y,X),n(X,`text-xl font-semibold`),i(X,a(`Hero`));let he=e(`rue:component:anchor`);i(Y,he),s(()=>{let e=f(B,{rows:ie});p(()=>l(e,Y,he))});let Z=r(`section`,G);i(G,Z),n(Z,`space-y-3`);let Q=r(`h3`,Z);i(Z,Q),n(Q,`text-xl font-semibold`),i(Q,a(`Hero.Content`));let ge=e(`rue:component:anchor`);i(Z,ge),s(()=>{let e=f(B,{rows:ae});p(()=>l(e,Z,ge))});let $=r(`section`,G);i(G,$),n($,`space-y-3`);let _e=r(`h3`,$);i($,_e),n(_e,`text-xl font-semibold`),i(_e,a(`Hero parts`));let ve=e(`rue:component:anchor`);return i($,ve),s(()=>{let e=f(B,{rows:oe});p(()=>l(e,$,ve))}),c})}),d,m),d})};export{V as default};