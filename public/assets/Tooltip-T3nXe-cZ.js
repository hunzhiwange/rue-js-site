...
</Tooltip>`});g(()=>d(e,f,N))});let P=_(`rue:component:anchor`);e(f,P),t(()=>{let e=h(w,{title:`Tooltip placements`,tab:i,preview:()=>x(`div`,{className:`grid gap-4 sm:grid-cols-2 xl:grid-cols-4`,children:[b(S,{"data-testid":`tooltip-top`,title:`top / topLeft / topRight`,open:!0,placement:`top`,className:`justify-self-start`,children:b(`button`,{className:`btn`,children:`Top`})}),b(S,{"data-testid":`tooltip-bottom`,title:`bottom / bottomLeft / bottomRight`,open:!0,placement:`bottomRight`,className:`justify-self-start`,children:b(`button`,{className:`btn`,children:`Bottom`})}),b(S,{"data-testid":`tooltip-left`,title:`left / leftTop / leftBottom`,open:!0,placement:`leftTop`,className:`justify-self-start`,children:b(`button`,{className:`btn`,children:`Left`})}),b(S,{"data-testid":`tooltip-right`,title:`right / rightTop / rightBottom`,open:!0,placement:`rightBottom`,className:`justify-self-start`,children:b(`button`,{className:`btn`,children:`Right`})})]}),code:`<div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
...
</div>`});g(()=>d(e,f,P))});let F=_(`rue:component:anchor`);e(f,F),t(()=>{let e=h(w,{title:`Rich content`,tab:a,preview:()=>x(`div`,{className:`grid gap-5 lg:grid-cols-2`,children:[b(S,{title:x(`div`,{className:`space-y-1 text-left`,children:[b(`div`,{className:`font-semibold`,children:`发布检查`}),b(`div`,{className:`text-xs opacity-80`,children:`包含静态资源、接口联调和埋点确认。`})]}),open:!0,className:`justify-self-start`,overlayClassName:`max-w-56 border border-base-300 shadow-lg`,overlayStyle:{padding:`0.75rem`,letterSpacing:`0.02em`},children:b(`button`,{className:`btn btn-soft btn-primary`,children:`JSX title`})}),x(S,{open:!0,arrow:!1,className:`justify-self-start`,classNames:{body:`max-w-56 text-left`},styles:{body:{padding:`0.75rem`}},children:[b(S.Content,{children:x(`div`,{className:`space-y-2`,children:[b(`div`,{className:`badge badge-primary badge-soft`,children:`Rue`}),b(`p`,{className:`m-0 text-xs leading-5`,children:`Tooltip.Content 适合承载更自由的结构化信息。`})]})}),b(`button`,{className:`btn btn-soft`,children:`Tooltip.Content`})]})]}),code:`<Tooltip
  title={
...
</Tooltip>`});g(()=>d(e,f,F))});let I=_(`rue:component:anchor`);e(f,I),t(()=>{let e=h(w,{title:`Colors and semantic styling`,tab:s,preview:()=>x(`div`,{className:`flex flex-wrap gap-4`,children:[b(S,{title:`语义色`,color:`primary`,open:!0,children:b(`button`,{className:`btn btn-primary`,children:`Primary`})}),b(S,{title:`自定义颜色`,color:`#1d4ed8`,open:!0,children:b(`button`,{className:`btn border-0 bg-[#1d4ed8] text-white`,children:`Custom blue`})}),b(S,{title:`可通过 classNames.root 和 styles.body 精细调节`,open:!0,classNames:{root:`inline-flex`,body:`max-w-52 rounded-2xl`},styles:{body:{padding:`0.875rem`,boxShadow:`0 16px 40px rgba(15, 23, 42, 0.16)`}},children:b(`button`,{className:`btn btn-accent btn-soft`,children:`Semantic slots`})})]}),code:`<Tooltip title="语义色" color="primary" open={true}>
...
</Tooltip>`});g(()=>d(e,f,I))});let L=_(`rue:component:anchor`);e(f,L),t(()=>{let e=h(w,{title:`Trigger modes`,tab:D,preview:()=>x(`div`,{className:`grid gap-4 lg:grid-cols-3`,children:[b(S,{trigger:`click`,title:`Click again to close`,children:b(`button`,{className:`btn btn-outline`,children:`Click trigger`})}),b(S,{trigger:`focus`,title:`聚焦输入框时显示`,children:x(`label`,{className:`input`,children:[b(`span`,{className:`label`,children:`Focus`}),b(`input`,{type:`text`,placeholder:`Tab 到这里`})]})}),b(S,{trigger:`contextMenu`,title:`右键也可以作为触发手势`,children:b(`div`,{className:`rounded-box border border-dashed border-base-300 px-4 py-3 text-sm`,children:`Right click me`})})]}),code:`<Tooltip trigger="click" title="Click again to close">
