...
<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});h(()=>l(e,s,ie))});let ae=g(`rue:component:anchor`);e(s,ae),t(()=>{let e=m(F,{title:`推荐：复合子组件写法`,summary:`当某一列需要自己控制内容结构时，可以直接组合 Footer.Brand、Footer.Section、Footer.Link。`,tab:_,preview:()=>S(P,{className:`p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal`,children:[S(P.Brand,{children:[C(I,{}),S(`p`,{className:`text-sm mt-3 mb-3`,children:[`Rue Design System`,C(`br`,{}),`Ship consistent experiences.`]})]}),S(P.Section,{title:`Product`,children:[C(P.Link,{children:`Overview`}),C(P.Link,{children:`Pricing`}),C(P.Link,{children:`Changelog`})]}),C(P.Section,{title:`Community`,content:C(`div`,{className:`grid grid-flow-col gap-4`,children:L.map(({key:e,Icon:t})=>C(`button`,{type:`button`,"aria-label":e,children:C(t,{})},e))})})]}),code:`<Footer className="p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal">
  ...
  />
</Footer>`});h(()=>l(e,s,ae))});let oe=g(`rue:component:anchor`);e(s,oe),t(()=>{let e=m(F,{title:`Footer（默认纵向，sm 起横向）`,summary:`基础示例 展示，这里改用 sections 表达同一个场景。`,tab:v,preview:()=>C(P,{className:`p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal`,sections:W}),code:`<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});h(()=>l(e,s,oe))});let se=g(`rue:component:anchor`);e(s,se),t(()=>{let e=m(F,{title:`Footer with a logo section`,summary:`展示品牌区场景；推荐用 brand + sections，把品牌说明和导航列拆开。`,tab:b,preview:()=>C(P,{className:`p-10 bg-base-200 text-base-content rounded sm:footer-horizontal`,brand:S(`div`,{children:[C(I,{}),S(`p`,{className:`text-sm mt-3 mb-3`,children:[`ACME Industries Ltd.`,C(`br`,{}),`Providing reliable tech since 1992`]})]}),sections:W}),code:`<Footer
...
</Footer>`});h(()=>l(e,s,ue))});let de=g(`rue:component:anchor`);e(s,de),t(()=>{let e=m(F,{title:`Links and social icons (two rows)`,summary:`展示两行链接矩阵；用 sections 组合数据，继续交给 className 控制布局。`,tab:D,preview:()=>C(P,{className:`p-10 bg-neutral text-neutral-content rounded sm:grid-rows-2 sm:footer-horizontal`,sections:te}),code:`<Footer
