...
/>`});m(()=>u(e,d,P))});let F=e(`rue:component:anchor`);i(d,F),c(()=>{let e=p(z,{title:`图片对比`,summary:`组合式写法示例。`,tab:C,preview:()=>v(R,{className:`rounded-field aspect-16/9`,tabIndex:0,children:[y(R.Item1,{role:`img`,tabIndex:0,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a.webp`})}),y(R.Item2,{role:`img`,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a-blur.webp`})}),y(R.Resizer,{})]}),code:`<Diff className="aspect-16/9" tabIndex={0}>
  ...
  <Diff.Resizer />
</Diff>`});m(()=>u(e,d,I))});let L=r(`h2`,d);i(d,L),s(L,`id`,`diff-api`),i(L,o(`API`));let H=r(`p`,d);i(d,H),i(H,o(`Diff 现在同时支持快捷模式和组合式模式，下面按根组件和子组件拆开列出。`));let U=e(`rue:component:anchor`);i(d,U),c(()=>{let e=p(B,{rows:ne});m(()=>u(e,d,U))});let W=r(`div`,d);i(d,W),n(W,`not-prose mt-6`);let G=e(`rue:component:anchor`);i(d,G),c(()=>{let e=p(B,{rows:V});m(()=>u(e,d,G))});let K=r(`div`,d);i(d,K),n(K,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4 text-sm`);let q=r(`div`,K);i(K,q),n(q,`font-semibold`),i(q,o(`模式选择建议`));let J=r(`div`,K);i(K,J),n(J,`mt-2 grid gap-2 md:grid-cols-2`);let Y=r(`div`,J);i(J,Y);let re=r(`code`,Y);i(Y,re),i(re,o(`item1 / item2`)),i(Y,o(`适合快速搭 demo、做受控联动、补标签和默认手柄内容。`));let X=r(`div`,J);i(J,X);let ie=r(`code`,X);i(X,ie),i(ie,o(`children + Diff.Item1 / Item2 / Resizer`));let ae=h(X);i(X,ae),a(ae,` `),i(X,o(`适合保留旧结构，或自己完全掌控内部布局。`));let oe=r(`h2`,d);i(d,oe),i(oe,o(`FAQ`));let se=r(`h3`,d);i(d,se),i(se,o(`快捷模式和组合式模式怎么选？`));let Z=r(`p`,d);i(d,Z),i(Z,o(`如果你只是想比较两个内容块，优先用`));let ce=r(`code`,Z);i(Z,ce),i(ce,o(`item1`)),i(Z,o(`和`));let le=r(`code`,Z);i(Z,le),i(le,o(`item2`)),i(Z,o(`。如果你已经有现成结构， 或者需要完全接管内部节点顺序，就继续用旧的组合式写法。`));let ue=r(`h3`,d);i(d,ue),i(ue,o(`value 和 defaultValue 有什么区别？`));let Q=r(`p`,d);i(d,Q);let de=r(`code`,Q);i(Q,de),i(de,o(`value`)),i(Q,o(`是受控值，外部状态说了算；`));let fe=r(`code`,Q);i(Q,fe),i(fe,o(`defaultValue`));let pe=h(Q);i(Q,pe),a(pe,` `),i(Q,o(`只决定初始位置，之后由组件内部维护。`));let me=r(`h3`,d);i(d,me),i(me,o(`传了 children 之后 value 还会生效吗？`));let $=r(`p`,d);i(d,$),i($,o(`当前版本里，`));let he=r(`code`,$);i($,he),i(he,o(`children`)),i($,o(`会切换到组合式模式，因此`));let ge=r(`code`,$);i($,ge),i(ge,o(`value`)),i($,o(`、`));let _e=r(`code`,$);i($,_e),i(_e,o(`defaultValue`)),i($,o(`这些快捷模式能力不会接管内部布局。需要受控拖动时，优先使用`));let ve=r(`code`,$);i($,ve),i(ve,o(`item1`)),i($,o(`/`));let ye=h($);i($,ye),a(ye,` `);let be=r(`code`,$);return i($,be),i(be,o(`item2`)),i($,o(`。`)),l})}),f,g),f})};export{H as default};