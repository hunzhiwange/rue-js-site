import{Kt as e,L as t,Q as n,Vt as r,Xt as i,Z as a,_t as o,an as s,at as c,bt as l,dt as u,f as d,ft as f,i as p,it as m,l as h,n as g,nt as _,o as v,on as y,pt as b,r as x,rt as S,t as C,tn as w,tt as T,u as E,vt as D,wt as O,yt as k}from"./vapor-runtime-x7F5M-49.js";import{a as A,n as ee,t as j}from"./vapor-helpers-vapor-D1LP4JjK.js";import{o as te,s as ne}from"./persistentSidebarPlayground-Cl_JMYk5.js";import{n as M,r as re,t as N}from"./custom-elements-DPWAZOXg.js";import{t as ie}from"./Code-C5NjdoiC.js";import{r as P}from"./SidebarPlaygroundExample-DpItFif-.js";var ae=A(`ref:1:0`,()=>i(0)),oe=A(`ref:1:1`,()=>i(0)),F=A(`ref:1:2`,()=>i(0)),se=A(`ref:1:3`,()=>i(0)),I=0,L=0,R=new WeakMap,ce=new WeakMap,le=`rue-demo-nonce`,ue=`rue-shadow-console`,de=`rue-light-signal`,fe=E(`provider:missing`),pe=[`
    :host {
      display: block;
      color: #e5eef3;
  ...
  `],z=e=>{try{return JSON.stringify(e,null,2)}catch{return String(e)}},B=e=>e.split(`,`).map(e=>e.trim()).filter(Boolean),he=e=>e&&typeof e==`object`?e:void 0,V=e=>he(e.config)?.compact===!0,ge=e=>{let t=he(e.config)?.preset;return typeof t==`string`?t:`manual`},_e=e=>e?R.get(e)||(I+=1,F.value+=1,R.set(e,I),I):0,ve=e=>e?ce.get(e)||(L+=1,se.value+=1,ce.set(e,L),L):0,H=e=>Number(he(e.metrics)?.events??0),U=e=>Number(he(e.metrics)?.tags??0),W=e=>e,G=()=>{let{host:e,shadowRoot:t,mountId:i}=A(`useSetup:0:0`,()=>y(()=>{let e=M();return{host:e,shadowRoot:re(),mountId:ve(e)}}));return h(a=>{let o=S(`p`,a);b(o,`lightMeta`),n(o,m(`实例 #`));let s=T(`rue:slot:anchor`);n(o,s),r(()=>{let e=i;w(()=>v(e,o,s))}),n(o,m(` · `));let c=T(`rue:slot:anchor`);n(o,c),r(()=>{let t=e?.tagName.toLowerCase()??`unknown-host`;w(()=>v(t,o,c))}),n(o,m(` ·`));let l=T(`rue:slot:anchor`);n(o,l),r(()=>{w(()=>v(` `,o,l))}),n(o,m(` `));let u=T(`rue:slot:anchor`);return n(o,u),r(()=>{let e=t?`shadow-root`:`light-dom`;w(()=>v(e,o,u))}),o})},ye=e=>{let{host:i,shadowRoot:o,bridgeChannel:s,emit:f,mountId:p,count:g,accent:x,panelTitle:E,tags:k,busy:j,meterWidth:te}=A(`useSetup:0:0:dup1`,()=>y(()=>{let n=M(),r=re(),i=d(fe),a=A(`computed:1:4`,()=>O(()=>t(e))),o=_e(n),s=A(`computed:1:5`,()=>O(()=>Number(e.count??0))),c=s;return{host:n,shadowRoot:r,bridgeChannel:i,emit:a,mountId:o,count:s,accent:A(`computed:1:6`,()=>O(()=>String(e.accent??`teal`))),panelTitle:A(`computed:1:7`,()=>O(()=>String(e.panelTitle??`Shadow console`))),tags:A(`computed:1:8`,()=>O(()=>Array.isArray(e.tags)?e.tags:[])),busy:A(`computed:1:9`,()=>O(()=>e.busy===!0)),meterWidth:A(`computed:1:10`,()=>O(()=>`${Math.max(8,Math.min(c.get()*9,100))}%`))}}));return h(t=>{let d=S(`article`,t);r(()=>{b(d,`frame ${V(e)?`compact`:``}`)}),r(()=>{u(d,`data-accent`,String(x.get()))}),r(()=>{u(d,`data-busy`,String(j.get()?`yes`:`no`))});let y=S(`header`,d);n(d,y),b(y,`hero`);let O=S(`div`,y);n(y,O);let A=S(`p`,O);n(O,A),b(A,`eyebrow`),n(A,m(`Shadow Root / Slot / CustomEvent`));let M=S(`h2`,O);n(O,M),b(M,`title`);let re=T(`rue:slot:anchor`);n(M,re),r(()=>{let e=E.get();w(()=>v(e,M,re))});let N=S(`p`,O);n(O,N),b(N,`subtitle`),n(N,m(`实例 #`));let ie=T(`rue:slot:anchor`);n(N,ie),r(()=>{let e=p;w(()=>v(e,N,ie))}),n(N,m(` · `));let P=c(N);n(N,P),r(()=>{l(P,i?.tagName.toLowerCase()??`unknown-host`)}),n(N,m(` ·`));let ae=c(N);n(N,ae),l(ae,` `),n(N,m(` `));let oe=c(N);n(N,oe),r(()=>{l(oe,o?`shadow-root 已开启`:`light-dom`)});let F=S(`div`,y);n(y,F),b(F,`actions`);let se=S(`button`,F);n(F,se),u(se,`type`,`button`),b(se,`button primary`),a(se,`click`,()=>{f.get()(`save`,{mountId:p,panelTitle:E.get(),count:g.get(),tags:k.get(),busy:j.get()},{host:i?.tagName.toLowerCase()??`unknown`,rootMode:o?`shadow`:`light`})}),n(se,m(`派发 save`));let I=S(`button`,F);n(F,I),u(I,`type`,`button`),b(I,`button`),a(I,`click`,()=>{f.get()(`pulse`,g.get()+1,x.get())}),n(I,m(`派发 pulse`));let L=S(`div`,d);n(d,L),b(L,`grid`);let R=S(`section`,L);n(L,R),b(R,`panel`);let ce=S(`div`,R);n(R,ce),b(ce,`metricValue`);let le=T(`rue:slot:anchor`);n(ce,le),r(()=>{let e=g.get();w(()=>v(e,ce,le))});let ue=S(`div`,R);n(R,ue),b(ue,`metricLabel`),n(ue,m(`这个数值来自宿主上的 el.props.count`));let de=S(`div`,R);n(R,de),b(de,`meter`);let fe=S(`div`,de);n(de,fe),b(fe,`meterFill`),r(()=>{D(fe,{width:te.get()})});let pe=S(`div`,R);n(R,pe),b(pe,`chips`);let me=T(`rue:slot:anchor`);n(pe,me),r(()=>{let e=k.get().length?h(()=>{let e=_(),t=T(`rue:list:start`),i=T(`rue:list:end`);n(e,t),n(e,i);let a=new Map;return r(()=>{a=ee({items:k.get()||[],getKey:(e,t)=>e,elements:a,parent:t.parentNode,before:i,singleRoot:!0,trackIndex:!1,start:t,renderItem:(e,t,i,a,o)=>{v(h(()=>{let t=_(),i=S(`span`,t);n(t,i),r(()=>{u(i,`key`,String(e))}),b(i,`chip`);let a=c(i);return n(i,a),r(()=>{l(a,e)}),t}),t,i)}})}),e}):h(()=>{let e=_(),t=S(`span`,e);return n(e,t),b(t,`chip muted`),n(t,m(`暂无 tags`)),e});w(()=>v(e,pe,me))});let z=S(`section`,L);n(L,z),b(z,`panel`);let B=S(`p`,z);n(z,B),b(B,`slotTitle`),n(B,m(`命名 Slot`));let he=S(`slot`,z);n(z,he),u(he,`name`,`meta`);let _e=S(`div`,z);n(z,_e),D(_e,{height:`12px`});let ve=S(`p`,z);n(z,ve),b(ve,`slotTitle`),n(ve,m(`默认 Slot`)),n(z,S(`slot`,z));let H=S(`section`,L);n(L,H),b(H,`panel`);let U=S(`p`,H);n(H,U),b(U,`slotTitle`),n(U,m(`Rue scoped slot / Context`));let W=S(`div`,H);n(H,W),b(W,`bridgeBox`);let G=S(`div`,W);n(W,G),b(G,`bridgeContext`),u(G,`data-testid`,`ce-context`),n(G,m(`Context: `));let ye=T(`rue:slot:anchor`);n(G,ye),r(()=>{let e=s;w(()=>v(e,G,ye))});let K=T(`rue:component:anchor`);n(W,K);let be=h(()=>{let e=_(),t=S(`span`,e);return n(e,t),u(t,`data-testid`,`ce-scoped-fallback`),n(t,m(`等待外层 scoped slot`)),e});r(()=>{let t=C(ne,{source:e,name:`badge`,props:{channel:s,count:g.get(),accent:x.get()},children:be});w(()=>v(t,W,K))});let q=S(`footer`,d);n(d,q),b(q,`footer`);let xe=S(`span`,q);n(q,xe),n(xe,m(`preset: `));let Se=T(`rue:slot:anchor`);n(xe,Se),r(()=>{let t=ge(e);w(()=>v(t,xe,Se))});let Ce=S(`span`,q);n(q,Ce);let we=c(Ce);n(Ce,we),r(()=>{l(we,j.get()?`后台同步中`:`空闲`)});let Te=S(`span`,q);n(q,Te);let Ee=c(Te);return n(Te,Ee),r(()=>{l(Ee,V(e)?`compact on`:`compact off`)}),d})},K=e=>{let{emit:i,label:o,tone:s}=A(`useSetup:0:0:dup2`,()=>y(()=>({emit:A(`computed:1:11`,()=>O(()=>t(e))),label:A(`computed:1:12`,()=>O(()=>String(e.label??`Light DOM signal`))),tone:A(`computed:1:13`,()=>O(()=>String(e.tone??`teal`)))})));return h(t=>{let c=S(`div`,t);r(()=>{b(c,`lightShell tone-${s.get()}`)});let l=S(`div`,c);n(c,l);let d=S(`p`,l);n(l,d),b(d,`lightTitle`);let f=T(`rue:slot:anchor`);n(d,f),r(()=>{let e=o.get();w(()=>v(e,d,f))});let p=T(`rue:component:anchor`);n(l,p),v(C(G,{}),l,p);let h=S(`div`,c);n(c,h),b(h,`lightValue`);let g=T(`rue:slot:anchor`);n(h,g),r(()=>{let t=H(e);w(()=>v(t,h,g))}),n(h,m(` events / `));let _=T(`rue:slot:anchor`);n(h,_),r(()=>{let t=U(e);w(()=>v(t,h,_))}),n(h,m(` tags`));let y=S(`button`,c);return n(c,y),u(y,`type`,`button`),b(y,`lightButton`),a(y,`click`,()=>{i.get()(`light-tap`,{label:o.get(),events:H(e),tags:U(e)})}),n(y,m(`emit`)),c})},be=N(ye,{styles:pe,nonce:le,configureApp(){ae.value+=1}}),q=N(K,{shadowRoot:!1,styles:me,configureApp(){oe.value+=1}}),xe=(e,t)=>{typeof customElements>`u`||customElements.get(e)||customElements.define(e,t)};xe(ue,be),xe(de,q);var Se=String.raw`import {
  createContext,
  Slot,
  Template,
  type FC,
