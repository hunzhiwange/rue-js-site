...
<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});l(()=>f(e,d,ce))});let le=e(`rue:component:anchor`);i(d,le),h(()=>{let e=m(j,{title:`推荐：复合子组件写法`,summary:`当某一列需要自己控制内容结构时，可以直接组合 Footer.Brand、Footer.Section、Footer.Link。`,tab:v,preview:()=>y(A,{className:`p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal`,children:[y(A.Brand,{children:[b(M,{}),y(`p`,{className:`text-sm mt-3 mb-3`,children:[`Rue Design System`,b(`br`,{}),`Ship consistent experiences.`]})]}),y(A.Section,{title:`Product`,children:[b(A.Link,{children:`Overview`}),b(A.Link,{children:`Pricing`}),b(A.Link,{children:`Changelog`})]}),b(A.Section,{title:`Community`,content:b(`div`,{className:`grid grid-flow-col gap-4`,children:N.map(({key:e,Icon:t})=>b(`button`,{type:`button`,"aria-label":e,children:b(t,{})},e))})})]}),code:`<Footer className="p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal">
  ...
  />
</Footer>`});l(()=>f(e,d,le))});let ue=e(`rue:component:anchor`);i(d,ue),h(()=>{let e=m(j,{title:`Footer（默认纵向，sm 起横向）`,summary:`原始基础 demo 继续保留，这里改用 sections 表达同一个场景。`,tab:S,preview:()=>b(A,{className:`p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal`,sections:B}),code:`<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});l(()=>f(e,d,ue))});let de=e(`rue:component:anchor`);i(d,de),h(()=>{let e=m(j,{title:`Footer with a logo section`,summary:`保留品牌区场景；推荐用 brand + sections，把品牌说明和导航列拆开。`,tab:C,preview:()=>b(A,{className:`p-10 bg-base-200 text-base-content rounded sm:footer-horizontal`,brand:y(`div`,{children:[b(M,{}),y(`p`,{className:`text-sm mt-3 mb-3`,children:[`ACME Industries Ltd.`,b(`br`,{}),`Providing reliable tech since 1992`]})]}),sections:B}),code:`<Footer
...
</Footer>`});l(()=>f(e,d,me))});let he=e(`rue:component:anchor`);i(d,he),h(()=>{let e=m(j,{title:`Links and social icons (two rows)`,summary:`保留两行链接矩阵；用 sections 组合数据，继续交给 className 控制布局。`,tab:D,preview:()=>b(A,{className:`p-10 bg-neutral text-neutral-content rounded sm:grid-rows-2 sm:footer-horizontal`,sections:re}),code:`<Footer
...
</div>`});l(()=>f(e,d,ve))});let U=r(`h2`,d);i(d,U),s(U,`id`,`footer-api`),i(U,o(`API`));let ye=r(`p`,d);i(d,ye),i(ye,o(`当前页展示的是增强后的 Footer API，旧的 children 写法仍然可用。`));let be=r(`h3`,d);i(d,be),i(be,o(`Footer`));let xe=e(`rue:component:anchor`);i(d,xe),h(()=>{let e=m(ne,{rows:ie});l(()=>f(e,d,xe))});let W=r(`h3`,d);i(d,W),n(W,`mt-8`),i(W,o(`Footer.Section`));let Se=e(`rue:component:anchor`);i(d,Se),h(()=>{let e=m(ne,{rows:ae});l(()=>f(e,d,Se))});let G=r(`div`,d);i(d,G),n(G,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let Ce=r(`h3`,G);i(G,Ce),n(Ce,`mt-0 mb-3 text-base font-semibold`),i(Ce,o(`复合子组件`));let K=r(`div`,G);i(G,K),n(K,`grid gap-2 text-sm md:grid-cols-2`);let q=r(`div`,K);i(K,q);let we=r(`code`,q);i(q,we),i(we,o(`Footer.Brand`)),i(q,o(`：品牌或版权信息容器，默认渲染`));let Te=r(`code`,q);i(q,Te),i(Te,o(`aside`));let J=r(`div`,K);i(K,J);let Ee=r(`code`,J);i(J,Ee),i(Ee,o(`Footer.Title`)),i(J,o(`：带`));let De=r(`code`,J);i(J,De),i(De,o(`footer-title`)),i(J,o(`类名的标题节点`));let Y=r(`div`,K);i(K,Y);let Oe=r(`code`,Y);i(Y,Oe),i(Oe,o(`Footer.Link`)),i(Y,o(`：默认输出带`));let ke=r(`code`,Y);i(Y,ke),i(ke,o(`link link-hover`)),i(Y,o(`的文本链接`));let X=r(`div`,K);i(K,X);let Ae=r(`code`,X);i(X,Ae),i(Ae,o(`Footer.Section`)),i(X,o(`：单列容器，支持`));let je=r(`code`,X);i(X,je),i(je,o(`title`)),i(X,o(`、`));let Me=r(`code`,X);i(X,Me),i(Me,o(`items`)),i(X,o(`、`));let Ne=r(`code`,X);i(X,Ne),i(Ne,o(`content`));let Pe=r(`h2`,d);i(d,Pe),i(Pe,o(`FAQ`));let Fe=r(`h3`,d);i(d,Fe),i(Fe,o(`什么时候用 sections，什么时候继续写 children？`));let Z=r(`p`,d);i(d,Z),i(Z,o(`列结构比较规则时，优先用`));let Ie=r(`code`,Z);i(Z,Ie),i(Ie,o(`sections`)),i(Z,o(`，维护成本更低；如果某一列需要完全自定义布局，或者你已经有现成的`));let Le=r(`code`,Z);i(Z,Le),i(Le,o(`nav`)),i(Z,o(`/`));let Re=r(`code`,Z);i(Z,Re),i(Re,o(`aside`)),i(Z,o(`模板，也可以继续直接写`));let ze=r(`code`,Z);i(Z,ze),i(ze,o(`children`)),i(Z,o(`。`));let Be=r(`h3`,d);i(d,Be),i(Be,o(`社交图标和订阅表单怎么放进去？`));let Q=r(`p`,d);i(d,Q),i(Q,o(`这类内容更适合放到`));let Ve=r(`code`,Q);i(Q,Ve),i(Ve,o(`Footer.Section`)),i(Q,o(`的`));let He=r(`code`,Q);i(Q,He),i(He,o(`content`));let Ue=g(Q);i(Q,Ue),a(Ue,` `),i(Q,o(`里；如果只是普通文本链接，再用`));let We=r(`code`,Q);i(Q,We),i(We,o(`items`)),i(Q,o(`会更省代码。`));let Ge=r(`h3`,d);i(d,Ge),i(Ge,o(`direction 和 center 还需要保留吗？`));let $=r(`p`,d);i(d,$),i($,o(`需要。它们仍然是最轻量的布局开关，适合和现有的`));let Ke=r(`code`,$);i($,Ke),i(Ke,o(`sm:footer-horizontal`)),i($,o(`、`));let qe=r(`code`,$);return i($,qe),i(qe,o(`footer-center`)),i($,o(`类名习惯一起工作，不会破坏旧页面的视觉结果。`)),c})}),p,_),p})};export{V as default};