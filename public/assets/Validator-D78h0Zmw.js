import{F as e,I as t,K as n,L as r,M as i,N as a,R as o,W as s,d as c,dt as l,ht as u,l as d,st as f,t as p,vt as m}from"./vapor-runtime-BuwLbCGk.js";import{a as h,n as g}from"./vapor-helpers-vapor-Bly5xJie.js";import{n as _,t as v}from"./src-BQwLQD8R.js";import{n as y}from"./SidebarPlaygroundDesign-SQXYHI-q.js";import{t as b}from"./Code-DQxnq0in.js";import{t as x}from"./button-BlewusST.js";import{t as S}from"./tabs-DqfJzZfa.js";var C=[`input`,`select`,`textarea`,`checkbox`,`toggle`],w=(...e)=>e.filter(Boolean).join(` `),T=e=>new Set((e??``).split(/\s+/).map(e=>e.trim()).filter(Boolean)),E=e=>{let t=T(e);return C.find(e=>t.has(e))},D=(e,t,n)=>{if(t)return t;let r=E(n);if(r)return r;if(e===`select`)return`select`;if(e===`textarea`)return`textarea`},O=(e,t)=>e||(t===`select`?`select`:t===`textarea`?`textarea`:`input`),k=(e,t,n,r)=>{let i=T(r);return w(`validator`,e&&!i.has(e)?e:void 0,e&&t&&!i.has(`${e}-${t}`)?`${e}-${t}`:void 0,e&&n&&!i.has(`${e}-${n}`)?`${e}-${n}`:void 0,r)},A=e=>Array.isArray(e)?e.map((e,t)=>v(`span`,{className:`block`,children:e},`validator-line-${t}`)):e,j=({as:e,appearance:t,size:n,status:r,className:i,children:a,...o})=>{let s=D(e,t,i),c=O(e,s),l=k(s,n,r,i);return c===`select`?v(`select`,{...o,className:l,children:a}):c===`textarea`?v(`textarea`,{...o,className:l,children:a}):v(`input`,{...o,className:l})},M=({as:e=`p`,className:t,children:n,hideUntilInvalid:r,lines:i,...a})=>v(e,{...a,className:w(`validator-hint`,r?`hidden`:void 0,t),children:i?.length?A(i):n}),N=(e,t)=>w(e===`fieldset`?`fieldset gap-2`:`grid gap-2`,t),P=Object.assign(j,{Hint:M,Field:({fieldAs:e=`fieldset`,className:t,controlClassName:n,label:r,labelClassName:i,hint:a,hintAs:o=`p`,hintClassName:s,hideHintWhenValid:c,extra:l,extraClassName:u,requiredMark:d,id:f,children:p,...m})=>{let h=e,g=typeof f==`string`&&f.trim()?f:void 0,y=g&&a!=null&&m[`aria-describedby`]==null?`${g}-hint`:void 0,b=m[`aria-describedby`]??y,x=d??m.required===!0;return _(h,{className:N(e,t),children:[r==null?null:_(`label`,{className:w(`label`,i),for:g,children:[v(`span`,{children:r}),x?v(`span`,{className:`text-error`,"aria-hidden":`true`,children:`*`}):null]}),v(j,{...m,id:g,"aria-describedby":b,className:n,children:p}),a==null?null:v(M,{id:y,as:o,className:s,hideUntilInvalid:c,children:A(a)}),l==null?null:v(`p`,{className:w(`label text-xs opacity-70`,u),children:A(l)})]})}}),F=i=>c(s=>{let u=r(`div`,s);n(u,`component-preview not-prose text-base-content my-6 lg:my-12`);let f=r(`div`,u);a(u,f),n(f,`flex flex-wrap items-start justify-between gap-3`);let h=r(`div`,f);a(f,h);let g=r(`h2`,h);a(h,g),n(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),a(g,o(`# `));let _=e(`rue:slot:anchor`);a(g,_),m(()=>{let e=i.title;l(()=>d(e,g,_))});let v=e(`rue:slot:anchor`);a(h,v),m(()=>{let o=i.summary?c(()=>{let o=t(),s=r(`p`,o);a(o,s),n(s,`m-0 text-sm opacity-70`);let c=e(`rue:slot:anchor`);return a(s,c),m(()=>{let e=i.summary;l(()=>d(e,s,c))}),o}):``;l(()=>d(o,h,v))});let y=e(`rue:component:anchor`);a(u,y),m(()=>{let e=p(S,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:i.tab.value,onChange:e=>i.tab.value=e,className:`mb-3 mt-4`});l(()=>d(e,u,y))});let x=e(`rue:slot:anchor`);return a(u,x),m(()=>{let n=i.tab.value===`preview`?i.preview():c(()=>{let n=t(),r=e(`rue:component:anchor`);return a(n,r),m(()=>{let e=p(b,{className:`mt-2`,lang:`tsx`,code:i.code});l(()=>d(e,n,r))}),n});l(()=>d(n,u,x))}),u}),I=i=>c(u=>{let f=r(`div`,u);n(f,`not-prose my-6 lg:my-8`);let p=r(`h3`,f);a(f,p),n(p,`mt-0 mb-3 text-base font-semibold text-base-content`);let h=e(`rue:slot:anchor`);a(p,h),m(()=>{let e=i.title;l(()=>d(e,p,h))});let _=r(`div`,f);a(f,_),n(_,`overflow-x-auto rounded-box border border-base-300 bg-base-100`);let v=r(`table`,_);a(_,v),n(v,`table table-zebra`);let y=r(`thead`,v);a(v,y);let b=r(`tr`,y);a(y,b);let x=r(`th`,b);a(b,x),a(x,o(`属性`));let S=r(`th`,b);a(b,S),a(S,o(`说明`));let C=r(`th`,b);a(b,C),a(C,o(`类型`));let w=r(`th`,b);a(b,w),a(w,o(`默认值`));let T=r(`tbody`,v);a(v,T);let E=e(`rue:list:start`),D=e(`rue:list:end`);a(T,E),a(T,D);let O=new Map;return m(()=>{O=g({items:i.rows||[],getKey:(e,t)=>e.prop,elements:O,parent:T,before:D,singleRoot:!0,trackIndex:!1,start:E,renderItem:(n,i,o,u,f)=>{d(c(()=>{let i=t(),o=r(`tr`,i);a(i,o),m(()=>{s(o,`key`,String(n.prop))});let c=r(`td`,o);a(o,c);let u=r(`code`,c);a(c,u);let f=e(`rue:slot:anchor`);a(u,f),m(()=>{let e=n.prop;l(()=>d(e,u,f))});let p=r(`td`,o);a(o,p);let h=e(`rue:slot:anchor`);a(p,h),m(()=>{let e=n.description;l(()=>d(e,p,h))});let g=r(`td`,o);a(o,g);let _=r(`code`,g);a(g,_);let v=e(`rue:slot:anchor`);a(_,v),m(()=>{let e=n.type;l(()=>d(e,_,v))});let y=r(`td`,o);a(o,y);let b=r(`code`,y);a(y,b);let x=e(`rue:slot:anchor`);return a(b,x),m(()=>{let e=n.defaultValue;l(()=>d(e,b,x))}),i}),i,o)}})}),f}),L=(e,t)=>{let n=e.currentTarget;n&&(t.value=!n.checkValidity())},R=(e,t)=>{t.value=!0},z=e=>{e.preventDefault()},ee=()=>{let{invalid:t}=h(`useSetup:0:0`,()=>u(()=>({invalid:h(`ref:1:0`,()=>f(!1))})));return c(o=>{let s=r(`form`,o);n(s,`grid gap-2`),i(s,`submit`,z);let c=e(`rue:component:anchor`);a(s,c),m(()=>{let e=p(P,{appearance:`input`,type:`password`,required:!0,minLength:8,pattern:`(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}`,title:`Must include number, lowercase and uppercase letters`,placeholder:`Password`,"aria-invalid":t.value?`true`:`false`,onInvalid:e=>R(e,t),onInput:e=>L(e,t),onBlur:e=>L(e,t)});l(()=>d(e,s,c))});let u=e(`rue:component:anchor`);a(s,u),m(()=>{let e=p(P.Hint,{hideUntilInvalid:!0,lines:[`Must be at least 8 characters`,`Must include number, lowercase and uppercase letters`]});l(()=>d(e,s,u))});let f=e(`rue:component:anchor`);return a(s,f),d(p(x,{htmlType:`submit`,size:`sm`,className:`w-fit`,children:`Check password`}),s,f),s})},te=()=>{let{invalid:t}=h(`useSetup:0:0:dup1`,()=>u(()=>({invalid:h(`ref:1:1`,()=>f(!1))})));return c(o=>{let s=r(`form`,o);n(s,`grid gap-2`),i(s,`submit`,z);let c=e(`rue:component:anchor`);a(s,c),m(()=>{let e=p(P,{appearance:`input`,type:`text`,required:!0,minLength:3,maxLength:30,pattern:`[A-Za-z0-9-]+`,title:`Only letters, numbers or dash`,placeholder:`Username`,"aria-invalid":t.value?`true`:`false`,onInvalid:e=>R(e,t),onInput:e=>L(e,t),onBlur:e=>L(e,t)});l(()=>d(e,s,c))});let u=e(`rue:component:anchor`);a(s,u),m(()=>{let e=p(P.Hint,{hideUntilInvalid:!0,lines:[`Must be 3 to 30 characters`,`Only letters, numbers or dash`]});l(()=>d(e,s,u))});let f=e(`rue:component:anchor`);return a(s,f),d(p(x,{htmlType:`submit`,size:`sm`,className:`w-fit`,children:`Check username`}),s,f),s})},ne=[{prop:`appearance`,description:`自动补齐 input、select、textarea、checkbox、toggle 这些宿主类名`,type:`'input' | 'select' | 'textarea' | 'checkbox' | 'toggle'`,defaultValue:`-`},{prop:`as`,description:`指定渲染标签，select 和 textarea 会自动推断对应外观`,type:`'input' | 'select' | 'textarea'`,defaultValue:`'input'`},{prop:`className`,description:`追加自定义类名，旧写法仍可继续手动传入 input / select / textarea`,type:`string`,defaultValue:`-`},{prop:`size`,description:`按宿主类型拼接尺寸类，例如 input-lg、checkbox-sm`,type:`'xs' | 'sm' | 'md' | 'lg' | 'xl'`,defaultValue:`-`},{prop:`status`,description:`手动追加状态类，适合服务端校验或异步反馈场景`,type:`'error' | 'success' | 'warning'`,defaultValue:`-`}],re=[{prop:`as`,description:`指定 hint 标签`,type:`'div' | 'p' | 'span'`,defaultValue:`'p'`},{prop:`className`,description:`追加 hint 的自定义类名`,type:`string`,defaultValue:`-`},{prop:`hideUntilInvalid`,description:`自动追加 hidden 类，让 hint 在无效前不占布局空间`,type:`boolean`,defaultValue:`false`},{prop:`lines`,description:`按多行规则渲染 hint 内容，每一项会单独包成一行`,type:`any[]`,defaultValue:`-`}],ie=[{prop:`className`,description:`Field 外层容器类名`,type:`string`,defaultValue:`-`},{prop:`controlClassName`,description:`内部 Validator 控件的类名`,type:`string`,defaultValue:`-`},{prop:`extra`,description:`底部补充说明，会以 label 风格文本渲染`,type:`any`,defaultValue:`-`},{prop:`extraClassName`,description:`extra 区域的类名`,type:`string`,defaultValue:`-`},{prop:`fieldAs`,description:`外层容器标签，默认是 fieldset，也可切到 div`,type:`'fieldset' | 'div'`,defaultValue:`'fieldset'`},{prop:`hint`,description:`快捷生成 Validator.Hint`,type:`any`,defaultValue:`-`},{prop:`hintAs`,description:`快捷生成的 hint 标签`,type:`'div' | 'p' | 'span'`,defaultValue:`'p'`},{prop:`hintClassName`,description:`快捷生成的 hint 类名`,type:`string`,defaultValue:`-`},{prop:`hideHintWhenValid`,description:`等价于给快捷 hint 开启 hideUntilInvalid`,type:`boolean`,defaultValue:`false`},{prop:`label`,description:`快捷生成字段标题，并在传入 id 时自动关联到控件`,type:`any`,defaultValue:`-`},{prop:`labelClassName`,description:`字段标题类名`,type:`string`,defaultValue:`-`},{prop:`requiredMark`,description:`强制展示必填星号，未设置时会跟随 required`,type:`boolean`,defaultValue:`根据 required 推断`}],B=()=>{let{tabBasic:i,tabHosts:g,tabRules:b,tabStatus:S,tabField:C,tabForm:w}=h(`useSetup:0:0:dup2`,()=>u(()=>({tabBasic:h(`ref:1:2`,()=>f(`preview`)),tabHosts:h(`ref:1:3`,()=>f(`preview`)),tabRules:h(`ref:1:4`,()=>f(`preview`)),tabStatus:h(`ref:1:5`,()=>f(`preview`)),tabField:h(`ref:1:6`,()=>f(`preview`)),tabForm:h(`ref:1:7`,()=>f(`preview`))})));return c(u=>{let f=t(),h=e(`rue:component:anchor`);return a(f,h),d(p(y,{children:c(()=>{let c=t(),u=r(`div`,c);a(c,u),n(u,`max-w-none prose prose-sm md:prose-base`);let f=r(`h1`,u);a(u,f),a(f,o(`Validator 校验辅助`));let h=r(`p`,u);a(u,h),n(h,`text-sm mt-3 mb-3`),a(h,o(`Validator 仍然只负责把浏览器原生校验结果映射成 Rue 当前的表单视觉，不引入额外校验引擎。原有的`));let y=r(`code`,h);a(h,y),a(y,o(`className="input validator"`)),a(h,o(`写法继续可用，但现在也可以直接通过`));let T=r(`code`,h);a(h,T),a(T,o(`appearance`)),a(h,o(`、`));let E=r(`code`,h);a(h,E),a(E,o(`size`)),a(h,o(`、`));let D=r(`code`,h);a(h,D),a(D,o(`status`)),a(h,o(`和`));let O=r(`code`,h);a(h,O),a(O,o(`Field`)),a(h,o(`组合件来组织更完整的表单场景。`));let k=r(`div`,u);a(u,k),n(k,`not-prose grid gap-3 rounded-box border border-base-300 bg-base-200/70 p-4 text-sm sm:grid-cols-3`);let A=r(`div`,k);a(k,A);let j=r(`div`,A);a(A,j),n(j,`font-medium text-base-content`),a(j,o(`原生校验优先`));let M=r(`div`,A);a(A,M),n(M,`mt-1 opacity-70`),a(M,o(`继续依赖 required、pattern、minLength 等原生约束。`));let N=r(`div`,k);a(k,N);let L=r(`div`,N);a(N,L),n(L,`font-medium text-base-content`),a(L,o(`语义外观补齐`));let R=r(`div`,N);a(N,R),n(R,`mt-1 opacity-70`),a(R,o(`用 appearance 直接映射 input、select、toggle 等宿主风格。`));let z=r(`div`,k);a(k,z);let B=r(`div`,z);a(z,B),n(B,`font-medium text-base-content`),a(B,o(`表单结构复用`));let V=r(`div`,z);a(z,V),n(V,`mt-1 opacity-70`),a(V,o(`Field 统一 label、hint、extra 和基础可访问性连线。`));let H=r(`div`,u);a(u,H),n(H,`text-sm mt-3`);let U=r(`a`,H);a(H,U),s(U,`href`,`https://daisyui.com/components/validator/`),s(U,`target`,`_blank`),s(U,`rel`,`noreferrer`),a(U,o(`查看 daisyUI 原始静态样式`));let W=e(`rue:component:anchor`);a(u,W),m(()=>{let e=p(F,{title:`Validator and validator-hint`,summary:`最基础的邮箱校验示例，点击按钮即可触发浏览器原生 required / email 校验和 hint 展示。`,tab:i,preview:()=>_(`form`,{className:`grid w-full max-w-xs gap-2`,children:[v(P,{appearance:`input`,type:`email`,required:!0,placeholder:`mail@site.com`}),v(P.Hint,{children:`Enter valid email address`}),v(x,{htmlType:`submit`,size:`sm`,className:`w-fit`,children:`Check email`})]}),code:`<form className="grid w-full max-w-xs gap-2">
...
</form>`});l(()=>d(e,u,Y))});let X=r(`div`,u);a(u,X),n(X,`my-8 lg:my-12`);let Z=r(`h2`,X);a(X,Z),a(Z,o(`API`));let Q=r(`p`,X);a(X,Q),n(Q,`text-sm opacity-80`),a(Q,o(`Validator 本体负责控件本身的宿主类和状态类，Hint 管理提示文案，Field 则把常见表单项的结构和可访问性连线收敛到一处。`));let $=e(`rue:component:anchor`);a(X,$),m(()=>{let e=p(I,{title:`Validator`,rows:ne});l(()=>d(e,X,$))});let ae=e(`rue:component:anchor`);a(X,ae),m(()=>{let e=p(I,{title:`Validator.Hint`,rows:re});l(()=>d(e,X,ae))});let oe=e(`rue:component:anchor`);return a(X,oe),m(()=>{let e=p(I,{title:`Validator.Field`,rows:ie});l(()=>d(e,X,oe))}),c})}),f,h),f})};export{B as default};