...
`,N=()=>s(g=>{let D=t(),re=e(`style`,D);r(D,re),i(()=>{d(re,Se)});let k=e(`div`,D);r(D,k),o(k,`report-data1-scope report-page`);let A=e(`section`,k);r(k,A),o(A,`report-hero report-card`);let N=e(`div`,A);r(A,N),o(N,`report-hero-copy`);let Ce=e(`p`,N);r(N,Ce),o(Ce,`report-kicker`),r(Ce,c(`Data Pulse / March 2026`));let we=e(`h1`,N);r(N,we),r(we,c(`10 日经营数据从静默切换到集中爆发，峰值日几乎决定整段窗口表现。`));let P=e(`p`,N);r(N,P),o(P,`report-hero-text`),r(P,c(`统计区间为 `));let Te=p(P);r(P,Te),i(()=>{d(Te,ve)}),r(P,c(`。窗口总成交额达到 `));let Ee=a(`rue:slot:anchor`);r(P,Ee),i(()=>{let e=j(y);n(()=>u(e,P,Ee))}),r(P,c(`，共形成`));let De=p(P);r(P,De),d(De,` `),r(P,c(` `));let Oe=p(P);r(P,Oe),i(()=>{d(Oe,_.format(v))}),r(P,c(` 笔订单， 其中`));let ke=p(P);r(P,ke),d(ke,` `),r(P,c(` `));let Ae=a(`rue:slot:anchor`);r(P,Ae),i(()=>{let e=_e(w.sumDate);n(()=>u(e,P,Ae))}),r(P,c(` 单日贡献 `));let je=a(`rue:slot:anchor`);r(P,je),i(()=>{let e=he(T);n(()=>u(e,P,je))}),r(P,c(` ，而退货金额维持在 `));let Me=a(`rue:slot:anchor`);r(P,Me),i(()=>{let e=j(b);n(()=>u(e,P,Me))}),r(P,c(`。`));let F=e(`div`,N);r(N,F),o(F,`report-hero-tags`);let Ne=e(`span`,F);r(F,Ne),o(Ne,`report-tag`);let Pe=p(Ne);r(Ne,Pe),i(()=>{d(Pe,S)}),r(Ne,c(` 天静默期`));let Fe=e(`span`,F);r(F,Fe),o(Fe,`report-tag`);let Ie=p(Fe);r(Fe,Ie),i(()=>{d(Ie,x)}),r(Fe,c(` 天有效成交`));let Le=e(`span`,F);r(F,Le),o(Le,`report-tag`),r(Le,c(`客户记录 `));let Re=p(Le);r(Le,Re),i(()=>{d(Re,_.format(te))});let I=e(`div`,A);r(A,I),o(I,`report-hero-board`);let L=e(`div`,I);r(I,L),o(L,`report-board-header`);let ze=e(`span`,L);r(L,ze),o(ze,`report-board-label`),r(ze,c(`峰值日`));let Be=e(`span`,L);r(L,Be),o(Be,`report-board-date`);let Ve=a(`rue:slot:anchor`);r(Be,Ve),i(()=>{let e=_e(w.sumDate);n(()=>u(e,Be,Ve))});let He=e(`div`,I);r(I,He),o(He,`report-board-value`);let Ue=a(`rue:slot:anchor`);r(He,Ue),i(()=>{let e=M(w.allAmount);n(()=>u(e,He,Ue))});let R=e(`p`,I);r(I,R),o(R,`report-board-copy`),r(R,c(`单日完成 `));let We=p(R);r(R,We),i(()=>{d(We,_.format(w.ordersCount))}),r(R,c(` 笔订单，客户均额`));let Ge=p(R);r(R,Ge),d(Ge,` `),r(R,c(` `));let Ke=a(`rue:slot:anchor`);r(R,Ke),i(()=>{let e=M(w.avgClientPrice);n(()=>u(e,R,Ke))}),r(R,c(`。`));let qe=e(`div`,I);r(I,qe),o(qe,`report-sparkline`);let Je=a(`rue:list:start`),Ye=a(`rue:list:end`);r(qe,Je),r(qe,Ye);let Xe=new Map;i(()=>{Xe=m({items:xe||[],getKey:(e,t)=>e.sumDate,elements:Xe,parent:qe,before:Ye,singleRoot:!0,trackIndex:!1,start:Je,renderItem:(c,d,p,m,h)=>{u(s(()=>{let s=t(),d=e(`div`,s);r(s,d),i(()=>{f(d,`key`,String(c.sumDate))}),o(d,`report-spark-item`);let p=e(`span`,d);r(d,p),i(()=>{o(p,String(`report-spark-bar ${c.sumDate===w.sumDate?`is-peak`:``}`))}),i(()=>{l(p,{height:`${Math.max(10,c.amountRatio*100)}%`})});let m=e(`span`,d);r(d,m),o(m,`report-spark-label`);let h=a(`rue:slot:anchor`);return r(m,h),i(()=>{let e=c.label;n(()=>u(e,m,h))}),s}),d,p)}})});let Ze=e(`section`,k);r(k,Ze),o(Ze,`report-kpi-grid`);let Qe=a(`rue:list:start`),$e=a(`rue:list:end`);r(Ze,Qe),r(Ze,$e);let et=new Map;i(()=>{et=m({items:ye||[],getKey:(e,t)=>e.label,elements:et,parent:Ze,before:$e,singleRoot:!0,trackIndex:!1,start:Qe,renderItem:(c,l,m,h,g)=>{u(s(()=>{let s=t(),l=e(`article`,s);r(s,l),i(()=>{f(l,`key`,String(c.label))}),o(l,`report-kpi-card report-card`);let m=e(`p`,l);r(l,m);let h=a(`rue:slot:anchor`);r(m,h),i(()=>{let e=c.label;n(()=>u(e,m,h))});let g=e(`h2`,l);r(l,g);let _=p(g);r(g,_),i(()=>{d(_,c.value)});let v=e(`span`,l);r(l,v);let y=a(`rue:slot:anchor`);return r(v,y),i(()=>{let e=c.detail;n(()=>u(e,v,y))}),s}),l,m)}})});let z=e(`section`,k);r(k,z),o(z,`report-panel-grid report-panel-grid-primary`);let B=e(`article`,z);r(z,B),o(B,`report-card report-chart-card report-chart-wide`);let V=e(`div`,B);r(B,V),o(V,`report-panel-header`);let tt=e(`div`,V);r(V,tt);let nt=e(`p`,tt);r(tt,nt),o(nt,`report-panel-eyebrow`),r(nt,c(`GMV Trend`));let rt=e(`h2`,tt);r(tt,rt),r(rt,c(`成交金额波动`));let it=e(`div`,V);r(V,it),o(it,`report-panel-summary`),r(it,c(`03.24 抬升整段曲线，后续三天维持正向成交尾流。`));let at=e(`div`,B);r(B,at),o(at,`report-chart-shell`);let H=e(`svg`,at);r(at,H),i(()=>{f(H,`viewBox`,String(`0 0 ${ie} ${ae}`))}),o(H,`report-svg-chart`),f(H,`role`,`img`),f(H,`aria-label`,`每日成交金额趋势图`);let ot=e(`defs`,H);r(H,ot);let U=e(`linearGradient`,ot);r(ot,U),f(U,`id`,`reportAreaGradient`),f(U,`x1`,`0`),f(U,`x2`,`0`),f(U,`y1`,`0`),f(U,`y2`,`1`);let st=e(`stop`,U);r(U,st),f(st,`offset`,`0%`),o(st,`report-stop-area-top`);let ct=e(`stop`,U);r(U,ct),f(ct,`offset`,`100%`),o(ct,`report-stop-area-bottom`);let W=e(`linearGradient`,ot);r(ot,W),f(W,`id`,`reportLineGradient`),f(W,`x1`,`0`),f(W,`x2`,`1`),f(W,`y1`,`0`),f(W,`y2`,`0`);let lt=e(`stop`,W);r(W,lt),f(lt,`offset`,`0%`),o(lt,`report-stop-line-start`);let ut=e(`stop`,W);r(W,ut),f(ut,`offset`,`100%`),o(ut,`report-stop-line-end`);let dt=a(`rue:list:start`),ft=a(`rue:list:end`);r(H,dt),r(H,ft);let pt=new Map;i(()=>{pt=m({items:de||[],getKey:(e,t)=>e.step,elements:pt,parent:H,before:ft,singleRoot:!0,trackIndex:!1,start:dt,renderItem:(n,a,c,l,m)=>{u(s(()=>{let a=t(),s=e(`g`,a);r(a,s),i(()=>{f(s,`key`,String(n.step))});let c=e(`line`,s);r(s,c),i(()=>{f(c,`x1`,String(O.left))}),i(()=>{f(c,`y1`,String(n.y))}),i(()=>{f(c,`x2`,String(ie-O.right))}),i(()=>{f(c,`y2`,String(n.y))}),o(c,`report-grid-line`);let l=e(`text`,s);r(s,l),i(()=>{f(l,`x`,String(O.left+6))}),i(()=>{f(l,`y`,String(n.y-8))}),o(l,`report-grid-label`);let u=p(l);return r(l,u),i(()=>{d(u,M(oe*n.step))}),a}),a,c)}})});let mt=e(`path`,H);r(H,mt),i(()=>{f(mt,`d`,String(ue))}),f(mt,`fill`,`url(#reportAreaGradient)`);let ht=e(`path`,H);r(H,ht),i(()=>{f(ht,`d`,String(le))}),o(ht,`report-line-path`),f(ht,`stroke`,`url(#reportLineGradient)`);let gt=a(`rue:list:start`),_t=a(`rue:list:end`);r(H,gt),r(H,_t);let vt=new Map;i(()=>{vt=m({items:ce||[],getKey:(e,t)=>e.row.sumDate,elements:vt,parent:H,before:_t,singleRoot:!0,trackIndex:!1,start:gt,renderItem:(n,a,c,l,m)=>{u(s(()=>{let a=t(),s=e(`g`,a);r(a,s),i(()=>{f(s,`key`,String(n.row.sumDate))});let c=e(`circle`,s);r(s,c),i(()=>{f(c,`cx`,String(n.x))}),i(()=>{f(c,`cy`,String(n.y))}),i(()=>{f(c,`r`,String(n.row.sumDate===w.sumDate?7:4.5))}),o(c,`report-point-outer`);let l=e(`circle`,s);r(s,l),i(()=>{f(l,`cx`,String(n.x))}),i(()=>{f(l,`cy`,String(n.y))}),f(l,`r`,`3.2`),o(l,`report-point-inner`);let u=e(`text`,s);r(s,u),i(()=>{f(u,`x`,String(n.x))}),i(()=>{f(u,`y`,String(ae-12))}),f(u,`text-anchor`,`middle`),o(u,`report-axis-label`);let m=p(u);return r(u,m),i(()=>{d(m,ge(n.row.sumDate))}),a}),a,c)}})});let G=e(`article`,z);r(z,G),o(G,`report-card report-channel-card`);let yt=e(`div`,G);r(G,yt),o(yt,`report-panel-header`);let bt=e(`div`,yt);r(yt,bt);let xt=e(`p`,bt);r(bt,xt),o(xt,`report-panel-eyebrow`),r(xt,c(`Channel Mix`));let St=e(`h2`,bt);r(bt,St),r(St,c(`下单渠道分布`));let K=e(`div`,G);r(G,K),o(K,`report-channel-body`);let q=e(`svg`,K);r(K,q),f(q,`viewBox`,`0 0 160 160`),o(q,`report-donut`),f(q,`role`,`img`),f(q,`aria-label`,`下单渠道占比图`);let Ct=e(`circle`,q);r(q,Ct),f(Ct,`cx`,`80`),f(Ct,`cy`,`80`),i(()=>{f(Ct,`r`,String(fe))}),o(Ct,`report-donut-track`);let J=e(`circle`,q);r(q,J),f(J,`cx`,`80`),f(J,`cy`,`80`),i(()=>{f(J,`r`,String(fe))}),o(J,`report-donut-admin`),i(()=>{f(J,`stroke-dasharray`,String(`${pe}`))}),f(J,`stroke-dashoffset`,`0`);let Y=e(`circle`,q);r(q,Y),f(Y,`cx`,`80`),f(Y,`cy`,`80`),i(()=>{f(Y,`r`,String(fe))}),o(Y,`report-donut-self`),i(()=>{f(Y,`stroke-dasharray`,String(`${pe*ne} ${pe}`))}),i(()=>{f(Y,`stroke-dashoffset`,String(-me))});let X=e(`div`,K);r(K,X),o(X,`report-channel-center`);let wt=e(`strong`,X);r(X,wt);let Tt=a(`rue:slot:anchor`);r(wt,Tt),i(()=>{let e=he(E);n(()=>u(e,wt,Tt))});let Et=e(`span`,X);r(X,Et),r(Et,c(`后台代客`));let Dt=e(`div`,G);r(G,Dt),o(Dt,`report-channel-list`);let Z=e(`div`,Dt);r(Dt,Z),o(Z,`report-channel-item`);let Ot=e(`span`,Z);r(Z,Ot),o(Ot,`report-dot report-dot-admin`);let kt=e(`div`,Z);r(Z,kt);let At=e(`strong`,kt);r(kt,At),r(At,c(`后台代客下单`));let jt=e(`p`,kt);r(kt,jt);let Mt=a(`rue:slot:anchor`);r(jt,Mt),i(()=>{let e=j(ee);n(()=>u(e,jt,Mt))});let Nt=e(`span`,Z);r(Z,Nt);let Pt=a(`rue:slot:anchor`);r(Nt,Pt),i(()=>{let e=he(E);n(()=>u(e,Nt,Pt))});let Q=e(`div`,Dt);r(Dt,Q),o(Q,`report-channel-item`);let Ft=e(`span`,Q);r(Q,Ft),o(Ft,`report-dot report-dot-self`);let It=e(`div`,Q);r(Q,It);let Lt=e(`strong`,It);r(It,Lt),r(Lt,c(`客户自主下单`));let Rt=e(`p`,It);r(It,Rt);let zt=a(`rue:slot:anchor`);r(Rt,zt),i(()=>{let e=j(C);n(()=>u(e,Rt,zt))});let Bt=e(`span`,Q);r(Q,Bt);let Vt=a(`rue:slot:anchor`);r(Bt,Vt),i(()=>{let e=he(ne);n(()=>u(e,Bt,Vt))});let Ht=e(`section`,k);r(k,Ht),o(Ht,`report-panel-grid`);let Ut=e(`article`,Ht);r(Ht,Ut),o(Ut,`report-card report-chart-card`);let Wt=e(`div`,Ut);r(Ut,Wt),o(Wt,`report-panel-header`);let Gt=e(`div`,Wt);r(Wt,Gt);let Kt=e(`p`,Gt);r(Gt,Kt),o(Kt,`report-panel-eyebrow`),r(Kt,c(`Order Volume`));let qt=e(`h2`,Gt);r(Gt,qt),r(qt,c(`每日订单笔数`));let Jt=e(`div`,Wt);r(Wt,Jt),o(Jt,`report-panel-summary`),r(Jt,c(`尾段交易频次持续升高，03.27 以 8 笔达到订单数峰值。`));let Yt=e(`div`,Ut);r(Ut,Yt),o(Yt,`report-bars`);let Xt=a(`rue:list:start`),Zt=a(`rue:list:end`);r(Yt,Xt),r(Yt,Zt);let Qt=new Map;i(()=>{Qt=m({items:h||[],getKey:(e,t)=>e.sumDate,elements:Qt,parent:Yt,before:Zt,singleRoot:!0,trackIndex:!1,start:Xt,renderItem:(c,m,h,g,v)=>{u(s(()=>{let s=t(),m=e(`div`,s);r(s,m),i(()=>{f(m,`key`,String(c.sumDate))}),o(m,`report-bar-group`);let h=e(`div`,m);r(m,h),o(h,`report-bar-shell`);let g=e(`div`,h);r(h,g),i(()=>{o(g,String(`report-bar-fill ${c.sumDate===w.sumDate?`is-accent`:``}`))}),i(()=>{l(g,{height:`${Math.max(8,c.ordersCount/se*100)}%`})});let v=e(`strong`,m);r(m,v);let y=p(v);r(v,y),i(()=>{d(y,_.format(c.ordersCount))});let b=e(`span`,m);r(m,b);let x=a(`rue:slot:anchor`);return r(b,x),i(()=>{let e=ge(c.sumDate);n(()=>u(e,b,x))}),s}),m,h)}})});let $t=e(`article`,Ht);r(Ht,$t),o($t,`report-card report-insight-card`);let en=e(`div`,$t);r($t,en),o(en,`report-panel-header`);let tn=e(`div`,en);r(en,tn);let nn=e(`p`,tn);r(tn,nn),o(nn,`report-panel-eyebrow`),r(nn,c(`Signals`));let rn=e(`h2`,tn);r(tn,rn),r(rn,c(`关键观察`));let an=e(`div`,$t);r($t,an),o(an,`report-insight-list`);let on=a(`rue:list:start`),sn=a(`rue:list:end`);r(an,on),r(an,sn);let cn=new Map;i(()=>{cn=m({items:be||[],getKey:(e,t)=>e.title,elements:cn,parent:an,before:sn,singleRoot:!0,trackIndex:!1,start:on,renderItem:(c,l,d,p,m)=>{u(s(()=>{let s=t(),l=e(`article`,s);r(s,l),i(()=>{f(l,`key`,String(c.title))}),o(l,`report-insight-item`);let d=e(`h3`,l);r(l,d);let p=a(`rue:slot:anchor`);r(d,p),i(()=>{let e=c.title;n(()=>u(e,d,p))});let m=e(`p`,l);r(l,m);let h=a(`rue:slot:anchor`);return r(m,h),i(()=>{let e=c.text;n(()=>u(e,m,h))}),s}),l,d)}})});let ln=e(`section`,k);r(k,ln),o(ln,`report-card report-timeline-card`);let $=e(`div`,ln);r(ln,$),o($,`report-panel-header`);let un=e(`div`,$);r($,un);let dn=e(`p`,un);r(un,dn),o(dn,`report-panel-eyebrow`),r(dn,c(`Daily Playback`));let fn=e(`h2`,un);r(un,fn),r(fn,c(`逐日回放`));let pn=e(`div`,$);r($,pn),o(pn,`report-panel-summary`),r(pn,c(`按金额强度缩放，便于观察 10 天窗口内的启动、放量与回落节奏。`));let mn=e(`div`,ln);r(ln,mn),o(mn,`report-timeline-list`);let hn=a(`rue:list:start`),gn=a(`rue:list:end`);r(mn,hn),r(mn,gn);let _n=new Map;return i(()=>{_n=m({items:xe||[],getKey:(e,t)=>e.sumDate,elements:_n,parent:mn,before:gn,singleRoot:!0,trackIndex:!1,start:hn,renderItem:(m,h,g,v,y)=>{u(s(()=>{let s=t(),h=e(`div`,s);r(s,h),i(()=>{f(h,`key`,String(m.sumDate))}),o(h,`report-timeline-row`);let g=e(`div`,h);r(h,g),o(g,`report-timeline-main`);let v=e(`strong`,g);r(g,v);let y=a(`rue:slot:anchor`);r(v,y),i(()=>{let e=m.label;n(()=>u(e,v,y))});let b=e(`span`,g);r(g,b);let x=a(`rue:slot:anchor`);r(b,x),i(()=>{let e=m.notes;n(()=>u(e,b,x))});let S=e(`div`,h);r(h,S),o(S,`report-timeline-track`);let ee=e(`span`,S);r(S,ee),o(ee,`report-timeline-fill`),i(()=>{l(ee,{width:`${Math.max(4,m.amountRatio*100)}%`})});let C=e(`div`,h);r(h,C),o(C,`report-timeline-metrics`);let te=e(`strong`,C);r(C,te);let w=a(`rue:slot:anchor`);r(te,w),i(()=>{let e=M(m.allAmount);n(()=>u(e,te,w))});let T=e(`span`,C);r(C,T);let E=p(T);r(T,E),i(()=>{d(E,_.format(m.ordersCount))}),r(T,c(` 笔 / 客户均额`));let ne=p(T);r(T,ne),d(ne,` `),r(T,c(` `));let D=a(`rue:slot:anchor`);return r(T,D),i(()=>{let e=M(m.avgClientPrice);n(()=>u(e,T,D))}),s}),h,g)}})}),D});export{N as default};