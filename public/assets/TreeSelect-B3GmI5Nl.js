...
/>
`,Le=[{prop:`allowClear`,description:`追加清空按钮，适合单选、多选和勾选模式统一收敛到一个入口`,type:`boolean | { clearIcon?: any }`,defaultValue:`false`},{prop:`fieldNames`,description:`映射 label、value、children、key 与 simple mode 的 id / pId 字段`,type:`TreeSelectFieldNames`,defaultValue:`{ title, value, children, key }`},{prop:`labelInValue`,description:`把回填值升级为 { value, key, label, halfChecked } 结构`,type:`boolean`,defaultValue:`false`},{prop:`loadData`,description:`展开未加载节点时触发异步加载，适合目录、权限树、远端分类场景`,type:`(node) => Promise<any> | void`,defaultValue:`-`},{prop:`maxCount`,description:`限制多选 / 勾选模式下最多展示并回填多少个节点`,type:`number`,defaultValue:`-`},{prop:`multiple`,description:`多选模式，已选项会回填为标签列表`,type:`boolean`,defaultValue:`false`},{prop:`showCheckedStrategy`,description:`控制 treeCheckable 时的回填策略，支持 SHOW_ALL / SHOW_PARENT / SHOW_CHILD`,type:`TreeSelectShowCheckedStrategy`,defaultValue:`SHOW_CHILD`},{prop:`showSearch`,description:`开启搜索输入；对象模式可配置 autoClearSearchValue、filterTreeNode 与 onSearch`,type:`boolean | TreeSelectShowSearchConfig`,defaultValue:`单选 false / 多选 true`},{prop:`treeCheckable`,description:`把树节点切到 checkbox 模式，适合权限树、发布范围、分类选择`,type:`boolean`,defaultValue:`false`},{prop:`treeData`,description:`树数据源，title / value / children 为常用字段，value 在整棵树里需要唯一`,type:`TreeSelectDataNode[]`,defaultValue:`[]`},{prop:`treeDataSimpleMode`,description:`接收扁平结构树数据，并通过 id / pId 自动恢复层级`,type:`boolean | { id?: string; pId?: string; rootPId?: string | number | null }`,defaultValue:`false`},{prop:`treeDefaultExpandAll / treeExpandedKeys`,description:`控制树默认展开和受控展开，便于做大树分层浏览`,type:`boolean / TreeSelectValue[]`,defaultValue:`false / -`},{prop:`treeNodeFilterProp`,description:`搜索命中用的字段，常见设置是 title 或自定义 label 字段`,type:`string`,defaultValue:`value`},{prop:`variant / status`,description:`沿用 Rue 输入类组件的视觉语义，支持 filled、borderless、underlined 与 warning/error`,type:`'outlined' | 'filled' | 'borderless' | 'underlined' / 'warning' | 'error'`,defaultValue:`'outlined' / -`}],Re=()=>{let{basicValue:n,noClearValue:r,simpleValue:a,multipleValue:c,checkableValue:d,semanticValue:y,shellValue:w,asyncValue:T,asyncTreeData:ee,loadAsyncTree:te,tabs:E}=v(`useSetup:0:0`,()=>g(()=>{let e=v(`ref:1:0`,()=>f(`docs`)),t=v(`ref:1:1`,()=>f(`docs`)),n=v(`ref:1:2`,()=>f(`workflow`)),r=v(`ref:1:3`,()=>f([`analytics`,`minutes`])),i=v(`ref:1:4`,()=>f([`build`,`quality`])),a=v(`ref:1:5`,()=>f(null)),o=v(`ref:1:6`,()=>f(`prod`)),s=v(`ref:1:7`,()=>f(null)),c=v(`ref:1:8`,()=>f([{title:`按需加载目录`,value:`async-root`,isLeaf:!1}]));return{basicValue:e,noClearValue:t,simpleValue:n,multipleValue:r,checkableValue:i,semanticValue:a,shellValue:o,asyncValue:s,asyncTreeData:c,loadAsyncTree:async e=>{e.value===`async-root`&&(c.value=[{title:`按需加载目录`,value:`async-root`,isLeaf:!1,children:[{title:`实验看板`,value:`async-dashboard`},{title:`巡检报告`,value:`async-report`},{title:`回归清单`,value:`async-checklist`}]}])},tabs:{basic:v(`ref:1:9`,()=>f(`preview`)),noClear:v(`ref:1:10`,()=>f(`preview`)),simple:v(`ref:1:11`,()=>f(`preview`)),multiple:v(`ref:1:12`,()=>f(`preview`)),checkable:v(`ref:1:13`,()=>f(`preview`)),semantic:v(`ref:1:14`,()=>f(`preview`)),async:v(`ref:1:15`,()=>f(`preview`)),shell:v(`ref:1:16`,()=>f(`preview`))}}}));return p(f=>{let g=l(),v=s(`rue:component:anchor`);return t(g,v),m(h(S,{children:p(()=>{let f=l(),p=u(`div`,f);t(f,p),e(p,`max-w-none prose prose-sm md:prose-base`);let g=u(`h1`,p);t(p,g),t(g,o(`TreeSelect 树选择`));let v=u(`p`,p);t(p,v),e(v,`text-sm mt-3 mb-3`),t(v,o(`TreeSelect 适合“下拉选择 + 树结构浏览”同时存在的输入场景，比如目录、组织架构、权限树、资源分类和发布范围。 这一版不照搬其他组件库的视觉，而是延续 Rue 的 input / badge / base 色阶体系，把 treeData、simple mode、多选、勾选、语义值、异步加载和 filled / warning 等核心面一次补齐。`));let S=u(`div`,p);t(p,S),e(S,`not-prose mt-8 space-y-2`);let D=u(`h2`,S);t(S,D),e(D,`text-2xl font-semibold`),t(D,o(`基础能力`));let O=u(`p`,S);t(S,O),e(O,`text-sm text-base-content/70`),t(O,o(`先把单选、搜索和清空打稳，再把 simple mode、多选与勾选这些更接近业务配置面的能力接进来。`));let k=s(`rue:component:anchor`);t(p,k),i(()=>{let e=h(C,{title:`Basic`,summary:`单选、搜索、默认展开与 allowClear 的组合，是目录选择最常见的入口。`,tab:E.basic,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:n.value,treeData:L,treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,placeholder:`选择一个树节点`,onChange:e=>{n.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,n.value||`未选择`]})]})}),code:ke});_(()=>m(e,p,k))});let ne=s(`rue:component:anchor`);t(p,ne),i(()=>{let e=h(C,{title:`Without allowClear`,summary:`未开启 allowClear 时，只保留选择交互，不显示 selector 右侧的清空入口。`,tab:E.noClear,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:r.value,treeData:L,treeDefaultExpandAll:!0,onChange:e=>{r.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,r.value||`未选择`]})]})}),code:Ae});_(()=>m(e,p,ne))});let re=s(`rue:component:anchor`);t(p,re),i(()=>{let e=h(C,{title:`Simple Mode`,summary:`扁平树数据直接接入，适合后端给的是 id / pId 结构时减少前置整理成本。`,tab:E.simple,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:a.value,treeData:Oe,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{value:`code`,label:`name`,key:`code`},treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,onChange:e=>{a.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前目标：`,a.value||`未选择`]})]}),x(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`这类接口在 CMS、流程平台、低代码配置里很常见。只要给出 id / pId / value / title 映射，就能直接恢复成可搜索树。`})]})}),code:je});_(()=>m(e,p,re))});let ie=s(`rue:component:anchor`);t(p,ie),i(()=>{let e=h(C,{title:`Multiple`,summary:`多选模式默认以标签回填，适合通知订阅、面板订阅、资源批量绑定。`,tab:E.multiple,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:c.value,treeData:Ee,multiple:!0,treeDefaultExpandAll:!0,allowClear:!0,maxTagCount:2,placeholder:`选择多个项目`,onChange:e=>{c.value=Te(e)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`已选：`,c.value.join(` / `)||`未选择`]})]})}),code:Me});_(()=>m(e,p,ie))});let ae=s(`rue:component:anchor`);t(p,ae),i(()=>{let e=h(C,{title:`Checkable`,summary:`勾选树会把多选语义进一步贴近权限树和发布范围；默认 SHOW_CHILD 会直接回填实际勾选的子节点。`,tab:E.checkable,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:d.value,treeData:L,treeCheckable:!0,maxTagCount:2,maxTagPlaceholder:`...`,allowClear:!0,treeDefaultExpandAll:!0,onChange:e=>{d.value=Te(e)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`回填：`,d.value.join(` / `)||`未选择`]})]}),b(`ul`,{className:`list rounded-box border border-base-300 bg-base-200/40 p-4 text-sm`,children:[b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`策略`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例使用默认 SHOW_CHILD，选了哪些子节点就回填哪些子节点，更适合精确范围选择。`})]}),b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`切换`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`如果业务更想要紧凑展示，可以把 showCheckedStrategy 改成 TreeSelect.SHOW_PARENT，让完整分组选中时折叠成父标签。`})]}),b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`回填`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例最多展示两个标签，更多已选项会用 ... 收起，避免 selector 被撑成两排。`})]})]})]})}),code:Ne});_(()=>m(e,p,ae))});let A=u(`div`,p);t(p,A),e(A,`not-prose mt-10 space-y-2`);let oe=u(`h2`,A);t(A,oe),e(oe,`text-2xl font-semibold`),t(oe,o(`高级能力`));let se=u(`p`,A);t(A,se),e(se,`text-sm text-base-content/70`),t(se,o(`语义值、异步加载和外观变体补到位之后，TreeSelect 就能覆盖绝大多数配置类面板的核心需求。`));let ce=s(`rue:component:anchor`);t(p,ce),i(()=>{let e=h(C,{title:`Label In Value`,summary:`当业务既要 value 也要 label 时，直接回填结构体会更顺手。`,tab:E.semantic,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[x(`div`,{className:`grid gap-3`,children:x(F,{treeData:L,labelInValue:!0,treeDefaultExpandAll:!0,defaultValue:`release`,onChange:e=>{y.value=e??null}})}),b(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:[`当前结构：`,x(`code`,{children:JSON.stringify(y.value)})]})]})}),code:Pe});_(()=>m(e,p,ce))});let le=s(`rue:component:anchor`);t(p,le),i(()=>{let e=h(C,{title:`Async Load`,summary:`展开未加载分支时触发 loadData，适合远端目录、权限树和超大分类树。`,tab:E.async,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:T.value,treeData:ee.value,allowClear:!0,loadData:te,onChange:e=>{T.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,T.value||`尚未选择`]})]}),x(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`第一次展开“按需加载目录”时会把子节点注入到 treeData，这个模式适合服务端分页目录和按需权限树。`})]})}),code:Fe});_(()=>m(e,p,le))});let ue=s(`rue:component:anchor`);t(p,ue),i(()=>{let e=h(C,{title:`Variant and Status`,summary:`TreeSelect 也沿用 Rue 现有输入体系的 filled / warning 视觉语义。`,tab:E.shell,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 md:grid-cols-2`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:w.value,treeData:De,prefix:x(`span`,{className:`badge badge-neutral badge-sm`,children:`ENV`}),suffix:x(`span`,{className:`text-xs opacity-60`,children:`可清空`}),variant:`filled`,status:`warning`,allowClear:!0,treeDefaultExpandAll:!0,onChange:e=>{w.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前环境：`,w.value||`未选择`]})]}),x(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`prefix / suffix 让 TreeSelect 能自然落进环境切换、租户切换和带状态提醒的配置表单里。`})]})}),code:Ie});_(()=>m(e,p,ue))});let j=u(`div`,p);t(p,j),e(j,`not-prose mt-10 space-y-4`);let de=u(`h2`,j);t(j,de),e(de,`text-2xl font-semibold`),t(de,o(`API`));let fe=s(`rue:component:anchor`);return t(j,fe),i(()=>{let e=h(we,{rows:Le});_(()=>m(e,j,fe))}),f})}),g,v),g})};export{Re as default};