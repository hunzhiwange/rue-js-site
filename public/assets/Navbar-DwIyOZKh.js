...
/>`});i(()=>d(e,n,j))});let M=s(`rue:component:anchor`);a(n,M),o(()=>{let e=m(F,{title:`数据驱动导航项`,summary:`当中间菜单和右侧状态来自配置或接口时，用 items 比手写结构更容易维护。`,tab:v,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`rounded-box bg-base-100`,brand:y(`a`,{className:`btn btn-ghost gap-3 px-2 text-lg normal-case`,children:[b(z,{label:`W`}),`Workspace`]}),items:te,actions:b(`button`,{className:`btn btn-primary btn-sm`,children:`Invite`}),centerProps:{className:`hidden md:flex gap-1`},endProps:{className:`gap-2`},"data-testid":`navbar-items`})})}),code:`const items = [
...
/>`});i(()=>d(e,n,N))});let R=e(`h2`,n);a(n,R),a(R,u(`经典 demo`));let B=e(`p`,n);a(n,B),a(B,u(`下面这几组示例保留了原有写法，只做了页面重组，方便继续对照 Start / Center / End 的经典组合方式。`));let se=s(`rue:component:anchor`);a(n,se),o(()=>{let e=m(F,{title:`仅标题`,summary:`最简单的 navbar，用 root 直接承载内容。`,tab:C,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-only`,children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <button className="btn btn-ghost text-xl">daisyUI</button>
</Navbar>`});i(()=>d(e,n,se))});let ce=s(`rue:component:anchor`);a(n,ce),o(()=>{let e=m(F,{title:`标题与图标`,summary:`保留经典的 Start + End 组合。`,tab:w,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-icon`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:b(`button`,{className:`btn btn-square btn-ghost`,children:b(L,{})})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});i(()=>d(e,n,V))});let H=s(`rue:component:anchor`);a(n,H),o(()=>{let e=m(F,{title:`菜单与子菜单`,summary:`继续保留菜单容器和 details 子菜单的经典演示。`,tab:E,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-menu-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:y(`ul`,{className:`menu menu-horizontal items-center gap-1 px-1`,children:[b(`li`,{children:b(`button`,{className:`h-10 min-h-10 items-center`,children:`Link`})}),b(`li`,{children:y(`details`,{children:[b(`summary`,{className:`h-10 min-h-10 items-center`,children:`Parent`}),y(`ul`,{className:`bg-base-100 rounded-t-none p-2`,children:[b(`li`,{children:b(`button`,{children:`Link 1`})}),b(`li`,{children:b(`button`,{children:`Link 2`})})]})]})})]})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});i(()=>d(e,n,H))});let U=s(`rue:component:anchor`);a(n,U),o(()=>{let e=m(F,{title:`搜索框与头像下拉`,summary:`保留搜索、头像和下拉菜单混排的经典结构。`,tab:ee,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-search-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),y(P.End,{className:`gap-2`,children:[b(`input`,{type:`text`,placeholder:`Search`,className:`input input-bordered w-24 md:w-auto`}),y(`div`,{className:`dropdown dropdown-end`,children:[b(`div`,{tabIndex:`0`,role:`button`,className:`btn btn-ghost btn-circle avatar`,children:b(`div`,{className:`w-10 rounded-full`,children:b(`img`,{alt:`Tailwind CSS Navbar component`,src:`https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp`})})}),y(`ul`,{tabIndex:`-1`,className:`mt-3 z-1 p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52`,children:[b(`li`,{children:y(`button`,{className:`justify-between`,children:[`Profile`,b(`span`,{className:`badge`,children:`New`})]})}),b(`li`,{children:b(`button`,{children:`Settings`})}),b(`li`,{children:b(`button`,{children:`Logout`})})]})]})]})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
...
</Navbar>`});i(()=>d(e,n,U))});let W=e(`h2`,n);a(n,W),p(W,`id`,`navbar-api`),a(W,u(`API`));let le=e(`p`,n);a(n,le),a(le,u(`Navbar 现在同时支持推荐的语义插槽模式，以及原有的组合模式。`));let ue=e(`h3`,n);a(n,ue),a(ue,u(`Navbar`));let de=s(`rue:component:anchor`);a(n,de),o(()=>{let e=m(I,{rows:ie});i(()=>d(e,n,de))});let fe=e(`h3`,n);a(n,fe),a(fe,u(`Navbar.Start / Navbar.Center / Navbar.End / Navbar.Section`));let pe=s(`rue:component:anchor`);a(n,pe),o(()=>{let e=m(I,{rows:ae});i(()=>d(e,n,pe))});let me=e(`h3`,n);a(n,me),a(me,u(`Navbar.Item / items[]`));let he=s(`rue:component:anchor`);a(n,he),o(()=>{let e=m(I,{rows:oe});i(()=>d(e,n,he))});let G=e(`div`,n);a(n,G),c(G,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let K=e(`h3`,G);a(G,K),c(K,`mt-0 mb-3 text-base font-semibold`),a(K,u(`双模式说明`));let q=e(`div`,G);a(G,q),c(q,`grid gap-3 text-sm md:grid-cols-2`);let J=e(`div`,q);a(q,J);let ge=e(`code`,J);a(J,ge),a(ge,u(`children + Navbar.Start/Center/End`)),a(J,u(`: 适合完全手写布局，兼容旧 demo。`));let Y=e(`div`,q);a(q,Y);let _e=e(`code`,Y);a(Y,_e),a(_e,u(`brand / start / center / end / actions / items`)),a(Y,u(`: 适合抽象成复用头部或通过配置生成导航结构。`));let ve=e(`h2`,n);a(n,ve),a(ve,u(`FAQ`));let ye=e(`h3`,n);a(n,ye),a(ye,u(`什么时候选推荐模式，什么时候继续手写 children？`));let X=e(`p`,n);a(n,X),a(X,u(`如果页面头部结构在多个页面之间重复，或者导航项来自配置，优先用语义插槽和`));let be=h(X);a(X,be),f(be,` `);let xe=e(`code`,X);a(X,xe),a(xe,u(`items`)),a(X,u(`。 如果当前头部结构非常自由，包含复杂的 dropdown、menu、搜索表单，继续手写`));let Se=e(`code`,X);a(X,Se),a(Se,u(`children + Navbar.Start/Center/End`)),a(X,u(`会更直接。`));let Ce=e(`h3`,n);a(n,Ce),a(Ce,u(`children 和 items 同时传时谁优先？`));let Z=e(`p`,n);a(n,Z),a(Z,u(`当前实现会优先渲染`));let we=e(`code`,Z);a(Z,we),a(we,u(`children`)),a(Z,u(`。这样可以保证旧代码迁移时不被新属性打断， 也能让组合模式保持完全可控。`));let Q=e(`h3`,n);a(n,Q),a(Q,u(`sticky 和 bordered 是强样式能力吗？`));let $=e(`p`,n);a(n,$),a($,u(`不是。它们只是补一层常用布局类，仍然遵循 Rue 当前的视觉基底；更细的背景、阴影、圆角和响应式布局， 依然建议通过`));let Te=e(`code`,$);a($,Te),a(Te,u(`className`));let Ee=h($);return a($,Ee),f(Ee,` `),a($,u(`和区块 props 来组合。`)),t})}),n,_),n})};export{B as default};