import{An as e,B as t,Bt as n,C as r,Dn as i,Et as a,H as o,K as s,L as c,Lt as l,Mn as u,Nn as d,On as f,S as p,Sn as m,V as h,W as g,Wt as _,_n as v,bn as y,fn as b,gn as x,hn as S,nt as C,ot as w,pn as ee,qt as T,wn as E,x as D}from"./rue-runtime-CwEGJ854.js";import{t as O}from"./Code-B3jCYMAr.js";import{r as k}from"./SidebarPlaygroundExample-EGR0CyDT.js";var A=v(`<h1 class="text-5xl font-semibold mb-4 md:mb-4">effectScope 批量停止</h1>`),j=v(`<div role="tablist" class="tabs tabs-box"><button role="tab">效果</button><button role="tab">代码</button></div>`),M=v(`<div class="mt-4 grid md:grid-cols-1 gap-6 items-start"><!--rue:text-hole:0--><!--rue:text-hole:1--></div>`),N=()=>new Date().toLocaleTimeString(),P=`import {
  type EffectScope,
  type FC,
  computed,
  effectScope,
