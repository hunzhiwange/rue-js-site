...
<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});i(()=>m(e,n,se))});let ce=s(`rue:component:anchor`);a(n,ce),o(()=>{let e=h(j,{title:`推荐：复合子组件写法`,summary:`当某一列需要自己控制内容结构时，可以直接组合 Footer.Brand、Footer.Section、Footer.Link。`,tab:v,preview:()=>y(A,{className:`p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal`,children:[y(A.Brand,{children:[b(M,{}),y(`p`,{className:`text-sm mt-3 mb-3`,children:[`Rue Design System`,b(`br`,{}),`Ship consistent experiences.`]})]}),y(A.Section,{title:`Product`,children:[b(A.Link,{children:`Overview`}),b(A.Link,{children:`Pricing`}),b(A.Link,{children:`Changelog`})]}),b(A.Section,{title:`Community`,content:b(`div`,{className:`grid grid-flow-col gap-4`,children:N.map(({key:e,Icon:t})=>b(`button`,{type:`button`,"aria-label":e,children:b(t,{})},e))})})]}),code:`<Footer className="p-10 bg-base-100 border border-base-300 rounded sm:footer-horizontal">
  ...
  />
</Footer>`});i(()=>m(e,n,ce))});let le=s(`rue:component:anchor`);a(n,le),o(()=>{let e=h(j,{title:`Footer（默认纵向，sm 起横向）`,summary:`原始基础 demo 继续保留，这里改用 sections 表达同一个场景。`,tab:x,preview:()=>b(A,{className:`p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal`,sections:B}),code:`<Footer className="p-10 bg-neutral text-neutral-content rounded sm:footer-horizontal" sections={sections} />`});i(()=>m(e,n,le))});let ue=s(`rue:component:anchor`);a(n,ue),o(()=>{let e=h(j,{title:`Footer with a logo section`,summary:`保留品牌区场景；推荐用 brand + sections，把品牌说明和导航列拆开。`,tab:S,preview:()=>b(A,{className:`p-10 bg-base-200 text-base-content rounded sm:footer-horizontal`,brand:y(`div`,{children:[b(M,{}),y(`p`,{className:`text-sm mt-3 mb-3`,children:[`ACME Industries Ltd.`,b(`br`,{}),`Providing reliable tech since 1992`]})]}),sections:B}),code:`<Footer
...
</Footer>`});i(()=>m(e,n,pe))});let me=s(`rue:component:anchor`);a(n,me),o(()=>{let e=h(j,{title:`Links and social icons (two rows)`,summary:`保留两行链接矩阵；用 sections 组合数据，继续交给 className 控制布局。`,tab:D,preview:()=>b(A,{className:`p-10 bg-neutral text-neutral-content rounded sm:grid-rows-2 sm:footer-horizontal`,sections:re}),code:`<Footer
...
</div>`});i(()=>m(e,n,_e))});let H=e(`h2`,n);a(n,H),p(H,`id`,`footer-api`),a(H,l(`API`));let ve=e(`p`,n);a(n,ve),a(ve,l(`当前页展示的是增强后的 Footer API，旧的 children 写法仍然可用。`));let ye=e(`h3`,n);a(n,ye),a(ye,l(`Footer`));let be=s(`rue:component:anchor`);a(n,be),o(()=>{let e=h(ne,{rows:ie});i(()=>m(e,n,be))});let U=e(`h3`,n);a(n,U),c(U,`mt-8`),a(U,l(`Footer.Section`));let xe=s(`rue:component:anchor`);a(n,xe),o(()=>{let e=h(ne,{rows:ae});i(()=>m(e,n,xe))});let W=e(`div`,n);a(n,W),c(W,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let G=e(`h3`,W);a(W,G),c(G,`mt-0 mb-3 text-base font-semibold`),a(G,l(`复合子组件`));let K=e(`div`,W);a(W,K),c(K,`grid gap-2 text-sm md:grid-cols-2`);let q=e(`div`,K);a(K,q);let Se=e(`code`,q);a(q,Se),a(Se,l(`Footer.Brand`)),a(q,l(`：品牌或版权信息容器，默认渲染`));let Ce=e(`code`,q);a(q,Ce),a(Ce,l(`aside`));let J=e(`div`,K);a(K,J);let we=e(`code`,J);a(J,we),a(we,l(`Footer.Title`)),a(J,l(`：带`));let Te=e(`code`,J);a(J,Te),a(Te,l(`footer-title`)),a(J,l(`类名的标题节点`));let Y=e(`div`,K);a(K,Y);let Ee=e(`code`,Y);a(Y,Ee),a(Ee,l(`Footer.Link`)),a(Y,l(`：默认输出带`));let De=e(`code`,Y);a(Y,De),a(De,l(`link link-hover`)),a(Y,l(`的文本链接`));let X=e(`div`,K);a(K,X);let Oe=e(`code`,X);a(X,Oe),a(Oe,l(`Footer.Section`)),a(X,l(`：单列容器，支持`));let ke=e(`code`,X);a(X,ke),a(ke,l(`title`)),a(X,l(`、`));let Ae=e(`code`,X);a(X,Ae),a(Ae,l(`items`)),a(X,l(`、`));let je=e(`code`,X);a(X,je),a(je,l(`content`));let Me=e(`h2`,n);a(n,Me),a(Me,l(`FAQ`));let Ne=e(`h3`,n);a(n,Ne),a(Ne,l(`什么时候用 sections，什么时候继续写 children？`));let Z=e(`p`,n);a(n,Z),a(Z,l(`列结构比较规则时，优先用`));let Pe=e(`code`,Z);a(Z,Pe),a(Pe,l(`sections`)),a(Z,l(`，维护成本更低；如果某一列需要完全自定义布局，或者你已经有现成的`));let Fe=e(`code`,Z);a(Z,Fe),a(Fe,l(`nav`)),a(Z,l(`/`));let Ie=e(`code`,Z);a(Z,Ie),a(Ie,l(`aside`)),a(Z,l(`模板，也可以继续直接写`));let Le=e(`code`,Z);a(Z,Le),a(Le,l(`children`)),a(Z,l(`。`));let Re=e(`h3`,n);a(n,Re),a(Re,l(`社交图标和订阅表单怎么放进去？`));let Q=e(`p`,n);a(n,Q),a(Q,l(`这类内容更适合放到`));let ze=e(`code`,Q);a(Q,ze),a(ze,l(`Footer.Section`)),a(Q,l(`的`));let Be=e(`code`,Q);a(Q,Be),a(Be,l(`content`));let Ve=g(Q);a(Q,Ve),f(Ve,` `),a(Q,l(`里；如果只是普通文本链接，再用`));let He=e(`code`,Q);a(Q,He),a(He,l(`items`)),a(Q,l(`会更省代码。`));let Ue=e(`h3`,n);a(n,Ue),a(Ue,l(`direction 和 center 还需要保留吗？`));let $=e(`p`,n);a(n,$),a($,l(`需要。它们仍然是最轻量的布局开关，适合和现有的`));let We=e(`code`,$);a($,We),a(We,l(`sm:footer-horizontal`)),a($,l(`、`));let Ge=e(`code`,$);return a($,Ge),a(Ge,l(`footer-center`)),a($,l(`类名习惯一起工作，不会破坏旧页面的视觉结果。`)),t})}),n,_),n})};export{V as default};