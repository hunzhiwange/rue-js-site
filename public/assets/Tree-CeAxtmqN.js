...
</div>`,et=[{prop:`treeData`,description:`树数据源，支持嵌套 children 和字段映射。`,type:`TreeDataNode[]`,defaultValue:`[]`},{prop:`selectedKeys / defaultSelectedKeys`,description:`受控与非受控的当前选中项，multiple 打开后允许多选。`,type:`TreeKey[]`,defaultValue:`[]`},{prop:`checkedKeys / defaultCheckedKeys`,description:`勾选模式下的选中集合，strict 模式会回传 checked / halfChecked 结构。`,type:`TreeKey[] | { checked: TreeKey[]; halfChecked: TreeKey[] }`,defaultValue:`[]`},{prop:`expandedKeys / defaultExpandedKeys / defaultExpandAll`,description:`控制展开态，适合目录树、权限树和异步加载场景。`,type:`TreeKey[] / boolean`,defaultValue:`[] / false`},{prop:`checkable / checkStrictly`,description:`切换勾选与父子联动模式；strict 会关闭级联。`,type:`boolean`,defaultValue:`false`},{prop:`treeDataSimpleMode / fieldNames`,description:`直接接入 id / pId 扁平数据，同时可映射 title、key、children 字段。`,type:`boolean | TreeSimpleModeConfig / TreeFieldNames`,defaultValue:`- / -`},{prop:`allowSearch / searchValue / filterTreeNode`,description:`提供内置搜索输入和过滤逻辑，命中后会保持祖先链路。`,type:`boolean / string / boolean | ((inputValue, node) => boolean)`,defaultValue:`false / - / true`},{prop:`loadData`,description:`展开未加载分支时触发异步加载，适合远端目录与超大树。`,type:`(node: TreeNode) => Promise<any> | void`,defaultValue:`-`},{prop:`rangeSelect / Tree.DirectoryTree / expandAction / toggleSelect`,description:`Tree 多选和目录树都支持 shift 区间选择；目录树额外提供展开动作和 ctrl/meta 追加选择开关。`,type:`false | "append" | "replace" / DirectoryTreeProps / false | "click" | "doubleClick" / boolean`,defaultValue:`"append" / blockNode=true / showIcon=true / "click" / true`},{prop:`draggable / allowDrop / onDrop`,description:`开启拖拽排序并控制是否允许落点；allowDrop 和 onDrop 都会拿到 dropToGap，UI 会同步显示插前、插后或放入占位态。`,type:`TreeDraggable / (info) => boolean / (info) => void`,defaultValue:`false / - / -`},{prop:`height / itemHeight / virtual`,description:`为长列表开启虚拟滚动；height 定义视口高度，itemHeight 用于估算渲染窗口，也能和 loadData 组合接超长懒加载树。`,type:`number / number / boolean`,defaultValue:`- / 自动按尺寸估算 / true`},{prop:`showLine / showIcon / blockNode`,description:`控制树线、节点图标和整行可点的布局表现。`,type:`boolean`,defaultValue:`false`},{prop:`titleRender / switcherIcon / icon`,description:`按节点态自定义标题、展开图标和节点图标。`,type:`render function | any`,defaultValue:`-`}],tt=e=>Array.isArray(e)?e:e.checked,nt=(e,t)=>Array.isArray(e)?t?.halfCheckedKeys??[]:e.halfChecked,rt=e=>`${typeof e}:${String(e)}`,Y=e=>e.map(e=>({...e,children:Array.isArray(e.children)?Y(e.children):e.children})),it=(e,t)=>{let n=rt(t);for(let r=0;r<e.length;r+=1){let i=e[r];if(rt(i.key)===n){let[t]=e.splice(r,1);return t??null}if(Array.isArray(i.children)){let e=it(i.children,t);if(e)return e}}return null},at=(e,t,n,r)=>{let i=rt(n);for(let a=0;a<e.length;a+=1){let o=e[a];if(rt(o.key)===i){if(r===0){let e=Array.isArray(o.children)?[...o.children]:[];e.push(t),o.children=e}else e.splice(r<0?a:a+1,0,t);return!0}if(Array.isArray(o.children)&&at(o.children,t,n,r))return!0}return!1},ot=(e,t)=>{let n=Y(e),r=it(n,t.dragNode.key);return r&&(at(n,r,t.node.key,t.dropPosition)||n.push(r)),n},st=(e,t,n)=>{let r=rt(t);for(let i=0;i<e.length;i+=1){let a=e[i];if(rt(a.key)===r){let t=n(a);if(t===a)return e;let r=e.slice();return r[i]=t,r}if(Array.isArray(a.children)&&a.children.length){let r=st(a.children,t,n);if(r===a.children)continue;let o=e.slice();return o[i]={...a,children:r},o}}return e},ct=e=>e.reduce((e,t)=>!Array.isArray(t.children)||!t.children.length?e:e+1+ct(t.children),0),lt=e=>{let{isOpen:r,isFolder:o,toggle:s,addChild:l,changeType:d}=D(`useSetup:0:0`,()=>t(()=>{let t=D(`computed:1:0`,()=>i(()=>!!e.model.open)),n=D(`computed:1:1`,()=>i(()=>!!e.model.children&&e.model.children.length>0)),r=n=>{n?.stopPropagation(),e.model.open=!t.get()},a=t=>{t?.stopPropagation(),e.model.children||(e.model.children=[]),e.model.children.push({id:`${e.model.id}-new-${e.model.children.length}`,name:`new stuff`}),e.model.open=!0};return{isOpen:t,isFolder:n,toggle:r,addChild:a,changeType:t=>{t?.stopPropagation(),n.get()||(e.model.children=[],a(),e.model.open=!0)}}}));return w(t=>{let i=y(`li`,t);c(i,`list-none`);let p=y(`button`,i);x(i,p),n(p,`type`,`button`),S(()=>{c(p,`flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm transition `+(o.get()?`font-semibold text-base-content`:`text-base-content/80 hover:bg-base-200/70`))}),_(p,`click`,e=>s(e)),_(p,`dblclick`,e=>d(e));let g=y(`span`,p);x(p,g),c(g,`inline-flex size-5 items-center justify-center rounded-md bg-base-200/80 text-[11px] text-base-content/55`);let v=m(g);x(g,v),S(()=>{a(v,o.get()?r.get()?`−`:`+`:`•`)});let b=y(`span`,p);x(p,b);let D=u(`rue:slot:anchor`);x(b,D),S(()=>{let t=e.model.name;C(()=>T(t,b,D))});let k=u(`rue:slot:anchor`);return x(i,k),S(()=>{let t=o.get()&&r.get()?w(()=>{let t=f(),r=y(`ul`,t);x(t,r),c(r,`mt-1 grid gap-1 pl-5`);let i=u(`rue:list:start`),a=u(`rue:list:end`);x(r,i),x(r,a);let o=new Map;S(()=>{o=O({items:e.model.children||[],getKey:(e,t)=>e.id,elements:o,parent:r,before:a,start:i,renderItem:(e,t,n,r,i)=>{ee(E(lt,{key:e.id,model:e}),t,n,r)}})});let s=y(`li`,r);x(r,s),c(s,`list-none`);let d=y(`button`,s);return x(s,d),n(d,`type`,`button`),c(d,`btn btn-ghost btn-xs rounded-full text-emerald-600`),_(d,`click`,e=>l(e)),x(d,h(`+ add child`)),t}):``;C(()=>T(t,i,k))}),i})},ut=()=>{let{basicSelectedKeys:e,directorySelectedKeys:n,directoryExpandAction:a,directoryToggleSelect:o,directoryRangeSelect:s,directoryRangeAppendSelectedKeys:l,directoryRangeReplaceSelectedKeys:d,directoryRangeTreeVersion:p,checkableSelectedKeys:m,checkedKeys:g,halfCheckedKeys:_,disabledCheckedKeys:b,simpleSelectedKeys:ee,asyncSelectedKeys:O,asyncExpandedKeys:te,dragTreeData:ne,dragSummary:re,virtualSelectedKeys:N,asyncVirtualTreeData:P,asyncVirtualExpandedKeys:F,asyncVirtualSelectedKeys:ie,asyncVirtualLoadedBranchCount:I,asyncTreeData:ae,legacyTree:oe,tabs:L,loadAsyncTree:se,loadAsyncVirtualTree:R,resetDirectoryRangeDemo:ce}=D(`useSetup:0:0:dup1`,()=>t(()=>{let e=D(`ref:1:2`,()=>v([`docs-api`])),t=D(`ref:1:3`,()=>v([`dir-app`])),n=D(`ref:1:4`,()=>v(`click`)),a=D(`ref:1:5`,()=>v(!0)),o=D(`computed:1:6`,()=>i(()=>a.value?`append`:!1)),s=D(`ref:1:7`,()=>v([])),c=D(`ref:1:8`,()=>v([])),l=D(`ref:1:9`,()=>v(0)),u=D(`ref:1:10`,()=>v([`release-control`])),d=D(`ref:1:11`,()=>v([`site-home`])),f=D(`ref:1:12`,()=>v([`release-control`,`release-site`])),p=D(`ref:1:13`,()=>v([`editable-assets`])),m=D(`ref:1:14`,()=>v([`workflow`])),h=D(`ref:1:15`,()=>v([])),g=D(`ref:1:16`,()=>v([])),_=D(`ref:1:17`,()=>v(Y(Ve))),y=D(`ref:1:18`,()=>v(`folder 支持放入；file 只允许插前和插后，悬停时会显示明确占位态。`)),b=D(`ref:1:19`,()=>v([`virtual-3`])),x=D(`ref:1:20`,()=>v(Y(Ue))),S=D(`ref:1:21`,()=>v([])),C=D(`ref:1:22`,()=>v([])),w=D(`computed:1:23`,()=>i(()=>ct(x.value))),T=D(`ref:1:24`,()=>v([{title:`发布总线`,key:`release-bus`,isLeaf:!1}]));return{basicSelectedKeys:e,directorySelectedKeys:t,directoryExpandAction:n,directoryToggleSelect:a,directoryRangeSelect:o,directoryRangeAppendSelectedKeys:s,directoryRangeReplaceSelectedKeys:c,directoryRangeTreeVersion:l,checkableSelectedKeys:u,checkedKeys:d,halfCheckedKeys:f,disabledCheckedKeys:p,simpleSelectedKeys:m,asyncSelectedKeys:h,asyncExpandedKeys:g,dragTreeData:_,dragSummary:y,virtualSelectedKeys:b,asyncVirtualTreeData:x,asyncVirtualExpandedKeys:S,asyncVirtualSelectedKeys:C,asyncVirtualLoadedBranchCount:w,asyncTreeData:T,legacyTree:D(`reactive:1:25`,()=>r({id:`root`,name:`My Tree`,open:!0,children:[{id:`hello`,name:`hello`},{id:`world`,name:`world`},{id:`branch`,name:`child folder`,open:!0,children:[{id:`branch-1`,name:`design review`},{id:`branch-2`,name:`release note`}]}]})),tabs:{basic:D(`ref:1:26`,()=>v(`preview`)),directory:D(`ref:1:27`,()=>v(`preview`)),directoryRange:D(`ref:1:28`,()=>v(`preview`)),checkable:D(`ref:1:29`,()=>v(`preview`)),checkableDisabled:D(`ref:1:30`,()=>v(`preview`)),simple:D(`ref:1:31`,()=>v(`preview`)),async:D(`ref:1:32`,()=>v(`preview`)),drag:D(`ref:1:33`,()=>v(`preview`)),virtual:D(`ref:1:34`,()=>v(`preview`)),virtualAsync:D(`ref:1:35`,()=>v(`preview`)),legacy:D(`ref:1:36`,()=>v(`preview`))},loadAsyncTree:async e=>{e.key===`release-bus`&&(T.value=[{title:`发布总线`,key:`release-bus`,isLeaf:!1,children:[{title:`桌面端`,key:`desktop`,children:[{title:`Windows`,key:`desktop-win`},{title:`macOS`,key:`desktop-mac`}]},{title:`移动端`,key:`mobile`,children:[{title:`iOS`,key:`mobile-ios`},{title:`Android`,key:`mobile-android`}]}]}])},loadAsyncVirtualTree:async e=>{e.children.length||(x.value=st(x.value,e.key,e=>({...e,children:Array.from({length:8},(t,n)=>({title:`${String(e.title)} / Module ${n+1}`,key:`${String(e.key)}-child-${n}`,isLeaf:n%3!=0}))})))},resetDirectoryRangeDemo:()=>{s.value=[],c.value=[],l.value+=1}}}));return w(t=>{let r=f(),i=u(`rue:component:anchor`);return x(r,i),T(E(j,{children:w(()=>{let t=f(),r=y(`div`,t);x(t,r),c(r,`max-w-none prose prose-sm md:prose-base`);let i=y(`h1`,r);x(r,i),x(i,h(`Tree 树控件`));let v=y(`p`,r);x(r,v),x(v,h(`Rue 的 Tree 补上了独立树组件这块空白：保持 TreeView 示例里递归数据直改的灵活性，同时把 树控件常用的展开、选中、勾选、简单模式、异步加载和自定义标题一次覆盖。 视觉上使用 Rue 当前的卡片、badge 和 base 色阶体系，不照搬其他组件库的外观。`));let w=y(`div`,r);x(r,w),c(w,`not-prose mt-6 grid gap-3 md:grid-cols-3`);let D=y(`div`,w);x(w,D),c(D,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let j=y(`div`,D);x(D,j),c(j,`text-xs uppercase tracking-[0.2em] text-base-content/45`),x(j,h(`Node Model`));let z=y(`div`,D);x(D,z),c(z,`mt-2 text-base font-semibold`),x(z,h(`选择、勾选、展开三条状态线`));let B=y(`p`,D);x(D,B),c(B,`mt-2 mb-0 text-sm text-base-content/68`),x(B,h(`目录树、权限树、发布树都能直接套进来。`));let V=y(`div`,w);x(w,V),c(V,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let H=y(`div`,V);x(V,H),c(H,`text-xs uppercase tracking-[0.2em] text-base-content/45`),x(H,h(`DirectoryTree`));let le=y(`div`,V);x(V,le),c(le,`mt-2 text-base font-semibold`),x(le,h(`目录树快捷 API`));let ue=y(`p`,V);x(V,ue),c(ue,`mt-2 mb-0 text-sm text-base-content/68`),x(ue,h(`支持 click / doubleClick 展开，以及更接近文件浏览器的多选交互。`));let U=y(`div`,w);x(w,U),c(U,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let de=y(`div`,U);x(U,de),c(de,`text-xs uppercase tracking-[0.2em] text-base-content/45`),x(de,h(`Heavy Interaction`));let fe=y(`div`,U);x(U,fe),c(fe,`mt-2 text-base font-semibold`),x(fe,h(`拖拽排序与虚拟滚动`));let W=y(`p`,U);x(U,W),c(W,`mt-2 mb-0 text-sm text-base-content/68`),x(W,h(`长列表和拖拽改序终于能落在同一个 Tree 上了。`));let pe=u(`rue:component:anchor`);x(r,pe),S(()=>{let t=E(M,{title:`基础选中与整行交互`,summary:`默认 Tree 就是一个纯浏览 + 选中容器；blockNode 和 showIcon 让它更像配置面板里的主导航。`,tab:L.basic,code:J,preview:k(`div`,{className:`space-y-4 not-prose`,children:[A(q,{treeData:Fe,selectedKeys:e.value,defaultExpandAll:!0,showIcon:!0,blockNode:!0,onSelect:t=>{e.value=t}}),k(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:e.value.length?e.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`未选择`})})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`推荐场景`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`组件目录、文档导航、资源分类`})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`状态模型`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`selectedKeys / expandedKeys 分离，便于受控更新。`})]})]})]})});C(()=>T(t,r,pe))});let G=u(`rue:component:anchor`);x(r,G),S(()=>{let e=E(M,{title:`DirectoryTree 目录树快捷 API`,summary:`Tree.DirectoryTree 默认补上目录图标、整行可点和 click 展开；这里先只看 expandAction 和 toggleSelect 这两个基础交互开关。`,tab:L.directory,code:Je,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q.DirectoryTree,{treeData:ze,selectedKeys:n.value,multiple:!0,expandAction:a.value,toggleSelect:o.value,rangeSelect:s.get(),onSelect:e=>{n.value=e}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`快捷属性`}),k(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[A(`button`,{type:`button`,className:a.value===`click`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=`click`},children:`click 展开`}),A(`button`,{type:`button`,className:a.value===`doubleClick`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=`doubleClick`},children:`doubleClick 展开`}),A(`button`,{type:`button`,className:a.value===!1?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=!1},children:`只选中不展开`})]}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:[A(`button`,{type:`button`,className:o.value?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{o.value=!0},children:`ctrl/meta 追加`}),A(`button`,{type:`button`,className:o.value?`btn btn-ghost btn-xs`:`btn btn-primary btn-xs`,onClick:()=>{o.value=!1},children:`关闭追加选择`})]})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:n.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e)))})]}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前组合是 expandAction=`,A(`strong`,{children:String(a.value)}),`、toggleSelect=`,A(`strong`,{children:String(o.value)}),`、rangeSelect=`,A(`strong`,{children:String(s.get())}),`。`,A(`div`,{className:`mt-3`,children:`普通点击会落成单选；打开追加后，meta / ctrl 会追加或移除选中，shift 也会启用区间选择。关闭追加时，这两类补充选择都会停用；append / replace 的差异放到下面的对照示例里单独演示。`})]})]})]})});C(()=>T(e,r,G))});let me=u(`rue:component:anchor`);x(r,me),S(()=>{let e=E(M,{title:`shift append vs shift replace`,summary:`Shift 的基础语义是先选一个节点，再 Shift 选另一个节点，中间连续区间都会选中；append / replace 只决定当前额外选择是否保持。`,tab:L.directoryRange,code:Ye,preview:k(`div`,{className:`space-y-4 not-prose`,children:[k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[A(`div`,{children:`基础行为：先单击 alpha.ts，再按住 Shift 单击 epsilon.ts，alpha.ts 到 epsilon.ts 都会选中。`}),A(`div`,{className:`mt-2`,children:`append / replace 只影响当前额外非连续选择是否保持：重置后先单击 beta.ts，再按住 Cmd / Ctrl 单击 epsilon.ts，最后按住 Shift 单击 delta.ts。`}),A(`div`,{className:`mt-2`,children:`append 会保持 beta.ts；replace 只保持 delta.ts 到 epsilon.ts 这一段。`}),A(`button`,{type:`button`,className:`btn btn-ghost btn-xs mt-3`,onClick:ce,children:`重置两边示例`})]}),k(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[k(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[k(`div`,{className:`flex items-center justify-between gap-3`,children:[k(`div`,{children:[A(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="append"`}),A(`div`,{className:`text-xs text-base-content/55`,children:`保持原先的非连续选择，再并入新的 shift 区间。`})]}),A(`span`,{className:`badge badge-outline badge-sm`,children:`append`})]}),A(q.DirectoryTree,{treeData:Be,selectedKeys:l.value,multiple:!0,toggleSelect:!0,rangeSelect:`append`,onSelect:e=>{l.value=e}},`append-${p.value}`),k(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:l.value.length?l.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]}),k(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[k(`div`,{className:`flex items-center justify-between gap-3`,children:[k(`div`,{children:[A(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="replace"`}),A(`div`,{className:`text-xs text-base-content/55`,children:`只保持新的 shift 区间，基础的非连续选择会被替换掉。`})]}),A(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:`replace`})]}),A(q.DirectoryTree,{treeData:Be,selectedKeys:d.value,multiple:!0,toggleSelect:!0,rangeSelect:`replace`,onSelect:e=>{d.value=e}},`replace-${p.value}`),k(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:d.value.length?d.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]})]})]})});C(()=>T(e,r,me))});let he=u(`rue:component:anchor`);x(r,he),S(()=>{let e=E(M,{title:`父子联动与半选态`,summary:`这一块只看级联勾选和 halfChecked，不再混入 disabled / disableCheckbox，点击父节点时能直接看到整棵子树联动。`,tab:L.checkable,code:We,preview:k(`div`,{className:`space-y-4 not-prose`,children:[A(q,{treeData:Ie,selectedKeys:m.value,checkedKeys:g.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onSelect:e=>{m.value=e},onCheck:(e,t)=>{g.value=tt(e),_.value=nt(e,t)}}),k(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:m.value.length?m.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`当前没有选中节点`})})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`checkedKeys`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:g.value.map(e=>A(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:String(e)},String(e)))})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`halfCheckedKeys`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:_.value.length?_.value.map(e=>A(`span`,{className:`badge badge-ghost badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`当前没有半选`})})]})]})]})});C(()=>T(e,r,he))});let ge=u(`rue:component:anchor`);x(r,ge),S(()=>{let e=E(M,{title:`禁用节点与禁用复选框`,summary:`把 disabled 和 disableCheckbox 单独拆出来看：前者整节点只读，后者只禁用勾选框，不再干扰联动示例。`,tab:L.checkableDisabled,code:Ge,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q,{treeData:Le,checkedKeys:b.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onCheck:e=>{b.value=tt(e)}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前勾选`}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:b.value.length?b.value.map(e=>A(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):A(`span`,{className:`text-sm text-base-content/55`,children:`当前没有勾选`})})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[A(`div`,{className:`font-medium text-base-content`,children:`disabled`}),A(`div`,{className:`mt-2`,children:`整节点不可展开、不可选中、不可勾选，适合只读目录或冻结配置。`})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[A(`div`,{className:`font-medium text-base-content`,children:`disableCheckbox`}),A(`div`,{className:`mt-2`,children:`节点仍能展示和展开，但复选框不会参与交互，适合“只可浏览不可授权”的条目。`})]})]})]})});C(()=>T(e,r,ge))});let _e=u(`rue:component:anchor`);x(r,_e),S(()=>{let e=E(M,{title:`Simple Mode + Search`,summary:`扁平数据直入后，内置搜索会保持命中节点的祖先链，不会把层级上下文切断。`,tab:L.simple,code:Ke,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q,{treeData:Re,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{title:`name`,key:`code`},selectedKeys:ee.value,allowSearch:!0,defaultExpandAll:!0,onSelect:e=>{ee.value=e}}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前选中：`,A(`code`,{children:JSON.stringify(ee.value)}),A(`div`,{className:`mt-3`,children:`这类 simple mode 很适合后端直接给 id / pId 的菜单、流程节点和权限项，不需要再先做一遍树转换。`})]})]})});C(()=>T(e,r,_e))});let ve=u(`rue:component:anchor`);x(r,ve),S(()=>{let e=E(M,{title:`Async Load 与自定义标题`,summary:`第一次展开时再拉子节点，同时用 titleRender 和 icon 把状态信息塞回每一行。`,tab:L.async,code:qe,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,26rem),1fr] lg:items-start`,children:[A(q,{treeData:ae.value,selectedKeys:O.value,expandedKeys:te.value,loadData:se,showLine:!0,showIcon:!0,blockNode:!0,titleRender:({node:e,loading:t})=>k(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[A(`span`,{className:`truncate`,children:e.title}),A(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`branch`:`leaf`})]}),onSelect:e=>{O.value=e},onExpand:e=>{te.value=e}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`expandedKeys`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(te.value)})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(O.value)})]}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`展开 release-bus 后才会注入桌面端和移动端节点，适合远端目录、超大权限树和发布范围配置。`})]})]})});C(()=>T(e,r,ve))});let K=y(`div`,r);x(r,K),c(K,`not-prose mt-10 space-y-2`);let ye=y(`h2`,K);x(K,ye),c(ye,`text-2xl font-semibold`),x(ye,h(`更重交互`));let be=y(`p`,K);x(K,be),c(be,`text-sm text-base-content/70`),x(be,h(`当 Tree 既要承载拖拽整理，又要承载超长数据时，draggable 和 virtual 就是两个最关键的控制面。`));let xe=u(`rue:component:anchor`);x(r,xe),S(()=>{let e=E(M,{title:`allowDrop 策略与拖拽占位`,summary:`allowDrop 可以把 folder / file 的落点规则写清楚；hover 时 Tree 会直接给出插前、插后或放入占位提示。`,tab:L.drag,code:Xe,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q,{treeData:ne.value,draggable:!0,blockNode:!0,defaultExpandAll:!0,allowDrop:({dropNode:e,dropToGap:t})=>t||e.raw.kind!==`file`,titleRender:({node:e})=>k(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[A(`span`,{className:`truncate`,children:e.title}),A(`span`,{className:e.raw.kind===`folder`?`badge badge-ghost badge-xs`:`badge badge-outline badge-xs`,children:e.raw.kind})]}),onDrop:e=>{ne.value=ot(ne.value,e),re.value=`${String(e.dragNode.key)} -> ${String(e.node.key)} (${e.dropToGap?e.dropPosition<0?`before`:`after`:`inside`})`}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`最近一次拖拽`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:re.value})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`allowDrop 规则`}),k(`div`,{className:`mt-2 grid gap-2 text-sm text-base-content/75`,children:[A(`div`,{children:`folder：允许放入，也允许插前 / 插后。`}),A(`div`,{children:`file：只允许插前 / 插后，不允许作为 inside 目标。`})]})]}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`拖到 folder 正中央会看到“放入”，拖到行的上沿或下沿则会出现“插前 / 插后”；如果目标是 file，inside 落点会被 allowDrop 直接拦掉。`})]})]})});C(()=>T(e,r,xe))});let Se=u(`rue:component:anchor`);x(r,Se),S(()=>{let e=E(M,{title:`Virtual Scroll`,summary:`长列表下只渲染可见窗口，height 和 itemHeight 负责限定视口和估算切片范围。`,tab:L.virtual,code:Ze,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q,{treeData:He,selectedKeys:N.value,height:320,itemHeight:42,virtual:!0,blockNode:!0,onSelect:e=>{N.value=e}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`数据量`}),A(`div`,{className:`mt-2 text-2xl font-semibold`,children:He.length})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(N.value)})]}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`对文档页目录、埋点树、批量资源目录这种长列表场景，虚拟滚动能显著降低初始渲染压力。`})]})]})});C(()=>T(e,r,Se))});let Ce=u(`rue:component:anchor`);x(r,Ce),S(()=>{let e=E(M,{title:`Virtual + Async Load 场景页`,summary:`把 virtual、height、itemHeight 和 loadData 合在一起，就能接超长目录或资源树，只在展开分支时再注入子节点。`,tab:L.virtualAsync,code:Qe,preview:k(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[A(q,{treeData:P.value,selectedKeys:ie.value,expandedKeys:F.value,height:340,itemHeight:40,virtual:!0,showIcon:!0,blockNode:!0,loadData:R,titleRender:({node:e,loading:t})=>k(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[A(`span`,{className:`truncate`,children:e.title}),A(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`loaded`:e.isLeaf?`leaf`:`lazy`})]}),onSelect:e=>{ie.value=e},onExpand:e=>{F.value=e}}),k(`div`,{className:`space-y-3`,children:[k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`根节点数量`}),A(`div`,{className:`mt-2 text-2xl font-semibold`,children:P.value.length})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`已加载分支`}),A(`div`,{className:`mt-2 text-2xl font-semibold`,children:I.get()})]}),k(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[A(`div`,{className:`text-xs text-base-content/45`,children:`当前展开`}),A(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(F.value)})]}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`先滚动到较深位置再展开节点也没问题：视口外的行不会真正渲染，只有命中的 branch 才会触发 loadData 注入子节点。`})]})]})});C(()=>T(e,r,Ce))});let we=u(`rue:component:anchor`);x(r,we),S(()=>{let e=E(M,{title:`展示基础递归 示例`,summary:`基础的 TreeView 行为没有删掉，只是并进 design 页面里，方便对比“直接改数据”这类递归写法。`,tab:L.legacy,code:$e,preview:A(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm not-prose`,children:k(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,1fr),18rem] lg:items-start`,children:[A(`ul`,{className:`m-0 grid gap-1 p-0`,children:A(lt,{model:oe})}),A(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`单击切换展开，双击叶子节点会把它转换成 folder，并在当前层直接追加一个新子节点。`})]})})});C(()=>T(e,r,we))});let Te=y(`div`,r);x(r,Te),c(Te,`not-prose mt-10 space-y-4`);let Ee=y(`h2`,Te);x(Te,Ee),c(Ee,`text-2xl font-semibold`),x(Ee,h(`API`));let De=u(`rue:component:anchor`);return x(Te,De),S(()=>{let e=E(Pe,{rows:et});C(()=>T(e,Te,De))}),t})}),r,i),r})};export{ut as default};