...
`,Demo:()=>{let{route:t,demo:n,historyRecords:ee,historyRecorderCleanup:w,appendHistoryRecord:T,currentPath:E,currentPage:D,expectedQuery:ie,resetStoreQuery:ae,clearAllUrlParams:oe}=C(`useSetup:0:0`,()=>c(()=>{let e=re(),t=we(),n=C(`ref:1:4`,()=>S([])),r=C(`ref:1:5`,()=>S(null)),i=(e,t)=>{be+=1,n.value=[{id:be,kind:e,href:t},...n.value].slice(0,_e)};v(()=>{r.value=Ce(i)}),f(()=>{r.value?.(),t.clampEffect.dispose(),t.root.dispose()});let a=e.get()?.path||`/examples/store-query-sync`,o=C(`computed:1:6`,()=>x(()=>Math.min(Math.max(1,t.store.page),t.totalPages.get()))),s=C(`computed:1:7`,()=>x(()=>X(t.store))),c=()=>{t.store.search=``,t.store.tab=`all`,t.store.page=1};return{route:e,demo:t,historyRecords:n,historyRecorderCleanup:r,appendHistoryRecord:i,currentPath:a,currentPage:o,expectedQuery:s,resetStoreQuery:c,clearAllUrlParams:()=>{if(c(),typeof window>`u`||!window.history)return;let e=new URL(window.location.href);e.search=``,window.history.replaceState(window.history.state,``,`${e.pathname}${e.search}${e.hash}`)}}}));return p(t=>{let c=u(`div`,t);m(c,`grid gap-6`);let f=u(`div`,c);o(c,f),m(f,`card bg-base-100 shadow`);let v=u(`div`,f);o(f,v),m(v,`card-body gap-4`);let x=u(`div`,v);o(v,x),m(x,`flex flex-wrap items-start justify-between gap-3`);let S=u(`div`,x);o(x,S),m(S,`space-y-2`);let C=u(`h2`,S);o(S,C),m(C,`text-2xl font-semibold`),o(C,b(`Store、Router、Query Sync 串联演示`));let re=u(`p`,S);o(S,re),m(re,`max-w-3xl text-sm leading-6 text-base-content/75`),o(re,b(`搜索框走 500ms debounce，分类和分页走 throttle + history push。页面路径由 Router 控制，查询参数由 Store Query Sync 控制，二者共享同一条可分享链接。`));let w=u(`div`,x);o(x,w),m(w,`flex flex-wrap gap-2 text-xs`);let T=u(`span`,w);o(w,T),m(T,`rounded-full bg-base-200 px-3 py-1 font-medium`),o(T,b(`当前路由：`));let O=r(`rue:slot:anchor`);o(T,O),i(()=>{let e=E;a(()=>_(e,T,O))});let k=u(`span`,w);o(w,k),m(k,`rounded-full bg-base-200 px-3 py-1 font-medium`),o(k,b(`预期 Query：`));let se=r(`rue:slot:anchor`);o(k,se),i(()=>{let e=ie.get();a(()=>_(e,k,se))});let A=u(`div`,v);o(v,A),m(A,`flex flex-wrap gap-2`);let j=u(`a`,A);o(A,j),i(()=>{y(j,`href`,String(ne.__rueHref(`${E}?q=router&tab=router&page=1`)))}),s(j,`click`,e=>ne.__rueOnClick(e,`${E}?q=router&tab=router&page=1`,!1)),m(j,`btn btn-sm btn-outline`),o(j,b(`Router 预设`));let M=u(`a`,A);o(A,M),i(()=>{y(M,`href`,String(ne.__rueHref(`${E}?q=sync&tab=store&page=1`)))}),s(M,`click`,e=>ne.__rueOnClick(e,`${E}?q=sync&tab=store&page=1`,!1)),m(M,`btn btn-sm btn-outline`),o(M,b(`Store 预设`));let N=u(`a`,A);o(A,N),i(()=>{y(N,`href`,String(ne.__rueHref(`${E}?q=render&tab=runtime&page=1`)))}),s(N,`click`,e=>ne.__rueOnClick(e,`${E}?q=render&tab=runtime&page=1`,!1)),m(N,`btn btn-sm btn-outline`),o(N,b(`Runtime 预设`));let P=u(`button`,A);o(A,P),m(P,`btn btn-sm btn-ghost`),s(P,`click`,ae),o(P,b(`清空 Query`));let F=u(`button`,A);o(A,F),m(F,`btn btn-sm btn-ghost`),s(F,`click`,oe),o(F,b(`清理所有 URL 参数`));let I=u(`div`,c);o(c,I),m(I,`grid gap-6`);let ce=u(`div`,I);o(I,ce),m(ce,`card bg-base-100 shadow`);let L=u(`div`,ce);o(ce,L),m(L,`card-body gap-4`);let R=u(`label`,L);o(L,R),m(R,`form-control gap-2`);let le=u(`span`,R);o(R,le),m(le,`label-text font-medium`),o(le,b(`搜索（debounce 500ms）`));let z=u(`input`,R);o(R,z),m(z,`input input-bordered`),i(()=>{h(z,n.store.search)}),s(z,`input`,e=>{n.store.search=e.target.value,n.store.page=1}),y(z,`placeholder`,`例如：router / sync / render`);let B=u(`div`,L);o(L,B),m(B,`grid gap-2`);let V=u(`span`,B);o(B,V),m(V,`label-text font-medium`),o(V,b(`分类（throttle 180ms + push）`));let H=u(`div`,B);o(B,H),m(H,`flex flex-wrap gap-2`);let ue=r(`rue:list:start`),de=r(`rue:list:end`);o(H,ue),o(H,de);let U=new Map;i(()=>{U=te({items:ye||[],getKey:(e,t)=>e.id,elements:U,parent:H,before:de,singleRoot:!0,trackIndex:!1,start:ue,renderItem:(t,c,l,d,f)=>{_(p(()=>{let c=e(),l=u(`button`,c);o(c,l),i(()=>{y(l,`key`,String(t.id))}),i(()=>{m(l,`btn btn-sm ${n.store.tab===t.id?`btn-primary`:`btn-outline`}`)}),s(l,`click`,()=>{n.store.tab=t.id,n.store.page=1});let d=r(`rue:slot:anchor`);return o(l,d),i(()=>{let e=t.label;a(()=>_(e,l,d))}),c}),c,l)}})});let fe=u(`p`,B);o(B,fe),m(fe,`text-xs leading-5 text-base-content/60`);let pe=g(fe);o(fe,pe),i(()=>{d(pe,ye.find(e=>e.id===n.store.tab)?.hint)});let W=u(`div`,L);o(L,W),m(W,`grid gap-2`);let me=u(`span`,W);o(W,me),m(me,`label-text font-medium`),o(me,b(`分页（throttle 180ms + push）`));let G=u(`div`,W);o(W,G),m(G,`flex items-center gap-2`);let K=u(`button`,G);o(G,K),m(K,`btn btn-sm btn-outline`),i(()=>{l(K,D.get()<=1)}),s(K,`click`,()=>{n.store.page=Math.max(1,D.get()-1)}),o(K,b(`上一页`));let q=u(`span`,G);o(G,q),m(q,`min-w-24 text-center text-sm font-medium`),o(q,b(`第 `));let he=r(`rue:slot:anchor`);o(q,he),i(()=>{let e=D.get();a(()=>_(e,q,he))}),o(q,b(` / `));let ge=r(`rue:slot:anchor`);o(q,ge),i(()=>{let e=n.totalPages.get();a(()=>_(e,q,ge))}),o(q,b(` 页`));let J=u(`button`,G);o(G,J),m(J,`btn btn-sm btn-outline`),i(()=>{l(J,D.get()>=n.totalPages.get())}),s(J,`click`,()=>{n.store.page=Math.min(n.totalPages.get(),D.get()+1)}),o(J,b(`下一页`));let Y=u(`div`,L);o(L,Y),m(Y,`rounded-2xl border border-base-200 bg-base-200/40 p-4 text-sm leading-6 text-base-content/70`);let _e=u(`p`,Y);o(Y,_e),o(_e,b(`本地状态会立刻刷新卡片列表。`));let ve=u(`p`,Y);o(Y,ve),o(ve,b(`地址栏会按 debounce 或 throttle 的规则延后追上。`));let be=u(`p`,Y);o(Y,be),o(be,b(`上面的预设链接会保持同一路由，只替换 query，用浏览器后退能看到 push 历史回放。`));let xe=u(`p`,Y);o(Y,xe),o(xe,b(`下方记录面板会直接捕获 pushState、replaceState 和 popstate，方便确认“下一页”是否真的入栈。`));let X=u(`div`,L);o(L,X),m(X,`grid gap-2`);let Z=u(`div`,X);o(X,Z),m(Z,`flex flex-wrap items-center justify-between gap-2`);let Ce=u(`span`,Z);o(Z,Ce),m(Ce,`label-text font-medium`),o(Ce,b(`URL 写入记录`));let we=u(`span`,Z);o(Z,we),m(we,`text-xs text-base-content/60`),o(we,b(`分类 / 分页走 pushState，搜索走 replaceState。`));let Te=r(`rue:slot:anchor`);o(X,Te),i(()=>{let t=ee.value.length?p(()=>{let t=e(),n=u(`ul`,t);o(t,n),m(n,`rounded-2xl border border-base-200 bg-base-100`);let s=r(`rue:list:start`),c=r(`rue:list:end`);o(n,s),o(n,c);let l=new Map;return i(()=>{l=te({items:ee.value||[],getKey:(e,t)=>e.id,elements:l,parent:n,before:c,singleRoot:!0,trackIndex:!1,start:s,renderItem:(t,n,s,c,l)=>{_(p(()=>{let n=e(),s=u(`li`,n);o(n,s),i(()=>{y(s,`key`,String(t.id))}),m(s,`flex flex-wrap items-center gap-2 border-b border-base-200 px-4 py-3 text-sm last:border-b-0`);let c=u(`span`,s);o(s,c),i(()=>{m(c,`badge badge-sm ${t.kind===`push`?`badge-primary`:t.kind===`replace`?`badge-ghost`:`badge-outline`}`)});let l=r(`rue:slot:anchor`);o(c,l),i(()=>{let e=Se(t.kind);a(()=>_(e,c,l))});let d=u(`span`,s);o(s,d),m(d,`font-mono text-xs text-base-content/70`);let f=r(`rue:slot:anchor`);return o(d,f),i(()=>{let e=t.href;a(()=>_(e,d,f))}),n}),n,s)}})}),t}):p(()=>{let t=e(),n=u(`div`,t);return o(t,n),m(n,`rounded-2xl border border-dashed border-base-300 p-4 text-sm text-base-content/60`),o(n,b(`暂无 URL 写入记录。点击“下一页”或切换分类后，会在这里看到入栈结果。`)),t});a(()=>_(t,X,Te))});let Ee=u(`div`,I);o(I,Ee),m(Ee,`card bg-base-100 shadow`);let De=u(`div`,Ee);o(Ee,De),m(De,`card-body gap-4`);let Oe=u(`div`,De);o(De,Oe),m(Oe,`flex flex-col gap-3`);let ke=u(`div`,Oe);o(Oe,ke);let Ae=u(`h3`,ke);o(ke,Ae),m(Ae,`text-xl font-semibold`),o(Ae,b(`筛选结果`));let Q=u(`p`,ke);o(ke,Q),m(Q,`text-sm text-base-content/70`),o(Q,b(`共 `));let je=r(`rue:slot:anchor`);o(Q,je),i(()=>{let e=n.filteredItems.get().length;a(()=>_(e,Q,je))}),o(Q,b(` 条，当前展示 `));let Me=r(`rue:slot:anchor`);o(Q,Me),i(()=>{let e=n.visibleItems.get().length;a(()=>_(e,Q,Me))});let Ne=g(Q);o(Q,Ne),d(Ne,` `),o(Q,b(`条。`));let $=u(`div`,Oe);o(Oe,$),m($,`flex flex-wrap gap-2 text-xs`);let Pe=u(`span`,$);o($,Pe),m(Pe,`rounded-full bg-base-200 px-3 py-1`),o(Pe,b(`search=`));let Fe=r(`rue:slot:anchor`);o(Pe,Fe),i(()=>{let e=n.store.search||`(空)`;a(()=>_(e,Pe,Fe))});let Ie=u(`span`,$);o($,Ie),m(Ie,`rounded-full bg-base-200 px-3 py-1`),o(Ie,b(`tab=`));let Le=r(`rue:slot:anchor`);o(Ie,Le),i(()=>{let e=n.store.tab;a(()=>_(e,Ie,Le))});let Re=u(`span`,$);o($,Re),m(Re,`rounded-full bg-base-200 px-3 py-1`),o(Re,b(`page=`));let ze=r(`rue:slot:anchor`);o(Re,ze),i(()=>{let e=D.get();a(()=>_(e,Re,ze))});let Be=r(`rue:slot:anchor`);return o(De,Be),i(()=>{let t=n.visibleItems.get().length?p(()=>{let t=e(),s=u(`div`,t);o(t,s),m(s,`grid gap-3 md:grid-cols-2 xl:grid-cols-3`);let c=r(`rue:list:start`),l=r(`rue:list:end`);o(s,c),o(s,l);let d=new Map;return i(()=>{d=te({items:n.visibleItems.get()||[],getKey:(e,t)=>e.id,elements:d,parent:s,before:l,singleRoot:!0,trackIndex:!1,start:c,renderItem:(t,n,s,c,l)=>{_(p(()=>{let n=e(),s=u(`article`,n);o(n,s),i(()=>{y(s,`key`,String(t.id))}),m(s,`rounded-2xl border border-base-200 bg-gradient-to-br from-base-100 to-base-200/70 p-4`);let c=u(`div`,s);o(s,c),m(c,`mb-3 flex items-center justify-between gap-3`);let l=u(`span`,c);o(c,l),m(l,`badge badge-outline`);let d=r(`rue:slot:anchor`);o(l,d),i(()=>{let e=t.badge;a(()=>_(e,l,d))});let f=u(`span`,c);o(c,f),m(f,`text-xs text-base-content/50`);let p=r(`rue:slot:anchor`);o(f,p),i(()=>{let e=t.id;a(()=>_(e,f,p))});let h=u(`h4`,s);o(s,h),m(h,`text-base font-semibold leading-6`);let g=r(`rue:slot:anchor`);o(h,g),i(()=>{let e=t.title;a(()=>_(e,h,g))});let v=u(`p`,s);o(s,v),m(v,`mt-2 text-sm leading-6 text-base-content/70`);let b=r(`rue:slot:anchor`);return o(v,b),i(()=>{let e=t.teaser;a(()=>_(e,v,b))}),n}),n,s)}})}),t}):p(()=>{let t=e(),n=u(`div`,t);return o(t,n),m(n,`rounded-2xl border border-dashed border-base-300 p-8 text-center text-sm text-base-content/60`),o(n,b(`当前筛选没有命中结果。尝试清空搜索词，或者切回“全部”分类。`)),t});a(()=>_(t,De,Be))}),c})},codeCardClassName:`h-[520px] md:h-[1220px]`});export{Te as default};