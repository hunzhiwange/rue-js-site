...
/>`});l(()=>f(e,d,z))});let B=r(`h2`,d);i(d,B),s(B,`id`,`mockup-phone-api`),i(B,o(`API`));let V=r(`p`,d);i(d,V),i(V,o(`MockupPhone 现在支持“根级简写模式”和“经典 compound 模式”两套写法。`));let me=r(`h3`,d);i(d,me),i(me,o(`MockupPhone`));let he=e(`rue:component:anchor`);i(d,he),h(()=>{let e=m(te,{rows:ne});l(()=>f(e,d,he))});let H=r(`h3`,d);i(d,H),n(H,`mt-6`),i(H,o(`Compound Parts`));let ge=e(`rue:component:anchor`);i(d,ge),h(()=>{let e=m(te,{rows:re});l(()=>f(e,d,ge))});let U=r(`div`,d);i(d,U),n(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=r(`h3`,U);i(U,W),n(W,`mt-0 mb-3 text-base font-semibold`),i(W,o(`display 对象结构`));let G=r(`div`,U);i(U,G),n(G,`grid gap-2 text-sm md:grid-cols-2`);let K=r(`div`,G);i(G,K);let _e=r(`code`,K);i(K,_e),i(_e,o(`className`)),i(K,o(`：显示区根节点类名`));let q=r(`div`,G);i(G,q);let ve=r(`code`,q);i(q,ve),i(ve,o(`src`)),i(q,o(`/`));let ye=r(`code`,q);i(q,ye),i(ye,o(`alt`)),i(q,o(`/`));let be=r(`code`,q);i(q,be),i(be,o(`imgClassName`)),i(q,o(`：内置壁纸图`));let J=r(`div`,G);i(G,J);let xe=r(`code`,J);i(J,xe),i(xe,o(`children`)),i(J,o(`：显示区内容`));let Y=r(`div`,G);i(G,Y);let Se=r(`code`,Y);i(Y,Se),i(Se,o(`contentClassName`)),i(Y,o(`：为 children 额外包一层容器，便于做绝对定位和覆盖层`));let Ce=r(`h2`,d);i(d,Ce),i(Ce,o(`FAQ`));let we=r(`h3`,d);i(d,we),i(we,o(`什么时候用 display，什么时候继续写 MockupPhone.Display？`));let X=r(`p`,d);i(d,X),i(X,o(`如果只是想快速搭一个手机画面，优先用`));let Te=r(`code`,X);i(X,Te),i(Te,o(`display`)),i(X,o(`。如果你需要自己决定显示区里的完整节点树，或者已经在复用旧 demo，继续用`));let Ee=r(`code`,X);i(X,Ee),i(Ee,o(`MockupPhone.Camera`)),i(X,o(`和`));let De=r(`code`,X);i(X,De),i(De,o(`MockupPhone.Display`)),i(X,o(`会更直观。`));let Oe=r(`h3`,d);i(d,Oe),i(Oe,o(`color 和 className 应该怎么选？`));let Z=r(`p`,d);i(d,Z);let Q=r(`code`,Z);i(Z,Q),i(Q,o(`color`)),i(Z,o(`负责常用边框主题色，适合快速选主色；`));let ke=r(`code`,Z);i(Z,ke),i(ke,o(`className`));let Ae=g(Z);i(Z,Ae),a(Ae,` `),i(Z,o(`负责更细的样式控制，比如任意十六进制边框色、自定义阴影或缩放。`));let je=r(`h3`,d);i(d,je),i(je,o(`如何在壁纸上叠加浮层内容？`));let $=r(`p`,d);i(d,$),i($,o(`让`));let Me=r(`code`,$);i($,Me),i(Me,o(`display.className`)),i($,o(`具备`));let Ne=r(`code`,$);i($,Ne),i(Ne,o(`relative`)),i($,o(`和`));let Pe=g($);i($,Pe),a(Pe,` `);let Fe=r(`code`,$);i($,Fe),i(Fe,o(`overflow-hidden`)),i($,o(`，再把浮层内容放进`));let Ie=r(`code`,$);i($,Ie),i(Ie,o(`children`)),i($,o(`，通过`));let Le=r(`code`,$);i($,Le),i(Le,o(`contentClassName`)),i($,o(`设置`));let Re=g($);i($,Re),a(Re,` `);let ze=r(`code`,$);return i($,ze),i(ze,o(`absolute inset-0`)),i($,o(`即可。`)),c})}),p,_),p})};export{P as default};