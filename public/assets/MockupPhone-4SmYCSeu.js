...
/>`});t(()=>m(e,l,R))});let z=e(`h2`,l);a(l,z),f(z,`id`,`mockup-phone-api`),a(z,c(`API`));let B=e(`p`,l);a(l,B),a(B,c(`MockupPhone 现在支持“根级简写模式”和“经典 compound 模式”两套写法。`));let V=e(`h3`,l);a(l,V),a(V,c(`MockupPhone`));let pe=o(`rue:component:anchor`);a(l,pe),i(()=>{let e=h(te,{rows:ne});t(()=>m(e,l,pe))});let H=e(`h3`,l);a(l,H),s(H,`mt-6`),a(H,c(`Compound Parts`));let me=o(`rue:component:anchor`);a(l,me),i(()=>{let e=h(te,{rows:re});t(()=>m(e,l,me))});let U=e(`div`,l);a(l,U),s(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=e(`h3`,U);a(U,W),s(W,`mt-0 mb-3 text-base font-semibold`),a(W,c(`display 对象结构`));let G=e(`div`,U);a(U,G),s(G,`grid gap-2 text-sm md:grid-cols-2`);let K=e(`div`,G);a(G,K);let he=e(`code`,K);a(K,he),a(he,c(`className`)),a(K,c(`：显示区根节点类名`));let q=e(`div`,G);a(G,q);let ge=e(`code`,q);a(q,ge),a(ge,c(`src`)),a(q,c(`/`));let _e=e(`code`,q);a(q,_e),a(_e,c(`alt`)),a(q,c(`/`));let ve=e(`code`,q);a(q,ve),a(ve,c(`imgClassName`)),a(q,c(`：内置壁纸图`));let J=e(`div`,G);a(G,J);let ye=e(`code`,J);a(J,ye),a(ye,c(`children`)),a(J,c(`：显示区内容`));let Y=e(`div`,G);a(G,Y);let be=e(`code`,Y);a(Y,be),a(be,c(`contentClassName`)),a(Y,c(`：为 children 额外包一层容器，便于做绝对定位和覆盖层`));let xe=e(`h2`,l);a(l,xe),a(xe,c(`FAQ`));let Se=e(`h3`,l);a(l,Se),a(Se,c(`什么时候用 display，什么时候继续写 MockupPhone.Display？`));let X=e(`p`,l);a(l,X),a(X,c(`如果只是想快速搭一个手机画面，优先用`));let Ce=e(`code`,X);a(X,Ce),a(Ce,c(`display`)),a(X,c(`。如果你需要自己决定显示区里的完整节点树，或者已经在复用旧 demo，继续用`));let we=e(`code`,X);a(X,we),a(we,c(`MockupPhone.Camera`)),a(X,c(`和`));let Te=e(`code`,X);a(X,Te),a(Te,c(`MockupPhone.Display`)),a(X,c(`会更直观。`));let Ee=e(`h3`,l);a(l,Ee),a(Ee,c(`color 和 className 应该怎么选？`));let Z=e(`p`,l);a(l,Z);let De=e(`code`,Z);a(Z,De),a(De,c(`color`)),a(Z,c(`负责常用边框主题色，适合快速选主色；`));let Oe=e(`code`,Z);a(Z,Oe),a(Oe,c(`className`));let Q=g(Z);a(Z,Q),d(Q,` `),a(Z,c(`负责更细的样式控制，比如任意十六进制边框色、自定义阴影或缩放。`));let ke=e(`h3`,l);a(l,ke),a(ke,c(`如何在壁纸上叠加浮层内容？`));let $=e(`p`,l);a(l,$),a($,c(`让`));let Ae=e(`code`,$);a($,Ae),a(Ae,c(`display.className`)),a($,c(`具备`));let je=e(`code`,$);a($,je),a(je,c(`relative`)),a($,c(`和`));let Me=g($);a($,Me),d(Me,` `);let Ne=e(`code`,$);a($,Ne),a(Ne,c(`overflow-hidden`)),a($,c(`，再把浮层内容放进`));let Pe=e(`code`,$);a($,Pe),a(Pe,c(`children`)),a($,c(`，通过`));let Fe=e(`code`,$);a($,Fe),a(Fe,c(`contentClassName`)),a($,c(`设置`));let Ie=g($);a($,Ie),d(Ie,` `);let Le=e(`code`,$);return a($,Le),a(Le,c(`absolute inset-0`)),a($,c(`即可。`)),r})}),p,_),p})};export{F as default};