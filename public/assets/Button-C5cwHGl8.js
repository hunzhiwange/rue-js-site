...
</div>`});h(()=>u(e,c,ye))});let be=g(`rue:component:anchor`);e(c,be),t(()=>{let e=m(E,{title:`风格矩阵`,summary:`把基础的 soft、outline、dash 演示融合成统一的 type 展示。`,tab:w,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-5`,children:[ae.map(e=>b(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:e.label}),y(`div`,{className:`flex flex-wrap gap-2`,children:ie.map(t=>y(S,{color:t.color,type:e.variant,children:t.label},`${e.label}-${t.label}`))})]},e.label)),b(`div`,{className:`rounded-box bg-white p-4 text-black`,children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] text-black/60`,children:`Neutral on light surface`}),b(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{color:`neutral`,type:`outlined`,children:`Outline`}),y(S,{color:`neutral`,type:`dashed`,children:`Dash`})]})]})]})}),code:`const tones = [
  { label: 'Default' },
  { label: 'Neutral', color: 'neutral' },
  { label: 'Primary', color: 'primary' },
  { label: 'Secondary', color: 'secondary' },
...
</div>`});h(()=>u(e,c,be))});let xe=g(`rue:component:anchor`);e(c,xe),t(()=>{let e=m(E,{title:`危险态`,summary:`danger 是快捷开关，也可以直接通过 color='danger' 控制。`,tab:T,preview:()=>y(`div`,{className:`card bg-neutral text-neutral-content shadow-sm`,children:b(`div`,{className:`card-body flex flex-row flex-wrap items-center gap-2`,children:[y(S,{color:`danger`,children:`Delete forever`}),y(S,{color:`danger`,type:`outlined`,children:`Remove access`}),y(S,{color:`danger`,type:`filled`,children:`Archive branch`}),y(S,{color:`danger`,type:`text`,children:`Clear cache`})]})}),code:`<Button color="danger">Delete forever</Button>
        <Button color="danger" type="outlined">Remove access</Button>
        <Button color="danger" type="filled">Archive branch</Button>
        <Button color="danger" type="text">Clear cache</Button>`});h(()=>u(e,c,xe))});let Se=g(`rue:component:anchor`);e(c,Se),t(()=>{let e=m(E,{title:`图标与图标位置`,summary:`icon 和 iconPlacement 用来组织图标按钮与带文案按钮。`,tab:ee,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body flex flex-row flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,icon:y(te,{}),children:`Create project`}),y(S,{color:`secondary`,type:`outlined`,icon:y(O,{}),iconPlacement:`end`,children:`Continue`}),y(S,{color:`accent`,shape:`circle`,icon:y(k,{}),"aria-label":`收藏`}),y(S,{color:`info`,shape:`square`,icon:y(A,{}),"aria-label":`高亮`})]})}),code:`<Button color="primary" icon={<span>+</span>}>
  Create project
</Button>
...
<Button color="accent" shape="circle" icon={<span>♥</span>} aria-label="收藏" />`});h(()=>u(e,c,Se))});let Ce=g(`rue:component:anchor`);e(c,Ce),t(()=>{let e=m(E,{title:`加载状态`,summary:`loading 会锁定按钮；对象写法可以替换默认加载图标。`,tab:j,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body flex flex-row flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,loading:!0,children:`Saving`}),y(S,{type:`outlined`,loading:{icon:y(`span`,{className:`loading loading-dots loading-xs`})},children:`Syncing`}),y(S,{color:`success`,icon:y(ne,{}),children:`Ready to publish`})]})}),code:`<Button color="primary" loading>Saving</Button>
...
>
  Syncing
</Button>`});h(()=>u(e,c,Ce))});let we=g(`rue:component:anchor`);e(c,we),t(()=>{let e=m(E,{title:`点击事件`,summary:`onClick 会透传原生点击事件，适合命令触发、埋点和分组按钮内交互。`,tab:ue,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-4`,children:[b(`div`,{className:`flex flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,onClick:e=>{N.value+=1,P.value=`save:${e.currentTarget.tagName.toLowerCase()}`},children:`Trigger save`}),y(S,{type:`outlined`,onClick:e=>{N.value+=1,P.value=`preview:${e.currentTarget.tagName.toLowerCase()}`},children:`Preview draft`}),y(S,{href:`#button-api`,type:`link`,onClick:e=>{e.preventDefault(),N.value+=1,P.value=`link:${e.currentTarget.tagName.toLowerCase()}`},children:`Track jump`})]}),b(`div`,{className:`rounded-box bg-base-200/70 px-4 py-3 text-sm`,children:[b(`div`,{children:[`click count: `,N.value]}),b(`div`,{children:[`last action: `,P.value]})]})]})}),code:`const clickCount = ref(0)
...
</div>`});h(()=>u(e,c,we))});let Te=g(`rue:component:anchor`);e(c,Te),t(()=>{let e=m(E,{title:`尺寸与形状`,summary:`size 管尺寸，shape 管轮廓形态。`,tab:de,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-5`,children:[b(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Sizes`}),b(`div`,{className:`flex flex-wrap items-center gap-2`,children:[y(S,{size:`small`,children:`Small`}),y(S,{children:`Default`}),y(S,{size:`large`,color:`primary`,children:`Large`}),y(S,{size:`xs`,type:`outlined`,children:`XS`}),y(S,{size:`xl`,color:`secondary`,children:`XL`})]})]}),b(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Shapes`}),b(`div`,{className:`flex flex-wrap items-center gap-2`,children:[y(S,{color:`primary`,shape:`round`,children:`Round action`}),y(S,{color:`secondary`,shape:`square`,icon:y(A,{}),"aria-label":`square`}),y(S,{color:`accent`,shape:`circle`,icon:y(k,{}),"aria-label":`circle`})]})]})]})}),code:`<Button size="small">Small</Button>
...
<Button color="accent" shape="circle" icon={<span>♥</span>} />`});h(()=>u(e,c,Te))});let Ee=g(`rue:component:anchor`);e(c,Ee),t(()=>{let e=m(E,{title:`按钮组合`,summary:`提供与常见 ButtonGroup 类似的分组能力，这里统一用 Button.Group。`,tab:fe,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-6`,children:[b(`div`,{children:[y(`div`,{className:`mb-3 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Basic`}),b(`div`,{className:`flex flex-wrap items-center gap-3`,children:[b(S.Group,{children:[y(S,{children:`Cancel`}),y(S,{color:`primary`,children:`Confirm`})]}),b(S.Group,{children:[y(S,{disabled:!0,children:`Yesterday`}),y(S,{disabled:!0,children:`Today`}),y(S,{disabled:!0,children:`Tomorrow`})]}),b(S.Group,{children:[y(S,{color:`primary`,children:`L`}),y(S,{children:`M`}),y(S,{children:`M`}),y(S,{type:`dashed`,children:`R`})]})]})]}),b(`div`,{children:[y(`div`,{className:`mb-3 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Icons`}),b(`div`,{className:`flex flex-wrap items-center gap-3`,children:[b(S.Group,{children:[y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`←`}),children:`Backward`}),y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`→`}),iconPlacement:`end`,children:`Forward`})]}),b(S.Group,{children:[y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`«`}),"aria-label":`skip backward`}),y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`»`}),"aria-label":`skip forward`})]}),b(S.Group,{children:[y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`✦`}),"aria-label":`magic`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`☀`}),"aria-label":`sunny`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`✂`}),"aria-label":`crop`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`⛶`}),"aria-label":`filter`})]})]})]}),b(`div`,{children:[y(`div`,{className:`mb-3 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Circle`}),b(`div`,{className:`flex flex-wrap items-center gap-3`,children:[b(S.Group,{shape:`circle`,children:[y(S,{color:`primary`,children:`Backward`}),y(S,{color:`primary`,children:`Forward`})]}),b(S.Group,{shape:`circle`,children:[y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`«`}),"aria-label":`circle backward`}),y(S,{color:`primary`,icon:y(`span`,{"aria-hidden":`true`,children:`»`}),"aria-label":`circle forward`})]}),b(S.Group,{shape:`circle`,children:[y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`✦`}),"aria-label":`circle magic`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`☀`}),"aria-label":`circle sunny`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`✂`}),"aria-label":`circle crop`}),y(S,{icon:y(`span`,{"aria-hidden":`true`,children:`⛶`}),"aria-label":`circle filter`})]})]})]}),b(`div`,{children:[y(`div`,{className:`mb-3 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Size`}),b(`div`,{className:`space-y-3`,children:[b(`div`,{className:`flex flex-wrap items-center gap-3`,children:[b(S.Group,{size:`large`,children:[y(S,{children:`Large`}),y(S,{children:`Large`})]}),b(S.Group,{children:[y(S,{children:`Default`}),y(S,{children:`Default`})]}),b(S.Group,{size:`small`,children:[y(S,{children:`Small`}),y(S,{children:`Small`})]})]}),b(`div`,{className:`flex flex-wrap items-center gap-3`,children:[b(S.Group,{size:`large`,shape:`circle`,children:[y(S,{children:`Large`}),y(S,{children:`Large`})]}),b(S.Group,{shape:`circle`,children:[y(S,{children:`Default`}),y(S,{children:`Default`})]}),b(S.Group,{size:`small`,shape:`circle`,children:[y(S,{children:`Small`}),y(S,{children:`Small`})]})]})]})]})]})}),code:`<div className="space-y-6">
  <div>
...
</div>`});h(()=>u(e,c,Ee))});let De=g(`rue:component:anchor`);e(c,De),t(()=>{let e=m(E,{title:`状态与布局`,summary:`把基础的 active、disabled、wide、block 示例也融合到当前页面。`,tab:pe,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-5`,children:[b(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`States`}),b(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{active:!0,children:`Active`}),y(S,{color:`primary`,active:!0,children:`Primary active`}),y(S,{disabled:!0,children:`Disabled`}),y(S,{href:`#button-api`,disabled:!0,children:`Disabled link`})]})]}),b(`div`,{children:[y(`div`,{className:`mb-2 text-xs font-medium uppercase tracking-[0.2em] opacity-60`,children:`Layout`}),b(`div`,{className:`flex flex-col gap-2 sm:max-w-sm`,children:[y(S,{wide:!0,children:`Wide button`}),y(S,{block:!0,color:`primary`,children:`Block button`})]})]})]})}),code:`<div className="flex flex-wrap gap-2">
...
</div>`});h(()=>u(e,c,De))});let Oe=g(`rue:component:anchor`);e(c,Oe),t(()=>{let e=m(E,{title:`根节点与表单行为`,summary:`默认渲染 button，同时保持链接根节点、div 根节点和表单行为示例。`,tab:me,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-4`,children:[b(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{children:`Native button`}),y(S,{href:`#button-api`,children:`Anchor`}),y(S,{as:`div`,type:`text`,children:`Div button`})]}),b(`div`,{className:`text-sm opacity-70`,children:[`submit count: `,M.value]}),b(`form`,{className:`flex flex-wrap items-center gap-2`,onSubmit:e=>{e.preventDefault(),M.value+=1},children:[y(S,{color:`primary`,htmlType:`submit`,children:`Submit form`}),y(S,{type:`outlined`,htmlType:`reset`,children:`Reset form`}),y(S,{href:`#button-api`,type:`link`,children:`Jump to API`})]})]})}),code:`const submitCount = ref(0)
...
</form>`});h(()=>u(e,c,Oe))});let ke=g(`rue:component:anchor`);e(c,ke),t(()=>{let e=m(E,{title:`场景组合`,summary:`把图标、变体、布局属性组合在一起，可以很快搭出操作条。`,tab:he,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-4`,children:[b(`div`,{className:`flex flex-wrap gap-2`,children:[y(S,{color:`primary`,icon:y(ne,{}),children:`Publish`}),y(S,{type:`outlined`,icon:y(O,{}),iconPlacement:`end`,children:`Preview`}),y(S,{type:`text`,icon:y(A,{}),children:`Save draft`})]}),b(`div`,{className:`grid gap-2 md:grid-cols-2`,children:[y(S,{block:!0,className:`justify-start bg-white text-base-content border-base-300`,icon:y(re,{}),children:`Continue with Email`}),y(S,{block:!0,color:`primary`,className:`justify-start`,icon:y(A,{}),children:`Continue with Rue ID`})]})]})}),code:`<div className="flex flex-wrap gap-2">
...
</div>`});h(()=>u(e,c,ke))});let Ae=g(`rue:component:anchor`);e(c,Ae),t(()=>{let e=m(E,{title:`登录按钮`,summary:`把基础的 provider 登录按钮演示融合回来，统一改成 icon + block + className 的新 API 写法。`,tab:ge,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body`,children:y(`div`,{className:`grid gap-2 md:grid-cols-2`,children:oe.map(e=>y(S,{block:!0,className:`justify-start ${e.className}`,icon:y(se,{text:e.icon,className:e.iconClassName}),children:e.label},e.label))})})}),code:`const loginButtons = [
