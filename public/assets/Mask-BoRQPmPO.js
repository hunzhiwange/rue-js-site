...
<Mask shape="circle" src="${j}" alt="circle" size="md" bordered />`});p(()=>u(e,l,y))});let w=i(`rue:component:anchor`);t(l,w),n(()=>{let e=d(V,{title:`Star variants`,summary:`保留星形与粗星形示例，增加 ring 和 hover，适合头像墙或精选内容。`,tab:h,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap gap-5`,children:F.map(e=>v(A,{shape:e,src:j,alt:e,size:`lg`,ring:!0,shadow:!0,interactive:!0},e))})}),code:`<Mask shape="star" src="${j}" alt="star" size="lg" ring shadow interactive />
<Mask shape="star-2" src="${j}" alt="star-2" size="lg" ring shadow interactive />`});p(()=>u(e,l,w))});let T=i(`rue:component:anchor`);t(l,T),n(()=>{let e=d(V,{title:`Triangle variants`,summary:`保留四向三角形示例，并通过统一尺寸让方向差异更好观察。`,tab:g,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap gap-5`,children:I.map(e=>v(A,{shape:e,src:j,alt:e,size:`lg`,bordered:!0,shadow:!0},e))})}),code:`<Mask shape="triangle" src="${j}" alt="triangle" size="lg" bordered shadow />
...
<Mask shape="triangle-4" src="${j}" alt="triangle-4" size="lg" bordered shadow />`});p(()=>u(e,l,T))});let E=i(`rue:component:anchor`);t(l,E),n(()=>{let e=d(V,{title:`Half modifiers and arbitrary host`,summary:`保留 half modifier 与任意宿主演示，并补上 start / end 语义别名。`,tab:b,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:_(`div`,{className:`card-body flex flex-wrap items-center gap-6`,children:[v(A,{shape:`star`,half:`1`,src:j,alt:`star half 1`,size:`lg`,ring:!0}),v(A,{shape:`star`,half:`2`,src:j,alt:`star half 2`,size:`lg`,ring:!0}),v(A,{shape:`diamond`,half:`start`,src:j,alt:`diamond start`,size:`lg`,bordered:!0}),v(A,{as:`div`,shape:`diamond`,tone:`primary`,size:`lg`,ring:!0,shadow:!0,className:`grid place-content-center text-sm font-semibold uppercase tracking-[0.2em]`,"data-testid":`mask-host-demo`,children:`Host`})]})}),code:`<Mask shape="star" half="1" src="${j}" alt="star half 1" size="lg" ring />
...
>
  Host
</Mask>`});p(()=>u(e,l,E))});let D=i(`rue:component:anchor`);t(l,D),n(()=>{let e=d(V,{title:`Semantic sizes`,summary:`新增尺寸别名，常见头像和封面尺寸不再需要每次都手写宽高 class。`,tab:x,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap items-end gap-5`,children:L.map(e=>_(`div`,{className:`flex flex-col items-center gap-3 text-xs uppercase tracking-[0.18em] opacity-80`,children:[v(A,{shape:`circle`,src:j,alt:e,size:e,ring:!0}),v(`span`,{children:e})]},e))})}),code:`<Mask shape="circle" src="${j}" alt="xs" size="xs" ring />
...
<Mask shape="circle" src="${j}" alt="2xl" size="2xl" ring />`});p(()=>u(e,l,D))});let O=i(`rue:component:anchor`);t(l,O),n(()=>{let e=d(V,{title:`Fit modes`,summary:`新增 fit 语义，宽图、竖图和封面图都能直接得到明确的裁切策略。`,tab:S,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body grid gap-6 md:grid-cols-3`,children:R.map(e=>_(`div`,{className:`space-y-3`,children:[v(`div`,{className:`text-xs font-semibold uppercase tracking-[0.18em] opacity-70`,children:e.label}),v(`div`,{className:`rounded-box bg-base-200 p-4`,children:v(A,{shape:`hexagon-2`,src:e.src,alt:e.label,size:`xl`,fit:e.fit,bordered:!0,className:`mx-auto`})})]},e.label))})}),code:`<Mask shape="hexagon-2" src="${M}" alt="cover" size="xl" fit="cover" bordered className="mx-auto" />
<Mask shape="hexagon-2" src="${N}" alt="contain" size="xl" fit="contain" bordered className="mx-auto" />
<Mask shape="hexagon-2" src="${M}" alt="fill" size="xl" fit="fill" bordered className="mx-auto" />`});p(()=>u(e,l,O))});let k=i(`rue:component:anchor`);t(l,k),n(()=>{let e=d(V,{title:`Tone surfaces`,summary:`新增 tone、ring、shadow 组合后，Mask 也能承担数字徽记、内容牌和亮点卡片的职责。`,tab:C,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:_(`div`,{className:`card-body gap-6`,children:[v(`div`,{className:`flex flex-wrap gap-4`,children:z.map(e=>v(A,{as:`div`,shape:`squircle`,tone:e.tone,size:`md`,ring:!0,className:`grid place-content-center text-center text-xs font-semibold uppercase tracking-[0.18em]`,children:e.label},e.label))}),_(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[v(A,{as:`div`,shape:`hexagon`,tone:`secondary`,size:`xl`,ring:!0,shadow:!0,interactive:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:_(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-3xl font-black`,children:`24`}),v(`div`,{className:`text-xs uppercase tracking-[0.22em] opacity-80`,children:`Launches`})]})}),v(A,{as:`div`,shape:`diamond`,tone:`accent`,size:`xl`,ring:!0,shadow:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:_(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-sm font-semibold uppercase tracking-[0.18em]`,children:`Featured`}),v(`div`,{className:`text-xs opacity-80`,children:`Rue Studio`})]})}),v(A,{as:`div`,shape:`circle`,tone:`success`,size:`xl`,ring:!0,shadow:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:_(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-2xl font-black`,children:`98%`}),v(`div`,{className:`text-xs uppercase tracking-[0.18em] opacity-80`,children:`Approval`})]})})]})]})}),code:`<div className="flex flex-wrap gap-4">
  <Mask
    as="div"
    shape="squircle"
    tone="base"
...
</div>`});p(()=>u(e,l,k))});let U=o(`div`,l);t(l,U),e(U,`my-8`);let W=o(`h2`,U);t(U,W),e(W,`mt-0`),t(W,r(`API`));let G=i(`rue:component:anchor`);return t(U,G),n(()=>{let e=d(H,{rows:B});p(()=>u(e,U,G))}),c})}),f,m),f})};export{U as default};