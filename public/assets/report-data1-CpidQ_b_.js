...
`,N=()=>l(g=>{let D=t(),re=r(`style`,D);i(D,re),f(()=>{a(re,Se)});let k=r(`div`,D);i(D,k),n(k,`report-data1-scope report-page`);let A=r(`section`,k);i(k,A),n(A,`report-hero report-card`);let N=r(`div`,A);i(A,N),n(N,`report-hero-copy`);let Ce=r(`p`,N);i(N,Ce),n(Ce,`report-kicker`),i(Ce,o(`Data Pulse / March 2026`));let we=r(`h1`,N);i(N,we),i(we,o(`10 日经营数据从静默切换到集中爆发，峰值日几乎决定整段窗口表现。`));let P=r(`p`,N);i(N,P),n(P,`report-hero-text`),i(P,o(`统计区间为 `));let Te=p(P);i(P,Te),f(()=>{a(Te,ve)}),i(P,o(`。窗口总成交额达到 `));let Ee=e(`rue:slot:anchor`);i(P,Ee),f(()=>{let e=j(y);u(()=>d(e,P,Ee))}),i(P,o(`，共形成`));let De=p(P);i(P,De),a(De,` `),i(P,o(` `));let Oe=p(P);i(P,Oe),f(()=>{a(Oe,_.format(v))}),i(P,o(` 笔订单， 其中`));let ke=p(P);i(P,ke),a(ke,` `),i(P,o(` `));let Ae=e(`rue:slot:anchor`);i(P,Ae),f(()=>{let e=_e(w.sumDate);u(()=>d(e,P,Ae))}),i(P,o(` 单日贡献 `));let je=e(`rue:slot:anchor`);i(P,je),f(()=>{let e=he(T);u(()=>d(e,P,je))}),i(P,o(` ，而退货金额维持在 `));let Me=e(`rue:slot:anchor`);i(P,Me),f(()=>{let e=j(b);u(()=>d(e,P,Me))}),i(P,o(`。`));let F=r(`div`,N);i(N,F),n(F,`report-hero-tags`);let Ne=r(`span`,F);i(F,Ne),n(Ne,`report-tag`);let Pe=p(Ne);i(Ne,Pe),f(()=>{a(Pe,S)}),i(Ne,o(` 天静默期`));let Fe=r(`span`,F);i(F,Fe),n(Fe,`report-tag`);let Ie=p(Fe);i(Fe,Ie),f(()=>{a(Ie,x)}),i(Fe,o(` 天有效成交`));let Le=r(`span`,F);i(F,Le),n(Le,`report-tag`),i(Le,o(`客户记录 `));let Re=p(Le);i(Le,Re),f(()=>{a(Re,_.format(te))});let I=r(`div`,A);i(A,I),n(I,`report-hero-board`);let L=r(`div`,I);i(I,L),n(L,`report-board-header`);let ze=r(`span`,L);i(L,ze),n(ze,`report-board-label`),i(ze,o(`峰值日`));let Be=r(`span`,L);i(L,Be),n(Be,`report-board-date`);let Ve=e(`rue:slot:anchor`);i(Be,Ve),f(()=>{let e=_e(w.sumDate);u(()=>d(e,Be,Ve))});let He=r(`div`,I);i(I,He),n(He,`report-board-value`);let Ue=e(`rue:slot:anchor`);i(He,Ue),f(()=>{let e=M(w.allAmount);u(()=>d(e,He,Ue))});let R=r(`p`,I);i(I,R),n(R,`report-board-copy`),i(R,o(`单日完成 `));let We=p(R);i(R,We),f(()=>{a(We,_.format(w.ordersCount))}),i(R,o(` 笔订单，客户均额`));let Ge=p(R);i(R,Ge),a(Ge,` `),i(R,o(` `));let Ke=e(`rue:slot:anchor`);i(R,Ke),f(()=>{let e=M(w.avgClientPrice);u(()=>d(e,R,Ke))}),i(R,o(`。`));let qe=r(`div`,I);i(I,qe),n(qe,`report-sparkline`);let Je=e(`rue:list:start`),Ye=e(`rue:list:end`);i(qe,Je),i(qe,Ye);let Xe=new Map;f(()=>{Xe=m({items:xe||[],getKey:(e,t)=>e.sumDate,elements:Xe,parent:qe,before:Ye,singleRoot:!0,trackIndex:!1,start:Je,renderItem:(a,o,p,m,h)=>{d(l(()=>{let o=t(),l=r(`div`,o);i(o,l),f(()=>{s(l,`key`,String(a.sumDate))}),n(l,`report-spark-item`);let p=r(`span`,l);i(l,p),f(()=>{n(p,String(`report-spark-bar ${a.sumDate===w.sumDate?`is-peak`:``}`))}),f(()=>{c(p,{height:`${Math.max(10,a.amountRatio*100)}%`})});let m=r(`span`,l);i(l,m),n(m,`report-spark-label`);let h=e(`rue:slot:anchor`);return i(m,h),f(()=>{let e=a.label;u(()=>d(e,m,h))}),o}),o,p)}})});let Ze=r(`section`,k);i(k,Ze),n(Ze,`report-kpi-grid`);let Qe=e(`rue:list:start`),$e=e(`rue:list:end`);i(Ze,Qe),i(Ze,$e);let et=new Map;f(()=>{et=m({items:ye||[],getKey:(e,t)=>e.label,elements:et,parent:Ze,before:$e,singleRoot:!0,trackIndex:!1,start:Qe,renderItem:(o,c,m,h,g)=>{d(l(()=>{let c=t(),l=r(`article`,c);i(c,l),f(()=>{s(l,`key`,String(o.label))}),n(l,`report-kpi-card report-card`);let m=r(`p`,l);i(l,m);let h=e(`rue:slot:anchor`);i(m,h),f(()=>{let e=o.label;u(()=>d(e,m,h))});let g=r(`h2`,l);i(l,g);let _=p(g);i(g,_),f(()=>{a(_,o.value)});let v=r(`span`,l);i(l,v);let y=e(`rue:slot:anchor`);return i(v,y),f(()=>{let e=o.detail;u(()=>d(e,v,y))}),c}),c,m)}})});let z=r(`section`,k);i(k,z),n(z,`report-panel-grid report-panel-grid-primary`);let B=r(`article`,z);i(z,B),n(B,`report-card report-chart-card report-chart-wide`);let V=r(`div`,B);i(B,V),n(V,`report-panel-header`);let tt=r(`div`,V);i(V,tt);let nt=r(`p`,tt);i(tt,nt),n(nt,`report-panel-eyebrow`),i(nt,o(`GMV Trend`));let rt=r(`h2`,tt);i(tt,rt),i(rt,o(`成交金额波动`));let it=r(`div`,V);i(V,it),n(it,`report-panel-summary`),i(it,o(`03.24 抬升整段曲线，后续三天维持正向成交尾流。`));let at=r(`div`,B);i(B,at),n(at,`report-chart-shell`);let H=r(`svg`,at);i(at,H),f(()=>{s(H,`viewBox`,String(`0 0 ${ie} ${ae}`))}),n(H,`report-svg-chart`),s(H,`role`,`img`),s(H,`aria-label`,`每日成交金额趋势图`);let ot=r(`defs`,H);i(H,ot);let U=r(`linearGradient`,ot);i(ot,U),s(U,`id`,`reportAreaGradient`),s(U,`x1`,`0`),s(U,`x2`,`0`),s(U,`y1`,`0`),s(U,`y2`,`1`);let st=r(`stop`,U);i(U,st),s(st,`offset`,`0%`),n(st,`report-stop-area-top`);let ct=r(`stop`,U);i(U,ct),s(ct,`offset`,`100%`),n(ct,`report-stop-area-bottom`);let W=r(`linearGradient`,ot);i(ot,W),s(W,`id`,`reportLineGradient`),s(W,`x1`,`0`),s(W,`x2`,`1`),s(W,`y1`,`0`),s(W,`y2`,`0`);let lt=r(`stop`,W);i(W,lt),s(lt,`offset`,`0%`),n(lt,`report-stop-line-start`);let ut=r(`stop`,W);i(W,ut),s(ut,`offset`,`100%`),n(ut,`report-stop-line-end`);let dt=e(`rue:list:start`),ft=e(`rue:list:end`);i(H,dt),i(H,ft);let pt=new Map;f(()=>{pt=m({items:de||[],getKey:(e,t)=>e.step,elements:pt,parent:H,before:ft,singleRoot:!0,trackIndex:!1,start:dt,renderItem:(e,o,c,u,m)=>{d(l(()=>{let o=t(),c=r(`g`,o);i(o,c),f(()=>{s(c,`key`,String(e.step))});let l=r(`line`,c);i(c,l),f(()=>{s(l,`x1`,String(O.left))}),f(()=>{s(l,`y1`,String(e.y))}),f(()=>{s(l,`x2`,String(ie-O.right))}),f(()=>{s(l,`y2`,String(e.y))}),n(l,`report-grid-line`);let u=r(`text`,c);i(c,u),f(()=>{s(u,`x`,String(O.left+6))}),f(()=>{s(u,`y`,String(e.y-8))}),n(u,`report-grid-label`);let d=p(u);return i(u,d),f(()=>{a(d,M(oe*e.step))}),o}),o,c)}})});let mt=r(`path`,H);i(H,mt),f(()=>{s(mt,`d`,String(ue))}),s(mt,`fill`,`url(#reportAreaGradient)`);let ht=r(`path`,H);i(H,ht),f(()=>{s(ht,`d`,String(le))}),n(ht,`report-line-path`),s(ht,`stroke`,`url(#reportLineGradient)`);let gt=e(`rue:list:start`),_t=e(`rue:list:end`);i(H,gt),i(H,_t);let vt=new Map;f(()=>{vt=m({items:ce||[],getKey:(e,t)=>e.row.sumDate,elements:vt,parent:H,before:_t,singleRoot:!0,trackIndex:!1,start:gt,renderItem:(e,o,c,u,m)=>{d(l(()=>{let o=t(),c=r(`g`,o);i(o,c),f(()=>{s(c,`key`,String(e.row.sumDate))});let l=r(`circle`,c);i(c,l),f(()=>{s(l,`cx`,String(e.x))}),f(()=>{s(l,`cy`,String(e.y))}),f(()=>{s(l,`r`,String(e.row.sumDate===w.sumDate?7:4.5))}),n(l,`report-point-outer`);let u=r(`circle`,c);i(c,u),f(()=>{s(u,`cx`,String(e.x))}),f(()=>{s(u,`cy`,String(e.y))}),s(u,`r`,`3.2`),n(u,`report-point-inner`);let d=r(`text`,c);i(c,d),f(()=>{s(d,`x`,String(e.x))}),f(()=>{s(d,`y`,String(ae-12))}),s(d,`text-anchor`,`middle`),n(d,`report-axis-label`);let m=p(d);return i(d,m),f(()=>{a(m,ge(e.row.sumDate))}),o}),o,c)}})});let G=r(`article`,z);i(z,G),n(G,`report-card report-channel-card`);let yt=r(`div`,G);i(G,yt),n(yt,`report-panel-header`);let bt=r(`div`,yt);i(yt,bt);let xt=r(`p`,bt);i(bt,xt),n(xt,`report-panel-eyebrow`),i(xt,o(`Channel Mix`));let St=r(`h2`,bt);i(bt,St),i(St,o(`下单渠道分布`));let K=r(`div`,G);i(G,K),n(K,`report-channel-body`);let q=r(`svg`,K);i(K,q),s(q,`viewBox`,`0 0 160 160`),n(q,`report-donut`),s(q,`role`,`img`),s(q,`aria-label`,`下单渠道占比图`);let Ct=r(`circle`,q);i(q,Ct),s(Ct,`cx`,`80`),s(Ct,`cy`,`80`),f(()=>{s(Ct,`r`,String(fe))}),n(Ct,`report-donut-track`);let J=r(`circle`,q);i(q,J),s(J,`cx`,`80`),s(J,`cy`,`80`),f(()=>{s(J,`r`,String(fe))}),n(J,`report-donut-admin`),f(()=>{s(J,`stroke-dasharray`,String(`${pe}`))}),s(J,`stroke-dashoffset`,`0`);let Y=r(`circle`,q);i(q,Y),s(Y,`cx`,`80`),s(Y,`cy`,`80`),f(()=>{s(Y,`r`,String(fe))}),n(Y,`report-donut-self`),f(()=>{s(Y,`stroke-dasharray`,String(`${pe*ne} ${pe}`))}),f(()=>{s(Y,`stroke-dashoffset`,String(-me))});let X=r(`div`,K);i(K,X),n(X,`report-channel-center`);let wt=r(`strong`,X);i(X,wt);let Tt=e(`rue:slot:anchor`);i(wt,Tt),f(()=>{let e=he(E);u(()=>d(e,wt,Tt))});let Et=r(`span`,X);i(X,Et),i(Et,o(`后台代客`));let Dt=r(`div`,G);i(G,Dt),n(Dt,`report-channel-list`);let Z=r(`div`,Dt);i(Dt,Z),n(Z,`report-channel-item`);let Ot=r(`span`,Z);i(Z,Ot),n(Ot,`report-dot report-dot-admin`);let kt=r(`div`,Z);i(Z,kt);let At=r(`strong`,kt);i(kt,At),i(At,o(`后台代客下单`));let jt=r(`p`,kt);i(kt,jt);let Mt=e(`rue:slot:anchor`);i(jt,Mt),f(()=>{let e=j(ee);u(()=>d(e,jt,Mt))});let Nt=r(`span`,Z);i(Z,Nt);let Pt=e(`rue:slot:anchor`);i(Nt,Pt),f(()=>{let e=he(E);u(()=>d(e,Nt,Pt))});let Q=r(`div`,Dt);i(Dt,Q),n(Q,`report-channel-item`);let Ft=r(`span`,Q);i(Q,Ft),n(Ft,`report-dot report-dot-self`);let It=r(`div`,Q);i(Q,It);let Lt=r(`strong`,It);i(It,Lt),i(Lt,o(`客户自主下单`));let Rt=r(`p`,It);i(It,Rt);let zt=e(`rue:slot:anchor`);i(Rt,zt),f(()=>{let e=j(C);u(()=>d(e,Rt,zt))});let Bt=r(`span`,Q);i(Q,Bt);let Vt=e(`rue:slot:anchor`);i(Bt,Vt),f(()=>{let e=he(ne);u(()=>d(e,Bt,Vt))});let Ht=r(`section`,k);i(k,Ht),n(Ht,`report-panel-grid`);let Ut=r(`article`,Ht);i(Ht,Ut),n(Ut,`report-card report-chart-card`);let Wt=r(`div`,Ut);i(Ut,Wt),n(Wt,`report-panel-header`);let Gt=r(`div`,Wt);i(Wt,Gt);let Kt=r(`p`,Gt);i(Gt,Kt),n(Kt,`report-panel-eyebrow`),i(Kt,o(`Order Volume`));let qt=r(`h2`,Gt);i(Gt,qt),i(qt,o(`每日订单笔数`));let Jt=r(`div`,Wt);i(Wt,Jt),n(Jt,`report-panel-summary`),i(Jt,o(`尾段交易频次持续升高，03.27 以 8 笔达到订单数峰值。`));let Yt=r(`div`,Ut);i(Ut,Yt),n(Yt,`report-bars`);let Xt=e(`rue:list:start`),Zt=e(`rue:list:end`);i(Yt,Xt),i(Yt,Zt);let Qt=new Map;f(()=>{Qt=m({items:h||[],getKey:(e,t)=>e.sumDate,elements:Qt,parent:Yt,before:Zt,singleRoot:!0,trackIndex:!1,start:Xt,renderItem:(o,m,h,g,v)=>{d(l(()=>{let l=t(),m=r(`div`,l);i(l,m),f(()=>{s(m,`key`,String(o.sumDate))}),n(m,`report-bar-group`);let h=r(`div`,m);i(m,h),n(h,`report-bar-shell`);let g=r(`div`,h);i(h,g),f(()=>{n(g,String(`report-bar-fill ${o.sumDate===w.sumDate?`is-accent`:``}`))}),f(()=>{c(g,{height:`${Math.max(8,o.ordersCount/se*100)}%`})});let v=r(`strong`,m);i(m,v);let y=p(v);i(v,y),f(()=>{a(y,_.format(o.ordersCount))});let b=r(`span`,m);i(m,b);let x=e(`rue:slot:anchor`);return i(b,x),f(()=>{let e=ge(o.sumDate);u(()=>d(e,b,x))}),l}),m,h)}})});let $t=r(`article`,Ht);i(Ht,$t),n($t,`report-card report-insight-card`);let en=r(`div`,$t);i($t,en),n(en,`report-panel-header`);let tn=r(`div`,en);i(en,tn);let nn=r(`p`,tn);i(tn,nn),n(nn,`report-panel-eyebrow`),i(nn,o(`Signals`));let rn=r(`h2`,tn);i(tn,rn),i(rn,o(`关键观察`));let an=r(`div`,$t);i($t,an),n(an,`report-insight-list`);let on=e(`rue:list:start`),sn=e(`rue:list:end`);i(an,on),i(an,sn);let cn=new Map;f(()=>{cn=m({items:be||[],getKey:(e,t)=>e.title,elements:cn,parent:an,before:sn,singleRoot:!0,trackIndex:!1,start:on,renderItem:(a,o,c,p,m)=>{d(l(()=>{let o=t(),c=r(`article`,o);i(o,c),f(()=>{s(c,`key`,String(a.title))}),n(c,`report-insight-item`);let l=r(`h3`,c);i(c,l);let p=e(`rue:slot:anchor`);i(l,p),f(()=>{let e=a.title;u(()=>d(e,l,p))});let m=r(`p`,c);i(c,m);let h=e(`rue:slot:anchor`);return i(m,h),f(()=>{let e=a.text;u(()=>d(e,m,h))}),o}),o,c)}})});let ln=r(`section`,k);i(k,ln),n(ln,`report-card report-timeline-card`);let $=r(`div`,ln);i(ln,$),n($,`report-panel-header`);let un=r(`div`,$);i($,un);let dn=r(`p`,un);i(un,dn),n(dn,`report-panel-eyebrow`),i(dn,o(`Daily Playback`));let fn=r(`h2`,un);i(un,fn),i(fn,o(`逐日回放`));let pn=r(`div`,$);i($,pn),n(pn,`report-panel-summary`),i(pn,o(`按金额强度缩放，便于观察 10 天窗口内的启动、放量与回落节奏。`));let mn=r(`div`,ln);i(ln,mn),n(mn,`report-timeline-list`);let hn=e(`rue:list:start`),gn=e(`rue:list:end`);i(mn,hn),i(mn,gn);let _n=new Map;return f(()=>{_n=m({items:xe||[],getKey:(e,t)=>e.sumDate,elements:_n,parent:mn,before:gn,singleRoot:!0,trackIndex:!1,start:hn,renderItem:(m,h,g,v,y)=>{d(l(()=>{let l=t(),h=r(`div`,l);i(l,h),f(()=>{s(h,`key`,String(m.sumDate))}),n(h,`report-timeline-row`);let g=r(`div`,h);i(h,g),n(g,`report-timeline-main`);let v=r(`strong`,g);i(g,v);let y=e(`rue:slot:anchor`);i(v,y),f(()=>{let e=m.label;u(()=>d(e,v,y))});let b=r(`span`,g);i(g,b);let x=e(`rue:slot:anchor`);i(b,x),f(()=>{let e=m.notes;u(()=>d(e,b,x))});let S=r(`div`,h);i(h,S),n(S,`report-timeline-track`);let ee=r(`span`,S);i(S,ee),n(ee,`report-timeline-fill`),f(()=>{c(ee,{width:`${Math.max(4,m.amountRatio*100)}%`})});let C=r(`div`,h);i(h,C),n(C,`report-timeline-metrics`);let te=r(`strong`,C);i(C,te);let w=e(`rue:slot:anchor`);i(te,w),f(()=>{let e=M(m.allAmount);u(()=>d(e,te,w))});let T=r(`span`,C);i(C,T);let E=p(T);i(T,E),f(()=>{a(E,_.format(m.ordersCount))}),i(T,o(` 笔 / 客户均额`));let ne=p(T);i(T,ne),a(ne,` `),i(T,o(` `));let D=e(`rue:slot:anchor`);return i(T,D),f(()=>{let e=M(m.avgClientPrice);u(()=>d(e,T,D))}),l}),h,g)}})}),D});export{N as default};