...
</div>`,He=[{prop:`treeData`,description:`树数据源，支持嵌套 children 和字段映射。`,type:`TreeDataNode[]`,defaultValue:`[]`},{prop:`selectedKeys / defaultSelectedKeys`,description:`受控与非受控的当前选中项，multiple 打开后允许多选。`,type:`TreeKey[]`,defaultValue:`[]`},{prop:`checkedKeys / defaultCheckedKeys`,description:`勾选模式下的选中集合，strict 模式会回传 checked / halfChecked 结构。`,type:`TreeKey[] | { checked: TreeKey[]; halfChecked: TreeKey[] }`,defaultValue:`[]`},{prop:`expandedKeys / defaultExpandedKeys / defaultExpandAll`,description:`控制展开态，适合目录树、权限树和异步加载场景。`,type:`TreeKey[] / boolean`,defaultValue:`[] / false`},{prop:`checkable / checkStrictly`,description:`切换勾选与父子联动模式；strict 会关闭级联。`,type:`boolean`,defaultValue:`false`},{prop:`treeDataSimpleMode / fieldNames`,description:`直接接入 id / pId 扁平数据，同时可映射 title、key、children 字段。`,type:`boolean | TreeSimpleModeConfig / TreeFieldNames`,defaultValue:`- / -`},{prop:`allowSearch / searchValue / filterTreeNode`,description:`提供内置搜索输入和过滤逻辑，命中后会保留祖先链路。`,type:`boolean / string / boolean | ((inputValue, node) => boolean)`,defaultValue:`false / - / true`},{prop:`loadData`,description:`展开未加载分支时触发异步加载，适合远端目录与超大树。`,type:`(node: TreeNode) => Promise<any> | void`,defaultValue:`-`},{prop:`Tree.DirectoryTree / expandAction / toggleSelect / rangeSelect`,description:`目录树快捷 API；除了展开动作，还能细化 ctrl/meta 追加选择和 shift 区间选择是 append 还是 replace。`,type:`DirectoryTreeProps / false | "click" | "doubleClick" / boolean / false | "append" | "replace"`,defaultValue:`blockNode=true / showIcon=true / "click" / true / "append"`},{prop:`draggable / allowDrop / onDrop`,description:`开启拖拽排序并控制是否允许落点；allowDrop 和 onDrop 都会拿到 dropToGap，UI 会同步显示插前、插后或放入占位态。`,type:`TreeDraggable / (info) => boolean / (info) => void`,defaultValue:`false / - / -`},{prop:`height / itemHeight / virtual`,description:`为长列表开启虚拟滚动；height 定义视口高度，itemHeight 用于估算渲染窗口，也能和 loadData 组合接超长懒加载树。`,type:`number / number / boolean`,defaultValue:`- / 自动按尺寸估算 / true`},{prop:`showLine / showIcon / blockNode`,description:`控制树线、节点图标和整行可点的布局表现。`,type:`boolean`,defaultValue:`false`},{prop:`titleRender / switcherIcon / icon`,description:`按节点态自定义标题、展开图标和节点图标。`,type:`render function | any`,defaultValue:`-`}],Ue=e=>Array.isArray(e)?e:e.checked,We=(e,t)=>Array.isArray(e)?t?.halfCheckedKeys??[]:e.halfChecked,J=e=>`${typeof e}:${String(e)}`,Y=e=>e.map(e=>({...e,children:Array.isArray(e.children)?Y(e.children):e.children})),X=(e,t)=>{let n=J(t);for(let r=0;r<e.length;r+=1){let i=e[r];if(J(i.key)===n){let[t]=e.splice(r,1);return t??null}if(Array.isArray(i.children)){let e=X(i.children,t);if(e)return e}}return null},Z=(e,t,n,r)=>{let i=J(n);for(let a=0;a<e.length;a+=1){let o=e[a];if(J(o.key)===i){if(r===0){let e=Array.isArray(o.children)?[...o.children]:[];e.push(t),o.children=e}else e.splice(r<0?a:a+1,0,t);return!0}if(Array.isArray(o.children)&&Z(o.children,t,n,r))return!0}return!1},Ge=(e,t)=>{let n=Y(e),r=X(n,t.dragNode.key);return r&&(Z(n,r,t.node.key,t.dropPosition)||n.push(r)),n},Ke=(e,t,n)=>{let r=J(t);return e.map(e=>J(e.key)===r?n(e):Array.isArray(e.children)?{...e,children:Ke(e.children,t,n)}:e)},qe=e=>e.reduce((e,t)=>!Array.isArray(t.children)||!t.children.length?e:e+1+qe(t.children),0),Je=n=>{let{isOpen:r,isFolder:a,toggle:l,addChild:p,changeType:g}=D(`useSetup:0:0`,()=>w(()=>{let e=D(`computed:1:0`,()=>b(()=>!!n.model.open)),t=D(`computed:1:1`,()=>b(()=>!!n.model.children&&n.model.children.length>0)),r=t=>{t?.stopPropagation(),n.model.open=!e.get()},i=e=>{e?.stopPropagation(),n.model.children||(n.model.children=[]),n.model.children.push({id:`${n.model.id}-new-${n.model.children.length}`,name:`new stuff`}),n.model.open=!0};return{isOpen:e,isFolder:t,toggle:r,addChild:i,changeType:e=>{e?.stopPropagation(),t.get()||(n.model.children=[],i(),n.model.open=!0)}}}));return y(_=>{let v=d(`li`,_);e(v,`list-none`);let b=d(`button`,v);t(v,b),f(b,`type`,`button`),i(()=>{e(b,String(`flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm transition `+(a.get()?`font-semibold text-base-content`:`text-base-content/80 hover:bg-base-200/70`)))}),E(b,`click`,e=>l(e)),E(b,`dblclick`,e=>g(e));let x=d(`span`,b);t(b,x),e(x,`inline-flex size-5 items-center justify-center rounded-md bg-base-200/80 text-[11px] text-base-content/55`);let w=c(x);t(x,w),i(()=>{m(w,a.get()?r.get()?`−`:`+`:`•`)});let D=d(`span`,b);t(b,D);let O=s(`rue:slot:anchor`);t(D,O),i(()=>{let e=n.model.name;T(()=>S(e,D,O))});let k=s(`rue:slot:anchor`);return t(v,k),i(()=>{let c=a.get()&&r.get()?y(()=>{let r=u(),a=d(`ul`,r);t(r,a),e(a,`mt-1 grid gap-1 pl-5`);let c=s(`rue:list:start`),l=s(`rue:list:end`);t(a,c),t(a,l);let m=new Map;i(()=>{m=ee({items:n.model.children||[],getKey:(e,t)=>e.id,elements:m,parent:a,before:l,start:c,renderItem:(e,t,n,r,i)=>{h(C(Je,{key:e.id,model:e}),t,n,r)}})});let g=d(`li`,a);t(a,g),e(g,`list-none`);let _=d(`button`,g);return t(g,_),f(_,`type`,`button`),e(_,`btn btn-ghost btn-xs rounded-full text-emerald-600`),E(_,`click`,e=>p(e)),t(_,o(`+ add child`)),r}):``;T(()=>S(c,v,k))}),v})},Ye=()=>{let{basicSelectedKeys:n,directorySelectedKeys:r,directoryExpandAction:a,directoryToggleSelect:c,directoryRangeSelect:l,directoryRangeAppendSelectedKeys:f,directoryRangeReplaceSelectedKeys:p,directoryRangeTreeVersion:m,checkableSelectedKeys:h,checkedKeys:g,halfCheckedKeys:v,disabledCheckedKeys:E,simpleSelectedKeys:ee,asyncSelectedKeys:ne,asyncExpandedKeys:j,dragTreeData:M,dragSummary:N,virtualSelectedKeys:P,asyncVirtualTreeData:F,asyncVirtualExpandedKeys:I,asyncVirtualSelectedKeys:L,asyncTreeData:R,legacyTree:re,tabs:z,loadAsyncTree:B,loadAsyncVirtualTree:ie,resetDirectoryRangeDemo:ae}=D(`useSetup:0:0:dup1`,()=>w(()=>{let e=D(`ref:1:2`,()=>_([`docs-api`])),t=D(`ref:1:3`,()=>_([`dir-app`])),n=D(`ref:1:4`,()=>_(`click`)),r=D(`ref:1:5`,()=>_(!0)),i=D(`computed:1:6`,()=>b(()=>r.value?`append`:!1)),a=D(`ref:1:7`,()=>_([])),o=D(`ref:1:8`,()=>_([])),s=D(`ref:1:9`,()=>_(0)),c=D(`ref:1:10`,()=>_([`release-control`])),l=D(`ref:1:11`,()=>_([`site-home`])),u=D(`ref:1:12`,()=>_([`release-control`,`release-site`])),d=D(`ref:1:13`,()=>_([`editable-assets`])),f=D(`ref:1:14`,()=>_([`workflow`])),p=D(`ref:1:15`,()=>_([])),m=D(`ref:1:16`,()=>_([])),h=D(`ref:1:17`,()=>_(Y(Ae))),g=D(`ref:1:18`,()=>_(`folder 支持放入；file 只允许插前和插后，悬停时会显示明确占位态。`)),v=D(`ref:1:19`,()=>_([`virtual-3`])),y=D(`ref:1:20`,()=>_(Y(Me))),S=D(`ref:1:21`,()=>_([])),C=D(`ref:1:22`,()=>_([])),w=D(`ref:1:23`,()=>_([{title:`发布总线`,key:`release-bus`,isLeaf:!1}]));return{basicSelectedKeys:e,directorySelectedKeys:t,directoryExpandAction:n,directoryToggleSelect:r,directoryRangeSelect:i,directoryRangeAppendSelectedKeys:a,directoryRangeReplaceSelectedKeys:o,directoryRangeTreeVersion:s,checkableSelectedKeys:c,checkedKeys:l,halfCheckedKeys:u,disabledCheckedKeys:d,simpleSelectedKeys:f,asyncSelectedKeys:p,asyncExpandedKeys:m,dragTreeData:h,dragSummary:g,virtualSelectedKeys:v,asyncVirtualTreeData:y,asyncVirtualExpandedKeys:S,asyncVirtualSelectedKeys:C,asyncTreeData:w,legacyTree:D(`reactive:1:24`,()=>x({id:`root`,name:`My Tree`,open:!0,children:[{id:`hello`,name:`hello`},{id:`world`,name:`world`},{id:`branch`,name:`child folder`,open:!0,children:[{id:`branch-1`,name:`design review`},{id:`branch-2`,name:`release note`}]}]})),tabs:{basic:D(`ref:1:25`,()=>_(`preview`)),directory:D(`ref:1:26`,()=>_(`preview`)),directoryRange:D(`ref:1:27`,()=>_(`preview`)),checkable:D(`ref:1:28`,()=>_(`preview`)),checkableDisabled:D(`ref:1:29`,()=>_(`preview`)),simple:D(`ref:1:30`,()=>_(`preview`)),async:D(`ref:1:31`,()=>_(`preview`)),drag:D(`ref:1:32`,()=>_(`preview`)),virtual:D(`ref:1:33`,()=>_(`preview`)),virtualAsync:D(`ref:1:34`,()=>_(`preview`)),legacy:D(`ref:1:35`,()=>_(`preview`))},loadAsyncTree:async e=>{e.key===`release-bus`&&(w.value=[{title:`发布总线`,key:`release-bus`,isLeaf:!1,children:[{title:`桌面端`,key:`desktop`,children:[{title:`Windows`,key:`desktop-win`},{title:`macOS`,key:`desktop-mac`}]},{title:`移动端`,key:`mobile`,children:[{title:`iOS`,key:`mobile-ios`},{title:`Android`,key:`mobile-android`}]}]}])},loadAsyncVirtualTree:async e=>{e.children.length||(y.value=Ke(y.value,e.key,e=>({...e,children:Array.from({length:8},(t,n)=>({title:`${String(e.title)} / Module ${n+1}`,key:`${String(e.key)}-child-${n}`,isLeaf:n%3!=0}))})))},resetDirectoryRangeDemo:()=>{a.value=[],o.value=[],s.value+=1}}}));return y(_=>{let b=u(),x=s(`rue:component:anchor`);return t(b,x),S(C(te,{children:y(()=>{let _=u(),y=d(`div`,_);t(_,y),e(y,`max-w-none prose prose-sm md:prose-base`);let b=d(`h1`,y);t(y,b),t(b,o(`Tree 树控件`));let x=d(`p`,y);t(y,x),t(x,o(`Rue 的 Tree 补上了独立树组件这块空白：保留 TreeView 示例里递归数据直改的灵活性，同时把 树控件常用的展开、选中、勾选、简单模式、异步加载和自定义标题一次补齐。 视觉上继续沿用 Rue 现有的卡片、badge 和 base 色阶体系，不照搬其他组件库的外观。`));let w=d(`div`,y);t(y,w),e(w,`not-prose mt-6 grid gap-3 md:grid-cols-3`);let D=d(`div`,w);t(w,D),e(D,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let te=d(`div`,D);t(D,te),e(te,`text-xs uppercase tracking-[0.2em] text-base-content/45`),t(te,o(`Node Model`));let oe=d(`div`,D);t(D,oe),e(oe,`mt-2 text-base font-semibold`),t(oe,o(`选择、勾选、展开三条状态线`));let se=d(`p`,D);t(D,se),e(se,`mt-2 mb-0 text-sm text-base-content/68`),t(se,o(`目录树、权限树、发布树都能直接套进来。`));let V=d(`div`,w);t(w,V),e(V,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let ce=d(`div`,V);t(V,ce),e(ce,`text-xs uppercase tracking-[0.2em] text-base-content/45`),t(ce,o(`DirectoryTree`));let le=d(`div`,V);t(V,le),e(le,`mt-2 text-base font-semibold`),t(le,o(`目录树快捷 API`));let ue=d(`p`,V);t(V,ue),e(ue,`mt-2 mb-0 text-sm text-base-content/68`),t(ue,o(`支持 click / doubleClick 展开，以及更接近文件浏览器的多选交互。`));let H=d(`div`,w);t(w,H),e(H,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let de=d(`div`,H);t(H,de),e(de,`text-xs uppercase tracking-[0.2em] text-base-content/45`),t(de,o(`Heavy Interaction`));let fe=d(`div`,H);t(H,fe),e(fe,`mt-2 text-base font-semibold`),t(fe,o(`拖拽排序与虚拟滚动`));let pe=d(`p`,H);t(H,pe),e(pe,`mt-2 mb-0 text-sm text-base-content/68`),t(pe,o(`长列表和拖拽改序终于能落在同一个 Tree 上了。`));let me=s(`rue:component:anchor`);t(y,me),i(()=>{let e=C(A,{title:`基础选中与整行交互`,summary:`默认 Tree 就是一个纯浏览 + 选中容器；blockNode 和 showIcon 让它更像配置面板里的主导航。`,tab:z.basic,code:Ne,preview:O(`div`,{className:`space-y-4 not-prose`,children:[k(G,{treeData:we,selectedKeys:n.value,defaultExpandAll:!0,showIcon:!0,blockNode:!0,onSelect:e=>{n.value=e}}),O(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:n.value.length?n.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`未选择`})})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`推荐场景`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`组件目录、文档导航、资源分类`})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`状态模型`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`selectedKeys / expandedKeys 分离，便于受控更新。`})]})]})]})});T(()=>S(e,y,me))});let he=s(`rue:component:anchor`);t(y,he),i(()=>{let e=C(A,{title:`DirectoryTree 目录树快捷 API`,summary:`Tree.DirectoryTree 默认补上目录图标、整行可点和 click 展开；这里先只看 expandAction 和 toggleSelect 这两个基础交互开关。`,tab:z.directory,code:Re,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G.DirectoryTree,{treeData:Oe,selectedKeys:r.value,multiple:!0,expandAction:a.value,toggleSelect:c.value,rangeSelect:l.get(),onSelect:e=>{r.value=e}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`快捷属性`}),O(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[k(`button`,{type:`button`,className:a.value===`click`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=`click`},children:`click 展开`}),k(`button`,{type:`button`,className:a.value===`doubleClick`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=`doubleClick`},children:`doubleClick 展开`}),k(`button`,{type:`button`,className:a.value===!1?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=!1},children:`只选中不展开`})]}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:[k(`button`,{type:`button`,className:c.value?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{c.value=!0},children:`ctrl/meta 追加`}),k(`button`,{type:`button`,className:c.value?`btn btn-ghost btn-xs`:`btn btn-primary btn-xs`,onClick:()=>{c.value=!1},children:`关闭追加选择`})]})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:r.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e)))})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前组合是 expandAction=`,k(`strong`,{children:String(a.value)}),`、toggleSelect=`,k(`strong`,{children:String(c.value)}),`、rangeSelect=`,k(`strong`,{children:String(l.get())}),`。`,k(`div`,{className:`mt-3`,children:`普通点击会落成单选；打开追加后，meta / ctrl 会追加或移除选中，shift 也会启用区间选择。关闭追加时，这两类补充选择都会停用；append / replace 的差异放到下面的对照示例里单独演示。`})]})]})]})});T(()=>S(e,y,he))});let ge=s(`rue:component:anchor`);t(y,ge),i(()=>{let e=C(A,{title:`shift append vs shift replace`,summary:`这两个模式只有在“先做一次非连续多选，再用 shift 选区间”时才会分出差异；左边保留旧选择，右边只保留新区间。`,tab:z.directoryRange,code:ze,preview:O(`div`,{className:`space-y-4 not-prose`,children:[O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[k(`div`,{children:`操作顺序：先单击 beta.ts，再按住 Cmd / Ctrl 单击 epsilon.ts，最后按住 Shift 单击 delta.ts。`}),k(`div`,{className:`mt-2`,children:`append 会保留 beta.ts；replace 只保留 delta.ts 到 epsilon.ts 这一段。`}),k(`button`,{type:`button`,className:`btn btn-ghost btn-xs mt-3`,onClick:ae,children:`重置两边示例`})]}),O(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[O(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[O(`div`,{className:`flex items-center justify-between gap-3`,children:[O(`div`,{children:[k(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="append"`}),k(`div`,{className:`text-xs text-base-content/55`,children:`保留原先的非连续选择，再并入新的 shift 区间。`})]}),k(`span`,{className:`badge badge-outline badge-sm`,children:`append`})]}),k(G.DirectoryTree,{treeData:ke,selectedKeys:f.value,multiple:!0,toggleSelect:!0,rangeSelect:`append`,onSelect:e=>{f.value=e}},`append-${m.value}`),O(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:f.value.length?f.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]}),O(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[O(`div`,{className:`flex items-center justify-between gap-3`,children:[O(`div`,{children:[k(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="replace"`}),k(`div`,{className:`text-xs text-base-content/55`,children:`只保留新的 shift 区间，旧的非连续选择会被替换掉。`})]}),k(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:`replace`})]}),k(G.DirectoryTree,{treeData:ke,selectedKeys:p.value,multiple:!0,toggleSelect:!0,rangeSelect:`replace`,onSelect:e=>{p.value=e}},`replace-${m.value}`),O(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:p.value.length?p.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]})]})]})});T(()=>S(e,y,ge))});let _e=s(`rue:component:anchor`);t(y,_e),i(()=>{let e=C(A,{title:`父子联动与半选态`,summary:`这一块只看级联勾选和 halfChecked，不再混入 disabled / disableCheckbox，点击父节点时能直接看到整棵子树联动。`,tab:z.checkable,code:Pe,preview:O(`div`,{className:`space-y-4 not-prose`,children:[k(G,{treeData:Te,selectedKeys:h.value,checkedKeys:g.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onSelect:e=>{h.value=e},onCheck:(e,t)=>{g.value=Ue(e),v.value=We(e,t)}}),O(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:h.value.length?h.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`当前没有选中节点`})})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`checkedKeys`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:g.value.map(e=>k(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:String(e)},String(e)))})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`halfCheckedKeys`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:v.value.length?v.value.map(e=>k(`span`,{className:`badge badge-ghost badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`当前没有半选`})})]})]})]})});T(()=>S(e,y,_e))});let ve=s(`rue:component:anchor`);t(y,ve),i(()=>{let e=C(A,{title:`禁用节点与禁用复选框`,summary:`把 disabled 和 disableCheckbox 单独拆出来看：前者整节点只读，后者只禁用勾选框，不再干扰联动示例。`,tab:z.checkableDisabled,code:Fe,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G,{treeData:Ee,checkedKeys:E.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onCheck:e=>{E.value=Ue(e)}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前勾选`}),k(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:E.value.length?E.value.map(e=>k(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):k(`span`,{className:`text-sm text-base-content/55`,children:`当前没有勾选`})})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[k(`div`,{className:`font-medium text-base-content`,children:`disabled`}),k(`div`,{className:`mt-2`,children:`整节点不可展开、不可选中、不可勾选，适合只读目录或冻结配置。`})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[k(`div`,{className:`font-medium text-base-content`,children:`disableCheckbox`}),k(`div`,{className:`mt-2`,children:`节点仍能展示和展开，但复选框不会参与交互，适合“只可浏览不可授权”的条目。`})]})]})]})});T(()=>S(e,y,ve))});let ye=s(`rue:component:anchor`);t(y,ye),i(()=>{let e=C(A,{title:`Simple Mode + Search`,summary:`扁平数据直入后，内置搜索会保留命中节点的祖先链，不会把层级上下文切断。`,tab:z.simple,code:Ie,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G,{treeData:De,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{title:`name`,key:`code`},selectedKeys:ee.value,allowSearch:!0,defaultExpandAll:!0,onSelect:e=>{ee.value=e}}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前选中：`,k(`code`,{children:JSON.stringify(ee.value)}),k(`div`,{className:`mt-3`,children:`这类 simple mode 很适合后端直接给 id / pId 的菜单、流程节点和权限项，不需要再先做一遍树转换。`})]})]})});T(()=>S(e,y,ye))});let be=s(`rue:component:anchor`);t(y,be),i(()=>{let e=C(A,{title:`Async Load 与自定义标题`,summary:`第一次展开时再拉子节点，同时用 titleRender 和 icon 把状态信息塞回每一行。`,tab:z.async,code:Le,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,26rem),1fr] lg:items-start`,children:[k(G,{treeData:R.value,selectedKeys:ne.value,expandedKeys:j.value,loadData:B,showLine:!0,showIcon:!0,blockNode:!0,titleRender:({node:e,loading:t})=>O(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[k(`span`,{className:`truncate`,children:e.title}),k(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`branch`:`leaf`})]}),onSelect:e=>{ne.value=e},onExpand:e=>{j.value=e}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`expandedKeys`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(j.value)})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(ne.value)})]}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`展开 release-bus 后才会注入桌面端和移动端节点，适合远端目录、超大权限树和发布范围配置。`})]})]})});T(()=>S(e,y,be))});let U=d(`div`,y);t(y,U),e(U,`not-prose mt-10 space-y-2`);let xe=d(`h2`,U);t(U,xe),e(xe,`text-2xl font-semibold`),t(xe,o(`更重交互`));let W=d(`p`,U);t(U,W),e(W,`text-sm text-base-content/70`),t(W,o(`当 Tree 既要承载拖拽整理，又要承载超长数据时，draggable 和 virtual 就是两个最关键的控制面。`));let Se=s(`rue:component:anchor`);t(y,Se),i(()=>{let e=C(A,{title:`allowDrop 策略与拖拽占位`,summary:`allowDrop 可以把 folder / file 的落点规则写清楚；hover 时 Tree 会直接给出插前、插后或放入占位提示。`,tab:z.drag,code:K,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G,{treeData:M.value,draggable:!0,blockNode:!0,defaultExpandAll:!0,allowDrop:({dropNode:e,dropToGap:t})=>t||e.raw.kind!==`file`,titleRender:({node:e})=>O(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[k(`span`,{className:`truncate`,children:e.title}),k(`span`,{className:e.raw.kind===`folder`?`badge badge-ghost badge-xs`:`badge badge-outline badge-xs`,children:e.raw.kind})]}),onDrop:e=>{M.value=Ge(M.value,e),N.value=`${String(e.dragNode.key)} -> ${String(e.node.key)} (${e.dropToGap?e.dropPosition<0?`before`:`after`:`inside`})`}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`最近一次拖拽`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:N.value})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`allowDrop 规则`}),O(`div`,{className:`mt-2 grid gap-2 text-sm text-base-content/75`,children:[k(`div`,{children:`folder：允许放入，也允许插前 / 插后。`}),k(`div`,{children:`file：只允许插前 / 插后，不允许作为 inside 目标。`})]})]}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`拖到 folder 正中央会看到“放入”，拖到行的上沿或下沿则会出现“插前 / 插后”；如果目标是 file，inside 落点会被 allowDrop 直接拦掉。`})]})]})});T(()=>S(e,y,Se))});let Ae=s(`rue:component:anchor`);t(y,Ae),i(()=>{let e=C(A,{title:`Virtual Scroll`,summary:`长列表下只渲染可见窗口，height 和 itemHeight 负责限定视口和估算切片范围。`,tab:z.virtual,code:q,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G,{treeData:je,selectedKeys:P.value,height:320,itemHeight:42,virtual:!0,blockNode:!0,onSelect:e=>{P.value=e}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`数据量`}),k(`div`,{className:`mt-2 text-2xl font-semibold`,children:je.length})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(P.value)})]}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`对文档页目录、埋点树、批量资源目录这种长列表场景，虚拟滚动能显著降低初始渲染压力。`})]})]})});T(()=>S(e,y,Ae))});let Me=s(`rue:component:anchor`);t(y,Me),i(()=>{let e=C(A,{title:`Virtual + Async Load 场景页`,summary:`把 virtual、height、itemHeight 和 loadData 合在一起，就能接超长目录或资源树，只在展开分支时再注入子节点。`,tab:z.virtualAsync,code:Be,preview:O(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[k(G,{treeData:F.value,selectedKeys:L.value,expandedKeys:I.value,height:340,itemHeight:40,virtual:!0,showIcon:!0,blockNode:!0,loadData:ie,titleRender:({node:e,loading:t})=>O(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[k(`span`,{className:`truncate`,children:e.title}),k(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`loaded`:e.isLeaf?`leaf`:`lazy`})]}),onSelect:e=>{L.value=e},onExpand:e=>{I.value=e}}),O(`div`,{className:`space-y-3`,children:[O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`根节点数量`}),k(`div`,{className:`mt-2 text-2xl font-semibold`,children:F.value.length})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`已加载分支`}),k(`div`,{className:`mt-2 text-2xl font-semibold`,children:qe(F.value)})]}),O(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[k(`div`,{className:`text-xs text-base-content/45`,children:`当前展开`}),k(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(I.value)})]}),k(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`先滚动到较深位置再展开节点也没问题：视口外的行不会真正渲染，只有命中的 branch 才会触发 loadData 注入子节点。`})]})]})});T(()=>S(e,y,Me))});let J=s(`rue:component:anchor`);t(y,J),i(()=>{let e=C(A,{title:`保留原始递归 Demo`,summary:`旧的 TreeView 行为没有删掉，只是并进 design 页面里，方便对比“直接改数据”这类递归写法。`,tab:z.legacy,code:Ve,preview:k(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm not-prose`,children:O(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,1fr),18rem] lg:items-start`,children:[k(`ul`,{className:`m-0 grid gap-1 p-0`,children:k(Je,{model:re})}),k(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`单击切换展开，双击叶子节点会把它转换成 folder，并在当前层直接追加一个新子节点。`})]})})});T(()=>S(e,y,J))});let Y=d(`div`,y);t(y,Y),e(Y,`not-prose mt-10 space-y-4`);let X=d(`h2`,Y);t(Y,X),e(X,`text-2xl font-semibold`),t(X,o(`API`));let Z=s(`rue:component:anchor`);return t(Y,Z),i(()=>{let e=C(Ce,{rows:He});T(()=>S(e,Y,Z))}),_})}),b,x),b})};export{Ye as default};