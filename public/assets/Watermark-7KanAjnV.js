...
</Watermark>`});u(()=>f(e,d,R))});let z=e(`rue:component:anchor`);i(d,z),g(()=>{let e=h(T,{title:`Custom controls`,summary:`把 antd 的可调 demo 落到 Rue 风格里，用原生表单快速调整排版参数。`,tab:o.custom,preview:y(`div`,{className:`grid gap-4 xl:grid-cols-[minmax(0,1fr)_20rem]`,children:[b(X,{content:[s.value,`Scenario Sandbox`],rotate:c.value,gap:[p.value,v.value],offset:[E.value,D.value],zIndex:k.value,width:180,height:72,font:{color:A.value,fontSize:O.value,fontWeight:700,textAlign:`center`},className:`rounded-[1.75rem] border border-base-300 bg-gradient-to-br from-base-100 via-base-100 to-base-200 shadow-sm`,children:y(`div`,{className:`space-y-4 p-5 md:p-6`,children:[y(`div`,{className:`flex flex-wrap items-center justify-between gap-3`,children:[y(`div`,{children:[b(`div`,{className:`text-xs uppercase tracking-[0.18em] text-base-content/45`,children:`Scenario Sandbox`}),b(`div`,{className:`mt-2 text-2xl font-semibold text-base-content`,children:`参数调整后的实时预览`})]}),y(w,{outline:!0,children:[`z-index `,k.value]})]}),b(`p`,{className:`m-0 max-w-2xl text-sm leading-7 text-base-content/65`,children:`这里故意放了文字、徽标和按钮，方便观察水印对不同内容密度与层次关系的影响。`}),y(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[b(C,{className:`bg-base-100/90 shadow-sm md:col-span-2`,children:y(C.Body,{children:[b(`div`,{className:`text-sm font-semibold text-base-content`,children:`内容流`}),b(`p`,{className:`m-0 text-sm leading-7 text-base-content/65`,children:`Rue Watermark 会把铺设逻辑限制在当前容器内部，圆角、阴影和内容布局都可以继续由宿主容器控制。`})]})}),y(`div`,{className:`rounded-[1.25rem] bg-accent px-4 py-5 text-accent-content shadow-sm`,children:[b(`div`,{className:`text-xs uppercase tracking-[0.2em] opacity-70`,children:`Preset`}),b(`div`,{className:`mt-2 text-2xl font-black`,children:s.value})]})]}),y(`div`,{className:`flex flex-wrap gap-3`,children:[b(S,{size:`sm`,color:`primary`,onClick:()=>{s.value=`Rue Design`,c.value=-22,p.value=120,v.value=96,E.value=48,D.value=48,O.value=18,k.value=12,A.value=`rgba(15, 23, 42, 0.16)`},children:`重置参数`}),b(S,{size:`sm`,type:`outlined`,onClick:()=>{s.value=`Shared with Partner`,c.value=-8,p.value=156,v.value=124,E.value=64,D.value=32,O.value=14,k.value=10,A.value=`rgba(20, 83, 45, 0.16)`},children:`切换到稀疏模式`})]})]})}),b(C,{className:`bg-base-100 shadow-sm`,children:y(C.Body,{className:`gap-4`,children:[y(`div`,{children:[b(`div`,{className:`text-sm font-semibold text-base-content`,children:`文本`}),b(`input`,{className:`input input-bordered mt-2 w-full`,value:s.value,onInput:e=>{s.value=e.currentTarget.value}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Rotate `,c.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`-90`,max:`90`,value:String(c.value),onInput:e=>{c.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Font size `,O.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`12`,max:`28`,value:String(O.value),onInput:e=>{O.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Gap X `,p.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`72`,max:`180`,value:String(p.value),onInput:e=>{p.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Gap Y `,v.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`72`,max:`180`,value:String(v.value),onInput:e=>{v.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Offset X `,E.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`0`,max:`120`,value:String(E.value),onInput:e=>{E.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`Offset Y `,D.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`0`,max:`120`,value:String(D.value),onInput:e=>{D.value=Number(e.currentTarget.value)}})]}),y(`label`,{className:`grid gap-2`,children:[y(`span`,{className:`text-sm font-medium text-base-content`,children:[`z-index `,k.value]}),b(`input`,{className:`range range-sm`,type:`range`,min:`1`,max:`24`,value:String(k.value),onInput:e=>{k.value=Number(e.currentTarget.value)}})]}),y(`div`,{children:[b(`div`,{className:`text-sm font-medium text-base-content`,children:`Color`}),b(`input`,{className:`input input-bordered mt-2 w-full`,value:A.value,onInput:e=>{A.value=e.currentTarget.value}})]})]})})]}),code:`const content = ref('Rue Design')
const rotate = ref(-22)
const gapX = ref(120)
const gapY = ref(96)
...
</div>`});u(()=>f(e,d,z))});let B=r(`h2`,d);i(d,B),i(B,a(`API`));let V=e(`rue:component:anchor`);return i(d,V),g(()=>{let e=h(ee,{rows:$});u(()=>f(e,d,V))}),l})}),m,_),m})};export{te as default};