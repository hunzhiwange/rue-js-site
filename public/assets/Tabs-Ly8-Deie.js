import{F as e,I as t,K as n,L as r,N as i,Q as a,R as o,W as s,d as c,dt as l,ht as u,l as d,mt as f,rt as p,st as m,t as h,vt as g,z as _}from"./vapor-runtime-BuwLbCGk.js";import{a as v,n as y}from"./vapor-helpers-vapor-Bly5xJie.js";import{n as b,t as x}from"./src-BQwLQD8R.js";import{n as S}from"./SidebarPlaygroundDesign-SQXYHI-q.js";import{t as C}from"./Code-DQxnq0in.js";import{t as w}from"./tabs-DqfJzZfa.js";var T=t=>c(o=>{let s=r(`div`,o);n(s,`rounded-box border border-base-300/70 bg-base-200/40 p-4`);let c=r(`div`,s);i(s,c),n(c,`text-xs uppercase tracking-[0.18em] opacity-60`);let u=e(`rue:slot:anchor`);i(c,u),g(()=>{let e=t.title;l(()=>d(e,c,u))});let f=r(`div`,s);i(s,f),n(f,`mt-2 text-2xl font-semibold`);let p=_(f);i(f,p),g(()=>{a(p,t.value)});let m=r(`div`,s);i(s,m),n(m,`mt-1 text-sm opacity-75`);let h=e(`rue:slot:anchor`);return i(m,h),g(()=>{let e=t.description;l(()=>d(e,m,h))}),s}),ee=a=>c(u=>{let f=r(`div`,u);n(f,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let p=r(`table`,f);i(f,p),n(p,`table table-zebra`);let m=r(`thead`,p);i(p,m);let h=r(`tr`,m);i(m,h);let _=r(`th`,h);i(h,_),i(_,o(`属性`));let v=r(`th`,h);i(h,v),i(v,o(`说明`));let b=r(`th`,h);i(h,b),i(b,o(`类型`));let x=r(`th`,h);i(h,x),i(x,o(`默认值`));let S=r(`tbody`,p);i(p,S);let C=e(`rue:list:start`),w=e(`rue:list:end`);i(S,C),i(S,w);let T=new Map;return g(()=>{T=y({items:a.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(n,a,o,u,f)=>{d(c(()=>{let a=t(),o=r(`tr`,a);i(a,o),g(()=>{s(o,`key`,String(n.prop))});let c=r(`td`,o);i(o,c);let u=r(`code`,c);i(c,u);let f=e(`rue:slot:anchor`);i(u,f),g(()=>{let e=n.prop;l(()=>d(e,u,f))});let p=r(`td`,o);i(o,p);let m=e(`rue:slot:anchor`);i(p,m),g(()=>{let e=n.description;l(()=>d(e,p,m))});let h=r(`td`,o);i(o,h);let _=r(`code`,h);i(h,_);let v=e(`rue:slot:anchor`);i(_,v),g(()=>{let e=n.type;l(()=>d(e,_,v))});let y=r(`td`,o);i(o,y);let b=r(`code`,y);i(y,b);let x=e(`rue:slot:anchor`);return i(b,x),g(()=>{let e=n.defaultValue;l(()=>d(e,b,x))}),a}),a,o)}})}),f}),E=a=>{let{tabRef:s,tab:_,previewNode:y}=v(`useSetup:0:0`,()=>u(()=>{let e=v(`useRef:1:0`,()=>f());return e.current||=v(`ref:1:1`,()=>m(`preview`)),{tabRef:e,tab:e.current,previewNode:v(`computed:1:2`,()=>p(()=>Array.isArray(a.children)?a.children.find(e=>e!=null&&e!==``):a.children))}}));return c(s=>{let u=r(`div`,s);n(u,`component-preview not-prose text-base-content my-6 lg:my-12`);let f=r(`h2`,u);i(u,f),n(f,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(f,o(`# `));let p=e(`rue:slot:anchor`);i(f,p),g(()=>{let e=a.title;l(()=>d(e,f,p))});let m=e(`rue:component:anchor`);i(u,m),g(()=>{let e=h(w,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:_.value,onChange:e=>_.value=e,className:`mb-3`});l(()=>d(e,u,m))});let v=e(`rue:slot:anchor`);return i(u,v),g(()=>{let n=_.value===`preview`?y.get():c(()=>{let n=t(),r=e(`rue:component:anchor`);return i(n,r),g(()=>{let e=h(C,{className:`mt-2`,lang:`tsx`,code:a.code});l(()=>d(e,n,r))}),n});l(()=>d(n,u,v))}),u})},te=String.raw`<Tabs
  type="line"
...
/>`,children:Ee});l(()=>d(e,f,Te))});let De=e(`rue:component:anchor`);i(f,De);let Oe=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{style:`border`,items:[{key:`tab1`,label:`Tab 1`},{key:`tab2`,label:`Tab 2`},{key:`tab3`,label:`Tab 3`}],activeKey:C.value,onChange:e=>C.value=e});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tabs-border`,code:`<Tabs style="border" items={[{ key: 'tab1', label: 'Tab 1' }, { key: 'tab2', label: 'Tab 2' }, { key: 'tab3', label: 'Tab 3' }]} activeKey="tab2" />`,children:Oe});l(()=>d(e,f,De))});let ke=e(`rue:component:anchor`);i(f,ke);let Ae=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{style:`lift`,items:[{key:`tab1`,label:`Tab 1`},{key:`tab2`,label:`Tab 2`},{key:`tab3`,label:`Tab 3`}],activeKey:D.value,onChange:e=>D.value=e});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tabs-lift`,code:`<Tabs style="lift" items={[{ key: 'tab1', label: 'Tab 1' }, { key: 'tab2', label: 'Tab 2' }, { key: 'tab3', label: 'Tab 3' }]} activeKey="tab2" />`,children:Ae});l(()=>d(e,f,ke))});let je=e(`rue:component:anchor`);i(f,je);let Me=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{style:`box`,items:[{key:`tab1`,label:`Tab 1`},{key:`tab2`,label:`Tab 2`},{key:`tab3`,label:`Tab 3`}],activeKey:se.value,onChange:e=>se.value=e});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tabs-box`,code:`<Tabs style="box" items={[{ key: 'tab1', label: 'Tab 1' }, { key: 'tab2', label: 'Tab 2' }, { key: 'tab3', label: 'Tab 3' }]} activeKey="tab2" />`,children:Me});l(()=>d(e,f,je))});let Ne=e(`rue:component:anchor`);i(f,Ne);let Pe=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{type:`line`,defaultActiveKey:`overview`,destroyOnHidden:!0,items:[{key:`overview`,label:`Overview`,children:b(`div`,{className:`space-y-4`,children:[b(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[x(T,{title:`Velocity`,value:`+18%`,description:`本周交付速度`}),x(T,{title:`QA`,value:`7`,description:`待验证缺陷`}),x(T,{title:`Review`,value:`3`,description:`待合并 PR`})]}),b(`div`,{className:`grid gap-3 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]`,children:[b(`div`,{className:`rounded-box border border-base-300/70 bg-base-100 p-4`,children:[b(`div`,{className:`flex items-center justify-between`,children:[x(`div`,{className:`text-sm font-semibold`,children:`本周推进节奏`}),x(`span`,{className:`badge badge-success badge-sm`,children:`On Track`})]}),x(`progress`,{className:`progress progress-primary mt-4`,value:`72`,max:`100`}),b(`div`,{className:`mt-3 flex justify-between text-xs opacity-70`,children:[x(`span`,{children:`设计`}),x(`span`,{children:`联调`}),x(`span`,{children:`回归`}),x(`span`,{children:`发布`})]})]}),b(`div`,{className:`rounded-box border border-base-300/70 bg-base-100 p-4`,children:[x(`div`,{className:`text-sm font-semibold`,children:`Next Step`}),b(`ul`,{className:`mt-3 space-y-2 text-sm opacity-75`,children:[x(`li`,{children:`锁定接口字段命名`}),x(`li`,{children:`同步埋点事件与告警阈值`}),x(`li`,{children:`准备灰度发布公告`})]})]})]})]})},{key:`activity`,label:`Activity`,children:b(`div`,{className:`space-y-3`,children:[b(`ul`,{className:`list gap-2`,children:[b(`li`,{className:`list-row`,children:[x(`div`,{className:`font-medium`,children:`10:15`}),x(`div`,{className:`list-col-grow text-sm opacity-75`,children:`完成视觉验收，设计 token 已同步。`})]}),b(`li`,{className:`list-row`,children:[x(`div`,{className:`font-medium`,children:`14:35`}),x(`div`,{className:`list-col-grow text-sm opacity-75`,children:`设计评审通过，进入开发联调。`})]}),b(`li`,{className:`list-row`,children:[x(`div`,{className:`font-medium`,children:`16:20`}),x(`div`,{className:`list-col-grow text-sm opacity-75`,children:`补齐埋点与告警配置。`})]}),b(`li`,{className:`list-row`,children:[x(`div`,{className:`font-medium`,children:`18:40`}),x(`div`,{className:`list-col-grow text-sm opacity-75`,children:`QA 已预约今晚的回归窗口。`})]})]}),x(`div`,{role:`alert`,className:`alert alert-soft alert-info text-sm`,children:x(`span`,{children:`今晚 20:00 进入联调窗口，QA 会同步回归结果。`})})]})},{key:`members`,label:`Members`,children:x(`div`,{className:`grid gap-3 sm:grid-cols-3`,children:[{label:`UI`,owner:`Lin`,note:`组件规格与 token 已冻结`},{label:`FE`,owner:`Kai`,note:`交互联调与埋点已完成`},{label:`QA`,owner:`Mio`,note:`回归清单与冒烟脚本已准备`}].map(e=>b(`div`,{className:`rounded-box border border-base-300/70 bg-base-200/50 p-4`,children:[b(`div`,{className:`flex items-center justify-between`,children:[x(`div`,{className:`text-lg font-semibold`,children:e.label}),x(`span`,{className:`badge badge-ghost badge-sm`,children:e.owner})]}),x(`div`,{className:`mt-2 text-sm opacity-75`,children:e.note})]},e.label))})}]});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`content-panels`,code:te,children:Pe});l(()=>d(e,f,Ne))});let Fe=e(`rue:component:anchor`);i(f,Fe);let Ie=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{type:`card`,activeKey:ge.value,onChange:e=>ge.value=e,tabBarExtraContent:{left:x(`span`,{className:`badge badge-neutral badge-sm`,children:`Workspace`}),right:x(`button`,{className:`btn btn-primary btn-sm`,type:`button`,children:`New Milestone`})},items:[{key:`overview`,label:`Overview`,children:`版本计划、优先级排序与协作说明统一放在这里。`},{key:`timeline`,label:`Timeline`,children:`时间轴、里程碑和负责人信息可以作为右侧扩展操作的搭配内容。`},{key:`qa`,label:`QA`,children:`测试结果、风险等级与回归建议。`}]});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tab-bar-extra-content`,code:ne,children:Ie});l(()=>d(e,f,Fe))});let Le=e(`rue:component:anchor`);i(f,Le);let Re=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{centered:!0,type:`line`,activeKey:_e.value,onChange:e=>_e.value=e,items:[{key:`alpha`,label:`Alpha`},{key:`beta`,label:`Beta`},{key:`stable`,label:`Stable`}]});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`centered-tabs`,code:`<Tabs centered type="line" items={[{ key: 'alpha', label: 'Alpha' }, { key: 'beta', label: 'Beta' }, { key: 'stable', label: 'Stable' }]} activeKey="beta" />`,children:Re});l(()=>d(e,f,Le))});let ze=e(`rue:component:anchor`);i(f,ze);let Be=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm overflow-hidden`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{tabPlacement:O.value,type:`line`,activeKey:ve.value,onChange:e=>ve.value=e,className:`min-h-72`,tabBarExtraContent:{left:b(`div`,{className:`flex gap-2`,children:[x(`button`,{className:`btn btn-xs ${O.value===`start`?`btn-neutral`:`btn-ghost`}`,type:`button`,onClick:()=>O.value=`start`,children:`start`}),x(`button`,{className:`btn btn-xs ${O.value===`end`?`btn-neutral`:`btn-ghost`}`,type:`button`,onClick:()=>O.value=`end`,children:`end`})]})},items:[{key:`design`,label:`Design`,children:`左侧导航布局适合文档、设置页和大段信息浏览。`},{key:`review`,label:`Review`,children:`右侧摆放则更适合注释面板或对照式配置区域。`}]});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tab-placement`,code:re,children:Be});l(()=>d(e,f,ze))});let Ve=e(`rue:component:anchor`);i(f,Ve);let He=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{type:`editable-card`,activeKey:xe.value,onChange:e=>xe.value=e,onEdit:Ce,items:Se.value});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`editable-card`,code:ie,children:He});l(()=>d(e,f,Ve))});let Ue=e(`rue:component:anchor`);i(f,Ue);let We=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{type:`line`,activeKey:ye.value,onChange:e=>ye.value=e,indicator:{align:`center`,size:24,className:`bg-primary opacity-100`},items:[{key:`roadmap`,icon:x(`span`,{className:`mr-1 inline-flex badge badge-outline badge-xs`,"aria-hidden":`true`}),label:`Roadmap`},{key:`metrics`,icon:x(`span`,{className:`mr-1 inline-flex badge badge-primary badge-xs`,"aria-hidden":`true`}),label:`Metrics`},{key:`notes`,icon:x(`span`,{className:`mr-1 inline-flex badge badge-secondary badge-xs`,"aria-hidden":`true`}),label:`Notes`}]});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`custom-indicator`,code:`<Tabs
  type="line"
  ...
  activeKey="metrics"
/>`,children:We});l(()=>d(e,f,Ue))});let Ge=e(`rue:component:anchor`);i(f,Ge);let Ke=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=r(`div`,s);i(s,c),n(c,`flex flex-col items-center gap-6`);let u=e(`rue:component:anchor`);i(c,u),g(()=>{let e=h(w,{style:`lift`,size:`xs`,items:[{key:`xs1`,label:`Xsmall`},{key:`xs2`,label:`Xsmall`},{key:`xs3`,label:`Xsmall`}],activeKey:ce.value,onChange:e=>ce.value=e});l(()=>d(e,c,u))});let f=e(`rue:component:anchor`);i(c,f),g(()=>{let e=h(w,{style:`lift`,size:`sm`,items:[{key:`sm1`,label:`Small`},{key:`sm2`,label:`Small`},{key:`sm3`,label:`Small`}],activeKey:le.value,onChange:e=>le.value=e});l(()=>d(e,c,f))});let p=e(`rue:component:anchor`);i(c,p),g(()=>{let e=h(w,{style:`lift`,items:[{key:`md1`,label:`Medium`},{key:`md2`,label:`Medium`},{key:`md3`,label:`Medium`}],activeKey:ue.value,onChange:e=>ue.value=e});l(()=>d(e,c,p))});let m=e(`rue:component:anchor`);i(c,m),g(()=>{let e=h(w,{style:`lift`,size:`lg`,items:[{key:`lg1`,label:`Large`},{key:`lg2`,label:`Large`},{key:`lg3`,label:`Large`}],activeKey:de.value,onChange:e=>de.value=e});l(()=>d(e,c,m))});let _=e(`rue:component:anchor`);return i(c,_),g(()=>{let e=h(w,{style:`lift`,size:`xl`,items:[{key:`xl1`,label:`Xlarge`},{key:`xl2`,label:`Xlarge`},{key:`xl3`,label:`Xlarge`}],activeKey:fe.value,onChange:e=>fe.value=e});l(()=>d(e,c,_))}),a});g(()=>{let e=h(E,{title:`Sizes`,code:`<Tabs style="lift" size="xs" items={[{ key: 'xs1', label: 'Xsmall' }, { key: 'xs2', label: 'Xsmall' }, { key: 'xs3', label: 'Xsmall' }]} activeKey="xs2" />
...
<Tabs style="lift" size="xl" items={[{ key: 'xl1', label: 'Xlarge' }, { key: 'xl2', label: 'Xlarge' }, { key: 'xl3', label: 'Xlarge' }]} activeKey="xl2" />`,children:Ke});l(()=>d(e,f,Ge))});let qe=e(`rue:component:anchor`);i(f,qe);let Je=c(()=>{let a=t(),o=r(`div`,a);i(a,o),n(o,`card bg-base-100 shadow-sm`);let s=r(`div`,o);i(o,s),n(s,`card-body gap-4`);let c=e(`rue:component:anchor`);return i(s,c),g(()=>{let e=h(w,{style:`lift`,placement:`bottom`,items:[{key:`b1`,label:`Tab 1`,children:`Tab content 1`},{key:`b2`,label:`Tab 2`,children:`Tab content 2`},{key:`b3`,label:`Tab 3`,children:`Tab content 3`}],activeKey:pe.value,onChange:e=>pe.value=e});l(()=>d(e,s,c))}),a});g(()=>{let e=h(E,{title:`tabs-bottom`,code:`<Tabs
  style="lift"
  placement="bottom"
  items={[
