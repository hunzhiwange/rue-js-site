...
</div>`});p(()=>l(e,o,fe))});let W=i(`div`,o);r(o,W),f(W,`not-prose my-12 space-y-8`);let G=i(`section`,W);r(W,G),f(G,`space-y-2`);let K=i(`h2`,G);r(G,K),f(K,`text-2xl font-semibold`),r(K,u(`API`));let q=i(`p`,G);r(G,q),f(q,`text-sm opacity-70`),r(q,u(`推荐把外层背景和高度交给 Hero Root，把布局交给 Hero.Content，把标题、描述和 CTA 交给语义子组件。这样页面里仍然可以继续用 className 微调，但不会反复重写同一套结构。`));let J=i(`section`,W);r(W,J),f(J,`space-y-3`);let Y=i(`h3`,J);r(J,Y),f(Y,`text-xl font-semibold`),r(Y,u(`Hero`));let pe=a(`rue:component:anchor`);r(J,pe),c(()=>{let e=d(H,{rows:ne});p(()=>l(e,J,pe))});let X=i(`section`,W);r(W,X),f(X,`space-y-3`);let Z=i(`h3`,X);r(X,Z),f(Z,`text-xl font-semibold`),r(Z,u(`Hero.Content`));let me=a(`rue:component:anchor`);r(X,me),c(()=>{let e=d(H,{rows:re});p(()=>l(e,X,me))});let Q=i(`section`,W);r(W,Q),f(Q,`space-y-3`);let $=i(`h3`,Q);r(Q,$),f($,`text-xl font-semibold`),r($,u(`Hero parts`));let he=a(`rue:component:anchor`);return r(Q,he),c(()=>{let e=d(H,{rows:ie});p(()=>l(e,Q,he))}),t})}),o,m),o})};export{U as default};