...
`,I=(e,n,r)=>i(O,()=>({options:{title:`基础待办事项`,source:F},children:(e,n,r)=>{let i=()=>s(e=>{let n=v();t(n,P,()=>({}));let r=m(``),i=m(``);return n.insertBefore(r,n.firstChild),n.appendChild(i),[n.firstChild,n.lastChild]});return e==null?i():a(e,r,i)}}));export{I as default};