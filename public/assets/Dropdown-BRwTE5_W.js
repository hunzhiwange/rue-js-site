import{$ as e,Ht as t,Q as n,Rt as r,Xt as i,Y as a,Z as o,ct as s,et as c,l,mt as u,ot as d,qt as f,s as p,t as m,tt as h}from"./vapor-runtime-aZAg0Qkw.js";import{a as g,n as _}from"./vapor-helpers-vapor-gtGwiIv0.js";import{a as v,i as y}from"./persistentSidebarPlayground-IkfbXpbu.js";import{t as b}from"./dropdown-BrhxL5Zo.js";import{r as x}from"./SidebarPlaygroundDesign-CS11MI8e.js";import{t as S}from"./PreviewBlock-Byu5jIqR.js";var C=r=>l(u=>{let f=e(`div`,u);s(f,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let m=e(`table`,f);a(f,m),s(m,`table table-zebra`);let h=e(`thead`,m);a(m,h);let g=e(`tr`,h);a(h,g);let v=e(`th`,g);a(g,v),a(v,c(`属性`));let y=e(`th`,g);a(g,y),a(y,c(`说明`));let b=e(`th`,g);a(g,b),a(b,c(`类型`));let x=e(`th`,g);a(g,x),a(x,c(`默认值`));let S=e(`tbody`,m);a(m,S);let C=o(`rue:list:start`),w=o(`rue:list:end`);a(S,C),a(S,w);let T=new Map;return i(()=>{T=_({items:r.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(r,s,c,u,f)=>{p(l(()=>{let s=n(),c=e(`tr`,s);a(s,c),i(()=>{d(c,`key`,String(r.prop))});let l=e(`td`,c);a(c,l);let u=e(`code`,l);a(l,u);let f=o(`rue:slot:anchor`);a(u,f),i(()=>{let e=r.prop;t(()=>p(e,u,f))});let m=e(`td`,c);a(c,m);let h=o(`rue:slot:anchor`);a(m,h),i(()=>{let e=r.description;t(()=>p(e,m,h))});let g=e(`td`,c);a(c,g);let _=e(`code`,g);a(g,_);let v=o(`rue:slot:anchor`);a(_,v),i(()=>{let e=r.type;t(()=>p(e,_,v))});let y=e(`td`,c);a(c,y);let b=e(`code`,y);a(y,b);let x=o(`rue:slot:anchor`);return a(b,x),i(()=>{let e=r.defaultValue;t(()=>p(e,b,x))}),s}),s,c)}})}),f}),w=()=>{let{open:_,source:v}=g(`useSetup:0:0`,()=>f(()=>({open:g(`ref:1:0`,()=>r(!1)),source:g(`ref:1:1`,()=>r(`trigger`))})));return l(r=>{let f=e(`div`,r);s(f,`not-prose rounded-box border border-base-300 bg-base-100/70 p-6`);let g=e(`div`,f);a(f,g),s(g,`flex flex-wrap items-center gap-3`);let y=o(`rue:component:anchor`);a(g,y);let x=l(()=>{let t=n(),r=e(`button`,t);a(t,r),d(r,`type`,`button`),s(r,`btn btn-primary`),d(r,`data-testid`,`dropdown-controlled-trigger`);let o=h(r);return a(r,o),i(()=>{u(o,_.value?`关闭菜单`:`打开菜单`)}),t});i(()=>{let e=m(b,{trigger:`click`,open:_.value,overlayClassName:`animate-none transition-none`,onOpenChange:(e,t)=>{_.value=e,v.value=t.source},menu:{items:[{key:`pin`,label:`Pin to top`},{key:`mute`,label:`Mute notifications`},{type:`divider`},{key:`remove`,label:`Remove workspace`,danger:!0}]},children:x});t(()=>p(e,g,y))});let S=e(`span`,g);a(g,S),s(S,`text-sm text-base-content/70`),a(S,c(`用单个触发器演示受控模式，按钮文本和状态说明都跟随`));let C=e(`code`,S);a(S,C),a(C,c(`open`)),a(S,c(`变化。`));let w=e(`div`,f);a(f,w),s(w,`mt-4 rounded-box border border-base-300 bg-base-100 p-4 shadow-sm`);let T=e(`div`,w);a(w,T),s(T,`flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between`);let E=e(`div`,T);a(T,E),s(E,`text-sm font-medium`),a(E,c(`受控状态面板`));let D=e(`div`,T);a(T,D),s(D,`grid gap-2 sm:grid-flow-col sm:items-center sm:justify-end sm:gap-4`);let O=e(`div`,D);a(D,O),s(O,`flex items-center justify-between gap-3 sm:min-w-[11rem]`);let k=e(`span`,O);a(O,k),s(k,`text-xs uppercase tracking-wide text-base-content/60`),a(k,c(`当前状态`));let A=e(`span`,O);a(O,A),s(A,`badge badge-soft badge-primary min-w-[5.5rem] justify-center uppercase tracking-wide`),d(A,`data-testid`,`dropdown-controlled-state`);let j=h(A);a(A,j),i(()=>{u(j,_.value?`open`:`closed`)});let M=e(`div`,D);a(D,M),s(M,`flex items-center justify-between gap-3 sm:min-w-[11rem]`);let N=e(`span`,M);a(M,N),s(N,`text-sm text-base-content/60`),a(N,c(`最近来源`));let P=e(`span`,M);a(M,P),s(P,`badge badge-outline min-w-[5.5rem] justify-center font-normal`),d(P,`data-testid`,`dropdown-controlled-source`);let F=h(P);return a(P,F),i(()=>{u(F,v.value)}),f})},T=[{prop:`menu / items`,description:`推荐的数据驱动入口。直接渲染命令菜单，支持 divider、group、submenu、selectable 等能力。`,type:`DropdownMenuProps / MenuDataEntry[]`,defaultValue:`-`},{prop:`trigger`,description:`控制打开方式，支持 hover、click、contextMenu；默认更接近成熟组件库的 hover。`,type:`'hover' | 'click' | 'contextMenu' | Array<...>`,defaultValue:`'hover'`},{prop:`open / defaultOpen / onOpenChange`,description:`受控与非受控显隐；回调会额外返回 source，便于区分 trigger、menu、outside、escape。`,type:`boolean / boolean / (open, info) => void`,defaultValue:`false / false / -`},{prop:`placement`,description:`语义化定位别名，内部映射到 Rue 当前的 align + direction 组合。`,type:`'bottomLeft' | 'bottom' | 'bottomRight' | 'topLeft' | ...`,defaultValue:`'bottomLeft'`},{prop:`overlay / content / popupRender`,description:`自定义面板内容或在原面板外层追加头部、底部、快捷操作区。`,type:`any / any / (originNode) => any`,defaultValue:`-`},{prop:`arrow / overlayClassName / overlayStyle`,description:`保留 Rue 当前视觉基底，同时提供箭头与面板层定制。`,type:`boolean / string / style object`,defaultValue:`false / - / -`},{prop:`align / direction / hover / forceOpen / forceClose`,description:`原有 daisyUI 风格能力继续保留，适合原生结构或静态布局演示。`,type:`兼容属性`,defaultValue:`-`},{prop:`children + Dropdown.Trigger / Dropdown.Content`,description:`旧的 compound 结构继续可用；当你不想走数据驱动时，仍可手写原生内容。`,type:`any`,defaultValue:`-`}],E=[{prop:`menu.items`,description:`菜单项数组，复用 Rue Menu 的 item / divider / group / submenu 数据结构。`,type:`MenuDataEntry[]`,defaultValue:`[]`},{prop:`menu.selectable / multiple / selectedKeys`,description:`用于做筛选面板、视图切换、状态菜单等可选中场景。`,type:`boolean / boolean / MenuKey[]`,defaultValue:`false / false / -`},{prop:`menu.onClick / onSelect / onOpenChange`,description:`菜单项点击、选中和子菜单展开都复用 Menu 的回调结构。`,type:`Menu callbacks`,defaultValue:`-`},{prop:`closeOnClick`,description:`点击菜单项后是否自动关闭；命令菜单推荐保留默认 true，筛选面板常见设为 false。`,type:`boolean`,defaultValue:`true`}],D=()=>{let{tabs:_,selectedKeys:D,filterKeys:O}=g(`useSetup:0:0:dup1`,()=>f(()=>({tabs:{recommended:g(`ref:1:2`,()=>r(`preview`)),controlled:g(`ref:1:3`,()=>r(`preview`)),selectable:g(`ref:1:4`,()=>r(`preview`)),custom:g(`ref:1:5`,()=>r(`preview`)),contextMenu:g(`ref:1:6`,()=>r(`preview`)),details:g(`ref:1:7`,()=>r(`preview`)),popover:g(`ref:1:8`,()=>r(`preview`)),focus:g(`ref:1:9`,()=>r(`preview`)),positions:g(`ref:1:10`,()=>r(`preview`)),modifiers:g(`ref:1:11`,()=>r(`preview`))},selectedKeys:g(`ref:1:12`,()=>r([`overview`])),filterKeys:g(`ref:1:13`,()=>r([`mentions`,`comment`]))}))),k=[{type:`group`,label:`Workspace`,children:[{key:`overview`,label:`Overview`,extra:y(`span`,{className:`badge badge-primary badge-xs`,children:`Live`})},{key:`activity`,label:`Activity Feed`}]},{type:`submenu`,key:`publish`,label:`Publish`,children:[{key:`draft`,label:`Save Draft`},{key:`review`,label:`Send For Review`},{key:`live`,label:`Publish Now`,danger:!0}]},{type:`divider`},{key:`archive`,label:`Archive Space`}],A=[{key:`overview`,label:`Overview`},{key:`mentions`,label:`Mentions`},{key:`comment`,label:`Comments`},{key:`watching`,label:`Watching`,disabled:!0}];return l(r=>{let f=n(),g=o(`rue:component:anchor`);return a(f,g),p(m(x,{children:l(()=>{let r=n(),l=e(`div`,r);a(r,l),s(l,`max-w-none prose prose-sm md:prose-base`);let f=e(`h1`,l);a(l,f),a(f,c(`Dropdown 下拉菜单`));let g=e(`p`,l);a(l,g),s(g,`text-sm mt-3 mb-3`),a(g,c(`Rue 的 Dropdown 现在同时支持两条路径：一条是保留当前视觉风格与 daisyUI 原生结构的兼容写法；另一条是更贴近业务组件习惯的增强 API，直接支持`));let x=h(g);a(g,x),u(x,` `);let j=e(`code`,g);a(g,j),a(j,c(`menu / items`)),a(g,c(`、`));let M=e(`code`,g);a(g,M),a(M,c(`trigger`)),a(g,c(`、`));let N=e(`code`,g);a(g,N),a(N,c(`placement`)),a(g,c(`、`));let P=e(`code`,g);a(g,P),a(P,c(`open`)),a(g,c(`、`));let F=e(`code`,g);a(g,F),a(F,c(`popupRender`)),a(g,c(`和右键菜单。`));let I=e(`div`,l);a(l,I),s(I,`not-prose mt-6 grid gap-4 md:grid-cols-3`);let L=e(`div`,I);a(I,L),s(L,`rounded-box border border-base-300 bg-base-100 p-4 shadow-sm`);let R=e(`div`,L);a(L,R),s(R,`text-xs font-semibold uppercase tracking-wide text-primary`),a(R,c(`推荐写法`));let z=e(`div`,L);a(L,z),s(z,`mt-2 text-sm font-medium`),a(z,c(`用 menu / items 描述命令菜单`));let B=e(`p`,L);a(L,B),s(B,`mt-2 text-sm opacity-70`),a(B,c(`更适合操作菜单、用户菜单、列表行操作和上下文菜单，不必再手写浮层结构。`));let V=e(`div`,I);a(I,V),s(V,`rounded-box border border-base-300 bg-base-100 p-4 shadow-sm`);let H=e(`div`,V);a(V,H),s(H,`text-xs font-semibold uppercase tracking-wide text-secondary`),a(H,c(`daisyUI 原始写法`));let U=e(`div`,V);a(V,U),s(U,`mt-2 text-sm font-medium`),a(U,c(`原始写法可用`));let W=e(`p`,V);a(V,W),s(W,`mt-2 text-sm opacity-70`);let ee=e(`code`,W);a(W,ee),a(ee,c(`details`)),a(W,c(`、`));let te=e(`code`,W);a(W,te),a(te,c(`popover`)),a(W,c(`、`));let ne=e(`code`,W);a(W,ne),a(ne,c(`focus`)),a(W,c(`、位置类和 modifier 都没有删除。`));let G=e(`div`,I);a(I,G),s(G,`rounded-box border border-base-300 bg-base-100 p-4 shadow-sm`);let K=e(`div`,G);a(G,K),s(K,`text-xs font-semibold uppercase tracking-wide text-accent`),a(K,c(`交互补齐`));let q=e(`div`,G);a(G,q),s(q,`mt-2 text-sm font-medium`),a(q,c(`受控、右键、可选中、自定义面板`));let re=e(`p`,G);a(G,re),s(re,`mt-2 text-sm opacity-70`),a(re,c(`适合业务菜单、筛选菜单、带说明区的弹层菜单，以及需要区分关闭来源的场景。`));let ie=e(`h2`,l);a(l,ie),a(ie,c(`何时使用`));let J=e(`ul`,l);a(l,J);let ae=e(`li`,J);a(J,ae),a(ae,c(`需要一个轻量命令面板，把 3 到 8 个动作收纳到按钮、头像或行内入口后面。`));let oe=e(`li`,J);a(J,oe),a(oe,c(`希望保留 Rue 当前 dropdown 视觉风格，但把 API 提升到更接近成熟组件库的层级。`));let se=e(`li`,J);a(J,se),a(se,c(`既要支持原生 HTML 结构，也要支持数据驱动菜单、受控状态和右键上下文菜单。`));let ce=e(`h2`,l);a(l,ce),a(ce,c(`推荐增强 API`));let le=o(`rue:component:anchor`);a(l,le),i(()=>{let e=m(S,{title:`推荐：命令菜单`,tab:_.recommended,preview:()=>y(`div`,{className:`not-prose flex min-h-56 items-start justify-start rounded-box border border-base-300 bg-base-100/70 p-6`,children:y(b,{trigger:`click`,placement:`bottomLeft`,arrow:!0,items:k,"data-testid":`dropdown-recommended`,children:y(`button`,{className:`btn btn-primary`,children:`Workspace`})})}),code:`const items = [
  {
    type: 'group',
    label: 'Workspace',
    children: [
...
</Dropdown>`});t(()=>p(e,l,le))});let ue=o(`rue:component:anchor`);a(l,ue),i(()=>{let e=m(S,{title:`受控开关与来源`,tab:_.controlled,preview:y(w,{}),code:`const open = ref(false);
...
</Dropdown>`});t(()=>p(e,l,de))});let fe=o(`rue:component:anchor`);a(l,fe),i(()=>{let e=m(S,{title:`自定义面板包装`,tab:_.custom,preview:()=>y(`div`,{className:`not-prose flex min-h-64 items-start rounded-box border border-base-300 bg-base-100/70 p-6`,children:y(b,{trigger:`click`,placement:`bottomRight`,arrow:!0,overlay:v(`div`,{className:`p-4`,children:[y(`div`,{className:`text-sm font-medium`,children:`Editor shortcuts`}),y(`div`,{className:`mt-2 text-sm text-base-content/70`,children:`Publish, share and manage visibility in one place.`})]}),popupRender:e=>v(`div`,{className:`w-72`,children:[y(`div`,{className:`border-b border-base-300 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-primary`,children:`Quick panel`}),e,v(`div`,{className:`flex items-center justify-end gap-2 border-t border-base-300 px-4 py-3`,children:[y(`button`,{className:`btn btn-ghost btn-sm`,children:`Later`}),y(`button`,{className:`btn btn-primary btn-sm`,children:`Publish`})]})]}),children:y(`button`,{className:`btn btn-secondary`,children:`Quick Panel`})})}),code:`<Dropdown
  trigger="click"
...
<Dropdown direction="left" align="end">
  ...
  <Dropdown.Content as="ul" tabIndex={-1} className="menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm">...</Dropdown.Content>
</Dropdown>`});t(()=>p(e,l,ve))});let ye=o(`rue:component:anchor`);a(l,ye),i(()=>{let e=m(S,{title:`Dropdown hover and force open`,tab:_.modifiers,preview:()=>v(b,{hover:!0,forceOpen:!0,children:[y(`div`,{tabIndex:0,role:`button`,className:`btn m-1`,children:`Always visible`}),v(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[y(`li`,{children:y(`button`,{children:`Item 1`})}),y(`li`,{children:y(`button`,{children:`Item 2`})})]})]}),code:`<Dropdown hover forceOpen>
  <div tabIndex={0} role="button" className="btn m-1">Always visible</div>
  <Dropdown.Content as="ul" tabIndex={-1} className="menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm">
    <li><button>Item 1</button></li>
    <li><button>Item 2</button></li>
  </Dropdown.Content>
</Dropdown>`});t(()=>p(e,l,ye))}),a(l,e(`br`,l));let be=e(`h2`,l);a(l,be),d(be,`id`,`dropdown-api`),a(be,c(`API`));let xe=o(`rue:component:anchor`);a(l,xe),i(()=>{let e=m(C,{rows:T});t(()=>p(e,l,xe))});let Se=e(`h3`,l);a(l,Se),s(Se,`mt-8`),a(Se,c(`menu 扩展`));let Ce=o(`rue:component:anchor`);a(l,Ce),i(()=>{let e=m(C,{rows:E});t(()=>p(e,l,Ce))});let we=e(`h2`,l);a(l,we),a(we,c(`FAQ`));let Y=e(`ul`,l);a(l,Y);let X=e(`li`,Y);a(Y,X),a(X,c(`想做业务菜单、用户菜单、右键菜单时，优先用`));let Te=e(`code`,X);a(X,Te),a(Te,c(`menu`)),a(X,c(`或`));let Ee=e(`code`,X);a(X,Ee),a(Ee,c(`items`)),a(X,c(`。`));let Z=e(`li`,Y);a(Y,Z),a(Z,c(`想保留完全原生的 HTML 结构时，继续使用`));let De=e(`code`,Z);a(Z,De),a(De,c(`Dropdown.Trigger`)),a(Z,c(`+`));let Oe=h(Z);a(Z,Oe),u(Oe,` `);let ke=e(`code`,Z);a(Z,ke),a(ke,c(`Dropdown.Content`)),a(Z,c(`，或直接写 details / summary。`));let Q=e(`li`,Y);a(Y,Q),a(Q,c(`需要筛选面板、多选菜单时，通常把`));let Ae=e(`code`,Q);a(Q,Ae),a(Ae,c(`closeOnClick`)),a(Q,c(`设为`));let je=e(`code`,Q);a(Q,je),a(je,c(`false`)),a(Q,c(`，并配合`));let Me=e(`code`,Q);a(Q,Me),a(Me,c(`menu.selectable`)),a(Q,c(`。`));let $=e(`li`,Y);a(Y,$),a($,c(`需要在面板里追加说明、底部操作区或二次确认按钮时，使用`));let Ne=e(`code`,$);a($,Ne),a(Ne,c(`popupRender`));let Pe=h($);return a($,Pe),u(Pe,` `),a($,c(`包住原始内容。`)),r})}),f,g),f})};export{D as default};