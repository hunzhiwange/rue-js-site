...
export default LazySplitterDemo`,Z=t=>f(n=>{let a=o(`div`,n);b(a,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let s=o(`table`,a);i(a,s),b(s,`table table-zebra`);let c=o(`thead`,s);i(s,c);let l=o(`tr`,c);i(c,l);let d=o(`th`,l);i(l,d),i(d,_(`属性`));let p=o(`th`,l);i(l,p),i(p,_(`说明`));let m=o(`th`,l);i(l,m),i(m,_(`类型`));let v=o(`th`,l);i(l,v),i(v,_(`默认值`));let y=o(`tbody`,s);i(s,y);let S=u(`rue:list:start`),w=u(`rue:list:end`);i(y,S),i(y,w);let T=new Map;return h(()=>{T=C({items:t.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:y,before:w,singleRoot:!0,trackIndex:!1,start:S,renderItem:(t,n,a,s,c)=>{g(f(()=>{let n=r(),a=o(`tr`,n);i(n,a),h(()=>{e(a,`key`,String(t.prop))});let s=o(`td`,a);i(a,s);let c=o(`code`,s);i(s,c);let l=u(`rue:slot:anchor`);i(c,l),h(()=>{let e=t.prop;x(()=>g(e,c,l))});let d=o(`td`,a);i(a,d);let f=u(`rue:slot:anchor`);i(d,f),h(()=>{let e=t.description;x(()=>g(e,d,f))});let p=o(`td`,a);i(a,p);let m=o(`code`,p);i(p,m);let _=u(`rue:slot:anchor`);i(m,_),h(()=>{let e=t.type;x(()=>g(e,m,_))});let v=o(`td`,a);i(a,v);let y=o(`code`,v);i(v,y);let b=u(`rue:slot:anchor`);return i(y,b),h(()=>{let e=t.defaultValue;x(()=>g(e,y,b))}),n}),n,a)}})}),a}),Q=e=>s(`div`,{className:`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)] ${e.className??``}`.trim()},s(`div`,{className:`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`},e.title),s(`div`,{className:`mb-4 text-sm leading-6 text-base-content/70`},e.subtitle),s(`div`,{className:`min-h-0`},...G(e.children))),pe=()=>{let{controlledSizes:t,controlledResizable:s,controlledStatus:c}=S(`useSetup:0:0`,()=>n(()=>({controlledSizes:S(`ref:1:0`,()=>d([`38%`,`62%`])),controlledResizable:S(`ref:1:1`,()=>d(!0)),controlledStatus:S(`ref:1:2`,()=>d(`等待拖拽`))})));return f(n=>{let d=o(`div`,n);b(d,`space-y-4`);let p=o(`div`,d);i(d,p),b(p,`flex flex-wrap gap-2`);let m=o(`button`,p);i(p,m),e(m,`type`,`button`),b(m,`btn btn-sm`),l(m,`click`,()=>{t.value=[`30%`,`70%`],c.value=`已切到 30 / 70 预设`}),i(m,_(`30 / 70`));let S=o(`button`,p);i(p,S),e(S,`type`,`button`),b(S,`btn btn-sm btn-outline`),l(S,`click`,()=>{t.value=[`50%`,`50%`],c.value=`已重置为 50 / 50`}),i(S,_(`平分`));let C=o(`button`,p);i(p,C),e(C,`type`,`button`),h(()=>{b(C,String(`btn btn-sm btn-ghost ${s.value?``:`btn-active`}`.trim()))}),l(C,`click`,()=>{s.value=!s.value,c.value=s.value?`已恢复左栏拖拽`:`已锁定左栏拖拽`});let w=a(C);i(C,w),h(()=>{v(w,s.value?`锁定左栏`:`恢复拖拽`)});let T=u(`rue:component:anchor`);i(d,T);let E=f(()=>{let e=r(),n=u(`rue:component:anchor`);i(e,n);let l=f(()=>{let e=r(),t=o(`div`,e);i(e,t),b(t,`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)]`);let n=o(`div`,t);i(t,n),b(n,`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`),i(n,_(`Filters`));let s=o(`div`,t);i(t,s),b(s,`mb-4 text-sm leading-6 text-base-content/70`),i(s,_(`受控模式下，这一栏可以被外部按钮锁定或重置。`));let l=o(`div`,t);i(t,l),b(l,`text-xs text-base-content/60`);let u=a(l);return i(l,u),h(()=>{v(u,c.value)}),e});h(()=>{let r=y(U.Panel,{size:t.value[0],resizable:s.value,children:l});x(()=>g(r,e,n))});let d=u(`rue:component:anchor`);i(e,d);let p=f(()=>{let e=r(),n=o(`div`,e);i(e,n),b(n,`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)]`);let s=o(`div`,n);i(n,s),b(s,`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`),i(s,_(`Results`));let c=o(`div`,n);i(n,c),b(c,`mb-4 text-sm leading-6 text-base-content/70`),i(c,_(`右栏跟随 onResize 返回值同步，适合持久化工作台布局。`));let l=o(`div`,n);i(n,l),b(l,`text-sm text-base-content/70`),i(l,_(`受控尺寸：`));let u=a(l);return i(l,u),h(()=>{v(u,t.value.join(` / `))}),e});return h(()=>{let n=y(U.Panel,{size:t.value[1],children:p});x(()=>g(n,e,d))}),e});return h(()=>{let e=y(U,{style:{height:300},onResize:e=>{t.value=e,c.value=`当前尺寸：${e.join(` / `)}`},children:E});x(()=>g(e,d,T))}),d})},me=()=>{let{triptychSizes:e,triptychStatus:t}=S(`useSetup:0:0:dup1`,()=>n(()=>({triptychSizes:S(`ref:1:3`,()=>d(W.slice())),triptychStatus:S(`ref:1:4`,()=>d(`双击任意分隔柄可重置`))})));return f(n=>{let s=o(`div`,n);b(s,`space-y-4`);let c=o(`div`,s);i(s,c),b(c,`text-sm text-base-content/65`);let l=a(c);i(c,l),h(()=>{v(l,t.value)});let d=u(`rue:component:anchor`);i(s,d);let p=f(()=>{let t=r(),n=u(`rue:component:anchor`);i(t,n);let a=y(Q,{title:`Sources`,subtitle:`左侧资源树或文档大纲。`});h(()=>{let r=y(U.Panel,{size:e.value[0],min:120,children:a});x(()=>g(r,t,n))});let o=u(`rue:component:anchor`);i(t,o);let s=y(Q,{title:`Editor`,subtitle:`中间主编辑区通常需要最大的宽度。`});h(()=>{let n=y(U.Panel,{size:e.value[1],min:180,children:s});x(()=>g(n,t,o))});let c=u(`rue:component:anchor`);i(t,c);let l=y(Q,{title:`Preview`,subtitle:`右侧实时预览或审阅信息。`});return h(()=>{let n=y(U.Panel,{size:e.value[2],min:120,children:l});x(()=>g(n,t,c))}),t});return h(()=>{let n=y(U,{style:{height:260},onResize:n=>{e.value=n,t.value=`当前布局：${n.join(` / `)}`},onDraggerDoubleClick:()=>{e.value=W.slice(),t.value=`已恢复 Sources / Editor / Preview 默认布局`},children:p});x(()=>g(n,s,d))}),s})},$=()=>{let{lazyStatus:e}=S(`useSetup:0:0:dup2`,()=>n(()=>({lazyStatus:S(`ref:1:5`,()=>d(`拖拽时只移动 handle，释放后才提交尺寸`))})));return f(t=>{let n=o(`div`,t);b(n,`space-y-4`);let s=o(`div`,n);i(n,s),b(s,`text-sm text-base-content/65`);let c=a(s);i(s,c),h(()=>{v(c,e.value)});let l=u(`rue:component:anchor`);i(n,l);let d=f(()=>{let e=r(),t=u(`rue:component:anchor`);i(e,t);let n=y(Q,{title:`Analysis`,subtitle:`左侧适合放图表、规则或输入参数。`,children:f(()=>{let e=r(),t=o(`div`,e);return i(e,t),b(t,`rounded-box bg-primary/10 p-4 text-sm text-base-content/70`),i(t,_(`Strategy setup`)),e})});g(y(U.Panel,{defaultSize:`44%`,min:`30%`,children:n}),e,t);let a=u(`rue:component:anchor`);i(e,a);let s=y(Q,{title:`Output`,subtitle:`右侧接收结果、日志或建议列表。`,children:f(()=>{let e=r(),t=o(`div`,e);i(e,t),b(t,`space-y-2 text-sm text-base-content/70`);let n=o(`div`,t);i(t,n),b(n,`rounded-box bg-base-200/70 px-3 py-2`),i(n,_(`Insight A`));let a=o(`div`,t);i(t,a),b(a,`rounded-box bg-base-200/70 px-3 py-2`),i(a,_(`Insight B`));let s=o(`div`,t);return i(t,s),b(s,`rounded-box bg-base-200/70 px-3 py-2`),i(s,_(`Insight C`)),e})});return g(y(U.Panel,{children:s}),e,a),e});return h(()=>{let t=y(U,{lazy:!0,style:{height:280},onResizeStart:()=>{e.value=`开始拖拽，当前只移动 handle 预览位移`},onResize:t=>{e.value=`释放后已提交尺寸：${t.join(` / `)}`},children:d});x(()=>g(t,n,l))}),n})},he=()=>{let{tabs:t}=S(`useSetup:0:0:dup3`,()=>n(()=>({tabs:{basic:S(`ref:1:6`,()=>d(`preview`)),controlled:S(`ref:1:7`,()=>d(`preview`)),vertical:S(`ref:1:8`,()=>d(`preview`)),collapsible:S(`ref:1:9`,()=>d(`preview`)),reset:S(`ref:1:10`,()=>d(`preview`)),lazy:S(`ref:1:11`,()=>d(`preview`))}})));return f(n=>{let s=r(),c=u(`rue:component:anchor`);return i(s,c),g(y(E,{children:f(()=>{let n=r(),s=o(`div`,n);i(n,s),b(s,`max-w-none prose prose-sm md:prose-base`);let c=o(`h1`,s);i(s,c),i(c,_(`Splitter 分割面板`));let l=o(`p`,s);i(s,l),b(l,`text-sm mt-3 mb-3`),i(l,_(`Splitter 在 Rue 里不是一条简单的分隔线，而是一套适合工作台、配置台和双栏内容区的布局行为层。 它保留 Rue Design 当前的柔和卡片气质和细颗粒 handle 视觉，同时补上可拖拽、受控尺寸、垂直布局、 折叠、lazy 拖拽和双击重置这些更接近成熟组件库的核心能力。`));let d=o(`h2`,s);i(s,d),i(d,_(`何时使用`));let f=o(`ul`,s);i(s,f);let p=o(`li`,f);i(f,p),i(p,_(`需要左右或上下两个工作区同时存在，并允许用户按内容密度自己调节比例。`));let m=o(`li`,f);i(f,m),i(m,_(`需要把筛选区、编辑区、预览区、日志区这类不同角色的面板拆开，但仍保持同一个页面上下文。`));let S=o(`li`,f);i(f,S),i(S,_(`需要在布局层提供折叠、受控重置和 lazy 拖拽，而不是只做静态栅格分栏。`));let C=o(`h2`,s);i(s,C),i(C,_(`推荐用法`));let E=o(`p`,s);i(s,E),b(E,`text-sm mt-3 mb-4`),i(E,_(`下面每个 JSX 示例都保留了完整结构，方便直接复制到页面组件里使用。`));let O=u(`rue:component:anchor`);i(s,O),h(()=>{let e=y(D,{title:`Basic workspace split`,summary:`最基础的双栏写法，默认比例、最小值和最大值都在 Panel 上声明。`,tab:t.basic,preview:()=>w(U,{style:{height:280},children:[T(U.Panel,{defaultSize:`40%`,min:`24%`,max:`70%`,children:T(Q,{title:`Navigation`,subtitle:`把目录、资源树或查询条件放在左侧。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Overview`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Metrics`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Deployments`})]})})}),T(U.Panel,{children:T(Q,{title:`Editor`,subtitle:`右侧保留完整内容区，适合表单、文档或分析结果。`,children:T(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-200/50 p-4 text-sm leading-7 text-base-content/70`,children:`这里是主工作区。拖动中间的 handle，可以把左右空间分配给导航和正文。`})})})]}),code:K});x(()=>g(e,s,O))});let k=u(`rue:component:anchor`);i(s,k),h(()=>{let e=y(D,{title:`Controlled sizes and reset`,summary:`受控模式适合和按钮、预设布局、权限开关联动。`,tab:t.controlled,preview:pe,code:q});x(()=>g(e,s,k))});let A=u(`rue:component:anchor`);i(s,A),h(()=>{let e=y(D,{title:`Vertical split`,summary:`上下分栏适合 dashboard 顶部概览 + 底部明细、编辑区 + 日志区这类结构。`,tab:t.vertical,preview:()=>w(U,{orientation:`vertical`,style:{height:520},children:[T(U.Panel,{defaultSize:`32%`,min:`10%`,children:T(Q,{title:`Summary`,subtitle:`顶部保留关键指标和状态总览。`,children:w(`div`,{className:`grid gap-3 sm:grid-cols-3`,children:[T(`div`,{className:`rounded-box bg-success/12 p-3 text-sm`,children:`Success 18`}),T(`div`,{className:`rounded-box bg-warning/12 p-3 text-sm`,children:`Queued 4`}),T(`div`,{className:`rounded-box bg-info/12 p-3 text-sm`,children:`Running 2`})]})})}),T(U.Panel,{children:T(Q,{title:`Details`,subtitle:`底部用来承接更长的列表、表格或日志。`,children:T(`div`,{className:`rounded-box bg-base-200/60 p-4 text-sm leading-7 text-base-content/70`,children:`这里可以放明细列表、数据表格、执行日志，或者任何比顶部更“长”的内容。`})})})]}),code:J});x(()=>g(e,s,A))});let j=u(`rue:component:anchor`);i(s,j),h(()=>{let e=y(D,{title:`Collapsible panels and custom handle`,summary:`折叠按钮和自定义 draggerIcon 适合三栏工作区，让辅助区可以快速收起。`,tab:t.collapsible,preview:()=>w(U,{style:{height:320},draggerIcon:T(`span`,{className:`inline-flex h-4 w-4 items-center justify-center text-[10px] font-black leading-none text-base-content/70`,children:`|||`}),collapsibleIcon:{start:T(`span`,{className:`text-xs`,children:`+`}),end:T(`span`,{className:`text-xs`,children:`-`})},children:[T(U.Panel,{defaultSize:`28%`,collapsible:{end:!0},children:T(Q,{title:`Palette`,subtitle:`左栏可快速折叠，适合图层、筛选器或工具箱。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Components`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Tokens`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Layers`})]})})}),T(U.Panel,{collapsible:{start:!0,end:!0},children:T(Q,{title:`Canvas`,subtitle:`中间主区保留最大的操作空间。`,children:T(`div`,{className:`flex h-40 items-center justify-center rounded-box border border-dashed border-base-300 bg-base-200/40 text-sm text-base-content/55`,children:`Main canvas`})})}),T(U.Panel,{defaultSize:`22%`,collapsible:{start:!0},children:T(Q,{title:`Inspector`,subtitle:`右侧检查面板按需展开，减少噪音。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{children:`Width: 320`}),T(`div`,{children:`Height: 180`}),T(`div`,{children:`Radius: 16`})]})})})]}),code:fe});x(()=>g(e,s,j))});let M=u(`rue:component:anchor`);i(s,M),h(()=>{let e=y(D,{title:`Multiple panels and double click reset`,summary:`多面板场景里，双击分隔柄常常比额外按钮更顺手。`,tab:t.reset,preview:me,code:Y});x(()=>g(e,s,M))});let N=u(`rue:component:anchor`);i(s,N),h(()=>{let e=y(D,{title:`Lazy drag for analysis view`,summary:`lazy 模式更适合重内容布局，拖动过程先预览位置，释放后再真正提交尺寸。`,tab:t.lazy,preview:$,code:X});x(()=>g(e,s,N))});let P=o(`h2`,s);i(s,P),e(P,`id`,`splitter-api`),i(P,_(`API`));let F=o(`p`,s);i(s,F),b(F,`text-sm mt-3 mb-4`),i(F,_(`Splitter 的根组件负责布局和交互，所有真正参与计算的子节点都应该是`));let I=a(F);i(F,I),v(I,` `);let L=o(`code`,F);i(F,L),i(L,_(`Splitter.Panel`)),i(F,_(`。 如果你在业务里需要把布局状态持久化，优先使用`));let ee=a(F);i(F,ee),v(ee,` `);let R=o(`code`,F);i(F,R),i(R,_(`size`)),i(F,_(`+`));let z=o(`code`,F);i(F,z),i(z,_(`onResize`)),i(F,_(`的受控写法；如果只需要默认占比，用`));let B=o(`code`,F);i(F,B),i(B,_(`defaultSize`)),i(F,_(`即可。`));let V=u(`rue:component:anchor`);return i(s,V),h(()=>{let e=y(Z,{rows:de});x(()=>g(e,s,V))}),n})}),s,c),s})};export{he as default};