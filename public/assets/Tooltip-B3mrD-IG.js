import{$ as e,Ht as t,J as n,Lt as r,Q as i,X as a,Xt as o,Z as s,at as c,et as l,l as u,lt as d,pt as f,q as p,qt as m,s as h,st as g,t as _}from"./vapor-runtime-iQZthBPQ.js";import{a as v,n as y}from"./vapor-helpers-vapor-BjKHCvOa.js";import{a as b,i as x}from"./persistentSidebarPlayground-BfF7yM0K.js";import{t as S}from"./tooltip-Bz59VdZF.js";import{r as C}from"./SidebarPlaygroundDesign-BcHYLGe4.js";import{t as w}from"./PreviewBlock-DJFn4Hia.js";var T=[{prop:`arrow`,description:`是否显示箭头，适合在卡片式信息和标签式提示之间切换语气。`,type:`boolean`,defaultValue:`true`},{prop:`classNames`,description:`语义化类名扩展，支持分别定制根节点和提示内容。`,type:`{ root?: string; body?: string }`,defaultValue:`-`},{prop:`color`,description:`支持 daisyUI 语义色，也支持自定义颜色字符串。`,type:`'neutral' | 'primary' | 'secondary' | 'accent' | 'info' | 'success' | 'warning' | 'error' | string`,defaultValue:`-`},{prop:`content / overlay / title / tip`,description:`提示内容入口，支持文本、JSX 节点、函数返回值，并兼容旧的 tip 写法。`,type:`any`,defaultValue:`-`},{prop:`defaultOpen`,description:`非受控初始显示状态。`,type:`boolean`,defaultValue:`false`},{prop:`disabled`,description:`禁用 Tooltip，仅保留包裹结构，不显示提示内容。`,type:`boolean`,defaultValue:`false`},{prop:`open`,description:`受控显示状态，适合与外部按钮、校验状态或页面步骤联动。`,type:`boolean`,defaultValue:`-`},{prop:`onOpenChange`,description:`显示状态变化回调。`,type:`(open: boolean) => void`,defaultValue:`-`},{prop:`overlayClassName / overlayStyle`,description:`提示内容层的类名和样式扩展。`,type:`string / Record<string, any>`,defaultValue:`-`},{prop:`placement`,description:`支持四个基础方向和常见浮层组件里的角落别名。`,type:`'top' | 'bottom' | 'left' | 'right' | 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight' | 'leftTop' | 'leftBottom' | 'rightTop' | 'rightBottom'`,defaultValue:`'top'`},{prop:`styles`,description:`语义化样式扩展，支持根节点与提示内容。`,type:`{ root?: Record<string, any>; body?: Record<string, any> }`,defaultValue:`-`},{prop:`trigger`,description:`触发方式，可单独或组合使用 hover、focus、click、contextMenu。`,type:`'hover' | 'focus' | 'click' | 'contextMenu' | Array<...>`,defaultValue:`['hover', 'focus']`}],E=()=>{let{controlledOpen:c}=v(`useSetup:0:0`,()=>m(()=>({controlledOpen:v(`ref:1:0`,()=>r(!0))})));return u(r=>{let m=i(`div`,r);g(m,`flex flex-wrap items-center gap-4`);let v=a(`rue:component:anchor`);n(m,v),h(_(S,{"data-testid":`tooltip-open`,title:`Always visible`,open:!0,color:`primary`,children:u(()=>{let t=s(),r=i(`button`,t);return n(t,r),g(r,`btn btn-primary`),n(r,e(`Force open`)),t})}),m,v);let y=a(`rue:component:anchor`);n(m,y);let b=u(()=>{let t=s(),r=i(`button`,t);return n(t,r),g(r,`btn btn-soft`),p(r,`click`,()=>c.value=!c.value),n(r,e(`Controlled tooltip`)),t});o(()=>{let e=_(S,{title:c.value?`点击任一按钮都可以关闭`:`点击任一按钮都可以打开`,open:c.value,children:b});t(()=>h(e,m,y))});let x=i(`button`,m);n(m,x),g(x,`btn btn-outline`),p(x,`click`,()=>c.value=!c.value);let C=l(x);n(x,C),o(()=>{f(C,c.value?`Hide controlled tooltip`:`Show controlled tooltip`)});let w=a(`rue:component:anchor`);return n(m,w),h(_(S,{title:`包一层 span 可兼容禁用按钮`,placement:`bottom`,children:u(()=>{let t=s(),r=i(`span`,t);n(t,r),g(r,`inline-flex`);let a=i(`button`,r);return n(r,a),g(a,`btn btn-disabled`),d(a,!0),n(a,e(`Disabled button`)),t})}),m,w),m})},D=()=>{let{tabBasic:l,tabPlacements:d,tabContent:f,tabColors:p,tabTriggers:D,tabOpen:O}=v(`useSetup:0:0:dup1`,()=>m(()=>({tabBasic:v(`ref:1:1`,()=>r(`preview`)),tabPlacements:v(`ref:1:2`,()=>r(`preview`)),tabContent:v(`ref:1:3`,()=>r(`preview`)),tabColors:v(`ref:1:4`,()=>r(`preview`)),tabTriggers:v(`ref:1:5`,()=>r(`preview`)),tabOpen:v(`ref:1:6`,()=>r(`preview`))})));return u(r=>{let m=s(),v=a(`rue:component:anchor`);return n(m,v),h(_(C,{children:u(()=>{let r=s(),m=i(`div`,r);n(r,m),g(m,`max-w-none prose prose-sm md:prose-base`);let v=i(`h1`,m);n(m,v),n(v,e(`Tooltip 提示框`));let C=i(`p`,m);n(m,C),g(C,`text-sm mt-3 mb-3`),n(C,e(`Tooltip 现在既保留 Rue 原本轻量、包裹式的视觉习惯，也补上更完整的语义 API。你可以继续使用`));let k=i(`code`,C);n(C,k),n(k,e(`tip`)),n(C,e(`和`));let A=i(`code`,C);n(C,A),n(A,e(`Tooltip.Content`)),n(C,e(`，也可以切到`));let j=i(`code`,C);n(C,j),n(j,e(`title`)),n(C,e(`、`));let M=i(`code`,C);n(C,M),n(M,e(`overlay`)),n(C,e(`、受控显示、 自定义颜色和语义化样式扩展。`));let N=a(`rue:component:anchor`);n(m,N),o(()=>{let e=_(w,{title:`Tooltip`,tab:l,preview:()=>b(`div`,{className:`flex flex-wrap gap-4`,children:[x(S,{"data-testid":`tooltip-basic`,title:`用于解释按钮含义`,children:x(`button`,{className:`btn`,children:`Hover me`})}),x(S,{title:()=>`函数内容也可以惰性返回`,children:x(`button`,{className:`btn btn-outline`,children:`Lazy title`})}),x(S,{disabled:!0,title:`不会显示`,children:x(`button`,{className:`btn btn-ghost`,children:`Disabled tooltip`})})]}),code:`<Tooltip title="用于解释按钮含义">
...
</Tooltip>`});t(()=>h(e,m,L))});let R=a(`rue:component:anchor`);n(m,R),o(()=>{let e=_(w,{title:`Force open`,tab:O,preview:E,code:`const controlledOpen = ref(true)
...
</div>`});t(()=>h(e,m,R))});let z=i(`div`,m);n(m,z),g(z,`not-prose mt-10 overflow-x-auto rounded-box border border-base-300 bg-base-100`);let B=i(`table`,z);n(z,B),g(B,`table table-zebra`);let V=i(`thead`,B);n(B,V);let H=i(`tr`,V);n(V,H);let U=i(`th`,H);n(H,U),n(U,e(`属性`));let W=i(`th`,H);n(H,W),n(W,e(`说明`));let G=i(`th`,H);n(H,G),n(G,e(`类型`));let K=i(`th`,H);n(H,K),n(K,e(`默认值`));let q=i(`tbody`,B);n(B,q);let J=a(`rue:list:start`),Y=a(`rue:list:end`);n(q,J),n(q,Y);let X=new Map;return o(()=>{X=y({items:T||[],getKey:(e,t)=>e.prop,elements:X,parent:q,before:Y,singleRoot:!0,trackIndex:!1,start:J,renderItem:(e,r,l,d,f)=>{h(u(()=>{let r=s(),l=i(`tr`,r);n(r,l),o(()=>{c(l,`key`,String(e.prop))});let u=i(`td`,l);n(l,u);let d=i(`code`,u);n(u,d);let f=a(`rue:slot:anchor`);n(d,f),o(()=>{let n=e.prop;t(()=>h(n,d,f))});let p=i(`td`,l);n(l,p);let m=a(`rue:slot:anchor`);n(p,m),o(()=>{let n=e.description;t(()=>h(n,p,m))});let g=i(`td`,l);n(l,g);let _=i(`code`,g);n(g,_);let v=a(`rue:slot:anchor`);n(_,v),o(()=>{let n=e.type;t(()=>h(n,_,v))});let y=i(`td`,l);n(l,y);let b=i(`code`,y);n(y,b);let x=a(`rue:slot:anchor`);return n(b,x),o(()=>{let n=e.defaultValue;t(()=>h(n,b,x))}),r}),r,l)}})}),r})}),m,v),m})};export{D as default};