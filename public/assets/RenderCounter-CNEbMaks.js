import{$t as e,Q as t,an as n,dt as r,et as i,in as a,l as o,nt as s,o as c,x as l,zt as u}from"./vapor-runtime-DsQWl-IB.js";import{a as d}from"./vapor-helpers-vapor-Dg64FcpK.js";import{t as f}from"./createHomeSplitExamplePage-DpsCt1Bb.js";var p=`rounded-lg border px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all`,m=n=>o(a=>{let o=s(`div`,a);r(o,`text-3xl font-bold mb-3`);let l=i(`rue:slot:anchor`);return t(o,l),u(()=>{let t=n.count.value;e(()=>c(t,o,l))}),o}),h=f({title:`渲染函数计数器`,source:`import { type FC, h, useSetup, useState, watchEffect } from '@rue-js/rue'
