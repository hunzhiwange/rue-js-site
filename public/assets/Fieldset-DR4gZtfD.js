...
</Fieldset>`});h(()=>d(e,f,I))});let L=e(`rue:component:anchor`);i(f,L),c(()=>{let e=m(D,{title:`尺寸与状态`,summary:`size 管信息密度，invalid 管容器错误态；原生 disabled 仍透传给 fieldset。`,tab:w,preview:()=>y(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[b(T,{legend:`Compact settings`,description:`适合侧栏或弹窗里的轻量配置。`,variant:`outlined`,size:`small`,className:`w-full`,items:[{label:`Branch`,control:b(E,{placeholder:`main`})},{label:`Region`,optional:!0,control:b(E,{placeholder:`Hangzhou`})}]}),b(T,{legend:`Verification`,description:`错误态会统一强调标题、底部提示和边框。`,invalid:!0,className:`w-full`,items:[{label:`Email`,invalid:!0,control:b(E,{type:`email`,placeholder:`team@rue.design`}),hint:`当前邮箱尚未完成验证，请先检查收件箱。`},{label:`Backup email`,optional:!0,control:b(E,{disabled:!0,placeholder:`disabled by parent fieldset`})}],disabled:!0,hint:`只读模式下仍可展示当前表单结构与校验上下文。`})]}),code:`<Fieldset
...
</Fieldset>`});h(()=>d(e,f,pe))});let H=r(`h2`,f);i(f,H),s(H,`id`,`fieldset-api`),i(H,o(`API`));let me=r(`p`,f);i(f,me),i(me,o(`当前页面展示的是增强后的完整可用 API，同时保留原有 children 组合写法。`));let he=r(`h3`,f);i(f,he),i(he,o(`Fieldset`));let ge=e(`rue:component:anchor`);i(f,ge),c(()=>{let e=m(O,{rows:ee});h(()=>d(e,f,ge))});let _e=r(`h3`,f);i(f,_e),i(_e,o(`Fieldset.Item`));let ve=e(`rue:component:anchor`);i(f,ve),c(()=>{let e=m(O,{rows:te});h(()=>d(e,f,ve))});let ye=r(`h3`,f);i(f,ye),i(ye,o(`复合子组件`));let be=e(`rue:component:anchor`);i(f,be),c(()=>{let e=m(O,{rows:ne});h(()=>d(e,f,be))});let U=r(`div`,f);i(f,U),n(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=r(`h3`,U);i(U,W),n(W,`mt-0 mb-3 text-base font-semibold`),i(W,o(`推荐用法总结`));let G=r(`div`,U);i(U,G),n(G,`grid gap-2 text-sm md:grid-cols-2`);let K=r(`div`,G);i(G,K);let xe=r(`code`,K);i(K,xe),i(xe,o(`legend + items`)),i(K,o(`适合直接搭一整块表单`));let q=r(`div`,G);i(G,q);let Se=r(`code`,q);i(q,Se),i(Se,o(`Fieldset.Item`)),i(q,o(`适合沉淀复用字段行`));let J=r(`div`,G);i(G,J);let Ce=r(`code`,J);i(J,Ce),i(Ce,o(`children + Legend/Label`)),i(J,o(`继续兼容原有写法`));let Y=r(`div`,G);i(G,Y);let we=r(`code`,Y);i(Y,we),i(we,o(`variant / tone / invalid`)),i(Y,o(`用来表达区块层级和状态`));let Te=r(`h2`,f);i(f,Te),i(Te,o(`FAQ`));let Ee=r(`h3`,f);i(f,Ee),i(Ee,o(`结构化 props 和 children 可以同时用吗？`));let X=r(`p`,f);i(f,X),i(X,o(`当前实现里，`));let De=r(`code`,X);i(X,De),i(De,o(`children`)),i(X,o(`仍然是最高优先级。想走推荐写法时使用`));let Oe=r(`code`,X);i(X,Oe),i(Oe,o(`legend`)),i(X,o(`、`));let ke=r(`code`,X);i(X,ke),i(ke,o(`description`)),i(X,o(`、`));let Ae=r(`code`,X);i(X,Ae),i(Ae,o(`items`)),i(X,o(`；想自由拼装时继续直接写`));let je=g(X);i(X,je),a(je,` `);let Me=r(`code`,X);i(X,Me),i(Me,o(`children`)),i(X,o(`。`));let Z=r(`h3`,f);i(f,Z),i(Z,o(`什么时候该用 items，什么时候该用 Fieldset.Item？`));let Q=r(`p`,f);i(f,Q),i(Q,o(`简单表单优先用`));let Ne=r(`code`,Q);i(Q,Ne),i(Ne,o(`items`)),i(Q,o(`，这样信息更集中；字段布局开始变复杂、需要横向排版或局部复用时， 更适合切到`));let Pe=g(Q);i(Q,Pe),a(Pe,` `);let Fe=r(`code`,Q);i(Q,Fe),i(Fe,o(`Fieldset.Item`)),i(Q,o(`。`));let Ie=r(`h3`,f);i(f,Ie),i(Ie,o(`variant 和手写 className 会冲突吗？`));let $=r(`p`,f);i(f,$),i($,o(`不会。`));let Le=r(`code`,$);i($,Le),i(Le,o(`variant`)),i($,o(`只是给出一套推荐容器样式，仍然可以继续叠加现有的`));let Re=r(`code`,$);i($,Re),i(Re,o(`rounded-box`)),i($,o(`、`));let ze=r(`code`,$);i($,ze),i(ze,o(`border`)),i($,o(`、`));let Be=r(`code`,$);return i($,Be),i(Be,o(`bg-*`)),i($,o(`等类名做局部覆盖。`)),l})}),p,_),p})};export{re as default};