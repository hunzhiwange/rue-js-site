...
</Pagination>`});a(()=>m(e,n,ne))});let re=c(`rue:component:anchor`);o(n,re),s(()=>{let e=h(I,{title:`Vertical pagination`,summary:"继续沿用 `direction='vertical'`，适合侧栏步骤、目录或分段导航。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(F,{direction:`vertical`,className:`w-fit`,"data-testid":`pagination-vertical`,children:[b(F.Item,{children:`Overview`}),b(F.Item,{children:`Updates`}),b(F.Item,{children:`Logs`})]})})}),code:`<Pagination direction="vertical" className="w-fit">
  <Pagination.Item>Overview</Pagination.Item>
  <Pagination.Item>Updates</Pagination.Item>
  <Pagination.Item>Logs</Pagination.Item>
</Pagination>`});a(()=>m(e,n,re))});let ie=c(`rue:component:anchor`);o(n,ie),s(()=>{let e=h(I,{title:`Current and disabled items`,summary:"静态模式下仍可通过 `active`、`disabled` 和 `tag='a'` 控制语义与状态。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(F,{className:`w-fit`,"data-testid":`pagination-stateful`,children:[b(F.Item,{disabled:!0,children:`Prev`}),b(F.Item,{children:`1`}),b(F.Item,{active:!0,children:`2`}),b(F.Item,{children:`3`}),b(F.Item,{tag:`a`,href:`#next`,children:`Next`})]})})}),code:`<Pagination className="w-fit">
  <Pagination.Item disabled>Prev</Pagination.Item>
  <Pagination.Item>1</Pagination.Item>
  <Pagination.Item active>2</Pagination.Item>
  <Pagination.Item>3</Pagination.Item>
  <Pagination.Item tag="a" href="#next">Next</Pagination.Item>
</Pagination>`});a(()=>m(e,n,ie))});let R=c(`rue:component:anchor`);o(n,R),s(()=>{let e=h(I,{title:`Data driven basic`,summary:"传入 `total` 后由组件自动计算页码；这里改成受控版本，便于在设计页直接切换和观察当前页变化。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body gap-4`,children:[b(F,{current:x.value,total:120,showTotal:(e,t)=>`${t[0]}-${t[1]} / ${e}`,onChange:e=>{x.value=e}}),b(F,{current:S.value,total:500,size:`sm`,align:`center`,onChange:e=>{S.value=e}}),y(`div`,{className:`text-sm opacity-70`,children:[`当前示例页码：默认尺寸第 `,x.value,` 页，小尺寸第`,` `,S.value,` 页`]})]})}),code:`const primaryPage = ref(2)
...
<Pagination total={8} defaultCurrent={1} hideOnSinglePage />`});a(()=>m(e,n,H))});let U=e(`h2`,n);o(n,U),p(U,`id`,`pagination-api`),o(U,u(`API`));let oe=c(`rue:component:anchor`);o(n,oe),s(()=>{let e=h(L,{rows:ae});a(()=>m(e,n,oe))});let W=e(`h2`,n);o(n,W),o(W,u(`FAQ`));let G=e(`div`,n);o(n,G),l(G,`space-y-4 text-sm leading-6`);let K=e(`div`,G);o(G,K);let q=e(`h3`,K);o(K,q),l(q,`mb-1 text-base font-semibold`),o(q,u(`什么时候用静态组合，什么时候用数据驱动？`));let J=e(`p`,K);o(K,J),l(J,`m-0 opacity-80`),o(J,u("当按钮结构、文案和链接完全由业务自定义时，用 `Pagination.Item` 静态组合更直接；只要你已经有 `total`、`current`、`pageSize` 这些分页信息，优先使用数据驱动模式，省去页码计算与边界处理。"));let Y=e(`div`,G);o(G,Y);let X=e(`h3`,Y);o(Y,X),l(X,`mb-1 text-base font-semibold`),o(X,u("`simple` 适合什么场景？"));let Z=e(`p`,Y);o(Y,Z),l(Z,`m-0 opacity-80`),o(Z,u("`simple` 适合工具栏、卡片头部、移动端等横向空间有限的区域；如果只想展示当前页而不允许直接输入， 可以传 `simple="));let se=g(Z);o(Z,se),s(()=>{f(se,{readOnly:!0})}),o(Z,u("`。"));let Q=e(`div`,G);o(G,Q);let ce=e(`h3`,Q);o(Q,ce),l(ce,`mb-1 text-base font-semibold`),o(ce,u(`切换每页条数时会触发哪些回调？`));let le=e(`p`,Q);o(Q,le),l(le,`m-0 opacity-80`),o(le,u("`onShowSizeChange` 专门用于处理页容量变更；为了保持外部状态同步，`onChange` 也会收到新的页码和 `pageSize`，所以受控场景通常同时兼容这两个回调。"));let $=e(`div`,G);o(G,$);let ue=e(`h3`,$);o($,ue),l(ue,`mb-1 text-base font-semibold`),o(ue,u(`如何把上一页、下一页改成业务文案？`));let de=e(`p`,$);return o($,de),l(de,`m-0 opacity-80`),o(de,u("轻量替换可以用 `itemRender` 改写 `prev`、`next`、`jump-prev`、`jump-next` 的内容；如果还要替换 aria/title 文案，可以继续传 `locale`。")),t})}),n,r),n})};export{R as default};