...
/>`});p(()=>c(e,o,L))});let R=m(`rue:component:anchor`);e(o,R),t(()=>{let e=f(J,{title:`Accordion`,summary:`使用 accordion 改成一次只展开一项，并结合受控 key 管理当前面板。`,tab:i,preview:()=>b(`div`,{className:`space-y-4`,children:[b(`div`,{className:`flex flex-wrap gap-2`,children:[y(`button`,{className:`btn btn-sm`,onClick:()=>F.value=`guide`,children:`打开 Guide`}),y(`button`,{className:`btn btn-sm`,onClick:()=>F.value=`api`,children:`打开 API`}),y(`button`,{className:`btn btn-sm btn-ghost`,onClick:()=>F.value=null,children:`全部收起`})]}),y(q,{accordion:!0,plus:!0,activeKey:F.value,onChange:e=>F.value=e??null,items:[{key:`guide`,label:`Migration Guide`,children:`梳理 breaking changes、默认行为差异与升级建议。`},{key:`api`,label:`API Delta`,children:`列出属性变化与使用策略。`},{key:`qa`,label:`QA Notes`,children:`补充测试范围、回归清单和已知限制。`}]})]}),code:`const activeKey = ref<string | null>('guide')
...
/>`});p(()=>c(e,o,R))});let z=m(`rue:component:anchor`);e(o,z),t(()=>{let e=f(J,{title:`描述与额外操作`,summary:`每一项可带 description、extra 和独立禁用状态，extra 区域点击不会触发展开。`,tab:h,preview:()=>y(q,{arrow:!0,defaultActiveKey:[`ops`],items:[{key:`ops`,label:`Ops Console`,description:`控制发布节奏、灰度范围与告警阈值。`,extra:y(`span`,{className:`badge badge-soft badge-info`,children:`Beta`}),children:`适合放置运维策略、SLA 约束和异常回滚说明。`},{key:`billing`,label:`Billing Center`,description:`当前模块仍在整理，暂不开放编辑。`,extra:y(`span`,{className:`badge badge-soft`,children:`Read only`}),disabled:!0,children:`禁用项会保持信息展示，但不响应交互。`}]}),code:`<Collapse
  arrow
...
/>`});p(()=>c(e,o,z))});let B=m(`rue:component:anchor`);e(o,B),t(()=>{let e=f(J,{title:`图标位置与触发区域`,summary:`支持把图标放在左侧，并限制只有图标本身可触发开合。`,tab:g,preview:()=>y(q,{arrow:!0,expandIconPlacement:`start`,items:[{key:`deployment`,label:`Deployment Window`,description:`只有左侧图标可点击，标题区更适合放长文本说明。`,collapsible:`icon`,children:`当标题里还有链接、状态或操作说明时，这个模式会更稳妥。`},{key:`security`,label:`Security Review`,description:`保持默认 header 触发，图标只是视觉反馈。`,children:`适合和 icon-only 模式混合使用。`}]}),code:`<Collapse
  arrow
...
/>`});p(()=>c(e,o,B))});let V=m(`rue:component:anchor`);e(o,V),t(()=>{let e=f(J,{title:`Ghost 与无边框`,summary:`不想用分组边框时，可以关闭 bordered，再按需开启 ghost。`,tab:v,preview:()=>y(q,{arrow:!0,bordered:!1,ghost:!0,className:`space-y-3`,defaultActiveKey:[`design`],items:[{key:`design`,label:`Design Tokens`,children:`透明背景更适合嵌在卡片、侧栏或深色容器中。`},{key:`theme`,label:`Theme Sync`,children:`可继续叠加自定义类名，让容器完全交给外层布局控制。`}]}),code:`<Collapse
  arrow
  bordered={false}
  ghost
  className="space-y-3"
...
/>`});p(()=>c(e,o,V))});let H=m(`rue:component:anchor`);e(o,H),t(()=>{let e=f(J,{title:`尺寸与受控多开`,summary:`size 会统一影响标题和内容尺寸；非 accordion 模式可同时展开多项。`,tab:x,preview:()=>b(`div`,{className:`space-y-4`,children:[b(`div`,{className:`flex flex-wrap gap-2`,children:[y(`button`,{className:`btn btn-sm`,onClick:()=>P.value=[`release`],children:`仅展开 Release`}),y(`button`,{className:`btn btn-sm`,onClick:()=>P.value=[`release`,`notes`],children:`展开两项`}),y(`button`,{className:`btn btn-sm btn-ghost`,onClick:()=>P.value=[],children:`全部收起`})]}),y(q,{plus:!0,size:`lg`,activeKey:P.value,onChange:e=>P.value=e??[],items:[{key:`release`,label:`Release Plan`,children:`大尺寸适合在信息层级较重的管理页或文档页中使用。`},{key:`notes`,label:`Release Notes`,children:`多开模式下可以把相邻的几块信息一起展开对照查看。`},{key:`rollback`,label:`Rollback`,children:`受控模式更方便和 URL、筛选器或外部按钮联动。`}]})]}),code:`const openKeys = ref<string[]>(['release'])
...
/>`});p(()=>c(e,o,H))});let U=m(`rue:component:anchor`);e(o,U),t(()=>{let e=f(J,{title:`Collapse with focus`,summary:`聚焦时展开、失焦时关闭，同时也支持重复点击标题切换开合。`,tab:S,preview:()=>b(q,{tabIndex:0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} className="bg-base-100 border border-base-300">
...
</Collapse>`});p(()=>c(e,o,G))});let K=m(`rue:component:anchor`);e(o,K),t(()=>{let e=f(J,{title:`Without border and background color`,tab:E,preview:()=>b(q,{tabIndex:0,children:[y(q.Title,{className:`font-semibold`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0}>
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>c(e,o,K))});let X=m(`rue:component:anchor`);e(o,X),t(()=>{let e=f(J,{title:`With arrow icon`,tab:D,preview:()=>b(q,{tabIndex:0,arrow:!0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} arrow className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>c(e,o,X))});let Z=m(`rue:component:anchor`);e(o,Z),t(()=>{let e=f(J,{title:`With plus/minus icon`,tab:O,preview:()=>b(q,{tabIndex:0,plus:!0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} plus className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">How do I create an account?</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>c(e,o,Z))});let Q=m(`rue:component:anchor`);e(o,Q),t(()=>{let e=f(J,{title:`Moving collapse icon to the start`,summary:`通过 utility 类移动图标位置，并保持标题区重复点击切换能力。`,tab:k,preview:()=>b(q,{tabIndex:0,arrow:!0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold after:start-5 after:end-auto pe-4 ps-12`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} arrow className="bg-base-100 border border-base-300">
...
</Collapse>`});p(()=>c(e,o,Q))});let $=m(`rue:component:anchor`);e(o,$),t(()=>{let e=f(J,{title:`Force open`,tab:A,preview:()=>b(q,{tabIndex:0,open:!0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold`,children:`I have collapse-open class`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} open className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">I have collapse-open class</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>c(e,o,$))});let ne=m(`rue:component:anchor`);e(o,ne),t(()=>{let e=f(J,{title:`Force close`,tab:j,preview:()=>b(q,{tabIndex:0,close:!0,className:`bg-base-100 border border-base-300`,children:[y(q.Title,{className:`font-semibold`,children:`I have collapse-close class`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse tabIndex={0} close className="bg-base-100 border border-base-300">
  <Collapse.Title className="font-semibold">I have collapse-close class</Collapse.Title>
  <Collapse.Content className="text-sm">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Collapse.Content>
</Collapse>`});p(()=>c(e,o,ne))});let re=m(`rue:component:anchor`);e(o,re),t(()=>{let e=f(J,{title:`Custom colors for collapse that works with focus`,summary:`通过 focus 触发颜色变化。`,tab:M,preview:()=>b(q,{tabIndex:0,className:`bg-primary text-primary-content focus:bg-secondary focus:text-secondary-content`,children:[y(q.Title,{className:`font-semibold`,children:`How do I create an account?`}),y(q.Content,{className:`text-sm`,children:`Click the "Sign Up" button in the top right corner and follow the registration process.`})]}),code:`<Collapse
  tabIndex={0}
