...
</Dropdown>`});i(()=>p(e,n,le))});let ue=s(`rue:component:anchor`);a(n,ue),o(()=>{let e=m(S,{title:`受控开关与来源`,tab:_.controlled,preview:y(w,{}),code:`const open = ref(false);
...
</Dropdown>`});i(()=>p(e,n,de))});let fe=s(`rue:component:anchor`);a(n,fe),o(()=>{let e=m(S,{title:`自定义面板包装`,tab:_.custom,preview:()=>y(`div`,{className:`not-prose flex min-h-64 items-start rounded-box border border-base-300 bg-base-100/70 p-6`,children:y(b,{trigger:`click`,placement:`bottomRight`,arrow:!0,overlay:v(`div`,{className:`p-4`,children:[y(`div`,{className:`text-sm font-medium`,children:`Editor shortcuts`}),y(`div`,{className:`mt-2 text-sm text-base-content/70`,children:`Publish, share and manage visibility in one place.`})]}),popupRender:e=>v(`div`,{className:`w-72`,children:[y(`div`,{className:`border-b border-base-300 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-primary`,children:`Quick panel`}),e,v(`div`,{className:`flex items-center justify-end gap-2 border-t border-base-300 px-4 py-3`,children:[y(`button`,{className:`btn btn-ghost btn-sm`,children:`Later`}),y(`button`,{className:`btn btn-primary btn-sm`,children:`Publish`})]})]}),children:y(`button`,{className:`btn btn-secondary`,children:`Quick Panel`})})}),code:`<Dropdown
  trigger="click"
...
<Dropdown direction="left" align="end">
  ...
  <Dropdown.Content as="ul" tabIndex={-1} className="menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm">...</Dropdown.Content>
</Dropdown>`});i(()=>p(e,n,ve))});let ye=s(`rue:component:anchor`);a(n,ye),o(()=>{let e=m(S,{title:`Dropdown hover and force open`,tab:_.modifiers,preview:()=>v(b,{hover:!0,forceOpen:!0,children:[y(`div`,{tabIndex:0,role:`button`,className:`btn m-1`,children:`Always visible`}),v(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[y(`li`,{children:y(`button`,{children:`Item 1`})}),y(`li`,{children:y(`button`,{children:`Item 2`})})]})]}),code:`<Dropdown hover forceOpen>
  <div tabIndex={0} role="button" className="btn m-1">Always visible</div>
  <Dropdown.Content as="ul" tabIndex={-1} className="menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm">
    <li><button>Item 1</button></li>
    <li><button>Item 2</button></li>
  </Dropdown.Content>
</Dropdown>`});i(()=>p(e,n,ye))}),a(n,e(`br`,n));let be=e(`h2`,n);a(n,be),f(be,`id`,`dropdown-api`),a(be,l(`API`));let xe=s(`rue:component:anchor`);a(n,xe),o(()=>{let e=m(C,{rows:T});i(()=>p(e,n,xe))});let Se=e(`h3`,n);a(n,Se),c(Se,`mt-8`),a(Se,l(`menu 扩展`));let Ce=s(`rue:component:anchor`);a(n,Ce),o(()=>{let e=m(C,{rows:E});i(()=>p(e,n,Ce))});let we=e(`h2`,n);a(n,we),a(we,l(`FAQ`));let Y=e(`ul`,n);a(n,Y);let X=e(`li`,Y);a(Y,X),a(X,l(`想做业务菜单、用户菜单、右键菜单时，优先用`));let Te=e(`code`,X);a(X,Te),a(Te,l(`menu`)),a(X,l(`或`));let Ee=e(`code`,X);a(X,Ee),a(Ee,l(`items`)),a(X,l(`。`));let Z=e(`li`,Y);a(Y,Z),a(Z,l(`想保留完全原生的 HTML 结构时，继续使用`));let De=e(`code`,Z);a(Z,De),a(De,l(`Dropdown.Trigger`)),a(Z,l(`+`));let Oe=h(Z);a(Z,Oe),d(Oe,` `);let ke=e(`code`,Z);a(Z,ke),a(ke,l(`Dropdown.Content`)),a(Z,l(`，或直接写 details / summary。`));let Q=e(`li`,Y);a(Y,Q),a(Q,l(`需要筛选面板、多选菜单时，通常把`));let Ae=e(`code`,Q);a(Q,Ae),a(Ae,l(`closeOnClick`)),a(Q,l(`设为`));let je=e(`code`,Q);a(Q,je),a(je,l(`false`)),a(Q,l(`，并配合`));let Me=e(`code`,Q);a(Q,Me),a(Me,l(`menu.selectable`)),a(Q,l(`。`));let $=e(`li`,Y);a(Y,$),a($,l(`需要在面板里追加说明、底部操作区或二次确认按钮时，使用`));let Ne=e(`code`,$);a($,Ne),a(Ne,l(`popupRender`));let Pe=h($);return a($,Pe),d(Pe,` `),a($,l(`包住原始内容。`)),t})}),n,g),n})};export{D as default};