...
export default LazySplitterDemo`,Z=e=>d(a=>{let s=i(`div`,a);r(s,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let l=i(`table`,s);o(s,l),r(l,`table table-zebra`);let p=i(`thead`,l);o(l,p);let h=i(`tr`,p);o(p,h);let g=i(`th`,h);o(h,g),o(g,c(`属性`));let _=i(`th`,h);o(h,_),o(_,c(`说明`));let v=i(`th`,h);o(h,v),o(v,c(`类型`));let b=i(`th`,h);o(h,b),o(b,c(`默认值`));let x=i(`tbody`,l);o(l,x);let S=t(`rue:list:start`),w=t(`rue:list:end`);o(x,S),o(x,w);let T=new Map;return y(()=>{T=C({items:e.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:x,before:w,singleRoot:!0,trackIndex:!1,start:S,renderItem:(e,r,a,s,c)=>{m(d(()=>{let r=n(),a=i(`tr`,r);o(r,a),y(()=>{u(a,`key`,String(e.prop))});let s=i(`td`,a);o(a,s);let c=i(`code`,s);o(s,c);let l=t(`rue:slot:anchor`);o(c,l),y(()=>{let t=e.prop;f(()=>m(t,c,l))});let d=i(`td`,a);o(a,d);let p=t(`rue:slot:anchor`);o(d,p),y(()=>{let t=e.description;f(()=>m(t,d,p))});let h=i(`td`,a);o(a,h);let g=i(`code`,h);o(h,g);let _=t(`rue:slot:anchor`);o(g,_),y(()=>{let t=e.type;f(()=>m(t,g,_))});let v=i(`td`,a);o(a,v);let b=i(`code`,v);o(v,b);let x=t(`rue:slot:anchor`);return o(b,x),y(()=>{let t=e.defaultValue;f(()=>m(t,b,x))}),r}),r,a)}})}),s}),Q=e=>v(`div`,{className:`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)] ${e.className??``}`.trim()},v(`div`,{className:`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`},e.title),v(`div`,{className:`mb-4 text-sm leading-6 text-base-content/70`},e.subtitle),v(`div`,{className:`min-h-0`},...G(e.children))),pe=()=>{let{controlledSizes:e,controlledResizable:l,controlledStatus:h}=S(`useSetup:0:0`,()=>p(()=>({controlledSizes:S(`ref:1:0`,()=>g([`38%`,`62%`])),controlledResizable:S(`ref:1:1`,()=>g(!0)),controlledStatus:S(`ref:1:2`,()=>g(`等待拖拽`))})));return d(p=>{let g=i(`div`,p);r(g,`space-y-4`);let v=i(`div`,g);o(g,v),r(v,`flex flex-wrap gap-2`);let b=i(`button`,v);o(v,b),u(b,`type`,`button`),r(b,`btn btn-sm`),a(b,`click`,()=>{e.value=[`30%`,`70%`],h.value=`已切到 30 / 70 预设`}),o(b,c(`30 / 70`));let S=i(`button`,v);o(v,S),u(S,`type`,`button`),r(S,`btn btn-sm btn-outline`),a(S,`click`,()=>{e.value=[`50%`,`50%`],h.value=`已重置为 50 / 50`}),o(S,c(`平分`));let C=i(`button`,v);o(v,C),u(C,`type`,`button`),y(()=>{r(C,String(`btn btn-sm btn-ghost ${l.value?``:`btn-active`}`.trim()))}),a(C,`click`,()=>{l.value=!l.value,h.value=l.value?`已恢复左栏拖拽`:`已锁定左栏拖拽`});let w=x(C);o(C,w),y(()=>{s(w,l.value?`锁定左栏`:`恢复拖拽`)});let T=t(`rue:component:anchor`);o(g,T);let E=d(()=>{let a=n(),u=t(`rue:component:anchor`);o(a,u);let p=d(()=>{let e=n(),t=i(`div`,e);o(e,t),r(t,`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)]`);let a=i(`div`,t);o(t,a),r(a,`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`),o(a,c(`Filters`));let l=i(`div`,t);o(t,l),r(l,`mb-4 text-sm leading-6 text-base-content/70`),o(l,c(`受控模式下，这一栏可以被外部按钮锁定或重置。`));let u=i(`div`,t);o(t,u),r(u,`text-xs text-base-content/60`);let d=x(u);return o(u,d),y(()=>{s(d,h.value)}),e});y(()=>{let t=_(U.Panel,{size:e.value[0],resizable:l.value,children:p});f(()=>m(t,a,u))});let g=t(`rue:component:anchor`);o(a,g);let v=d(()=>{let t=n(),a=i(`div`,t);o(t,a),r(a,`h-full rounded-box border border-base-300/75 bg-base-100/95 p-4 shadow-[0_20px_50px_-40px_rgba(15,23,42,0.55)]`);let l=i(`div`,a);o(a,l),r(l,`mb-3 text-[11px] uppercase tracking-[0.24em] text-base-content/45`),o(l,c(`Results`));let u=i(`div`,a);o(a,u),r(u,`mb-4 text-sm leading-6 text-base-content/70`),o(u,c(`右栏跟随 onResize 返回值同步，适合持久化工作台布局。`));let d=i(`div`,a);o(a,d),r(d,`text-sm text-base-content/70`),o(d,c(`受控尺寸：`));let f=x(d);return o(d,f),y(()=>{s(f,e.value.join(` / `))}),t});return y(()=>{let t=_(U.Panel,{size:e.value[1],children:v});f(()=>m(t,a,g))}),a});return y(()=>{let t=_(U,{style:{height:300},onResize:t=>{e.value=t,h.value=`当前尺寸：${t.join(` / `)}`},children:E});f(()=>m(t,g,T))}),g})},me=()=>{let{triptychSizes:e,triptychStatus:a}=S(`useSetup:0:0:dup1`,()=>p(()=>({triptychSizes:S(`ref:1:3`,()=>g(W.slice())),triptychStatus:S(`ref:1:4`,()=>g(`双击任意分隔柄可重置`))})));return d(c=>{let l=i(`div`,c);r(l,`space-y-4`);let u=i(`div`,l);o(l,u),r(u,`text-sm text-base-content/65`);let p=x(u);o(u,p),y(()=>{s(p,a.value)});let h=t(`rue:component:anchor`);o(l,h);let g=d(()=>{let r=n(),i=t(`rue:component:anchor`);o(r,i);let a=_(Q,{title:`Sources`,subtitle:`左侧资源树或文档大纲。`});y(()=>{let t=_(U.Panel,{size:e.value[0],min:120,children:a});f(()=>m(t,r,i))});let s=t(`rue:component:anchor`);o(r,s);let c=_(Q,{title:`Editor`,subtitle:`中间主编辑区通常需要最大的宽度。`});y(()=>{let t=_(U.Panel,{size:e.value[1],min:180,children:c});f(()=>m(t,r,s))});let l=t(`rue:component:anchor`);o(r,l);let u=_(Q,{title:`Preview`,subtitle:`右侧实时预览或审阅信息。`});return y(()=>{let t=_(U.Panel,{size:e.value[2],min:120,children:u});f(()=>m(t,r,l))}),r});return y(()=>{let t=_(U,{style:{height:260},onResize:t=>{e.value=t,a.value=`当前布局：${t.join(` / `)}`},onDraggerDoubleClick:()=>{e.value=W.slice(),a.value=`已恢复 Sources / Editor / Preview 默认布局`},children:g});f(()=>m(t,l,h))}),l})},$=()=>{let{lazyStatus:e}=S(`useSetup:0:0:dup2`,()=>p(()=>({lazyStatus:S(`ref:1:5`,()=>g(`拖拽时只移动 handle，释放后才提交尺寸`))})));return d(a=>{let l=i(`div`,a);r(l,`space-y-4`);let u=i(`div`,l);o(l,u),r(u,`text-sm text-base-content/65`);let p=x(u);o(u,p),y(()=>{s(p,e.value)});let h=t(`rue:component:anchor`);o(l,h);let g=d(()=>{let e=n(),a=t(`rue:component:anchor`);o(e,a);let s=_(Q,{title:`Analysis`,subtitle:`左侧适合放图表、规则或输入参数。`,children:d(()=>{let e=n(),t=i(`div`,e);return o(e,t),r(t,`rounded-box bg-primary/10 p-4 text-sm text-base-content/70`),o(t,c(`Strategy setup`)),e})});m(_(U.Panel,{defaultSize:`44%`,min:`30%`,children:s}),e,a);let l=t(`rue:component:anchor`);o(e,l);let u=_(Q,{title:`Output`,subtitle:`右侧接收结果、日志或建议列表。`,children:d(()=>{let e=n(),t=i(`div`,e);o(e,t),r(t,`space-y-2 text-sm text-base-content/70`);let a=i(`div`,t);o(t,a),r(a,`rounded-box bg-base-200/70 px-3 py-2`),o(a,c(`Insight A`));let s=i(`div`,t);o(t,s),r(s,`rounded-box bg-base-200/70 px-3 py-2`),o(s,c(`Insight B`));let l=i(`div`,t);return o(t,l),r(l,`rounded-box bg-base-200/70 px-3 py-2`),o(l,c(`Insight C`)),e})});return m(_(U.Panel,{children:u}),e,l),e});return y(()=>{let t=_(U,{lazy:!0,style:{height:280},onResizeStart:()=>{e.value=`开始拖拽，当前只移动 handle 预览位移`},onResize:t=>{e.value=`释放后已提交尺寸：${t.join(` / `)}`},children:g});f(()=>m(t,l,h))}),l})},he=()=>{let{tabs:e}=S(`useSetup:0:0:dup3`,()=>p(()=>({tabs:{basic:S(`ref:1:6`,()=>g(`preview`)),controlled:S(`ref:1:7`,()=>g(`preview`)),vertical:S(`ref:1:8`,()=>g(`preview`)),collapsible:S(`ref:1:9`,()=>g(`preview`)),reset:S(`ref:1:10`,()=>g(`preview`)),lazy:S(`ref:1:11`,()=>g(`preview`))}})));return d(a=>{let l=n(),p=t(`rue:component:anchor`);return o(l,p),m(_(E,{children:d(()=>{let a=n(),l=i(`div`,a);o(a,l),r(l,`max-w-none prose prose-sm md:prose-base`);let d=i(`h1`,l);o(l,d),o(d,c(`Splitter 分割面板`));let p=i(`p`,l);o(l,p),r(p,`text-sm mt-3 mb-3`),o(p,c(`Splitter 在 Rue 里不是一条简单的分隔线，而是一套适合工作台、配置台和双栏内容区的布局行为层。 它保留 Rue Design 当前的柔和卡片气质和细颗粒 handle 视觉，同时补上可拖拽、受控尺寸、垂直布局、 折叠、lazy 拖拽和双击重置这些更接近成熟组件库的核心能力。`));let h=i(`h2`,l);o(l,h),o(h,c(`何时使用`));let g=i(`ul`,l);o(l,g);let v=i(`li`,g);o(g,v),o(v,c(`需要左右或上下两个工作区同时存在，并允许用户按内容密度自己调节比例。`));let b=i(`li`,g);o(g,b),o(b,c(`需要把筛选区、编辑区、预览区、日志区这类不同角色的面板拆开，但仍保持同一个页面上下文。`));let S=i(`li`,g);o(g,S),o(S,c(`需要在布局层提供折叠、受控重置和 lazy 拖拽，而不是只做静态栅格分栏。`));let C=i(`h2`,l);o(l,C),o(C,c(`推荐用法`));let E=i(`p`,l);o(l,E),r(E,`text-sm mt-3 mb-4`),o(E,c(`下面每个 JSX 示例都保留了完整结构，方便直接复制到页面组件里使用。`));let O=t(`rue:component:anchor`);o(l,O),y(()=>{let t=_(D,{title:`Basic workspace split`,summary:`最基础的双栏写法，默认比例、最小值和最大值都在 Panel 上声明。`,tab:e.basic,preview:()=>w(U,{style:{height:280},children:[T(U.Panel,{defaultSize:`40%`,min:`24%`,max:`70%`,children:T(Q,{title:`Navigation`,subtitle:`把目录、资源树或查询条件放在左侧。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Overview`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Metrics`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Deployments`})]})})}),T(U.Panel,{children:T(Q,{title:`Editor`,subtitle:`右侧保留完整内容区，适合表单、文档或分析结果。`,children:T(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-200/50 p-4 text-sm leading-7 text-base-content/70`,children:`这里是主工作区。拖动中间的 handle，可以把左右空间分配给导航和正文。`})})})]}),code:K});f(()=>m(t,l,O))});let k=t(`rue:component:anchor`);o(l,k),y(()=>{let t=_(D,{title:`Controlled sizes and reset`,summary:`受控模式适合和按钮、预设布局、权限开关联动。`,tab:e.controlled,preview:pe,code:q});f(()=>m(t,l,k))});let A=t(`rue:component:anchor`);o(l,A),y(()=>{let t=_(D,{title:`Vertical split`,summary:`上下分栏适合 dashboard 顶部概览 + 底部明细、编辑区 + 日志区这类结构。`,tab:e.vertical,preview:()=>w(U,{orientation:`vertical`,style:{height:520},children:[T(U.Panel,{defaultSize:`32%`,min:`10%`,children:T(Q,{title:`Summary`,subtitle:`顶部保留关键指标和状态总览。`,children:w(`div`,{className:`grid gap-3 sm:grid-cols-3`,children:[T(`div`,{className:`rounded-box bg-success/12 p-3 text-sm`,children:`Success 18`}),T(`div`,{className:`rounded-box bg-warning/12 p-3 text-sm`,children:`Queued 4`}),T(`div`,{className:`rounded-box bg-info/12 p-3 text-sm`,children:`Running 2`})]})})}),T(U.Panel,{children:T(Q,{title:`Details`,subtitle:`底部用来承接更长的列表、表格或日志。`,children:T(`div`,{className:`rounded-box bg-base-200/60 p-4 text-sm leading-7 text-base-content/70`,children:`这里可以放明细列表、数据表格、执行日志，或者任何比顶部更“长”的内容。`})})})]}),code:J});f(()=>m(t,l,A))});let j=t(`rue:component:anchor`);o(l,j),y(()=>{let t=_(D,{title:`Collapsible panels and custom handle`,summary:`折叠按钮和自定义 draggerIcon 适合三栏工作区，让辅助区可以快速收起。`,tab:e.collapsible,preview:()=>w(U,{style:{height:320},draggerIcon:T(`span`,{className:`inline-flex h-4 w-4 items-center justify-center text-[10px] font-black leading-none text-base-content/70`,children:`|||`}),collapsibleIcon:{start:T(`span`,{className:`text-xs`,children:`+`}),end:T(`span`,{className:`text-xs`,children:`-`})},children:[T(U.Panel,{defaultSize:`28%`,collapsible:{end:!0},children:T(Q,{title:`Palette`,subtitle:`左栏可快速折叠，适合图层、筛选器或工具箱。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Components`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Tokens`}),T(`div`,{className:`rounded-box bg-base-200/70 px-3 py-2`,children:`Layers`})]})})}),T(U.Panel,{collapsible:{start:!0,end:!0},children:T(Q,{title:`Canvas`,subtitle:`中间主区保留最大的操作空间。`,children:T(`div`,{className:`flex h-40 items-center justify-center rounded-box border border-dashed border-base-300 bg-base-200/40 text-sm text-base-content/55`,children:`Main canvas`})})}),T(U.Panel,{defaultSize:`22%`,collapsible:{start:!0},children:T(Q,{title:`Inspector`,subtitle:`右侧检查面板按需展开，减少噪音。`,children:w(`div`,{className:`space-y-2 text-sm text-base-content/70`,children:[T(`div`,{children:`Width: 320`}),T(`div`,{children:`Height: 180`}),T(`div`,{children:`Radius: 16`})]})})})]}),code:fe});f(()=>m(t,l,j))});let M=t(`rue:component:anchor`);o(l,M),y(()=>{let t=_(D,{title:`Multiple panels and double click reset`,summary:`多面板场景里，双击分隔柄常常比额外按钮更顺手。`,tab:e.reset,preview:me,code:Y});f(()=>m(t,l,M))});let N=t(`rue:component:anchor`);o(l,N),y(()=>{let t=_(D,{title:`Lazy drag for analysis view`,summary:`lazy 模式更适合重内容布局，拖动过程先预览位置，释放后再真正提交尺寸。`,tab:e.lazy,preview:$,code:X});f(()=>m(t,l,N))});let P=i(`h2`,l);o(l,P),u(P,`id`,`splitter-api`),o(P,c(`API`));let F=i(`p`,l);o(l,F),r(F,`text-sm mt-3 mb-4`),o(F,c(`Splitter 的根组件负责布局和交互，所有真正参与计算的子节点都应该是`));let I=x(F);o(F,I),s(I,` `);let L=i(`code`,F);o(F,L),o(L,c(`Splitter.Panel`)),o(F,c(`。 如果你在业务里需要把布局状态持久化，优先使用`));let ee=x(F);o(F,ee),s(ee,` `);let R=i(`code`,F);o(F,R),o(R,c(`size`)),o(F,c(`+`));let z=i(`code`,F);o(F,z),o(z,c(`onResize`)),o(F,c(`的受控写法；如果只需要默认占比，用`));let B=i(`code`,F);o(F,B),o(B,c(`defaultSize`)),o(F,c(`即可。`));let V=t(`rue:component:anchor`);return o(l,V),y(()=>{let e=_(Z,{rows:de});f(()=>m(e,l,V))}),a})}),l,p),l})};export{he as default};