...
export default Fragments;`});t(()=>p(e,l,u))}),n}):``;t(()=>p(n,b,x))}),o(b,l(` `));let S=s(`rue:slot:anchor`);return o(b,S),a(()=>{let n=v.value===`preview`?u(()=>{let t=r(),n=e(`div`,t);o(t,n),c(n,`card bg-base-100 shadow`);let i=e(`div`,n);o(n,i),c(i,`card-body grid gap-2`),o(i,l(` `));let a=e(`span`,i);o(i,a),o(a,l(`片段 1`)),o(i,l(` `));let s=e(`span`,i);return o(i,s),o(s,l(`片段 2`)),o(i,l(` `)),t}):``;t(()=>p(n,b,S))}),i})}),f,h),f})};export{v as default};