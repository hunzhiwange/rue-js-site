import{$ as e,Ht as t,Q as n,Rt as r,S as i,Xt as a,Y as o,Z as s,ct as c,et as l,l as u,mt as d,ot as f,qt as p,s as m,t as h,tt as g}from"./vapor-runtime-aZAg0Qkw.js";import{a as _,n as v}from"./vapor-helpers-vapor-gtGwiIv0.js";import{a as y,i as b}from"./persistentSidebarPlayground-IkfbXpbu.js";import{t as x}from"./Code-5DOEyGxf.js";import{t as S}from"./tabs-CWmjyn0I.js";import{t as C}from"./toast-B83TaBKR.js";import{r as w}from"./SidebarPlaygroundDesign-CS11MI8e.js";import{t as T}from"./preview-test-gate-DdwKChL0.js";var E=r=>u(i=>{let d=e(`div`,i);c(d,`component-preview not-prose text-base-content my-6 lg:my-12`);let f=e(`div`,d);o(d,f),c(f,`flex flex-wrap items-start justify-between gap-3`);let p=e(`div`,f);o(f,p);let g=e(`h2`,p);o(p,g),c(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),o(g,l(`# `));let _=s(`rue:slot:anchor`);o(g,_),a(()=>{let e=r.title;t(()=>m(e,g,_))});let v=s(`rue:slot:anchor`);o(p,v),a(()=>{let i=r.summary?u(()=>{let i=n(),l=e(`p`,i);o(i,l),c(l,`m-0 text-sm opacity-70`);let u=s(`rue:slot:anchor`);return o(l,u),a(()=>{let e=r.summary;t(()=>m(e,l,u))}),i}):``;t(()=>m(i,p,v))});let y=s(`rue:component:anchor`);o(d,y),a(()=>{let e=h(S,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:r.tab.value,onChange:e=>r.tab.value=e,className:`mb-3 mt-4`});t(()=>m(e,d,y))});let b=s(`rue:slot:anchor`);return o(d,b),a(()=>{let e=r.tab.value===`preview`?T(r.title,r.preview):u(()=>{let e=n(),i=s(`rue:component:anchor`);return o(e,i),a(()=>{let n=h(x,{className:`mt-2`,lang:`tsx`,code:r.code});t(()=>m(n,e,i))}),e});t(()=>m(e,d,b))}),d}),D=e=>Array.isArray(e)?e.flatMap(e=>D(e)):e==null?[]:[e],O=r=>u(i=>{let d=e(`div`,i);c(d,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let p=e(`table`,d);o(d,p),c(p,`table table-zebra`);let h=e(`thead`,p);o(p,h);let g=e(`tr`,h);o(h,g);let _=e(`th`,g);o(g,_),o(_,l(`属性`));let y=e(`th`,g);o(g,y),o(y,l(`说明`));let b=e(`th`,g);o(g,b),o(b,l(`类型`));let x=e(`th`,g);o(g,x),o(x,l(`默认值`));let S=e(`tbody`,p);o(p,S);let C=s(`rue:list:start`),w=s(`rue:list:end`);o(S,C),o(S,w);let T=new Map;return a(()=>{T=v({items:r.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(r,i,c,l,d)=>{m(u(()=>{let i=n(),c=e(`tr`,i);o(i,c),a(()=>{f(c,`key`,String(r.prop))});let l=e(`td`,c);o(c,l);let u=e(`code`,l);o(l,u);let d=s(`rue:slot:anchor`);o(u,d),a(()=>{let e=r.prop;t(()=>m(e,u,d))});let p=e(`td`,c);o(c,p);let h=s(`rue:slot:anchor`);o(p,h),a(()=>{let e=r.description;t(()=>m(e,p,h))});let g=e(`td`,c);o(c,g);let _=e(`code`,g);o(g,_);let v=s(`rue:slot:anchor`);o(_,v),a(()=>{let e=r.type;t(()=>m(e,_,v))});let y=e(`td`,c);o(c,y);let b=e(`code`,y);o(y,b);let x=s(`rue:slot:anchor`);return o(b,x),a(()=>{let e=r.defaultValue;t(()=>m(e,b,x))}),i}),i,c)}})}),d}),k=e=>i(`div`,{className:`not-prose rounded-[1.5rem] border border-base-300 bg-base-200/50 p-4 shadow-sm`},i(`div`,{className:`relative overflow-hidden rounded-[1.25rem] border border-base-300 bg-base-100/90`,style:{minHeight:e.minHeight===void 0?`14rem`:e.minHeight}},...D(e.children))),ee={info:`alert alert-info`,success:`alert alert-success`,warning:`alert alert-warning`},te=[{label:`top-start`,placement:`top-start`,tone:`info`},{label:`top`,placement:`top`,tone:`success`},{label:`top-end`,placement:`top-end`,tone:`warning`},{label:`middle-start`,placement:`middle-start`,tone:`warning`},{label:`center`,placement:`center`,tone:`info`},{label:`middle-end`,placement:`middle-end`,tone:`success`},{label:`bottom-start`,placement:`bottom-start`,tone:`success`},{label:`bottom`,placement:`bottom`,tone:`warning`},{label:`bottom-end`,placement:`bottom-end`,tone:`info`}],ne=[{type:`info`,title:`Draft synced`,description:`The latest edits have been pushed to your shared workspace.`},{type:`success`,title:`Publish complete`,description:`The release has been deployed to production without errors.`},{type:`warning`,title:`Review pending`,description:`Two comments still need acknowledgement before merge.`},{type:`error`,title:`Backup failed`,description:`Storage quota is exhausted. Free up space and retry.`},{type:`loading`,title:`Indexing content`,description:`Toast.Item can keep a loading state visible until your flow completes.`}],re=[{label:`Soft`,variant:`soft`,type:`info`},{label:`Outline`,variant:`outline`,type:`warning`},{label:`Solid`,variant:`solid`,type:`success`}],ie=[{prop:`as`,description:`指定根节点标签，例如 div、section`,type:`any`,defaultValue:`'div'`},{prop:`gap`,description:`控制多个 toast 项之间的间距，支持数字和任意 CSS 长度`,type:`number | string`,defaultValue:`-`},{prop:`horizontal`,description:`横向位置；传入后会覆盖 placement 推导出的横轴结果`,type:`'start' | 'center' | 'end'`,defaultValue:`-`},{prop:`inset`,description:`容器内边距，可统一设置，也可通过 x / y 分别控制横向与纵向留白`,type:`number | string | { x?: number | string; y?: number | string }`,defaultValue:`-`},{prop:`placement`,description:`语义化九宫格定位别名，例如 top-end、center、bottom-start`,type:`'top-start' | 'top' | 'top-center' | 'top-end' | 'middle-start' | 'middle' | 'middle-center' | 'middle-end' | 'bottom-start' | 'bottom' | 'bottom-center' | 'bottom-end' | 'start' | 'center' | 'end'`,defaultValue:`-`},{prop:`reverse`,description:`反转容器内子项顺序，适合最新消息置顶或横向倒序布局`,type:`boolean`,defaultValue:`false`},{prop:`stack`,description:`堆叠方向，默认维持竖向通知流，也可以切到横向条带式布局`,type:`'vertical' | 'horizontal'`,defaultValue:`'vertical'`},{prop:`vertical`,description:`纵向位置；传入后会覆盖 placement 推导出的纵轴结果`,type:`'top' | 'middle' | 'bottom'`,defaultValue:`-`},{prop:`zIndex`,description:`调整容器层级，适合叠放在抽屉、卡片或 mock 页面之上`,type:`number | string`,defaultValue:`-`}],ae=[{prop:`action`,description:`右侧操作区，可放按钮、链接或状态标签`,type:`any`,defaultValue:`-`},{prop:`as`,description:`单条提示的根节点标签，默认 div`,type:`any`,defaultValue:`'div'`},{prop:`closable`,description:`显示内建关闭按钮，并在点击时触发 onClose / onOpenChange`,type:`boolean`,defaultValue:`false`},{prop:`closeIcon`,description:`自定义关闭按钮图标`,type:`any`,defaultValue:`-`},{prop:`defaultOpen`,description:`非受控初始显示状态`,type:`boolean`,defaultValue:`true`},{prop:`description`,description:`说明文案，适合放补充上下文或后续动作提示`,type:`any`,defaultValue:`-`},{prop:`duration`,description:`自动关闭时长，单位秒；传入 0 或 null 时保持常驻`,type:`number | null`,defaultValue:`-`},{prop:`icon`,description:`自定义图标；未传时会根据 type 渲染默认图标`,type:`any`,defaultValue:`-`},{prop:`onClose`,description:`关闭完成时触发，meta.source 会标记 close 或 timeout`,type:`(meta) => void`,defaultValue:`-`},{prop:`onOpenChange`,description:`显示状态变化回调，适合受控关闭或外部同步状态`,type:`(open, meta) => void`,defaultValue:`-`},{prop:`open`,description:`受控显示状态`,type:`boolean`,defaultValue:`-`},{prop:`pauseOnHover`,description:`自动关闭时鼠标移入是否暂停剩余计时`,type:`boolean`,defaultValue:`true`},{prop:`showIcon`,description:`关闭默认图标渲染，只保留文字和操作区`,type:`boolean`,defaultValue:`true`},{prop:`title`,description:`标题文案，适合放主状态结论`,type:`any`,defaultValue:`-`},{prop:`type`,description:`语义类型，会同时影响默认图标、无障碍语义和视觉配色`,type:`'neutral' | 'info' | 'success' | 'warning' | 'error' | 'loading'`,defaultValue:`'neutral'`},{prop:`variant`,description:`提示外观风格，适合在页面层级里调节存在感`,type:`'soft' | 'solid' | 'outline'`,defaultValue:`'soft'`}],oe=[{prop:`placement / inset / gap / zIndex`,description:`复用 Toast 根容器的定位能力；默认消息层会挂到全局页面层，而不是被当前 box 裁住。`,type:`ToastProps 子集`,defaultValue:`placement = 'top'`},{prop:`getContainer`,description:`控制消息挂载位置；默认挂到 document.body，传 false 时退回到 contextHolder 所在的局部 box。`,type:`string | HTMLElement | (() => HTMLElement) | false`,defaultValue:`document.body`},{prop:`maxCount`,description:`限制同时显示的消息数量；超过时会自动挤掉最早的一条。`,type:`number`,defaultValue:`-`},{prop:`duration`,description:`给 hook 创建出来的消息设定默认自动关闭时长，单条消息可覆盖。`,type:`number | null`,defaultValue:`3`},{prop:`variant / closable / pauseOnHover / showIcon / type`,description:`为整个 message 通道设定单条提示的默认外观和行为。`,type:`ToastItemProps 子集`,defaultValue:`-`}],se=[{prop:`open(config)`,description:`创建一条消息；返回关闭函数，适合临时保存句柄。`,type:`(config: ToastMessageConfig) => () => void`,defaultValue:`-`},{prop:`success / info / warning / error`,description:`带语义类型的快捷方法，等价于 open({ type, ...config })。`,type:`(config) => () => void`,defaultValue:`-`},{prop:`loading(config)`,description:`加载态快捷方法，默认会把 duration 设为 0，便于后续按 key 更新。`,type:`(config) => () => void`,defaultValue:`-`},{prop:`destroy(key?)`,description:`销毁指定 key 的消息；不传 key 时清空当前 holder 里的全部消息。`,type:`(key?: string | number) => void`,defaultValue:`-`}],ce=[{prop:`key`,description:`稳定标识；重复调用同一个 key 时会原位更新，而不是追加新消息。`,type:`string | number`,defaultValue:`自动生成`},{prop:`content`,description:`message 风格的主内容；未传 children 时会直接渲染在正文区域。`,type:`any`,defaultValue:`-`},{prop:`children`,description:`需要 richer JSX 时可直接传 children，优先级高于 content。`,type:`any`,defaultValue:`-`},{prop:`其余字段`,description:`type、duration、action、closable、variant、icon、onClose 等字段复用 Toast.Item。`,type:`ToastItemProps 子集`,defaultValue:`-`}],A=()=>{let{tabs:i,controlledOpen:f,controlledToastKey:v,autoToastKey:x,messageApi:S,messageContextHolder:T}=_(`useSetup:0:0`,()=>p(()=>{let e={items:_(`ref:1:0`,()=>r(`preview`)),variants:_(`ref:1:1`,()=>r(`preview`)),controlled:_(`ref:1:2`,()=>r(`preview`)),useMessage:_(`ref:1:3`,()=>r(`preview`)),compound:_(`ref:1:4`,()=>r(`preview`)),basic:_(`ref:1:5`,()=>r(`preview`)),placements:_(`ref:1:6`,()=>r(`preview`)),stacked:_(`ref:1:7`,()=>r(`preview`)),inset:_(`ref:1:8`,()=>r(`preview`)),host:_(`ref:1:9`,()=>r(`preview`))},t=_(`ref:1:10`,()=>r(!0)),n=_(`ref:1:11`,()=>r(0)),i=_(`ref:1:12`,()=>r(0)),[a,o]=C.useMessage({placement:`top-end`,inset:{x:16,y:68},gap:12,maxCount:3,zIndex:80});return{tabs:e,controlledOpen:t,controlledToastKey:n,autoToastKey:i,messageApi:a,messageContextHolder:o}}));return u(r=>{let p=n(),_=s(`rue:component:anchor`);return o(p,_),m(h(w,{children:u(()=>{let r=n(),u=e(`div`,r);o(r,u),c(u,`max-w-none prose prose-sm md:prose-base`);let p=e(`h1`,u);o(u,p),o(p,l(`Toast 轻提示`));let _=e(`p`,u);o(u,_),c(_,`text-sm mt-3 mb-3`),o(_,l(`这次 Toast 不再只有一个“放 alert 的定位壳”。根容器依旧负责 placement、stack 和 inset， 但单条提示现在可以直接用`));let w=e(`code`,_);o(_,w),o(w,l(`Toast.Item`)),o(_,l(`写出接近 message 的反馈体验：类型、标题、说明、 操作区、关闭按钮、自动关闭与悬停暂停都已经补齐；现在还可以像常见 message API 一样通过`));let D=e(`code`,_);o(_,D),o(D,l(`Toast.useMessage()`)),o(_,l(`拿到`));let A=e(`code`,_);o(_,A),o(A,l(`messageApi`)),o(_,l(`和`));let le=e(`code`,_);o(_,le),o(le,l(`contextHolder`)),o(_,l(`， 在业务按钮、异步流程和页面局部容器里直接按 key 推送、更新和销毁消息；默认会弹到全局页面层， 只有显式传`));let ue=g(_);o(_,ue),d(ue,` `);let de=e(`code`,_);o(_,de),o(de,l(`getContainer={false}`)),o(_,l(`时才会留在当前 box 里，同时仍然保留 Rue 自己更轻、更靠近页面内容的视觉语气。`));let fe=e(`h2`,u);o(u,fe),o(fe,l(`何时使用`));let j=e(`ul`,u);o(u,j);let M=e(`li`,j);o(j,M),o(M,l(`需要在页面局部提供轻量反馈，但不想上升成全局通知系统。`));let N=e(`li`,j);o(j,N),o(N,l(`希望像 message 一样直接描述成功、失败、加载、警告这些状态，又想保留更贴近 Rue 的视觉风格。`));let P=e(`li`,j);o(j,P),o(P,l(`希望在事件处理函数里直接触发反馈，而不是先把消息数组提升到页面状态。`));let F=e(`li`,j);o(j,F),o(F,l(`既要兼容旧的 alert 容器写法，也想在业务里直接拿到可关闭、可自动关闭的单条提示能力。`));let I=s(`rue:component:anchor`);o(u,I),a(()=>{let e=h(E,{title:`Message-like items`,summary:`最直接的增强用法：把内容交给 Toast.Item，根容器继续负责定位和堆叠。`,tab:i.items,preview:()=>y(k,{minHeight:`19rem`,children:[b(`div`,{className:`absolute inset-x-0 top-0 h-20 bg-gradient-to-r from-info/10 via-success/10 to-warning/10`}),b(C,{className:`absolute`,placement:`top-end`,inset:{x:16,y:16},gap:12,children:ne.slice(0,3).map(e=>b(C.Item,{type:e.type,title:e.title,description:e.description,closable:!0},e.title))})]}),code:`<Toast className="absolute" placement="top-end" inset={{ x: 16, y: 16 }} gap={12}>
  ...
  <Toast.Item
    ...
    closable
  />
</Toast>`});t(()=>m(e,u,I))});let L=s(`rue:component:anchor`);o(u,L),a(()=>{let e=h(E,{title:`Variants and actions`,summary:`soft、outline、solid 三种外观可以调整存在感，action 让单条提示具备 message 之上的轻量操作能力。`,tab:i.variants,preview:()=>b(`div`,{className:`grid gap-4`,children:re.map(e=>y(k,{minHeight:`11rem`,children:[b(`div`,{className:`absolute left-3 top-3 badge badge-ghost badge-sm`,children:e.label}),b(C,{className:`absolute`,placement:`bottom-start`,inset:{x:12,y:12},children:b(C.Item,{type:e.type,variant:e.variant,title:`${e.label} feedback`,description:`Toast.Item 可以直接承载业务动作。`,action:b(`button`,{type:`button`,className:`btn btn-xs btn-ghost`,children:`Undo`}),closable:!0})})]},e.label))}),code:`<Toast.Item
  type="warning"
  variant="outline"
  ...
  closable
/>`});t(()=>m(e,u,L))});let R=s(`rue:component:anchor`);o(u,R),a(()=>{let e=h(E,{title:`Controlled and auto close`,summary:`受控关闭适合和外部状态联动；自动关闭则补齐了 message 常用的短时反馈体验，并支持 hover 暂停。`,tab:i.controlled,preview:()=>y(k,{minHeight:`19rem`,children:[y(`div`,{className:`absolute left-4 top-4 flex flex-wrap gap-2`,children:[b(`button`,{type:`button`,className:`btn btn-sm`,onClick:()=>{v.value+=1,f.value=!0},children:`重新显示受控提示`}),b(`button`,{type:`button`,className:`btn btn-sm btn-outline`,onClick:()=>{x.value+=1},children:`重新触发自动关闭`})]}),y(C,{className:`absolute`,placement:`top-end`,inset:{x:16,y:56},gap:12,children:[b(C.Item,{open:f.value,type:`warning`,title:`Deployment paused`,description:`This one is controlled from the outside so you can coordinate with page state.`,closable:!0,onOpenChange:e=>{f.value=e}},v.value),b(C.Item,{type:`success`,title:`Auto saved`,description:`This toast closes itself after 4 seconds and pauses while hovered.`,duration:4,closable:!0},x.value)]})]}),code:`const controlledOpen = ref(true)
...
</Toast>`});t(()=>m(e,u,W))});let he=s(`rue:component:anchor`);o(u,he),a(()=>{let e=h(E,{title:`Custom host element`,summary:`需要语义容器时，可以把根节点改成 section，并直接挂上 status / aria-live 之类的可访问性语义。`,tab:i.host,preview:()=>b(k,{children:y(C,{as:`section`,className:`absolute`,placement:`top`,inset:{x:16,y:16},role:`status`,"aria-live":`polite`,gap:10,children:[b(`div`,{role:`alert`,className:`alert alert-info shadow-sm`,children:b(`span`,{children:`Auto save completed.`})}),b(`div`,{role:`alert`,className:`alert alert-warning shadow-sm`,children:b(`span`,{children:`1 draft still requires review.`})})]})}),code:`<Toast
  as="section"
  className="absolute"
  placement="top"
  inset={{ x: 16, y: 16 }}
...
</Toast>`});t(()=>m(e,u,he))});let G=e(`div`,u);o(u,G),c(G,`my-8 lg:my-12`);let K=e(`h2`,G);o(G,K),c(K,`mt-2 mb-4 text-lg font-semibold`),o(K,l(`API`));let q=e(`h3`,G);o(G,q),c(q,`mt-2 mb-3 text-base font-semibold`),o(q,l(`Toast.useMessage(options)`));let ge=s(`rue:component:anchor`);o(G,ge),a(()=>{let e=h(O,{rows:oe});t(()=>m(e,G,ge))});let J=e(`p`,G);o(G,J),c(J,`mt-4 text-sm opacity-70`),o(J,l(`返回值固定为`));let _e=e(`code`,J);o(J,_e),o(_e,l(`[messageApi, contextHolder]`)),o(J,l(`。为了保持这类 hook 的用法习惯，`));let ve=e(`code`,J);o(J,ve),o(ve,l(`contextHolder`)),o(J,l(`仍然建议真实渲染到页面里；默认情况下它主要跟随当前组件生命周期，真正的消息层会挂到`));let ye=e(`code`,J);o(J,ye),o(ye,l(`document.body`)),o(J,l(`，传`));let be=e(`code`,J);o(J,be),o(be,l(`getContainer={false}`)),o(J,l(`时才会回到 holder 内。`));let Y=e(`h3`,G);o(G,Y),c(Y,`mt-8 mb-3 text-base font-semibold`),o(Y,l(`messageApi`));let xe=s(`rue:component:anchor`);o(G,xe),a(()=>{let e=h(O,{rows:se});t(()=>m(e,G,xe))});let X=e(`h3`,G);o(G,X),c(X,`mt-8 mb-3 text-base font-semibold`),o(X,l(`ToastMessageConfig`));let Se=s(`rue:component:anchor`);o(G,Se),a(()=>{let e=h(O,{rows:ce});t(()=>m(e,G,Se))});let Z=e(`h3`,G);o(G,Z),c(Z,`mt-2 mb-3 text-base font-semibold`),o(Z,l(`Toast 根容器`));let Ce=s(`rue:component:anchor`);o(G,Ce),a(()=>{let e=h(O,{rows:ie});t(()=>m(e,G,Ce))});let Q=e(`h3`,G);o(G,Q),c(Q,`mt-8 mb-3 text-base font-semibold`),o(Q,l(`Toast.Item 单条提示`));let we=s(`rue:component:anchor`);o(G,we),a(()=>{let e=h(O,{rows:ae});t(()=>m(e,G,we))});let $=e(`p`,G);o(G,$),c($,`mt-4 text-sm opacity-70`),o($,l(`Compound 子组件包括`));let Te=e(`code`,$);o($,Te),o(Te,l(`Toast.Icon`)),o($,l(`、`));let Ee=e(`code`,$);o($,Ee),o(Ee,l(`Toast.Content`)),o($,l(`、`));let De=e(`code`,$);o($,De),o(De,l(`Toast.Title`)),o($,l(`、`));let Oe=e(`code`,$);o($,Oe),o(Oe,l(`Toast.Description`)),o($,l(`、`));let ke=e(`code`,$);o($,ke),o(ke,l(`Toast.Action`)),o($,l(`和`));let Ae=g($);o($,Ae),d(Ae,` `);let je=e(`code`,$);return o($,je),o(je,l(`Toast.Close`)),o($,l(`。`)),r})}),p,_),p})};export{A as default};