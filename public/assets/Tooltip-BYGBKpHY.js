...
</div>`});i(()=>d(e,n,R))});let z=e(`div`,n);a(n,z),c(z,`not-prose mt-10 overflow-x-auto rounded-box border border-base-300 bg-base-100`);let B=e(`table`,z);a(z,B),c(B,`table table-zebra`);let V=e(`thead`,B);a(B,V);let H=e(`tr`,V);a(V,H);let U=e(`th`,H);a(H,U),a(U,u(`属性`));let W=e(`th`,H);a(H,W),a(W,u(`说明`));let G=e(`th`,H);a(H,G),a(G,u(`类型`));let K=e(`th`,H);a(H,K),a(K,u(`默认值`));let q=e(`tbody`,B);a(B,q);let J=s(`rue:list:start`),Y=s(`rue:list:end`);a(q,J),a(q,Y);let X=new Map;return o(()=>{X=h({items:x||[],getKey:(e,t)=>e.prop,elements:X,parent:q,before:Y,singleRoot:!0,trackIndex:!1,start:J,renderItem:(t,n,c,u,p)=>{d(l(()=>{let n=r(),c=e(`tr`,n);a(n,c),o(()=>{f(c,`key`,String(t.prop))});let l=e(`td`,c);a(c,l);let u=e(`code`,l);a(l,u);let p=s(`rue:slot:anchor`);a(u,p),o(()=>{let e=t.prop;i(()=>d(e,u,p))});let m=e(`td`,c);a(c,m);let h=s(`rue:slot:anchor`);a(m,h),o(()=>{let e=t.description;i(()=>d(e,m,h))});let g=e(`td`,c);a(c,g);let _=e(`code`,g);a(g,_);let v=s(`rue:slot:anchor`);a(_,v),o(()=>{let e=t.type;i(()=>d(e,_,v))});let y=e(`td`,c);a(c,y);let b=e(`code`,y);a(y,b);let x=s(`rue:slot:anchor`);return a(b,x),o(()=>{let e=t.defaultValue;i(()=>d(e,b,x))}),n}),n,c)}})}),t})}),n,m),n})};export{S as default};