import{H as e,V as t,Vt as n,Wt as r,gn as i,mn as a}from"./rue-runtime-Cv6BZekS.js";import{t as o}from"./createHomeSplitExamplePage-DqLcVC_n.js";import{r as s}from"./RouterDemoScene-BNQVUrf1.js";var c=`/*
路由示例概述
...
`,l=(l,u,d)=>t(o,()=>({options:{title:`路由（嵌套 / 命名路由 / 守卫）`,source:c,codeCardClassName:`h-[560px] md:h-[1850px]`},children:(t,o,c)=>{let l=()=>r(t=>{let n=a();e(n,s,()=>({}));let r=i(``),o=i(``);return n.insertBefore(r,n.firstChild),n.appendChild(o),[n.firstChild,n.lastChild]});return t==null?l():n(t,c,l)}}));export{l as default};