import{$ as e,$t as t,Bt as n,Gt as r,X as i,Xt as a,Z as o,Zt as s,_t as c,ct as l,et as u,ft as d,gt as f,ht as p,l as m,mt as h,nt as g,o as _,rt as v,s as y,t as b,tt as x,ut as S,yt as C}from"./vapor-runtime-CKrmRMZX.js";import{a as w,n as T}from"./vapor-helpers-vapor-s6lMjTDZ.js";import{a as E,i as D}from"./persistentSidebarPlayground-CKHFGglU.js";import{t as O}from"./Code-D5UqTwV6.js";import{t as k}from"./tabs-DRfs918f.js";import{t as A}from"./dropdown-B1RdFRdI.js";import{r as j}from"./SidebarPlaygroundDesign-CWudvLqE.js";var M=0,N={emptyText:`No Data`,filterConfirm:`应用`,filterReset:`重置`,triggerAsc:`切换为升序`,triggerDesc:`切换为降序`,cancelSort:`取消排序`},P=(e,t)=>{if(t){if(Array.isArray(t)){let n=e;for(let e of t){if(n==null)return;n=n[e]}return n}return e?.[t]}},F=e=>e===`right`?`text-right`:e===`center`?`text-center`:`text-left`,I=(...e)=>e.filter(Boolean).join(` `).trim()||void 0,L=(...e)=>{let t;return e.forEach(e=>{e&&(t=t?{...t,...e}:{...e})}),t},R=e=>e==null||e===!1?[]:Array.isArray(e)?[...e]:typeof e!=`string`&&typeof e?.[Symbol.iterator]==`function`?Array.from(e):[e],ee=(e,t)=>e.key?e.key:typeof e.dataIndex==`string`?e.dataIndex:Array.isArray(e.dataIndex)&&e.dataIndex.length>0?e.dataIndex.join(`.`):`column-${t.join(`-`)}`,z=e=>(e.children??[]).filter(e=>!e.hidden),te=e=>e.reduce((e,t)=>{if(t.hidden)return e;let n=z(t);return n.length===0?e+1:e+te(n)},0),B=e=>{let t=1;return e.forEach(e=>{if(e.hidden)return;let n=z(e);n.length>0&&(t=Math.max(t,1+B(n)))}),t},ne=(e,t=[])=>{let n=[];return e.forEach((e,r)=>{if(e.hidden)return;let i=[...t,r],a=z(e);if(a.length>0){n.push(...ne(a,i));return}n.push({column:e,indexPath:i,key:ee(e,i)})}),n},re=e=>{let t=e.filter(e=>!e.hidden),n=B(t),r=Array.from({length:n},()=>[]),i=(e,t,a=[])=>{e.forEach((e,o)=>{if(e.hidden)return;let s=[...a,o],c=z(e),l=c.length>0?te(c):1,u=e.colSpan??l;if(u===0)return;let d=e.rowSpan??(c.length>0?1:n-t);r[t].push({column:e,index:o,key:ee(e,s),colSpan:u,rowSpan:d}),c.length>0&&i(c,t+1,s)})};return i(t,0),r},ie=e=>!!(e.fixedCol||e.fixed===!0||e.fixed===`left`||e.fixed===`start`),ae=e=>typeof e==`object`&&!!e,V=e=>{if(ae(e.sorter))return e.sorter.multiple},H=e=>e.filter(e=>!!e?.order).sort((e,t)=>{let n=e.multiple??0,r=t.multiple??0;return n===r?0:r-n}),oe=e=>{let t=H(e.filter(e=>e.column.sortOrder!==void 0).map(e=>({key:e.key,order:e.column.sortOrder,multiple:V(e.column)})));return t.length>0?t:H(e.filter(e=>!!e.column.defaultSortOrder).map(e=>({key:e.key,order:e.column.defaultSortOrder,multiple:V(e.column)})))},se=e=>{let t={};return e.forEach(({column:e,key:n})=>{if(e.filteredValue!==void 0){t[n]=R(e.filteredValue);return}e.defaultFilteredValue!==void 0&&(t[n]=R(e.defaultFilteredValue))}),t},ce=(e,t)=>e<=1?1:e>=t?t:e,le=e=>typeof e==`number`?`${e}px`:e,ue=e=>{switch(e){case`small`:return`table-sm`;case`middle`:return`table-md`;case`large`:return`table-lg`;case`xs`:case`sm`:case`md`:case`lg`:case`xl`:return`table-${e}`;default:return}},de=e=>({...N,...e}),fe=(e,t)=>typeof e==`function`?e({props:t})??{}:e??{},pe=e=>e?e===!0?!0:e.showTitle!==!1:!1,me=e=>{switch(e){case`topLeft`:return`topStart`;case`topCenter`:return`topCenter`;case`topRight`:return`topEnd`;case`bottomLeft`:return`bottomStart`;case`bottomCenter`:return`bottomCenter`;case`bottomRight`:return`bottomEnd`;default:return`none`}},he=e=>e==null||e===!1?[]:(e.placement?.length?e.placement:e.position?.length?e.position.map(me):[`bottomEnd`]).filter((e,t,n)=>e===`none`?n.length===1:n.indexOf(e)===t),ge=e=>{switch(e){case`topStart`:case`bottomStart`:return`justify-start`;case`topCenter`:case`bottomCenter`:return`justify-center`;default:return`justify-end`}},_e=(e,t)=>{let n=e?.[t];return Array.isArray(n)?n:[]},ve=({render:e,data:t})=>typeof e==`function`?e(t):null,ye=({render:e,record:t,index:n,indent:r,expanded:i})=>typeof e==`function`?e(t,n,r,i):null,be=e=>{let t=typeof e;return t===`string`||t===`number`},U=Object.assign(n=>{let O=w(`useSetup:0:0`,()=>a(()=>{let{size:e,zebra:t,pinRows:r,pinCols:i,bordered:a,className:o,classNames:s,styles:c,children:l,dataSource:u,columns:d,rowKey:f=`key`,showHeader:p=!0,onRow:m,onHeaderRow:h,onChange:g,rowSelection:_,pagination:v,expandable:y,rowClassName:b,summary:x,emptyText:S,locale:T,title:E,footer:D,loading:O,rowHoverable:k=!1,rowHoverClass:A,tableLayout:j,sortDirections:M,showSorterTooltip:N,scroll:P,sticky:F,height:I,onScroll:L}=n,R=de(T),ee=w(`computed:1:0`,()=>C(()=>fe(s,n))),z=ee,te=w(`computed:1:1`,()=>C(()=>fe(c,n))),B=typeof O==`object`?{spinning:O.spinning!==!1,tip:O.tip}:{spinning:!!O,tip:void 0},ne=y?.childrenColumnName??`children`,re=y?.indentSize??15,ie=(e,t)=>(typeof f==`function`?f(e):e?.[f])??t,ae=(e,t=[])=>e.flatMap((e,n)=>{let r=[...t,n],i=ie(e,`row-${r.join(`-`)}`),a=_e(e,ne);return a.length===0?[]:[i,...ae(a,r)]}),V=`table`,H=ue(e);return H&&(V+=` ${H}`),t&&(V+=` table-zebra`),(r||F)&&(V+=` table-pin-rows`),i&&(V+=` table-pin-cols`),a&&(V+=` border-separate border-spacing-0`),z.get().table&&(V+=` ${z.get().table}`),o&&(V+=` ${o}`),{size:e,zebra:t,pinRows:r,pinCols:i,bordered:a,className:o,classNames:s,styles:c,children:l,dataSource:u,columns:d,rowKey:f,showHeader:p,onRow:m,onHeaderRow:h,onChange:g,rowSelection:_,pagination:v,expandable:y,rowClassName:b,summary:x,emptyText:S,locale:T,titleRender:E,footerRender:D,loading:O,rowHoverable:k,rowHoverClass:A,tableLayout:j,sortDirections:M,showSorterTooltip:N,scroll:P,sticky:F,height:I,onScroll:L,localeText:R,semanticClasses:ee,semanticStyles:te,loadingConfig:B,childrenColumnName:ne,indentSize:re,getRecordKey:ie,collectExpandedKeys:ae,sizeClass:H,hasChildren:!(l==null||Array.isArray(l)&&l.length===0),cls:V}})),{size:k,zebra:j,pinRows:N,pinCols:ee,bordered:te,className:B,classNames:me,styles:U,children:W,dataSource:xe,columns:G,rowKey:Se,showHeader:Ce,onRow:we,onHeaderRow:Te,onChange:Ee,rowSelection:K,pagination:De,expandable:q,rowClassName:Oe,summary:ke,emptyText:Ae,locale:je,titleRender:Me,footerRender:Ne,loading:Pe,rowHoverable:Fe,rowHoverClass:Ie,tableLayout:Le,sortDirections:Re,showSorterTooltip:ze,scroll:Be,sticky:Ve,height:He,onScroll:Ue,localeText:We,semanticClasses:J,semanticStyles:Y,loadingConfig:Ge,childrenColumnName:Ke,indentSize:qe,getRecordKey:Je,collectExpandedKeys:Ye,sizeClass:X,hasChildren:Xe}=O,{cls:Ze}=O;if(Xe)return m(n=>{let i=x(`table`,n);t(()=>{S(i,Ze)}),t(()=>{let e=Y.get().table;h(i,e)});let a=e(`rue:slot:anchor`);return o(i,a),t(()=>{let e=W;r(()=>_(e,i,a))}),i});let Qe=Array.isArray(G)?ne(G):[],[$e]=w(`useState:1:2`,()=>s(`rue-table-${M++}`)),[et,tt]=w(`useState:1:3`,()=>s(oe(Qe),{kind:`ref`})),[nt,rt]=w(`useState:1:4`,()=>s(se(Qe),{kind:`ref`})),[it,at]=w(`useState:1:5`,()=>s({},{kind:`ref`})),[ot,st]=w(`useState:1:6`,()=>s({},{kind:`ref`})),[ct,lt]=w(`useState:1:7`,()=>s(null)),[ut,dt]=w(`useState:1:8`,()=>s(0)),[ft,pt]=w(`useState:1:9`,()=>s(K?.defaultSelectedRowKeys?[...K.defaultSelectedRowKeys]:[],{kind:`ref`})),Z=De!=null&&De!==!1?De:void 0,[mt,ht]=w(`useState:1:10`,()=>s(Z?Z.current??Z.defaultCurrent??1:1)),[gt]=w(`useState:1:11`,()=>s(Z?Z.pageSize??Z.defaultPageSize??10:Math.max(xe?.length??0,1))),[Q,_t]=w(`useState:1:12`,()=>s(q?.defaultExpandedRowKeys?[...q.defaultExpandedRowKeys]:q?.defaultExpandAllRows&&Array.isArray(xe)?xe.flatMap((e,t)=>{let n=Je(e,`row-${t}`),r=_e(e,Ke);return q?.expandedRowRender||r.length>0?[n,...Ye(r,[t])]:[]}):[],{kind:`ref`}));if(Array.isArray(G)&&Array.isArray(xe)){let n=re(G),s=ne(G),O=new Map(s.map(e=>[e.key,e])),k=()=>{dt(ut.value+1)},j=s.some(e=>e.column.sortOrder!==void 0),M=H(j?s.filter(e=>e.column.sortOrder!==void 0).map(e=>({key:e.key,order:e.column.sortOrder,multiple:V(e.column)})):et.value),N=new Map(M.map(e=>[e.key,e])),B=s.reduce((e,t)=>{let n=t.column.filteredValue;return n===void 0?(e[t.key]=R(nt.value[t.key]),e):(e[t.key]=R(n),e)},{}),oe=e=>{let t={};return Object.keys(e).forEach(n=>{Array.isArray(e[n])&&e[n].length>0&&(t[n]=[...e[n]])}),t},se=oe(B),ue=e=>typeof e.sorter==`function`?e.sorter:ae(e.sorter)&&typeof e.sorter.compare==`function`?e.sorter.compare:(t,n)=>{let r=P(t,e.dataIndex),i=P(n,e.dataIndex);return r==null&&i==null?0:r==null?-1:i==null||r>i?1:r<i?-1:0},de=(e,t,n)=>{for(let r of H(n)){let n=O.get(r.key);if(!n?.column.sorter)continue;let i=ue(n.column),a=r.order===`ascend`?i(e,t):-i(e,t);if(a!==0)return a}return 0},fe=(e,t)=>s.every(n=>{let r=t[n.key]??[];if(!Array.isArray(r)||r.length===0)return!0;let i=n.column.filterCombine??`or`;if(n.column.onFilter)return i===`and`?r.every(t=>n.column.onFilter(t,e)):r.some(t=>n.column.onFilter(t,e));let a=P(e,n.column.dataIndex);return i===`and`?r.every(e=>e===a):r.includes(a)}),me=(e,t)=>{let n=r=>{let i=r.flatMap(t=>{let r=_e(t,Ke),i=r.length>0?n(r):[];return!fe(t,e)&&i.length===0?[]:r.length>0?[{...t,[Ke]:i}]:[t]});return H(t).length>0&&(i=i.slice().sort((e,n)=>de(e,n,t))),i};return n(xe)},U=q?.expandedRowKeys?[...q.expandedRowKeys]:[...Q.value],W=new Set(U),Se=(e,t=0,n=[],r=!1)=>e.flatMap((e,i)=>{let a=[...n,i],o=Je(e,`row-${a.join(`-`)}`),s=_e(e,Ke),c={key:o,record:e,indent:t,hasTreeChildren:s.length>0};return s.length>0&&(r||W.has(o))?[c,...Se(s,t+1,a,r)]:[c]}),De=Se(xe,0,[],!0),je=De.some(e=>e.hasTreeChildren),Pe=Se(me(B,M)),Ye=Pe.length,X=Z!=null,Xe=X?Math.max(1,Z.pageSize??gt.value):Math.max(Ye,1),Qe=X?Math.max(1,Math.ceil(Ye/Xe)):1,$=X?ce(Z.current??mt.value,Qe):1,vt=X?Pe.slice(($-1)*Xe,$*Xe):Pe,yt=vt.map(e=>e.record),bt=K?.selectedRowKeys?[...K.selectedRowKeys]:[...ft.value],xt=new Set(bt),St=K?.align??`center`,Ct=!!K,wt=!!q?.expandedRowRender,Tt=(wt||je)&&q?.showExpandColumn!==!1,Et=+!!Ct+ +!!Tt,Dt=s.length+Et,Ot=L(Y.get().wrapper,Be?.y===void 0?void 0:{maxHeight:le(Be.y)},He===void 0?void 0:{height:le(He)},Ve&&typeof Ve==`object`&&Ve.offsetScroll!==void 0?{top:le(Ve.offsetScroll)}:void 0),kt=I(Be?.x?`overflow-x-auto`:void 0,Be?.y||He!==void 0?`overflow-y-auto`:void 0,J.get().wrapper),At=L(Y.get().table)??{},jt=s.some(({column:e})=>!!e.ellipsis);Le?At.tableLayout=Le:(jt||Be?.x)&&(At.tableLayout=`fixed`),Be?.x===!0?(At.width=`max-content`,At.minWidth=`100%`):Be?.x!==void 0&&(At.width=le(Be.x),At.minWidth=`100%`),(()=>{let e=globalThis,t=`__rue_table_outside_close_${$e.value}`;if(e[t])return;let n=e=>{let t=e?.target;t&&(t.closest(`[data-rue-table-root="${$e.value}"]`)||(lt(null),k()))};e?.addEventListener&&e.addEventListener(`pointerdown`,n),e[t]=n})();let Mt=()=>{if(!Be?.scrollToFirstRowOnChange)return;let e=document.querySelector(`[data-rue-table-scroll="${$e.value}"]`);e&&(e.scrollTop=0)},Nt=H(M).map(e=>{let t=O.get(e.key);return t?{column:t.column,columnKey:e.key,order:e.order}:null}).filter(Boolean),Pt=(e,t)=>{let n=e.title;return typeof n==`function`?n({sortOrder:N.get(t)?.order??null,filteredValue:B[t]??[],sortColumns:Nt,filters:se}):n},Ft=e=>{let t=H(e).map(e=>{let t=O.get(e.key);return t?{column:t.column,order:e.order,columnKey:e.key,field:t.column.dataIndex,multiple:e.multiple}:null}).filter(Boolean);return t.length===0?{column:null,order:null}:t.length===1?t[0]:t},It=(e,t,n,r,i)=>{if(!Ee)return;let a=Se(me(r,i)),o=X?Math.max(1,Math.ceil(a.length/n)):1,s=X?ce(t,o):1,c=X?a.slice((s-1)*n,s*n).map(e=>e.record):a.map(e=>e.record);Ee(X?{current:s,pageSize:n}:!1,oe(r),Ft(i),{action:e,currentDataSource:c})},Lt=(e,t)=>{let n=O.get(e)?.column;if(!n?.sorter)return;let r=V(n),i=(()=>{if(r!=null){let n=M.filter(t=>{let n=O.get(t.key)?.column;return V(n??{})!=null&&t.key!==e}).map(e=>({...e}));return t&&n.push({key:e,order:t,multiple:r}),H(n)}return t?[{key:e,order:t,multiple:r}]:[]})();j||tt(i),k(),X&&Z.current===void 0&&ht(1),Mt(),It(`sort`,X?1:$,Xe,B,i)},Rt=(e,t,n)=>{let r=R(t),i={...B,[e]:r};s.find(t=>t.key===e)?.column?.filteredValue===void 0&&rt(i),at({...it.value,[e]:r}),k(),X&&Z.current===void 0&&ht(1),n&&lt(null),Mt(),It(`filter`,X?1:$,Xe,i,M)},zt=e=>{let t=ce(e,Qe);X&&Z.current===void 0&&ht(t),k(),X&&Z.onChange&&Z.onChange(t,Xe),Mt(),It(`paginate`,t,Xe,B,M)},Bt=(e=>e.filter(e=>K?.disabled?!1:!(K?.getCheckboxProps?K.getCheckboxProps(e.record):{})?.disabled))(vt).map(e=>e.key),Vt=Bt.length>0&&Bt.every(e=>xt.has(e)),Ht=Bt.some(e=>xt.has(e))&&!Vt,Ut=(e,t,n,r,i)=>{K?.selectedRowKeys===void 0&&pt([...e]),k();let a=De.filter(t=>e.includes(t.key)).map(e=>e.record);n!==void 0&&K?.onSelect&&typeof r==`boolean`&&K.onSelect(n,r,a,i),K?.onChange&&K.onChange([...e],a,t)},Wt=e=>{if(!K||K.type===`radio`)return;let t=new Set(Bt),n=K.selectedRowKeys??ft.value,r=new Set(n);t.forEach(t=>{e?r.add(t):r.delete(t)});let i=Array.from(r);if(Ut(i,{type:`checkbox`}),K.onSelectAll){let t=De.filter(e=>i.includes(e.key)).map(e=>e.record);K.onSelectAll(e,t)}},Gt=(e,t)=>{let n=!!q?.expandedRowRender&&(q?.rowExpandable?q.rowExpandable(e.record):!0),r=e.hasTreeChildren||n;return{key:e.key,enabled:r,expanded:W.has(e.key),hasExpandedRowRender:n,indent:e.indent,rowIndex:t}},Kt=(e,t)=>{let n=Gt(e,t);if(!n.enabled)return;let r=new Set(U);n.expanded?r.delete(n.key):r.add(n.key);let i=Array.from(r);q?.expandedRowKeys===void 0&&_t(i),k(),q?.onExpand&&q.onExpand(!n.expanded,e.record),q?.onExpandedRowsChange&&q.onExpandedRowsChange(i)},qt=e=>[...e.sortDirections??Re??[`ascend`,`descend`],null],Jt=(e,t)=>{let n=qt(t),r=N.get(e)?.order??null;return n[(n.findIndex(e=>e===r)+1+n.length)%n.length]},Yt=(e,t)=>{let n=e.filterDropdownProps?.open??e.filterDropdownOpen;return n===void 0?ct.value===t:!!n},Xt=(e,t)=>(t?Yt(t,e):ct.value===e)||it.value[e]!==void 0?R(it.value[e]??B[e]):R(B[e]),Zt=(e,t)=>{at({...it.value,[e]:R(t)}),k()},Qt=(e,t,n)=>{let r=Yt(t,e);n&&(it.value={...it.value,[e]:R(B[e])}),!n&&t.filterDropdownProps?.open===void 0&&t.filterDropdownOpen===void 0&&lt(n?e:ct.value===e?null:ct.value),!n&&r!==n&&k(),t.filterDropdownProps?.onOpenChange?.(n),t.onFilterDropdownOpenChange?.(n)},$t=(e,t)=>{Qt(e,t,!1)},en=(e,t,n)=>{Rt(e,Xt(e,t),n?.closeDropdown??!0)},tn=(e,t,n)=>{let r=t.filterResetToDefaultFilteredValue?R(t.defaultFilteredValue):[];if(Zt(e,r),n?.confirm){Rt(e,r,n.closeDropdown??!0);return}n?.closeDropdown&&$t(e,t)},nn=(e,t)=>typeof e.filterIcon==`function`?e.filterIcon(t):e.filterIcon===void 0?`☰`:e.filterIcon,rn=(e,n)=>typeof e.sortIcon==`function`?e.sortIcon({sortOrder:n}):m(e=>{let r=x(`span`,e);t(()=>{S(r,I(`inline-flex flex-col leading-none`,n?`text-base-content`:`opacity-60`))});let i=x(`span`,r);o(r,i),t(()=>{S(i,I(n===`ascend`?`text-base-content`:`opacity-40`))}),o(i,g(`▲`));let a=x(`span`,r);return o(r,a),t(()=>{S(a,I(`-mt-0.5`,n===`descend`?`text-base-content`:`opacity-40`))}),o(a,g(`▼`)),r}),an=(e,t,n)=>t?e.map(e=>{let r=typeof n.filterSearch==`function`?n.filterSearch(t,e):String(e.text).toLowerCase().includes(t.toLowerCase()),i=Array.isArray(e.children)?an(e.children,t,n):void 0;return r||i&&i.length>0?i&&i.length>0?{...e,children:i}:e:null}).filter(Boolean):e,on=(e,t,n,r,i=0)=>e.flatMap(e=>{let a=r.includes(e.value),o=Array.isArray(e.children)&&e.children.length>0?on(e.children,t,n,r,i+1):[],s=E(`label`,{className:`flex items-center gap-2 text-sm`,style:i>0?{paddingLeft:`${i*12}px`}:void 0,children:[D(`input`,{type:t.filterMultiple===!1?`radio`:`checkbox`,name:`rue-table-filter-${$e.value}-${n}`,className:t.filterMultiple===!1?`radio radio-xs`:`checkbox checkbox-xs`,checked:a,onChange:i=>{let a=i.target,o;if(t.filterMultiple===!1)o=a.checked?[e.value]:[];else{let t=new Set(r);a.checked?t.add(e.value):t.delete(e.value),o=Array.from(t)}Zt(n,o),t.filterOnClose===!1&&Rt(n,o,!1)}}),D(`span`,{children:e.text})]},`${String(e.value)}-${i}`);return o.length>0?[s,...o]:[s]}),sn=(n,a,s,c,d)=>typeof a.filterDropdown==`function`?a.filterDropdown({setSelectedKeys:e=>Zt(n,e),selectedKeys:c,confirm:e=>en(n,a,e),clearFilters:e=>tn(n,a,e),filters:a.filters,close:()=>$t(n,a),visible:s}):a.filterDropdown===void 0?m(s=>{let f=x(`div`,s);S(f,`w-56 rounded-box border border-base-content/10 bg-base-100 p-3 shadow-xl`);let h=e(`rue:slot:anchor`);o(f,h),t(()=>{let e=a.filterSearch?m(()=>{let e=u(),r=x(`input`,e);return o(e,r),l(r,`type`,`text`),S(r,`input input-bordered input-xs mb-2 w-full`),l(r,`placeholder`,`搜索筛选项`),t(()=>{p(r,ot.value[n]??``)}),i(r,`input`,e=>{st({...ot.value,[n]:e.target.value}),k()}),e}):``;r(()=>_(e,f,h))});let v=x(`div`,f);o(f,v),S(v,`max-h-56 space-y-2 overflow-auto`);let y=e(`rue:slot:anchor`);o(v,y),t(()=>{let e=on(d,a,n,c);r(()=>_(e,v,y))}),o(v,g(` `));let b=e(`rue:slot:anchor`);o(v,b),t(()=>{let e=d.length===0?m(()=>{let e=u(),t=x(`div`,e);return o(e,t),S(t,`text-sm opacity-60`),o(t,g(`暂无匹配项`)),e}):``;r(()=>_(e,v,b))});let C=e(`rue:slot:anchor`);return o(f,C),t(()=>{let s=a.filterOnClose===!1?``:m(()=>{let s=u(),c=x(`div`,s);o(s,c),S(c,`mt-3 flex justify-end gap-2`);let l=x(`button`,c);o(c,l),S(l,`btn btn-ghost btn-xs`),i(l,`click`,()=>tn(n,a,{confirm:!0}));let d=e(`rue:slot:anchor`);o(l,d),t(()=>{let e=We.filterReset;r(()=>_(e,l,d))});let f=x(`button`,c);o(c,f),S(f,`btn btn-primary btn-xs`),i(f,`click`,()=>en(n,a));let p=e(`rue:slot:anchor`);return o(f,p),t(()=>{let e=We.filterConfirm;r(()=>_(e,f,p))}),s});r(()=>_(s,f,C))}),f}):a.filterDropdown,cn=(e,t)=>{let n=e.showSorterTooltip??ze;if(n===!1)return;if(typeof n==`object`&&n?.title!==void 0)return n.title;let r=Jt(t,e);return r===`ascend`?We.triggerAsc:r===`descend`?We.triggerDesc:We.cancelSort},ln=(n,s)=>{let{titleNode:c,filtered:d,sortOrder:f,draftValues:p,filterSearchValue:h,visible:v,menuItems:y,sorterTooltipTitle:T,_dropdownOpen:E,_dropdownOnOpenChange:D,_dropdownChildren:O,_dropdownContent:k,_dropdownOverlay:j,_dropdownItems:M,_dropdownMenu:P,_dropdownPopupRender:F,dropdownProps:L}=w(`useSetup:0:0:dup1`,()=>a(()=>{let e=w(`computed:1:13`,()=>C(()=>Pt(s,n))),t=w(`computed:1:14`,()=>C(()=>s.filtered??(B[n]??[]).length>0)),r=N.get(n)?.order??null,i=w(`computed:1:15`,()=>C(()=>Xt(n,s))),a=ot.value[n]??``,o=w(`computed:1:16`,()=>C(()=>Yt(s,n))),c=w(`computed:1:17`,()=>C(()=>an(s.filters??[],a,s))),l=w(`computed:1:18`,()=>C(()=>cn(s,n))),{open:u,onOpenChange:d,children:f,content:p,overlay:m,items:h,menu:g,popupRender:_,...v}=s.filterDropdownProps??{};return{titleNode:e,filtered:t,sortOrder:r,draftValues:i,filterSearchValue:a,visible:o,menuItems:c,sorterTooltipTitle:l,_dropdownOpen:u,_dropdownOnOpenChange:d,_dropdownChildren:f,_dropdownContent:p,_dropdownOverlay:m,_dropdownItems:h,_dropdownMenu:g,_dropdownPopupRender:_,dropdownProps:v}}));return m(a=>{let h=x(`div`,a);S(h,`relative flex items-center gap-2`);let C=x(`span`,h);o(h,C);let w=e(`rue:slot:anchor`);o(C,w),t(()=>{let e=c.get();r(()=>_(e,C,w))});let E=e(`rue:slot:anchor`);o(h,E),t(()=>{let a=s.sorter?m(()=>{let a=u(),c=x(`button`,a);o(a,c),l(c,`type`,`button`),t(()=>{l(c,`aria-label`,String(`sort-${n}`))}),t(()=>{l(c,`title`,String(T.get()))}),S(c,`btn btn-ghost btn-xs h-auto min-h-0 px-1 py-0.5`),i(c,`click`,e=>{e.stopPropagation(),Lt(n,Jt(n,s))});let d=e(`rue:slot:anchor`);return o(c,d),t(()=>{let e=rn(s,f);r(()=>_(e,c,d))}),a}):``;r(()=>_(a,h,E))}),o(h,g(` `));let D=e(`rue:slot:anchor`);return o(h,D),t(()=>{let i=Array.isArray(s.filters)&&s.filters.length>0||s.filterDropdown!==void 0?m(()=>{let i=u(),a=e(`rue:component:anchor`);o(i,a);let c=m(()=>{let i=u(),a=e(`rue:component:anchor`);o(i,a),t(()=>{let e=b(A.Trigger,{as:`button`,type:`button`,"aria-label":`filter-${n}`,className:I(`btn btn-ghost btn-xs h-auto min-h-0 px-1 py-0.5 select-none`,d.get()?`text-base-content`:`opacity-40`),children:nn(s,d.get())});r(()=>_(e,i,a))});let c=e(`rue:component:anchor`);return o(i,c),_(b(A.Content,{className:`dropdown-content z-50 mt-2 p-0`,onClick:e=>e.stopPropagation(),children:sn(n,s,v.get(),p.get(),y.get())}),i,c),i});return t(()=>{let e=b(A,{trigger:`click`,open:v.get(),closeOnClick:!1,align:`start`,...L,onOpenChange:e=>Qt(n,s,e),children:c});r(()=>_(e,i,a))}),i}):``;r(()=>_(i,h,D))}),h})},un=(n,i)=>{let{cellProps:s,children:u,isLeaf:d,leaf:f,key:p,colSpan:g,rowSpan:v}=w(`useSetup:0:0:dup2`,()=>a(()=>{let e=w(`computed:1:19`,()=>C(()=>n.column.onHeaderCell&&n.column.onHeaderCell(n.column,n.index)||{})),t=e,r=w(`computed:1:20`,()=>C(()=>z(n.column))),i=r,a=w(`computed:1:21`,()=>C(()=>i.get().length===0)),o=a,s=w(`computed:1:22`,()=>C(()=>o.get()?O.get(n.key)??null:null)),c=s;return{cellProps:e,children:r,isLeaf:a,leaf:s,key:w(`computed:1:23`,()=>C(()=>c.get()?.key??n.key)),colSpan:w(`computed:1:24`,()=>C(()=>t.get().colSpan??n.colSpan)),rowSpan:w(`computed:1:25`,()=>C(()=>t.get().rowSpan??n.rowSpan))}}));if(g.get()===0||v.get()===0)return null;let{className:y,style:b,...T}=s.get(),E=I(J.get().headerCell,F(n.column.align),n.column.className,y),D=L(Y.get().headerCell,n.column.width||n.column.minWidth?{...n.column.width?{width:n.column.width}:{},...n.column.minWidth?{minWidth:n.column.minWidth}:{}}:void 0,b),k=f.get()?ln(p.get(),n.column):Pt(n.column,n.key);return m(a=>{let s=x(`th`,a);t(()=>{l(s,`key`,String(`${i}-${n.key}`))}),t(()=>{l(s,`colSpan`,String(g.get()))}),t(()=>{l(s,`rowSpan`,String(v.get()))}),t(()=>{S(s,E)}),t(()=>{h(s,D)}),t(()=>{c(s,T)});let u=e(`rue:slot:anchor`);return o(s,u),t(()=>{let e=k;r(()=>_(e,s,u))}),s})},dn=(n,i)=>{if(!K)return null;let a=K.getCheckboxProps?{...K.getCheckboxProps(n.record)}:{};K.disabled&&(a.disabled=!0);let s=xt.has(n.key),c=K.type===`radio`?`radio`:`checkbox`,l=D(`label`,{onClick:e=>e.stopPropagation(),children:D(`input`,{type:K.type===`radio`?`radio`:`checkbox`,className:c,checked:s,onChange:e=>{let t=e.target;if(K.type===`radio`){Ut([n.key],{type:`radio`},n.record,!0,e);return}let r=K.selectedRowKeys??ft.value,i=new Set(r);t.checked?i.add(n.key):i.delete(n.key),Ut(Array.from(i),{type:`checkbox`},n.record,t.checked,e)},...a})}),d=K.renderCell?K.renderCell(s,n.record,i,l):l,f=ee&&K.fixed?`th`:`td`;return m(n=>{let i=u(),a=e(`rue:component:anchor`);return o(i,a),t(()=>{let e=b(f,{className:I(J.get().cell,F(St)),style:L(Y.get().cell,K.columnWidth?{width:K.columnWidth}:void 0),children:d});r(()=>_(e,i,a))}),i})},fn=(n,a,s)=>s.enabled?q?.expandIcon?q.expandIcon({expanded:s.expanded,expandable:s.enabled,record:n.record,onExpand:(e,t)=>{t?.stopPropagation?.(),Kt(n,a)}}):m(c=>{let l=x(`button`,c);S(l,`btn btn-ghost btn-xs`),i(l,`click`,e=>{e.stopPropagation(),Kt(n,a)});let u=e(`rue:slot:anchor`);return o(l,u),t(()=>{let e=s.expanded?`-`:`+`;r(()=>_(e,l,u))}),l}):null,pn={total:Ye,page:$,pageSize:Xe},mn=yt.slice();mn.total=Ye;let hn=typeof ke==`function`?ke(mn,pn):null,gn=Me?D(ve,{render:Me,data:yt}):null,_n=Ne?D(ve,{render:Ne,data:yt}):null,vn=he(Z),yn=X&&!(Z?.hideOnSinglePage&&Qe<=1)&&!(vn.length===1&&vn[0]===`none`),bn=n=>m(r=>{let a=x(`div`,r);t(()=>{l(a,`key`,String(`pager-${n}`))}),t(()=>{l(a,`data-rue-table-pager`,String(n))}),t(()=>{S(a,I(`flex items-center gap-2 p-2`,ge(n),J.get().pager))}),t(()=>{let e=Y.get().pager;h(a,e)});let s=x(`button`,a);o(a,s),S(s,`btn btn-ghost btn-xs`),t(()=>{d(s,$<=1)}),i(s,`click`,()=>zt($-1)),o(s,g(`Prev`));let c=e(`rue:list:start`),p=e(`rue:list:end`);o(a,c),o(a,p);let y=new Map;t(()=>{y=T({items:Array.from({length:Qe})||[],getKey:(e,t)=>`page-${n}-${t+1}`,elements:y,parent:c.parentNode,before:p,singleRoot:!0,start:c,renderItem:(e,r,a,s,c)=>{_(m(()=>{let e=u(),r=x(`button`,e);o(e,r),t(()=>{l(r,`key`,String(`page-${n}-${c+1}`))}),t(()=>{S(r,`btn btn-ghost btn-xs${$===c+1?` btn-active`:``}`)}),i(r,`click`,()=>zt(c+1));let a=v(r);return o(r,a),t(()=>{f(a,c+1)}),e}),r,a)}})});let b=x(`button`,a);return o(a,b),S(b,`btn btn-ghost btn-xs`),t(()=>{d(b,$>=Qe)}),i(b,`click`,()=>zt($+1)),o(b,g(`Next`)),a}),xn=K?.getTitleCheckboxProps?.()??{},Sn=K?.type===`radio`||K?.hideSelectAll?null:D(`label`,{children:D(`input`,{type:`checkbox`,className:`checkbox`,checked:Vt,"aria-checked":Ht?`mixed`:Vt?`true`:`false`,disabled:K?.disabled||Bt.length===0,onChange:e=>Wt(e.target.checked),...xn})}),Cn=K?.columnTitle===void 0?Sn:typeof K.columnTitle==`function`?K.columnTitle(Sn):K.columnTitle,wn=e=>{Ue&&Ue(e)};return m(a=>{let d=x(`div`,a);t(()=>{l(d,`data-rue-table-root`,String($e.value))}),t(()=>{l(d,`data-rue-table-scroll`,String($e.value))}),t(()=>{l(d,`data-rue-table-version`,String(ut.value))}),t(()=>{S(d,I(`relative`,te?`rounded-box border border-base-300 bg-base-100`:void 0,J.get().root,kt))}),t(()=>{h(d,L(Y.get().root,Ot))}),i(d,`scroll`,wn);let p=e(`rue:slot:anchor`);o(d,p),t(()=>{let e=yn?vn.filter(e=>e.startsWith(`top`)).map(bn):``;r(()=>_(e,d,p))}),o(d,g(` `));let C=e(`rue:slot:anchor`);o(d,C),t(()=>{let n=gn?m(()=>{let n=u(),i=x(`div`,n);o(n,i),t(()=>{S(i,I(`p-2`,J.get().title))}),t(()=>{let e=Y.get().title;h(i,e)});let a=e(`rue:slot:anchor`);return o(i,a),t(()=>{let e=gn;r(()=>_(e,i,a))}),n}):``;r(()=>_(n,d,C))});let w=x(`table`,d);o(d,w),t(()=>{S(w,Ze)}),t(()=>{h(w,At)}),t(()=>{l(w,`data-rue-table-id`,String($e.value))});let O=e(`rue:slot:anchor`);o(w,O),t(()=>{let i=Ce?m(()=>{let i=u(),a=x(`thead`,i);o(i,a),t(()=>{S(a,J.get().thead)}),t(()=>{let e=Y.get().thead;h(a,e)});let s=e(`rue:list:start`),d=e(`rue:list:end`);o(a,s),o(a,d);let p=new Map;return t(()=>{p=T({items:n||[],getKey:(e,t)=>`header-row-${t}`,elements:p,parent:a,before:d,singleRoot:!0,start:s,renderItem:(i,a,s,d,p)=>{_(m(()=>{let a=u(),{className:s,style:d,...b}=Te&&Te(i.map(e=>e.column),p)||{},C=x(`tr`,a);o(a,C),t(()=>{l(C,`key`,String(`header-row-${p}`))}),t(()=>{S(C,I(J.get().headerRow,s))}),t(()=>{h(C,L(Y.get().headerRow,d))}),t(()=>{c(C,b)});let w=e(`rue:slot:anchor`);o(C,w),t(()=>{let e=p===0&&Tt?m(()=>{let e=u(),r=x(`th`,e);o(e,r),t(()=>{l(r,`rowSpan`,String(n.length))}),t(()=>{S(r,I(J.get().headerCell,F(`center`)))}),t(()=>{h(r,L(Y.get().headerCell,q?.columnWidth?{width:q.columnWidth}:void 0))});let i=v(r);return o(r,i),t(()=>{f(i,q?.columnTitle)}),e}):``;r(()=>_(e,C,w))}),o(C,g(` `));let E=e(`rue:slot:anchor`);o(C,E),t(()=>{let i=p===0&&Ct?m(()=>{let i=u(),a=x(`th`,i);o(i,a),t(()=>{l(a,`rowSpan`,String(n.length))}),t(()=>{S(a,I(J.get().headerCell,F(St)))}),t(()=>{h(a,L(Y.get().headerCell,K?.columnWidth?{width:K.columnWidth}:void 0))});let s=e(`rue:slot:anchor`);return o(a,s),t(()=>{let e=Cn;r(()=>_(e,a,s))}),i}):``;r(()=>_(i,C,E))}),o(C,g(` `));let D=e(`rue:list:start`),O=e(`rue:list:end`);o(C,D),o(C,O);let k=new Map;return t(()=>{k=T({items:i||[],getKey:(e,t)=>t,elements:k,parent:C,before:O,start:D,renderItem:(e,t,n,r,i)=>{y(un(e,p),t,n,r)}})}),a}),a,s)}})}),i}):``;r(()=>_(i,w,O))});let k=x(`tbody`,w);o(w,k),t(()=>{l(k,`key`,String(`body-${ut.value}`))}),t(()=>{S(k,J.get().tbody)}),t(()=>{let e=Y.get().tbody;h(k,e)});let A=e(`rue:list:start`),j=e(`rue:list:end`);o(k,A),o(k,j);let M=new Map;t(()=>{M=T({items:vt||[],getKey:(e,t)=>`row-group-${String(e.key)}`,elements:M,parent:k,before:j,start:A,renderItem:(n,a,d,f,p)=>{let v=Gt(n,p),{className:C,style:w,onClick:O,...k}=we&&we(n.record,p)||{},A=typeof Oe==`function`?Oe(n.record,p):``,j=Fe?Ie||`hover:bg-base-200`:``,M=e=>{O&&O(e),!(!q?.expandRowByClick||!v.enabled)&&((e?.target)?.closest(`button, input, a, label`)||Kt(n,p))},N=wt&&v.hasExpandedRowRender&&v.expanded,R=N?typeof q?.expandedRowClassName==`function`?q.expandedRowClassName(n.record,p,n.indent):q?.expandedRowClassName:void 0;y(m(()=>{let a=u(),d=x(`tr`,a);o(a,d),t(()=>{l(d,`key`,String(`row-${String(n.key)}`))}),t(()=>{c(d,k)}),i(d,`click`,M),t(()=>{S(d,I(J.get().bodyRow,C,A,j))}),t(()=>{h(d,L(Y.get().bodyRow,w))});let f=e(`rue:slot:anchor`);o(d,f),t(()=>{let i=Tt?m(()=>{let i=u(),a=x(`td`,i);o(i,a),t(()=>{S(a,I(J.get().cell,F(`center`)))}),t(()=>{h(a,L(Y.get().cell,q?.columnWidth?{width:q.columnWidth}:void 0,n.indent>0?{paddingLeft:`${n.indent*qe}px`}:void 0))});let s=e(`rue:slot:anchor`);return o(a,s),t(()=>{let e=fn(n,p,v);r(()=>_(e,a,s))}),i}):``;r(()=>_(i,d,f))}),o(d,g(` `));let O=e(`rue:slot:anchor`);o(d,O),t(()=>{let e=Ct?dn(n,p):``;r(()=>_(e,d,O))}),o(d,g(` `));let z=e(`rue:list:start`),te=e(`rue:list:end`);o(d,z),o(d,te);let B=new Map;t(()=>{B=T({items:s||[],getKey:(e,t)=>`cell-${String(n.key)}-${e.key}-${t}`,elements:B,parent:d,before:te,start:z,renderItem:(e,t,r,i,a)=>{y((()=>{let t=P(n.record,e.column.dataIndex),r=e.column.render?e.column.render(t,n.record,p):t,i=e.column.onCell&&e.column.onCell(n.record,p)||{},{className:o,style:s,...c}=i,l=i.colSpan??1,u=i.rowSpan??1;if(l===0||u===0)return null;let d=!Tt&&a===0,f=e.column.rowScope||ee&&ie(e.column)?`th`:`td`,m=I(J.get().cell,F(e.column.align),e.column.className,e.column.ellipsis?`truncate`:void 0,o),h=L(Y.get().cell,e.column.width||e.column.minWidth?{...e.column.width?{width:e.column.width}:{},...e.column.minWidth?{minWidth:e.column.minWidth}:{}}:void 0,d&&n.indent>0?{paddingLeft:`${n.indent*qe}px`}:void 0,s),g=e.column.ellipsis&&pe(e.column.ellipsis)&&be(r)?String(r):void 0,_=d?E(`div`,{className:`flex items-center gap-2`,children:[fn(n,p,v),D(`span`,{className:e.column.ellipsis?`truncate`:void 0,children:r})]}):r;return D(f,{className:m,style:h,title:g,colSpan:l,rowSpan:u,scope:e.column.rowScope,"data-rue-table-indent":d&&n.indent>0?String(n.indent):void 0,...c,children:_},`cell-${String(n.key)}-${e.key}-${a}`)})(),t,r,i)}})});let ne=e(`rue:slot:anchor`);return o(a,ne),t(()=>{let i=N?m(()=>{let i=u(),a=x(`tr`,i);o(i,a),t(()=>{l(a,`key`,String(`expanded-${String(n.key)}`))}),t(()=>{S(a,R)});let s=x(`td`,a);o(a,s),t(()=>{l(s,`colSpan`,String(Dt))});let c=e(`rue:component:anchor`);return o(s,c),t(()=>{let e=b(ye,{render:q?.expandedRowRender,record:n.record,index:p,indent:n.indent,expanded:!0});r(()=>_(e,s,c))}),i}):``;r(()=>_(i,a,ne))}),a}),a,d,f)}})}),o(k,g(` `));let N=e(`rue:slot:anchor`);o(k,N),t(()=>{let n=vt.length===0?m(()=>{let n=u(),i=x(`tr`,n);o(n,i);let a=x(`td`,i);o(i,a),t(()=>{l(a,`colSpan`,String(Dt))}),t(()=>{S(a,I(J.get().empty,F(`center`)))}),t(()=>{let e=Y.get().empty;h(a,e)});let s=e(`rue:slot:anchor`);return o(a,s),t(()=>{let e=Ae===void 0?We.emptyText:Ae;r(()=>_(e,a,s))}),n}):``;r(()=>_(n,k,N))});let R=e(`rue:slot:anchor`);o(w,R),t(()=>{let n=hn||yn&&vn.some(e=>e.startsWith(`bottom`))?m(()=>{let n=u(),i=x(`tfoot`,n);o(n,i),t(()=>{S(i,J.get().tfoot)}),t(()=>{let e=Y.get().tfoot;h(i,e)});let a=e(`rue:slot:anchor`);o(i,a),t(()=>{let n=hn?m(()=>{let n=u(),i=x(`tr`,n);o(n,i),t(()=>{S(i,J.get().summary)}),t(()=>{let e=Y.get().summary;h(i,e)});let a=x(`td`,i);o(i,a),t(()=>{l(a,`colSpan`,String(Dt))});let s=e(`rue:slot:anchor`);return o(a,s),t(()=>{let e=hn;r(()=>_(e,a,s))}),n}):``;r(()=>_(n,i,a))}),o(i,g(` `));let s=e(`rue:slot:anchor`);return o(i,s),t(()=>{let n=yn?m(()=>{let n=u(),i=e(`rue:list:start`),a=e(`rue:list:end`);o(n,i),o(n,a);let s=new Map;return t(()=>{s=T({items:vn.filter(e=>e.startsWith(`bottom`))||[],getKey:(e,t)=>`pager-row-${e}`,elements:s,parent:i.parentNode,before:a,singleRoot:!0,trackIndex:!1,start:i,renderItem:(n,i,a,s,c)=>{_(m(()=>{let i=u(),a=x(`tr`,i);o(i,a),t(()=>{l(a,`key`,String(`pager-row-${n}`))});let s=x(`td`,a);o(a,s),t(()=>{l(s,`colSpan`,String(Dt))});let c=e(`rue:slot:anchor`);return o(s,c),t(()=>{let e=bn(n);r(()=>_(e,s,c))}),i}),i,a)}})}),n}):``;r(()=>_(n,i,s))}),n}):``;r(()=>_(n,w,R))});let z=e(`rue:slot:anchor`);o(d,z),t(()=>{let n=_n?m(()=>{let n=u(),i=x(`div`,n);o(n,i),t(()=>{S(i,I(`p-2`,J.get().footer))}),t(()=>{let e=Y.get().footer;h(i,e)});let a=e(`rue:slot:anchor`);return o(i,a),t(()=>{let e=_n;r(()=>_(e,i,a))}),n}):``;r(()=>_(n,d,z))}),o(d,g(` `));let B=e(`rue:slot:anchor`);return o(d,B),t(()=>{let n=Ge.spinning?m(()=>{let n=u(),i=x(`div`,n);o(n,i),t(()=>{S(i,I(`absolute inset-0 z-20 flex flex-col items-center justify-center gap-2 rounded-box bg-base-100/70`,J.get().loading))}),t(()=>{let e=Y.get().loading;h(i,e)});let a=x(`span`,i);o(i,a),S(a,`loading loading-spinner loading-md`);let s=e(`rue:slot:anchor`);return o(i,s),t(()=>{let n=Ge.tip?m(()=>{let n=u(),i=x(`div`,n);o(n,i),S(i,`text-sm opacity-70`);let a=e(`rue:slot:anchor`);return o(i,a),t(()=>{let e=Ge.tip;r(()=>_(e,i,a))}),n}):``;r(()=>_(n,i,s))}),n}):``;r(()=>_(n,d,B))}),d})}return m(e=>{let n=x(`table`,e);return t(()=>{S(n,Ze)}),t(()=>{let e=Y.get().table;h(n,e)}),n})},{Head:n=>m(i=>{let a=x(`thead`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a}),Body:n=>m(i=>{let a=x(`tbody`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a}),Foot:n=>m(i=>{let a=x(`tfoot`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a}),TR:n=>m(i=>{let a=x(`tr`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a}),TH:n=>m(i=>{let a=x(`th`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a}),TD:n=>m(i=>{let a=x(`td`,i);t(()=>{S(a,n.className||void 0)});let s=e(`rue:children:anchor`);return o(a,s),t(()=>{let e=n.children;r(()=>_(e,a,s))}),a})}),W=n=>m(i=>{let a=x(`div`,i);S(a,`component-preview not-prose text-base-content my-6 lg:my-12`);let s=x(`div`,a);o(a,s),S(s,`flex flex-wrap items-start justify-between gap-3`);let c=x(`div`,s);o(s,c);let l=x(`h2`,c);o(c,l),S(l,`component-preview-title mt-2 mb-1 text-lg font-semibold`),o(l,g(`# `));let d=e(`rue:slot:anchor`);o(l,d),t(()=>{let e=n.title;r(()=>_(e,l,d))});let f=e(`rue:slot:anchor`);o(c,f),t(()=>{let i=n.summary?m(()=>{let i=u(),a=x(`p`,i);o(i,a),S(a,`m-0 text-sm opacity-70`);let s=e(`rue:slot:anchor`);return o(a,s),t(()=>{let e=n.summary;r(()=>_(e,a,s))}),i}):``;r(()=>_(i,c,f))});let p=e(`rue:component:anchor`);o(a,p),t(()=>{let e=b(k,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:n.tab.value,onChange:e=>n.tab.value=e,className:`mb-3 mt-4`});r(()=>_(e,a,p))});let h=e(`rue:slot:anchor`);return o(a,h),t(()=>{let i=n.tab.value===`preview`?n.preview():m(()=>{let i=u(),a=e(`rue:component:anchor`);return o(i,a),t(()=>{let e=b(O,{className:`mt-2`,lang:`tsx`,code:n.code});r(()=>_(e,i,a))}),i});r(()=>_(i,a,h))}),a}),xe=n=>m(i=>{let a=x(`div`,i);S(a,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let s=x(`table`,a);o(a,s),S(s,`table table-zebra`);let c=x(`thead`,s);o(s,c);let d=x(`tr`,c);o(c,d);let f=x(`th`,d);o(d,f),o(f,g(`属性`));let p=x(`th`,d);o(d,p),o(p,g(`说明`));let h=x(`th`,d);o(d,h),o(h,g(`类型`));let v=x(`th`,d);o(d,v),o(v,g(`默认值`));let y=x(`tbody`,s);o(s,y);let b=e(`rue:list:start`),C=e(`rue:list:end`);o(y,b),o(y,C);let w=new Map;return t(()=>{w=T({items:n.rows||[],getKey:(e,t)=>e.prop,elements:w,parent:y,before:C,singleRoot:!0,trackIndex:!1,start:b,renderItem:(n,i,a,s,c)=>{_(m(()=>{let i=u(),a=x(`tr`,i);o(i,a),t(()=>{l(a,`key`,String(n.prop))});let s=x(`td`,a);o(a,s);let c=x(`code`,s);o(s,c);let d=e(`rue:slot:anchor`);o(c,d),t(()=>{let e=n.prop;r(()=>_(e,c,d))});let f=x(`td`,a);o(a,f);let p=e(`rue:slot:anchor`);o(f,p),t(()=>{let e=n.description;r(()=>_(e,f,p))});let m=x(`td`,a);o(a,m);let h=x(`code`,m);o(m,h);let g=e(`rue:slot:anchor`);o(h,g),t(()=>{let e=n.type;r(()=>_(e,h,g))});let v=x(`td`,a);o(a,v);let y=x(`code`,v);o(v,y);let b=e(`rue:slot:anchor`);return o(y,b),t(()=>{let e=n.defaultValue;r(()=>_(e,y,b))}),i}),i,a)}})}),a}),G=[{key:`1`,name:`林青`,age:28,city:`杭州`,role:`设计工程师`,team:`体验平台`,status:`active`,score:92,salary:26e3,visits:148,address:`云谷路 88 号`},{key:`2`,name:`周宁`,age:34,city:`上海`,role:`前端工程师`,team:`设计系统`,status:`active`,score:88,salary:31e3,visits:203,address:`武康路 12 号`},{key:`3`,name:`刘溪`,age:41,city:`深圳`,role:`产品经理`,team:`商业化`,status:`leave`,score:79,salary:35e3,visits:167,address:`深南大道 100 号`},{key:`4`,name:`陈默`,age:26,city:`成都`,role:`测试开发`,team:`质量平台`,status:`trial`,score:95,salary:22e3,visits:98,address:`天府三街 18 号`},{key:`5`,name:`顾安`,age:31,city:`北京`,role:`运营分析`,team:`增长`,status:`active`,score:83,salary:24500,visits:132,address:`望京 SOHO`}],Se=[{id:`1`,item:`套餐 A`,owner:`前台`,channel:`门店`,stock:42,price:`199`},{id:`2`,item:`套餐 B`,owner:`门店`,channel:`小程序`,stock:36,price:`299`},{id:`3`,item:`套餐 C`,owner:`线上`,channel:`官网`,stock:28,price:`399`},{id:`4`,item:`体验卡`,owner:`运营`,channel:`社群`,stock:86,price:`99`},{id:`5`,item:`企业版`,owner:`销售`,channel:`直销`,stock:12,price:`1299`},{id:`6`,item:`家庭版`,owner:`门店`,channel:`门店`,stock:25,price:`699`},{id:`7`,item:`增值包`,owner:`客服`,channel:`续费`,stock:57,price:`159`},{id:`8`,item:`旗舰包`,owner:`线上`,channel:`官网`,stock:18,price:`999`},{id:`9`,item:`季度包`,owner:`增长`,channel:`投放`,stock:64,price:`499`},{id:`10`,item:`年度包`,owner:`销售`,channel:`直销`,stock:21,price:`1599`}],Ce=[{key:`1`,name:`林青`,role:`设计工程师`,team:`体验平台`,city:`杭州`,score:92,visits:148,salary:26e3,address:`云谷路 88 号`},{key:`2`,name:`周宁`,role:`前端工程师`,team:`设计系统`,city:`上海`,score:88,visits:216,salary:31e3,address:`武康路 12 号`},{key:`3`,name:`刘溪`,role:`产品经理`,team:`商业化`,city:`深圳`,score:76,visits:174,salary:35e3,address:`深南大道 100 号`},{key:`4`,name:`陈默`,role:`测试开发`,team:`质量平台`,city:`成都`,score:95,visits:98,salary:22e3,address:`天府三街 18 号`},{key:`5`,name:`顾安`,role:`运营分析`,team:`增长`,city:`北京`,score:83,visits:132,salary:24500,address:`望京 SOHO`},{key:`6`,name:`许嘉`,role:`数据分析`,team:`策略`,city:`南京`,score:91,visits:121,salary:27e3,address:`软件大道 66 号`},{key:`7`,name:`何澈`,role:`客户成功`,team:`企业服务`,city:`苏州`,score:87,visits:154,salary:24e3,address:`金鸡湖大道 9 号`}],we=[{key:`1`,name:`John Brown`,age:32,address:`New York No. 1 Lake Park`},{key:`2`,name:`Jim Green`,age:42,address:`London No. 1 Lake Park`},{key:`3`,name:`Joe Black`,age:32,address:`Sydney No. 1 Lake Park`},{key:`4`,name:`Jim Red`,age:32,address:`London No. 2 Lake Park`}],Te=[{key:`name`,label:`姓名`},{key:`age`,label:`年龄`},{key:`address`,label:`地址`}],Ee=[{key:`1`,name:`John Brown`,chinese:98,math:60,english:70},{key:`2`,name:`Jim Green`,chinese:98,math:66,english:89},{key:`3`,name:`Joe Black`,chinese:98,math:90,english:70},{key:`4`,name:`Jim Red`,chinese:88,math:99,english:89}],K=[{key:`chinese`,label:`语文`,priority:3},{key:`math`,label:`数学`,priority:2},{key:`english`,label:`英语`,priority:1}],De=e=>K.some(t=>t.key===e),q=e=>e===`ascend`||e===`descend`,Oe=[{key:`1`,name:`Cy Ganderton`,team:`Design Ops`,city:`Hangzhou`,owner:`Hart Hagerty`,updatedAt:`2026-04-18`},{key:`2`,name:`Brice Swyre`,team:`Growth`,city:`Shanghai`,owner:`Yancy Tear`,updatedAt:`2026-04-19`},{key:`3`,name:`Marjy Ferencz`,team:`Infra`,city:`Shenzhen`,owner:`Maribeth Popping`,updatedAt:`2026-04-21`}],ke=[{key:`name`,label:`Name`},{key:`team`,label:`Team`},{key:`city`,label:`City`},{key:`owner`,label:`Owner`},{key:`updatedAt`,label:`Updated`}],Ae=e=>ke.map(t=>({key:t.key,title:t.label,dataIndex:t.key,hidden:!e.includes(t.key)})),je=[{prop:`columns`,description:`列配置，支持分组表头、排序、筛选、隐藏列与单元格属性。`,type:`ColumnItem[]`,defaultValue:`-`},{prop:`dataSource`,description:`数据数组。`,type:`any[]`,defaultValue:`-`},{prop:`rowKey`,description:`行主键，可传字段名或函数。`,type:`string | (record) => key`,defaultValue:"`key`"},{prop:`rowSelection`,description:`选择列配置，支持多选、单选、禁用项、表头标题。`,type:`object`,defaultValue:`-`},{prop:`expandable`,description:`展开行配置，支持按行点击展开与受控展开。`,type:`object`,defaultValue:`-`},{prop:`pagination`,description:"分页配置，设为 `false` 时关闭分页。",type:`object | false`,defaultValue:`-`},{prop:`scroll`,description:`横向 / 纵向滚动配置，可在变更后自动回到顶部。`,type:`object`,defaultValue:`-`},{prop:`summary`,description:`汇总栏渲染。`,type:`(currentData, info) => any`,defaultValue:`-`}],Me=[{prop:`title`,description:`列标题，支持传节点或函数。`,type:`any | (context) => any`,defaultValue:`-`},{prop:`dataIndex`,description:`字段路径，支持字符串和数组路径。`,type:`string | string[]`,defaultValue:`-`},{prop:`sorter / sortOrder`,description:`本地排序、受控排序与多列排序。`,type:`boolean | fn | { compare?: fn; multiple?: number } / SortOrder`,defaultValue:`-`},{prop:`filters / filterDropdown / filteredValue`,description:`默认筛选菜单、自定义筛选面板与受控筛选值。`,type:`FilterItem[] / render fn / any[]`,defaultValue:`-`},{prop:`filterSearch`,description:`筛选项搜索。`,type:`boolean | fn`,defaultValue:`false`},{prop:`children`,description:`分组表头子列。`,type:`ColumnItem[]`,defaultValue:`-`},{prop:`hidden`,description:`隐藏列但保留配置。`,type:`boolean`,defaultValue:`false`},{prop:`onCell / onHeaderCell`,description:`给单元格注入 className、style、colSpan、rowSpan 等属性。`,type:`fn`,defaultValue:`-`}],Ne=[{prop:`type`,description:`选择模式。`,type:"`checkbox` | `radio`",defaultValue:"`checkbox`"},{prop:`columnTitle`,description:`选择列表头内容。`,type:`any`,defaultValue:`-`},{prop:`hideSelectAll`,description:`隐藏全选框。`,type:`boolean`,defaultValue:`false`},{prop:`getCheckboxProps`,description:`为某一行注入 disabled 等状态。`,type:`(record) => object`,defaultValue:`-`},{prop:`onSelect / onSelectAll / onChange`,description:`选择行为回调。`,type:`fn`,defaultValue:`-`}],Pe=[{prop:`expandedRowRender`,description:`展开内容渲染函数。`,type:`(record, index) => any`,defaultValue:`-`},{prop:`expandRowByClick`,description:`点击行即可展开。`,type:`boolean`,defaultValue:`false`},{prop:`showExpandColumn`,description:`是否展示展开列。`,type:`boolean`,defaultValue:`true`},{prop:`rowExpandable`,description:`按行控制是否可展开。`,type:`(record) => boolean`,defaultValue:`-`},{prop:`defaultExpandedRowKeys / expandedRowKeys`,description:`默认展开 / 受控展开。`,type:`key[]`,defaultValue:`-`}],Fe=`import { Table } from '@rue-js/design'
...
}`,J=()=>{let{tabBasic:s,tabVisual:c,tabControlledSort:d,tabMultipleSorter:p,tabColumnToggle:h,tabSelection:y,tabExpand:C,tabLayout:T,tabGrouped:O,tabStatic:k,selectedKeys:A,selectedRadio:M,clickedName:N,controlledNameFilter:P,controlledAddressFilter:F,controlledSorter:I,multiSortOrders:L,visibleColumnKeys:R,columnToggleColumns:ee,hideSalary:z,expandedKeys:te,buildControlledSortColumns:B,controlledSortColumns:ne,syncControlledSortColumns:re,buildMultipleSorterColumns:ie,multipleSorterColumns:ae,syncMultipleSorterColumns:V,cycleControlledSort:H,getControlledSortButtonText:oe,getControlledSortFieldText:se,getControlledSortOrderText:ce,setMultiSortPreset:le,cycleMultiSort:ue,getMultiSortButtonText:de,getMultiSortSummary:fe,toggleColumnVisibility:pe,employeeColumns:me,buildGroupedColumns:he,groupedColumns:ge,toggleSalaryColumn:_e,scrollColumns:ve}=w(`useSetup:0:0`,()=>a(()=>{let e=w(`ref:1:0`,()=>n(`preview`)),t=w(`ref:1:1`,()=>n(`preview`)),r=w(`ref:1:2`,()=>n(`preview`)),a=w(`ref:1:3`,()=>n(`preview`)),s=w(`ref:1:4`,()=>n(`preview`)),c=w(`ref:1:5`,()=>n(`preview`)),l=w(`ref:1:6`,()=>n(`preview`)),u=w(`ref:1:7`,()=>n(`preview`)),d=w(`ref:1:8`,()=>n(`preview`)),f=w(`ref:1:9`,()=>n(`preview`)),p=w(`ref:1:10`,()=>n([`2`])),h=w(`ref:1:11`,()=>n([`2`])),_=w(`ref:1:12`,()=>n(`未点击`)),v=w(`ref:1:13`,()=>n([`Jim`])),y=w(`ref:1:14`,()=>n([`London`])),b=w(`ref:1:15`,()=>n({columnKey:`age`,order:`descend`})),C=w(`ref:1:16`,()=>n({chinese:`descend`,math:`descend`})),T=w(`ref:1:17`,()=>n([`name`,`team`,`city`,`owner`])),E=w(`ref:1:18`,()=>n(Ae(T.value))),D=w(`ref:1:19`,()=>n(!1)),O=w(`ref:1:20`,()=>n([`2`])),k=()=>[{key:`name`,title:`Name`,filters:[{text:`Jim`,value:`Jim`},{text:`Joe`,value:`Joe`},{text:`John`,value:`John`}],dataIndex:`name`,filteredValue:v.value,filterSearch:!0,onFilter:(e,t)=>t.name.includes(e),sorter:(e,t)=>e.name.length-t.name.length,sortDirections:[`descend`,`ascend`],sortOrder:b.value.columnKey===`name`?b.value.order:null},{key:`age`,title:`Age`,dataIndex:`age`,sorter:(e,t)=>e.age-t.age,sortDirections:[`descend`,`ascend`],sortOrder:b.value.columnKey===`age`?b.value.order:null},{key:`address`,title:`Address`,filters:[{text:`London`,value:`London`},{text:`New York`,value:`New York`},{text:`Sydney`,value:`Sydney`}],dataIndex:`address`,filteredValue:y.value,filterSearch:!0,onFilter:(e,t)=>t.address.includes(e),sorter:(e,t)=>e.address.length-t.address.length,sortDirections:[`descend`,`ascend`],sortOrder:b.value.columnKey===`address`?b.value.order:null,ellipsis:!0}],A=w(`ref:1:21`,()=>n(k())),j=()=>{A.value=k()},M=()=>[{title:`Name`,dataIndex:`name`},{key:`chinese`,title:`Chinese Score`,dataIndex:`chinese`,sortOrder:C.value.chinese??null,sorter:{compare:(e,t)=>e.chinese-t.chinese,multiple:3},sortDirections:[`descend`,`ascend`]},{key:`math`,title:`Math Score`,dataIndex:`math`,sortOrder:C.value.math??null,sorter:{compare:(e,t)=>e.math-t.math,multiple:2},sortDirections:[`descend`,`ascend`]},{key:`english`,title:`English Score`,dataIndex:`english`,sortOrder:C.value.english??null,sorter:{compare:(e,t)=>e.english-t.english,multiple:1},sortDirections:[`descend`,`ascend`]}],N=w(`ref:1:22`,()=>n(M())),P=()=>{N.value=M()},F=e=>{let t=b.value,n=t.columnKey===e?t.order===`descend`?`ascend`:t.order===`ascend`?null:`descend`:`descend`;b.value=n?{columnKey:e,order:n}:{columnKey:null,order:null},j()},I=(e,t)=>{let n=b.value.columnKey===e?b.value.order:null;return n===`descend`?`${t}降序`:n===`ascend`?`${t}升序`:`${t}排序`},L=()=>Te.find(e=>e.key===b.value.columnKey)?.label??`无`,R=()=>b.value.order===`descend`?`降序`:b.value.order===`ascend`?`升序`:`无`,ee=e=>{C.value={...e},P()},z=e=>{let t=C.value[e]??null,n=t===`descend`?`ascend`:t===`ascend`?null:`descend`,r={...C.value};n?r[e]=n:delete r[e],C.value=r,P()},te=e=>{let t=C.value[e.key];return t===`descend`?`${e.label}降序`:t===`ascend`?`${e.label}升序`:`${e.label}排序`},B=()=>K.filter(e=>C.value[e.key]).sort((e,t)=>t.priority-e.priority).map(e=>{let t=C.value[e.key]===`descend`?`降序`:`升序`;return`${e.label}${t} P${e.priority}`}).join(` / `)||`无`,ne=e=>{let t=T.value.includes(e)?T.value.filter(t=>t!==e):[...T.value,e];T.value=t,E.value=Ae(t)},re=[{title:`姓名`,dataIndex:`name`},{title:`城市`,dataIndex:`city`},{title:`岗位`,dataIndex:`role`},{title:`团队`,dataIndex:`team`}],ie=e=>[{title:`成员信息`,children:[{title:`姓名`,dataIndex:`name`,width:120},{title:`城市`,dataIndex:`city`,width:120}]},{title:`工作概览`,children:[{title:`岗位`,dataIndex:`role`,ellipsis:!0},{title:`团队`,dataIndex:`team`,ellipsis:!0},{title:`月薪`,dataIndex:`salary`,align:`right`,hidden:e}]},{title:`操作`,key:`action`,width:120,align:`center`,render:(e,t)=>m(e=>{let n=x(`button`,e);return S(n,`btn btn-ghost btn-xs`),i(n,`click`,()=>_.value=`操作 ${t.name}`),o(n,g(`查看`)),n}),onCell:(e,t)=>({className:t%2==0?`bg-base-100`:`bg-base-200/30`})}],ae=w(`ref:1:23`,()=>n(ie(D.value)));return{tabBasic:e,tabVisual:t,tabControlledSort:r,tabMultipleSorter:a,tabColumnToggle:s,tabSelection:c,tabExpand:l,tabLayout:u,tabGrouped:d,tabStatic:f,selectedKeys:p,selectedRadio:h,clickedName:_,controlledNameFilter:v,controlledAddressFilter:y,controlledSorter:b,multiSortOrders:C,visibleColumnKeys:T,columnToggleColumns:E,hideSalary:D,expandedKeys:O,buildControlledSortColumns:k,controlledSortColumns:A,syncControlledSortColumns:j,buildMultipleSorterColumns:M,multipleSorterColumns:N,syncMultipleSorterColumns:P,cycleControlledSort:F,getControlledSortButtonText:I,getControlledSortFieldText:L,getControlledSortOrderText:R,setMultiSortPreset:ee,cycleMultiSort:z,getMultiSortButtonText:te,getMultiSortSummary:B,toggleColumnVisibility:ne,employeeColumns:re,buildGroupedColumns:ie,groupedColumns:ae,toggleSalaryColumn:()=>{D.value=!D.value,ae.value=ie(D.value)},scrollColumns:[{title:`姓名`,dataIndex:`name`,width:120,fixedCol:!0},{title:`城市`,dataIndex:`city`,width:120},{title:`岗位`,dataIndex:`role`,width:180,ellipsis:!0},{title:`团队`,dataIndex:`team`,width:160},{title:`地址`,dataIndex:`address`,width:220,ellipsis:!0},{title:`访问量`,dataIndex:`visits`,width:120,align:`right`}]}}));return m(n=>{let i=u(),a=e(`rue:component:anchor`);return o(i,a),_(b(j,{children:m(()=>{let n=u(),i=x(`div`,n);o(n,i),S(i,`max-w-none prose prose-sm md:prose-base`);let a=x(`h1`,i);o(i,a),o(a,g(`Table 表格`));let m=x(`p`,i);o(i,m),o(m,g(`Rue Table 现在同时覆盖数据驱动表格和 daisyUI 风格的静态表格写法，保留 Rue 当前视觉风格，并补齐更完整的 排序、筛选、分页、选择、展开与分组表头能力。`));let w=x(`p`,i);o(i,w),o(w,g(`可以先从基础用法进入，再根据场景查看筛选排序、选择模式、滚动布局与分组表头。静态样式写法仍然保留，可继续 使用`));let j=x(`code`,w);o(w,j),o(j,g(`Table.Head`)),o(w,g(`、`));let B=x(`code`,w);o(w,B),o(B,g(`Table.Body`)),o(w,g(`等复合组件。`));let ie=x(`h2`,i);o(i,ie),o(ie,g(`何时使用`));let he=x(`ul`,i);o(i,he);let ye=x(`li`,he);o(he,ye),o(ye,g(`需要展示结构化列表数据，并同时提供排序、筛选、分页等交互。`));let be=x(`li`,he);o(he,be),o(be,g(`希望沿用 Rue / daisyUI 的表格视觉风格，但 API 更接近成熟数据表组件。`));let Ae=x(`li`,he);o(he,Ae),o(Ae,g(`既有简单静态表格，也有复杂后台表格，想统一在一个组件里处理。`));let J=e(`rue:component:anchor`);o(i,J),t(()=>{let e=b(W,{title:`基础数据表格`,summary:`最直接的 columns + dataSource 用法，适合作为大多数列表页的起点。`,tab:s,preview:()=>D(`div`,{className:`overflow-x-auto rounded-box border border-base-300 bg-base-100 p-4`,children:D(U,{className:`w-full`,columns:me,dataSource:G})}),code:Fe});r(()=>_(e,i,J))});let Y=e(`rue:component:anchor`);o(i,Y),t(()=>{let e=b(W,{title:`视觉风格与静态行态`,summary:`保留原有视觉类 demo：背景、激活行、hover、zebra 与尺寸示例。`,tab:c,preview:()=>E(`div`,{className:`grid gap-4 lg:grid-cols-2`,children:[E(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:[D(`div`,{className:`mb-3 text-sm font-medium`,children:`带背景与激活行`}),E(U,{className:`w-full`,children:[D(U.Head,{children:E(U.TR,{children:[D(U.TH,{children:`姓名`}),D(U.TH,{children:`岗位`}),D(U.TH,{children:`城市`})]})}),E(U.Body,{children:[E(U.TR,{className:`bg-base-200`,children:[D(U.TD,{children:`林青`}),D(U.TD,{children:`设计工程师`}),D(U.TD,{children:`杭州`})]}),E(U.TR,{className:`active`,children:[D(U.TD,{children:`周宁`}),D(U.TD,{children:`前端工程师`}),D(U.TD,{children:`上海`})]})]})]})]}),E(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:[D(`div`,{className:`mb-3 text-sm font-medium`,children:`hover / zebra / xs`}),D(U,{className:`w-full`,zebra:!0,size:`xs`,rowHoverable:!0,columns:me,dataSource:G.slice(0,3)})]})]}),code:Ie});r(()=>_(e,i,Y))});let Ge=e(`rue:component:anchor`);o(i,Ge),t(()=>{let e=b(W,{title:`可控筛选与排序`,summary:`恢复外部控制台式的筛选与排序示例，避免交互状态混在一起。`,tab:d,preview:()=>E(`div`,{className:`space-y-4 rounded-box border border-base-300 bg-base-100 p-4`,children:[E(`div`,{className:`flex flex-wrap items-center gap-2 text-sm`,children:[Te.map(e=>D(`button`,{className:`btn btn-xs ${I.value.columnKey===e.key?`btn-primary`:`btn-ghost`}`,onClick:()=>H(e.key),children:oe(e.key,e.label)},e.key)),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>{I.value={columnKey:null,order:null},re()},children:`清空排序`}),D(`button`,{className:`btn btn-xs ${P.value.length===1&&P.value[0]===`Jim`&&F.value.length===0?`btn-primary`:`btn-ghost`}`,onClick:()=>{P.value=[`Jim`],F.value=[],re()},children:`只看 Jim`}),D(`button`,{className:`btn btn-xs ${F.value.length===1&&F.value[0]===`London`&&P.value.length===0?`btn-primary`:`btn-ghost`}`,onClick:()=>{P.value=[],F.value=[`London`],re()},children:`只看 London`}),D(`button`,{className:`btn btn-xs ${P.value.length===1&&P.value[0]===`Jim`&&F.value.length===1&&F.value[0]===`London`?`btn-primary`:`btn-ghost`}`,onClick:()=>{P.value=[`Jim`],F.value=[`London`],re()},children:`Jim + London`}),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>{P.value=[],F.value=[],re()},children:`清空筛选`}),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>{P.value=[],F.value=[],I.value={columnKey:null,order:null},re()},children:`清空全部`}),E(`span`,{className:`opacity-70`,children:[`筛选：Name `,P.value.join(`, `)||`无`,` / Address`,` `,F.value.join(`, `)||`无`,`； 当前排序：`,se(),` / `,ce()]})]}),D(U,{className:`w-full`,columns:ne.value,dataSource:we,sortDirections:[`descend`,`ascend`],onChange:(e,t,n)=>{P.value=Array.isArray(t?.name)&&t.name.length>0?t.name:[],F.value=Array.isArray(t?.address)&&t.address.length>0?t.address:[];let r=Array.isArray(n)?n[0]:n;I.value={columnKey:r?.order?r?.columnKey??null:null,order:r?.order??null},re()}})]}),code:Le});r(()=>_(e,i,Ge))});let Ke=e(`rue:component:anchor`);o(i,Ke),t(()=>{let e=b(W,{title:`多列排序（优先级组合）`,summary:`补回多列优先级排序 demo，支持 { compare, multiple } 并按优先级组合排序。`,tab:p,preview:()=>E(`div`,{className:`space-y-4 rounded-box border border-base-300 bg-base-100 p-4`,children:[E(`div`,{className:`flex flex-wrap gap-2 text-sm`,children:[D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>le({chinese:`descend`,math:`descend`}),children:`语文 + 数学降序`}),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>le({chinese:`descend`,math:`descend`,english:`descend`}),children:`三科降序`}),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>le({chinese:`ascend`,english:`descend`}),children:`语文升序 + 英语降序`}),D(`button`,{className:`btn btn-ghost btn-xs`,onClick:()=>le({}),children:`清空排序`})]}),E(`div`,{className:`flex flex-wrap items-center gap-2 text-sm`,children:[K.map(e=>D(`button`,{className:`btn btn-xs ${L.value[e.key]?`btn-primary`:`btn-ghost`}`,onClick:()=>ue(e.key),children:de(e)},e.key)),E(`span`,{className:`opacity-70`,children:[`当前优先级：`,fe()]})]}),D(U,{className:`w-full`,columns:ae.value,dataSource:Ee,sortDirections:[`descend`,`ascend`],onChange:(e,t,n)=>{L.value=(Array.isArray(n)?n:n?.order?[n]:[]).reduce((e,t)=>{let n=t?.columnKey,r=t?.order;return De(n)&&q(r)&&(e[n]=r),e},{}),V()}})]}),code:Re});r(()=>_(e,i,Ke))});let qe=e(`rue:component:anchor`);o(i,qe),t(()=>{let e=b(W,{title:`动态列显隐`,summary:`把旧的隐藏列 demo 补回来，并用外部开关控制列可见性。`,tab:h,preview:()=>E(`div`,{className:`space-y-4 rounded-box border border-base-300 bg-base-100 p-4`,children:[D(`div`,{className:`flex flex-wrap gap-2 text-sm`,children:ke.map(e=>{let t=R.value.includes(e.key);return D(`button`,{className:`btn btn-xs ${t?`btn-primary`:`btn-ghost`}`,onClick:()=>pe(e.key),children:t?`隐藏 ${e.label}`:`显示 ${e.label}`},e.key)})}),D(U,{className:`w-full`,columns:ee.value,dataSource:Oe})]}),code:ze});r(()=>_(e,i,qe))});let Je=e(`rue:component:anchor`);o(i,Je),t(()=>{let e=b(W,{title:`选择模式`,summary:`保留多选、单选、禁用项、部分禁用几类示例，并增加选择列表头与回调展示。`,tab:y,preview:()=>E(`div`,{className:`grid gap-4 lg:grid-cols-2`,children:[E(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:[E(`div`,{className:`mb-3 text-sm`,children:[`多选：当前 `,A.value.join(`, `)||`空`]}),D(U,{className:`w-full`,columns:[{title:`姓名`,dataIndex:`name`},{title:`团队`,dataIndex:`team`},{title:`状态`,dataIndex:`status`}],dataSource:G,rowSelection:{columnTitle:`成员`,selectedRowKeys:A.value,getCheckboxProps:e=>({disabled:e.status===`leave`}),onChange:e=>A.value=[...e]}})]}),E(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:[E(`div`,{className:`mb-3 text-sm`,children:[`单选：当前 `,M.value[0]??`空`]}),D(U,{className:`w-full`,columns:[{title:`姓名`,dataIndex:`name`},{title:`城市`,dataIndex:`city`}],dataSource:G.slice(0,4),rowSelection:{type:`radio`,hideSelectAll:!0,selectedRowKeys:M.value,onChange:e=>M.value=[...e]}})]})]}),code:Be});r(()=>_(e,i,Je))});let Ye=e(`rue:component:anchor`);o(i,Ye),t(()=>{let e=b(W,{title:`展开、摘要与空态`,summary:`把展开行、按行点击展开、summary 和 emptyText 放在同一个业务场景里。`,tab:C,preview:()=>E(`div`,{className:`grid gap-4 lg:grid-cols-2`,children:[D(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:D(U,{className:`w-full`,columns:[{title:`姓名`,dataIndex:`name`},{title:`绩效`,dataIndex:`score`,align:`right`}],dataSource:G,expandable:{expandedRowKeys:te.value,expandRowByClick:!0,onExpandedRowsChange:e=>te.value=[...e],expandedRowRender:e=>E(`div`,{className:`text-sm leading-6`,children:[E(`div`,{children:[`团队：`,e.team]}),E(`div`,{children:[`地址：`,e.address]})]})},summary:e=>E(`div`,{className:`flex justify-between text-sm`,children:[E(`span`,{children:[`当前行数：`,e.length]}),E(`span`,{children:[`平均绩效：`,Math.round(e.reduce((e,t)=>e+t.score,0)/e.length)]})]})})}),D(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:D(U,{className:`w-full`,columns:[{title:`姓名`,dataIndex:`name`},{title:`团队`,dataIndex:`team`}],dataSource:[],emptyText:D(`span`,{className:`text-sm opacity-60`,children:`暂无成员，请先创建数据。`})})})]}),code:Ve});r(()=>_(e,i,Ye))});let X=e(`rue:component:anchor`);o(i,X),t(()=>{let e=b(W,{title:`滚动、标题、尾部与省略`,summary:`保留滚动、title/footer、ellipsis 和滚动容器类 demo，并串成一个长表格布局场景。`,tab:T,preview:()=>D(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4`,children:D(U,{className:`w-full`,columns:ve,dataSource:G.concat(G).concat(G),scroll:{x:900,y:220,scrollToFirstRowOnChange:!0},title:e=>E(`div`,{className:`text-sm font-medium`,children:[`成员列表（当前页 `,e.length,` 行）`]}),footer:e=>D(`div`,{className:`text-sm opacity-70`,children:`展示了固定列、纵向滚动和 ellipsis。`})})}),code:He});r(()=>_(e,i,X))});let Xe=e(`rue:component:anchor`);o(i,Xe),t(()=>{let e=b(W,{title:`分组表头、隐藏列与单元格属性`,summary:`新增分组表头，同时把隐藏列、单元格 className/style/操作列示例合并到这里。`,tab:O,preview:()=>E(`div`,{className:`space-y-4 rounded-box border border-base-300 bg-base-100 p-4`,children:[E(`div`,{className:`flex flex-wrap gap-2 text-sm`,children:[D(`button`,{className:`btn btn-ghost btn-xs`,onClick:_e,children:z.value?`显示月薪列`:`隐藏月薪列`}),E(`span`,{children:[`最近操作：`,N.value]})]}),D(U,{className:`w-full`,columns:ge.value,dataSource:G,rowHoverable:!0,onRow:e=>({onClick:()=>N.value=`点击 ${e.name}`})})]}),code:Ue});r(()=>_(e,i,Xe))});let Ze=e(`rue:component:anchor`);o(i,Ze),t(()=>{let e=b(W,{title:`静态样式、Pinned Rows 与 Pinned Cols`,summary:`原有静态样式 demo 仍然保留，适合不需要 columns/dataSource 时直接写结构。`,tab:k,preview:()=>E(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[D(`div`,{className:`h-72 overflow-auto rounded-box border border-base-300 bg-base-100 p-4`,children:E(U,{zebra:!0,pinRows:!0,className:`w-full min-w-[640px]`,children:[D(U.Head,{children:E(U.TR,{children:[D(U.TH,{children:`商品`}),D(U.TH,{children:`负责人`}),D(U.TH,{children:`渠道`}),D(U.TH,{className:`text-right`,children:`库存`}),D(U.TH,{className:`text-right`,children:`价格`})]})}),D(U.Body,{children:Se.map(e=>E(U.TR,{children:[D(U.TD,{children:e.item}),D(U.TD,{children:e.owner}),D(U.TD,{children:e.channel}),D(U.TD,{className:`text-right`,children:e.stock}),D(U.TD,{className:`text-right`,children:e.price})]},e.id))})]})}),D(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4 overflow-x-auto`,children:E(U,{pinCols:!0,className:`w-[980px]`,children:[D(U.Head,{children:E(U.TR,{children:[D(U.TH,{className:`bg-base-100`,children:`姓名`}),D(U.TH,{children:`岗位`}),D(U.TH,{children:`团队`}),D(U.TH,{children:`城市`}),D(U.TH,{className:`text-right`,children:`绩效`}),D(U.TH,{className:`text-right`,children:`访问`}),D(U.TH,{className:`text-right`,children:`月薪`}),D(U.TH,{children:`地址`})]})}),D(U.Body,{children:Ce.map(e=>E(U.TR,{children:[D(U.TH,{className:`bg-base-100`,children:e.name}),D(U.TD,{children:e.role}),D(U.TD,{children:e.team}),D(U.TD,{children:e.city}),D(U.TD,{className:`text-right`,children:e.score}),D(U.TD,{className:`text-right`,children:e.visits}),D(U.TD,{className:`text-right`,children:e.salary}),D(U.TD,{children:e.address})]},e.key))})]})})]}),code:We});r(()=>_(e,i,Ze))});let Qe=x(`h2`,i);o(i,Qe),l(Qe,`id`,`table-api`),o(Qe,g(`API`));let $e=x(`p`,i);o(i,$e),o($e,g(`当前页面只列出 Rue Table 本次增强后最常用的配置项，优先对应实际使用场景。`));let et=x(`h3`,i);o(i,et),o(et,g(`Table`));let tt=e(`rue:component:anchor`);o(i,tt),t(()=>{let e=b(xe,{rows:je});r(()=>_(e,i,tt))});let nt=x(`h3`,i);o(i,nt),o(nt,g(`Column`));let rt=e(`rue:component:anchor`);o(i,rt),t(()=>{let e=b(xe,{rows:Me});r(()=>_(e,i,rt))});let it=x(`h3`,i);o(i,it),o(it,g(`rowSelection`));let at=e(`rue:component:anchor`);o(i,at),t(()=>{let e=b(xe,{rows:Ne});r(()=>_(e,i,at))});let ot=x(`h3`,i);o(i,ot),o(ot,g(`expandable`));let st=e(`rue:component:anchor`);o(i,st),t(()=>{let e=b(xe,{rows:Pe});r(()=>_(e,i,st))});let ct=x(`h2`,i);o(i,ct),o(ct,g(`FAQ`));let lt=x(`h3`,i);o(i,lt),o(lt,g(`数据驱动和静态结构怎么选？`));let ut=x(`p`,i);o(i,ut),o(ut,g(`需要排序、筛选、分页、选择、展开时优先使用`));let dt=x(`code`,ut);o(ut,dt),o(dt,g(`columns + dataSource`)),o(ut,g(`。只想快速输出结构化样式， 或需要完全手写表格结构时，继续使用复合组件写法即可。`));let ft=x(`h3`,i);o(i,ft),o(ft,g(`为什么筛选或排序后会回到第一页？`));let pt=x(`p`,i);o(i,pt),o(pt,g(`这是为了避免当前页在筛选后没有数据。如果你希望完全自行控制分页，把`));let Z=v(pt);o(pt,Z),f(Z,` `);let mt=x(`code`,pt);o(pt,mt),o(mt,g(`pagination.current`)),o(pt,g(`和`));let ht=x(`code`,pt);o(pt,ht),o(ht,g(`onChange`)),o(pt,g(`一起受控即可。`));let gt=x(`h3`,i);o(i,gt),o(gt,g(`固定列和 pinCols 的关系是什么？`));let Q=x(`p`,i);o(i,Q);let _t=x(`code`,Q);o(Q,_t),o(_t,g(`pinCols`)),o(Q,g(`负责启用 daisyUI 的固定列视觉能力，具体哪一列固定则由列上的`));let $=v(Q);o(Q,$),f($,` `);let vt=x(`code`,Q);o(Q,vt),o(vt,g(`fixedCol`)),o(Q,g(`或`));let yt=x(`code`,Q);o(Q,yt),o(yt,g(`fixed`)),o(Q,g(`控制。静态结构写法中，通常把固定列单元格写成`));let bt=v(Q);o(Q,bt),f(bt,` `);let xt=x(`code`,Q);return o(Q,xt),o(xt,g(`TH`)),o(Q,g(`会更自然。`)),n})}),i,a),i})};export{J as default};