...
`});r(()=>d(e,l,w))});let T=e(`h2`,l);i(l,T),s(T,`mt-10`),i(T,c(`API`));let E=o(`rue:component:anchor`);i(l,E),a(()=>{let e=f(V,{rows:ee});r(()=>d(e,l,E))});let D=e(`p`,l);return i(l,D),s(D,`text-sm opacity-70 mt-4`),i(D,c(`除了上表 props，组件还暴露了 Result.PRESENTED_IMAGE_403、Result.PRESENTED_IMAGE_404 和 Result.PRESENTED_IMAGE_500 三个静态插画组件，便于你在更复杂的空壳页面里单独复用。`)),t})}),u,p),u});export{te as default};