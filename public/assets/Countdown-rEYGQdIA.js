...
<Countdown
  ...
  format="HH:mm:ss:SSS"
  interval={250}
/>`});_(()=>u(e,r,d))});let p=v(`rue:component:anchor`);t(r,p),n(()=>{let e=g(K,{title:`Day Level Format`,summary:`支持把单位文字写进 format，并自动拆成数字段与纯文本分隔符。`,tab:ne,preview:()=>E(`div`,{className:`space-y-4`,children:[T(G,{className:`font-mono text-2xl`,value:O.value,format:`D [days] H [hours] m [minutes] s [seconds]`},O.value),T(`button`,{className:`btn btn-sm btn-outline ml-3`,onClick:se,children:`重置长倒计时`})]}),code:`const longDeadline =
...
/>`});_(()=>u(e,r,p))});let b=v(`rue:component:anchor`);t(r,b),n(()=>{let e=g(K,{title:`Callbacks`,summary:`onChange 返回剩余毫秒数，onFinish 只在归零时触发一次。`,tab:re,preview:()=>E(`div`,{className:`space-y-4`,children:[T(G,{className:`font-mono text-3xl`,value:A.value,format:`s.SSS`,interval:250,onChange:e=>{M.value=Math.max(Math.round(e??0),0)},onFinish:()=>{j.value=`已完成`}},A.value),E(`div`,{className:`text-sm opacity-70`,children:[`最近一次 onChange: `,M.value,` ms`]}),E(`div`,{className:`text-sm opacity-70`,children:[`onFinish 状态: `,j.value]}),T(`button`,{className:`btn btn-sm btn-outline`,onClick:ce,children:`重置 10 秒示例`})]}),code:`const target = Date.now() + 10 * 1000
...
/>`});_(()=>u(e,r,b))});let S=m(`h2`,r);t(r,S),t(S,o(`组合方式`));let k=m(`p`,r);t(r,k),f(k,`text-sm`),t(k,o("这组示例使用 Rue 组合式写法，用于展示 `Countdown.Value` 与 `items` 的自由排布能力。"));let N=v(`rue:component:anchor`);t(r,N),n(()=>{let e=g(K,{title:`Countdown`,tab:I,preview:()=>T(G,{children:T(G.Value,{value:h.value,ariaLabel:`${h.value} seconds remaining`})}),code:`const remaining = ref(10 * 60 * 60 + 24 * 60 + 59)

<Countdown>
  <Countdown.Value value={remaining.value} ariaLabel={\`\${remaining.value} seconds remaining\`} />
</Countdown>`});_(()=>u(e,r,N))});let P=v(`rue:component:anchor`);t(r,P),n(()=>{let e=g(K,{title:`Large Text With 2 Digits`,tab:L,preview:()=>T(G,{className:`font-mono text-6xl`,children:T(G.Value,{value:C.value,digits:2,ariaLabel:`${C.value} seconds remaining`})}),code:`const parts = computed(() => {
...
</Countdown>`});_(()=>u(e,r,P))});let F=v(`rue:component:anchor`);t(r,F),n(()=>{let e=g(K,{title:`Clock Countdown`,tab:R,preview:()=>E(G,{className:`font-mono text-2xl`,children:[T(G.Value,{value:y.value,ariaLabel:`${y.value} hours`}),`h`,T(G.Value,{value:x.value,digits:2,ariaLabel:`${x.value} minutes`}),`m`,T(G.Value,{value:C.value,digits:2,ariaLabel:`${C.value} seconds`}),`s`]}),code:`const parts = computed(() => {
  const totalSeconds = Math.max(Math.floor(remaining.value), 0)
...
</Countdown>`});_(()=>u(e,r,F))});let Y=v(`rue:component:anchor`);t(r,Y),n(()=>{let e=g(K,{title:`Countdown 通过数据渲染（数组，组件内部）`,summary:`items 适合在业务层先拼好数字段与分隔符，再一次性交给 Countdown。`,tab:U,preview:()=>T(G,{className:`font-mono text-2xl`,items:ie.get()}),code:`const items = [
  { value: 10 },
  { content: 'h' },
  { value: 24, digits: 2 },
  { content: 'm' },
...
<Countdown className="font-mono text-2xl" items={items} />`});_(()=>u(e,r,Y))});let X=v(`rue:component:anchor`);t(r,X),n(()=>{let e=g(K,{title:`Clock Countdown With Colons`,tab:z,preview:()=>E(G,{className:`font-mono text-2xl`,children:[T(G.Value,{value:10,ariaLabel:`10`}),`:`,T(G.Value,{value:24,digits:2,ariaLabel:`24`}),`:`,T(G.Value,{value:i.value,digits:2,ariaLabel:String(i.value)})]}),code:`<Countdown className="font-mono text-2xl">
...
</Countdown>`});_(()=>u(e,r,X))});let Z=v(`rue:component:anchor`);t(r,Z),n(()=>{let e=g(K,{title:`Large Text With Labels`,tab:B,preview:()=>E(`div`,{className:`flex gap-5`,children:[T(q,{label:`days`,countdownClassName:`font-mono text-4xl`,children:T(G.Value,{value:15,ariaLabel:`15`})}),T(q,{label:`hours`,countdownClassName:`font-mono text-4xl`,children:T(G.Value,{value:10,ariaLabel:`10`})}),T(q,{label:`min`,countdownClassName:`font-mono text-4xl`,children:T(G.Value,{value:24,ariaLabel:`24`})}),T(q,{label:`sec`,countdownClassName:`font-mono text-4xl`,children:T(G.Value,{value:i.value,ariaLabel:String(i.value)})})]}),code:`<div className="flex gap-5">
  <div>
...
</div>`});_(()=>u(e,r,Z))});let Q=v(`rue:component:anchor`);t(r,Q),n(()=>{let e=g(K,{title:`Large Text With Labels Under`,tab:V,preview:()=>E(`div`,{className:`grid grid-flow-col gap-5 text-center auto-cols-max`,children:[T(q,{className:`flex flex-col`,label:`days`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:15,ariaLabel:`15`})}),T(q,{className:`flex flex-col`,label:`hours`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:10,ariaLabel:`10`})}),T(q,{className:`flex flex-col`,label:`min`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:24,ariaLabel:`24`})}),T(q,{className:`flex flex-col`,label:`sec`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:i.value,ariaLabel:String(i.value)})})]}),code:`<div className="grid grid-flow-col gap-5 text-center auto-cols-max">
...
</div>`});_(()=>u(e,r,Q))});let $=v(`rue:component:anchor`);t(r,$),n(()=>{let e=g(K,{title:`In Boxes`,tab:H,preview:()=>E(`div`,{className:`grid grid-flow-col gap-5 text-center auto-cols-max`,children:[T(q,{className:`flex flex-col p-2 bg-neutral rounded-box text-neutral-content`,label:`days`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:15,ariaLabel:`15`})}),T(q,{className:`flex flex-col p-2 bg-neutral rounded-box text-neutral-content`,label:`hours`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:10,ariaLabel:`10`})}),T(q,{className:`flex flex-col p-2 bg-neutral rounded-box text-neutral-content`,label:`min`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:24,ariaLabel:`24`})}),T(q,{className:`flex flex-col p-2 bg-neutral rounded-box text-neutral-content`,label:`sec`,countdownClassName:`font-mono text-5xl`,children:T(G.Value,{value:i.value,ariaLabel:String(i.value)})})]}),code:`<div className="grid grid-flow-col gap-5 text-center auto-cols-max">
