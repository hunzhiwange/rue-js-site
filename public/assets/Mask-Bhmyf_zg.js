...
<Mask shape="circle" src="${j}" alt="circle" size="md" bordered />`});i(()=>f(e,n,b))});let w=s(`rue:component:anchor`);a(n,w),o(()=>{let e=p(V,{title:`Star variants`,summary:`保留星形与粗星形示例，增加 ring 和 hover，适合头像墙或精选内容。`,tab:h,preview:()=>_(`div`,{className:`card bg-base-100 shadow-sm`,children:_(`div`,{className:`card-body flex flex-wrap gap-5`,children:F.map(e=>_(A,{shape:e,src:j,alt:e,size:`lg`,ring:!0,shadow:!0,interactive:!0},e))})}),code:`<Mask shape="star" src="${j}" alt="star" size="lg" ring shadow interactive />
<Mask shape="star-2" src="${j}" alt="star-2" size="lg" ring shadow interactive />`});i(()=>f(e,n,w))});let T=s(`rue:component:anchor`);a(n,T),o(()=>{let e=p(V,{title:`Triangle variants`,summary:`保留四向三角形示例，并通过统一尺寸让方向差异更好观察。`,tab:v,preview:()=>_(`div`,{className:`card bg-base-100 shadow-sm`,children:_(`div`,{className:`card-body flex flex-wrap gap-5`,children:I.map(e=>_(A,{shape:e,src:j,alt:e,size:`lg`,bordered:!0,shadow:!0},e))})}),code:`<Mask shape="triangle" src="${j}" alt="triangle" size="lg" bordered shadow />
...
<Mask shape="triangle-4" src="${j}" alt="triangle-4" size="lg" bordered shadow />`});i(()=>f(e,n,T))});let E=s(`rue:component:anchor`);a(n,E),o(()=>{let e=p(V,{title:`Half modifiers and arbitrary host`,summary:`保留 half modifier 与任意宿主演示，并补上 start / end 语义别名。`,tab:y,preview:()=>_(`div`,{className:`card bg-base-100 shadow-sm`,children:g(`div`,{className:`card-body flex flex-wrap items-center gap-6`,children:[_(A,{shape:`star`,half:`1`,src:j,alt:`star half 1`,size:`lg`,ring:!0}),_(A,{shape:`star`,half:`2`,src:j,alt:`star half 2`,size:`lg`,ring:!0}),_(A,{shape:`diamond`,half:`start`,src:j,alt:`diamond start`,size:`lg`,bordered:!0}),_(A,{as:`div`,shape:`diamond`,tone:`primary`,size:`lg`,ring:!0,shadow:!0,className:`grid place-content-center text-sm font-semibold uppercase tracking-[0.2em]`,"data-testid":`mask-host-demo`,children:`Host`})]})}),code:`<Mask shape="star" half="1" src="${j}" alt="star half 1" size="lg" ring />
...
</div>`});i(()=>f(e,n,k))});let U=e(`div`,n);a(n,U),c(U,`my-8`);let W=e(`h2`,U);a(U,W),c(W,`mt-0`),a(W,l(`API`));let G=s(`rue:component:anchor`);return a(U,G),o(()=>{let e=p(H,{rows:B});i(()=>f(e,U,G))}),t})}),n,m),n})};export{U as default};