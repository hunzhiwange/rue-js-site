...
</div>`});p(()=>s(e,a,se))});let ce=m(`rue:component:anchor`);e(a,ce),t(()=>{let e=f(V,{title:`Placement shorthand and offset`,summary:`placement 先给出主定位，再用 offset 做细调，适合视觉需要避让边框或圆角的场景。`,tab:O,preview:()=>y(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[v(R,{item:v(S,{variant:`secondary`,children:`Start`}),itemProps:{placement:`top-start`,offset:[8,-4]},children:v(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`top-start`})}),v(R,{item:v(S,{variant:`accent`,children:`Center`}),itemProps:{placement:`middle-center`,offset:[0,4]},children:v(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`middle-center`})}),v(R,{item:v(S,{variant:`warning`,children:`End`}),itemProps:{placement:`bottom-end`,offset:[10,6]},children:v(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`bottom-end`})})]}),code:`<div className="grid gap-4 md:grid-cols-3">
  <Indicator
...
</div>`});p(()=>s(e,a,ce))});let le=m(`rue:component:anchor`);e(a,le),t(()=>{let e=f(V,{title:`Props-driven shorthand`,summary:`常见的一主一辅场景可以完全通过 item 和 itemProps 表达，代码更短，也更适合数据驱动。`,tab:k,preview:()=>v(R,{className:`w-full max-w-sm`,item:v(S,{variant:`primary`,children:`8 pending`}),itemProps:{placement:`top-end`,offset:[12,-6]},children:v(`div`,{className:`card border border-base-300 bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body gap-3`,children:[y(`div`,{children:[v(`div`,{className:`text-xs uppercase tracking-[0.18em] text-base-content/55`,children:`Queue`}),v(`div`,{className:`mt-2 text-lg font-semibold`,children:`Build pipeline`})]}),v(`p`,{className:`m-0 text-sm text-base-content/70`,children:`Web hooks, release notes and QA approvals are waiting for merge.`})]})})}),code:`<Indicator
...
</Indicator>`});p(()=>s(e,a,le))});let ue=m(`rue:component:anchor`);e(a,ue),t(()=>{let e=f(V,{title:`Multiple indicators`,summary:`items 适合一个主体上同时悬挂多个提示，比如在线状态和悬挂操作。`,tab:A,preview:()=>v(R,{className:`w-full max-w-sm`,items:[{key:`presence`,placement:`top-start`,offset:[6,-4],children:v(C,{status:`success`})},{key:`cta`,as:`div`,placement:`bottom-center`,children:v(`button`,{className:`btn btn-primary btn-sm`,children:`Apply`})}],children:v(`div`,{className:`card border border-base-300 bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body gap-2`,children:[v(`h3`,{className:`m-0 text-lg font-semibold`,children:`Design review board`}),v(`p`,{className:`m-0 text-sm text-base-content/70`,children:`This board keeps the latest reviewer presence and the primary action in one place.`})]})})}),code:`<Indicator
  className="w-full max-w-sm"
  items={[
    {
      key: 'presence',
