import{$ as e,Ht as t,J as n,Lt as r,Q as i,X as a,Xt as o,Z as s,at as c,gt as l,l as u,mt as d,qt as f,s as p,st as m,t as h}from"./vapor-runtime-iQZthBPQ.js";import{a as g,n as _}from"./vapor-helpers-vapor-BjKHCvOa.js";import{a as v,i as y}from"./persistentSidebarPlayground-BfF7yM0K.js";import{t as b}from"./Code-CZqShVUj.js";import{t as x}from"./tabs-BBuGEPV7.js";import{r as S}from"./SidebarPlaygroundDesign-BcHYLGe4.js";var C=(e,t)=>t?`${e} ${t}`:e,w=e=>Array.isArray(e)?e.some(e=>w(e)):e!=null&&e!==!1,T=e=>{if(e)return e===`start`?`1`:e===`end`?`2`:e},E=e=>{switch(e){case`xs`:return`size-12`;case`sm`:case`small`:return`size-16`;case`md`:case`middle`:case`medium`:return`size-24`;case`lg`:case`large`:return`size-32`;case`xl`:return`size-40`;case`2xl`:return`size-52`;case`3xl`:return`size-64`;default:return}},D=e=>{switch(e){case`top`:return`object-top`;case`bottom`:return`object-bottom`;case`left`:return`object-left`;case`right`:return`object-right`;case`top-left`:return`object-left-top`;case`top-right`:return`object-right-top`;case`bottom-left`:return`object-left-bottom`;case`bottom-right`:return`object-right-bottom`;default:return e?`object-center`:void 0}},O=e=>{switch(e){case`contain`:return`object-contain`;case`fill`:return`object-fill`;case`none`:return`object-none`;case`scale-down`:return`object-scale-down`;default:return e?`object-cover`:void 0}},k=e=>{switch(e){case`neutral`:return`bg-neutral text-neutral-content`;case`primary`:return`bg-primary text-primary-content`;case`secondary`:return`bg-secondary text-secondary-content`;case`accent`:return`bg-accent text-accent-content`;case`info`:return`bg-info text-info-content`;case`success`:return`bg-success text-success-content`;case`warning`:return`bg-warning text-warning-content`;case`error`:return`bg-error text-error-content`;case`base`:return`bg-base-200 text-base-content`;default:return}},A=e=>{switch(e){case`neutral`:return`ring-neutral/35`;case`primary`:return`ring-primary/35`;case`secondary`:return`ring-secondary/35`;case`accent`:return`ring-accent/35`;case`info`:return`ring-info/35`;case`success`:return`ring-success/35`;case`warning`:return`ring-warning/35`;case`error`:return`ring-error/35`;default:return`ring-base-300`}},j=({shape:e,half:t,size:n,fit:r,position:i,tone:a,bordered:o,ring:s,shadow:c,interactive:l})=>{let u=`mask mask-${e??`squircle`}`,d=T(t),f=E(n),p=O(r),m=D(i),h=k(a);return d&&(u+=` mask-half-${d}`),f&&(u+=` ${f}`),p&&(u+=` ${p}`),m&&(u+=` ${m}`),h&&(u+=` ${h}`),o&&(u+=` ring-1 ring-inset ring-base-300/80`),s&&(u+=` ring-2 ring-offset-2 ring-offset-base-100 ${A(a)}`),c&&(u+=` shadow-xl shadow-base-content/10`),l&&(u+=` transition duration-200 ease-out hover:-translate-y-1 hover:shadow-2xl`),u},M=e=>{let{__rue_rest_omit_0:r,__rue_rest_omit_1:h,__rue_rest_omit_2:_,__rue_rest_omit_3:v,__rue_rest_omit_4:y,__rue_rest_omit_5:b,__rue_rest_omit_6:x,__rue_rest_omit_7:S,__rue_rest_omit_8:T,__rue_rest_omit_9:E,__rue_rest_omit_10:D,__rue_rest_omit_11:O,__rue_rest_omit_12:k,__rue_rest_omit_13:A,__rue_rest_omit_14:M,__rue_rest_omit_15:N,__rue_rest_omit_16:P,__rue_rest_omit_17:F,__rue_rest_omit_18:I,__rue_rest_omit_19:L,__rue_rest_omit_20:R,__rue_rest_omit_21:z,rest:B,cls:V,contentNode:H,mediaMode:U}=g(`useSetup:0:0`,()=>f(()=>{let{as:t,shape:n,half:r,size:i,fit:a,position:o,tone:s,bordered:c,ring:u,shadow:d,interactive:f,src:p,alt:m,imageProps:h,wrapperClassName:_,imageClassName:v,content:y,contentClassName:b,caption:x,captionClassName:S,className:C,children:T,...E}=e,D=g(`computed:1:0`,()=>l(()=>j({shape:e.shape===void 0?`squircle`:e.shape,half:e.half,size:e.size,fit:e.fit===void 0?`cover`:e.fit,position:e.position,tone:e.tone,bordered:e.bordered,ring:e.ring,shadow:e.shadow,interactive:e.interactive}))),O=g(`computed:1:1`,()=>l(()=>e.content??e.children)),k=O;return{__rue_rest_omit_0:t,__rue_rest_omit_1:n,__rue_rest_omit_2:r,__rue_rest_omit_3:i,__rue_rest_omit_4:a,__rue_rest_omit_5:o,__rue_rest_omit_6:s,__rue_rest_omit_7:c,__rue_rest_omit_8:u,__rue_rest_omit_9:d,__rue_rest_omit_10:f,__rue_rest_omit_11:p,__rue_rest_omit_12:m,__rue_rest_omit_13:h,__rue_rest_omit_14:_,__rue_rest_omit_15:v,__rue_rest_omit_16:y,__rue_rest_omit_17:b,__rue_rest_omit_18:x,__rue_rest_omit_19:S,__rue_rest_omit_20:C,__rue_rest_omit_21:T,rest:E,cls:D,contentNode:O,mediaMode:g(`computed:1:2`,()=>l(()=>!!e.src&&(w(k.get())||e.caption!=null||e.wrapperClassName!=null||e.imageClassName!=null||e.contentClassName!=null||e.captionClassName!=null||(e.as===void 0?`img`:e.as)===`figure`)))}}));if(U.get()){let r=C(`relative inline-flex flex-col items-center gap-3`,e.wrapperClassName);return(e.as===void 0?`img`:e.as)===`div`?u(l=>{let f=i(`div`,l);o(()=>{d(f,B)}),o(()=>{m(f,r)});let h=i(`div`,f);n(f,h),m(h,`relative inline-flex`);let g=i(`img`,h);n(h,g),o(()=>{d(g,e.imageProps)}),o(()=>{c(g,`src`,String(e.src))}),o(()=>{c(g,`alt`,String(e.alt))}),o(()=>{m(g,C(C(V.get(),e.className),e.imageClassName))});let _=a(`rue:slot:anchor`);n(h,_),o(()=>{let r=w(H.get())?u(()=>{let r=s(),c=i(`div`,r);n(r,c),o(()=>{m(c,C(`absolute inset-0 grid place-items-center p-4 text-center`,e.contentClassName))});let l=a(`rue:slot:anchor`);return n(c,l),o(()=>{let e=H.get();t(()=>p(e,c,l))}),r}):``;t(()=>p(r,h,_))});let v=a(`rue:slot:anchor`);return n(f,v),o(()=>{let r=e.caption==null?``:u(()=>{let r=s(),c=i(`div`,r);n(r,c),o(()=>{m(c,C(`text-center text-sm opacity-70`,e.captionClassName))});let l=a(`rue:slot:anchor`);return n(c,l),o(()=>{let n=e.caption;t(()=>p(n,c,l))}),r});t(()=>p(r,f,v))}),f}):u(l=>{let f=i(`figure`,l);o(()=>{d(f,B)}),o(()=>{m(f,r)});let h=i(`div`,f);n(f,h),m(h,`relative inline-flex`);let g=i(`img`,h);n(h,g),o(()=>{d(g,e.imageProps)}),o(()=>{c(g,`src`,String(e.src))}),o(()=>{c(g,`alt`,String(e.alt))}),o(()=>{m(g,C(C(V.get(),e.className),e.imageClassName))});let _=a(`rue:slot:anchor`);n(h,_),o(()=>{let r=w(H.get())?u(()=>{let r=s(),c=i(`div`,r);n(r,c),o(()=>{m(c,C(`absolute inset-0 grid place-items-center p-4 text-center`,e.contentClassName))});let l=a(`rue:slot:anchor`);return n(c,l),o(()=>{let e=H.get();t(()=>p(e,c,l))}),r}):``;t(()=>p(r,h,_))});let v=a(`rue:slot:anchor`);return n(f,v),o(()=>{let r=e.caption==null?``:u(()=>{let r=s(),c=i(`figcaption`,r);n(r,c),o(()=>{m(c,C(`text-center text-sm opacity-70`,e.captionClassName))});let l=a(`rue:slot:anchor`);return n(c,l),o(()=>{let n=e.caption;t(()=>p(n,c,l))}),r});t(()=>p(r,f,v))}),f})}let W=C(V.get(),e.className);return(e.as===void 0?`img`:e.as)===`div`?u(r=>{let s=i(`div`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`span`?u(r=>{let s=i(`span`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`figure`?u(r=>{let s=i(`figure`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`section`?u(r=>{let s=i(`section`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`article`?u(r=>{let s=i(`article`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`a`?u(r=>{let s=i(`a`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):(e.as===void 0?`img`:e.as)===`button`?u(r=>{let s=i(`button`,r);o(()=>{d(s,B)}),o(()=>{m(s,W)});let c=a(`rue:children:anchor`);return n(s,c),o(()=>{let n=e.children;t(()=>p(n,s,c))}),s}):u(t=>{let n=i(`img`,t);return o(()=>{d(n,B)}),o(()=>{c(n,`src`,String(e.src))}),o(()=>{c(n,`alt`,String(e.alt))}),o(()=>{m(n,W)}),n})},N=`https://picsum.photos/320/320?grayscale`,P=`https://picsum.photos/420/240?grayscale`,F=`https://picsum.photos/240/420?grayscale`,I=[`squircle`,`heart`,`hexagon`,`hexagon-2`,`decagon`,`pentagon`,`diamond`,`square`,`circle`],L=[`star`,`star-2`],R=[`triangle`,`triangle-2`,`triangle-3`,`triangle-4`],z=[`xs`,`sm`,`md`,`lg`,`xl`,`2xl`],B=[{label:`cover`,fit:`cover`,src:P},{label:`contain`,fit:`contain`,src:F},{label:`fill`,fit:`fill`,src:P}],V=[{label:`Base`,tone:`base`},{label:`Primary`,tone:`primary`},{label:`Secondary`,tone:`secondary`},{label:`Accent`,tone:`accent`},{label:`Success`,tone:`success`},{label:`Warning`,tone:`warning`}],H=[{prop:`as`,description:`指定渲染标签，默认输出 img，也可渲染 div、figure 等任意宿主元素`,type:`string`,defaultValue:`'img'`},{prop:`shape`,description:`遮罩形状，覆盖当前支持的全部 mask-* 造型`,type:`'squircle' | 'heart' | 'hexagon' | 'hexagon-2' | 'decagon' | 'pentagon' | 'diamond' | 'square' | 'circle' | 'star' | 'star-2' | 'triangle' | 'triangle-2' | 'triangle-3' | 'triangle-4'`,defaultValue:`'squircle'`},{prop:`half`,description:`半边遮罩；支持数字写法，也支持 start / end 语义别名`,type:`'1' | '2' | 'start' | 'end'`,defaultValue:`-`},{prop:`size`,description:`语义尺寸，映射到一组常用正方形尺寸 class`,type:`'xs' | 'sm' | 'md' | 'lg' | 'xl' | '2xl' | '3xl'`,defaultValue:`-`},{prop:`fit`,description:`媒体内容适配模式，输出 object-* 类名`,type:`'cover' | 'contain' | 'fill' | 'none' | 'scale-down'`,defaultValue:`'cover'`},{prop:`tone`,description:`给非图片宿主补齐背景与前景色，方便做头像牌、数字徽记和内容卡片`,type:`'base' | 'neutral' | 'primary' | 'secondary' | 'accent' | 'info' | 'success' | 'warning' | 'error'`,defaultValue:`-`},{prop:`bordered`,description:`追加轻量内描边，适合浅背景图片或卡片`,type:`boolean`,defaultValue:`false`},{prop:`ring`,description:`追加 ring 与 offset，tone 存在时会自动继承对应的环颜色`,type:`boolean`,defaultValue:`false`},{prop:`shadow`,description:`追加投影，适合头像、封面和内容模块`,type:`boolean`,defaultValue:`false`},{prop:`interactive`,description:`追加轻量 hover 动效，方便做可点击素材墙或精选卡片`,type:`boolean`,defaultValue:`false`},{prop:`className`,description:`透传自定义样式类，可与组件生成的 mask 类叠加`,type:`string`,defaultValue:`-`}],U=r=>u(c=>{let l=i(`div`,c);m(l,`component-preview not-prose text-base-content my-6 lg:my-12`);let d=i(`div`,l);n(l,d),m(d,`flex flex-wrap items-start justify-between gap-3`);let f=i(`div`,d);n(d,f);let g=i(`h2`,f);n(f,g),m(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),n(g,e(`# `));let _=a(`rue:slot:anchor`);n(g,_),o(()=>{let e=r.title;t(()=>p(e,g,_))});let v=a(`rue:slot:anchor`);n(f,v),o(()=>{let e=r.summary?u(()=>{let e=s(),c=i(`p`,e);n(e,c),m(c,`m-0 text-sm opacity-70`);let l=a(`rue:slot:anchor`);return n(c,l),o(()=>{let e=r.summary;t(()=>p(e,c,l))}),e}):``;t(()=>p(e,f,v))});let y=a(`rue:component:anchor`);n(l,y),o(()=>{let e=h(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:r.tab.value,onChange:e=>r.tab.value=e,className:`mb-3 mt-4`});t(()=>p(e,l,y))});let S=a(`rue:slot:anchor`);return n(l,S),o(()=>{let e=r.tab.value===`preview`?r.preview():u(()=>{let e=s(),i=a(`rue:component:anchor`);return n(e,i),o(()=>{let n=h(b,{className:`mt-2`,lang:`tsx`,code:r.code});t(()=>p(n,e,i))}),e});t(()=>p(e,l,S))}),l}),W=r=>u(l=>{let d=i(`div`,l);m(d,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let f=i(`table`,d);n(d,f),m(f,`table table-zebra`);let h=i(`thead`,f);n(f,h);let g=i(`tr`,h);n(h,g);let v=i(`th`,g);n(g,v),n(v,e(`属性`));let y=i(`th`,g);n(g,y),n(y,e(`说明`));let b=i(`th`,g);n(g,b),n(b,e(`类型`));let x=i(`th`,g);n(g,x),n(x,e(`默认值`));let S=i(`tbody`,f);n(f,S);let C=a(`rue:list:start`),w=a(`rue:list:end`);n(S,C),n(S,w);let T=new Map;return o(()=>{T=_({items:r.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(e,r,l,d,f)=>{p(u(()=>{let r=s(),l=i(`tr`,r);n(r,l),o(()=>{c(l,`key`,String(e.prop))});let u=i(`td`,l);n(l,u);let d=i(`code`,u);n(u,d);let f=a(`rue:slot:anchor`);n(d,f),o(()=>{let n=e.prop;t(()=>p(n,d,f))});let m=i(`td`,l);n(l,m);let h=a(`rue:slot:anchor`);n(m,h),o(()=>{let n=e.description;t(()=>p(n,m,h))});let g=i(`td`,l);n(l,g);let _=i(`code`,g);n(g,_);let v=a(`rue:slot:anchor`);n(_,v),o(()=>{let n=e.type;t(()=>p(n,_,v))});let y=i(`td`,l);n(l,y);let b=i(`code`,y);n(y,b);let x=a(`rue:slot:anchor`);return n(b,x),o(()=>{let n=e.defaultValue;t(()=>p(n,b,x))}),r}),r,l)}})}),d}),G=()=>{let{tabShapes:c,tabStars:l,tabTriangles:d,tabHalf:_,tabSize:b,tabFit:x,tabTone:C}=g(`useSetup:0:0`,()=>f(()=>({tabShapes:g(`ref:1:0`,()=>r(`preview`)),tabStars:g(`ref:1:1`,()=>r(`preview`)),tabTriangles:g(`ref:1:2`,()=>r(`preview`)),tabHalf:g(`ref:1:3`,()=>r(`preview`)),tabSize:g(`ref:1:4`,()=>r(`preview`)),tabFit:g(`ref:1:5`,()=>r(`preview`)),tabTone:g(`ref:1:6`,()=>r(`preview`))})));return u(r=>{let f=s(),g=a(`rue:component:anchor`);return n(f,g),p(h(S,{children:u(()=>{let r=s(),u=i(`div`,r);n(r,u),m(u,`max-w-none prose prose-sm md:prose-base`);let f=i(`h1`,u);n(u,f),n(f,e(`Mask 形状裁切`));let g=i(`p`,u);n(u,g),m(g,`text-sm mt-3 mb-3`),n(g,e(`Mask 现在不只是原始 class 的薄封装。它保留 Rue 的轻量视觉路线，同时补上尺寸、fit、tone、ring 与交互态这些更适合实际页面搭建的语义化能力。`));let S=a(`rue:component:anchor`);n(u,S),o(()=>{let e=h(U,{title:`Core shapes`,summary:`保留原有基础形状示例，并统一到更整洁的卡片布局里。`,tab:c,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body flex flex-wrap gap-4`,"data-testid":`mask-shapes-demo`,children:I.map(e=>y(M,{shape:e,src:N,alt:e,size:`md`,bordered:!0},e))})}),code:`<Mask shape="squircle" src="${N}" alt="squircle" size="md" bordered />
...
<Mask shape="circle" src="${N}" alt="circle" size="md" bordered />`});t(()=>p(e,u,S))});let w=a(`rue:component:anchor`);n(u,w),o(()=>{let e=h(U,{title:`Star variants`,summary:`保留星形与粗星形示例，增加 ring 和 hover，适合头像墙或精选内容。`,tab:l,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body flex flex-wrap gap-5`,children:L.map(e=>y(M,{shape:e,src:N,alt:e,size:`lg`,ring:!0,shadow:!0,interactive:!0},e))})}),code:`<Mask shape="star" src="${N}" alt="star" size="lg" ring shadow interactive />
<Mask shape="star-2" src="${N}" alt="star-2" size="lg" ring shadow interactive />`});t(()=>p(e,u,w))});let T=a(`rue:component:anchor`);n(u,T),o(()=>{let e=h(U,{title:`Triangle variants`,summary:`保留四向三角形示例，并通过统一尺寸让方向差异更好观察。`,tab:d,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body flex flex-wrap gap-5`,children:R.map(e=>y(M,{shape:e,src:N,alt:e,size:`lg`,bordered:!0,shadow:!0},e))})}),code:`<Mask shape="triangle" src="${N}" alt="triangle" size="lg" bordered shadow />
...
<Mask shape="triangle-4" src="${N}" alt="triangle-4" size="lg" bordered shadow />`});t(()=>p(e,u,T))});let E=a(`rue:component:anchor`);n(u,E),o(()=>{let e=h(U,{title:`Half modifiers and arbitrary host`,summary:`保留 half modifier 与任意宿主演示，并补上 start / end 语义别名。`,tab:_,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap items-center gap-6`,children:[y(M,{shape:`star`,half:`1`,src:N,alt:`star half 1`,size:`lg`,ring:!0}),y(M,{shape:`star`,half:`2`,src:N,alt:`star half 2`,size:`lg`,ring:!0}),y(M,{shape:`diamond`,half:`start`,src:N,alt:`diamond start`,size:`lg`,bordered:!0}),y(M,{as:`div`,shape:`diamond`,tone:`primary`,size:`lg`,ring:!0,shadow:!0,className:`grid place-content-center text-sm font-semibold uppercase tracking-[0.2em]`,"data-testid":`mask-host-demo`,children:`Host`})]})}),code:`<Mask shape="star" half="1" src="${N}" alt="star half 1" size="lg" ring />
...
</div>`});t(()=>p(e,u,k))});let A=i(`div`,u);n(u,A),m(A,`my-8`);let j=i(`h2`,A);n(A,j),m(j,`mt-0`),n(j,e(`API`));let G=a(`rue:component:anchor`);return n(A,G),o(()=>{let e=h(W,{rows:H});t(()=>p(e,A,G))}),r})}),f,g),f})};export{G as default};