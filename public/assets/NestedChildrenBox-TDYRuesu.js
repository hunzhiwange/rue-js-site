...
`,Demo:()=>s(n=>{let i=e(`div`,n);o(i,`card bg-base-100 shadow`);let l=e(`div`,i);r(i,l),o(l,`card-body`);let f=e(`h2`,l);r(l,f),o(f,`text-2xl font-semibold`),r(f,c(`嵌套 children Box`));let m=a(`rue:component:anchor`);return r(l,m),u(d(p,{title:`嵌套 children`,background:`blue`,children:d(p,{title:`内层 Box`,background:`red`,children:s(()=>{let n=t(),i=e(`span`,n);r(n,i),r(i,c(`嵌套的子元素`));let o=a(`rue:component:anchor`);return r(n,o),u(d(p,{title:`内层 Box2`,background:`yellow`,children:s(()=>{let n=t(),i=e(`span`,n);r(n,i),r(i,c(`嵌套的子元素2`));let o=a(`rue:component:anchor`);return r(n,o),u(d(p,{title:`内层 Box3`,background:`green`,children:s(()=>{let n=t(),i=e(`span`,n);return r(n,i),r(i,c(`嵌套的子元素3`)),n})}),n,o),n})}),n,o),n})})}),l,m),i})});export{m as default};