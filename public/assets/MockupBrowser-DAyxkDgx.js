...
</MockupBrowser>`});i(()=>d(e,n,de))});let P=e(`h2`,n);a(n,P),p(P,`id`,`mockup-browser-api`),a(P,u(`API`));let F=e(`p`,n);a(n,F),a(F,u(`MockupBrowser 现在支持推荐快捷模式和原始组合模式两套写法。`));let I=e(`h3`,n);a(n,I),a(I,u(`MockupBrowser`));let L=s(`rue:component:anchor`);a(n,L),o(()=>{let e=m(M,{rows:te});i(()=>d(e,n,L))});let R=e(`h3`,n);a(n,R),a(R,u(`MockupBrowser.Toolbar`));let z=s(`rue:component:anchor`);a(n,z),o(()=>{let e=m(M,{rows:ne});i(()=>d(e,n,z))});let B=e(`h3`,n);a(n,B),a(B,u(`MockupBrowser.AddressBar`));let V=s(`rue:component:anchor`);a(n,V),o(()=>{let e=m(M,{rows:re});i(()=>d(e,n,V))});let H=e(`h3`,n);a(n,H),a(H,u(`MockupBrowser.Content`));let fe=s(`rue:component:anchor`);a(n,fe),o(()=>{let e=m(M,{rows:ie});i(()=>d(e,n,fe))});let U=e(`div`,n);a(n,U),c(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=e(`h3`,U);a(U,W),c(W,`mt-0 mb-3 text-base font-semibold`),a(W,u(`推荐写法对照`));let G=e(`div`,U);a(U,G),c(G,`grid gap-2 text-sm md:grid-cols-2`);let K=e(`div`,G);a(G,K);let pe=e(`code`,K);a(K,pe),a(pe,u(`url`)),a(K,u(`适合快速生成地址栏`));let q=e(`div`,G);a(G,q);let me=e(`code`,q);a(q,me),a(me,u(`contentClassName`)),a(q,u(`适合直接包裹内容区`));let J=e(`div`,G);a(G,J);let he=e(`code`,J);a(J,he),a(he,u(`Toolbar + AddressBar + Content`)),a(J,u(`适合需要细粒度控制的页面`));let Y=e(`div`,G);a(G,Y),a(Y,u(`旧的手写`));let ge=e(`code`,Y);a(Y,ge),a(ge,u(`Toolbar`)),a(Y,u(`结构仍然完全可用`));let _e=e(`h2`,n);a(n,_e),a(_e,u(`FAQ`));let ve=e(`h3`,n);a(n,ve),a(ve,u(`什么时候用快捷 props，什么时候用子组件？`));let X=e(`p`,n);a(n,X),a(X,u(`如果只是想快速放一个带地址栏的浏览器框，优先用`));let ye=e(`code`,X);a(X,ye),a(ye,u(`url`)),a(X,u(`、`));let be=e(`code`,X);a(X,be),a(be,u(`toolbarEnd`)),a(X,u(`、`));let xe=e(`code`,X);a(X,xe),a(xe,u(`contentClassName`)),a(X,u(`这些快捷 props。需要更细的布局控制时，再切到`));let Se=h(X);a(X,Se),f(Se,` `);let Ce=e(`code`,X);a(X,Ce),a(Ce,u(`MockupBrowser.Toolbar`)),a(X,u(`、`));let we=e(`code`,X);a(X,we),a(we,u(`MockupBrowser.AddressBar`)),a(X,u(`和`));let Te=h(X);a(X,Te),f(Te,` `);let Ee=e(`code`,X);a(X,Ee),a(Ee,u(`MockupBrowser.Content`)),a(X,u(`。`));let De=e(`h3`,n);a(n,De),a(De,u(`原来的 demo 写法会失效吗？`));let Z=e(`p`,n);a(n,Z),a(Z,u(`不会。原来的`));let Oe=e(`code`,Z);a(Z,Oe),a(Oe,u(`children + MockupBrowser.Toolbar`)),a(Z,u(`结构仍然保留；当前页面里的 “browser mockup with border” 和 “browser mockup with background color” 就是旧写法的直接保留版。`));let Q=e(`h3`,n);a(n,Q),a(Q,u(`Content 和根节点上的 contentClassName 有什么区别？`));let $=e(`p`,n);a(n,$);let ke=e(`code`,$);a($,ke),a(ke,u(`contentClassName`));let Ae=h($);a($,Ae),f(Ae,` `),a($,u(`适合推荐写法，直接让根组件帮你包一层内容区；如果你还需要分别控制`));let je=e(`code`,$);a($,je),a(je,u(`padding`)),a($,u(`、`));let Me=e(`code`,$);a($,Me),a(Me,u(`background`)),a($,u(`或自己拆更多节点，就更适合直接使用`));let Ne=h($);a($,Ne),f(Ne,` `);let Pe=e(`code`,$);return a($,Pe),a(Pe,u(`MockupBrowser.Content`)),a($,u(`。`)),t})}),n,_),n})};export{N as default};