...
}`,Be=()=>{let{tabs:n}=T(`useSetup:0:0:dup1`,()=>m(()=>({tabs:{basic:T(`ref:1:16`,()=>r(`preview`)),multiline:T(`ref:1:17`,()=>r(`preview`)),image:T(`ref:1:18`,()=>r(`preview`)),inherit:T(`ref:1:19`,()=>r(`preview`)),custom:T(`ref:1:20`,()=>r(`preview`))}})));return u(r=>{let i=f(),a=b(`rue:component:anchor`);return e(i,a),p(v(P,{children:u(()=>{let r=f(),i=_(`div`,r);e(r,i),h(i,`max-w-none prose prose-sm md:prose-base`);let a=_(`h1`,i);e(i,a),e(a,c(`Watermark 水印`));let o=_(`p`,i);e(i,o),h(o,`mt-3 mb-3 text-sm`),e(o,c(`Rue 的 Watermark 不照搬其他组件库的视觉，而是把能力落成更适合当前设计站点的轻量覆盖层。 你可以直接给任意容器加文字或图片水印，同时保持按钮、卡片、统计区这些内容本身的交互。`));let s=_(`h2`,i);e(i,s),e(s,c(`何时使用`));let l=_(`ul`,i);e(i,l);let u=_(`li`,l);e(l,u),e(u,c(`需要给卡片、报表、详情页加上“内部预览”“草稿”“仅限共享”等视觉标记。`));let d=_(`li`,l);e(l,d),e(d,c(`需要图片或文字水印覆盖在任意内容上，但又不希望阻断按钮、链接和表单的交互。`));let m=_(`li`,l);e(l,m),e(m,c(`需要局部容器继承上层水印图案，而不是为每一块内容重复写一遍配置。`));let g=b(`rue:component:anchor`);e(i,g),t(()=>{let e=v(F,{title:`Basic text watermark`,summary:`最直接的用法：给一个内容容器加上文本水印，按钮仍然可以正常点击。`,tab:n.basic,preview:k(Z,{content:`Rue Design`,className:`rounded-[2rem] border border-base-300 bg-gradient-to-br from-base-100 via-base-100 to-base-200 shadow-sm`,children:O(`div`,{className:`grid gap-6 px-6 py-8 md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] md:px-8`,children:[O(`div`,{className:`space-y-4`,children:[k(M,{variant:`secondary`,children:`Internal Preview`}),k(`h3`,{className:`m-0 text-3xl font-black tracking-tight text-base-content md:text-4xl`,children:`协作面板正在生成新一轮可共享快照`}),k(`p`,{className:`m-0 max-w-2xl text-sm leading-7 text-base-content/70`,children:`水印覆盖层默认在视觉上方，但采用 pointer-events none，不会挡住卡片、按钮和其它交互控件。`}),O(`div`,{className:`flex flex-wrap gap-3`,children:[k(A,{color:`primary`,children:`导出摘要`}),k(A,{type:`outlined`,children:`查看访问日志`})]})]}),k(j,{className:`bg-base-100/85 shadow-sm backdrop-blur-sm`,children:k(j.Body,{className:`gap-4`,children:Me.map(e=>O(`div`,{className:`rounded-box border border-base-300/70 bg-base-100/70 px-4 py-3`,children:[k(`div`,{className:`text-xs uppercase tracking-[0.2em] text-base-content/50`,children:e.label}),k(`div`,{className:`mt-2 text-2xl font-bold text-base-content`,children:e.value}),k(`div`,{className:`mt-1 text-sm text-base-content/60`,children:e.detail})]},e.label))})})]})}),code:`const stats = [
...
</Watermark>`});y(()=>p(e,i,C))});let w=b(`rue:component:anchor`);e(i,w),t(()=>{let e=v(F,{title:`Custom controls`,summary:`把可调示例 落到 Rue 风格里，用 Range 的按帧更新快速调整排版参数。`,tab:n.custom,preview:k(Re,{}),code:ze});y(()=>p(e,i,w))});let T=_(`h2`,i);e(i,T),e(T,c(`API`));let E=b(`rue:component:anchor`);return e(i,E),t(()=>{let e=v(Pe,{rows:Ne});y(()=>p(e,i,E))}),r})}),i,a),i})};export{Be as default};