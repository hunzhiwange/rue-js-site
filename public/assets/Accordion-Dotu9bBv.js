import{$ as e,Et as t,G as n,H as r,K as i,W as a,_t as o,d as s,kt as c,l,q as u,t as d,tt as f,u as p,xt as m,y as h}from"./vapor-runtime-BAZOdMd8.js";import{a as g,n as _}from"./vapor-helpers-vapor-BvUp1QnH.js";import{n as v,t as y}from"./src-DZJ4J6sD.js";import{n as b}from"./SidebarPlaygroundDesign-COnQ_JKl.js";import{t as x}from"./Code-DY4Ua5uc.js";import{t as S}from"./tabs-Casd077O.js";var C=0,w=(e,t)=>e?t?`${e} ${t}`:e:t??``,T=e=>{let t=[];return e.forEach(e=>{t.some(t=>t===e)||t.push(e)}),t},E=(e,t)=>{let n=T(Array.isArray(e)?e:[]);return t?n:n.slice(0,1)},D=e=>e==null?[]:[e],O=(e,t,n,r,i,a)=>E(r===void 0?t===void 0?i===void 0?n===void 0?e.filter(e=>e.open).map(e=>e.key):D(n):i:D(t):r,a),k=(e,t,n)=>n===`open`?!0:n===`close`?!1:typeof e==`boolean`?e:typeof t==`boolean`?t:!1,A=(e,t)=>t===`open`?`collapse-open`:t===`close`?`collapse-close`:e?`collapse-open`:`collapse-close`,j=(e,t)=>{let n=t?.getRootNode?.(),r=n&&typeof n.querySelectorAll==`function`?n:typeof document<`u`?document:null;return r?Array.from(r.querySelectorAll(`[data-rue-accordion-group]`)).filter(t=>t.dataset.rueAccordionGroup===e):[]},M=e=>Array.from(e.children).find(e=>e instanceof HTMLInputElement&&(e.type===`checkbox`||e.type===`radio`)),N=e=>Array.from(e.children).find(e=>e instanceof HTMLElement&&e.classList.contains(`collapse-title`)),P=(e,t,n)=>{if(!(e instanceof HTMLElement))return;e.classList.remove(`collapse-open`,`collapse-close`),e.classList.add(A(t,n));let r=M(e);r&&r.checked!==t&&(r.checked=t),e instanceof HTMLDetailsElement&&e.open!==t&&(e.open=t);let i=N(e);i&&i.setAttribute(`aria-expanded`,t?`true`:`false`)},F=(e,t,n,r,i)=>r?n?T([...e,t]):e.filter(e=>e!==t):n?[t]:i?[]:e.some(e=>e===t)?[...e]:[t],I=e=>e?.type===`radio`,L=e=>e.description==null&&e.extra==null?e.title:v(`div`,{className:`flex w-full items-start justify-between gap-3`,children:[v(`div`,{className:`min-w-0 flex-1`,children:[y(`div`,{children:e.title}),e.description==null?null:y(`div`,{className:w(`mt-1 text-xs opacity-70`,e.descriptionClassName),children:e.description})]}),e.extra==null?null:y(`div`,{className:w(`shrink-0 text-xs opacity-70`,e.extraClassName),children:e.extra})]}),R=Object.assign(({icon:e,force:t,use:n=`radio`,name:r,open:i,defaultOpen:a,activeKey:s,defaultActiveKey:c,openKeys:l,defaultOpenKeys:u,multiple:d,collapsible:f,disabled:p,className:m,titleClassName:g,contentClassName:_,children:b,items:x,onChange:S,onToggle:T})=>{let N=x?.map((e,t)=>({...e,key:e.key??t,index:t}))??[],R=o(`rue-accordion-${C++}`),z=o(k(i,a,t)),B=o(O(N,s,c,l,u,d)),V=r??R.value,H=N.length>0,U=l!==void 0||s!==void 0,W=t===`open`?!0:t===`close`?!1:i===void 0?z.value:!!i,G=()=>l===void 0?s===void 0?B.value:E(D(s),d):E(l,d),K=(e,n)=>{j(V,n).forEach(n=>{let r=N[Number(n.dataset.rueAccordionIndex??-1)];if(!r)return;let i=r.force??t;P(n,i===`open`?!0:i===`close`?!1:e.some(e=>e===r.key),i)})},q=e=>{j(V,e).forEach(e=>{let n=e.dataset.rueAccordionForce??t,r=M(e);P(e,n===`open`?!0:n===`close`?!1:e instanceof HTMLDetailsElement?e.open:r?.checked===!0,n)})},J=(e,n,r)=>{let i=e.force??t;if(p||e.disabled||i)return;let a=F(G(),e.key,n,d,f),o=a.some(t=>t===e.key);U||(B.value=a,K(a,r)),S&&S(d?a:a[0]??null,{key:e.key,index:e.index,open:o,item:e})},Y=(e,n)=>{p||t||(i===void 0&&(z.value=e,q(n)),T&&T(e,{key:V,index:0,open:e}))};if(H)return y(h,{children:N.map(r=>{let i=r.use??n,a=r.icon??e,o=r.force??t,s=o===`open`?!0:o===`close`?!1:G().some(e=>e===r.key),c=w(`collapse`,A(s,o));a===`arrow`&&(c+=` collapse-arrow`),a===`plus`&&(c+=` collapse-plus`),m&&(c+=` ${m}`),r.className&&(c+=` ${r.className}`),(p||r.disabled)&&(c+=` opacity-70`);let l=a===`arrow`&&(r.description!=null||r.extra!=null)?`after:top-6`:void 0,u=w(w(`collapse-title`,g),w(r.titleClassName,l)),h=w(w(`collapse-content`,_),r.contentClassName);if(i===`details`)return v(`details`,{className:c,name:V,open:s,"data-rue-accordion-group":V,"data-rue-accordion-index":String(r.index),"data-rue-accordion-force":o,children:[y(`summary`,{className:u,"aria-expanded":s?`true`:`false`,onClick:e=>{e.preventDefault(),J(r,!s,e.currentTarget)},children:L(r)}),y(`div`,{className:h,children:r.content})]},r.key);let b=d?`checkbox`:`radio`;return v(`div`,{className:c,"data-rue-accordion-group":V,"data-rue-accordion-index":String(r.index),"data-rue-accordion-force":o,children:[y(`input`,{type:b,name:b===`radio`?V:void 0,checked:s,disabled:p||r.disabled||!!o,onClick:e=>{let t=e.currentTarget;!f||!s||!I(t)||(e.preventDefault(),t.checked=!1,J(r,!1,t))},onChange:e=>{let t=e.target.checked;J(r,t,e.currentTarget)}}),y(`div`,{className:u,"aria-expanded":s?`true`:`false`,children:L(r)}),y(`div`,{className:h,children:r.content})]},r.key)})});let X=w(`collapse`,A(W,t));if(e===`arrow`&&(X+=` collapse-arrow`),e===`plus`&&(X+=` collapse-plus`),m&&(X+=` ${m}`),p&&(X+=` opacity-70`),n===`details`)return y(`details`,{className:X,name:V,open:W,"data-rue-accordion-group":V,"data-rue-accordion-force":t,onToggle:e=>{let n=e.currentTarget.open;if(p||t){e.currentTarget.open!==W&&(e.currentTarget.open=W);return}Y(n,e.currentTarget)},children:b});let Z=`radio`;return v(`div`,{className:X,"data-rue-accordion-group":V,"data-rue-accordion-force":t,children:[y(`input`,{type:Z,name:Z===`radio`?V:void 0,checked:W,disabled:p||!!t,onClick:e=>{let t=e.currentTarget;!f||!W||!I(t)||(e.preventDefault(),t.checked=!1,Y(!1,t))},onChange:e=>{let t=e.target.checked;Y(t,e.currentTarget)}}),b]})},{Title:({className:e,children:t,as:n=`div`})=>{let r=w(`collapse-title`,e);return n===`summary`?y(`summary`,{className:r,children:t}):n===`button`?y(`button`,{type:`button`,className:r,children:t}):y(`div`,{className:r,children:t})},Content:({className:e,children:t})=>y(`div`,{className:w(`collapse-content`,e),children:t})}),z=e=>s(t=>{let o=i(`div`,t);f(o,`component-preview not-prose text-base-content my-6 lg:my-12`);let p=i(`div`,o);r(o,p),f(p,`flex flex-wrap items-start justify-between gap-3`);let h=i(`div`,p);r(p,h);let g=i(`h2`,h);r(h,g),f(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),r(g,u(`# `));let _=a(`rue:slot:anchor`);r(g,_),c(()=>{let t=e.title;m(()=>l(t,g,_))});let v=a(`rue:slot:anchor`);r(h,v),c(()=>{let t=e.summary?s(()=>{let t=n(),o=i(`p`,t);r(t,o),f(o,`m-0 text-sm opacity-70`);let s=a(`rue:slot:anchor`);return r(o,s),c(()=>{let t=e.summary;m(()=>l(t,o,s))}),t}):``;m(()=>l(t,h,v))});let y=a(`rue:component:anchor`);r(o,y),c(()=>{let t=d(S,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`TSX代码`}],activeKey:e.tab.value,onChange:t=>e.tab.value=t,className:`mb-3 mt-4`});m(()=>l(t,o,y))});let b=a(`rue:slot:anchor`);return r(o,b),c(()=>{let t=e.tab.value===`preview`?e.preview():s(()=>{let t=n(),i=a(`rue:component:anchor`);return r(t,i),c(()=>{let n=d(x,{className:`mt-2`,lang:`tsx`,code:e.code});m(()=>l(n,t,i))}),t});m(()=>l(t,o,b))}),o}),B=t=>s(o=>{let d=i(`div`,o);f(d,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let p=i(`table`,d);r(d,p),f(p,`table table-zebra`);let h=i(`thead`,p);r(p,h);let g=i(`tr`,h);r(h,g);let v=i(`th`,g);r(g,v),r(v,u(`属性`));let y=i(`th`,g);r(g,y),r(y,u(`说明`));let b=i(`th`,g);r(g,b),r(b,u(`类型`));let x=i(`th`,g);r(g,x),r(x,u(`默认值`));let S=i(`tbody`,p);r(p,S);let C=a(`rue:list:start`),w=a(`rue:list:end`);r(S,C),r(S,w);let T=new Map;return c(()=>{T=_({items:t.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(t,o,u,d,f)=>{l(s(()=>{let o=n(),s=i(`tr`,o);r(o,s),c(()=>{e(s,`key`,String(t.prop))});let u=i(`td`,s);r(s,u);let d=i(`code`,u);r(u,d);let f=a(`rue:slot:anchor`);r(d,f),c(()=>{let e=t.prop;m(()=>l(e,d,f))});let p=i(`td`,s);r(s,p);let h=a(`rue:slot:anchor`);r(p,h),c(()=>{let e=t.description;m(()=>l(e,p,h))});let g=i(`td`,s);r(s,g);let _=i(`code`,g);r(g,_);let v=a(`rue:slot:anchor`);r(_,v),c(()=>{let e=t.type;m(()=>l(e,_,v))});let y=i(`td`,s);r(s,y);let b=i(`code`,y);r(y,b);let x=a(`rue:slot:anchor`);return r(b,x),c(()=>{let e=t.defaultValue;m(()=>l(e,b,x))}),o}),o,u)}})}),d}),V=[{key:`account`,title:`How do I create an account?`,content:`Click the "Sign Up" button in the top right corner and follow the registration process.`},{key:`password`,title:`I forgot my password. What should I do?`,content:`Click on "Forgot Password" on the login page and follow the instructions sent to your email.`},{key:`profile`,title:`How do I update my profile information?`,content:`Go to "My Account" settings and select "Edit Profile" to make changes.`}],H=[{title:`Children 组合`,desc:`保留 Accordion.Title / Accordion.Content，用于局部定制标题和内容。`},{title:`Items 驱动`,desc:`直接用 items 写标题、描述、额外信息和禁用态，适合后台配置页。`},{title:`受控状态`,desc:`通过 activeKey、openKeys、onChange 接管当前展开项。`},{title:`两种语义`,desc:`默认 radio 风格适合单开；details 适合保留可搜索内容与原生语义。`}],U=[{prop:`activeKey`,description:`items 模式下的受控单开 key`,type:`string | number | null`,defaultValue:`-`},{prop:`className`,description:`追加到每个 Accordion 根节点的类名`,type:`string`,defaultValue:`-`},{prop:`collapsible`,description:`单开模式下允许把当前面板再次折叠`,type:`boolean`,defaultValue:`false`},{prop:`contentClassName`,description:`items 模式下统一追加到内容区域的类名`,type:`string`,defaultValue:`-`},{prop:`defaultActiveKey`,description:`items 模式下的非受控默认单开 key`,type:`string | number | null`,defaultValue:`-`},{prop:`defaultOpen`,description:`children 模式下的非受控默认展开状态`,type:`boolean`,defaultValue:`false`},{prop:`defaultOpenKeys`,description:`items 模式下的非受控默认多开 keys`,type:`Array<string | number>`,defaultValue:`-`},{prop:`disabled`,description:`禁用整个 Accordion 或当前 items 组的交互`,type:`boolean`,defaultValue:`false`},{prop:`force`,description:`强制视觉保持展开或收起，优先级高于 open 与 items 状态`,type:`'open' | 'close'`,defaultValue:`-`},{prop:`icon`,description:`标题右侧的内置指示样式`,type:`'arrow' | 'plus'`,defaultValue:`-`},{prop:`items`,description:`数据驱动渲染方式，适合 FAQ、配置面板和后台列表`,type:`AccordionDataItem[]`,defaultValue:`-`},{prop:`multiple`,description:`允许同时展开多个 items；radio 形态会切为 checkbox 行为`,type:`boolean`,defaultValue:`false`},{prop:`name`,description:`分组名；radio 与 details 语义都会复用这个名称`,type:`string`,defaultValue:`自动生成`},{prop:`onChange`,description:`items 模式下的开合回调；单开返回 key，多开返回 keys`,type:`(value, context) => void`,defaultValue:`-`},{prop:`onToggle`,description:`children 模式下的单项开合回调`,type:`(open, context) => void`,defaultValue:`-`},{prop:`open`,description:`children 模式下的受控展开状态`,type:`boolean`,defaultValue:`-`},{prop:`openKeys`,description:`items 模式下的受控多开 keys`,type:`Array<string | number>`,defaultValue:`-`},{prop:`titleClassName`,description:`items 模式下统一追加到标题区域的类名`,type:`string`,defaultValue:`-`},{prop:`use`,description:`切换 radio 或 details 两种结构输出`,type:`'radio' | 'details'`,defaultValue:`'radio'`}],W=[{prop:`className`,description:`追加到当前 item 根节点的类名`,type:`string`,defaultValue:`-`},{prop:`content`,description:`折叠区内容`,type:`any`,defaultValue:`-`},{prop:`contentClassName`,description:`内容区域类名`,type:`string`,defaultValue:`-`},{prop:`description`,description:`标题下的补充说明文字`,type:`any`,defaultValue:`-`},{prop:`descriptionClassName`,description:`说明文字类名`,type:`string`,defaultValue:`-`},{prop:`disabled`,description:`禁用当前 item 交互`,type:`boolean`,defaultValue:`false`},{prop:`extra`,description:`标题行右侧的补充信息，可用于状态标记或数字`,type:`any`,defaultValue:`-`},{prop:`extraClassName`,description:`额外信息区域类名`,type:`string`,defaultValue:`-`},{prop:`force`,description:`对单个 item 单独强制展开或收起`,type:`'open' | 'close'`,defaultValue:`-`},{prop:`icon`,description:`覆盖全局 icon 设置`,type:`'arrow' | 'plus'`,defaultValue:`-`},{prop:`key`,description:`推荐显式提供的稳定标识，用于 activeKey / openKeys 匹配`,type:`string | number`,defaultValue:`index`},{prop:`open`,description:`非受控模式下的默认展开状态`,type:`boolean`,defaultValue:`false`},{prop:`title`,description:`标题区域内容`,type:`any`,defaultValue:`-`},{prop:`titleClassName`,description:`标题区域类名`,type:`string`,defaultValue:`-`},{prop:`use`,description:`覆盖全局 use 设置`,type:`'radio' | 'details'`,defaultValue:`-`}],G=(e,t)=>s(o=>{let u=i(`div`,o);c(()=>{f(u,String(t?.containerClassName??`grid gap-3`))});let h=a(`rue:list:start`),g=a(`rue:list:end`);r(u,h),r(u,g);let v=new Map;return c(()=>{v=_({items:V||[],getKey:(t,n)=>`${e}-${t.key}`,elements:v,parent:h.parentNode,before:g,start:h,renderItem:(i,o,u,f,h)=>{let g=s(()=>{let e=n(),o=a(`rue:component:anchor`);r(e,o),c(()=>{let n=d(R.Title,{as:t?.use===`details`?`summary`:`div`,className:`font-semibold`,children:i.title});m(()=>l(n,e,o))});let s=a(`rue:component:anchor`);return r(e,s),l(d(R.Content,{className:`text-sm opacity-80`,children:i.content}),e,s),e});p(d(R,{key:`${e}-${i.key}`,name:e,use:t?.use,icon:t?.icon,collapsible:t?.collapsible,className:t?.itemClassName??`bg-base-100 border border-base-300`,defaultOpen:h===0,children:g}),o,u,f)}})}),u}),K=()=>{let{tabRadio:p,tabDetails:h,tabControlled:x,tabMultiple:S,tabRich:C,tabArrow:w,tabPlus:T,tabJoin:E,tabArrayRadio:D,tabArrayDetails:O,controlledKey:k,lastChanged:A,roadmapItems:j,faqItemsCode:M}=g(`useSetup:0:0`,()=>t(()=>({tabRadio:g(`ref:1:0`,()=>o(`preview`)),tabDetails:g(`ref:1:1`,()=>o(`preview`)),tabControlled:g(`ref:1:2`,()=>o(`preview`)),tabMultiple:g(`ref:1:3`,()=>o(`preview`)),tabRich:g(`ref:1:4`,()=>o(`preview`)),tabArrow:g(`ref:1:5`,()=>o(`preview`)),tabPlus:g(`ref:1:6`,()=>o(`preview`)),tabJoin:g(`ref:1:7`,()=>o(`preview`)),tabArrayRadio:g(`ref:1:8`,()=>o(`preview`)),tabArrayDetails:g(`ref:1:9`,()=>o(`preview`)),controlledKey:g(`ref:1:10`,()=>o(`build`)),lastChanged:g(`ref:1:11`,()=>o(`build`)),roadmapItems:[{key:`plan`,title:`Plan backlog`,description:`先确定优先级，再安排设计和开发`,extra:`Sprint 12`,content:`Collect the most urgent requirements, align on edge cases, and freeze the delivery order before implementation starts.`},{key:`build`,title:`Build feature slice`,description:`把 API、交互和回归验证收敛到同一轮里`,extra:`In progress`,content:`Ship the smallest useful slice first, then expand demos and tests around the verified behavior instead of guessing a broad design up front.`},{key:`ship`,title:`Ship and monitor`,description:`发布后持续看告警、埋点和反馈`,extra:`Ready`,content:`After release, keep an eye on error rate, support feedback and adoption signals so the next iteration has concrete evidence.`}],faqItemsCode:`const items = [
  {
    key: 'account',
...
]`})));return s(t=>{let o=n(),g=a(`rue:component:anchor`);return r(o,g),l(d(b,{children:s(()=>{let t=n(),o=i(`div`,t);r(t,o),f(o,`max-w-none prose prose-sm md:prose-base`);let g=i(`h1`,o);r(o,g),r(g,u(`Accordion 手风琴`));let b=i(`p`,o);r(o,b),f(b,`text-sm mt-3 mb-3`),r(b,u(`Accordion 现在保留 Rue 原本的轻量视觉风格，但 API 不再只是静态包装。你可以继续用`));let N=i(`code`,b);r(b,N),r(N,u(`Accordion.Title`)),r(b,u(`和`));let P=i(`code`,b);r(b,P),r(P,u(`Accordion.Content`)),r(b,u(`组合单个面板，也可以直接用`));let F=i(`code`,b);r(b,F),r(F,u(`items`)),r(b,u(`走数据驱动，接入受控 key、多开、禁用和富标题信息。`));let I=i(`h2`,o);r(o,I),r(I,u(`何时使用`));let L=i(`ul`,o);r(o,L);let K=i(`li`,L);r(L,K),r(K,u(`需要 FAQ、设置说明、任务面板这类“标题 + 可折叠内容”的信息组织方式。`));let q=i(`li`,L);r(L,q),r(q,u(`需要在单开和多开之间切换，或把当前展开项接到页面状态里。`));let J=i(`li`,L);r(L,J),r(J,u(`需要在标题里补充状态、说明、标签，而不想为每个面板手写结构。`));let Y=i(`li`,L);r(L,Y),r(Y,u(`需要让浏览器能搜索折叠内容时，使用`));let X=i(`code`,Y);r(Y,X),r(X,u(`use="details"`)),r(Y,u(`。`));let Z=i(`div`,o);r(o,Z),f(Z,`not-prose my-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4`);let ee=a(`rue:list:start`),te=a(`rue:list:end`);r(Z,ee),r(Z,te);let ne=new Map;c(()=>{ne=_({items:H||[],getKey:(e,t)=>e.title,elements:ne,parent:Z,before:te,singleRoot:!0,trackIndex:!1,start:ee,renderItem:(t,o,d,p,h)=>{l(s(()=>{let o=n(),s=i(`div`,o);r(o,s),c(()=>{e(s,`key`,String(t.title))}),f(s,`card border border-base-300 bg-base-100 shadow-sm`);let d=i(`div`,s);r(s,d),f(d,`card-body gap-2 p-4`);let p=i(`div`,d);r(d,p),f(p,`text-xs uppercase tracking-[0.2em] text-base-content/50`),r(p,u(`Capability`));let h=i(`div`,d);r(d,h),f(h,`text-sm font-semibold`);let g=a(`rue:slot:anchor`);r(h,g),c(()=>{let e=t.title;m(()=>l(e,h,g))});let _=i(`p`,d);r(d,_),f(_,`m-0 text-sm opacity-70`);let v=a(`rue:slot:anchor`);return r(_,v),c(()=>{let e=t.desc;m(()=>l(e,_,v))}),o}),o,d)}})});let re=a(`rue:component:anchor`);r(o,re),c(()=>{let e=d(z,{title:`Accordion using radio inputs`,summary:`保留单开分组，同时额外开启 collapsible，方便在文档页里反复点按查看开合状态。`,tab:p,preview:()=>G(`accordion-radio-demo`,{collapsible:!0}),code:`<Accordion className="bg-base-100 border border-base-300" name="accordion-radio-demo" defaultOpen collapsible>
...
</Accordion>`});m(()=>l(e,o,re))});let ie=a(`rue:component:anchor`);r(o,ie),c(()=>{let e=d(z,{title:`Accordion using details`,summary:`保留 details 结构，适合需要原生语义和浏览器搜索能力的内容区。`,tab:h,preview:()=>G(`accordion-details-demo`,{use:`details`}),code:`<Accordion use="details" className="bg-base-100 border border-base-300" name="accordion-details-demo" defaultOpen>
...
</Accordion>`});m(()=>l(e,o,ie))});let ae=a(`rue:component:anchor`);r(o,ae),c(()=>{let e=d(z,{title:`Controlled active key`,summary:`受控模式同样支持 collapsible；点击已展开项时，activeKey 会回到 null。`,tab:x,preview:()=>y(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body gap-4`,children:[y(`div`,{className:`flex flex-wrap gap-2`,children:j.map(e=>v(`button`,{className:`btn btn-sm ${k.value===e.key?`btn-primary`:`btn-ghost`}`,onClick:()=>{let t=k.value===e.key?null:e.key;k.value=t,A.value=t},children:[`切换 `,e.title]},e.key))}),v(`div`,{className:`grid gap-2 rounded-box border border-base-300 bg-base-200/40 p-3 text-sm`,children:[v(`div`,{children:[`当前 `,y(`code`,{children:`activeKey`}),`：`,y(`code`,{children:k.value??`null`})]}),v(`div`,{children:[`最近一次切换：`,y(`code`,{children:A.value??`null`})]})]}),y(R,{activeKey:k.value,collapsible:!0,icon:`arrow`,className:`bg-base-100 border border-base-300`,items:j,onChange:e=>{let t=Array.isArray(e)?e[0]:e;k.value=t??null,A.value=t??null}})]})}),code:`import { ref } from '@rue-js/rue'
...
</Accordion>`});m(()=>l(e,o,ce))});let le=a(`rue:component:anchor`);r(o,le),c(()=>{let e=d(z,{title:`Accordion with plus/minus icon`,summary:`保留 plus/minus 方案，并开启 collapsible，方便直接验证开合反馈。`,tab:T,preview:()=>G(`accordion-plus-demo`,{icon:`plus`,collapsible:!0}),code:`<Accordion icon="plus" className="bg-base-100 border border-base-300" name="accordion-plus-demo" defaultOpen collapsible>
  <Accordion.Title className="font-semibold">How do I create an account?</Accordion.Title>
  <Accordion.Content className="text-sm opacity-80">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Accordion.Content>
...
</div>`});m(()=>l(e,o,ue))});let de=a(`rue:component:anchor`);r(o,de),c(()=>{let e=d(z,{title:`Accordion using items array (radio)`,summary:`保留 items 数组写法，并开启 collapsible，方便直接验证数据驱动下的收起逻辑。`,tab:D,preview:()=>y(R,{collapsible:!0,className:`bg-base-100 border border-base-300`,name:`accordion-array-radio-demo`,items:V.map((e,t)=>({key:e.key,title:e.title,content:e.content,open:t===0}))}),code:`${M}
...
<Accordion
  ...
  items={items}
/>`});m(()=>l(e,o,fe))});let Q=i(`h2`,o);r(o,Q),e(Q,`id`,`accordion-api`),r(Q,u(`API`));let pe=i(`p`,o);r(o,pe),r(pe,u(`Accordion 现在分成两套用法：children 模式适合局部排版，items 模式适合数据驱动和受控状态。 两套模式共用同一套视觉类名，因此迁移旧示例时通常只需要把结构收敛到更清晰的语义层。`));let me=i(`h3`,o);r(o,me),r(me,u(`Accordion Props`));let he=a(`rue:component:anchor`);r(o,he),c(()=>{let e=d(B,{rows:U});m(()=>l(e,o,he))});let $=i(`h3`,o);r(o,$),f($,`mt-6`),r($,u(`AccordionDataItem`));let ge=a(`rue:component:anchor`);return r(o,ge),c(()=>{let e=d(B,{rows:W});m(()=>l(e,o,ge))}),t})}),o,g),o})};export{K as default};