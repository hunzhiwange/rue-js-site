...
</Dropdown>`});m(()=>l(e,s,le))});let ue=h(`rue:component:anchor`);e(s,ue),t(()=>{let e=p(S,{title:`受控开关与来源`,tab:_.controlled,preview:v(w,{}),code:`const open = ref(false);
...
</Dropdown>`});m(()=>l(e,s,ue))});let de=h(`rue:component:anchor`);e(s,de),t(()=>{let e=p(S,{title:`可选中筛选菜单`,tab:_.selectable,preview:()=>y(`div`,{className:`not-prose grid gap-4 lg:grid-cols-[minmax(0,1fr)_280px]`,children:[v(`div`,{className:`rounded-box border border-base-300 bg-base-100/70 p-6`,children:y(`div`,{className:`flex flex-wrap gap-3`,children:[v(b,{trigger:`click`,closeOnClick:!1,menu:{selectable:!0,selectedKeys:D.value,onSelect:e=>{D.value=e.selectedKeys},items:A},children:v(`button`,{className:`btn`,children:`Single Select`})}),v(b,{trigger:`click`,closeOnClick:!1,menu:{selectable:!0,multiple:!0,selectedKeys:O.value,onSelect:e=>{O.value=e.selectedKeys},onDeselect:e=>{O.value=e.selectedKeys},items:A},children:v(`button`,{className:`btn btn-outline`,children:`Multiple Filters`})})]})}),y(`div`,{className:`rounded-box border border-base-300 bg-base-100 p-4 shadow-sm text-sm`,children:[y(`div`,{children:[`单选：`,D.value.join(`, `)||`未选中`]}),y(`div`,{className:`mt-2`,children:[`多选：`,O.value.join(`, `)||`未选中`]}),y(`p`,{className:`mt-3 text-base-content/70`,children:[`这类筛选面板通常会把 `,v(`code`,{children:`closeOnClick`}),` 设为 `,v(`code`,{children:`false`}),`，让用户连续选择。`]})]})]}),code:`const selectedKeys = ref(['overview']);
...
</Dropdown>`});m(()=>l(e,s,de))});let fe=h(`rue:component:anchor`);e(s,fe),t(()=>{let e=p(S,{title:`自定义面板包装`,tab:_.custom,preview:()=>v(`div`,{className:`not-prose flex min-h-64 items-start rounded-box border border-base-300 bg-base-100/70 p-6`,children:v(b,{trigger:`click`,placement:`bottomRight`,arrow:!0,overlay:y(`div`,{className:`p-4`,children:[v(`div`,{className:`text-sm font-medium`,children:`Editor shortcuts`}),v(`div`,{className:`mt-2 text-sm text-base-content/70`,children:`Publish, share and manage visibility in one place.`})]}),popupRender:e=>y(`div`,{className:`w-72`,children:[v(`div`,{className:`border-b border-base-300 px-4 py-3 text-xs font-semibold uppercase tracking-wide text-primary`,children:`Quick panel`}),e,y(`div`,{className:`flex items-center justify-end gap-2 border-t border-base-300 px-4 py-3`,children:[v(`button`,{className:`btn btn-ghost btn-sm`,children:`Later`}),v(`button`,{className:`btn btn-primary btn-sm`,children:`Publish`})]})]}),children:v(`button`,{className:`btn btn-secondary`,children:`Quick Panel`})})}),code:`<Dropdown
  trigger="click"
...
</Dropdown>`});m(()=>l(e,s,fe))});let pe=h(`rue:component:anchor`);e(s,pe),t(()=>{let e=p(S,{title:`右键上下文菜单`,tab:_.contextMenu,preview:()=>v(`div`,{className:`not-prose rounded-box border border-dashed border-base-300 bg-base-100/70 p-6`,children:v(b,{trigger:`contextMenu`,items:[{key:`copy`,label:`Copy link`},{key:`rename`,label:`Rename block`},{type:`divider`},{key:`delete`,label:`Delete block`,danger:!0}],children:v(`div`,{className:`flex h-44 items-center justify-center rounded-box bg-base-200 text-sm text-base-content/70`,children:`在这个区域右键，打开上下文菜单`})})}),code:`<Dropdown
  trigger="contextMenu"
  items={[
...
</Dropdown>`});m(()=>l(e,s,_e))});let ve=h(`rue:component:anchor`);e(s,ve),t(()=>{let e=p(S,{title:`Positions`,tab:_.positions,preview:()=>y(`div`,{className:`grid gap-x-16 gap-y-24 py-24 md:grid-cols-2 xl:grid-cols-[minmax(10rem,1fr)_minmax(12rem,1fr)_minmax(20rem,1.2fr)]`,children:[v(`div`,{className:`flex min-h-28 items-start justify-start`,children:y(b,{align:`start`,children:[v(b.Trigger,{as:`button`,type:`button`,className:`btn m-1`,"data-testid":`dropdown-position-start`,children:`Start`}),y(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[v(`li`,{children:v(`button`,{children:`Item 1`})}),v(`li`,{children:v(`button`,{children:`Item 2`})})]})]})}),v(`div`,{className:`flex min-h-28 items-end justify-center`,children:y(b,{align:`center`,direction:`top`,children:[v(b.Trigger,{as:`button`,type:`button`,className:`btn m-1`,"data-testid":`dropdown-position-top-center`,children:`Top Center`}),y(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[v(`li`,{children:v(`button`,{children:`Item 1`})}),v(`li`,{children:v(`button`,{children:`Item 2`})})]})]})}),v(`div`,{className:`flex min-h-28 min-w-80 items-end justify-end sm:ps-56`,"data-testid":`dropdown-position-left-end-slot`,children:y(b,{direction:`left`,align:`end`,children:[v(b.Trigger,{as:`button`,type:`button`,className:`btn m-1`,"data-testid":`dropdown-position-left-end`,children:`Left End`}),y(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[v(`li`,{children:v(`button`,{children:`Item 1`})}),v(`li`,{children:v(`button`,{children:`Item 2`})})]})]})})]}),code:`<Dropdown align="start">
...
</Dropdown>`});m(()=>l(e,s,ve))});let ye=h(`rue:component:anchor`);e(s,ye),t(()=>{let e=p(S,{title:`Dropdown hover and force open`,tab:_.modifiers,preview:()=>y(b,{hover:!0,forceOpen:!0,children:[v(`div`,{tabIndex:0,role:`button`,className:`btn m-1`,children:`Always visible`}),y(b.Content,{as:`ul`,tabIndex:-1,className:`menu z-1 w-52 rounded-box bg-base-100 p-2 shadow-sm`,children:[v(`li`,{children:v(`button`,{children:`Item 1`})}),v(`li`,{children:v(`button`,{children:`Item 2`})})]})]}),code:`<Dropdown hover forceOpen>
