...
`,I=(e,t,r)=>i(O,()=>({options:{title:`本地待办事项`,source:F},children:(e,t,r)=>{let i=()=>o(e=>{let t=v();n(t,P,()=>({}));let r=m(``),i=m(``);return t.insertBefore(r,t.firstChild),t.appendChild(i),[t.firstChild,t.lastChild]});return e==null?i():a(e,r,i)}}));export{I as default};