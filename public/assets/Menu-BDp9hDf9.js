...
/>`});h(()=>l(e,n,r))}),n});h(()=>l(n,A,ze))});let j=f(`div`,u);e(u,j),d(j,`component-preview not-prose text-base-content my-6 lg:my-12`);let Be=f(`h2`,j);e(j,Be),d(Be,`component-preview-title mt-2 mb-1 text-lg font-semibold`),e(Be,o(`# 推荐：多选、分组与分割线`));let Ve=f(`p`,j);e(j,Ve),d(Ve,`mb-3 text-sm text-base-content/70`),e(Ve,o("沿着常见菜单组件的 `multiple + group + divider` 思路，适合消息筛选、标签面板一类场景。"));let He=g(`rue:component:anchor`);e(j,He),t(()=>{let e=m(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:te.value,onChange:e=>te.value=e,className:`mb-3`});h(()=>l(e,j,He))});let Ue=g(`rue:slot:anchor`);e(j,Ue),t(()=>{let n=te.value===`preview`?s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(C,{className:`bg-base-200 rounded-box w-80`,items:Fe,multiple:!0,defaultSelectedKeys:[`mentions`,`archived`]});h(()=>l(e,n,r))}),n}):s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(y,{className:`mt-2`,lang:`tsx`,code:`const items = [
  {
    type: 'group',
    label: 'Inbox',
    children: [
...
/>`});h(()=>l(e,n,r))}),n});h(()=>l(n,j,Ue))});let M=f(`div`,u);e(u,M),d(M,`component-preview not-prose text-base-content my-6 lg:my-12`);let We=f(`h2`,M);e(M,We),d(We,`component-preview-title mt-2 mb-1 text-lg font-semibold`),e(We,o(`# 推荐：组合式语义 API`));let Ge=f(`p`,M);e(M,Ge),d(Ge,`mb-3 text-sm text-base-content/70`),e(Ge,o("如果你更喜欢手写 JSX 结构，可以直接使用 `Menu.SubMenu / Menu.ItemGroup / Menu.Divider`。"));let Ke=g(`rue:component:anchor`);e(M,Ke),t(()=>{let e=m(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:D.value,onChange:e=>D.value=e,className:`mb-3`});h(()=>l(e,M,Ke))});let qe=g(`rue:slot:anchor`);e(M,qe),t(()=>{let n=D.value===`preview`?s(()=>{let n=c(),r=g(`rue:component:anchor`);e(n,r);let i=s(()=>{let n=c(),r=g(`rue:component:anchor`);e(n,r);let i=s(()=>{let n=c(),r=g(`rue:component:anchor`);e(n,r),t(()=>{let e=m(C.Item,{eventKey:`profile`,icon:b(`span`,{className:`inline-flex h-2.5 w-2.5 rounded-full bg-primary`}),children:`Profile`});h(()=>l(e,n,r))});let i=g(`rue:component:anchor`);return e(n,i),t(()=>{let e=m(C.Item,{eventKey:`notifications`,extra:b(S,{size:`xs`,children:`2`}),children:`Notifications`});h(()=>l(e,n,i))}),n});l(m(C.ItemGroup,{title:`Account`,children:i}),n,r);let a=g(`rue:component:anchor`);e(n,a),l(m(C.Divider,{}),n,a);let o=g(`rue:component:anchor`);e(n,o);let u=s(()=>{let t=c(),n=g(`rue:component:anchor`);e(t,n),l(m(C.Item,{eventKey:`security`,children:`Security`}),t,n);let r=g(`rue:component:anchor`);return e(t,r),l(m(C.Item,{eventKey:`tokens`,extra:`Beta`,children:`API Tokens`}),t,r),t});return t(()=>{let e=m(C.SubMenu,{eventKey:`settings`,title:`Settings`,icon:b(`span`,{className:`inline-flex h-2.5 w-2.5 rounded-full bg-accent`}),children:u});h(()=>l(e,n,o))}),n});return t(()=>{let e=m(C,{className:`bg-base-200 rounded-box w-80`,selectedKeys:De.value,openKeys:Oe.value,onSelect:e=>De.value=e.selectedKeys,onOpenChange:e=>Oe.value=e,children:i});h(()=>l(e,n,r))}),n}):s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(y,{className:`mt-2`,lang:`tsx`,code:`const selectedKeys = ref(['profile']);
...
</Menu>`});h(()=>l(e,n,r))}),n});h(()=>l(n,P,et))});let F=f(`div`,u);e(u,F),d(F,`component-preview not-prose text-base-content my-6 lg:my-12`);let tt=f(`h2`,F);e(F,tt),d(tt,`component-preview-title mt-2 mb-1 text-lg font-semibold`),e(tt,o(`# Menu 通过数据渲染（数组，组件内部）`));let nt=g(`rue:component:anchor`);e(F,nt),t(()=>{let e=m(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:Ce.value,onChange:e=>Ce.value=e,className:`mb-3`});h(()=>l(e,F,nt))});let rt=g(`rue:slot:anchor`);e(F,rt),t(()=>{let n=Ce.value===`preview`?s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(C,{items:Ne,className:`xl:menu-horizontal bg-base-200 rounded-box lg:min-w-max`});h(()=>l(e,n,r))}),n}):s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(y,{className:`mt-2`,lang:`tsx`,code:`import { Menu } from '@rue-js/design';
const menuItems = [
...
<Menu items={menuItems} className="xl:menu-horizontal bg-base-200 rounded-box lg:min-w-max" />`});h(()=>l(e,n,r))}),n});h(()=>l(n,F,rt))});let I=f(`div`,u);e(u,I),d(I,`component-preview not-prose text-base-content my-6 lg:my-12`);let it=f(`h2`,I);e(I,it),d(it,`component-preview-title mt-2 mb-1 text-lg font-semibold`),e(it,o(`# Menu`));let at=g(`rue:component:anchor`);e(I,at),t(()=>{let e=m(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:ne.value,onChange:e=>ne.value=e,className:`mb-3`});h(()=>l(e,I,at))});let ot=g(`rue:slot:anchor`);e(I,ot),t(()=>{let n=ne.value===`preview`?s(()=>{let t=c(),n=g(`rue:component:anchor`);return e(t,n),l(m(C,{className:`bg-base-200 rounded-box w-56`,children:s(()=>{let t=c(),n=g(`rue:component:anchor`);e(t,n),l(m(C.Item,{as:`button`,children:`Item 1`}),t,n);let r=g(`rue:component:anchor`);e(t,r),l(m(C.Item,{as:`button`,children:`Item 2`}),t,r);let i=g(`rue:component:anchor`);return e(t,i),l(m(C.Item,{as:`button`,children:`Item 3`}),t,i),t})}),t,n),t}):s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(y,{className:`mt-2`,lang:`tsx`,code:`<Menu className="bg-base-200 rounded-box w-56">
  ...
  <Menu.Item as="button">Item 3</Menu.Item>
</Menu>`});h(()=>l(e,n,r))}),n});h(()=>l(n,Y,Yt))});let X=f(`div`,u);e(u,X),d(X,`component-preview not-prose text-base-content my-6 lg:my-12`);let Xt=f(`h2`,X);e(X,Xt),d(Xt,`component-preview-title mt-2 mb-1 text-lg font-semibold`),e(Xt,o(`# 通过类名控制展开（JS）`));let Zt=g(`rue:component:anchor`);e(X,Zt),t(()=>{let e=m(x,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:he.value,onChange:e=>he.value=e,className:`mb-3`});h(()=>l(e,X,Zt))});let Qt=g(`rue:slot:anchor`);e(X,Qt),t(()=>{let n=he.value===`preview`?s(()=>{let n=c(),r=f(`div`,n);e(n,r),d(r,`grid gap-6`);let i=g(`rue:component:anchor`);e(r,i),l(m(C,{className:`bg-base-200 rounded-box w-56`,children:s(()=>{let t=c(),n=g(`rue:component:anchor`);e(t,n),l(m(C.Item,{children:`Item 1`}),t,n);let r=f(`li`,t);e(t,r);let i=g(`rue:component:anchor`);e(r,i),l(m(C.DropdownToggle,{onClick:je,children:`Parent`}),r,i);let a=g(`rue:component:anchor`);e(r,a);let o=s(()=>{let t=c(),n=g(`rue:component:anchor`);e(t,n),l(m(C.Item,{children:`Submenu 1`}),t,n);let r=g(`rue:component:anchor`);return e(t,r),l(m(C.Item,{children:`Submenu 2`}),t,r),t});return l(m(C.Dropdown,{children:o}),r,a),t})}),r,i);let a=g(`rue:component:anchor`);return e(r,a),l(m(C,{className:`bg-base-200 rounded-box w-56`,children:s(()=>{let n=c(),r=g(`rue:component:anchor`);e(n,r),l(m(C.Item,{children:`Item 1`}),n,r);let i=f(`li`,n);e(n,i);let a=g(`rue:component:anchor`);e(i,a),t(()=>{let e=m(C.DropdownToggle,{show:!0,onClick:je,children:`Parent`});h(()=>l(e,i,a))});let o=g(`rue:component:anchor`);e(i,o);let u=s(()=>{let t=c(),n=g(`rue:component:anchor`);e(t,n),l(m(C.Item,{children:`Submenu 1`}),t,n);let r=g(`rue:component:anchor`);return e(t,r),l(m(C.Item,{children:`Submenu 2`}),t,r),t});return t(()=>{let e=m(C.Dropdown,{show:!0,children:u});h(()=>l(e,i,o))}),n})}),r,a),n}):s(()=>{let n=c(),r=g(`rue:component:anchor`);return e(n,r),t(()=>{let e=m(y,{className:`mt-2`,lang:`tsx`,code:`import { Menu } from '@rue-js/design';
