import{K as e,L as t,M as n,N as r,Q as i,R as a,d as o,gt as s,ht as c,vt as l,z as u}from"./vapor-runtime-BuwLbCGk.js";import{a as d}from"./vapor-helpers-vapor-Bly5xJie.js";import{t as f}from"./createHomeSplitExamplePage-2wtBgDCk.js";var p=f({title:`useState 计数器`,source:`import { type FC, useState } from '@rue-js/rue'
...
`,Demo:()=>{let{count:f,setCount:p}=d(`useSetup:0:0`,()=>c(()=>{let[e,t]=d(`useState:1:0`,()=>s(0));return{count:e,setCount:t}}));return o(o=>{let s=t(`div`,o);e(s,`card bg-base-100 shadow`);let c=t(`div`,s);r(s,c),e(c,`card-body`);let d=t(`h2`,c);r(c,d),e(d,`text-2xl font-semibold mb-2`),r(d,a(`useState 计数器`));let m=t(`div`,c);r(c,m),e(m,`text-4xl font-bold mb-3`);let h=u(m);r(m,h),l(()=>{i(h,f.value)});let g=t(`div`,c);r(c,g),e(g,`flex flex-wrap justify-center gap-2`);let _=t(`button`,g);r(g,_),e(_,`rounded-lg border border-blue-500 bg-blue-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-blue-700 hover:bg-blue-700 focus:ring focus:ring-blue-200`),n(_,`click`,()=>p(e=>{e.value+=1})),r(_,a(`+1`));let v=t(`button`,g);r(g,v),e(v,`rounded-lg border border-yellow-500 bg-yellow-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-yellow-700 hover:bg-yellow-700 focus:ring focus:ring-yellow-200`),n(v,`click`,()=>p(e=>{--e.value})),r(v,a(`-1`));let y=t(`button`,g);return r(g,y),e(y,`rounded-lg border border-gray-700 bg-gray-700 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-gray-900 hover:bg-gray-900 focus:ring focus:ring-gray-200`),n(y,`click`,()=>p(0)),r(y,a(`重置`)),s})}});export{p as default};