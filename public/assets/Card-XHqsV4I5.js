import{F as e,I as t,K as n,L as r,N as i,R as a,W as o,d as s,dt as c,ht as l,l as u,st as d,t as f,vt as p}from"./vapor-runtime-BuwLbCGk.js";import{a as m,n as h}from"./vapor-helpers-vapor-Bly5xJie.js";import{n as g,t as _}from"./src-BQwLQD8R.js";import{n as v}from"./SidebarPlaygroundDesign-SQXYHI-q.js";import{t as y}from"./Code-DQxnq0in.js";import{t as b}from"./button-BlewusST.js";import{t as x}from"./card-BidtxlSu.js";import{t as S}from"./tabs-DqfJzZfa.js";import{t as C}from"./badge-lRk49Pw8.js";var w=o=>s(l=>{let d=r(`div`,l);n(d,`component-preview not-prose text-base-content my-6 lg:my-12`);let m=r(`div`,d);i(d,m),n(m,`flex flex-wrap items-start justify-between gap-3`);let h=r(`div`,m);i(m,h);let g=r(`h2`,h);i(h,g),n(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(g,a(`# `));let _=e(`rue:slot:anchor`);i(g,_),p(()=>{let e=o.title;c(()=>u(e,g,_))});let v=e(`rue:slot:anchor`);i(h,v),p(()=>{let a=o.summary?s(()=>{let a=t(),s=r(`p`,a);i(a,s),n(s,`m-0 text-sm opacity-70`);let l=e(`rue:slot:anchor`);return i(s,l),p(()=>{let e=o.summary;c(()=>u(e,s,l))}),a}):``;c(()=>u(a,h,v))});let b=e(`rue:component:anchor`);i(d,b),p(()=>{let e=f(S,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:o.tab.value,onChange:e=>o.tab.value=e,className:`mb-3 mt-4`});c(()=>u(e,d,b))});let x=e(`rue:slot:anchor`);return i(d,x),p(()=>{let n=o.tab.value===`preview`?o.preview():s(()=>{let n=t(),r=e(`rue:component:anchor`);return i(n,r),p(()=>{let e=f(y,{className:`mt-2`,lang:`tsx`,code:o.code});c(()=>u(e,n,r))}),n});c(()=>u(n,d,x))}),d}),T=l=>s(d=>{let f=r(`div`,d);n(f,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let m=r(`table`,f);i(f,m),n(m,`table table-zebra`);let g=r(`thead`,m);i(m,g);let _=r(`tr`,g);i(g,_);let v=r(`th`,_);i(_,v),i(v,a(`属性`));let y=r(`th`,_);i(_,y),i(y,a(`说明`));let b=r(`th`,_);i(_,b),i(b,a(`类型`));let x=r(`th`,_);i(_,x),i(x,a(`默认值`));let S=r(`tbody`,m);i(m,S);let C=e(`rue:list:start`),w=e(`rue:list:end`);i(S,C),i(S,w);let T=new Map;return p(()=>{T=h({items:l.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(n,a,l,d,f)=>{u(s(()=>{let a=t(),s=r(`tr`,a);i(a,s),p(()=>{o(s,`key`,String(n.prop))});let l=r(`td`,s);i(s,l);let d=r(`code`,l);i(l,d);let f=e(`rue:slot:anchor`);i(d,f),p(()=>{let e=n.prop;c(()=>u(e,d,f))});let m=r(`td`,s);i(s,m);let h=e(`rue:slot:anchor`);i(m,h),p(()=>{let e=n.description;c(()=>u(e,m,h))});let g=r(`td`,s);i(s,g);let _=r(`code`,g);i(g,_);let v=e(`rue:slot:anchor`);i(_,v),p(()=>{let e=n.type;c(()=>u(e,_,v))});let y=r(`td`,s);i(s,y);let b=r(`code`,y);i(y,b);let x=e(`rue:slot:anchor`);return i(b,x),p(()=>{let e=n.defaultValue;c(()=>u(e,b,x))}),a}),a,l)}})}),f}),E=`https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp`,ee=`https://img.daisyui.com/images/stock/photo-1635805737707-575885ab0820.webp`,te=`https://img.daisyui.com/images/stock/photo-1494232410401-ad00d5433cfa.webp`,ne=`https://picsum.photos/seed/rue-card-workspace/960/640`,re=`https://picsum.photos/seed/rue-card-report/960/640`,ie=()=>s(e=>{let t=r(`svg`,e);o(t,`xmlns`,`http://www.w3.org/2000/svg`),o(t,`viewBox`,`0 0 24 24`),o(t,`fill`,`none`),o(t,`stroke`,`currentColor`),o(t,`strokeWidth`,`2`),n(t,`size-4`);let a=r(`path`,t);i(t,a),o(a,`strokeLinecap`,`round`),o(a,`strokeLinejoin`,`round`),o(a,`d`,`M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6S2 12 2 12Z`);let s=r(`circle`,t);return i(t,s),o(s,`cx`,`12`),o(s,`cy`,`12`),o(s,`r`,`3`),t}),ae=()=>s(e=>{let t=r(`svg`,e);o(t,`xmlns`,`http://www.w3.org/2000/svg`),o(t,`viewBox`,`0 0 24 24`),o(t,`fill`,`none`),o(t,`stroke`,`currentColor`),o(t,`strokeWidth`,`2`),n(t,`size-4`);let a=r(`path`,t);i(t,a),o(a,`strokeLinecap`,`round`),o(a,`strokeLinejoin`,`round`),o(a,`d`,`m4 16 6-6 4 4 6-8`);let s=r(`path`,t);return i(t,s),o(s,`strokeLinecap`,`round`),o(s,`strokeLinejoin`,`round`),o(s,`d`,`M14 6h6v6`),t}),oe=()=>s(e=>{let t=r(`svg`,e);o(t,`xmlns`,`http://www.w3.org/2000/svg`),o(t,`viewBox`,`0 0 24 24`),o(t,`fill`,`none`),o(t,`stroke`,`currentColor`),o(t,`strokeWidth`,`2`),n(t,`size-4`);let a=r(`path`,t);return i(t,a),o(a,`strokeLinecap`,`round`),o(a,`strokeLinejoin`,`round`),o(a,`d`,`M6 6l12 12M18 6 6 18`),t}),se=()=>s(e=>{let t=r(`svg`,e);o(t,`xmlns`,`http://www.w3.org/2000/svg`),o(t,`viewBox`,`0 0 24 24`),o(t,`fill`,`none`),o(t,`stroke`,`currentColor`),o(t,`strokeWidth`,`2`),n(t,`size-4`);let a=r(`path`,t);return i(t,a),o(a,`strokeLinecap`,`round`),o(a,`strokeLinejoin`,`round`),o(a,`d`,`M12 5v14M5 12h14`),t}),ce=t=>s(a=>{let o=r(`div`,a);p(()=>{n(o,String(`inline-grid h-12 w-12 place-items-center rounded-full text-sm font-semibold ${t.className??`bg-primary text-primary-content`}`))});let s=e(`rue:slot:anchor`);return i(o,s),p(()=>{let e=t.text;c(()=>u(e,o,s))}),o}),le=[{prop:`actions`,description:`底部操作栏，传入节点数组后自动平均分栏`,type:`any[]`,defaultValue:`-`},{prop:`activeTabKey`,description:`受控模式下的当前 tab key`,type:`string`,defaultValue:`-`},{prop:`bodyClassName`,description:`语义化 body 容器的类名`,type:`string`,defaultValue:`-`},{prop:`border / bordered`,description:`旧版边框别名，等价于追加 card-border`,type:`boolean`,defaultValue:`false`},{prop:`className`,description:`根节点类名，保留与 daisyUI 类直接混用的能力`,type:`string`,defaultValue:`-`},{prop:`cover`,description:`卡片封面，自动渲染为顶部 figure 区域`,type:`any`,defaultValue:`-`},{prop:`dash`,description:`旧版虚线边框开关，追加 card-dash`,type:`boolean`,defaultValue:`false`},{prop:`defaultActiveTabKey`,description:`非受控模式下的默认 tab key`,type:`string`,defaultValue:`tabList 第一项`},{prop:`extra`,description:`头部右侧操作区域`,type:`any`,defaultValue:`-`},{prop:`headerClassName`,description:`语义化 header 容器的类名`,type:`string`,defaultValue:`-`},{prop:`hoverable`,description:`启用悬浮抬升与阴影过渡`,type:`boolean`,defaultValue:`false`},{prop:`imageFull`,description:`沿用 daisyUI image-full，适合封面做背景图`,type:`boolean`,defaultValue:`false`},{prop:`loading`,description:`在 body 区域输出骨架占位`,type:`boolean`,defaultValue:`false`},{prop:`onTabChange`,description:`tab 切换回调，受控与非受控模式都会触发`,type:`(key: string) => void`,defaultValue:`-`},{prop:`side`,description:`沿用 daisyUI card-side，让 figure 进入横向布局`,type:`boolean`,defaultValue:`false`},{prop:`size`,description:`支持 xs~xl 与 small / middle / large 语义别名`,type:`'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'small' | 'medium' | 'middle' | 'large'`,defaultValue:`md`},{prop:`tabBarExtraContent`,description:`tabs 右侧扩展区域`,type:`any`,defaultValue:`-`},{prop:`tabList`,description:`头部 tabs 配置列表，支持 disabled 与 className`,type:`Array<{ key: string; label?: any; tab?: any; disabled?: boolean; className?: string }>`,defaultValue:`-`},{prop:`tabProps`,description:`控制 tabs 的 style、placement、size 与 className`,type:`{ style?: 'box' | 'border' | 'lift'; placement?: 'top' | 'bottom'; size?: 'xs' | 'sm' | 'md' | 'lg' | 'xl'; className?: string }`,defaultValue:`-`},{prop:`title`,description:`头部标题区`,type:`any`,defaultValue:`-`},{prop:`type`,description:`卡片层次语义，inner 会切到更内嵌的底色与边框`,type:`'default' | 'inner'`,defaultValue:`default`},{prop:`variant`,description:`语义化边框风格，优先于展示层 API 编排`,type:`'outlined' | 'borderless' | 'dashed'`,defaultValue:`borderless`}],ue=[{prop:`avatar`,description:`头像或图标区域`,type:`any`,defaultValue:`-`},{prop:`children`,description:`标题和描述下方的自定义补充内容`,type:`any`,defaultValue:`-`},{prop:`className`,description:`Meta 根节点类名`,type:`string`,defaultValue:`-`},{prop:`description`,description:`描述内容`,type:`any`,defaultValue:`-`},{prop:`title`,description:`标题内容`,type:`any`,defaultValue:`-`}],de=[{prop:`className`,description:`Grid 单元的类名，常与宽度或背景类联用`,type:`string`,defaultValue:`-`},{prop:`hoverable`,description:`是否启用 hover 阴影与背景过渡`,type:`boolean`,defaultValue:`true`},{prop:`style`,description:`Grid 单元的行内样式`,type:`any`,defaultValue:`-`}],fe=`import { Badge, Button, Card } from '@rue-js/design'
...
</div>`,D=()=>{let{tabSemantic:h,tabCompound:y,tabMeta:S,tabTabs:D,tabLoading:we,tabGrid:Te,tabPricing:Ee,tabSizes:De,tabContent:Oe,tabAppearance:ke,tabMedia:Ae,tabHorizontal:je,productTab:O}=m(`useSetup:0:0`,()=>l(()=>({tabSemantic:m(`ref:1:0`,()=>d(`preview`)),tabCompound:m(`ref:1:1`,()=>d(`preview`)),tabMeta:m(`ref:1:2`,()=>d(`preview`)),tabTabs:m(`ref:1:3`,()=>d(`preview`)),tabLoading:m(`ref:1:4`,()=>d(`preview`)),tabGrid:m(`ref:1:5`,()=>d(`preview`)),tabPricing:m(`ref:1:6`,()=>d(`preview`)),tabSizes:m(`ref:1:7`,()=>d(`preview`)),tabContent:m(`ref:1:8`,()=>d(`preview`)),tabAppearance:m(`ref:1:9`,()=>d(`preview`)),tabMedia:m(`ref:1:10`,()=>d(`preview`)),tabHorizontal:m(`ref:1:11`,()=>d(`preview`)),productTab:m(`ref:1:12`,()=>d(`overview`))})));return s(l=>{let d=t(),m=e(`rue:component:anchor`);return i(d,m),u(f(v,{children:s(()=>{let s=t(),l=r(`div`,s);i(s,l),n(l,`max-w-none prose prose-sm md:prose-base`);let d=r(`h1`,l);i(l,d),i(d,a(`Card 卡片`));let m=r(`p`,l);i(l,m),n(m,`text-sm mt-3 mb-3`),i(m,a(`Card 用于把内容、媒体、操作和状态浓缩进一块易读的表面里。`));let v=r(`p`,l);i(l,v),n(v,`text-sm my-3 opacity-75`),i(v,a(`这一轮增强保留了 Rue 当前的视觉语气和 daisyUI class 直连能力，同时补上更接近业务组件的头部、封面、操作栏、Meta、Grid、loading 和 tabs API。`));let k=r(`div`,l);i(l,k),n(k,`text-sm`);let A=r(`a`,k);i(k,A),o(A,`href`,`https://daisyui.com/components/card/`),o(A,`target`,`_blank`),i(A,a(`查看 Card 静态样式`));let j=e(`rue:component:anchor`);i(l,j),p(()=>{let e=f(w,{title:`语义化 API`,summary:`优先展示新增加的 title、extra、cover、actions、hoverable 组合写法。`,tab:h,code:fe,preview:()=>g(`div`,{className:`grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]`,children:[g(x,{title:`Q2 产品指标`,extra:_(C,{variant:`secondary`,children:`Live`}),cover:_(`img`,{src:ne,alt:`Workspace dashboard`,className:`h-56 w-full object-cover`}),actions:[_(b,{type:`text`,size:`sm`,className:`inline-flex items-center justify-center`,children:g(`span`,{className:`inline-flex items-center gap-2`,children:[_(ie,{}),`查看报表`]})}),_(b,{color:`primary`,size:`sm`,className:`inline-flex items-center justify-center`,children:g(`span`,{className:`inline-flex items-center gap-2`,children:[_(ae,{}),`升级看板`]})})],hoverable:!0,className:`overflow-hidden bg-base-100 shadow-sm`,children:[_(`p`,{className:`text-sm leading-6 opacity-80`,children:`把封面、头部、操作区放进根组件 props，适合仪表盘、概览页和运营卡片。`}),g(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:[_(C,{outline:!0,children:`转化率 19.2%`}),_(C,{outline:!0,children:`客单价 +12%`}),_(C,{outline:!0,children:`复购率 +7%`})]})]}),g(x,{type:`inner`,title:`为什么要这样用`,className:`bg-base-100 shadow-sm`,children:[_(`p`,{className:`text-sm leading-6 opacity-75`,children:`语义化 API 适合把常见结构固定下来，减少反复手写 header、body、actions 和 tabs 布局。`}),g(`div`,{className:`mt-4 grid gap-3 sm:grid-cols-2`,children:[g(`div`,{className:`rounded-box bg-base-200/70 p-4`,children:[_(`div`,{className:`text-xs uppercase tracking-[0.18em] opacity-60`,children:`Cover`}),_(`div`,{className:`mt-2 text-sm font-medium`,children:`顶部封面`})]}),g(`div`,{className:`rounded-box bg-base-200/70 p-4`,children:[_(`div`,{className:`text-xs uppercase tracking-[0.18em] opacity-60`,children:`Actions`}),_(`div`,{className:`mt-2 text-sm font-medium`,children:`底部分栏操作`})]})]})]})]})});c(()=>u(e,l,j))});let M=e(`rue:component:anchor`);i(l,M),p(()=>{let e=f(w,{title:`复合子组件`,summary:`Body / Title / Actions / Figure 继续保留，适合手工拼装自定义结构。`,tab:y,code:pe,preview:()=>g(x,{className:`w-full max-w-md bg-base-100 shadow-sm`,children:[_(x.Figure,{children:_(`img`,{src:E,alt:`Shoes`})}),g(x.Body,{children:[_(x.Title,{children:`Card Title`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`低层子组件没有被移除，仍然适合自定义媒体顺序、插入任意节点或接管布局细节。`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Buy Now`})})]})]})});c(()=>u(e,l,M))});let Me=e(`rue:component:anchor`);i(l,Me),p(()=>{let e=f(w,{title:`Meta 与操作栏`,summary:`Card.Meta 统一头像、标题和描述；配合根组件 actions 更适合做资料卡与工作区卡片。`,tab:S,code:me,preview:()=>_(x,{cover:_(`img`,{src:re,alt:`Team workspace`,className:`h-52 w-full object-cover`}),actions:[_(b,{type:`text`,size:`sm`,children:`收藏`}),_(b,{type:`text`,size:`sm`,children:`分享`}),_(b,{color:`primary`,size:`sm`,children:`打开空间`})],className:`overflow-hidden bg-base-100 shadow-sm`,children:g(x.Body,{className:`gap-4`,children:[_(x.Meta,{avatar:_(ce,{text:`AI`}),title:`Rue Design Workspace`,description:`把文档、组件、评审记录聚合在一张卡片里。`,children:g(`div`,{className:`flex flex-wrap gap-2`,children:[_(C,{outline:!0,children:`12 个原型`}),_(C,{outline:!0,children:`3 位维护者`}),_(C,{outline:!0,children:`2 个待合并 PR`})]})}),_(`div`,{className:`rounded-box bg-base-200/60 p-4 text-sm leading-6 opacity-80`,children:`这类卡片适合团队空间、作者信息、文章摘要、资源入口等需要“头像 + 文案 + 操作”的场景。`})]})})});c(()=>u(e,l,Me))});let N=e(`rue:component:anchor`);i(l,N),p(()=>{let e=f(w,{title:`带 Tabs 的卡片`,summary:`Card 现在可直接承载卡片级 tab 头部，适合概览、里程碑、成员等分区内容。`,tab:D,code:he,preview:()=>g(x,{title:`版本节奏`,activeTabKey:O.value,tabList:[{key:`overview`,label:`总览`},{key:`milestones`,label:`里程碑`},{key:`members`,label:`成员`}],tabBarExtraContent:_(b,{size:`sm`,color:`primary`,children:g(`span`,{className:`inline-flex items-center gap-2`,children:[_(se,{}),`新建里程碑`]})}),onTabChange:e=>{O.value=e},className:`bg-base-100 shadow-sm`,children:[O.value===`overview`?g(`div`,{className:`grid gap-4 lg:grid-cols-3`,children:[g(`div`,{className:`rounded-box bg-base-200/70 p-4`,children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Velocity`}),_(`div`,{className:`mt-2 text-2xl font-semibold`,children:`+18%`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`本周交付速度`})]}),g(`div`,{className:`rounded-box bg-base-200/70 p-4`,children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`QA`}),_(`div`,{className:`mt-2 text-2xl font-semibold`,children:`7`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`待验证缺陷`})]}),g(`div`,{className:`rounded-box bg-base-200/70 p-4`,children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Review`}),_(`div`,{className:`mt-2 text-2xl font-semibold`,children:`3`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`待合并 PR`})]})]}):null,O.value===`milestones`?g(`ul`,{className:`list gap-2`,children:[g(`li`,{className:`list-row`,children:[_(`div`,{className:`font-medium`,children:`v0.8`}),_(`div`,{className:`list-col-grow text-sm opacity-75`,children:`表单编排和 SSR 回归测试`}),_(C,{variant:`secondary`,children:`In Review`})]}),g(`li`,{className:`list-row`,children:[_(`div`,{className:`font-medium`,children:`v0.9`}),_(`div`,{className:`list-col-grow text-sm opacity-75`,children:`设计页统一升级`}),_(C,{outline:!0,children:`Planning`})]})]}):null,O.value===`members`?_(`div`,{className:`grid gap-3 sm:grid-cols-3`,children:[`UI`,`DX`,`QA`].map(e=>g(`div`,{className:`rounded-box bg-base-200/70 p-4 text-center`,children:[_(ce,{text:e,className:`mx-auto bg-secondary text-secondary-content`}),g(`div`,{className:`mt-3 font-medium`,children:[e,` Owner`]})]},e))}):null]})});c(()=>u(e,l,N))});let P=e(`rue:component:anchor`);i(l,P),p(()=>{let e=f(w,{title:`Loading 与 Inner`,summary:`loading 为数据未返回时提供骨架占位，type='inner' 适合二级信息层。`,tab:we,code:ge,preview:()=>g(`div`,{className:`grid gap-6 lg:grid-cols-2`,children:[_(x,{loading:!0,title:`同步远程指标`,className:`bg-base-100 shadow-sm`}),g(x,{type:`inner`,title:`内嵌提示`,className:`bg-base-100 shadow-sm`,children:[_(`p`,{className:`text-sm leading-6 opacity-75`,children:`inner 卡片更适合放在正文、抽屉或主卡片内部作为次级说明层，不会抢掉主信息面的视觉焦点。`}),g(`div`,{className:`mt-4 flex flex-wrap gap-2`,children:[_(C,{outline:!0,children:`发布前检查`}),_(C,{outline:!0,children:`设计稿已对齐`})]})]})]})});c(()=>u(e,l,P))});let F=e(`rue:component:anchor`);i(l,F),p(()=>{let e=f(w,{title:`Grid 网格卡片`,summary:`Card.Grid 适合做快捷入口和稠密信息总览；bodyClassName='!p-0' 可以去掉默认留白。`,tab:Te,code:_e,preview:()=>_(x,{title:`常用入口`,bodyClassName:`!p-0`,className:`overflow-hidden bg-base-100 shadow-sm`,children:g(`div`,{className:`grid gap-px bg-base-300/70 sm:grid-cols-2 xl:grid-cols-4`,children:[g(x.Grid,{children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Docs`}),_(`div`,{className:`mt-2 font-semibold`,children:`文档中心`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`组件说明、计划和变更记录`})]}),g(x.Grid,{children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Token`}),_(`div`,{className:`mt-2 font-semibold`,children:`设计 Token`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`语义色、尺寸与层级规则`})]}),g(x.Grid,{hoverable:!1,children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Build`}),_(`div`,{className:`mt-2 font-semibold`,children:`构建产物`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`稳定视图，不需要 hover 干扰`})]}),g(x.Grid,{children:[_(`div`,{className:`text-xs uppercase tracking-[0.16em] opacity-60`,children:`Usage`}),_(`div`,{className:`mt-2 font-semibold`,children:`使用趋势`}),_(`div`,{className:`mt-1 text-sm opacity-75`,children:`近 7 天页面访问与组件调用`})]})]})})});c(()=>u(e,l,F))});let I=e(`rue:component:anchor`);i(l,I),p(()=>{let e=f(w,{title:`Pricing Card`,summary:`保留原有定价卡片示例，作为信息密度更高的业务组合案例。`,tab:Ee,code:ve,preview:()=>_(x,{className:`w-full max-w-md bg-base-100 shadow-sm`,children:g(`div`,{className:`card-body`,children:[_(`span`,{className:`badge badge-xs badge-warning`,children:`Most Popular`}),g(`div`,{className:`flex items-end justify-between gap-4`,children:[_(`h2`,{className:`text-3xl font-bold`,children:`Premium`}),_(`span`,{className:`text-xl`,children:`$29/mo`})]}),g(`ul`,{className:`mt-6 flex flex-col gap-2 text-xs leading-6`,children:[_(`li`,{children:`High-resolution image generation`}),_(`li`,{children:`Customizable style templates`}),_(`li`,{children:`Batch processing capabilities`}),_(`li`,{children:`AI-driven image enhancements`}),_(`li`,{className:`opacity-50 line-through`,children:`Seamless cloud integration`}),_(`li`,{className:`opacity-50 line-through`,children:`Real-time collaboration tools`})]}),_(`div`,{className:`mt-6`,children:_(b,{color:`primary`,block:!0,children:`Subscribe`})})]})})});c(()=>u(e,l,I))});let L=e(`rue:component:anchor`);i(l,L),p(()=>{let e=f(w,{title:`Card Sizes`,summary:`保留 xs ~ xl 的旧示例，同时补上更贴近业务语境的说明文案。`,tab:De,code:ye,preview:()=>g(`div`,{className:`grid gap-4 lg:grid-cols-2`,children:[_(x,{size:`xs`,className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Xsmall Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`适合最紧凑的信息块。`})]})}),_(x,{size:`sm`,className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Small Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`移动端列表卡片常用尺寸。`})]})}),_(x,{size:`md`,className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Medium Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`默认信息层级。`})]})}),_(x,{size:`lg`,className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Large Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`适合模块式运营位。`})]})}),_(x,{size:`xl`,className:`bg-base-100 shadow-sm lg:col-span-2`,children:g(x.Body,{children:[_(x.Title,{children:`Xlarge Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`适合宽幅内容摘要、品牌故事和大段说明。`})]})})]})});c(()=>u(e,l,L))});let Ne=e(`rue:component:anchor`);i(l,Ne),p(()=>{let e=f(w,{title:`内容组合`,summary:`保留 badge、纯内容卡片、顶部动作卡三种旧布局，并改成同一组内容编排能力展示。`,tab:Oe,code:be,preview:()=>g(`div`,{className:`grid gap-6 xl:grid-cols-3`,children:[_(x,{className:`overflow-hidden bg-base-100 shadow-sm`,cover:_(`img`,{src:E,alt:`Shoes`}),children:g(x.Body,{children:[g(x.Title,{children:[`Card Title `,_(C,{variant:`secondary`,children:`NEW`})]}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`标题区可以直接承载状态徽标、分类标签和辅助描述。`}),g(x.Actions,{className:`justify-end`,children:[_(C,{outline:!0,children:`Fashion`}),_(C,{outline:!0,children:`Products`})]})]})}),_(x,{className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Card title!`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`没有图片时，Card 依然可以作为纯文字信息块，常用于说明、公告和短引导。`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Buy Now`})})]})}),_(x,{className:`bg-base-100 shadow-sm`,children:g(x.Body,{children:[_(x.Actions,{className:`justify-end`,children:_(b,{shape:`square`,size:`sm`,children:_(oe,{})})}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`把动作放在内容上方，适合轻提示、清单项和可关闭的局部提醒。`})]})})]})});c(()=>u(e,l,Ne))});let Pe=e(`rue:component:anchor`);i(l,Pe),p(()=>{let e=f(w,{title:`边框、颜色与层次`,summary:`保留 border、dash、品牌色、深色居中卡片等旧示例，同时补入 inner 变体。`,tab:ke,code:xe,preview:()=>g(`div`,{className:`grid gap-6 lg:grid-cols-2 xl:grid-cols-3`,children:[_(x,{variant:`outlined`,className:`bg-base-100`,children:g(x.Body,{children:[_(x.Title,{children:`Outlined`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`经典描边信息卡，适合列表页和设置页。`})]})}),_(x,{variant:`dashed`,className:`bg-base-100`,children:g(x.Body,{children:[_(x.Title,{children:`Dashed`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`更像引导态或占位态，用来提示下一步动作。`})]})}),_(x,{className:`bg-primary text-primary-content shadow-sm`,children:g(x.Body,{children:[_(x.Title,{children:`Brand Surface`}),_(`p`,{className:`text-sm leading-6 opacity-90`,children:`保留原有的品牌色卡片用法。`}),_(x.Actions,{className:`justify-end`,children:_(b,{children:`Buy Now`})})]})}),_(x,{className:`bg-neutral text-neutral-content shadow-sm`,children:g(x.Body,{className:`items-center text-center`,children:[_(x.Title,{children:`Cookies!`}),_(`p`,{className:`text-sm leading-6 opacity-85`,children:`居中内容 + 反差表面适合提醒面板。`}),g(x.Actions,{className:`justify-end`,children:[_(b,{color:`primary`,children:`Accept`}),_(b,{type:`text`,children:`Deny`})]})]})}),_(x,{type:`inner`,className:`bg-base-100 shadow-sm lg:col-span-2 xl:col-span-1`,children:g(x.Body,{children:[_(x.Title,{children:`Inner`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`inner 会切到更内嵌的底色和边框，适合把提示块、日志块或小型面板压进更大的容器里。`})]})})]})});c(()=>u(e,l,Pe))});let Fe=e(`rue:component:anchor`);i(l,Fe),p(()=>{let e=f(w,{title:`媒体布局`,summary:`保留顶部图片、底部图片、居中留白、图片覆盖四种旧媒体布局。`,tab:Ae,code:Se,preview:()=>g(`div`,{className:`grid gap-6 xl:grid-cols-2`,children:[_(x,{className:`overflow-hidden bg-base-100 shadow-sm`,cover:_(`img`,{src:E,alt:`Shoes`}),children:g(x.Body,{children:[_(x.Title,{children:`Card Title`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`最常见的顶部封面布局。`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Buy Now`})})]})}),g(x,{className:`bg-base-100 shadow-sm`,children:[g(x.Body,{children:[_(x.Title,{children:`Bottom Image`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`把媒体放到内容之后，适合做故事卡片。`})]}),_(`figure`,{children:_(`img`,{src:E,alt:`Shoes`})})]}),g(x,{className:`bg-base-100 shadow-sm`,children:[_(`figure`,{className:`px-10 pt-10`,children:_(`img`,{src:E,alt:`Shoes`,className:`rounded-box`})}),g(x.Body,{className:`items-center text-center`,children:[_(x.Title,{children:`Centered Card`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`保留原有居中内容与额外留白的写法。`}),_(x.Actions,{children:_(b,{color:`primary`,children:`Buy Now`})})]})]}),_(x,{imageFull:!0,className:`overflow-hidden bg-base-100 shadow-sm`,cover:_(`img`,{src:E,alt:`Shoes`}),children:g(x.Body,{children:[_(x.Title,{children:`Image Overlay`}),_(`p`,{className:`text-sm leading-6 opacity-90`,children:`imageFull 让封面进入背景层，适合做大图氛围卡。`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Buy Now`})})]})})]})});c(()=>u(e,l,Fe))});let Ie=e(`rue:component:anchor`);i(l,Ie),p(()=>{let e=f(w,{title:`横向布局`,summary:`保留 side 和响应式横向布局两种旧示例，适合媒体摘要和推荐位。`,tab:je,code:Ce,preview:()=>g(`div`,{className:`grid gap-6 xl:grid-cols-2`,children:[g(x,{side:!0,className:`overflow-hidden bg-base-100 shadow-sm`,children:[_(`figure`,{children:_(`img`,{src:ee,alt:`Movie`})}),g(x.Body,{children:[_(x.Title,{children:`New movie is released!`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`Click the button to watch on Jetflix app.`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Watch`})})]})]}),g(x,{className:`overflow-hidden bg-base-100 shadow-sm lg:card-side`,children:[_(`figure`,{children:_(`img`,{src:te,alt:`Album`})}),g(x.Body,{children:[_(x.Title,{children:`New album is released!`}),_(`p`,{className:`text-sm leading-6 opacity-75`,children:`Click the button to listen on Spotiwhy app.`}),_(x.Actions,{className:`justify-end`,children:_(b,{color:`primary`,children:`Listen`})})]})]})]})});c(()=>u(e,l,Ie))});let R=r(`div`,l);i(l,R),n(R,`not-prose my-8 space-y-6`);let z=r(`div`,R);i(R,z);let B=r(`h2`,z);i(z,B),n(B,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(B,a(`# API`));let V=r(`p`,z);i(z,V),n(V,`m-0 text-sm opacity-70`),i(V,a(`Rue Card 现在同时支持“语义化根组件 API”和“低层复合子组件 API”。如果你已经习惯直接写 daisyUI 结构，也仍然可以继续混用。`));let H=r(`div`,R);i(R,H);let U=r(`h3`,H);i(H,U),n(U,`mt-0 mb-3 text-base font-semibold`),i(U,a(`Card`));let Le=e(`rue:component:anchor`);i(H,Le),p(()=>{let e=f(T,{rows:le});c(()=>u(e,H,Le))});let W=r(`div`,R);i(R,W);let G=r(`h3`,W);i(W,G),n(G,`mt-0 mb-3 text-base font-semibold`),i(G,a(`Card.Meta`));let K=e(`rue:component:anchor`);i(W,K),p(()=>{let e=f(T,{rows:ue});c(()=>u(e,W,K))});let q=r(`div`,R);i(R,q);let J=r(`h3`,q);i(q,J),n(J,`mt-0 mb-3 text-base font-semibold`),i(J,a(`Card.Grid`));let Y=e(`rue:component:anchor`);i(q,Y),p(()=>{let e=f(T,{rows:de});c(()=>u(e,q,Y))});let X=r(`div`,R);i(R,X),n(X,`rounded-box border border-base-300 bg-base-100 p-5 text-sm leading-7`);let Z=r(`div`,X);i(X,Z),n(Z,`text-xs uppercase tracking-[0.18em] opacity-60`),i(Z,a(`低层复合结构`));let Q=r(`div`,X);i(X,Q),n(Q,`mt-3 font-medium`),i(Q,a(`Card.Body / Card.Title / Card.Actions / Card.Figure`));let $=r(`p`,X);return i(X,$),n($,`mt-2 mb-0 opacity-75`),i($,a(`这四个子组件保持和旧版一样的职责：当你想完全接管布局顺序时，继续直接拼结构即可；当你只想快速生成头部、封面和操作区时，再切到根组件的语义化 props。`)),s})}),d,m),d})};export{D as default};