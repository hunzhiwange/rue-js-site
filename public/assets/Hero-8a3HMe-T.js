...
</div>`});i(()=>d(e,n,fe))});let W=e(`div`,n);a(n,W),c(W,`not-prose my-12 space-y-8`);let G=e(`section`,W);a(W,G),c(G,`space-y-2`);let K=e(`h2`,G);a(G,K),c(K,`text-2xl font-semibold`),a(K,u(`API`));let q=e(`p`,G);a(G,q),c(q,`text-sm opacity-70`),a(q,u(`推荐把外层背景和高度交给 Hero Root，把布局交给 Hero.Content，把标题、描述和 CTA 交给语义子组件。这样页面里仍然可以继续用 className 微调，但不会反复重写同一套结构。`));let J=e(`section`,W);a(W,J),c(J,`space-y-3`);let Y=e(`h3`,J);a(J,Y),c(Y,`text-xl font-semibold`),a(Y,u(`Hero`));let pe=s(`rue:component:anchor`);a(J,pe),o(()=>{let e=p(H,{rows:ne});i(()=>d(e,J,pe))});let X=e(`section`,W);a(W,X),c(X,`space-y-3`);let Z=e(`h3`,X);a(X,Z),c(Z,`text-xl font-semibold`),a(Z,u(`Hero.Content`));let me=s(`rue:component:anchor`);a(X,me),o(()=>{let e=p(H,{rows:re});i(()=>d(e,X,me))});let Q=e(`section`,W);a(W,Q),c(Q,`space-y-3`);let $=e(`h3`,Q);a(Q,$),c($,`text-xl font-semibold`),a($,u(`Hero parts`));let he=s(`rue:component:anchor`);return a(Q,he),o(()=>{let e=p(H,{rows:ie});i(()=>d(e,Q,he))}),t})}),n,m),n})};export{U as default};