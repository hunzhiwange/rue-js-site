...
/>
`,qe=[{prop:`allowClear`,description:`追加清空按钮，适合单选、多选和勾选模式统一收敛到一个入口`,type:`boolean | { clearIcon?: any }`,defaultValue:`false`},{prop:`fieldNames`,description:`映射 label、value、children、key 与 simple mode 的 id / pId 字段`,type:`TreeSelectFieldNames`,defaultValue:`{ title, value, children, key }`},{prop:`labelInValue`,description:`把回填值组织为 { value, key, label, halfChecked } 结构`,type:`boolean`,defaultValue:`false`},{prop:`loadData`,description:`展开未加载节点时触发异步加载，适合目录、权限树、远端分类场景`,type:`(node) => Promise<any> | void`,defaultValue:`-`},{prop:`maxCount`,description:`限制多选 / 勾选模式下最多展示并回填多少个节点`,type:`number`,defaultValue:`-`},{prop:`multiple`,description:`多选模式，已选项会回填为标签列表`,type:`boolean`,defaultValue:`false`},{prop:`showCheckedStrategy`,description:`控制 treeCheckable 时的回填策略，支持 SHOW_ALL / SHOW_PARENT / SHOW_CHILD`,type:`TreeSelectShowCheckedStrategy`,defaultValue:`SHOW_CHILD`},{prop:`showSearch`,description:`开启搜索输入；对象模式可配置 autoClearSearchValue、filterTreeNode 与 onSearch`,type:`boolean | TreeSelectShowSearchConfig`,defaultValue:`单选 false / 多选 true`},{prop:`treeCheckable`,description:`把树节点切到 checkbox 模式，适合权限树、发布范围、分类选择`,type:`boolean`,defaultValue:`false`},{prop:`treeData`,description:`树数据源，title / value / children 为常用字段，value 在整棵树里需要唯一`,type:`TreeSelectDataNode[]`,defaultValue:`[]`},{prop:`treeDataSimpleMode`,description:`接收扁平结构树数据，并通过 id / pId 自动恢复层级`,type:`boolean | { id?: string; pId?: string; rootPId?: string | number | null }`,defaultValue:`false`},{prop:`treeDefaultExpandAll / treeExpandedKeys`,description:`控制树默认展开和受控展开，便于做大树分层浏览`,type:`boolean / TreeSelectValue[]`,defaultValue:`false / -`},{prop:`treeNodeFilterProp`,description:`搜索命中用的字段，常见设置是 title 或自定义 label 字段`,type:`string`,defaultValue:`value`},{prop:`variant / status`,description:`使用 Rue 输入类组件的视觉语义，支持 filled、borderless、underlined 与 warning/error`,type:`'outlined' | 'filled' | 'borderless' | 'underlined' / 'warning' | 'error'`,defaultValue:`'outlined' / -`}],Je=()=>{let{basicValue:r,noClearValue:i,simpleValue:a,multipleValue:o,multipleOpen:s,checkableValue:c,checkableOpen:d,semanticValue:g,shellValue:v,asyncValue:S,asyncExpandedKeys:C,asyncTreeData:ee,loadAsyncTree:te,tabs:T}=w(`useSetup:0:0`,()=>m(()=>{let e=w(`ref:1:0`,()=>n(`docs`)),t=w(`ref:1:1`,()=>n(`docs`)),r=w(`ref:1:2`,()=>n(`workflow`)),i=w(`ref:1:3`,()=>n([`analytics`,`minutes`])),a=w(`ref:1:4`,()=>n(!1)),o=w(`ref:1:5`,()=>n([`build`,`quality`])),s=w(`ref:1:6`,()=>n(!1)),c=w(`ref:1:7`,()=>n({value:`release`,key:`release`,label:`发布管道`})),l=w(`ref:1:8`,()=>n(`prod`)),u=w(`ref:1:9`,()=>n(null)),d=w(`ref:1:10`,()=>n([])),f=w(`ref:1:11`,()=>n([{title:`按需加载目录`,value:`async-root`,isLeaf:!1}]));return{basicValue:e,noClearValue:t,simpleValue:r,multipleValue:i,multipleOpen:a,checkableValue:o,checkableOpen:s,semanticValue:c,shellValue:l,asyncValue:u,asyncExpandedKeys:d,asyncTreeData:f,loadAsyncTree:async e=>{e.value===`async-root`&&(f.value=[{title:`按需加载目录`,value:`async-root`,isLeaf:!1,children:[{title:`实验看板`,value:`async-dashboard`},{title:`巡检报告`,value:`async-report`},{title:`回归清单`,value:`async-checklist`}]}])},tabs:{basic:w(`ref:1:12`,()=>n(`preview`)),noClear:w(`ref:1:13`,()=>n(`preview`)),simple:w(`ref:1:14`,()=>n(`preview`)),multiple:w(`ref:1:15`,()=>n(`preview`)),checkable:w(`ref:1:16`,()=>n(`preview`)),semantic:w(`ref:1:17`,()=>n(`preview`)),async:w(`ref:1:18`,()=>n(`preview`)),shell:w(`ref:1:19`,()=>n(`preview`))}}}));return u(n=>{let m=f(),w=x(`rue:component:anchor`);return e(m,w),p(y(k,{children:u(()=>{let n=f(),u=_(`div`,n);e(n,u),h(u,`max-w-none prose prose-sm md:prose-base`);let m=_(`h1`,u);e(u,m),e(m,l(`TreeSelect 树选择`));let w=_(`p`,u);e(u,w),h(w,`text-sm mt-3 mb-3`),e(w,l(`TreeSelect 适合“下拉选择 + 树结构浏览”同时存在的输入场景，比如目录、组织架构、权限树、资源分类和发布范围。 视觉使用 Rue 的 input / badge / base 色阶体系，能力覆盖 treeData、simple mode、多选、 勾选、语义值、异步加载和 filled / warning 等核心场景。`));let E=_(`div`,u);e(u,E),h(E,`not-prose mt-8 space-y-2`);let k=_(`h2`,E);e(E,k),h(k,`text-2xl font-semibold`),e(k,l(`基础能力`));let j=_(`p`,E);e(E,j),h(j,`text-sm text-base-content/70`),e(j,l(`先把单选、搜索和清空打稳，再把 simple mode、多选与勾选这些更接近业务配置面的能力接进来。`));let ne=x(`rue:component:anchor`);e(u,ne),t(()=>{let e=y(A,{title:`Basic`,summary:`单选、搜索、默认展开与 allowClear 的组合，是目录选择最常见的入口。`,tab:T.basic,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body gap-3`,children:[O(V,{value:r.value,treeData:Fe,treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,placeholder:`选择一个树节点`,onChange:e=>{r.value=String(H(e)??``)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,r.value||`未选择`]})]})}),code:ze});b(()=>p(e,u,ne))});let M=x(`rue:component:anchor`);e(u,M),t(()=>{let e=y(A,{title:`Without allowClear`,summary:`未开启 allowClear 时，只保持选择交互，不显示 selector 右侧的清空入口。`,tab:T.noClear,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body gap-3`,children:[O(V,{value:i.value,treeData:Fe,treeDefaultExpandAll:!0,onChange:e=>{i.value=String(H(e)??``)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,i.value||`未选择`]})]})}),code:Be});b(()=>p(e,u,M))});let re=x(`rue:component:anchor`);e(u,re),t(()=>{let e=y(A,{title:`Simple Mode`,summary:`扁平树数据直接接入，适合后端给的是 id / pId 结构时减少前置整理成本。`,tab:T.simple,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[D(`div`,{className:`grid gap-3`,children:[O(V,{value:a.value,treeData:Re,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{value:`code`,label:`name`,key:`code`},treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,onChange:e=>{a.value=String(H(e)??``)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`当前目标：`,a.value||`未选择`]})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`这类接口在 CMS、流程平台、低代码配置里很常见。只要给出 id / pId / value / title 映射，就能直接恢复成可搜索树。`})]})}),code:Ve});b(()=>p(e,u,re))});let N=x(`rue:component:anchor`);e(u,N),t(()=>{let e=y(A,{title:`Multiple`,summary:`多选模式默认以标签回填，适合通知订阅、面板订阅、资源批量绑定。`,tab:T.multiple,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body gap-3`,children:[O(V,{value:o.value,open:s.value,treeData:Ie,multiple:!0,treeDefaultExpandAll:!0,allowClear:!0,maxTagCount:2,placeholder:`选择多个项目`,onOpenChange:e=>{s.value=e},onChange:(e,t,n)=>{o.value=Pe(e),n.clear||(s.value=!0)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`已选：`,o.value.join(` / `)||`未选择`]})]})}),code:He});b(()=>p(e,u,N))});let P=x(`rue:component:anchor`);e(u,P),t(()=>{let e=y(A,{title:`Checkable`,summary:`勾选树会把多选语义进一步贴近权限树和发布范围；默认 SHOW_CHILD 会直接回填实际勾选的子节点。`,tab:T.checkable,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[D(`div`,{className:`grid gap-3`,children:[O(V,{value:c.value,open:d.value,treeData:Fe,treeCheckable:!0,maxTagCount:2,maxTagPlaceholder:`...`,allowClear:!0,treeDefaultExpandAll:!0,onOpenChange:e=>{d.value=e},onChange:(e,t,n)=>{c.value=Pe(e),n.clear||(d.value=!0)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`回填：`,c.value.join(` / `)||`未选择`]})]}),D(`ul`,{className:`list rounded-box border border-base-300 bg-base-200/40 p-4 text-sm`,children:[D(`li`,{className:`list-row`,children:[O(`span`,{className:`font-medium`,children:`策略`}),O(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例使用默认 SHOW_CHILD，选了哪些子节点就回填哪些子节点，更适合精确范围选择。`})]}),D(`li`,{className:`list-row`,children:[O(`span`,{className:`font-medium`,children:`切换`}),O(`span`,{className:`list-col-grow text-base-content/70`,children:`如果业务更想要紧凑展示，可以把 showCheckedStrategy 改成 TreeSelect.SHOW_PARENT，让完整分组选中时折叠成父标签。`})]}),D(`li`,{className:`list-row`,children:[O(`span`,{className:`font-medium`,children:`回填`}),O(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例最多展示两个标签，更多已选项会用 ... 收起，避免 selector 被撑成两排。`})]})]})]})}),code:Ue});b(()=>p(e,u,P))});let F=_(`div`,u);e(u,F),h(F,`not-prose mt-10 space-y-2`);let I=_(`h2`,F);e(F,I),h(I,`text-2xl font-semibold`),e(I,l(`高级能力`));let L=_(`p`,F);e(F,L),h(L,`text-sm text-base-content/70`),e(L,l(`语义值、异步加载和外观变体覆盖配置类面板里的常见选择场景。`));let ie=x(`rue:component:anchor`);e(u,ie),t(()=>{let e=y(A,{title:`Label In Value`,summary:`当业务既要 value 也要 label 时，直接回填结构体会更顺手。`,tab:T.semantic,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[O(`div`,{className:`grid gap-3`,children:O(V,{value:g.value,treeData:Fe,labelInValue:!0,treeDefaultExpandAll:!0,onChange:e=>{g.value=e??null}})}),D(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:[`当前结构：`,O(`code`,{children:JSON.stringify(g.value)})]})]})}),code:We});b(()=>p(e,u,ie))});let ae=x(`rue:component:anchor`);e(u,ae),t(()=>{let e=y(A,{title:`Async Load`,summary:`展开未加载分支时触发 loadData，适合远端目录、权限树和超大分类树。`,tab:T.async,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[D(`div`,{className:`grid gap-3`,children:[O(V,{value:S.value,treeExpandedKeys:C.value,treeData:ee.value,allowClear:!0,loadData:te,onTreeExpand:e=>{C.value=e},onChange:e=>{S.value=String(H(e)??``)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,S.value||`尚未选择`]})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`第一次展开“按需加载目录”时会把子节点注入到 treeData，这个模式适合服务端分页目录和按需权限树。`})]})}),code:Ge});b(()=>p(e,u,ae))});let oe=x(`rue:component:anchor`);e(u,oe),t(()=>{let e=y(A,{title:`Variant and Status`,summary:`TreeSelect 也使用 Rue 当前输入体系的 filled / warning 视觉语义。`,tab:T.shell,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:D(`div`,{className:`card-body grid gap-4 md:grid-cols-2`,children:[D(`div`,{className:`grid gap-3`,children:[O(V,{value:v.value,treeData:Le,prefix:O(`span`,{className:`badge badge-neutral badge-sm`,children:`ENV`}),suffix:O(`span`,{className:`text-xs opacity-60`,children:`可清空`}),variant:`filled`,status:`warning`,allowClear:!0,treeDefaultExpandAll:!0,onChange:e=>{v.value=String(H(e)??``)}}),D(`div`,{className:`text-sm text-base-content/70`,children:[`当前环境：`,v.value||`未选择`]})]}),O(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`prefix / suffix 让 TreeSelect 能自然落进环境切换、租户切换和带状态提醒的配置表单里。`})]})}),code:Ke});b(()=>p(e,u,oe))});let R=_(`div`,u);e(u,R),h(R,`not-prose mt-10 space-y-4`);let z=_(`h2`,R);e(R,z),h(z,`text-2xl font-semibold`),e(z,l(`API`));let se=x(`rue:component:anchor`);return e(R,se),t(()=>{let e=y(Ne,{rows:qe});b(()=>p(e,R,se))}),n})}),m,w),m})};export{Je as default};