import{Bt as e,C as t,Dn as n,Et as r,H as i,K as a,L as o,Lt as s,S as c,V as l,Vt as u,W as d,Wt as f,_n as p,bn as m,fn as h,gn as g,hn as _,nt as v,ot as y,pn as b,qt as x,un as S,wn as C,x as w}from"./rue-runtime-CwEGJ854.js";import{t as T}from"./Code-B3jCYMAr.js";import{r as E}from"./SidebarPlaygroundExample-EGR0CyDT.js";var D=p(`<h1 class="text-5xl font-semibold mb-4 md:mb-4">triggerRef 手动触发浅层 ref</h1>`),O=p(`<div role="tablist" class="tabs tabs-box"><button role="tab">效果</button><button role="tab">代码</button></div>`),k=p(`<div class="mt-4 grid md:grid-cols-1 gap-6 items-start"><!--rue:text-hole:0--><!--rue:text-hole:1--></div>`),A=`import { type FC, ref, shallowRef, triggerRef } from '@rue-js/rue';
