...
</div>`});y(()=>p(e,u,j))});let M=b(`rue:component:anchor`);t(u,M),n(()=>{let e=v(A,{title:`Controlled visibility`,tab:c,preview:()=>O(oe,{}),code:`const controlledOpen = ref(false)
