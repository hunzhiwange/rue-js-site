import{Bt as e,Dn as t,Et as n,K as r,L as i,Lt as a,Mt as o,V as s,X as c,Y as l,_n as u,_t as d,at as f,et as p,gn as m,hn as h,ht as g,it as _,kn as v,nt as y,pt as b,q as x,rt as S,tt as C,wn as w,y as T,z as E}from"./rue-runtime-CwEGJ854.js";import{t as D}from"./Code-DUvGro8N.js";import{r as O}from"./SidebarPlaygroundExample-EGR0CyDT.js";var k=u(`<h1 class="text-5xl font-semibold mb-4 md:mb-4">带过渡动效的列表（移植自 Vue）</h1>`),A=u(`<div role="tablist" class="tabs tabs-box"><button role="tab">效果</button><button role="tab">代码</button></div>`),j=u(`<div class="mt-4 grid md:grid-cols-1 gap-6 items-start"><!--rue:text-hole:0--><!--rue:text-hole:1--></div>`),M=[1,2,3,4,5],N=350,P=`
.list-shell {
  position: relative;
}
