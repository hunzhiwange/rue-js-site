...
/>`});h(()=>u(e,s,j))});let M=o(`rue:component:anchor`);r(s,M),l(()=>{let e=p(F,{title:`数据驱动导航项`,summary:`当中间菜单和右侧状态来自配置或接口时，用 items 比手写结构更容易维护。`,tab:v,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`rounded-box bg-base-100`,brand:y(`a`,{className:`btn btn-ghost gap-3 px-2 text-lg normal-case`,children:[b(z,{label:`W`}),`Workspace`]}),items:te,actions:b(`button`,{className:`btn btn-primary btn-sm`,children:`Invite`}),centerProps:{className:`hidden md:flex gap-1`},endProps:{className:`gap-2`},"data-testid":`navbar-items`})})}),code:`const items = [
...
/>`});h(()=>u(e,s,N))});let R=a(`h2`,s);r(s,R),r(R,d(`经典 demo`));let B=a(`p`,s);r(s,B),r(B,d(`下面这几组示例保留了原有写法，只做了页面重组，方便继续对照 Start / Center / End 的经典组合方式。`));let se=o(`rue:component:anchor`);r(s,se),l(()=>{let e=p(F,{title:`仅标题`,summary:`最简单的 navbar，用 root 直接承载内容。`,tab:C,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-only`,children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <button className="btn btn-ghost text-xl">daisyUI</button>
</Navbar>`});h(()=>u(e,s,se))});let ce=o(`rue:component:anchor`);r(s,ce),l(()=>{let e=p(F,{title:`标题与图标`,summary:`保留经典的 Start + End 组合。`,tab:w,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-icon`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:b(`button`,{className:`btn btn-square btn-ghost`,children:b(L,{})})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});h(()=>u(e,s,V))});let H=o(`rue:component:anchor`);r(s,H),l(()=>{let e=p(F,{title:`菜单与子菜单`,summary:`继续保留菜单容器和 details 子菜单的经典演示。`,tab:E,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-menu-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:y(`ul`,{className:`menu menu-horizontal items-center gap-1 px-1`,children:[b(`li`,{children:b(`button`,{className:`h-10 min-h-10 items-center`,children:`Link`})}),b(`li`,{children:y(`details`,{children:[b(`summary`,{className:`h-10 min-h-10 items-center`,children:`Parent`}),y(`ul`,{className:`bg-base-100 rounded-t-none p-2`,children:[b(`li`,{children:b(`button`,{children:`Link 1`})}),b(`li`,{children:b(`button`,{children:`Link 2`})})]})]})})]})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});h(()=>u(e,s,H))});let U=o(`rue:component:anchor`);r(s,U),l(()=>{let e=p(F,{title:`搜索框与头像下拉`,summary:`保留搜索、头像和下拉菜单混排的经典结构。`,tab:ee,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-search-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),y(P.End,{className:`gap-2`,children:[b(`input`,{type:`text`,placeholder:`Search`,className:`input input-bordered w-24 md:w-auto`}),y(`div`,{className:`dropdown dropdown-end`,children:[b(`div`,{tabIndex:`0`,role:`button`,className:`btn btn-ghost btn-circle avatar`,children:b(`div`,{className:`w-10 rounded-full`,children:b(`img`,{alt:`Tailwind CSS Navbar component`,src:`https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp`})})}),y(`ul`,{tabIndex:`-1`,className:`mt-3 z-1 p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52`,children:[b(`li`,{children:y(`button`,{className:`justify-between`,children:[`Profile`,b(`span`,{className:`badge`,children:`New`})]})}),b(`li`,{children:b(`button`,{children:`Settings`})}),b(`li`,{children:b(`button`,{children:`Logout`})})]})]})]})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
...
</Navbar>`});h(()=>u(e,s,U))});let W=a(`h2`,s);r(s,W),e(W,`id`,`navbar-api`),r(W,d(`API`));let le=a(`p`,s);r(s,le),r(le,d(`Navbar 现在同时支持推荐的语义插槽模式，以及原有的组合模式。`));let ue=a(`h3`,s);r(s,ue),r(ue,d(`Navbar`));let de=o(`rue:component:anchor`);r(s,de),l(()=>{let e=p(I,{rows:ie});h(()=>u(e,s,de))});let fe=a(`h3`,s);r(s,fe),r(fe,d(`Navbar.Start / Navbar.Center / Navbar.End / Navbar.Section`));let pe=o(`rue:component:anchor`);r(s,pe),l(()=>{let e=p(I,{rows:ae});h(()=>u(e,s,pe))});let me=a(`h3`,s);r(s,me),r(me,d(`Navbar.Item / items[]`));let he=o(`rue:component:anchor`);r(s,he),l(()=>{let e=p(I,{rows:oe});h(()=>u(e,s,he))});let G=a(`div`,s);r(s,G),m(G,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let K=a(`h3`,G);r(G,K),m(K,`mt-0 mb-3 text-base font-semibold`),r(K,d(`双模式说明`));let q=a(`div`,G);r(G,q),m(q,`grid gap-3 text-sm md:grid-cols-2`);let J=a(`div`,q);r(q,J);let ge=a(`code`,J);r(J,ge),r(ge,d(`children + Navbar.Start/Center/End`)),r(J,d(`: 适合完全手写布局，兼容旧 demo。`));let Y=a(`div`,q);r(q,Y);let _e=a(`code`,Y);r(Y,_e),r(_e,d(`brand / start / center / end / actions / items`)),r(Y,d(`: 适合抽象成复用头部或通过配置生成导航结构。`));let ve=a(`h2`,s);r(s,ve),r(ve,d(`FAQ`));let ye=a(`h3`,s);r(s,ye),r(ye,d(`什么时候选推荐模式，什么时候继续手写 children？`));let X=a(`p`,s);r(s,X),r(X,d(`如果页面头部结构在多个页面之间重复，或者导航项来自配置，优先用语义插槽和`));let be=i(X);r(X,be),f(be,` `);let xe=a(`code`,X);r(X,xe),r(xe,d(`items`)),r(X,d(`。 如果当前头部结构非常自由，包含复杂的 dropdown、menu、搜索表单，继续手写`));let Se=a(`code`,X);r(X,Se),r(Se,d(`children + Navbar.Start/Center/End`)),r(X,d(`会更直接。`));let Ce=a(`h3`,s);r(s,Ce),r(Ce,d(`children 和 items 同时传时谁优先？`));let Z=a(`p`,s);r(s,Z),r(Z,d(`当前实现会优先渲染`));let we=a(`code`,Z);r(Z,we),r(we,d(`children`)),r(Z,d(`。这样可以保证旧代码迁移时不被新属性打断， 也能让组合模式保持完全可控。`));let Q=a(`h3`,s);r(s,Q),r(Q,d(`sticky 和 bordered 是强样式能力吗？`));let $=a(`p`,s);r(s,$),r($,d(`不是。它们只是补一层常用布局类，仍然遵循 Rue 当前的视觉基底；更细的背景、阴影、圆角和响应式布局， 依然建议通过`));let Te=a(`code`,$);r($,Te),r(Te,d(`className`));let Ee=i($);return r($,Ee),f(Ee,` `),r($,d(`和区块 props 来组合。`)),t})}),s,_),s})};export{B as default};