...
/>`});i(()=>p(e,n,N))});let te=s(`rue:component:anchor`);a(n,te),o(()=>{let e=m(z,{title:`图片对比`,summary:`组合式写法示例。`,tab:C,preview:()=>v(R,{className:`rounded-field aspect-16/9`,tabIndex:0,children:[y(R.Item1,{role:`img`,tabIndex:0,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a.webp`})}),y(R.Item2,{role:`img`,children:y(`img`,{alt:`daisy`,src:`https://img.daisyui.com/images/stock/photo-1560717789-0ac7c58ac90a-blur.webp`})}),y(R.Resizer,{})]}),code:`<Diff className="aspect-16/9" tabIndex={0}>
  ...
  <Diff.Resizer />
</Diff>`});i(()=>p(e,n,P))});let F=e(`h2`,n);a(n,F),f(F,`id`,`diff-api`),a(F,l(`API`));let I=e(`p`,n);a(n,I),a(I,l(`Diff 现在同时支持快捷模式和组合式模式，下面按根组件和子组件拆开列出。`));let L=s(`rue:component:anchor`);a(n,L),o(()=>{let e=m(B,{rows:V});i(()=>p(e,n,L))});let U=e(`div`,n);a(n,U),c(U,`not-prose mt-6`);let W=s(`rue:component:anchor`);a(n,W),o(()=>{let e=m(B,{rows:H});i(()=>p(e,n,W))});let G=e(`div`,n);a(n,G),c(G,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4 text-sm`);let K=e(`div`,G);a(G,K),c(K,`font-semibold`),a(K,l(`模式选择建议`));let q=e(`div`,G);a(G,q),c(q,`mt-2 grid gap-2 md:grid-cols-2`);let J=e(`div`,q);a(q,J);let Y=e(`code`,J);a(J,Y),a(Y,l(`item1 / item2`)),a(J,l(`适合快速搭 demo、做受控联动、补标签和默认手柄内容。`));let X=e(`div`,q);a(q,X);let ne=e(`code`,X);a(X,ne),a(ne,l(`children + Diff.Item1 / Item2 / Resizer`));let re=h(X);a(X,re),d(re,` `),a(X,l(`适合保留旧结构，或自己完全掌控内部布局。`));let ie=e(`h2`,n);a(n,ie),a(ie,l(`FAQ`));let ae=e(`h3`,n);a(n,ae),a(ae,l(`快捷模式和组合式模式怎么选？`));let Z=e(`p`,n);a(n,Z),a(Z,l(`如果你只是想比较两个内容块，优先用`));let oe=e(`code`,Z);a(Z,oe),a(oe,l(`item1`)),a(Z,l(`和`));let se=e(`code`,Z);a(Z,se),a(se,l(`item2`)),a(Z,l(`。如果你已经有现成结构， 或者需要完全接管内部节点顺序，就继续用旧的组合式写法。`));let ce=e(`h3`,n);a(n,ce),a(ce,l(`value 和 defaultValue 有什么区别？`));let Q=e(`p`,n);a(n,Q);let le=e(`code`,Q);a(Q,le),a(le,l(`value`)),a(Q,l(`是受控值，外部状态说了算；`));let ue=e(`code`,Q);a(Q,ue),a(ue,l(`defaultValue`));let de=h(Q);a(Q,de),d(de,` `),a(Q,l(`只决定初始位置，之后由组件内部维护。`));let fe=e(`h3`,n);a(n,fe),a(fe,l(`传了 children 之后 value 还会生效吗？`));let $=e(`p`,n);a(n,$),a($,l(`当前版本里，`));let pe=e(`code`,$);a($,pe),a(pe,l(`children`)),a($,l(`会切换到组合式模式，因此`));let me=e(`code`,$);a($,me),a(me,l(`value`)),a($,l(`、`));let he=e(`code`,$);a($,he),a(he,l(`defaultValue`)),a($,l(`这些快捷模式能力不会接管内部布局。需要受控拖动时，优先使用`));let ge=e(`code`,$);a($,ge),a(ge,l(`item1`)),a($,l(`/`));let _e=h($);a($,_e),d(_e,` `);let ve=e(`code`,$);return a($,ve),a(ve,l(`item2`)),a($,l(`。`)),t})}),n,g),n})};export{U as default};