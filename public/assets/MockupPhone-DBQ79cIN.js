...
/>`});h(()=>u(e,s,R))});let z=a(`h2`,s);r(s,z),e(z,`id`,`mockup-phone-api`),r(z,d(`API`));let B=a(`p`,s);r(s,B),r(B,d(`MockupPhone 现在支持“根级简写模式”和“经典 compound 模式”两套写法。`));let V=a(`h3`,s);r(s,V),r(V,d(`MockupPhone`));let pe=o(`rue:component:anchor`);r(s,pe),l(()=>{let e=p(te,{rows:ne});h(()=>u(e,s,pe))});let H=a(`h3`,s);r(s,H),m(H,`mt-6`),r(H,d(`Compound Parts`));let me=o(`rue:component:anchor`);r(s,me),l(()=>{let e=p(te,{rows:re});h(()=>u(e,s,me))});let U=a(`div`,s);r(s,U),m(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=a(`h3`,U);r(U,W),m(W,`mt-0 mb-3 text-base font-semibold`),r(W,d(`display 对象结构`));let G=a(`div`,U);r(U,G),m(G,`grid gap-2 text-sm md:grid-cols-2`);let K=a(`div`,G);r(G,K);let he=a(`code`,K);r(K,he),r(he,d(`className`)),r(K,d(`：显示区根节点类名`));let q=a(`div`,G);r(G,q);let ge=a(`code`,q);r(q,ge),r(ge,d(`src`)),r(q,d(`/`));let _e=a(`code`,q);r(q,_e),r(_e,d(`alt`)),r(q,d(`/`));let ve=a(`code`,q);r(q,ve),r(ve,d(`imgClassName`)),r(q,d(`：内置壁纸图`));let J=a(`div`,G);r(G,J);let ye=a(`code`,J);r(J,ye),r(ye,d(`children`)),r(J,d(`：显示区内容`));let Y=a(`div`,G);r(G,Y);let be=a(`code`,Y);r(Y,be),r(be,d(`contentClassName`)),r(Y,d(`：为 children 额外包一层容器，便于做绝对定位和覆盖层`));let xe=a(`h2`,s);r(s,xe),r(xe,d(`FAQ`));let Se=a(`h3`,s);r(s,Se),r(Se,d(`什么时候用 display，什么时候继续写 MockupPhone.Display？`));let X=a(`p`,s);r(s,X),r(X,d(`如果只是想快速搭一个手机画面，优先用`));let Ce=a(`code`,X);r(X,Ce),r(Ce,d(`display`)),r(X,d(`。如果你需要自己决定显示区里的完整节点树，或者已经在复用旧 demo，继续用`));let we=a(`code`,X);r(X,we),r(we,d(`MockupPhone.Camera`)),r(X,d(`和`));let Te=a(`code`,X);r(X,Te),r(Te,d(`MockupPhone.Display`)),r(X,d(`会更直观。`));let Ee=a(`h3`,s);r(s,Ee),r(Ee,d(`color 和 className 应该怎么选？`));let Z=a(`p`,s);r(s,Z);let De=a(`code`,Z);r(Z,De),r(De,d(`color`)),r(Z,d(`负责常用边框主题色，适合快速选主色；`));let Oe=a(`code`,Z);r(Z,Oe),r(Oe,d(`className`));let Q=i(Z);r(Z,Q),f(Q,` `),r(Z,d(`负责更细的样式控制，比如任意十六进制边框色、自定义阴影或缩放。`));let ke=a(`h3`,s);r(s,ke),r(ke,d(`如何在壁纸上叠加浮层内容？`));let $=a(`p`,s);r(s,$),r($,d(`让`));let Ae=a(`code`,$);r($,Ae),r(Ae,d(`display.className`)),r($,d(`具备`));let je=a(`code`,$);r($,je),r(je,d(`relative`)),r($,d(`和`));let Me=i($);r($,Me),f(Me,` `);let Ne=a(`code`,$);r($,Ne),r(Ne,d(`overflow-hidden`)),r($,d(`，再把浮层内容放进`));let Pe=a(`code`,$);r($,Pe),r(Pe,d(`children`)),r($,d(`，通过`));let Fe=a(`code`,$);r($,Fe),r(Fe,d(`contentClassName`)),r($,d(`设置`));let Ie=i($);r($,Ie),f(Ie,` `);let Le=a(`code`,$);return r($,Le),r(Le,d(`absolute inset-0`)),r($,d(`即可。`)),t})}),s,_),s})};export{F as default};