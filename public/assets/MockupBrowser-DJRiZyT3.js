...
</MockupBrowser>`});l(()=>f(e,d,P))});let F=r(`h2`,d);i(d,F),s(F,`id`,`mockup-browser-api`),i(F,o(`API`));let I=r(`p`,d);i(d,I),i(I,o(`MockupBrowser 现在支持推荐快捷模式和原始组合模式两套写法。`));let L=r(`h3`,d);i(d,L),i(L,o(`MockupBrowser`));let R=e(`rue:component:anchor`);i(d,R),h(()=>{let e=m(j,{rows:te});l(()=>f(e,d,R))});let z=r(`h3`,d);i(d,z),i(z,o(`MockupBrowser.Toolbar`));let B=e(`rue:component:anchor`);i(d,B),h(()=>{let e=m(j,{rows:ne});l(()=>f(e,d,B))});let V=r(`h3`,d);i(d,V),i(V,o(`MockupBrowser.AddressBar`));let H=e(`rue:component:anchor`);i(d,H),h(()=>{let e=m(j,{rows:re});l(()=>f(e,d,H))});let pe=r(`h3`,d);i(d,pe),i(pe,o(`MockupBrowser.Content`));let me=e(`rue:component:anchor`);i(d,me),h(()=>{let e=m(j,{rows:ie});l(()=>f(e,d,me))});let U=r(`div`,d);i(d,U),n(U,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let W=r(`h3`,U);i(U,W),n(W,`mt-0 mb-3 text-base font-semibold`),i(W,o(`推荐写法对照`));let G=r(`div`,U);i(U,G),n(G,`grid gap-2 text-sm md:grid-cols-2`);let K=r(`div`,G);i(G,K);let he=r(`code`,K);i(K,he),i(he,o(`url`)),i(K,o(`适合快速生成地址栏`));let q=r(`div`,G);i(G,q);let ge=r(`code`,q);i(q,ge),i(ge,o(`contentClassName`)),i(q,o(`适合直接包裹内容区`));let J=r(`div`,G);i(G,J);let _e=r(`code`,J);i(J,_e),i(_e,o(`Toolbar + AddressBar + Content`)),i(J,o(`适合需要细粒度控制的页面`));let Y=r(`div`,G);i(G,Y),i(Y,o(`旧的手写`));let ve=r(`code`,Y);i(Y,ve),i(ve,o(`Toolbar`)),i(Y,o(`结构仍然完全可用`));let ye=r(`h2`,d);i(d,ye),i(ye,o(`FAQ`));let be=r(`h3`,d);i(d,be),i(be,o(`什么时候用快捷 props，什么时候用子组件？`));let X=r(`p`,d);i(d,X),i(X,o(`如果只是想快速放一个带地址栏的浏览器框，优先用`));let xe=r(`code`,X);i(X,xe),i(xe,o(`url`)),i(X,o(`、`));let Se=r(`code`,X);i(X,Se),i(Se,o(`toolbarEnd`)),i(X,o(`、`));let Ce=r(`code`,X);i(X,Ce),i(Ce,o(`contentClassName`)),i(X,o(`这些快捷 props。需要更细的布局控制时，再切到`));let we=g(X);i(X,we),a(we,` `);let Te=r(`code`,X);i(X,Te),i(Te,o(`MockupBrowser.Toolbar`)),i(X,o(`、`));let Ee=r(`code`,X);i(X,Ee),i(Ee,o(`MockupBrowser.AddressBar`)),i(X,o(`和`));let De=g(X);i(X,De),a(De,` `);let Oe=r(`code`,X);i(X,Oe),i(Oe,o(`MockupBrowser.Content`)),i(X,o(`。`));let ke=r(`h3`,d);i(d,ke),i(ke,o(`原来的 demo 写法会失效吗？`));let Z=r(`p`,d);i(d,Z),i(Z,o(`不会。原来的`));let Q=r(`code`,Z);i(Z,Q),i(Q,o(`children + MockupBrowser.Toolbar`)),i(Z,o(`结构仍然保留；当前页面里的 “browser mockup with border” 和 “browser mockup with background color” 就是旧写法的直接保留版。`));let Ae=r(`h3`,d);i(d,Ae),i(Ae,o(`Content 和根节点上的 contentClassName 有什么区别？`));let $=r(`p`,d);i(d,$);let je=r(`code`,$);i($,je),i(je,o(`contentClassName`));let Me=g($);i($,Me),a(Me,` `),i($,o(`适合推荐写法，直接让根组件帮你包一层内容区；如果你还需要分别控制`));let Ne=r(`code`,$);i($,Ne),i(Ne,o(`padding`)),i($,o(`、`));let Pe=r(`code`,$);i($,Pe),i(Pe,o(`background`)),i($,o(`或自己拆更多节点，就更适合直接使用`));let Fe=g($);i($,Fe),a(Fe,` `);let Ie=r(`code`,$);return i($,Ie),i(Ie,o(`MockupBrowser.Content`)),i($,o(`。`)),c})}),p,_),p})};export{M as default};