...
</div>`});t(()=>f(e,l,fe))});let W=e(`div`,l);a(l,W),s(W,`not-prose my-12 space-y-8`);let G=e(`section`,W);a(W,G),s(G,`space-y-2`);let K=e(`h2`,G);a(G,K),s(K,`text-2xl font-semibold`),a(K,c(`API`));let q=e(`p`,G);a(G,q),s(q,`text-sm opacity-70`),a(q,c(`推荐把外层背景和高度交给 Hero Root，把布局交给 Hero.Content，把标题、描述和 CTA 交给语义子组件。这样页面里仍然可以继续用 className 微调，但不会反复重写同一套结构。`));let J=e(`section`,W);a(W,J),s(J,`space-y-3`);let Y=e(`h3`,J);a(J,Y),s(Y,`text-xl font-semibold`),a(Y,c(`Hero`));let pe=o(`rue:component:anchor`);a(J,pe),i(()=>{let e=p(H,{rows:ne});t(()=>f(e,J,pe))});let X=e(`section`,W);a(W,X),s(X,`space-y-3`);let Z=e(`h3`,X);a(X,Z),s(Z,`text-xl font-semibold`),a(Z,c(`Hero.Content`));let me=o(`rue:component:anchor`);a(X,me),i(()=>{let e=p(H,{rows:re});t(()=>f(e,X,me))});let Q=e(`section`,W);a(W,Q),s(Q,`space-y-3`);let $=e(`h3`,Q);a(Q,$),s($,`text-xl font-semibold`),a($,c(`Hero parts`));let he=o(`rue:component:anchor`);return a(Q,he),i(()=>{let e=p(H,{rows:ie});t(()=>f(e,Q,he))}),r})}),d,m),d})};export{U as default};