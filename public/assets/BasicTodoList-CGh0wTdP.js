import{F as e,I as t,K as n,L as r,M as i,N as a,Q as o,R as s,W as c,Z as l,d as u,dt as d,gt as f,ht as p,l as m,ot as h,rt as g,vt as _,z as v}from"./vapor-runtime-BuwLbCGk.js";import{a as y,n as b}from"./vapor-helpers-vapor-Bly5xJie.js";import{t as x}from"./createHomeSplitExamplePage-2wtBgDCk.js";var S=()=>y(`reactive:1:0`,()=>h({todos:[{id:1,text:`学习响应式框架`,completed:!1},{id:2,text:`编写示例代码`,completed:!0},{id:3,text:`测试功能`,completed:!1}],newTodo:``})),C=x({title:`基础待办事项`,source:`import { type FC, computed, reactive, useState } from '@rue-js/rue'
...
`,Demo:()=>{let{state:h,todoViews:x,completedCount:C,addTodo:w,toggleTodo:T,deleteTodo:E}=y(`useSetup:0:0`,()=>p(()=>{let[e]=y(`useState:1:1`,()=>f(S)),[t]=y(`useState:1:3`,()=>f(()=>y(`computed:1:2`,()=>g(()=>{let t=[];for(let n=0;n<e.todos.length;n+=1){let r=e.todos[n];r!=null&&t.push(r)}return t})))),[n]=y(`useState:1:5`,()=>f(()=>y(`computed:1:4`,()=>g(()=>t.get().filter(e=>e.completed).length))));return{state:e,todoViews:t,completedCount:n,addTodo:()=>{e.newTodo.trim()&&(e.todos.push({id:Date.now(),text:e.newTodo,completed:!1}),e.newTodo=``)},toggleTodo:t=>{let n=e.todos.findIndex(e=>e.id===t);n!==-1&&(e.todos[n].completed=!e.todos[n].completed)},deleteTodo:t=>{let n=e.todos.findIndex(e=>e.id===t);n!==-1&&e.todos.splice(n,1)}}}));return u(f=>{let p=r(`div`,f);n(p,`card bg-base-100 shadow`);let g=r(`div`,p);a(p,g),n(g,`card-body`);let y=r(`h2`,g);a(g,y),n(y,`text-2xl font-semibold mb-3`),a(y,s(`基础待办事项`));let S=r(`div`,g);a(g,S),n(S,`flex items-center gap-2 mb-3`);let D=r(`input`,S);a(S,D),c(D,`type`,`text`),c(D,`placeholder`,`输入待办事项`),_(()=>{l(D,h.newTodo)}),i(D,`input`,e=>{h.newTodo=e.target.value}),i(D,`keypress`,e=>{e.key===`Enter`&&w()}),n(D,`flex-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-400 focus:ring focus:ring-blue-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 px-3 py-2`);let O=r(`button`,S);a(S,O),n(O,`rounded-lg border border-green-500 bg-green-500 px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all hover:border-green-700 hover:bg-green-700 focus:ring focus:ring-green-200`),i(O,`click`,w),a(O,s(`添加`));let k=r(`div`,g);a(g,k);let A=e(`rue:list:start`),j=e(`rue:list:end`);a(k,A),a(k,j);let M=new Map;_(()=>{M=b({items:x.get()||[],getKey:(e,t)=>e.id,elements:M,parent:k,before:j,singleRoot:!0,trackIndex:!1,start:A,renderItem:(o,l,f,p,h)=>{m(u(()=>{let l=t(),u=r(`div`,l);a(l,u),_(()=>{c(u,`key`,String(o.id))}),_(()=>{n(u,String(`flex items-center justify-between rounded-lg border p-3 mb-2 ${o.completed?`bg-gray-50`:`bg-white`}`))});let f=r(`span`,u);a(u,f),i(f,`click`,()=>T(o.id)),_(()=>{n(f,String(`cursor-pointer ${o.completed?`line-through text-gray-500`:`text-gray-800`}`))});let p=e(`rue:slot:anchor`);a(f,p),_(()=>{let e=o.text;d(()=>m(e,f,p))});let h=r(`button`,u);return a(u,h),n(h,`rounded-lg border border-red-500 bg-red-500 px-3 py-1.5 text-sm font-medium text-white shadow-sm transition-all hover:border-red-700 hover:bg-red-700 focus:ring focus:ring-red-200`),i(h,`click`,()=>E(o.id)),a(h,s(`删除`)),l}),l,f)}})});let N=r(`p`,g);a(g,N);let P=v(N);return a(N,P),_(()=>{o(P,`总计: ${h.todos.length} | 已完成: ${C.get()}`)}),p})}});export{C as default};