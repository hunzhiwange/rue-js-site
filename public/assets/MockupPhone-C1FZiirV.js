...
/>`});h(()=>u(e,s,se))});let ce=g(`rue:component:anchor`);e(s,ce),t(()=>{let e=m(N,{title:`iPhone mockup`,summary:`展示 compound 写法，适合你想显式控制摄像头和显示区结构的时候。`,tab:v,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:x(`div`,{className:`card-body items-start`,children:S(j,{"data-testid":`mockup-phone-basic`,children:[x(j.Camera,{}),x(j.Display,{className:`text-white bg-neutral-900 grid place-content-center`,children:`It's Glowtime.`})]})})}),code:`<MockupPhone>
  <MockupPhone.Camera />
  <MockupPhone.Display className="text-white bg-neutral-900 grid place-content-center">
    It's Glowtime.
  </MockupPhone.Display>
</MockupPhone>`});h(()=>u(e,s,ce))});let le=g(`rue:component:anchor`);e(s,le),t(()=>{let e=m(N,{title:`With color and wallpaper`,summary:`基础壁纸示例 展示，同时说明 className 仍然是最高自由度的扩展入口。`,tab:b,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:x(`div`,{className:`card-body items-start`,children:S(j,{className:`border-[#ff8938]`,"data-testid":`mockup-phone-wallpaper`,children:[x(j.Camera,{}),x(j.Display,{children:x(`img`,{alt:`wallpaper`,src:M})})]})})}),code:`<MockupPhone className="border-[#ff8938]">
  <MockupPhone.Camera />
  <MockupPhone.Display>
    <img alt="wallpaper" src={wallpaperUrl} />
  </MockupPhone.Display>
</MockupPhone>`});h(()=>u(e,s,le))});let ue=g(`rue:component:anchor`);e(s,ue),t(()=>{let e=m(N,{title:`尺寸与边框色`,summary:`size 控制机身宽度，color 负责常用边框主题色；如果需要更细粒度样式，继续追加 className 即可。`,tab:C,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:x(`div`,{className:`card-body grid gap-6 lg:grid-cols-4`,children:re.map(e=>S(`div`,{className:`space-y-3 text-center`,children:[x(`div`,{className:`text-xs font-medium uppercase tracking-[0.25em] opacity-60`,children:e.label}),x(`div`,{className:`flex justify-center`,children:x(j,{size:e.size,color:e.color,display:{className:`grid place-content-center bg-base-200 text-base-content text-center px-4`,children:S(`div`,{children:[x(`div`,{className:`text-xs opacity-60`,children:e.size}),x(`div`,{className:`mt-2 text-sm font-semibold`,children:`Rue 示例`})]})}})})]},e.label))})}),code:`const phones = [
  { label: 'XS', size: 'xs' },
...
{phones.map(item => (
  ...
  />
))}`});h(()=>u(e,s,ue))});let de=g(`rue:component:anchor`);e(s,de),t(()=>{let e=m(N,{title:`屏幕内容布局`,summary:`display.contentClassName 适合把文案、状态块和浮层叠加到壁纸或纯色背景之上。`,tab:w,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:S(`div`,{className:`card-body flex flex-wrap justify-center gap-8 lg:flex-nowrap lg:items-start`,children:[x(j,{size:`sm`,color:`accent`,display:{className:`relative overflow-hidden bg-gradient-to-br from-violet-500 via-fuchsia-500 to-orange-400`,children:S(c,{children:[S(`div`,{className:`flex items-center justify-between`,children:[x(F,{label:`Recording`,tone:`bg-error/85 text-white`}),x(F,{label:`14m left`})]}),S(`div`,{children:[x(`div`,{className:`text-sm text-white/75`,children:`Weekly launch`}),x(`div`,{className:`mt-2 text-3xl font-semibold`,children:`84%`}),x(`div`,{className:`mt-2 h-2 rounded-full bg-white/15`,children:x(`div`,{className:`h-full w-[84%] rounded-full bg-white`})})]})]}),contentClassName:`flex h-full flex-col justify-between p-5 text-white`}}),x(j,{size:`sm`,color:`success`,display:{className:`bg-base-100 p-4`,children:S(`div`,{className:`space-y-3`,children:[S(`div`,{className:`rounded-2xl bg-success/10 p-3 text-success`,children:[x(`div`,{className:`text-xs uppercase tracking-[0.2em]`,children:`Focus`}),x(`div`,{className:`mt-1 text-lg font-semibold`,children:`2h 18m`})]}),S(`div`,{className:`rounded-2xl bg-base-200 p-3`,children:[x(`div`,{className:`text-sm font-medium`,children:`Notes`}),x(`div`,{className:`mt-1 text-xs opacity-70`,children:`保持 compound，同时用 display 简写快速搭状态屏。`})]}),S(`div`,{className:`rounded-2xl bg-base-200 p-3`,children:[x(`div`,{className:`text-sm font-medium`,children:`Next`}),x(`div`,{className:`mt-1 text-xs opacity-70`,children:`Ship Mockup Phone API`})]})]})}})]})}),code:`<MockupPhone
  size="sm"
  color="accent"
  display={{
...
/>`});h(()=>u(e,s,de))});let fe=g(`rue:component:anchor`);e(s,fe),t(()=>{let e=m(N,{title:`摄像头控制`,summary:`camera 默认开启；当画面更偏卡片展示时可以关闭，或者通过对象写法补充类名和属性。`,tab:ee,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:S(`div`,{className:`card-body flex flex-wrap justify-center gap-8 lg:flex-nowrap lg:items-start`,children:[x(j,{size:`sm`,camera:!1,display:{className:`grid place-content-center bg-base-200 text-base-content text-center px-6`,children:S(`div`,{children:[S(`div`,{className:`text-sm font-semibold`,children:[`camera=`,!1]}),x(`div`,{className:`mt-2 text-xs opacity-60`,children:`适合更像产品卡片的展示。`})]})}}),x(j,{size:`sm`,color:`primary`,camera:{className:`bg-primary/20 ring-2 ring-primary/40`},display:{className:`bg-neutral-950 text-white p-4`,children:S(`div`,{className:`space-y-3`,children:[x(`div`,{className:`text-sm font-medium`,children:`Custom camera`}),x(`div`,{className:`rounded-2xl bg-white/5 p-3 text-xs text-white/75`,children:`用对象写法继续给摄像头节点补 className 或测试属性。`})]})}})]})}),code:`<MockupPhone
  size="sm"
  camera={false}
  display={{
...
/>`});h(()=>u(e,s,fe))});let pe=g(`rue:component:anchor`);e(s,pe),t(()=>{let e=m(N,{title:`场景组合`,summary:`当手机只是内容容器时，可以把它当成页面模块来组合；推荐把复杂 UI 放进 display.children。`,tab:E,preview:()=>x(`div`,{className:`card bg-base-100 shadow-sm`,children:S(`div`,{className:`card-body grid gap-8 xl:grid-cols-2`,children:[x(`div`,{className:`flex justify-center`,children:x(j,{size:`sm`,color:`secondary`,display:{className:`relative overflow-hidden bg-neutral-950`,src:M,children:S(`div`,{className:`grid gap-3`,children:[S(`div`,{className:`rounded-2xl bg-black/35 p-3 ring-1 ring-white/10 backdrop-blur`,children:[x(`div`,{className:`text-xs uppercase tracking-[0.2em] text-white/60`,children:`Now Playing`}),x(`div`,{className:`mt-2 text-lg font-semibold`,children:`Midnight Route`}),x(`div`,{className:`text-sm text-white/70`,children:`Rue FM`})]}),S(`div`,{className:`rounded-2xl bg-black/35 p-3 ring-1 ring-white/10 backdrop-blur`,children:[x(`div`,{className:`text-sm font-medium`,children:`Next up`}),x(`div`,{className:`mt-1 text-xs text-white/70`,children:`3 new product updates`})]})]}),contentClassName:`absolute inset-0 flex flex-col justify-end p-4 text-white`}})}),x(`div`,{className:`flex justify-center`,children:x(j,{size:`sm`,color:`accent`,display:{className:`bg-slate-950 px-4 py-5`,children:S(`div`,{className:`flex h-full flex-col justify-between`,children:[S(`div`,{children:[x(`div`,{className:`text-sm font-medium text-white`,children:`Home`}),x(`div`,{className:`mt-1 text-xs text-white/55`,children:`6 apps pinned`})]}),S(`div`,{className:`grid grid-cols-3 gap-3`,children:[x(I,{label:`Mail`,className:`bg-sky-500 text-white`}),x(I,{label:`AI`,className:`bg-fuchsia-500 text-white`}),x(I,{label:`Cam`,className:`bg-emerald-500 text-white`}),x(I,{label:`Map`,className:`bg-amber-400 text-slate-950`}),x(I,{label:`Docs`,className:`bg-white text-slate-950`}),x(I,{label:`Pay`,className:`bg-rose-500 text-white`})]}),x(`div`,{className:`rounded-full bg-white/10 p-2 text-center text-xs text-white/70`,children:`Swipe up for more`})]})}})})]})}),code:`<MockupPhone
  size="sm"
  color="secondary"
  display={{
    className: 'relative overflow-hidden bg-neutral-950',
