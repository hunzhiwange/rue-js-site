...
]`})));return l(t=>{let n=r(),g=s(`rue:component:anchor`);return a(n,g),d(p(x,{children:l(()=>{let t=r(),n=e(`div`,t);a(t,n),c(n,`max-w-none prose prose-sm md:prose-base`);let g=e(`h1`,n);a(n,g),a(g,u(`Accordion 手风琴`));let x=e(`p`,n);a(n,x),c(x,`text-sm mt-3 mb-3`),a(x,u(`Accordion 现在保留 Rue 原本的轻量视觉风格，但 API 不再只是静态包装。你可以继续用`));let N=e(`code`,x);a(x,N),a(N,u(`Accordion.Title`)),a(x,u(`和`));let P=e(`code`,x);a(x,P),a(P,u(`Accordion.Content`)),a(x,u(`组合单个面板，也可以直接用`));let F=e(`code`,x);a(x,F),a(F,u(`items`)),a(x,u(`走数据驱动，接入受控 key、多开、禁用和富标题信息。`));let I=e(`h2`,n);a(n,I),a(I,u(`何时使用`));let L=e(`ul`,n);a(n,L);let K=e(`li`,L);a(L,K),a(K,u(`需要 FAQ、设置说明、任务面板这类“标题 + 可折叠内容”的信息组织方式。`));let q=e(`li`,L);a(L,q),a(q,u(`需要在单开和多开之间切换，或把当前展开项接到页面状态里。`));let J=e(`li`,L);a(L,J),a(J,u(`需要在标题里补充状态、说明、标签，而不想为每个面板手写结构。`));let Y=e(`li`,L);a(L,Y),a(Y,u(`需要让浏览器能搜索折叠内容时，使用`));let X=e(`code`,Y);a(Y,X),a(X,u(`use="details"`)),a(Y,u(`。`));let Z=e(`div`,n);a(n,Z),c(Z,`not-prose my-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4`);let ee=s(`rue:list:start`),te=s(`rue:list:end`);a(Z,ee),a(Z,te);let ne=new Map;o(()=>{ne=_({items:H||[],getKey:(e,t)=>e.title,elements:ne,parent:Z,before:te,singleRoot:!0,trackIndex:!1,start:ee,renderItem:(t,n,p,m,h)=>{d(l(()=>{let n=r(),l=e(`div`,n);a(n,l),o(()=>{f(l,`key`,String(t.title))}),c(l,`card border border-base-300 bg-base-100 shadow-sm`);let p=e(`div`,l);a(l,p),c(p,`card-body gap-2 p-4`);let m=e(`div`,p);a(p,m),c(m,`text-xs uppercase tracking-[0.2em] text-base-content/50`),a(m,u(`Capability`));let h=e(`div`,p);a(p,h),c(h,`text-sm font-semibold`);let g=s(`rue:slot:anchor`);a(h,g),o(()=>{let e=t.title;i(()=>d(e,h,g))});let _=e(`p`,p);a(p,_),c(_,`m-0 text-sm opacity-70`);let v=s(`rue:slot:anchor`);return a(_,v),o(()=>{let e=t.desc;i(()=>d(e,_,v))}),n}),n,p)}})});let re=s(`rue:component:anchor`);a(n,re),o(()=>{let e=p(z,{title:`Accordion using radio inputs`,summary:`保留单开分组，同时额外开启 collapsible，方便在文档页里反复点按查看开合状态。`,tab:m,preview:()=>G(`accordion-radio-demo`,{collapsible:!0}),code:`<Accordion className="bg-base-100 border border-base-300" name="accordion-radio-demo" defaultOpen collapsible>
...
</Accordion>`});i(()=>d(e,n,re))});let ie=s(`rue:component:anchor`);a(n,ie),o(()=>{let e=p(z,{title:`Accordion using details`,summary:`保留 details 结构，适合需要原生语义和浏览器搜索能力的内容区。`,tab:h,preview:()=>G(`accordion-details-demo`,{use:`details`}),code:`<Accordion use="details" className="bg-base-100 border border-base-300" name="accordion-details-demo" defaultOpen>
...
</Accordion>`});i(()=>d(e,n,ce))});let le=s(`rue:component:anchor`);a(n,le),o(()=>{let e=p(z,{title:`Accordion with plus/minus icon`,summary:`保留 plus/minus 方案，并开启 collapsible，方便直接验证开合反馈。`,tab:T,preview:()=>G(`accordion-plus-demo`,{icon:`plus`,collapsible:!0}),code:`<Accordion icon="plus" className="bg-base-100 border border-base-300" name="accordion-plus-demo" defaultOpen collapsible>
  <Accordion.Title className="font-semibold">How do I create an account?</Accordion.Title>
  <Accordion.Content className="text-sm opacity-80">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Accordion.Content>
...
</div>`});i(()=>d(e,n,ue))});let de=s(`rue:component:anchor`);a(n,de),o(()=>{let e=p(z,{title:`Accordion using items array (radio)`,summary:`保留 items 数组写法，并开启 collapsible，方便直接验证数据驱动下的收起逻辑。`,tab:D,preview:()=>y(R,{collapsible:!0,className:`bg-base-100 border border-base-300`,name:`accordion-array-radio-demo`,items:V.map((e,t)=>({key:e.key,title:e.title,content:e.content,open:t===0}))}),code:`${M}
...
<Accordion
  ...
  items={items}
/>`});i(()=>d(e,n,fe))});let Q=e(`h2`,n);a(n,Q),f(Q,`id`,`accordion-api`),a(Q,u(`API`));let pe=e(`p`,n);a(n,pe),a(pe,u(`Accordion 现在分成两套用法：children 模式适合局部排版，items 模式适合数据驱动和受控状态。 两套模式共用同一套视觉类名，因此迁移旧示例时通常只需要把结构收敛到更清晰的语义层。`));let me=e(`h3`,n);a(n,me),a(me,u(`Accordion Props`));let he=s(`rue:component:anchor`);a(n,he),o(()=>{let e=p(B,{rows:U});i(()=>d(e,n,he))});let $=e(`h3`,n);a(n,$),c($,`mt-6`),a($,u(`AccordionDataItem`));let ge=s(`rue:component:anchor`);return a(n,ge),o(()=>{let e=p(B,{rows:W});i(()=>d(e,n,ge))}),t})}),n,g),n})};export{K as default};