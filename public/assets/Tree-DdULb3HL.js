...
</div>`,et=[{prop:`treeData`,description:`树数据源，支持嵌套 children 和字段映射。`,type:`TreeDataNode[]`,defaultValue:`[]`},{prop:`selectedKeys / defaultSelectedKeys`,description:`受控与非受控的当前选中项，multiple 打开后允许多选。`,type:`TreeKey[]`,defaultValue:`[]`},{prop:`checkedKeys / defaultCheckedKeys`,description:`勾选模式下的选中集合，strict 模式会回传 checked / halfChecked 结构。`,type:`TreeKey[] | { checked: TreeKey[]; halfChecked: TreeKey[] }`,defaultValue:`[]`},{prop:`expandedKeys / defaultExpandedKeys / defaultExpandAll`,description:`控制展开态，适合目录树、权限树和异步加载场景。`,type:`TreeKey[] / boolean`,defaultValue:`[] / false`},{prop:`checkable / checkStrictly`,description:`切换勾选与父子联动模式；strict 会关闭级联。`,type:`boolean`,defaultValue:`false`},{prop:`treeDataSimpleMode / fieldNames`,description:`直接接入 id / pId 扁平数据，同时可映射 title、key、children 字段。`,type:`boolean | TreeSimpleModeConfig / TreeFieldNames`,defaultValue:`- / -`},{prop:`allowSearch / searchValue / filterTreeNode`,description:`提供内置搜索输入和过滤逻辑，命中后会保留祖先链路。`,type:`boolean / string / boolean | ((inputValue, node) => boolean)`,defaultValue:`false / - / true`},{prop:`loadData`,description:`展开未加载分支时触发异步加载，适合远端目录与超大树。`,type:`(node: TreeNode) => Promise<any> | void`,defaultValue:`-`},{prop:`rangeSelect / Tree.DirectoryTree / expandAction / toggleSelect`,description:`Tree 多选和目录树都支持 shift 区间选择；目录树额外提供展开动作和 ctrl/meta 追加选择开关。`,type:`false | "append" | "replace" / DirectoryTreeProps / false | "click" | "doubleClick" / boolean`,defaultValue:`"append" / blockNode=true / showIcon=true / "click" / true`},{prop:`draggable / allowDrop / onDrop`,description:`开启拖拽排序并控制是否允许落点；allowDrop 和 onDrop 都会拿到 dropToGap，UI 会同步显示插前、插后或放入占位态。`,type:`TreeDraggable / (info) => boolean / (info) => void`,defaultValue:`false / - / -`},{prop:`height / itemHeight / virtual`,description:`为长列表开启虚拟滚动；height 定义视口高度，itemHeight 用于估算渲染窗口，也能和 loadData 组合接超长懒加载树。`,type:`number / number / boolean`,defaultValue:`- / 自动按尺寸估算 / true`},{prop:`showLine / showIcon / blockNode`,description:`控制树线、节点图标和整行可点的布局表现。`,type:`boolean`,defaultValue:`false`},{prop:`titleRender / switcherIcon / icon`,description:`按节点态自定义标题、展开图标和节点图标。`,type:`render function | any`,defaultValue:`-`}],tt=e=>Array.isArray(e)?e:e.checked,nt=(e,t)=>Array.isArray(e)?t?.halfCheckedKeys??[]:e.halfChecked,rt=e=>`${typeof e}:${String(e)}`,Y=e=>e.map(e=>({...e,children:Array.isArray(e.children)?Y(e.children):e.children})),it=(e,t)=>{let n=rt(t);for(let r=0;r<e.length;r+=1){let i=e[r];if(rt(i.key)===n){let[t]=e.splice(r,1);return t??null}if(Array.isArray(i.children)){let e=it(i.children,t);if(e)return e}}return null},at=(e,t,n,r)=>{let i=rt(n);for(let a=0;a<e.length;a+=1){let o=e[a];if(rt(o.key)===i){if(r===0){let e=Array.isArray(o.children)?[...o.children]:[];e.push(t),o.children=e}else e.splice(r<0?a:a+1,0,t);return!0}if(Array.isArray(o.children)&&at(o.children,t,n,r))return!0}return!1},ot=(e,t)=>{let n=Y(e),r=it(n,t.dragNode.key);return r&&(at(n,r,t.node.key,t.dropPosition)||n.push(r)),n},st=(e,t,n)=>{let r=rt(t);for(let i=0;i<e.length;i+=1){let a=e[i];if(rt(a.key)===r){let t=n(a);if(t===a)return e;let r=e.slice();return r[i]=t,r}if(Array.isArray(a.children)&&a.children.length){let r=st(a.children,t,n);if(r===a.children)continue;let o=e.slice();return o[i]={...a,children:r},o}}return e},ct=e=>e.reduce((e,t)=>!Array.isArray(t.children)||!t.children.length?e:e+1+ct(t.children),0),lt=t=>{let{isOpen:n,isFolder:r,toggle:o,addChild:s,changeType:c}=O(`useSetup:0:0`,()=>C(()=>{let e=O(`computed:1:0`,()=>_(()=>!!t.model.open)),n=O(`computed:1:1`,()=>_(()=>!!t.model.children&&t.model.children.length>0)),r=n=>{n?.stopPropagation(),t.model.open=!e.get()},i=e=>{e?.stopPropagation(),t.model.children||(t.model.children=[]),t.model.children.push({id:`${t.model.id}-new-${t.model.children.length}`,name:`new stuff`}),t.model.open=!0};return{isOpen:e,isFolder:n,toggle:r,addChild:i,changeType:e=>{e?.stopPropagation(),n.get()||(t.model.children=[],i(),t.model.open=!0)}}}));return y(f=>{let _=l(`li`,f);T(_,`list-none`);let v=l(`button`,_);a(_,v),m(v,`type`,`button`),d(()=>{T(v,`flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm transition `+(r.get()?`font-semibold text-base-content`:`text-base-content/80 hover:bg-base-200/70`))}),S(v,`click`,e=>o(e)),S(v,`dblclick`,e=>c(e));let b=l(`span`,v);a(v,b),T(b,`inline-flex size-5 items-center justify-center rounded-md bg-base-200/80 text-[11px] text-base-content/55`);let C=g(b);a(b,C),d(()=>{x(C,r.get()?n.get()?`−`:`+`:`•`)});let D=l(`span`,v);a(v,D);let O=u(`rue:slot:anchor`);a(D,O),d(()=>{let e=t.model.name;i(()=>w(e,D,O))});let A=u(`rue:slot:anchor`);return a(_,A),d(()=>{let o=r.get()&&n.get()?y(()=>{let n=p(),r=l(`ul`,n);a(n,r),T(r,`mt-1 grid gap-1 pl-5`);let i=u(`rue:list:start`),o=u(`rue:list:end`);a(r,i),a(r,o);let c=new Map;d(()=>{c=k({items:t.model.children||[],getKey:(e,t)=>e.id,elements:c,parent:r,before:o,start:i,renderItem:(e,t,n,r,i)=>{h(E(lt,{key:e.id,model:e}),t,n,r)}})});let f=l(`li`,r);a(r,f),T(f,`list-none`);let g=l(`button`,f);return a(f,g),m(g,`type`,`button`),T(g,`btn btn-ghost btn-xs rounded-full text-emerald-600`),S(g,`click`,e=>s(e)),a(g,e(`+ add child`)),n}):``;i(()=>w(o,_,A))}),_})},ut=()=>{let{basicSelectedKeys:t,directorySelectedKeys:n,directoryExpandAction:r,directoryToggleSelect:o,directoryRangeSelect:c,directoryRangeAppendSelectedKeys:f,directoryRangeReplaceSelectedKeys:m,directoryRangeTreeVersion:h,checkableSelectedKeys:g,checkedKeys:v,halfCheckedKeys:b,disabledCheckedKeys:x,simpleSelectedKeys:S,asyncSelectedKeys:k,asyncExpandedKeys:te,dragTreeData:ne,dragSummary:re,virtualSelectedKeys:N,asyncVirtualTreeData:P,asyncVirtualExpandedKeys:F,asyncVirtualSelectedKeys:ie,asyncVirtualLoadedBranchCount:I,asyncTreeData:ae,legacyTree:oe,tabs:L,loadAsyncTree:se,loadAsyncVirtualTree:R,resetDirectoryRangeDemo:ce}=O(`useSetup:0:0:dup1`,()=>C(()=>{let e=O(`ref:1:2`,()=>s([`docs-api`])),t=O(`ref:1:3`,()=>s([`dir-app`])),n=O(`ref:1:4`,()=>s(`click`)),r=O(`ref:1:5`,()=>s(!0)),i=O(`computed:1:6`,()=>_(()=>r.value?`append`:!1)),a=O(`ref:1:7`,()=>s([])),o=O(`ref:1:8`,()=>s([])),c=O(`ref:1:9`,()=>s(0)),l=O(`ref:1:10`,()=>s([`release-control`])),u=O(`ref:1:11`,()=>s([`site-home`])),d=O(`ref:1:12`,()=>s([`release-control`,`release-site`])),f=O(`ref:1:13`,()=>s([`editable-assets`])),p=O(`ref:1:14`,()=>s([`workflow`])),m=O(`ref:1:15`,()=>s([])),h=O(`ref:1:16`,()=>s([])),g=O(`ref:1:17`,()=>s(Y(Ve))),v=O(`ref:1:18`,()=>s(`folder 支持放入；file 只允许插前和插后，悬停时会显示明确占位态。`)),y=O(`ref:1:19`,()=>s([`virtual-3`])),b=O(`ref:1:20`,()=>s(Y(Ue))),x=O(`ref:1:21`,()=>s([])),S=O(`ref:1:22`,()=>s([])),C=O(`computed:1:23`,()=>_(()=>ct(b.value))),w=O(`ref:1:24`,()=>s([{title:`发布总线`,key:`release-bus`,isLeaf:!1}]));return{basicSelectedKeys:e,directorySelectedKeys:t,directoryExpandAction:n,directoryToggleSelect:r,directoryRangeSelect:i,directoryRangeAppendSelectedKeys:a,directoryRangeReplaceSelectedKeys:o,directoryRangeTreeVersion:c,checkableSelectedKeys:l,checkedKeys:u,halfCheckedKeys:d,disabledCheckedKeys:f,simpleSelectedKeys:p,asyncSelectedKeys:m,asyncExpandedKeys:h,dragTreeData:g,dragSummary:v,virtualSelectedKeys:y,asyncVirtualTreeData:b,asyncVirtualExpandedKeys:x,asyncVirtualSelectedKeys:S,asyncVirtualLoadedBranchCount:C,asyncTreeData:w,legacyTree:O(`reactive:1:25`,()=>D({id:`root`,name:`My Tree`,open:!0,children:[{id:`hello`,name:`hello`},{id:`world`,name:`world`},{id:`branch`,name:`child folder`,open:!0,children:[{id:`branch-1`,name:`design review`},{id:`branch-2`,name:`release note`}]}]})),tabs:{basic:O(`ref:1:26`,()=>s(`preview`)),directory:O(`ref:1:27`,()=>s(`preview`)),directoryRange:O(`ref:1:28`,()=>s(`preview`)),checkable:O(`ref:1:29`,()=>s(`preview`)),checkableDisabled:O(`ref:1:30`,()=>s(`preview`)),simple:O(`ref:1:31`,()=>s(`preview`)),async:O(`ref:1:32`,()=>s(`preview`)),drag:O(`ref:1:33`,()=>s(`preview`)),virtual:O(`ref:1:34`,()=>s(`preview`)),virtualAsync:O(`ref:1:35`,()=>s(`preview`)),legacy:O(`ref:1:36`,()=>s(`preview`))},loadAsyncTree:async e=>{e.key===`release-bus`&&(w.value=[{title:`发布总线`,key:`release-bus`,isLeaf:!1,children:[{title:`桌面端`,key:`desktop`,children:[{title:`Windows`,key:`desktop-win`},{title:`macOS`,key:`desktop-mac`}]},{title:`移动端`,key:`mobile`,children:[{title:`iOS`,key:`mobile-ios`},{title:`Android`,key:`mobile-android`}]}]}])},loadAsyncVirtualTree:async e=>{e.children.length||(b.value=st(b.value,e.key,e=>({...e,children:Array.from({length:8},(t,n)=>({title:`${String(e.title)} / Module ${n+1}`,key:`${String(e.key)}-child-${n}`,isLeaf:n%3!=0}))})))},resetDirectoryRangeDemo:()=>{a.value=[],o.value=[],c.value+=1}}}));return y(s=>{let _=p(),C=u(`rue:component:anchor`);return a(_,C),w(E(ee,{children:y(()=>{let s=p(),_=l(`div`,s);a(s,_),T(_,`max-w-none prose prose-sm md:prose-base`);let y=l(`h1`,_);a(_,y),a(y,e(`Tree 树控件`));let C=l(`p`,_);a(_,C),a(C,e(`Rue 的 Tree 补上了独立树组件这块空白：保留 TreeView 示例里递归数据直改的灵活性，同时把 树控件常用的展开、选中、勾选、简单模式、异步加载和自定义标题一次补齐。 视觉上继续沿用 Rue 现有的卡片、badge 和 base 色阶体系，不照搬其他组件库的外观。`));let D=l(`div`,_);a(_,D),T(D,`not-prose mt-6 grid gap-3 md:grid-cols-3`);let O=l(`div`,D);a(D,O),T(O,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let ee=l(`div`,O);a(O,ee),T(ee,`text-xs uppercase tracking-[0.2em] text-base-content/45`),a(ee,e(`Node Model`));let z=l(`div`,O);a(O,z),T(z,`mt-2 text-base font-semibold`),a(z,e(`选择、勾选、展开三条状态线`));let B=l(`p`,O);a(O,B),T(B,`mt-2 mb-0 text-sm text-base-content/68`),a(B,e(`目录树、权限树、发布树都能直接套进来。`));let V=l(`div`,D);a(D,V),T(V,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let H=l(`div`,V);a(V,H),T(H,`text-xs uppercase tracking-[0.2em] text-base-content/45`),a(H,e(`DirectoryTree`));let le=l(`div`,V);a(V,le),T(le,`mt-2 text-base font-semibold`),a(le,e(`目录树快捷 API`));let ue=l(`p`,V);a(V,ue),T(ue,`mt-2 mb-0 text-sm text-base-content/68`),a(ue,e(`支持 click / doubleClick 展开，以及更接近文件浏览器的多选交互。`));let U=l(`div`,D);a(D,U),T(U,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let de=l(`div`,U);a(U,de),T(de,`text-xs uppercase tracking-[0.2em] text-base-content/45`),a(de,e(`Heavy Interaction`));let fe=l(`div`,U);a(U,fe),T(fe,`mt-2 text-base font-semibold`),a(fe,e(`拖拽排序与虚拟滚动`));let W=l(`p`,U);a(U,W),T(W,`mt-2 mb-0 text-sm text-base-content/68`),a(W,e(`长列表和拖拽改序终于能落在同一个 Tree 上了。`));let pe=u(`rue:component:anchor`);a(_,pe),d(()=>{let e=E(M,{title:`基础选中与整行交互`,summary:`默认 Tree 就是一个纯浏览 + 选中容器；blockNode 和 showIcon 让它更像配置面板里的主导航。`,tab:L.basic,code:J,preview:A(`div`,{className:`space-y-4 not-prose`,children:[j(q,{treeData:Fe,selectedKeys:t.value,defaultExpandAll:!0,showIcon:!0,blockNode:!0,onSelect:e=>{t.value=e}}),A(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:t.value.length?t.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`未选择`})})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`推荐场景`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`组件目录、文档导航、资源分类`})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`状态模型`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`selectedKeys / expandedKeys 分离，便于受控更新。`})]})]})]})});i(()=>w(e,_,pe))});let G=u(`rue:component:anchor`);a(_,G),d(()=>{let e=E(M,{title:`DirectoryTree 目录树快捷 API`,summary:`Tree.DirectoryTree 默认补上目录图标、整行可点和 click 展开；这里先只看 expandAction 和 toggleSelect 这两个基础交互开关。`,tab:L.directory,code:Je,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q.DirectoryTree,{treeData:ze,selectedKeys:n.value,multiple:!0,expandAction:r.value,toggleSelect:o.value,rangeSelect:c.get(),onSelect:e=>{n.value=e}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`快捷属性`}),A(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[j(`button`,{type:`button`,className:r.value===`click`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{r.value=`click`},children:`click 展开`}),j(`button`,{type:`button`,className:r.value===`doubleClick`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{r.value=`doubleClick`},children:`doubleClick 展开`}),j(`button`,{type:`button`,className:r.value===!1?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{r.value=!1},children:`只选中不展开`})]}),A(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:[j(`button`,{type:`button`,className:o.value?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{o.value=!0},children:`ctrl/meta 追加`}),j(`button`,{type:`button`,className:o.value?`btn btn-ghost btn-xs`:`btn btn-primary btn-xs`,onClick:()=>{o.value=!1},children:`关闭追加选择`})]})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:n.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e)))})]}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前组合是 expandAction=`,j(`strong`,{children:String(r.value)}),`、toggleSelect=`,j(`strong`,{children:String(o.value)}),`、rangeSelect=`,j(`strong`,{children:String(c.get())}),`。`,j(`div`,{className:`mt-3`,children:`普通点击会落成单选；打开追加后，meta / ctrl 会追加或移除选中，shift 也会启用区间选择。关闭追加时，这两类补充选择都会停用；append / replace 的差异放到下面的对照示例里单独演示。`})]})]})]})});i(()=>w(e,_,G))});let me=u(`rue:component:anchor`);a(_,me),d(()=>{let e=E(M,{title:`shift append vs shift replace`,summary:`Shift 的基础语义是先选一个节点，再 Shift 选另一个节点，中间连续区间都会选中；append / replace 只决定已有额外选择是否保留。`,tab:L.directoryRange,code:Ye,preview:A(`div`,{className:`space-y-4 not-prose`,children:[A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[j(`div`,{children:`基础行为：先单击 alpha.ts，再按住 Shift 单击 epsilon.ts，alpha.ts 到 epsilon.ts 都会选中。`}),j(`div`,{className:`mt-2`,children:`append / replace 只影响已有额外非连续选择是否保留：重置后先单击 beta.ts，再按住 Cmd / Ctrl 单击 epsilon.ts，最后按住 Shift 单击 delta.ts。`}),j(`div`,{className:`mt-2`,children:`append 会保留 beta.ts；replace 只保留 delta.ts 到 epsilon.ts 这一段。`}),j(`button`,{type:`button`,className:`btn btn-ghost btn-xs mt-3`,onClick:ce,children:`重置两边示例`})]}),A(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[A(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[A(`div`,{className:`flex items-center justify-between gap-3`,children:[A(`div`,{children:[j(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="append"`}),j(`div`,{className:`text-xs text-base-content/55`,children:`保留原先的非连续选择，再并入新的 shift 区间。`})]}),j(`span`,{className:`badge badge-outline badge-sm`,children:`append`})]}),j(q.DirectoryTree,{treeData:Be,selectedKeys:f.value,multiple:!0,toggleSelect:!0,rangeSelect:`append`,onSelect:e=>{f.value=e}},`append-${h.value}`),A(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:f.value.length?f.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]}),A(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[A(`div`,{className:`flex items-center justify-between gap-3`,children:[A(`div`,{children:[j(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="replace"`}),j(`div`,{className:`text-xs text-base-content/55`,children:`只保留新的 shift 区间，旧的非连续选择会被替换掉。`})]}),j(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:`replace`})]}),j(q.DirectoryTree,{treeData:Be,selectedKeys:m.value,multiple:!0,toggleSelect:!0,rangeSelect:`replace`,onSelect:e=>{m.value=e}},`replace-${h.value}`),A(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:m.value.length?m.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]})]})]})});i(()=>w(e,_,me))});let he=u(`rue:component:anchor`);a(_,he),d(()=>{let e=E(M,{title:`父子联动与半选态`,summary:`这一块只看级联勾选和 halfChecked，不再混入 disabled / disableCheckbox，点击父节点时能直接看到整棵子树联动。`,tab:L.checkable,code:We,preview:A(`div`,{className:`space-y-4 not-prose`,children:[j(q,{treeData:Ie,selectedKeys:g.value,checkedKeys:v.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onSelect:e=>{g.value=e},onCheck:(e,t)=>{v.value=tt(e),b.value=nt(e,t)}}),A(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:g.value.length?g.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`当前没有选中节点`})})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`checkedKeys`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:v.value.map(e=>j(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:String(e)},String(e)))})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`halfCheckedKeys`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:b.value.length?b.value.map(e=>j(`span`,{className:`badge badge-ghost badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`当前没有半选`})})]})]})]})});i(()=>w(e,_,he))});let ge=u(`rue:component:anchor`);a(_,ge),d(()=>{let e=E(M,{title:`禁用节点与禁用复选框`,summary:`把 disabled 和 disableCheckbox 单独拆出来看：前者整节点只读，后者只禁用勾选框，不再干扰联动示例。`,tab:L.checkableDisabled,code:Ge,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q,{treeData:Le,checkedKeys:x.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onCheck:e=>{x.value=tt(e)}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前勾选`}),j(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:x.value.length?x.value.map(e=>j(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):j(`span`,{className:`text-sm text-base-content/55`,children:`当前没有勾选`})})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[j(`div`,{className:`font-medium text-base-content`,children:`disabled`}),j(`div`,{className:`mt-2`,children:`整节点不可展开、不可选中、不可勾选，适合只读目录或冻结配置。`})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[j(`div`,{className:`font-medium text-base-content`,children:`disableCheckbox`}),j(`div`,{className:`mt-2`,children:`节点仍能展示和展开，但复选框不会参与交互，适合“只可浏览不可授权”的条目。`})]})]})]})});i(()=>w(e,_,ge))});let _e=u(`rue:component:anchor`);a(_,_e),d(()=>{let e=E(M,{title:`Simple Mode + Search`,summary:`扁平数据直入后，内置搜索会保留命中节点的祖先链，不会把层级上下文切断。`,tab:L.simple,code:Ke,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q,{treeData:Re,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{title:`name`,key:`code`},selectedKeys:S.value,allowSearch:!0,defaultExpandAll:!0,onSelect:e=>{S.value=e}}),A(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前选中：`,j(`code`,{children:JSON.stringify(S.value)}),j(`div`,{className:`mt-3`,children:`这类 simple mode 很适合后端直接给 id / pId 的菜单、流程节点和权限项，不需要再先做一遍树转换。`})]})]})});i(()=>w(e,_,_e))});let ve=u(`rue:component:anchor`);a(_,ve),d(()=>{let e=E(M,{title:`Async Load 与自定义标题`,summary:`第一次展开时再拉子节点，同时用 titleRender 和 icon 把状态信息塞回每一行。`,tab:L.async,code:qe,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,26rem),1fr] lg:items-start`,children:[j(q,{treeData:ae.value,selectedKeys:k.value,expandedKeys:te.value,loadData:se,showLine:!0,showIcon:!0,blockNode:!0,titleRender:({node:e,loading:t})=>A(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[j(`span`,{className:`truncate`,children:e.title}),j(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`branch`:`leaf`})]}),onSelect:e=>{k.value=e},onExpand:e=>{te.value=e}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`expandedKeys`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(te.value)})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(k.value)})]}),j(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`展开 release-bus 后才会注入桌面端和移动端节点，适合远端目录、超大权限树和发布范围配置。`})]})]})});i(()=>w(e,_,ve))});let K=l(`div`,_);a(_,K),T(K,`not-prose mt-10 space-y-2`);let ye=l(`h2`,K);a(K,ye),T(ye,`text-2xl font-semibold`),a(ye,e(`更重交互`));let be=l(`p`,K);a(K,be),T(be,`text-sm text-base-content/70`),a(be,e(`当 Tree 既要承载拖拽整理，又要承载超长数据时，draggable 和 virtual 就是两个最关键的控制面。`));let xe=u(`rue:component:anchor`);a(_,xe),d(()=>{let e=E(M,{title:`allowDrop 策略与拖拽占位`,summary:`allowDrop 可以把 folder / file 的落点规则写清楚；hover 时 Tree 会直接给出插前、插后或放入占位提示。`,tab:L.drag,code:Xe,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q,{treeData:ne.value,draggable:!0,blockNode:!0,defaultExpandAll:!0,allowDrop:({dropNode:e,dropToGap:t})=>t||e.raw.kind!==`file`,titleRender:({node:e})=>A(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[j(`span`,{className:`truncate`,children:e.title}),j(`span`,{className:e.raw.kind===`folder`?`badge badge-ghost badge-xs`:`badge badge-outline badge-xs`,children:e.raw.kind})]}),onDrop:e=>{ne.value=ot(ne.value,e),re.value=`${String(e.dragNode.key)} -> ${String(e.node.key)} (${e.dropToGap?e.dropPosition<0?`before`:`after`:`inside`})`}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`最近一次拖拽`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:re.value})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`allowDrop 规则`}),A(`div`,{className:`mt-2 grid gap-2 text-sm text-base-content/75`,children:[j(`div`,{children:`folder：允许放入，也允许插前 / 插后。`}),j(`div`,{children:`file：只允许插前 / 插后，不允许作为 inside 目标。`})]})]}),j(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`拖到 folder 正中央会看到“放入”，拖到行的上沿或下沿则会出现“插前 / 插后”；如果目标是 file，inside 落点会被 allowDrop 直接拦掉。`})]})]})});i(()=>w(e,_,xe))});let Se=u(`rue:component:anchor`);a(_,Se),d(()=>{let e=E(M,{title:`Virtual Scroll`,summary:`长列表下只渲染可见窗口，height 和 itemHeight 负责限定视口和估算切片范围。`,tab:L.virtual,code:Ze,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q,{treeData:He,selectedKeys:N.value,height:320,itemHeight:42,virtual:!0,blockNode:!0,onSelect:e=>{N.value=e}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`数据量`}),j(`div`,{className:`mt-2 text-2xl font-semibold`,children:He.length})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(N.value)})]}),j(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`对文档页目录、埋点树、批量资源目录这种长列表场景，虚拟滚动能显著降低初始渲染压力。`})]})]})});i(()=>w(e,_,Se))});let Ce=u(`rue:component:anchor`);a(_,Ce),d(()=>{let e=E(M,{title:`Virtual + Async Load 场景页`,summary:`把 virtual、height、itemHeight 和 loadData 合在一起，就能接超长目录或资源树，只在展开分支时再注入子节点。`,tab:L.virtualAsync,code:Qe,preview:A(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[j(q,{treeData:P.value,selectedKeys:ie.value,expandedKeys:F.value,height:340,itemHeight:40,virtual:!0,showIcon:!0,blockNode:!0,loadData:R,titleRender:({node:e,loading:t})=>A(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[j(`span`,{className:`truncate`,children:e.title}),j(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`loaded`:e.isLeaf?`leaf`:`lazy`})]}),onSelect:e=>{ie.value=e},onExpand:e=>{F.value=e}}),A(`div`,{className:`space-y-3`,children:[A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`根节点数量`}),j(`div`,{className:`mt-2 text-2xl font-semibold`,children:P.value.length})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`已加载分支`}),j(`div`,{className:`mt-2 text-2xl font-semibold`,children:I.get()})]}),A(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[j(`div`,{className:`text-xs text-base-content/45`,children:`当前展开`}),j(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(F.value)})]}),j(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`先滚动到较深位置再展开节点也没问题：视口外的行不会真正渲染，只有命中的 branch 才会触发 loadData 注入子节点。`})]})]})});i(()=>w(e,_,Ce))});let we=u(`rue:component:anchor`);a(_,we),d(()=>{let e=E(M,{title:`保留原始递归 Demo`,summary:`旧的 TreeView 行为没有删掉，只是并进 design 页面里，方便对比“直接改数据”这类递归写法。`,tab:L.legacy,code:$e,preview:j(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm not-prose`,children:A(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,1fr),18rem] lg:items-start`,children:[j(`ul`,{className:`m-0 grid gap-1 p-0`,children:j(lt,{model:oe})}),j(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`单击切换展开，双击叶子节点会把它转换成 folder，并在当前层直接追加一个新子节点。`})]})})});i(()=>w(e,_,we))});let Te=l(`div`,_);a(_,Te),T(Te,`not-prose mt-10 space-y-4`);let Ee=l(`h2`,Te);a(Te,Ee),T(Ee,`text-2xl font-semibold`),a(Ee,e(`API`));let De=u(`rue:component:anchor`);return a(Te,De),d(()=>{let e=E(Pe,{rows:et});i(()=>w(e,Te,De))}),s})}),_,C),_})};export{ut as default};