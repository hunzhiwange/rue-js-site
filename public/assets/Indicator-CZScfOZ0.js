import{$ as e,Kt as t,Lt as n,Q as r,Vt as i,Y as a,Yt as o,Z as s,ct as c,d as l,et as u,l as d,ot as f,t as p}from"./vapor-runtime-BR_2rwNk.js";import{a as m,n as h}from"./vapor-helpers-vapor-DkadWylb.js";import{i as g,r as _}from"./persistentSidebarPlayground-BLfmxcKI.js";import{t as v}from"./tabs-DMHgT-aV.js";import{t as y}from"./badge-2OxLkSBG.js";import{t as b}from"./status-Co23LJPU.js";import{t as x}from"./input-BfzrfJFV.js";import{n as S}from"./SidebarPlaygroundDesign-BScNtO2r.js";import{t as C}from"./Code-B_4lzH85.js";import{t as w}from"./preview-test-gate-BMJrlY7m.js";var T={start:{horizontal:`start`},center:{horizontal:`center`},end:{horizontal:`end`},top:{vertical:`top`},middle:{vertical:`middle`},bottom:{vertical:`bottom`},"top-start":{horizontal:`start`,vertical:`top`},"top-center":{horizontal:`center`,vertical:`top`},"top-end":{horizontal:`end`,vertical:`top`},"middle-start":{horizontal:`start`,vertical:`middle`},"middle-center":{horizontal:`center`,vertical:`middle`},"middle-end":{horizontal:`end`,vertical:`middle`},"bottom-start":{horizontal:`start`,vertical:`bottom`},"bottom-center":{horizontal:`center`,vertical:`bottom`},"bottom-end":{horizontal:`end`,vertical:`bottom`}},E=(e,t)=>t?`${e} ${t}`:e,ee=e=>typeof e==`number`?`${Math.abs(e)}px`:String(e).trim().replace(/^-/,``),D=e=>typeof e==`number`?e<0:String(e).trim().startsWith(`-`),O=(e,t,n=!1)=>`calc(${e} ${(n?!D(t):D(t))?`-`:`+`} ${ee(t)})`,k=e=>e?T[e]:{},A=(e,t,n,r)=>{if(!e)return;let i={"--indicator-s":void 0,"--indicator-e":void 0,"--indicator-t":void 0,"--indicator-b":void 0};if(r){let[e,a]=r;t===`start`?(i[`--indicator-s`]=O(`0px`,e),i[`--indicator-e`]=`auto`):t===`center`?(i[`--indicator-s`]=O(`50%`,e),i[`--indicator-e`]=O(`50%`,e,!0)):t===`end`&&(i[`--indicator-s`]=`auto`,i[`--indicator-e`]=O(`0px`,e,!0)),n===`top`?(i[`--indicator-t`]=O(`0px`,a),i[`--indicator-b`]=`auto`):n===`middle`?(i[`--indicator-t`]=O(`50%`,a),i[`--indicator-b`]=O(`50%`,a,!0)):n===`bottom`&&(i[`--indicator-t`]=`auto`,i[`--indicator-b`]=O(`0px`,a,!0))}Object.entries(i).forEach(([t,n])=>{if(n===void 0){e.style.removeProperty(t);return}e.style.setProperty(t,n)})},j=({as:e=`div`,className:t,style:n,item:r,itemProps:i,items:a,children:o,...s})=>{let c=e,l=Array.isArray(a)&&a.length>0?a.map((e,t)=>_(M,{...e,children:e.children},e.key??t)):r==null?[]:[_(M,{...i,children:r},`__indicator_item__`)];return g(c,{...s,className:E(`indicator`,t),style:n,children:[l,o]})},M=({as:e=`span`,placement:t,horizontal:n,vertical:r,offset:i,className:a,style:o,children:s,...c})=>{let l=e,u=k(t),d=n??u.horizontal,f=r??u.vertical,p=c.ref;`ref`in c&&delete c.ref;let m=`indicator-item`;return d&&(m+=` indicator-${d}`),f&&(m+=` indicator-${f}`),a&&(m+=` ${a}`),_(l,{...c,ref:e=>{typeof p==`function`?p(e):p&&typeof p==`object`&&(p.current=e??void 0),A(e,d,f,i)},className:m,style:o,children:s})},N=Object.assign(j,{Item:M}),te=`https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp`,ne=`https://img.daisyui.com/images/profile/demo/batperson@192.webp`,P=t=>l(n=>{let f=e(`div`,n);c(f,`component-preview not-prose text-base-content my-6 lg:my-12`);let m=e(`div`,f);a(f,m),c(m,`flex flex-wrap items-start justify-between gap-3`);let h=e(`div`,m);a(m,h);let g=e(`h2`,h);a(h,g),c(g,`component-preview-title mt-2 mb-1 text-lg font-semibold`),a(g,u(`# `));let _=s(`rue:slot:anchor`);a(g,_),o(()=>{let e=t.title;i(()=>d(e,g,_))});let y=s(`rue:slot:anchor`);a(h,y),o(()=>{let n=t.summary?l(()=>{let n=r(),l=e(`p`,n);a(n,l),c(l,`m-0 text-sm opacity-70`);let u=s(`rue:slot:anchor`);return a(l,u),o(()=>{let e=t.summary;i(()=>d(e,l,u))}),n}):``;i(()=>d(n,h,y))});let b=s(`rue:component:anchor`);a(f,b),o(()=>{let e=p(v,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:t.tab.value,onChange:e=>t.tab.value=e,className:`mb-3 mt-4`});i(()=>d(e,f,b))});let x=s(`rue:slot:anchor`);return a(f,x),o(()=>{let e=t.tab.value===`preview`?w(t.title,t.preview):l(()=>{let e=r(),n=s(`rue:component:anchor`);return a(e,n),o(()=>{let r=p(C,{className:`mt-2`,lang:`tsx`,code:t.code});i(()=>d(r,e,n))}),e});i(()=>d(e,f,x))}),f}),re=t=>l(n=>{let p=e(`div`,n);c(p,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let m=e(`table`,p);a(p,m),c(m,`table table-zebra`);let g=e(`thead`,m);a(m,g);let _=e(`tr`,g);a(g,_);let v=e(`th`,_);a(_,v),a(v,u(`属性`));let y=e(`th`,_);a(_,y),a(y,u(`说明`));let b=e(`th`,_);a(_,b),a(b,u(`类型`));let x=e(`th`,_);a(_,x),a(x,u(`默认值`));let S=e(`tbody`,m);a(m,S);let C=s(`rue:list:start`),w=s(`rue:list:end`);a(S,C),a(S,w);let T=new Map;return o(()=>{T=h({items:t.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(t,n,c,u,p)=>{d(l(()=>{let n=r(),c=e(`tr`,n);a(n,c),o(()=>{f(c,`key`,String(t.prop))});let l=e(`td`,c);a(c,l);let u=e(`code`,l);a(l,u);let p=s(`rue:slot:anchor`);a(u,p),o(()=>{let e=t.prop;i(()=>d(e,u,p))});let m=e(`td`,c);a(c,m);let h=s(`rue:slot:anchor`);a(m,h),o(()=>{let e=t.description;i(()=>d(e,m,h))});let g=e(`td`,c);a(c,g);let _=e(`code`,g);a(g,_);let v=s(`rue:slot:anchor`);a(_,v),o(()=>{let e=t.type;i(()=>d(e,_,v))});let y=e(`td`,c);a(c,y);let b=e(`code`,y);a(y,b);let x=s(`rue:slot:anchor`);return a(b,x),o(()=>{let e=t.defaultValue;i(()=>d(e,b,x))}),n}),n,c)}})}),p}),ie=[{prop:`as`,description:`指定容器标签，默认输出 div`,type:`any`,defaultValue:`'div'`},{prop:`item`,description:`单个快捷角标内容，适合最常见的一个 overlay 场景`,type:`any`,defaultValue:`-`},{prop:`itemProps`,description:`配合 item 使用的 Indicator.Item 属性透传`,type:`Omit<IndicatorItemProps, children>`,defaultValue:`-`},{prop:`items`,description:`多角标数据驱动写法，内部会自动展开为多个 Indicator.Item`,type:`IndicatorItemConfig[]`,defaultValue:`-`},{prop:`style`,description:`容器样式，保留原生 style 透传`,type:`Record<string, any> | string`,defaultValue:`-`}],ae=[{prop:`as`,description:`指定角标根节点标签，默认输出 span`,type:`any`,defaultValue:`'span'`},{prop:`className`,description:`追加到 indicator-item 上的视觉类名`,type:`string`,defaultValue:`-`},{prop:`horizontal`,description:`水平定位，显式传入时优先级高于 placement`,type:`'start' | 'center' | 'end'`,defaultValue:`-`},{prop:`offset`,description:`在既有 anchor 基础上微调角标位置，格式为 [x, y]`,type:`[number | string, number | string]`,defaultValue:`-`},{prop:`placement`,description:`组合式定位写法，例如 top-start、middle-center、bottom-end`,type:`IndicatorPlacement`,defaultValue:`-`},{prop:`style`,description:`原生 style 透传；offset 会通过 CSS 变量补充到最终节点`,type:`Record<string, any> | string`,defaultValue:`-`},{prop:`vertical`,description:`垂直定位，显式传入时优先级高于 placement`,type:`'top' | 'middle' | 'bottom'`,defaultValue:`-`}],F=()=>{let{tabStatus:f,tabBadge:h,tabButton:v,tabInput:C,tabCard:w,tabCenter:T,tabAvatar:E,tabTab:ee,tabPlacement:D,tabShortcut:O,tabMultiple:k}=m(`useSetup:0:0`,()=>t(()=>({tabStatus:m(`ref:1:0`,()=>n(`preview`)),tabBadge:m(`ref:1:1`,()=>n(`preview`)),tabButton:m(`ref:1:2`,()=>n(`preview`)),tabInput:m(`ref:1:3`,()=>n(`preview`)),tabCard:m(`ref:1:4`,()=>n(`preview`)),tabCenter:m(`ref:1:5`,()=>n(`preview`)),tabAvatar:m(`ref:1:6`,()=>n(`preview`)),tabTab:m(`ref:1:7`,()=>n(`preview`)),tabPlacement:m(`ref:1:8`,()=>n(`preview`)),tabShortcut:m(`ref:1:9`,()=>n(`preview`)),tabMultiple:m(`ref:1:10`,()=>n(`preview`))})));return l(t=>{let n=r(),m=s(`rue:component:anchor`);return a(n,m),d(p(S,{children:l(()=>{let t=r(),n=e(`div`,t);a(t,n),c(n,`max-w-none prose prose-sm md:prose-base`);let l=e(`h1`,n);a(n,l),a(l,u(`Indicator 指示器`));let m=e(`p`,n);a(n,m),c(m,`text-sm mt-3 mb-3`),a(m,u(`Indicator 负责把状态点、徽标、按钮或任意轻量信息悬挂到内容边缘。Rue 这一版在保留原有复合写法的同时，补齐了`));let S=e(`code`,m);a(m,S),a(S,u(`placement`)),a(m,u(`、`));let A=e(`code`,m);a(m,A),a(A,u(`offset`)),a(m,u(`，以及`));let j=e(`code`,m);a(m,j),a(j,u(`item / items`)),a(m,u(`这组三件套，方便快速搭角标而不必每次都手写一个`));let M=e(`code`,m);a(m,M),a(M,u(`Indicator.Item`)),a(m,u(`。`));let F=e(`div`,n);a(n,F),c(F,`not-prose grid gap-3 rounded-box border border-base-300 bg-base-100 p-4 md:grid-cols-3`);let I=e(`div`,F);a(F,I),c(I,`rounded-box bg-base-200/70 p-4`);let L=e(`div`,I);a(I,L),c(L,`text-sm font-medium`),a(L,u(`兼容旧用法`));let R=e(`p`,I);a(I,R),c(R,`m-0 mt-2 text-sm text-base-content/70`),a(R,u(`horizontal 和 vertical 仍然可直接使用，旧 demo 不需要回退。`));let z=e(`div`,F);a(F,z),c(z,`rounded-box bg-base-200/70 p-4`);let B=e(`div`,z);a(z,B),c(B,`text-sm font-medium`),a(B,u(`新增快捷模式`));let V=e(`p`,z);a(z,V),c(V,`m-0 mt-2 text-sm text-base-content/70`),a(V,u(`一个角标用 item，多角标用 items，页面模板代码可以明显收缩。`));let H=e(`div`,F);a(F,H),c(H,`rounded-box bg-base-200/70 p-4`);let U=e(`div`,H);a(H,U),c(U,`text-sm font-medium`),a(U,u(`定位更顺手`));let W=e(`p`,H);a(H,W),c(W,`m-0 mt-2 text-sm text-base-content/70`),a(W,u(`placement 负责主定位，offset 负责微调，适合图片、卡片、操作按钮等场景。`));let G=s(`rue:component:anchor`);a(n,G),o(()=>{let e=p(P,{title:`Status indicator`,summary:`最轻量的状态提醒，保留原始复合写法。`,tab:f,preview:()=>g(N,{children:[_(N.Item,{children:_(b,{status:`success`})}),_(`div`,{className:`grid h-32 w-32 place-items-center rounded bg-base-300`,children:`content`})]}),code:`<Indicator>
  <Indicator.Item>
    <Status status="success" />
  </Indicator.Item>
  <div className="grid h-32 w-32 place-items-center rounded bg-base-300">content</div>
</Indicator>`});i(()=>d(e,n,G))});let K=s(`rue:component:anchor`);a(n,K),o(()=>{let e=p(P,{title:`Badge as indicator`,summary:`把 Badge 挂到内容右上角，是最常见的信息提醒写法。`,tab:h,preview:()=>g(N,{children:[_(N.Item,{children:_(y,{variant:`primary`,children:`New`})}),_(`div`,{className:`grid h-32 w-32 place-items-center rounded bg-base-300`,children:`content`})]}),code:`<Indicator>
  <Indicator.Item>
    <Badge variant="primary">New</Badge>
  </Indicator.Item>
  <div className="grid h-32 w-32 place-items-center rounded bg-base-300">content</div>
</Indicator>`});i(()=>d(e,n,K))});let q=s(`rue:component:anchor`);a(n,q),o(()=>{let e=p(P,{title:`For button`,summary:`一个角标时可以直接改用 item 快捷模式，不再手写 Indicator.Item。`,tab:v,preview:()=>_(N,{item:_(y,{variant:`secondary`,children:`12`}),itemProps:{placement:`top-end`},children:_(`button`,{className:`btn`,children:`Inbox`})}),code:`<Indicator
  item={<Badge variant="secondary">12</Badge>}
  itemProps={{ placement: 'top-end' }}
>
  <button className="btn">Inbox</button>
</Indicator>`});i(()=>d(e,n,q))});let J=s(`rue:component:anchor`);a(n,J),o(()=>{let e=p(P,{title:`For an input`,summary:`表单必填、实验开关等轻提示适合放在输入框边缘。`,tab:C,preview:()=>g(N,{children:[_(N.Item,{children:_(y,{children:`Required`})}),_(x,{placeholder:`Your email address`,className:`input-bordered`})]}),code:`<Indicator>
  <Indicator.Item>
    <Badge>Required</Badge>
  </Indicator.Item>
  <Input placeholder="Your email address" className="input-bordered" />
</Indicator>`});i(()=>d(e,n,J))});let Y=s(`rue:component:anchor`);a(n,Y),o(()=>{let e=p(P,{title:`A button as an indicator for a card`,summary:`兼容旧的 vertical 写法，适合把操作按钮悬挂在卡片边缘。`,tab:w,preview:()=>g(N,{className:`mx-10 my-6`,children:[_(N.Item,{vertical:`bottom`,children:_(`button`,{className:`btn btn-primary`,children:`Apply`})}),_(`div`,{className:`card border border-base-300 bg-base-100 shadow-sm`,children:g(`div`,{className:`card-body`,children:[_(`h2`,{className:`card-title`,children:`Job Title`}),_(`p`,{children:`Rerum reiciendis beatae tenetur excepturi`})]})})]}),code:`<Indicator className="mx-10 my-6">
...
</div>`});i(()=>d(e,n,ce))});let le=s(`rue:component:anchor`);a(n,le),o(()=>{let e=p(P,{title:`Placement shorthand and offset`,summary:`placement 先给出主定位，再用 offset 做细调，适合视觉需要避让边框或圆角的场景。`,tab:D,preview:()=>g(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[_(N,{item:_(y,{variant:`secondary`,children:`Start`}),itemProps:{placement:`top-start`,offset:[8,-4]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`top-start`})}),_(N,{item:_(y,{variant:`accent`,children:`Center`}),itemProps:{placement:`middle-center`,offset:[0,4]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`middle-center`})}),_(N,{item:_(y,{variant:`warning`,children:`End`}),itemProps:{placement:`bottom-end`,offset:[10,6]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`bottom-end`})})]}),code:`<div className="grid gap-4 md:grid-cols-3">
  <Indicator
...
</Indicator>`});i(()=>d(e,n,ue))});let Z=e(`h2`,n);a(n,Z),c(Z,`mt-10`),a(Z,u(`API`));let Q=e(`p`,n);a(n,Q),c(Q,`text-sm text-base-content/70`),a(Q,u(`Indicator 仍然是一个纯布局组件，不接管 Badge、Status 或 Button 的视觉，只负责悬挂与定位。`));let de=e(`h3`,n);a(n,de),a(de,u(`Indicator`));let fe=s(`rue:component:anchor`);a(n,fe),o(()=>{let e=p(re,{rows:ie});i(()=>d(e,n,fe))});let $=e(`h3`,n);a(n,$),c($,`mt-8`),a($,u(`Indicator.Item`));let pe=s(`rue:component:anchor`);return a(n,pe),o(()=>{let e=p(re,{rows:ae});i(()=>d(e,n,pe))}),t})}),n,m),n})};export{F as default};