...
`,Demo:()=>r(p=>{let g=s(`div`,p);o(g,`card bg-base-100 shadow`);let _=s(`div`,g);e(g,_),o(_,`card-body space-y-3`);let v=s(`h2`,_);e(_,v),o(v,`text-2xl font-semibold`),e(v,n(`Layout children 示例`));let y=u(`rue:component:anchor`);e(_,y);let b=r(()=>{let t=i(),r=s(`p`,t);e(t,r),o(r,`text-gray-700`),e(r,n(`主体内容通过 props.children 传入`));let a=s(`p`,t);return e(t,a),o(a,`text-gray-600`),e(a,n(`这与 React 的 children 语义一致`)),t});return t(()=>{let e=c(h,{header:f(`div`,{className:`text-gray-800 font-semibold`,children:`自定义 Header`}),footer:f(`div`,{className:`text-gray-600`,children:`自定义 Footer`}),content:f(`div`,{className:`space-y-2`,children:f(m,{children:d(`p`,{className:`text-gray-700`,children:[`你好`,f(m,{children:`123456`})]})})}),children:b});l(()=>a(e,_,y))}),g})});export{g as default};