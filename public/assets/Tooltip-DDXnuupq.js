import{F as e,I as t,K as n,L as r,N as i,R as a,W as o,d as s,dt as c,ht as l,l as u,st as d,t as f,vt as p}from"./vapor-runtime-BuwLbCGk.js";import{a as m,n as h}from"./vapor-helpers-vapor-Bly5xJie.js";import{n as g,t as _}from"./src-BQwLQD8R.js";import{n as v}from"./SidebarPlaygroundDesign-SQXYHI-q.js";import{t as y}from"./tooltip-VgQ1AwY7.js";import{t as b}from"./PreviewBlock-Cks1b4IL.js";var x=[{prop:`arrow`,description:`是否显示箭头，适合在卡片式信息和标签式提示之间切换语气。`,type:`boolean`,defaultValue:`true`},{prop:`classNames`,description:`语义化类名扩展，支持分别定制根节点和提示内容。`,type:`{ root?: string; body?: string }`,defaultValue:`-`},{prop:`color`,description:`支持 daisyUI 语义色，也支持自定义颜色字符串。`,type:`'neutral' | 'primary' | 'secondary' | 'accent' | 'info' | 'success' | 'warning' | 'error' | string`,defaultValue:`-`},{prop:`content / overlay / title / tip`,description:`提示内容入口，支持文本、JSX 节点、函数返回值，并兼容旧的 tip 写法。`,type:`any`,defaultValue:`-`},{prop:`defaultOpen`,description:`非受控初始显示状态。`,type:`boolean`,defaultValue:`false`},{prop:`disabled`,description:`禁用 Tooltip，仅保留包裹结构，不显示提示内容。`,type:`boolean`,defaultValue:`false`},{prop:`open`,description:`受控显示状态，适合与外部按钮、校验状态或页面步骤联动。`,type:`boolean`,defaultValue:`-`},{prop:`onOpenChange`,description:`显示状态变化回调。`,type:`(open: boolean) => void`,defaultValue:`-`},{prop:`overlayClassName / overlayStyle`,description:`提示内容层的类名和样式扩展。`,type:`string / Record<string, any>`,defaultValue:`-`},{prop:`placement`,description:`支持四个基础方向和常见浮层组件里的角落别名。`,type:`'top' | 'bottom' | 'left' | 'right' | 'topLeft' | 'topRight' | 'bottomLeft' | 'bottomRight' | 'leftTop' | 'leftBottom' | 'rightTop' | 'rightBottom'`,defaultValue:`'top'`},{prop:`styles`,description:`语义化样式扩展，支持根节点与提示内容。`,type:`{ root?: Record<string, any>; body?: Record<string, any> }`,defaultValue:`-`},{prop:`trigger`,description:`触发方式，可单独或组合使用 hover、focus、click、contextMenu。`,type:`'hover' | 'focus' | 'click' | 'contextMenu' | Array<...>`,defaultValue:`['hover', 'focus']`}],S=()=>{let{tabBasic:S,tabPlacements:C,tabContent:w,tabColors:T,tabTriggers:E,tabOpen:D,controlledOpen:O}=m(`useSetup:0:0`,()=>l(()=>({tabBasic:m(`ref:1:0`,()=>d(`preview`)),tabPlacements:m(`ref:1:1`,()=>d(`preview`)),tabContent:m(`ref:1:2`,()=>d(`preview`)),tabColors:m(`ref:1:3`,()=>d(`preview`)),tabTriggers:m(`ref:1:4`,()=>d(`preview`)),tabOpen:m(`ref:1:5`,()=>d(`preview`)),controlledOpen:m(`ref:1:6`,()=>d(!0))})));return s(l=>{let d=t(),m=e(`rue:component:anchor`);return i(d,m),u(f(v,{children:s(()=>{let l=t(),d=r(`div`,l);i(l,d),n(d,`max-w-none prose prose-sm md:prose-base`);let m=r(`h1`,d);i(d,m),i(m,a(`Tooltip 提示框`));let v=r(`p`,d);i(d,v),n(v,`text-sm mt-3 mb-3`),i(v,a(`Tooltip 现在既保留 Rue 原本轻量、包裹式的视觉习惯，也补上更完整的语义 API。你可以继续使用`));let k=r(`code`,v);i(v,k),i(k,a(`tip`)),i(v,a(`和`));let A=r(`code`,v);i(v,A),i(A,a(`Tooltip.Content`)),i(v,a(`，也可以切到`));let j=r(`code`,v);i(v,j),i(j,a(`title`)),i(v,a(`、`));let M=r(`code`,v);i(v,M),i(M,a(`overlay`)),i(v,a(`、受控显示、 自定义颜色和语义化样式扩展。`));let N=r(`div`,d);i(d,N),n(N,`text-sm`);let P=r(`a`,N);i(N,P),o(P,`href`,`https://daisyui.com/components/tooltip/`),o(P,`target`,`_blank`),i(P,a(`查看 Tooltip 静态样式`));let F=e(`rue:component:anchor`);i(d,F),p(()=>{let e=f(b,{title:`Tooltip`,tab:S,preview:()=>g(`div`,{className:`flex flex-wrap gap-4`,children:[_(y,{"data-testid":`tooltip-basic`,title:`用于解释按钮含义`,children:_(`button`,{className:`btn`,children:`Hover me`})}),_(y,{title:()=>`函数内容也可以惰性返回`,children:_(`button`,{className:`btn btn-outline`,children:`Lazy title`})}),_(y,{disabled:!0,title:`不会显示`,children:_(`button`,{className:`btn btn-ghost`,children:`Disabled tooltip`})})]}),code:`<Tooltip title="用于解释按钮含义">
...
</div>`});c(()=>u(e,d,B))});let V=r(`div`,d);i(d,V),n(V,`not-prose mt-10 overflow-x-auto rounded-box border border-base-300 bg-base-100`);let H=r(`table`,V);i(V,H),n(H,`table table-zebra`);let U=r(`thead`,H);i(H,U);let W=r(`tr`,U);i(U,W);let G=r(`th`,W);i(W,G),i(G,a(`属性`));let K=r(`th`,W);i(W,K),i(K,a(`说明`));let q=r(`th`,W);i(W,q),i(q,a(`类型`));let J=r(`th`,W);i(W,J),i(J,a(`默认值`));let Y=r(`tbody`,H);i(H,Y);let X=e(`rue:list:start`),Z=e(`rue:list:end`);i(Y,X),i(Y,Z);let Q=new Map;return p(()=>{Q=h({items:x||[],getKey:(e,t)=>e.prop,elements:Q,parent:Y,before:Z,singleRoot:!0,trackIndex:!1,start:X,renderItem:(n,a,l,d,f)=>{u(s(()=>{let a=t(),s=r(`tr`,a);i(a,s),p(()=>{o(s,`key`,String(n.prop))});let l=r(`td`,s);i(s,l);let d=r(`code`,l);i(l,d);let f=e(`rue:slot:anchor`);i(d,f),p(()=>{let e=n.prop;c(()=>u(e,d,f))});let m=r(`td`,s);i(s,m);let h=e(`rue:slot:anchor`);i(m,h),p(()=>{let e=n.description;c(()=>u(e,m,h))});let g=r(`td`,s);i(s,g);let _=r(`code`,g);i(g,_);let v=e(`rue:slot:anchor`);i(_,v),p(()=>{let e=n.type;c(()=>u(e,_,v))});let y=r(`td`,s);i(s,y);let b=r(`code`,y);i(y,b);let x=e(`rue:slot:anchor`);return i(b,x),p(()=>{let e=n.defaultValue;c(()=>u(e,b,x))}),a}),a,l)}})}),l})}),d,m),d})};export{S as default};