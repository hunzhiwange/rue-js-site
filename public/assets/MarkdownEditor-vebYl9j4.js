...
export default MarkdownEditor;`});m(()=>l(e,i,a))}),n}):``;m(()=>l(n,T,E))}),e(T,o(` `));let D=h(`rue:slot:anchor`);return e(T,D),t(()=>{let n=w.value===`preview`?s(()=>{let n=c(),i=f(`div`,n);e(n,i),d(i,`card bg-base-100 shadow`);let o=f(`div`,i);e(i,o),d(o,`card-body grid gap-4`);let s=f(`div`,o);e(o,s),d(s,`grid grid-cols-2 gap-0 h-[360px] md:h-[560px] rounded-xl overflow-hidden ring-1 ring-black/5`);let l=f(`textarea`,s);e(s,l),d(l,`textarea textarea-bordered rounded-none border-r`),t(()=>{g(l,b.value)}),r(l,`input`,C);let u=f(`div`,s);return e(s,u),d(u,`p-4 overflow-auto`),t(()=>{let e={__html:x.render(b.value)};a(u,e&&`__html`in e?e.__html:``)}),n}):``;m(()=>l(n,T,D))}),n})}),u,_),u})};export{C as default};