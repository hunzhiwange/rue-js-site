...
</MockupWindow>`});l(()=>f(e,d,re))});let ie=e(`rue:component:anchor`);i(d,ie),h(()=>{let e=m(N,{title:`window mockup with border`,summary:`保留原有经典 demo，不改动原始 children 透传写法。`,tab:T,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(M,{className:`border border-base-300 w-full`,"data-testid":`mockup-window-border`,children:b(`div`,{className:`grid place-content-center border-t border-base-300 h-80`,children:`Hello!`})})})}),code:`<MockupWindow className="border border-base-300 w-full">
  <div className="grid place-content-center border-t border-base-300 h-80">Hello!</div>
</MockupWindow>`});l(()=>f(e,d,ie))});let ae=e(`rue:component:anchor`);i(d,ae),h(()=>{let e=m(N,{title:`window mockup with background color`,summary:`原有背景版本也继续保留，适合最简单的展示壳层。`,tab:E,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(M,{className:`bg-base-100 border border-base-300 w-full`,"data-testid":`mockup-window-background`,children:b(`div`,{className:`grid place-content-center h-80`,children:`Hello!`})})})}),code:`<MockupWindow className="bg-base-100 border border-base-300 w-full">
  <div className="grid place-content-center h-80">Hello!</div>
</MockupWindow>`});l(()=>f(e,d,ae))});let L=r(`h2`,d);i(d,L),s(L,`id`,`mockup-window-api`),i(L,o(`API`));let oe=r(`p`,d);i(d,oe),i(oe,o(`MockupWindow 同时支持“旧的 children 直出模式”和“新的结构化窗口模式”。`));let R=e(`rue:component:anchor`);i(d,R),h(()=>{let e=m(ee,{rows:ne});l(()=>f(e,d,R))});let z=r(`div`,d);i(d,z),n(z,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let B=r(`h3`,z);i(z,B),n(B,`mt-0 mb-3 text-base font-semibold`),i(B,o(`复合子组件`));let V=r(`div`,z);i(z,V),n(V,`grid gap-2 text-sm md:grid-cols-2`);let H=r(`div`,V);i(V,H);let U=r(`code`,H);i(H,U),i(U,o(`MockupWindow.Header`)),i(H,o(`：标准头部，支持`));let W=r(`code`,H);i(H,W),i(W,o(`title`)),i(H,o(`、`));let G=r(`code`,H);i(H,G),i(G,o(`description`)),i(H,o(`和`));let K=r(`code`,H);i(H,K),i(K,o(`extra`));let q=r(`div`,V);i(V,q);let J=r(`code`,q);i(q,J),i(J,o(`MockupWindow.Toolbar`)),i(q,o(`：头部工具区包装器，默认横向排列`));let Y=r(`div`,V);i(V,Y);let se=r(`code`,Y);i(Y,se),i(se,o(`MockupWindow.Body`)),i(Y,o(`：内容区，可选`));let ce=r(`code`,Y);i(Y,ce),i(ce,o(`padding`));let X=r(`div`,V);i(V,X);let le=r(`code`,X);i(X,le),i(le,o(`MockupWindow.Actions`)),i(X,o(`：底部操作区，默认右对齐并带分隔线`));let ue=r(`h2`,d);i(d,ue),i(ue,o(`FAQ`));let de=r(`h3`,d);i(d,de),i(de,o(`什么时候用根组件属性，什么时候用复合子组件？`));let Z=r(`p`,d);i(d,Z),i(Z,o(`如果只是常见的标题栏 + 内容区 + 按钮栏，优先直接使用根组件的`));let fe=r(`code`,Z);i(Z,fe),i(fe,o(`title`)),i(Z,o(`、`));let pe=r(`code`,Z);i(Z,pe),i(pe,o(`toolbar`)),i(Z,o(`和`));let me=r(`code`,Z);i(Z,me),i(me,o(`actions`)),i(Z,o(`。当你需要完全自定义头部排版，再切换到`));let he=g(Z);i(Z,he),a(he,` `);let ge=r(`code`,Z);i(Z,ge),i(ge,o(`MockupWindow.Header`)),i(Z,o(`这类低层拼装方式。`));let Q=r(`h3`,d);i(d,Q),i(Q,o(`padding 应该怎么理解？`));let $=r(`p`,d);i(d,$);let _e=r(`code`,$);i($,_e),i(_e,o(`padding`)),i($,o(`只作用于结构化模式下自动生成的`));let ve=r(`code`,$);i($,ve),i(ve,o(`Body`)),i($,o(`。如果你已经手动使用`));let ye=g($);i($,ye),a(ye,` `);let be=r(`code`,$);return i($,be),i(be,o(`MockupWindow.Body`)),i($,o(`或自己管理内容布局，直接在内容节点上写 className 会更直接。`)),c})}),p,_),p})};export{P as default};