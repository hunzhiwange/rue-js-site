...
/>`});l(()=>f(e,d,L))});let z=e(`rue:component:anchor`);i(d,z),h(()=>{let e=m(F,{title:`数据驱动导航项`,summary:`当中间菜单和右侧状态来自配置或接口时，用 items 比手写结构更容易维护。`,tab:v,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`rounded-box bg-base-100`,brand:y(`a`,{className:`btn btn-ghost gap-3 px-2 text-lg normal-case`,children:[b(R,{label:`W`}),`Workspace`]}),items:D,actions:b(`button`,{className:`btn btn-primary btn-sm`,children:`Invite`}),centerProps:{className:`hidden md:flex gap-1`},endProps:{className:`gap-2`},"data-testid":`navbar-items`})})}),code:`const items = [
...
/>`});l(()=>f(e,d,se))});let ce=r(`h2`,d);i(d,ce),i(ce,o(`经典 demo`));let le=r(`p`,d);i(d,le),i(le,o(`下面这几组示例保留了原有写法，只做了页面重组，方便继续对照 Start / Center / End 的经典组合方式。`));let ue=e(`rue:component:anchor`);i(d,ue),h(()=>{let e=m(F,{title:`仅标题`,summary:`最简单的 navbar，用 root 直接承载内容。`,tab:C,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:b(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-only`,children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <button className="btn btn-ghost text-xl">daisyUI</button>
</Navbar>`});l(()=>f(e,d,ue))});let B=e(`rue:component:anchor`);i(d,B),h(()=>{let e=m(F,{title:`标题与图标`,summary:`保留经典的 Start + End 组合。`,tab:w,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-title-icon`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:b(`button`,{className:`btn btn-square btn-ghost`,children:b(ne,{})})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});l(()=>f(e,d,V))});let H=e(`rue:component:anchor`);i(d,H),h(()=>{let e=m(F,{title:`菜单与子菜单`,summary:`继续保留菜单容器和 details 子菜单的经典演示。`,tab:E,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-menu-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),b(P.End,{children:y(`ul`,{className:`menu menu-horizontal items-center gap-1 px-1`,children:[b(`li`,{children:b(`button`,{className:`h-10 min-h-10 items-center`,children:`Link`})}),b(`li`,{children:y(`details`,{children:[b(`summary`,{className:`h-10 min-h-10 items-center`,children:`Parent`}),y(`ul`,{className:`bg-base-100 rounded-t-none p-2`,children:[b(`li`,{children:b(`button`,{children:`Link 1`})}),b(`li`,{children:b(`button`,{children:`Link 2`})})]})]})})]})})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
  <Navbar.End>
...
</Navbar>`});l(()=>f(e,d,H))});let U=e(`rue:component:anchor`);i(d,U),h(()=>{let e=m(F,{title:`搜索框与头像下拉`,summary:`保留搜索、头像和下拉菜单混排的经典结构。`,tab:ee,preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm mb-32`,children:b(`div`,{className:`card-body`,children:y(P,{className:`bg-base-100 shadow-sm`,"data-testid":`navbar-search-demo`,children:[b(P.Start,{children:b(`button`,{className:`btn btn-ghost text-xl`,children:`daisyUI`})}),y(P.End,{className:`gap-2`,children:[b(`input`,{type:`text`,placeholder:`Search`,className:`input input-bordered w-24 md:w-auto`}),y(`div`,{className:`dropdown dropdown-end`,children:[b(`div`,{tabIndex:`0`,role:`button`,className:`btn btn-ghost btn-circle avatar`,children:b(`div`,{className:`w-10 rounded-full`,children:b(`img`,{alt:`Tailwind CSS Navbar component`,src:`https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp`})})}),y(`ul`,{tabIndex:`-1`,className:`mt-3 z-1 p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52`,children:[b(`li`,{children:y(`button`,{className:`justify-between`,children:[`Profile`,b(`span`,{className:`badge`,children:`New`})]})}),b(`li`,{children:b(`button`,{children:`Settings`})}),b(`li`,{children:b(`button`,{children:`Logout`})})]})]})]})]})})}),code:`<Navbar className="bg-base-100 shadow-sm">
  <Navbar.Start>
    <button className="btn btn-ghost text-xl">daisyUI</button>
  </Navbar.Start>
...
</Navbar>`});l(()=>f(e,d,U))});let W=r(`h2`,d);i(d,W),s(W,`id`,`navbar-api`),i(W,o(`API`));let de=r(`p`,d);i(d,de),i(de,o(`Navbar 现在同时支持推荐的语义插槽模式，以及原有的组合模式。`));let fe=r(`h3`,d);i(d,fe),i(fe,o(`Navbar`));let pe=e(`rue:component:anchor`);i(d,pe),h(()=>{let e=m(I,{rows:ie});l(()=>f(e,d,pe))});let me=r(`h3`,d);i(d,me),i(me,o(`Navbar.Start / Navbar.Center / Navbar.End / Navbar.Section`));let he=e(`rue:component:anchor`);i(d,he),h(()=>{let e=m(I,{rows:ae});l(()=>f(e,d,he))});let ge=r(`h3`,d);i(d,ge),i(ge,o(`Navbar.Item / items[]`));let _e=e(`rue:component:anchor`);i(d,_e),h(()=>{let e=m(I,{rows:oe});l(()=>f(e,d,_e))});let G=r(`div`,d);i(d,G),n(G,`not-prose mt-6 rounded-box border border-base-300 bg-base-100 p-4`);let K=r(`h3`,G);i(G,K),n(K,`mt-0 mb-3 text-base font-semibold`),i(K,o(`双模式说明`));let q=r(`div`,G);i(G,q),n(q,`grid gap-3 text-sm md:grid-cols-2`);let J=r(`div`,q);i(q,J);let ve=r(`code`,J);i(J,ve),i(ve,o(`children + Navbar.Start/Center/End`)),i(J,o(`: 适合完全手写布局，兼容旧 demo。`));let Y=r(`div`,q);i(q,Y);let ye=r(`code`,Y);i(Y,ye),i(ye,o(`brand / start / center / end / actions / items`)),i(Y,o(`: 适合抽象成复用头部或通过配置生成导航结构。`));let be=r(`h2`,d);i(d,be),i(be,o(`FAQ`));let xe=r(`h3`,d);i(d,xe),i(xe,o(`什么时候选推荐模式，什么时候继续手写 children？`));let X=r(`p`,d);i(d,X),i(X,o(`如果页面头部结构在多个页面之间重复，或者导航项来自配置，优先用语义插槽和`));let Se=g(X);i(X,Se),a(Se,` `);let Z=r(`code`,X);i(X,Z),i(Z,o(`items`)),i(X,o(`。 如果当前头部结构非常自由，包含复杂的 dropdown、menu、搜索表单，继续手写`));let Ce=r(`code`,X);i(X,Ce),i(Ce,o(`children + Navbar.Start/Center/End`)),i(X,o(`会更直接。`));let we=r(`h3`,d);i(d,we),i(we,o(`children 和 items 同时传时谁优先？`));let Q=r(`p`,d);i(d,Q),i(Q,o(`当前实现会优先渲染`));let Te=r(`code`,Q);i(Q,Te),i(Te,o(`children`)),i(Q,o(`。这样可以保证旧代码迁移时不被新属性打断， 也能让组合模式保持完全可控。`));let Ee=r(`h3`,d);i(d,Ee),i(Ee,o(`sticky 和 bordered 是强样式能力吗？`));let $=r(`p`,d);i(d,$),i($,o(`不是。它们只是补一层常用布局类，仍然遵循 Rue 当前的视觉基底；更细的背景、阴影、圆角和响应式布局， 依然建议通过`));let De=r(`code`,$);i($,De),i(De,o(`className`));let Oe=g($);return i($,Oe),a(Oe,` `),i($,o(`和区块 props 来组合。`)),c})}),p,_),p})};export{z as default};