import{$ as e,Q as t,Qt as n,Wt as r,X as i,Yt as a,et as o,gt as s,i as c,l,lt as u,n as d,o as f,pt as p,r as m,st as h,t as g,tt as _,vt as v,zt as y}from"./vapor-runtime-CXIalONM.js";import{a as b,n as x,t as S}from"./vapor-helpers-vapor-CoXKrGmY.js";import{a as C,i as w}from"./persistentSidebarPlayground-DBDp2zjv.js";import{t as T}from"./Code-BIscIyEp.js";import{t as E}from"./button-CeShl0h_.js";import{t as D}from"./card-CUf5IzrW.js";import{t as O}from"./tabs-CZWMQq5i.js";import{t as k}from"./badge-yUyMWmRO.js";import{r as A}from"./SidebarPlaygroundDesign-CsC_YS7V.js";var j=[`xs`,`sm`,`md`,`lg`,`xl`,`xxl`],M={xs:0,sm:576,md:768,lg:992,xl:1200,xxl:1600},N=new Set,P=(e,t)=>e?t?`${e} ${t}`:e:t??``,F=e=>typeof e==`number`?`${e}px`:e,I=e=>e.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`),L=e=>e?typeof e==`string`?e.trim():Object.entries(e).filter(([,e])=>e!=null).map(([e,t])=>`${e.startsWith(`--`)?e:I(e)}:${String(t)}`).join(`; `):``,R=(...e)=>e.map(e=>L(e)).filter(Boolean).join(`; `),z=(e,t)=>{typeof e==`function`?e(t):e&&typeof e==`object`&&`current`in e&&(e.current=t??void 0)},B=()=>typeof window>`u`?M.xl:window.innerWidth||document.documentElement?.clientWidth||M.xl,V=b(`ref:1:0`,()=>y(B())),H=()=>{N.forEach(e=>e())},U=e=>typeof window>`u`?()=>{}:(N.size===0&&window.addEventListener(`resize`,H),N.add(e),()=>{N.delete(e),N.size===0&&window.removeEventListener(`resize`,H)}),W=e=>!e||typeof e!=`object`||Array.isArray(e)?!1:Object.keys(e).some(e=>j.includes(e)),G=(e,t)=>{if(!W(e))return e;let n;for(let r of j)t>=M[r]&&e[r]!==void 0&&(n=e[r]);return n},K=e=>e?Array.isArray(e)?e.some(e=>W(e)):W(e):!1,ee=e=>j.some(t=>e[t]!==void 0),q=(e,t=!1)=>{if(!(e==null||e===0||e===`0`)){if(typeof e==`number`){let n=e/2;return`${t?-n:n}px`}return`calc(${e} / ${t?`-2`:`2`})`}},J=e=>{switch(e){case`end`:return`flex-end`;case`center`:return`center`;case`space-around`:return`space-around`;case`space-between`:return`space-between`;case`space-evenly`:return`space-evenly`;default:return`flex-start`}},te=e=>{switch(e){case`middle`:return`center`;case`bottom`:return`flex-end`;case`stretch`:return`stretch`;default:return`flex-start`}},ne=(e,t)=>e?Array.isArray(e)?[G(e[0],t),G(e[1],t)]:[G(e,t),void 0]:[void 0,void 0],re=e=>{if(e!==void 0)return typeof e==`number`?{span:e}:e},ie=(e,t)=>{let n={span:e.span,order:e.order,offset:e.offset,push:e.push,pull:e.pull,flex:e.flex};for(let r of j){if(t<M[r])continue;let i=re(e[r]);i&&(i.span!==void 0&&(n.span=i.span),i.order!==void 0&&(n.order=i.order),i.offset!==void 0&&(n.offset=i.offset),i.push!==void 0&&(n.push=i.push),i.pull!==void 0&&(n.pull=i.pull),i.flex!==void 0&&(n.flex=i.flex))}return n},Y=e=>{if(e!==void 0)return`${Math.min(24,Math.max(0,e))/24*100}%`},ae=e=>{if(e==null)return;if(typeof e==`number`)return`${e} ${e} auto`;let t=e.trim();if(t)return t===`auto`?`1 1 auto`:t===`none`?`0 0 auto`:/^\d+(\.\d+)?(px|em|rem|vw|vh|%)$/.test(t)?`0 0 ${t}`:t},oe=(e,t,n,r,i)=>{let a={display:`flex`,flexWrap:i===!1?`nowrap`:`wrap`,minWidth:0,justifyContent:J(n),alignItems:te(r),"--rue-grid-gutter-x":F(e)??`0px`,"--rue-grid-gutter-y":F(t)??`0px`},o=q(e,!0),s=q(t,!0);return o&&(a.marginLeft=o,a.marginRight=o),s&&(a.marginTop=s,a.marginBottom=s),a},se=e=>{let t={boxSizing:`border-box`,minWidth:0,paddingLeft:`calc(var(--rue-grid-gutter-x, 0px) / 2)`,paddingRight:`calc(var(--rue-grid-gutter-x, 0px) / 2)`,paddingTop:`calc(var(--rue-grid-gutter-y, 0px) / 2)`,paddingBottom:`calc(var(--rue-grid-gutter-y, 0px) / 2)`};e.order!==void 0&&(t.order=e.order),e.offset&&(t.marginLeft=Y(e.offset)),e.push&&(t.position=`relative`,t.left=Y(e.push)),e.pull&&(t.position=`relative`,t.right=Y(e.pull)),e.span===0&&(t.display=`none`);let n=ae(e.flex);if(n)t.flex=n;else if(e.span!==void 0&&e.span>0){let n=Y(e.span);t.flex=`0 0 ${n}`,t.maxWidth=n}return t},X=e=>{let g=b(`useSetup:0:0`,()=>a(()=>{let{gutter:t,align:n,justify:r,wrap:i,className:a,style:o,children:s,ref:l,...u}=e,d=b(`computed:1:1`,()=>v(()=>K(e.gutter))),f=d,p;return f.get()&&(m(()=>{p=U(()=>{V.value=B()}),V.value=B()}),c(()=>{p&&p()})),{__rue_rest_omit_0:t,__rue_rest_omit_1:n,__rue_rest_omit_2:r,__rue_rest_omit_3:i,__rue_rest_omit_4:a,__rue_rest_omit_5:o,__rue_rest_omit_6:s,__rue_rest_omit_7:l,rest:u,requiresViewport:d,applyRef:t=>{z(e.ref,t)},resolvedClassName:b(`computed:1:2`,()=>v(()=>P(`rue-grid rue-grid-row`,e.className))),resolvedStyle:b(`computed:1:3`,()=>v(()=>{let[t,n]=ne(e.gutter,f.get()?V.value:B());return R(oe(t,n,e.justify,e.align,e.wrap===void 0?!0:e.wrap),e.style)})),stopTracking:p}})),{__rue_rest_omit_0:_,__rue_rest_omit_1:y,__rue_rest_omit_2:x,__rue_rest_omit_3:C,__rue_rest_omit_4:w,__rue_rest_omit_5:T,__rue_rest_omit_6:E,__rue_rest_omit_7:D,rest:O,requiresViewport:k,applyRef:A,resolvedClassName:j,resolvedStyle:M}=g,{stopTracking:N}=g;return l(a=>{let c=o(`div`,a);n(()=>{s(c,O)});let l=S(c,()=>A);d(()=>{l()}),h(c,`data-rue-grid-row`,`true`),n(()=>{u(c,j.get())}),n(()=>{p(c,M.get())});let m=t(`rue:children:anchor`);return i(c,m),n(()=>{let t=e.children;r(()=>f(t,c,m))}),c})},Z=Object.assign(X,{Row:X,Col:e=>{let g=b(`useSetup:0:0:dup1`,()=>a(()=>{let{span:t,order:n,offset:r,push:i,pull:a,flex:o,xs:s,sm:l,md:u,lg:d,xl:f,xxl:p,className:h,style:g,children:_,gutter:y,ref:x,...S}=e,C=b(`computed:1:4`,()=>v(()=>({span:e.span,order:e.order,offset:e.offset,push:e.push,pull:e.pull,flex:e.flex,xs:e.xs,sm:e.sm,md:e.md,lg:e.lg,xl:e.xl,xxl:e.xxl}))),w=C,T=b(`computed:1:5`,()=>v(()=>ee(w.get()))),E=T,D;return E.get()&&(m(()=>{D=U(()=>{V.value=B()}),V.value=B()}),c(()=>{D&&D()})),{__rue_rest_omit_0:t,__rue_rest_omit_1:n,__rue_rest_omit_2:r,__rue_rest_omit_3:i,__rue_rest_omit_4:a,__rue_rest_omit_5:o,__rue_rest_omit_6:s,__rue_rest_omit_7:l,__rue_rest_omit_8:u,__rue_rest_omit_9:d,__rue_rest_omit_10:f,__rue_rest_omit_11:p,__rue_rest_omit_12:h,__rue_rest_omit_13:g,__rue_rest_omit_14:_,__rue_rest_omit_15:y,__rue_rest_omit_16:x,domProps:S,gridProps:C,requiresViewport:T,applyRef:t=>{z(e.ref,t)},resolvedClassName:b(`computed:1:6`,()=>v(()=>P(`rue-grid-col`,e.className))),resolvedStyle:b(`computed:1:7`,()=>v(()=>R(se(ie(w.get(),E.get()?V.value:B())),e.style))),stopTracking:D}})),{__rue_rest_omit_0:_,__rue_rest_omit_1:y,__rue_rest_omit_2:x,__rue_rest_omit_3:C,__rue_rest_omit_4:w,__rue_rest_omit_5:T,__rue_rest_omit_6:E,__rue_rest_omit_7:D,__rue_rest_omit_8:O,__rue_rest_omit_9:k,__rue_rest_omit_10:A,__rue_rest_omit_11:j,__rue_rest_omit_12:M,__rue_rest_omit_13:N,__rue_rest_omit_14:F,__rue_rest_omit_15:I,__rue_rest_omit_16:L,domProps:H,gridProps:W,requiresViewport:G,applyRef:K,resolvedClassName:q,resolvedStyle:J}=g,{stopTracking:te}=g;return l(a=>{let c=o(`div`,a);n(()=>{s(c,H)});let l=S(c,()=>K);d(()=>{l()}),h(c,`data-rue-grid-col`,`true`),n(()=>{u(c,q.get())}),n(()=>{p(c,J.get())});let m=t(`rue:children:anchor`);return i(c,m),n(()=>{let t=e.children;r(()=>f(t,c,m))}),c})}}),Q=a=>l(s=>{let c=o(`div`,s);u(c,`component-preview not-prose text-base-content my-6 lg:my-12`);let d=o(`div`,c);i(c,d),u(d,`flex flex-wrap items-start justify-between gap-3`);let p=o(`div`,d);i(d,p);let m=o(`h2`,p);i(p,m),u(m,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(m,_(`# `));let h=t(`rue:slot:anchor`);i(m,h),n(()=>{let e=a.title;r(()=>f(e,m,h))});let v=t(`rue:slot:anchor`);i(p,v),n(()=>{let s=a.summary?l(()=>{let s=e(),c=o(`p`,s);i(s,c),u(c,`m-0 text-sm opacity-70`);let l=t(`rue:slot:anchor`);return i(c,l),n(()=>{let e=a.summary;r(()=>f(e,c,l))}),s}):``;r(()=>f(s,p,v))});let y=t(`rue:component:anchor`);i(c,y),n(()=>{let e=g(O,{style:`box`,items:[{key:`preview`,label:`预览`},{key:`code`,label:`JSX代码`}],activeKey:a.tab.value,onChange:e=>a.tab.value=e,className:`mb-3 mt-4`});r(()=>f(e,c,y))});let b=t(`rue:slot:anchor`);return i(c,b),n(()=>{let o=a.tab.value===`preview`?a.preview():l(()=>{let o=e(),s=t(`rue:component:anchor`);return i(o,s),n(()=>{let e=g(T,{className:`mt-2`,lang:`tsx`,code:a.code});r(()=>f(e,o,s))}),o});r(()=>f(o,c,b))}),c}),ce=a=>l(s=>{let c=o(`div`,s);u(c,`not-prose overflow-x-auto rounded-box border border-base-300 bg-base-100`);let d=o(`table`,c);i(c,d),u(d,`table table-zebra`);let p=o(`thead`,d);i(d,p);let m=o(`tr`,p);i(p,m);let g=o(`th`,m);i(m,g),i(g,_(`属性`));let v=o(`th`,m);i(m,v),i(v,_(`说明`));let y=o(`th`,m);i(m,y),i(y,_(`类型`));let b=o(`th`,m);i(m,b),i(b,_(`默认值`));let S=o(`tbody`,d);i(d,S);let C=t(`rue:list:start`),w=t(`rue:list:end`);i(S,C),i(S,w);let T=new Map;return n(()=>{T=x({items:a.rows||[],getKey:(e,t)=>e.prop,elements:T,parent:S,before:w,singleRoot:!0,trackIndex:!1,start:C,renderItem:(a,s,c,u,d)=>{f(l(()=>{let s=e(),c=o(`tr`,s);i(s,c),n(()=>{h(c,`key`,String(a.prop))});let l=o(`td`,c);i(c,l);let u=o(`code`,l);i(l,u);let d=t(`rue:slot:anchor`);i(u,d),n(()=>{let e=a.prop;r(()=>f(e,u,d))});let p=o(`td`,c);i(c,p);let m=t(`rue:slot:anchor`);i(p,m),n(()=>{let e=a.description;r(()=>f(e,p,m))});let g=o(`td`,c);i(c,g);let _=o(`code`,g);i(g,_);let v=t(`rue:slot:anchor`);i(_,v),n(()=>{let e=a.type;r(()=>f(e,_,v))});let y=o(`td`,c);i(c,y);let b=o(`code`,y);i(y,b);let x=t(`rue:slot:anchor`);return i(b,x),n(()=>{let e=a.defaultValue;r(()=>f(e,b,x))}),s}),s,c)}})}),c}),$=a=>l(s=>{let c=o(`div`,s);n(()=>{u(c,`rounded-[1.25rem] border border-base-300/70 bg-gradient-to-br from-base-100 via-base-100 to-base-200/80 p-4 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.55)] ${a.className??``}`.trim())});let d=o(`div`,c);i(c,d),u(d,`flex items-start justify-between gap-3`);let p=o(`div`,d);i(d,p);let m=o(`div`,p);i(p,m),u(m,`text-sm font-semibold leading-6`);let h=t(`rue:slot:anchor`);i(m,h),n(()=>{let e=a.title;r(()=>f(e,m,h))});let _=t(`rue:slot:anchor`);i(p,_),n(()=>{let s=a.detail?l(()=>{let s=e(),c=o(`div`,s);i(s,c),u(c,`mt-1 text-xs leading-5 opacity-70`);let l=t(`rue:slot:anchor`);return i(c,l),n(()=>{let e=a.detail;r(()=>f(e,c,l))}),s}):``;r(()=>f(s,p,_))});let v=t(`rue:slot:anchor`);return i(d,v),n(()=>{let o=a.tag?l(()=>{let o=e(),s=t(`rue:component:anchor`);return i(o,s),n(()=>{let e=g(k,{outline:!0,children:a.tag});r(()=>f(e,o,s))}),o}):``;r(()=>f(o,d,v))}),c}),le=[{prop:`gutter`,description:`栅格间距，支持单值、[水平, 垂直]，以及按断点配置的对象写法`,type:`number | string | ResponsiveValue | [ResponsiveValue, ResponsiveValue]`,defaultValue:`-`},{prop:`justify`,description:`主轴对齐方式，覆盖常见的 start / center / end / evenly 语义`,type:`'start' | 'end' | 'center' | 'space-around' | 'space-between' | 'space-evenly'`,defaultValue:`start`},{prop:`align`,description:`交叉轴对齐方式`,type:`'top' | 'middle' | 'bottom' | 'stretch'`,defaultValue:`top`},{prop:`wrap`,description:`是否允许自动换行`,type:`boolean`,defaultValue:`true`},{prop:`className / style`,description:`根节点样式扩展，保留 Rue 一贯的 class 直连能力`,type:`string / Record<string, any>`,defaultValue:`-`}],ue=[{prop:`span`,description:`24 栅格占位数，0 表示隐藏当前列`,type:`number`,defaultValue:`-`},{prop:`offset`,description:`在当前列左侧追加空白栅格`,type:`number`,defaultValue:`0`},{prop:`order`,description:`通过 flex order 调整显示顺序`,type:`number`,defaultValue:`-`},{prop:`push / pull`,description:`相对当前列原位向右或向左推移指定栅格数`,type:`number`,defaultValue:`0`},{prop:`flex`,description:`支持 number、固定宽度字符串、auto 和 none，用于混合弹性布局`,type:`number | string`,defaultValue:`-`},{prop:`xs ~ xxl`,description:`断点覆盖，支持直接传 span 数值，或传入包含 span / order / offset / push / pull / flex 的对象`,type:`number | { span?: number; order?: number; offset?: number; push?: number; pull?: number; flex?: number | string }`,defaultValue:`-`},{prop:`className / style`,description:`列节点样式扩展`,type:`string / Record<string, any>`,defaultValue:`-`}],de=`import { Grid } from '@rue-js/design'
...
</Grid>`,ge=()=>{let{tabBasic:s,tabResponsive:c,tabAlignment:d,tabFlex:p,tabDashboard:m}=b(`useSetup:0:0`,()=>a(()=>({tabBasic:b(`ref:1:0`,()=>y(`preview`)),tabResponsive:b(`ref:1:1`,()=>y(`preview`)),tabAlignment:b(`ref:1:2`,()=>y(`preview`)),tabFlex:b(`ref:1:3`,()=>y(`preview`)),tabDashboard:b(`ref:1:4`,()=>y(`preview`))})));return l(a=>{let h=e(),v=t(`rue:component:anchor`);return i(h,v),f(g(A,{children:l(()=>{let a=e(),l=o(`div`,a);i(a,l),u(l,`max-w-none prose prose-sm md:prose-base`);let h=o(`h1`,l);i(l,h),i(h,_(`Grid 栅格`));let v=o(`p`,l);i(l,v),u(v,`mt-3 mb-3 text-sm`),i(v,_(`Grid 提供接近成熟组件库的 24 栅格 API，用来组织页面骨架、卡片矩阵和左右混排布局。`));let y=o(`p`,l);i(l,y),u(y,`my-3 text-sm opacity-75`),i(y,_(`这一版不照搬其他设计体系的视觉，而是把核心布局能力迁到 Rue 当前的轻量表面体系里：支持 Row / Col、响应式断点、gutter、偏移、顺序和 flex 混排。`));let b=o(`div`,l);i(l,b),u(b,`not-prose mt-4 flex flex-wrap gap-2`);let x=t(`rue:component:anchor`);i(b,x),n(()=>{let e=g(k,{outline:!0,children:`24 Columns`});r(()=>f(e,b,x))});let S=t(`rue:component:anchor`);i(b,S),n(()=>{let e=g(k,{outline:!0,children:`Responsive`});r(()=>f(e,b,S))});let T=t(`rue:component:anchor`);i(b,T),n(()=>{let e=g(k,{outline:!0,children:`Offset & Order`});r(()=>f(e,b,T))});let O=t(`rue:component:anchor`);i(b,O),n(()=>{let e=g(k,{outline:!0,children:`Flex Mix`});r(()=>f(e,b,O))});let A=t(`rue:component:anchor`);i(l,A),n(()=>{let e=g(Q,{title:`基础 24 栅格`,summary:`先用最直接的 span 心智搭建信息密度，再往上叠加响应式与语义卡片。`,tab:s,code:de,preview:()=>C(`div`,{className:`space-y-5`,children:[w(D,{className:`overflow-hidden bg-base-100 shadow-sm`,children:w(D.Body,{className:`gap-4`,children:C(Z,{gutter:[16,16],children:[w(Z.Col,{span:6,children:w($,{title:`span 6`,detail:`季度销售`,tag:`25%`})}),w(Z.Col,{span:6,children:w($,{title:`span 6`,detail:`新增用户`,tag:`25%`,className:`from-info/8 to-base-100`})}),w(Z.Col,{span:6,children:w($,{title:`span 6`,detail:`留存趋势`,tag:`25%`,className:`from-success/8 to-base-100`})}),w(Z.Col,{span:6,children:w($,{title:`span 6`,detail:`投放效率`,tag:`25%`,className:`from-warning/10 to-base-100`})})]})})}),C(Z,{gutter:[16,16],children:[w(Z.Col,{span:8,children:w($,{title:`span 8`,detail:`三栏内容区`,tag:`33%`})}),w(Z.Col,{span:8,children:w($,{title:`span 8`,detail:`更适合导航+内容+侧栏`,tag:`33%`,className:`from-primary/8 to-base-100`})}),w(Z.Col,{span:8,children:w($,{title:`span 8`,detail:`与 Card、Stat 组合最常用`,tag:`33%`,className:`from-secondary/8 to-base-100`})})]})]})});r(()=>f(e,l,A))});let j=t(`rue:component:anchor`);i(l,j),n(()=>{let e=g(Q,{title:`响应式 gutter 与断点覆盖`,summary:`gutter 可以按断点变化，Col 也可以在 xs~xxl 分别覆盖 span 和布局参数。`,tab:c,code:fe,preview:()=>C(`div`,{className:`space-y-4`,children:[w(`div`,{className:`not-prose rounded-[1.5rem] border border-dashed border-base-300 bg-base-100/80 p-4 text-sm opacity-75`,children:`缩放窗口时，这组三列会从一列堆叠，逐步过渡到两列和三列，同时间距从紧凑切到宽松。`}),C(Z,{gutter:[{xs:8,md:24},{xs:8,md:24}],children:[w(Z.Col,{xs:24,sm:12,lg:8,children:w($,{title:`Hero 模块`,detail:`xs=24, sm=12, lg=8`,tag:`adaptive`,className:`from-primary/10 via-base-100 to-base-200`})}),w(Z.Col,{xs:24,sm:12,lg:8,children:w($,{title:`Insights`,detail:`xs=24, sm=12, lg=8`,tag:`adaptive`,className:`from-info/10 via-base-100 to-base-200`})}),w(Z.Col,{xs:24,lg:8,children:w($,{title:`Ops Panel`,detail:`xs=24, lg=8`,tag:`adaptive`,className:`from-success/10 via-base-100 to-base-200`})})]})]})});r(()=>f(e,l,j))});let M=t(`rue:component:anchor`);i(l,M),n(()=>{let e=g(Q,{title:`对齐、偏移与顺序`,summary:`同一套 Grid 既能做规则矩阵，也能做营销位或时间线这种非对称排布。`,tab:d,code:pe,preview:()=>C(`div`,{className:`space-y-6`,children:[w(D,{className:`bg-base-100 shadow-sm`,children:w(D.Body,{className:`gap-4`,children:C(Z,{gutter:[16,16],justify:`space-between`,align:`bottom`,children:[w(Z.Col,{span:5,children:w($,{title:`Top`,detail:`高度较小`,tag:`A`,className:`h-28`})}),w(Z.Col,{span:5,children:w($,{title:`Middle`,detail:`通过 align=bottom 对齐底边`,tag:`B`,className:`h-40 from-warning/10 to-base-100`})}),w(Z.Col,{span:5,children:w($,{title:`Bottom`,detail:`适合比较型面板`,tag:`C`,className:`h-32 from-secondary/8 to-base-100`})})]})})}),C(Z,{gutter:[16,16],children:[w(Z.Col,{span:6,offset:6,children:w($,{title:`offset 6`,detail:`给主内容留白`,tag:`offset`})}),w(Z.Col,{span:6,order:3,children:w($,{title:`order 3`,detail:`视觉顺序后移`,tag:`order`,className:`from-info/8 to-base-100`})}),w(Z.Col,{span:6,order:2,children:w($,{title:`order 2`,detail:`视觉顺序前置`,tag:`order`,className:`from-success/8 to-base-100`})})]})]})});r(()=>f(e,l,M))});let N=t(`rue:component:anchor`);i(l,N),n(()=>{let e=g(Q,{title:`Flex 混排与不换行轨道`,summary:`当 24 栅格不足以表达固定边栏 + 弹性主内容时，直接切到 flex 语义。`,tab:p,code:me,preview:()=>C(`div`,{className:`space-y-6`,children:[C(Z,{gutter:16,align:`stretch`,children:[w(Z.Col,{flex:`280px`,children:w($,{title:`Fixed rail`,detail:`280px 固定宽度，适合过滤器与导航`,tag:`280px`,className:`h-full from-base-200 to-base-100`})}),w(Z.Col,{flex:`auto`,children:w($,{title:`Fluid canvas`,detail:`auto 吃掉剩余空间，适合主编辑区`,tag:`auto`,className:`h-full from-primary/8 to-base-100`})}),w(Z.Col,{flex:`120px`,children:w($,{title:`Ops`,detail:`固定操作条`,tag:`120px`,className:`h-full from-warning/10 to-base-100`})})]}),C(Z,{gutter:12,wrap:!1,children:[w(Z.Col,{flex:`180px`,children:w($,{title:`No wrap`,detail:`水平工具带`,tag:`rail`})}),w(Z.Col,{flex:`180px`,children:w($,{title:`Keep inline`,detail:`不允许自动换行`,tag:`rail`,className:`from-info/8 to-base-100`})}),w(Z.Col,{flex:`180px`,children:w($,{title:`Sticky group`,detail:`适合顶部命令条`,tag:`rail`,className:`from-secondary/8 to-base-100`})})]})]})});r(()=>f(e,l,N))});let P=t(`rue:component:anchor`);i(l,P),n(()=>{let e=g(Q,{title:`仪表盘实战布局`,summary:`Grid 不是只用来排彩色方块，更适合和 Card、Badge、Button 组合成真实页面骨架。`,tab:m,code:he,preview:()=>C(Z,{gutter:[20,20],children:[w(Z.Col,{xs:24,xl:16,children:w(D,{className:`overflow-hidden bg-base-100 shadow-sm`,children:C(D.Body,{className:`gap-5`,children:[C(`div`,{className:`flex flex-wrap items-center justify-between gap-3`,children:[C(`div`,{children:[w(`div`,{className:`text-sm font-semibold`,children:`Growth cockpit`}),w(`div`,{className:`mt-1 text-sm opacity-70`,children:`一块主画布里继续嵌套 Grid，拆出指标和趋势卡。`})]}),C(`div`,{className:`flex flex-wrap gap-2`,children:[w(k,{outline:!0,children:`Live`}),w(k,{outline:!0,children:`Q2`})]})]}),C(Z,{gutter:[16,16],children:[w(Z.Col,{xs:24,md:12,children:w($,{title:`GMV`,detail:`¥ 4,230,000`,tag:`+18%`,className:`from-primary/10 via-base-100 to-base-200 h-full`})}),w(Z.Col,{xs:24,md:12,children:w($,{title:`Retention`,detail:`71.4%`,tag:`+4.8pt`,className:`from-success/10 via-base-100 to-base-200 h-full`})}),w(Z.Col,{xs:24,children:C(`div`,{className:`rounded-[1.25rem] border border-base-300/70 bg-gradient-to-br from-base-100 via-base-100 to-base-200/80 p-5 shadow-[0_24px_60px_-42px_rgba(15,23,42,0.55)]`,children:[C(`div`,{className:`flex flex-wrap items-center justify-between gap-3`,children:[C(`div`,{children:[w(`div`,{className:`text-sm font-semibold`,children:`Campaign timeline`}),w(`div`,{className:`mt-1 text-xs leading-5 opacity-70`,children:`用整行展示跨模块趋势和长内容。`})]}),w(E,{color:`primary`,size:`sm`,children:`查看明细`})]}),C(`div`,{className:`mt-4 grid gap-3 md:grid-cols-3`,children:[w(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`启动 6 个投放实验`}),w(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`完成落地页 AB 版本替换`}),w(`div`,{className:`rounded-box bg-base-200/70 p-4 text-sm`,children:`同步 CRM 标签到投放人群`})]})]})})]})]})})}),w(Z.Col,{xs:24,xl:8,children:w(D,{className:`bg-base-100 shadow-sm`,children:C(D.Body,{className:`gap-4`,children:[C(`div`,{className:`flex items-center justify-between gap-3`,children:[C(`div`,{children:[w(`div`,{className:`text-sm font-semibold`,children:`Ops queue`}),w(`div`,{className:`mt-1 text-xs opacity-70`,children:`右侧侧栏保持更紧凑的信息节奏。`})]}),w(k,{outline:!0,children:`7 items`})]}),C(`div`,{className:`space-y-3`,children:[w($,{title:`素材审批`,detail:`还剩 2 项待确认`,tag:`Today`,className:`from-warning/10 to-base-100`}),w($,{title:`会员分层`,detail:`等待 CRM 回传标签`,tag:`Sync`,className:`from-info/10 to-base-100`}),w($,{title:`报表快照`,detail:`18:00 自动归档`,tag:`Auto`,className:`from-secondary/10 to-base-100`})]})]})})})]})});r(()=>f(e,l,P))});let F=o(`div`,l);i(l,F),u(F,`component-preview not-prose text-base-content my-8 lg:my-12`);let I=o(`h2`,F);i(F,I),u(I,`component-preview-title mt-2 mb-1 text-lg font-semibold`),i(I,_(`# API`));let L=o(`p`,F);i(F,L),u(L,`m-0 text-sm opacity-70`),i(L,_(`默认导出的 Grid 可直接当作 Row 使用，也可以通过 Grid.Row / Grid.Col 显式书写。`));let R=o(`div`,l);i(l,R),u(R,`not-prose space-y-8`);let z=o(`div`,R);i(R,z);let B=o(`h3`,z);i(z,B),u(B,`mb-3 text-base font-semibold`),i(B,_(`Grid / Grid.Row`));let V=t(`rue:component:anchor`);i(z,V),n(()=>{let e=g(ce,{rows:le});r(()=>f(e,z,V))});let H=o(`div`,R);i(R,H);let U=o(`h3`,H);i(H,U),u(U,`mb-3 text-base font-semibold`),i(U,_(`Grid.Col`));let W=t(`rue:component:anchor`);return i(H,W),n(()=>{let e=g(ce,{rows:ue});r(()=>f(e,H,W))}),a})}),h,v),h})};export{ge as default};