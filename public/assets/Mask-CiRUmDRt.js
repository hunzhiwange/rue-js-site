...
<Mask shape="circle" src="${N}" alt="circle" size="md" bordered />`});f(()=>s(e,a,S))});let w=p(`rue:component:anchor`);e(a,w),t(()=>{let e=d(U,{title:`Star variants`,summary:`展示星形与粗星形示例，增加 ring 和 hover，适合头像墙或精选内容。`,tab:m,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap gap-5`,children:L.map(e=>v(M,{shape:e,src:N,alt:e,size:`lg`,ring:!0,shadow:!0,interactive:!0},e))})}),code:`<Mask shape="star" src="${N}" alt="star" size="lg" ring shadow interactive />
<Mask shape="star-2" src="${N}" alt="star-2" size="lg" ring shadow interactive />`});f(()=>s(e,a,w))});let T=p(`rue:component:anchor`);e(a,T),t(()=>{let e=d(U,{title:`Triangle variants`,summary:`展示四向三角形示例，并通过统一尺寸让方向差异更好观察。`,tab:h,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap gap-5`,children:R.map(e=>v(M,{shape:e,src:N,alt:e,size:`lg`,bordered:!0,shadow:!0},e))})}),code:`<Mask shape="triangle" src="${N}" alt="triangle" size="lg" bordered shadow />
...
<Mask shape="triangle-4" src="${N}" alt="triangle-4" size="lg" bordered shadow />`});f(()=>s(e,a,T))});let E=p(`rue:component:anchor`);e(a,E),t(()=>{let e=d(U,{title:`Half modifiers and arbitrary host`,summary:`展示 half modifier 与任意宿主演示，并补上 start / end 语义别名。`,tab:_,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body flex flex-wrap items-center gap-6`,children:[v(M,{shape:`star`,half:`1`,src:N,alt:`star half 1`,size:`lg`,ring:!0}),v(M,{shape:`star`,half:`2`,src:N,alt:`star half 2`,size:`lg`,ring:!0}),v(M,{shape:`diamond`,half:`start`,src:N,alt:`diamond start`,size:`lg`,bordered:!0}),v(M,{as:`div`,shape:`diamond`,tone:`primary`,size:`lg`,ring:!0,shadow:!0,className:`grid place-content-center text-sm font-semibold uppercase tracking-[0.2em]`,"data-testid":`mask-host-demo`,children:`Host`})]})}),code:`<Mask shape="star" half="1" src="${N}" alt="star half 1" size="lg" ring />
...
>
  Host
</Mask>`});f(()=>s(e,a,E))});let D=p(`rue:component:anchor`);e(a,D),t(()=>{let e=d(U,{title:`Semantic sizes`,summary:`尺寸别名适合常见头像和封面场景，不必每次都手写宽高 class。`,tab:b,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body flex flex-wrap items-end gap-5`,children:z.map(e=>y(`div`,{className:`flex flex-col items-center gap-3 text-xs uppercase tracking-[0.18em] opacity-80`,children:[v(M,{shape:`circle`,src:N,alt:e,size:e,ring:!0}),v(`span`,{children:e})]},e))})}),code:`<Mask shape="circle" src="${N}" alt="xs" size="xs" ring />
...
<Mask shape="circle" src="${N}" alt="2xl" size="2xl" ring />`});f(()=>s(e,a,D))});let O=p(`rue:component:anchor`);e(a,O),t(()=>{let e=d(U,{title:`Fit modes`,summary:`fit 语义让宽图、竖图和封面图都能直接得到明确的裁切策略。`,tab:x,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:v(`div`,{className:`card-body grid gap-6 md:grid-cols-3`,children:B.map(e=>y(`div`,{className:`space-y-3`,children:[v(`div`,{className:`text-xs font-semibold uppercase tracking-[0.18em] opacity-70`,children:e.label}),v(`div`,{className:`rounded-box bg-base-200 p-4`,children:v(M,{shape:`hexagon-2`,src:e.src,alt:e.label,size:`xl`,fit:e.fit,bordered:!0,className:`mx-auto`})})]},e.label))})}),code:`<Mask shape="hexagon-2" src="${P}" alt="cover" size="xl" fit="cover" bordered className="mx-auto" />
<Mask shape="hexagon-2" src="${F}" alt="contain" size="xl" fit="contain" bordered className="mx-auto" />
<Mask shape="hexagon-2" src="${P}" alt="fill" size="xl" fit="fill" bordered className="mx-auto" />`});f(()=>s(e,a,O))});let k=p(`rue:component:anchor`);e(a,k),t(()=>{let e=d(U,{title:`Tone surfaces`,summary:`tone、ring、shadow 组合后，Mask 也能承担数字徽记、内容牌和亮点卡片的职责。`,tab:C,preview:()=>v(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body gap-6`,children:[v(`div`,{className:`flex flex-wrap gap-4`,children:V.map(e=>v(M,{as:`div`,shape:`squircle`,tone:e.tone,size:`md`,ring:!0,className:`grid place-content-center text-center text-xs font-semibold uppercase tracking-[0.18em]`,children:e.label},e.label))}),y(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[v(M,{as:`div`,shape:`hexagon`,tone:`secondary`,size:`xl`,ring:!0,shadow:!0,interactive:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:y(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-3xl font-black`,children:`24`}),v(`div`,{className:`text-xs uppercase tracking-[0.22em] opacity-80`,children:`Launches`})]})}),v(M,{as:`div`,shape:`diamond`,tone:`accent`,size:`xl`,ring:!0,shadow:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:y(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-sm font-semibold uppercase tracking-[0.18em]`,children:`Featured`}),v(`div`,{className:`text-xs opacity-80`,children:`Rue Studio`})]})}),v(M,{as:`div`,shape:`circle`,tone:`success`,size:`xl`,ring:!0,shadow:!0,className:`mx-auto grid place-content-center p-6 text-center`,children:y(`div`,{className:`space-y-1`,children:[v(`div`,{className:`text-2xl font-black`,children:`98%`}),v(`div`,{className:`text-xs uppercase tracking-[0.18em] opacity-80`,children:`Approval`})]})})]})]})}),code:`<div className="flex flex-wrap gap-4">
  <Mask
    as="div"
    shape="squircle"
    tone="base"
