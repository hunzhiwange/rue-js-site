import{G as e,H as t,K as n,W as r,at as i,d as a,kt as o,l as s,q as c,t as l,tt as u,xt as d}from"./vapor-runtime-BAZOdMd8.js";import{t as f}from"./createHomeSplitExamplePage-BUuBaUet.js";var p=e=>a(a=>{let c=n(`div`,a);u(c,`box`),o(()=>{i(c,{border:`1px solid #ddd`,padding:`12px`,marginBottom:`12px`,background:e.background})});let l=n(`h3`,c);t(c,l),i(l,{margin:`0 0 8px`});let f=r(`rue:slot:anchor`);t(l,f),o(()=>{let t=e.title;d(()=>s(t,l,f))});let p=n(`div`,c);t(c,p),u(p,`content`);let m=r(`rue:children:anchor`);return t(p,m),o(()=>{let t=e.children;d(()=>s(t,p,m))}),c}),m=f({title:`基础 children Box`,source:`import { type FC } from '@rue-js/rue'
