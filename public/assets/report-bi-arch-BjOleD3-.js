...
`,ne=e=>e>=1e3?`${(e/1e3).toFixed(1)}K`:String(e),re=e=>e<1?`${(e*1e3).toFixed(0)}μs`:`${e.toFixed(1)}ms`,ie={mysql:`mysql`,pg:`pg`,ch:`ch`,redis:`redis`,api:`api`,gql:`gql`},ae={mysql:`sql`,pg:`sql`,ch:`olap`,redis:`cache`,api:`http`,gql:`http`},oe=e=>e<5?`fast`:e<30?`med`:`slow`,A=()=>l(v=>{let T=t(),A=r(`style`,T);i(T,A),f(()=>{a(A,te)});let j=r(`div`,T);i(T,j),n(j,`bi-scope bi-page`);let M=r(`section`,j);i(j,M),n(M,`bi-hero bi-card`);let N=r(`div`,M);i(M,N);let P=r(`p`,N);i(N,P),n(P,`bi-kicker`),i(P,o(`BI Platform Architecture / Realtime Monitor`));let se=r(`h1`,N);i(N,se),i(se,o(`多源异构数据接入架构，实时驱动业务决策`));let F=r(`p`,N);i(N,F),n(F,`bi-hero-desc`),i(F,o(`统一接入 MySQL、PostgreSQL、ClickHouse、Redis Cluster、REST API、GraphQL 等六大数据源， 通过 CDC 实时采集 + ETL 批量清洗的混合管道，将数据经过 ODS → DWD → DWS → ADS 四层治理后， 对外提供毫秒级查询服务。当前集群整体 QPS 达 360K+，平均响应延迟 6.8ms。`));let I=r(`div`,N);i(N,I),n(I,`bi-tags`);let L=r(`span`,I);i(I,L),n(L,`bi-tag`);let ce=r(`span`,L);i(L,ce),n(ce,`dot`),i(L,o(`6 数据源在线`));let R=r(`span`,I);i(I,R),n(R,`bi-tag`),i(R,o(`CDC 实时同步`));let z=r(`span`,I);i(I,z),n(z,`bi-tag`),i(z,o(`ETL 批处理`));let le=r(`span`,I);i(I,le),n(le,`bi-tag`),i(le,o(`四层仓储存档`));let ue=r(`span`,I);i(I,ue),n(ue,`bi-tag`),i(ue,o(`GraphQL + REST 双协议`));let B=r(`div`,M);i(M,B),n(B,`bi-metrics-grid`);let de=e(`rue:list:start`),fe=e(`rue:list:end`);i(B,de),i(B,fe);let pe=new Map;f(()=>{pe=m({items:_||[],getKey:(e,t)=>e.label,elements:pe,parent:B,before:fe,singleRoot:!0,trackIndex:!1,start:de,renderItem:(o,c,m,h,g)=>{d(l(()=>{let c=t(),l=r(`div`,c);i(c,l),f(()=>{s(l,`key`,String(o.label))}),n(l,`bi-metric-card`);let m=r(`div`,l);i(l,m),n(m,`bi-metric-label`);let h=e(`rue:slot:anchor`);i(m,h),f(()=>{let e=o.label;u(()=>d(e,m,h))});let g=r(`div`,l);i(l,g),n(g,`bi-metric-value`);let _=p(g);i(g,_),f(()=>{a(_,o.value)});let v=r(`span`,l);i(l,v),f(()=>{n(v,String(`bi-metric-delta ${o.delta.startsWith(`+`)&&o.label===`异常告警`?`down`:`up`}`))});let y=e(`rue:slot:anchor`);return i(v,y),f(()=>{let e=o.delta;u(()=>d(e,v,y))}),c}),c,m)}})});let V=r(`section`,j);i(j,V),n(V,`bi-card`);let me=r(`div`,V);i(V,me),c(me,{padding:`28px 28px 0`});let H=r(`div`,me);i(me,H),n(H,`bi-section-title`);let he=r(`div`,H);i(H,he);let ge=r(`p`,he);i(he,ge),n(ge,`bi-eyebrow`),i(ge,o(`Data Sources`));let _e=r(`h2`,he);i(he,_e),i(_e,o(`数据源连接池`));let ve=r(`p`,H);i(H,ve),i(ve,o(`实时监控六大异构数据源的连接状态、QPS、延迟与健康度。`));let ye=r(`div`,V);i(V,ye),n(ye,`bi-sources-grid`);let be=e(`rue:list:start`),xe=e(`rue:list:end`);i(ye,be),i(ye,xe);let Se=new Map;f(()=>{Se=m({items:h||[],getKey:(e,t)=>e.id,elements:Se,parent:ye,before:xe,singleRoot:!0,trackIndex:!1,start:be,renderItem:(h,g,_,v,y)=>{d(l(()=>{let g=t(),_=r(`div`,g);i(g,_),f(()=>{s(_,`key`,String(h.id))}),n(_,`bi-src`);let v=r(`div`,_);i(_,v),n(v,`bi-src-head`);let y=r(`div`,v);i(v,y),f(()=>{n(y,String(`bi-src-icon ${ie[h.id]}`))});let b=e(`rue:slot:anchor`);i(y,b),f(()=>{let e=h.icon;u(()=>d(e,y,b))});let x=r(`div`,v);i(v,x),c(x,{flex:1});let S=r(`div`,x);i(x,S),c(S,{display:`flex`,alignItems:`center`,gap:8});let C=r(`span`,S);i(S,C),n(C,`bi-src-name`);let w=e(`rue:slot:anchor`);i(C,w),f(()=>{let e=h.name;u(()=>d(e,C,w))});let T=r(`span`,S);i(S,T),f(()=>{n(T,String(`bi-status-dot ${h.status}`))});let E=r(`span`,x);i(x,E),f(()=>{n(E,String(`bi-src-type ${ae[h.id]}`))});let D=e(`rue:slot:anchor`);i(E,D),f(()=>{let e=h.type;u(()=>d(e,E,D))});let O=r(`div`,_);i(_,O),n(O,`bi-src-stats`);let k=r(`div`,O);i(O,k);let ee=r(`div`,k);i(k,ee),n(ee,`bi-src-stat-label`),i(ee,o(`QPS`));let te=r(`div`,k);i(k,te),n(te,`bi-src-stat-value`);let oe=e(`rue:slot:anchor`);i(te,oe),f(()=>{let e=ne(h.qps);u(()=>d(e,te,oe))});let A=r(`div`,O);i(O,A);let j=r(`div`,A);i(A,j),n(j,`bi-src-stat-label`),i(j,o(`延迟`));let M=r(`div`,A);i(A,M),n(M,`bi-src-stat-value`);let N=e(`rue:slot:anchor`);i(M,N),f(()=>{let e=re(h.latency);u(()=>d(e,M,N))});let P=r(`div`,O);i(O,P);let se=r(`div`,P);i(P,se),n(se,`bi-src-stat-label`),i(se,o(`可用率`));let F=r(`div`,P);i(P,F),n(F,`bi-src-stat-value`);let I=e(`rue:slot:anchor`);i(F,I),f(()=>{let e=h.uptime;u(()=>d(e,F,I))});let L=r(`div`,_);i(_,L),n(L,`bi-src-conn-bar`);let ce=r(`div`,L);i(L,ce),f(()=>{n(ce,String(`bi-src-conn-fill ${ie[h.id]}`))}),f(()=>{c(ce,{width:`${h.connections/h.maxConn*100}%`})});let R=r(`div`,_);i(_,R),c(R,{marginTop:6,display:`flex`,justifyContent:`space-between`});let z=r(`span`,R);i(R,z),n(z,`bi-src-stat-unit`);let le=e(`rue:slot:anchor`);i(z,le),f(()=>{let e=h.connections;u(()=>d(e,z,le))}),i(z,o(` / `));let ue=e(`rue:slot:anchor`);i(z,ue),f(()=>{let e=h.maxConn;u(()=>d(e,z,ue))}),i(z,o(` 连接`));let B=r(`div`,_);i(_,B),n(B,`bi-src-dbs`);let de=e(`rue:list:start`),fe=e(`rue:list:end`);i(B,de),i(B,fe);let pe=new Map;return f(()=>{pe=m({items:h.databases||[],getKey:(e,t)=>e,elements:pe,parent:B,before:fe,singleRoot:!0,trackIndex:!1,start:de,renderItem:(e,o,c,u,m)=>{d(l(()=>{let o=t(),c=r(`span`,o);i(o,c),f(()=>{s(c,`key`,String(e))}),n(c,`bi-src-db`);let l=p(c);return i(c,l),f(()=>{a(l,e)}),o}),o,c)}})}),g}),g,_)}})});let U=r(`section`,j);i(j,U),n(U,`bi-card`);let Ce=r(`div`,U);i(U,Ce),c(Ce,{padding:`28px 28px 0`});let W=r(`div`,Ce);i(Ce,W),n(W,`bi-section-title`);let we=r(`div`,W);i(W,we);let Te=r(`p`,we);i(we,Te),n(Te,`bi-eyebrow`),i(Te,o(`Data Pipeline`));let Ee=r(`h2`,we);i(we,Ee),i(Ee,o(`数据处理管线`));let De=r(`p`,W);i(W,De),i(De,o(`五阶段数据生命周期：从采集到可视化的全链路自动化。`));let Oe=r(`div`,U);i(U,Oe),n(Oe,`bi-pipeline`);let ke=e(`rue:list:start`),Ae=e(`rue:list:end`);i(Oe,ke),i(Oe,Ae);let je=new Map;f(()=>{je=m({items:g||[],getKey:(e,t)=>e.id,elements:je,parent:Oe,before:Ae,singleRoot:!0,start:ke,renderItem:(o,c,h,_,v)=>{d(l(()=>{let c=t(),h=r(`div`,c);i(c,h),f(()=>{s(h,`key`,String(o.id))}),n(h,`bi-pipe-stage`);let _=r(`div`,h);i(h,_),n(_,`bi-pipe-icon`);let y=e(`rue:slot:anchor`);i(_,y),f(()=>{let e=o.icon;u(()=>d(e,_,y))});let b=r(`div`,h);i(h,b),n(b,`bi-pipe-name`);let x=e(`rue:slot:anchor`);i(b,x),f(()=>{let e=o.name;u(()=>d(e,b,x))});let S=r(`div`,h);i(h,S),n(S,`bi-pipe-desc`);let C=e(`rue:slot:anchor`);i(S,C),f(()=>{let e=o.desc;u(()=>d(e,S,C))});let w=r(`div`,h);i(h,w),n(w,`bi-pipe-items`);let T=e(`rue:list:start`),E=e(`rue:list:end`);i(w,T),i(w,E);let D=new Map;f(()=>{D=m({items:o.items||[],getKey:(e,t)=>e,elements:D,parent:w,before:E,singleRoot:!0,trackIndex:!1,start:T,renderItem:(e,o,c,u,m)=>{d(l(()=>{let o=t(),c=r(`span`,o);i(o,c),f(()=>{s(c,`key`,String(e))}),n(c,`bi-pipe-item`);let l=p(c);return i(c,l),f(()=>{a(l,e)}),o}),o,c)}})});let O=e(`rue:slot:anchor`);return i(h,O),f(()=>{let e=v<g.length-1?l(()=>{let e=t(),a=r(`div`,e);return i(e,a),n(a,`bi-pipe-arrow`),e}):``;u(()=>d(e,h,O))}),c}),c,h)}})});let G=r(`section`,j);i(j,G),n(G,`bi-chart-section`);let K=r(`article`,G);i(G,K),n(K,`bi-card bi-chart-card`);let Me=r(`div`,K);i(K,Me),n(Me,`bi-section-title`);let Ne=r(`div`,Me);i(Me,Ne);let Pe=r(`p`,Ne);i(Ne,Pe),n(Pe,`bi-eyebrow`),i(Pe,o(`Latency Monitor`));let Fe=r(`h2`,Ne);i(Ne,Fe),i(Fe,o(`24H 延迟趋势`));let Ie=r(`div`,K);i(K,Ie),n(Ie,`bi-chart-shell`);let q=r(`svg`,Ie);i(Ie,q),f(()=>{s(q,`viewBox`,String(`0 0 ${S} ${C}`))}),n(q,`bi-chart-svg`),s(q,`role`,`img`),s(q,`aria-label`,`24小时延迟趋势图`);let Le=r(`defs`,q);i(q,Le);let J=r(`linearGradient`,Le);i(Le,J),s(J,`id`,`biLatMysql`),s(J,`x1`,`0`),s(J,`x2`,`0`),s(J,`y1`,`0`),s(J,`y2`,`1`);let Re=r(`stop`,J);i(J,Re),s(Re,`offset`,`0%`),s(Re,`stopColor`,`var(--b-mysql)`),s(Re,`stopOpacity`,`0.25`);let ze=r(`stop`,J);i(J,ze),s(ze,`offset`,`100%`),s(ze,`stopColor`,`var(--b-mysql)`),s(ze,`stopOpacity`,`0`);let Y=r(`linearGradient`,Le);i(Le,Y),s(Y,`id`,`biLatApi`),s(Y,`x1`,`0`),s(Y,`x2`,`0`),s(Y,`y1`,`0`),s(Y,`y2`,`1`);let Be=r(`stop`,Y);i(Y,Be),s(Be,`offset`,`0%`),s(Be,`stopColor`,`var(--b-api)`),s(Be,`stopOpacity`,`0.2`);let Ve=r(`stop`,Y);i(Y,Ve),s(Ve,`offset`,`100%`),s(Ve,`stopColor`,`var(--b-api)`),s(Ve,`stopOpacity`,`0`);let He=e(`rue:list:start`),Ue=e(`rue:list:end`);i(q,He),i(q,Ue);let We=new Map;f(()=>{We=m({items:[0,.25,.5,.75,1],getKey:(e,t)=>e,elements:We,parent:q,before:Ue,singleRoot:!0,trackIndex:!1,start:He,renderItem:(e,c,u,m,h)=>{d(l(()=>{let c=t(),l=w.t+E-e*E,u=r(`g`,c);i(c,u),f(()=>{s(u,`key`,String(e))});let d=r(`line`,u);i(u,d),f(()=>{s(d,`x1`,String(w.l))}),f(()=>{s(d,`y1`,String(l))}),f(()=>{s(d,`x2`,String(S-w.r))}),f(()=>{s(d,`y2`,String(l))}),n(d,`bi-grid-line`);let m=r(`text`,u);i(u,m),f(()=>{s(m,`x`,String(w.l+4))}),f(()=>{s(m,`y`,String(l-6))}),n(m,`bi-grid-label`);let h=p(m);return i(m,h),f(()=>{a(h,(D*e).toFixed(0))}),i(m,o(`ms`)),c}),c,u)}})});let Ge=r(`path`,q);i(q,Ge),f(()=>{s(Ge,`d`,String(`${k(`mysqlY`)} L ${O[O.length-1].x} ${w.t+E} L ${O[0].x} ${w.t+E} Z`))}),s(Ge,`fill`,`url(#biLatMysql)`);let Ke=r(`path`,q);i(q,Ke),f(()=>{s(Ke,`d`,String(k(`apiY`)))}),n(Ke,`bi-line-path`),s(Ke,`stroke`,`var(--b-api)`);let qe=r(`path`,q);i(q,qe),f(()=>{s(qe,`d`,String(k(`mysqlY`)))}),n(qe,`bi-line-path`),s(qe,`stroke`,`var(--b-mysql)`);let Je=r(`path`,q);i(q,Je),f(()=>{s(Je,`d`,String(k(`pgY`)))}),n(Je,`bi-line-path`),s(Je,`stroke`,`var(--b-pg)`);let Ye=r(`path`,q);i(q,Ye),f(()=>{s(Ye,`d`,String(k(`redisY`)))}),n(Ye,`bi-line-path`),s(Ye,`stroke`,`var(--b-redis)`);let Xe=e(`rue:list:start`),Ze=e(`rue:list:end`);i(q,Xe),i(q,Ze);let Qe=new Map;f(()=>{Qe=m({items:O||[],getKey:(e,t)=>e.label,elements:Qe,parent:q,before:Ze,singleRoot:!0,trackIndex:!1,start:Xe,renderItem:(e,o,c,u,m)=>{d(l(()=>{let o=t(),c=r(`g`,o);i(o,c),f(()=>{s(c,`key`,String(e.label))});let l=r(`text`,c);i(c,l),f(()=>{s(l,`x`,String(e.x))}),f(()=>{s(l,`y`,String(C-8))}),s(l,`textAnchor`,`middle`),n(l,`bi-axis-label`);let u=p(l);i(l,u),f(()=>{a(u,e.label)});let d=r(`circle`,c);i(c,d),f(()=>{s(d,`cx`,String(e.x))}),f(()=>{s(d,`cy`,String(e.mysqlY))}),s(d,`r`,`3.5`),s(d,`fill`,`var(--b-mysql)`),s(d,`opacity`,`0.85`);let m=r(`circle`,c);i(c,m),f(()=>{s(m,`cx`,String(e.x))}),f(()=>{s(m,`cy`,String(e.pgY))}),s(m,`r`,`3.5`),s(m,`fill`,`var(--b-pg)`),s(m,`opacity`,`0.85`);let h=r(`circle`,c);i(c,h),f(()=>{s(h,`cx`,String(e.x))}),f(()=>{s(h,`cy`,String(e.redisY))}),s(h,`r`,`3.5`),s(h,`fill`,`var(--b-redis)`),s(h,`opacity`,`0.85`);let g=r(`circle`,c);return i(c,g),f(()=>{s(g,`cx`,String(e.x))}),f(()=>{s(g,`cy`,String(e.apiY))}),s(g,`r`,`3.5`),s(g,`fill`,`var(--b-api)`),s(g,`opacity`,`0.85`),o}),o,c)}})});let X=r(`g`,q);i(q,X),f(()=>{s(X,`transform`,String(`translate(${S-w.r-100}, ${w.t+4})`))});let $e=r(`circle`,X);i(X,$e),s($e,`cx`,`0`),s($e,`cy`,`0`),s($e,`r`,`4`),s($e,`fill`,`var(--b-mysql)`);let et=r(`text`,X);i(X,et),s(et,`x`,`10`),s(et,`y`,`4`),n(et,`bi-axis-label`),i(et,o(`MySQL`));let tt=r(`circle`,X);i(X,tt),s(tt,`cx`,`50`),s(tt,`cy`,`0`),s(tt,`r`,`4`),s(tt,`fill`,`var(--b-pg)`);let nt=r(`text`,X);i(X,nt),s(nt,`x`,`60`),s(nt,`y`,`4`),n(nt,`bi-axis-label`),i(nt,o(`PG`));let rt=r(`circle`,X);i(X,rt),s(rt,`cx`,`0`),s(rt,`cy`,`16`),s(rt,`r`,`4`),s(rt,`fill`,`var(--b-redis)`);let it=r(`text`,X);i(X,it),s(it,`x`,`10`),s(it,`y`,`20`),n(it,`bi-axis-label`),i(it,o(`Redis`));let at=r(`circle`,X);i(X,at),s(at,`cx`,`50`),s(at,`cy`,`16`),s(at,`r`,`4`),s(at,`fill`,`var(--b-api)`);let ot=r(`text`,X);i(X,ot),s(ot,`x`,`60`),s(ot,`y`,`20`),n(ot,`bi-axis-label`),i(ot,o(`API`));let Z=r(`article`,G);i(G,Z),n(Z,`bi-card bi-tp-card`);let st=r(`div`,Z);i(Z,st),n(st,`bi-section-title`);let ct=r(`div`,st);i(st,ct);let lt=r(`p`,ct);i(ct,lt),n(lt,`bi-eyebrow`),i(lt,o(`Weekly Throughput`));let ut=r(`h2`,ct);i(ct,ut),i(ut,o(`周吞吐量`));let dt=r(`div`,Z);i(Z,dt),n(dt,`bi-tp-bars`);let ft=e(`rue:list:start`),pt=e(`rue:list:end`);i(dt,ft),i(dt,pt);let mt=new Map;f(()=>{mt=m({items:y||[],getKey:(e,t)=>e.time,elements:mt,parent:dt,before:pt,singleRoot:!0,trackIndex:!1,start:ft,renderItem:(m,h,g,_,v)=>{d(l(()=>{let l=t(),h=r(`div`,l);i(l,h),f(()=>{s(h,`key`,String(m.time))}),n(h,`bi-tp-group`);let g=r(`div`,h);i(h,g),n(g,`bi-tp-val`);let _=p(g);i(g,_),f(()=>{a(_,m.value.toFixed(1))}),i(g,o(`T`));let v=r(`div`,h);i(h,v),n(v,`bi-tp-bar-shell`);let y=r(`div`,v);i(v,y),n(y,`bi-tp-fill`),f(()=>{c(y,{height:`${Math.max(8,m.value/ee*100)}%`})});let b=r(`div`,h);i(h,b),n(b,`bi-tp-label`);let x=e(`rue:slot:anchor`);return i(b,x),f(()=>{let e=m.time;u(()=>d(e,b,x))}),l}),h,g)}})});let Q=r(`section`,j);i(j,Q),n(Q,`bi-bottom-grid`);let $=r(`article`,Q);i(Q,$),n($,`bi-card bi-queries-card`);let ht=r(`div`,$);i($,ht),n(ht,`bi-section-title`);let gt=r(`div`,ht);i(ht,gt);let _t=r(`p`,gt);i(gt,_t),n(_t,`bi-eyebrow`),i(_t,o(`Top Queries`));let vt=r(`h2`,gt);i(gt,vt),i(vt,o(`高频查询排行`));let yt=r(`div`,$);i($,yt);let bt=e(`rue:list:start`),xt=e(`rue:list:end`);i(yt,bt),i(yt,xt);let St=new Map;f(()=>{St=m({items:b||[],getKey:(e,t)=>e.rank,elements:St,parent:yt,before:xt,singleRoot:!0,trackIndex:!1,start:bt,renderItem:(a,c,p,m,h)=>{d(l(()=>{let c=t(),l=r(`div`,c);i(c,l),f(()=>{s(l,`key`,String(a.rank))}),n(l,`bi-query-row`);let p=r(`span`,l);i(l,p),f(()=>{n(p,String(`bi-query-rank ${a.rank<=3?`top3`:``}`))});let m=e(`rue:slot:anchor`);i(p,m),f(()=>{let e=a.rank;u(()=>d(e,p,m))});let h=r(`span`,l);i(l,h),n(h,`bi-query-sql`);let g=e(`rue:slot:anchor`);i(h,g),f(()=>{let e=a.sql;u(()=>d(e,h,g))});let _=r(`span`,l);i(l,_),f(()=>{n(_,String(`bi-query-src ${ie[a.source.toLowerCase().replace(` `,`-`)]||ie[a.source===`ClickHouse`?`ch`:a.source===`Redis`?`redis`:a.source===`MySQL`?`mysql`:a.source===`PostgreSQL`?`pg`:a.source===`GraphQL`?`gql`:`api`]}`))});let v=e(`rue:slot:anchor`);i(_,v),f(()=>{let e=a.source;u(()=>d(e,_,v))});let y=r(`span`,l);i(l,y),n(y,`bi-query-freq`);let b=e(`rue:slot:anchor`);i(y,b),f(()=>{let e=a.freq;u(()=>d(e,y,b))});let x=r(`span`,l);i(l,x),f(()=>{n(x,String(`bi-query-ms ${oe(a.avgMs)}`))});let S=e(`rue:slot:anchor`);return i(x,S),f(()=>{let e=a.avgMs;u(()=>d(e,x,S))}),i(x,o(`ms`)),c}),c,p)}})});let Ct=r(`article`,Q);i(Q,Ct),n(Ct,`bi-card bi-alert-card`);let wt=r(`div`,Ct);i(Ct,wt),n(wt,`bi-section-title`);let Tt=r(`div`,wt);i(wt,Tt);let Et=r(`p`,Tt);i(Tt,Et),n(Et,`bi-eyebrow`),i(Et,o(`Alert Center`));let Dt=r(`h2`,Tt);i(Tt,Dt),i(Dt,o(`告警事件`));let Ot=r(`div`,Ct);i(Ct,Ot);let kt=e(`rue:list:start`),At=e(`rue:list:end`);i(Ot,kt),i(Ot,At);let jt=new Map;return f(()=>{jt=m({items:x||[],getKey:(e,t)=>t,elements:jt,parent:Ot,before:At,singleRoot:!0,start:kt,renderItem:(o,c,m,h,g)=>{d(l(()=>{let c=t(),l=r(`div`,c);i(c,l),f(()=>{s(l,`key`,String(g))}),n(l,`bi-alert-row`);let m=r(`span`,l);i(l,m),n(m,`bi-alert-time`);let h=e(`rue:slot:anchor`);i(m,h),f(()=>{let e=o.time;u(()=>d(e,m,h))});let _=r(`span`,l);i(l,_),f(()=>{n(_,String(`bi-alert-level ${o.level}`))});let v=e(`rue:slot:anchor`);i(_,v),f(()=>{let e=o.level;u(()=>d(e,_,v))});let y=r(`span`,l);i(l,y),n(y,`bi-alert-msg`);let b=e(`rue:slot:anchor`);i(y,b),f(()=>{let e=o.message;u(()=>d(e,y,b))});let x=r(`span`,l);i(l,x),f(()=>{n(x,String(`bi-alert-resolved ${o.resolved?`yes`:`no`}`))});let S=p(x);return i(x,S),f(()=>{a(S,o.resolved?`已恢复`:`处理中`)}),c}),c,m)}})}),T});export{A as default};