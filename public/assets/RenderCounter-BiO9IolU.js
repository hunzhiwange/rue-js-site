import{Dt as e,Et as t,H as n,K as r,T as i,W as a,d as o,kt as s,l as c,tt as l,xt as u}from"./vapor-runtime-BAZOdMd8.js";import{a as d}from"./vapor-helpers-vapor-BvUp1QnH.js";import{t as f}from"./createHomeSplitExamplePage-BUuBaUet.js";var p=`rounded-lg border px-5 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all`,m=e=>o(t=>{let i=r(`div`,t);l(i,`text-3xl font-bold mb-3`);let o=a(`rue:slot:anchor`);return n(i,o),s(()=>{let t=e.count.value;u(()=>c(t,i,o))}),i}),h=f({title:`渲染函数计数器`,source:`import { type FC, h, useSetup, useState, watchEffect } from '@rue-js/rue'
