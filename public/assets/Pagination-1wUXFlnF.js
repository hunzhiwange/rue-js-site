...
</Pagination>`});h(()=>u(e,d,ae))});let L=e(`rue:component:anchor`);i(d,L),c(()=>{let e=m(F,{title:`Vertical pagination`,summary:"继续沿用 `direction='vertical'`，适合侧栏步骤、目录或分段导航。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(P,{direction:`vertical`,className:`w-fit`,"data-testid":`pagination-vertical`,children:[b(P.Item,{children:`Overview`}),b(P.Item,{children:`Updates`}),b(P.Item,{children:`Logs`})]})})}),code:`<Pagination direction="vertical" className="w-fit">
  <Pagination.Item>Overview</Pagination.Item>
  <Pagination.Item>Updates</Pagination.Item>
  <Pagination.Item>Logs</Pagination.Item>
</Pagination>`});h(()=>u(e,d,L))});let R=e(`rue:component:anchor`);i(d,R),c(()=>{let e=m(F,{title:`Current and disabled items`,summary:"静态模式下仍可通过 `active`、`disabled` 和 `tag='a'` 控制语义与状态。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body`,children:y(P,{className:`w-fit`,"data-testid":`pagination-stateful`,children:[b(P.Item,{disabled:!0,children:`Prev`}),b(P.Item,{children:`1`}),b(P.Item,{active:!0,children:`2`}),b(P.Item,{children:`3`}),b(P.Item,{tag:`a`,href:`#next`,children:`Next`})]})})}),code:`<Pagination className="w-fit">
  <Pagination.Item disabled>Prev</Pagination.Item>
  <Pagination.Item>1</Pagination.Item>
  <Pagination.Item active>2</Pagination.Item>
  <Pagination.Item>3</Pagination.Item>
  <Pagination.Item tag="a" href="#next">Next</Pagination.Item>
</Pagination>`});h(()=>u(e,d,R))});let z=e(`rue:component:anchor`);i(d,z),c(()=>{let e=m(F,{title:`Data driven basic`,summary:"传入 `total` 后由组件自动计算页码；这里改成受控版本，便于在设计页直接切换和观察当前页变化。",preview:()=>b(`div`,{className:`card bg-base-100 shadow-sm`,children:y(`div`,{className:`card-body gap-4`,children:[b(P,{current:S.value,total:120,showTotal:(e,t)=>`${t[0]}-${t[1]} / ${e}`,onChange:e=>{S.value=e}}),b(P,{current:C.value,total:500,size:`sm`,align:`center`,onChange:e=>{C.value=e}}),y(`div`,{className:`text-sm opacity-70`,children:[`当前示例页码：默认尺寸第 `,S.value,` 页，小尺寸第`,` `,C.value,` 页`]})]})}),code:`const primaryPage = ref(2)
...
<Pagination total={8} defaultCurrent={1} hideOnSinglePage />`});h(()=>u(e,d,se))});let U=r(`h2`,d);i(d,U),s(U,`id`,`pagination-api`),i(U,o(`API`));let W=e(`rue:component:anchor`);i(d,W),c(()=>{let e=m(I,{rows:oe});h(()=>u(e,d,W))});let G=r(`h2`,d);i(d,G),i(G,o(`FAQ`));let K=r(`div`,d);i(d,K),n(K,`space-y-4 text-sm leading-6`);let q=r(`div`,K);i(K,q);let J=r(`h3`,q);i(q,J),n(J,`mb-1 text-base font-semibold`),i(J,o(`什么时候用静态组合，什么时候用数据驱动？`));let Y=r(`p`,q);i(q,Y),n(Y,`m-0 opacity-80`),i(Y,o("当按钮结构、文案和链接完全由业务自定义时，用 `Pagination.Item` 静态组合更直接；只要你已经有 `total`、`current`、`pageSize` 这些分页信息，优先使用数据驱动模式，省去页码计算与边界处理。"));let X=r(`div`,K);i(K,X);let ce=r(`h3`,X);i(X,ce),n(ce,`mb-1 text-base font-semibold`),i(ce,o("`simple` 适合什么场景？"));let Z=r(`p`,X);i(X,Z),n(Z,`m-0 opacity-80`),i(Z,o("`simple` 适合工具栏、卡片头部、移动端等横向空间有限的区域；如果只想展示当前页而不允许直接输入， 可以传 `simple="));let le=g(Z);i(Z,le),c(()=>{a(le,{readOnly:!0})}),i(Z,o("`。"));let Q=r(`div`,K);i(K,Q);let ue=r(`h3`,Q);i(Q,ue),n(ue,`mb-1 text-base font-semibold`),i(ue,o(`切换每页条数时会触发哪些回调？`));let de=r(`p`,Q);i(Q,de),n(de,`m-0 opacity-80`),i(de,o("`onShowSizeChange` 专门用于处理页容量变更；为了保持外部状态同步，`onChange` 也会收到新的页码和 `pageSize`，所以受控场景通常同时兼容这两个回调。"));let $=r(`div`,K);i(K,$);let fe=r(`h3`,$);i($,fe),n(fe,`mb-1 text-base font-semibold`),i(fe,o(`如何把上一页、下一页改成业务文案？`));let pe=r(`p`,$);return i($,pe),n(pe,`m-0 opacity-80`),i(pe,o("轻量替换可以用 `itemRender` 改写 `prev`、`next`、`jump-prev`、`jump-next` 的内容；如果还要替换 aria/title 文案，可以继续传 `locale`。")),l})}),f,p),f})};export{L as default};