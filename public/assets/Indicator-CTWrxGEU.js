...
</div>`});p(()=>l(e,o,ce))});let le=a(`rue:component:anchor`);r(o,le),c(()=>{let e=d(P,{title:`Placement shorthand and offset`,summary:`placement 先给出主定位，再用 offset 做细调，适合视觉需要避让边框或圆角的场景。`,tab:D,preview:()=>g(`div`,{className:`grid gap-4 md:grid-cols-3`,children:[_(N,{item:_(x,{variant:`secondary`,children:`Start`}),itemProps:{placement:`top-start`,offset:[8,-4]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`top-start`})}),_(N,{item:_(x,{variant:`accent`,children:`Center`}),itemProps:{placement:`middle-center`,offset:[0,4]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`middle-center`})}),_(N,{item:_(x,{variant:`warning`,children:`End`}),itemProps:{placement:`bottom-end`,offset:[10,6]},children:_(`div`,{className:`grid h-24 rounded-xl bg-base-200 place-items-center text-sm`,children:`bottom-end`})})]}),code:`<div className="grid gap-4 md:grid-cols-3">
  <Indicator
...
</Indicator>`});p(()=>l(e,o,ue))});let Z=i(`h2`,o);r(o,Z),f(Z,`mt-10`),r(Z,u(`API`));let Q=i(`p`,o);r(o,Q),f(Q,`text-sm text-base-content/70`),r(Q,u(`Indicator 仍然是一个纯布局组件，不接管 Badge、Status 或 Button 的视觉，只负责悬挂与定位。`));let de=i(`h3`,o);r(o,de),r(de,u(`Indicator`));let fe=a(`rue:component:anchor`);r(o,fe),c(()=>{let e=d(re,{rows:ie});p(()=>l(e,o,fe))});let $=i(`h3`,o);r(o,$),f($,`mt-8`),r($,u(`Indicator.Item`));let pe=a(`rue:component:anchor`);return r(o,pe),c(()=>{let e=d(re,{rows:ae});p(()=>l(e,o,pe))}),t})}),o,m),o})};export{F as default};