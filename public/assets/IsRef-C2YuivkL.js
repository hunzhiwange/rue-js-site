import{Bt as e,C as t,Dn as n,Et as r,H as i,K as a,L as o,Lt as s,S as c,Sn as l,V as u,Vt as d,W as f,Wt as p,_n as m,bn as h,en as g,fn as _,gn as v,hn as y,nn as b,nt as x,ot as S,pn as C,qt as w,sn as T,wn as E,x as D}from"./rue-runtime-CwEGJ854.js";import{t as O}from"./Code-B3jCYMAr.js";import{r as k}from"./SidebarPlaygroundExample-EGR0CyDT.js";var A=m(`<h1 class="text-5xl font-semibold mb-4 md:mb-4">isRef 判定示例</h1>`),j=m(`<div role="tablist" class="tabs tabs-box"><button role="tab">效果</button><button role="tab">代码</button></div>`),M=m(`<div class="mt-4 grid md:grid-cols-1 gap-6 items-start"><!--rue:text-hole:0--><!--rue:text-hole:1--></div>`),N=`import {
  computed,
  isRef,
  reactive,
  ref,
