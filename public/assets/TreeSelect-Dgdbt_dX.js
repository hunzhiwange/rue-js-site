...
/>
`,Le=[{prop:`allowClear`,description:`追加清空按钮，适合单选、多选和勾选模式统一收敛到一个入口`,type:`boolean | { clearIcon?: any }`,defaultValue:`false`},{prop:`fieldNames`,description:`映射 label、value、children、key 与 simple mode 的 id / pId 字段`,type:`TreeSelectFieldNames`,defaultValue:`{ title, value, children, key }`},{prop:`labelInValue`,description:`把回填值升级为 { value, key, label, halfChecked } 结构`,type:`boolean`,defaultValue:`false`},{prop:`loadData`,description:`展开未加载节点时触发异步加载，适合目录、权限树、远端分类场景`,type:`(node) => Promise<any> | void`,defaultValue:`-`},{prop:`maxCount`,description:`限制多选 / 勾选模式下最多展示并回填多少个节点`,type:`number`,defaultValue:`-`},{prop:`multiple`,description:`多选模式，已选项会回填为标签列表`,type:`boolean`,defaultValue:`false`},{prop:`showCheckedStrategy`,description:`控制 treeCheckable 时的回填策略，支持 SHOW_ALL / SHOW_PARENT / SHOW_CHILD`,type:`TreeSelectShowCheckedStrategy`,defaultValue:`SHOW_CHILD`},{prop:`showSearch`,description:`开启搜索输入；对象模式可配置 autoClearSearchValue、filterTreeNode 与 onSearch`,type:`boolean | TreeSelectShowSearchConfig`,defaultValue:`单选 false / 多选 true`},{prop:`treeCheckable`,description:`把树节点切到 checkbox 模式，适合权限树、发布范围、分类选择`,type:`boolean`,defaultValue:`false`},{prop:`treeData`,description:`树数据源，title / value / children 为常用字段，value 在整棵树里需要唯一`,type:`TreeSelectDataNode[]`,defaultValue:`[]`},{prop:`treeDataSimpleMode`,description:`接收扁平结构树数据，并通过 id / pId 自动恢复层级`,type:`boolean | { id?: string; pId?: string; rootPId?: string | number | null }`,defaultValue:`false`},{prop:`treeDefaultExpandAll / treeExpandedKeys`,description:`控制树默认展开和受控展开，便于做大树分层浏览`,type:`boolean / TreeSelectValue[]`,defaultValue:`false / -`},{prop:`treeNodeFilterProp`,description:`搜索命中用的字段，常见设置是 title 或自定义 label 字段`,type:`string`,defaultValue:`value`},{prop:`variant / status`,description:`沿用 Rue 输入类组件的视觉语义，支持 filled、borderless、underlined 与 warning/error`,type:`'outlined' | 'filled' | 'borderless' | 'underlined' / 'warning' | 'error'`,defaultValue:`'outlined' / -`}],Re=()=>{let{basicValue:n,noClearValue:r,simpleValue:c,multipleValue:f,checkableValue:m,semanticValue:y,shellValue:w,asyncValue:T,asyncTreeData:ee,loadAsyncTree:te,tabs:E}=v(`useSetup:0:0`,()=>h(()=>{let e=v(`ref:1:0`,()=>a(`docs`)),t=v(`ref:1:1`,()=>a(`docs`)),n=v(`ref:1:2`,()=>a(`workflow`)),r=v(`ref:1:3`,()=>a([`analytics`,`minutes`])),i=v(`ref:1:4`,()=>a([`build`,`quality`])),o=v(`ref:1:5`,()=>a(null)),s=v(`ref:1:6`,()=>a(`prod`)),c=v(`ref:1:7`,()=>a(null)),l=v(`ref:1:8`,()=>a([{title:`按需加载目录`,value:`async-root`,isLeaf:!1}]));return{basicValue:e,noClearValue:t,simpleValue:n,multipleValue:r,checkableValue:i,semanticValue:o,shellValue:s,asyncValue:c,asyncTreeData:l,loadAsyncTree:async e=>{e.value===`async-root`&&(l.value=[{title:`按需加载目录`,value:`async-root`,isLeaf:!1,children:[{title:`实验看板`,value:`async-dashboard`},{title:`巡检报告`,value:`async-report`},{title:`回归清单`,value:`async-checklist`}]}])},tabs:{basic:v(`ref:1:9`,()=>a(`preview`)),noClear:v(`ref:1:10`,()=>a(`preview`)),simple:v(`ref:1:11`,()=>a(`preview`)),multiple:v(`ref:1:12`,()=>a(`preview`)),checkable:v(`ref:1:13`,()=>a(`preview`)),semantic:v(`ref:1:14`,()=>a(`preview`)),async:v(`ref:1:15`,()=>a(`preview`)),shell:v(`ref:1:16`,()=>a(`preview`))}}}));return p(a=>{let h=i(),v=l(`rue:component:anchor`);return s(h,v),g(_(S,{children:p(()=>{let a=i(),p=e(`div`,a);s(a,p),u(p,`max-w-none prose prose-sm md:prose-base`);let h=e(`h1`,p);s(p,h),s(h,d(`TreeSelect 树选择`));let v=e(`p`,p);s(p,v),u(v,`text-sm mt-3 mb-3`),s(v,d(`TreeSelect 适合“下拉选择 + 树结构浏览”同时存在的输入场景，比如目录、组织架构、权限树、资源分类和发布范围。 这一版不照搬其他组件库的视觉，而是延续 Rue 的 input / badge / base 色阶体系，把 treeData、simple mode、多选、勾选、语义值、异步加载和 filled / warning 等核心面一次补齐。`));let S=e(`div`,p);s(p,S),u(S,`not-prose mt-8 space-y-2`);let D=e(`h2`,S);s(S,D),u(D,`text-2xl font-semibold`),s(D,d(`基础能力`));let O=e(`p`,S);s(S,O),u(O,`text-sm text-base-content/70`),s(O,d(`先把单选、搜索和清空打稳，再把 simple mode、多选与勾选这些更接近业务配置面的能力接进来。`));let k=l(`rue:component:anchor`);s(p,k),o(()=>{let e=_(C,{title:`Basic`,summary:`单选、搜索、默认展开与 allowClear 的组合，是目录选择最常见的入口。`,tab:E.basic,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:n.value,treeData:L,treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,placeholder:`选择一个树节点`,onChange:e=>{n.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,n.value||`未选择`]})]})}),code:ke});t(()=>g(e,p,k))});let ne=l(`rue:component:anchor`);s(p,ne),o(()=>{let e=_(C,{title:`Without allowClear`,summary:`未开启 allowClear 时，只保留选择交互，不显示 selector 右侧的清空入口。`,tab:E.noClear,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:r.value,treeData:L,treeDefaultExpandAll:!0,onChange:e=>{r.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,r.value||`未选择`]})]})}),code:Ae});t(()=>g(e,p,ne))});let re=l(`rue:component:anchor`);s(p,re),o(()=>{let e=_(C,{title:`Simple Mode`,summary:`扁平树数据直接接入，适合后端给的是 id / pId 结构时减少前置整理成本。`,tab:E.simple,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:c.value,treeData:Oe,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{value:`code`,label:`name`,key:`code`},treeDefaultExpandAll:!0,showSearch:!0,treeNodeFilterProp:`title`,allowClear:!0,onChange:e=>{c.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前目标：`,c.value||`未选择`]})]}),x(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`这类接口在 CMS、流程平台、低代码配置里很常见。只要给出 id / pId / value / title 映射，就能直接恢复成可搜索树。`})]})}),code:je});t(()=>g(e,p,re))});let ie=l(`rue:component:anchor`);s(p,ie),o(()=>{let e=_(C,{title:`Multiple`,summary:`多选模式默认以标签回填，适合通知订阅、面板订阅、资源批量绑定。`,tab:E.multiple,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body gap-3`,children:[x(F,{value:f.value,treeData:Ee,multiple:!0,treeDefaultExpandAll:!0,allowClear:!0,maxTagCount:2,placeholder:`选择多个项目`,onChange:e=>{f.value=Te(e)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`已选：`,f.value.join(` / `)||`未选择`]})]})}),code:Me});t(()=>g(e,p,ie))});let ae=l(`rue:component:anchor`);s(p,ae),o(()=>{let e=_(C,{title:`Checkable`,summary:`勾选树会把多选语义进一步贴近权限树和发布范围；默认 SHOW_CHILD 会直接回填实际勾选的子节点。`,tab:E.checkable,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:m.value,treeData:L,treeCheckable:!0,maxTagCount:2,maxTagPlaceholder:`...`,allowClear:!0,treeDefaultExpandAll:!0,onChange:e=>{m.value=Te(e)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`回填：`,m.value.join(` / `)||`未选择`]})]}),b(`ul`,{className:`list rounded-box border border-base-300 bg-base-200/40 p-4 text-sm`,children:[b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`策略`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例使用默认 SHOW_CHILD，选了哪些子节点就回填哪些子节点，更适合精确范围选择。`})]}),b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`切换`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`如果业务更想要紧凑展示，可以把 showCheckedStrategy 改成 TreeSelect.SHOW_PARENT，让完整分组选中时折叠成父标签。`})]}),b(`li`,{className:`list-row`,children:[x(`span`,{className:`font-medium`,children:`回填`}),x(`span`,{className:`list-col-grow text-base-content/70`,children:`当前示例最多展示两个标签，更多已选项会用 ... 收起，避免 selector 被撑成两排。`})]})]})]})}),code:Ne});t(()=>g(e,p,ae))});let A=e(`div`,p);s(p,A),u(A,`not-prose mt-10 space-y-2`);let oe=e(`h2`,A);s(A,oe),u(oe,`text-2xl font-semibold`),s(oe,d(`高级能力`));let se=e(`p`,A);s(A,se),u(se,`text-sm text-base-content/70`),s(se,d(`语义值、异步加载和外观变体补到位之后，TreeSelect 就能覆盖绝大多数配置类面板的核心需求。`));let ce=l(`rue:component:anchor`);s(p,ce),o(()=>{let e=_(C,{title:`Label In Value`,summary:`当业务既要 value 也要 label 时，直接回填结构体会更顺手。`,tab:E.semantic,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[x(`div`,{className:`grid gap-3`,children:x(F,{treeData:L,labelInValue:!0,treeDefaultExpandAll:!0,defaultValue:`release`,onChange:e=>{y.value=e??null}})}),b(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:[`当前结构：`,x(`code`,{children:JSON.stringify(y.value)})]})]})}),code:Pe});t(()=>g(e,p,ce))});let le=l(`rue:component:anchor`);s(p,le),o(()=>{let e=_(C,{title:`Async Load`,summary:`展开未加载分支时触发 loadData，适合远端目录、权限树和超大分类树。`,tab:E.async,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,22rem),1fr] lg:items-start`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:T.value,treeData:ee.value,allowClear:!0,loadData:te,onChange:e=>{T.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前节点：`,T.value||`尚未选择`]})]}),x(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`第一次展开“按需加载目录”时会把子节点注入到 treeData，这个模式适合服务端分页目录和按需权限树。`})]})}),code:Fe});t(()=>g(e,p,le))});let ue=l(`rue:component:anchor`);s(p,ue),o(()=>{let e=_(C,{title:`Variant and Status`,summary:`TreeSelect 也沿用 Rue 现有输入体系的 filled / warning 视觉语义。`,tab:E.shell,preview:x(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm`,children:b(`div`,{className:`card-body grid gap-4 md:grid-cols-2`,children:[b(`div`,{className:`grid gap-3`,children:[x(F,{value:w.value,treeData:De,prefix:x(`span`,{className:`badge badge-neutral badge-sm`,children:`ENV`}),suffix:x(`span`,{className:`text-xs opacity-60`,children:`可清空`}),variant:`filled`,status:`warning`,allowClear:!0,treeDefaultExpandAll:!0,onChange:e=>{w.value=String(I(e)??``)}}),b(`div`,{className:`text-sm text-base-content/70`,children:[`当前环境：`,w.value||`未选择`]})]}),x(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`prefix / suffix 让 TreeSelect 能自然落进环境切换、租户切换和带状态提醒的配置表单里。`})]})}),code:Ie});t(()=>g(e,p,ue))});let j=e(`div`,p);s(p,j),u(j,`not-prose mt-10 space-y-4`);let de=e(`h2`,j);s(j,de),u(de,`text-2xl font-semibold`),s(de,d(`API`));let fe=l(`rue:component:anchor`);return s(j,fe),o(()=>{let e=_(we,{rows:Le});t(()=>g(e,j,fe))}),a})}),h,v),h})};export{Re as default};