...
export default BasicElements;`});e(()=>u(t,o,s))}),t}):``;e(()=>u(t,b,x))}),n(b,d(` `));let S=a(`rue:slot:anchor`);return n(b,S),m(()=>{let t=v.value===`preview`?s(()=>{let e=p(),t=l(`div`,e);n(e,t),i(t,`card bg-base-100 shadow`);let r=l(`div`,t);n(t,r),i(r,`card-body`);let a=l(`div`,r);n(r,a),n(a,d(`div 元素`));let o=l(`span`,r);n(r,o),n(o,d(`span 元素`)),n(r,l(`br`,r));let s=l(`img`,r);n(r,s),c(s,`src`,`https://placehold.co/600x400`),c(s,`alt`,`占位图`);let u=l(`input`,r);n(r,u),i(u,`input input-bordered`),c(u,`placeholder`,`自闭合 input`);let f=l(`p`,r);return n(r,f),n(f,d(`支持文本、嵌套与自闭合形式`)),e}):``;e(()=>u(t,b,S))}),t})}),o,h),o})};export{v as default};