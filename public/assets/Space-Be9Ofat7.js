...
</Space>`,q=()=>{let{tabs:o}=h(`useSetup:0:0`,()=>l(()=>({tabs:{basic:h(`ref:1:0`,()=>d(`preview`)),direction:h(`ref:1:1`,()=>d(`preview`)),size:h(`ref:1:2`,()=>d(`preview`)),wrap:h(`ref:1:3`,()=>d(`preview`)),separator:h(`ref:1:4`,()=>d(`preview`)),compactToolbar:h(`ref:1:5`,()=>d(`preview`)),compactButtons:h(`ref:1:6`,()=>d(`preview`)),compactVerticalButtons:h(`ref:1:7`,()=>d(`preview`)),compactVertical:h(`ref:1:8`,()=>d(`preview`)),scene:h(`ref:1:9`,()=>d(`preview`))}})));return s(l=>{let d=t(),p=e(`rue:component:anchor`);return i(d,p),u(f(y,{children:s(()=>{let s=t(),l=r(`div`,s);i(s,l),n(l,`max-w-none prose prose-sm md:prose-base`);let d=r(`h1`,l);i(l,d),i(d,a(`Space 间距容器`));let p=r(`p`,l);i(l,p),n(p,`text-sm mt-3 mb-3`),i(p,a(`Space 现在不再只是“自己写 gap”的占位组件，而是补成了一个完整的布局原语。它保留 Rue 自己干净直接的视觉，不抢内容本身的风头，同时把常用的水平/垂直编排、对齐、换行、分隔符和 Compact 紧凑组合一次补齐。`));let h=r(`h2`,l);i(l,h),i(h,a(`何时使用`));let g=r(`ul`,l);i(l,g);let y=r(`li`,g);i(g,y),i(y,a(`需要把按钮、标签、统计块、输入控件排成一致的节奏，而不想在每个页面重复手写 gap。`));let E=r(`li`,g);i(g,E),i(E,a(`需要在同一套 API 下切换 horizontal、vertical、wrap 和 separator，保持布局表达统一。`));let D=r(`li`,g);i(g,D),i(D,a(`需要工具条、搜索栏、批量操作区这类更紧凑的组合时，可以直接切到 Space.Compact。`));let O=r(`h2`,l);i(l,O),i(O,a(`推荐用法`));let k=e(`rue:component:anchor`);i(l,k),m(()=>{let e=f(T,{title:`基础间距`,summary:`最小可用写法，适合动作按钮、标签和轻量操作组。`,tab:o.basic,code:W,preview:v(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:_(L,{children:[v(b,{color:`primary`,children:`Run build`}),v(b,{color:`secondary`,variant:`outline`,children:`Preview`}),v(x,{color:`neutral`,children:`workspace`})]})})});c(()=>u(e,l,k))});let A=e(`rue:component:anchor`);i(l,A),m(()=>{let e=f(T,{title:`方向与对齐`,summary:`主轴方向和交叉轴对齐都在 Space 本身表达，不需要额外写 flex 类。`,tab:o.direction,code:G,preview:_(`div`,{className:`grid gap-4 lg:grid-cols-2`,children:[_(L,{align:`baseline`,className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[v(x,{color:`primary`,children:`baseline`}),v(`span`,{className:`text-2xl font-semibold`,children:`24h`}),v(`span`,{className:`text-sm opacity-60`,children:`fresh`})]}),_(L,{vertical:!0,align:`stretch`,className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[v(`div`,{className:`rounded-box bg-base-200 px-3 py-2`,children:`Upload assets`}),v(`div`,{className:`rounded-box bg-base-200 px-3 py-2`,children:`Sync routes`}),v(`div`,{className:`rounded-box bg-base-200 px-3 py-2`,children:`Publish preview`})]})]})});c(()=>u(e,l,A))});let j=e(`rue:component:anchor`);i(l,j),m(()=>{let e=f(T,{title:`尺寸与自定义 Gap`,summary:`延续 small / middle / large 预设，也支持 tuple 间距覆盖列距与行距。`,tab:o.size,code:K,preview:_(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm space-y-4`,children:[_(L,{size:`small`,children:[v(x,{color:`primary`,children:`small`}),v(x,{color:`secondary`,children:`8px token`}),v(x,{color:`accent`,children:`dense`})]}),_(L,{size:`middle`,children:[v(x,{color:`primary`,children:`middle`}),v(x,{color:`secondary`,children:`balanced`}),v(x,{color:`accent`,children:`12px token`})]}),_(L,{size:[28,14],wrap:!0,className:`max-w-xl`,children:[v(x,{color:`neutral`,children:`tuple gap`}),v(x,{color:`info`,children:`column 28`}),v(x,{color:`success`,children:`row 14`}),v(x,{color:`warning`,children:`wrap aware`}),v(x,{color:`error`,children:`custom density`})]})]})});c(()=>u(e,l,j))});let M=e(`rue:component:anchor`);i(l,M),m(()=>{let e=f(T,{title:`自动换行`,summary:`用 wrap 处理标签墙、筛选条件和批量状态块，保持行距稳定。`,tab:o.wrap,code:ee,preview:_(L,{wrap:!0,size:[16,12],className:`max-w-2xl rounded-[1.5rem] border border-dashed border-base-300 bg-base-100 p-4 shadow-sm`,children:[v(x,{color:`primary`,children:`router`}),v(x,{color:`secondary`,children:`runtime-vapor`}),v(x,{color:`accent`,children:`design-system`}),v(x,{color:`neutral`,children:`sfc playground`}),v(x,{color:`info`,children:`bench`}),v(x,{color:`success`,children:`release`}),v(x,{color:`warning`,children:`compat`}),v(x,{color:`error`,children:`incident`})]})});c(()=>u(e,l,M))});let N=e(`rue:component:anchor`);i(l,N),m(()=>{let e=f(T,{title:`Separator / Split`,summary:`分隔符适合 breadcrumb、命令路径和键值对；自定义节点推荐传函数。`,tab:o.separator,code:te,preview:v(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:_(L,{separator:()=>v(`span`,{className:`text-xs uppercase tracking-[0.2em] opacity-35`,children:`/`}),children:[v(`a`,{className:`link link-hover`,children:`Workspace`}),v(`a`,{className:`link link-hover`,children:`Design`}),v(`span`,{className:`font-medium`,children:`Space`})]})})});c(()=>u(e,l,N))});let P=e(`rue:component:anchor`);i(l,P),m(()=>{let e=f(T,{title:`Compact 横向工具条`,summary:`把输入、筛选和提交动作收成一个连续控制带，适合搜索栏与操作条；Compact 默认就是无间距拼接。`,tab:o.compactToolbar,code:ne,preview:v(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:_(L.Compact,{className:`w-full max-w-3xl`,children:[v(w,{className:`w-full`,placeholder:`Search component or token`}),_(`select`,{className:`select w-full min-w-40`,children:[v(`option`,{children:`All teams`}),v(`option`,{children:`Design infra`}),v(`option`,{children:`Runtime`})]}),v(b,{className:`w-full lg:w-auto`,color:`primary`,children:`Search`})]})})});c(()=>u(e,l,P))});let F=e(`rue:component:anchor`);i(l,F),m(()=>{let e=f(T,{title:`Compact 按钮拼接`,summary:`补一组更接近操作面板的按钮拼接示例：图标轨道、主色动作条和带下拉收口的混合按钮组。`,tab:o.compactButtons,code:ie,preview:_(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm space-y-4`,children:[_(L.Compact,{block:!0,children:[v(C,{title:`Like`,children:v(b,{shape:`square`,"aria-label":`Like`,icon:v(z,{label:`LK`})})}),v(C,{title:`Comment`,children:v(b,{shape:`square`,"aria-label":`Comment`,icon:v(z,{label:`CM`})})}),v(C,{title:`Star`,children:v(b,{shape:`square`,"aria-label":`Star`,icon:v(z,{label:`ST`})})}),v(C,{title:`Heart`,children:v(b,{shape:`square`,"aria-label":`Heart`,icon:v(z,{label:`HT`})})}),v(C,{title:`Share`,children:v(b,{shape:`square`,"aria-label":`Share`,icon:v(z,{label:`SH`})})}),v(C,{title:`Download`,children:v(b,{shape:`square`,"aria-label":`Download`,icon:v(z,{label:`DL`})})}),v(S,{trigger:`click`,placement:`bottomRight`,items:B,children:v(b,{shape:`square`,"aria-label":`More actions`,icon:v(z,{label:`...`})})})]}),_(L.Compact,{block:!0,children:[v(b,{color:`primary`,children:`Button 1`}),v(b,{color:`primary`,children:`Button 2`}),v(b,{color:`primary`,children:`Button 3`}),v(b,{color:`primary`,children:`Button 4`}),v(b,{color:`primary`,disabled:!0,title:`Disabled download`,icon:v(z,{label:`DL`})}),v(b,{color:`primary`,title:`Download`,icon:v(z,{label:`DL`})})]}),_(L.Compact,{block:!0,children:[v(b,{children:`Button 1`}),v(b,{children:`Button 2`}),v(b,{children:`Button 3`}),v(b,{disabled:!0,title:`Disabled download`,icon:v(z,{label:`DL`})}),v(b,{title:`Download`,icon:v(z,{label:`DL`})}),v(b,{color:`primary`,children:`Button 4`}),v(S,{trigger:`click`,placement:`bottomRight`,items:V,children:v(b,{color:`primary`,title:`More actions`,icon:v(z,{label:`...`})})})]})]})});c(()=>u(e,l,F))});let I=e(`rue:component:anchor`);i(l,I),m(()=>{let e=f(T,{title:`Compact 垂直按钮组`,summary:`再补一组更像 ant-design 的纵向按钮拼接，直接把默认、dashed、primary 和 outlined 四种按钮风格摆在一起。`,tab:o.compactVerticalButtons,code:ae,preview:v(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:_(L,{size:`large`,wrap:!0,children:[_(L.Compact,{orientation:`vertical`,className:`w-40`,children:[v(b,{block:!0,className:`justify-start`,children:`Button 1`}),v(b,{block:!0,className:`justify-start`,children:`Button 2`}),v(b,{block:!0,className:`justify-start`,children:`Button 3`})]}),_(L.Compact,{orientation:`vertical`,className:`w-40`,children:[v(b,{block:!0,type:`dashed`,className:`justify-start`,children:`Button 1`}),v(b,{block:!0,type:`dashed`,className:`justify-start`,children:`Button 2`}),v(b,{block:!0,type:`dashed`,className:`justify-start`,children:`Button 3`})]}),_(L.Compact,{orientation:`vertical`,className:`w-40`,children:[v(b,{block:!0,color:`primary`,className:`justify-start`,children:`Button 1`}),v(b,{block:!0,color:`primary`,className:`justify-start`,children:`Button 2`}),v(b,{block:!0,color:`primary`,className:`justify-start`,children:`Button 3`})]}),_(L.Compact,{orientation:`vertical`,className:`w-40`,children:[v(b,{block:!0,type:`outlined`,className:`justify-start`,children:`Button 1`}),v(b,{block:!0,type:`outlined`,className:`justify-start`,children:`Button 2`}),v(b,{block:!0,type:`outlined`,className:`justify-start`,children:`Button 3`})]})]})})});c(()=>u(e,l,I))});let q=e(`rue:component:anchor`);i(l,q),m(()=>{let e=f(T,{title:`Compact 纵向表单`,summary:`纵向 Compact 更适合移动端或窄侧栏里的批量录入。`,tab:o.compactVertical,code:re,preview:v(`div`,{className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:_(L.Compact,{vertical:!0,block:!0,className:`w-full max-w-sm`,children:[v(w,{className:`w-full`,placeholder:`Campaign title`}),v(w,{className:`w-full`,placeholder:`Owner`}),v(b,{className:`w-full`,color:`primary`,children:`Create workspace`})]})})});c(()=>u(e,l,q))});let J=e(`rue:component:anchor`);i(l,J),m(()=>{let e=f(T,{title:`场景化组合`,summary:`Space 负责主节奏，Space.Compact 负责局部收口，适合真实工作台头部。`,tab:o.scene,code:oe,preview:_(L,{block:!0,align:`center`,wrap:!0,className:`rounded-[1.5rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[_(L,{vertical:!0,className:`min-w-52`,children:[v(`span`,{className:`text-xs font-semibold uppercase tracking-[0.24em] text-base-content/45`,children:`release room`}),_(`div`,{children:[v(`div`,{className:`text-lg font-semibold`,children:`Weekly rollout`}),v(`div`,{className:`text-sm text-base-content/60`,children:`3 streams waiting for approval`})]})]}),_(L,{size:`large`,wrap:!0,className:`flex-1 justify-end`,children:[v(x,{color:`primary`,children:`preview ready`}),v(x,{color:`secondary`,children:`7 checks`}),v(x,{color:`accent`,children:`2 owners`}),_(L.Compact,{children:[v(b,{variant:`outline`,children:`Draft`}),v(b,{color:`primary`,children:`Publish`})]})]})]})});c(()=>u(e,l,J))});let Y=r(`h2`,l);i(l,Y),i(Y,a(`API`));let X=e(`rue:component:anchor`);i(l,X),m(()=>{let e=f(R,{rows:H});c(()=>u(e,l,X))});let Z=r(`h2`,l);i(l,Z),n(Z,`mt-10`),i(Z,a(`Space.Compact API`));let Q=r(`p`,l);i(l,Q),n(Q,`text-sm opacity-70`),i(Q,a(`Space.Compact 对齐的是 ant-design 的 compact 语义：它负责把控件压成连续组，默认不提供 gap；如果你要的是普通留白，请继续使用 Space。`));let $=e(`rue:component:anchor`);return i(l,$),m(()=>{let e=f(R,{rows:U});c(()=>u(e,l,$))}),s})}),d,p),d})};export{q as default};