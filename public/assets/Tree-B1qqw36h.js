...
</div>`,Ve=[{prop:`treeData`,description:`树数据源，支持嵌套 children 和字段映射。`,type:`TreeDataNode[]`,defaultValue:`[]`},{prop:`selectedKeys / defaultSelectedKeys`,description:`受控与非受控的当前选中项，multiple 打开后允许多选。`,type:`TreeKey[]`,defaultValue:`[]`},{prop:`checkedKeys / defaultCheckedKeys`,description:`勾选模式下的选中集合，strict 模式会回传 checked / halfChecked 结构。`,type:`TreeKey[] | { checked: TreeKey[]; halfChecked: TreeKey[] }`,defaultValue:`[]`},{prop:`expandedKeys / defaultExpandedKeys / defaultExpandAll`,description:`控制展开态，适合目录树、权限树和异步加载场景。`,type:`TreeKey[] / boolean`,defaultValue:`[] / false`},{prop:`checkable / checkStrictly`,description:`切换勾选与父子联动模式；strict 会关闭级联。`,type:`boolean`,defaultValue:`false`},{prop:`treeDataSimpleMode / fieldNames`,description:`直接接入 id / pId 扁平数据，同时可映射 title、key、children 字段。`,type:`boolean | TreeSimpleModeConfig / TreeFieldNames`,defaultValue:`- / -`},{prop:`allowSearch / searchValue / filterTreeNode`,description:`提供内置搜索输入和过滤逻辑，命中后会保留祖先链路。`,type:`boolean / string / boolean | ((inputValue, node) => boolean)`,defaultValue:`false / - / true`},{prop:`loadData`,description:`展开未加载分支时触发异步加载，适合远端目录与超大树。`,type:`(node: TreeNode) => Promise<any> | void`,defaultValue:`-`},{prop:`Tree.DirectoryTree / expandAction / toggleSelect / rangeSelect`,description:`目录树快捷 API；除了展开动作，还能细化 ctrl/meta 追加选择和 shift 区间选择是 append 还是 replace。`,type:`DirectoryTreeProps / false | "click" | "doubleClick" / boolean / false | "append" | "replace"`,defaultValue:`blockNode=true / showIcon=true / "click" / true / "append"`},{prop:`draggable / allowDrop / onDrop`,description:`开启拖拽排序并控制是否允许落点；allowDrop 和 onDrop 都会拿到 dropToGap，UI 会同步显示插前、插后或放入占位态。`,type:`TreeDraggable / (info) => boolean / (info) => void`,defaultValue:`false / - / -`},{prop:`height / itemHeight / virtual`,description:`为长列表开启虚拟滚动；height 定义视口高度，itemHeight 用于估算渲染窗口，也能和 loadData 组合接超长懒加载树。`,type:`number / number / boolean`,defaultValue:`- / 自动按尺寸估算 / true`},{prop:`showLine / showIcon / blockNode`,description:`控制树线、节点图标和整行可点的布局表现。`,type:`boolean`,defaultValue:`false`},{prop:`titleRender / switcherIcon / icon`,description:`按节点态自定义标题、展开图标和节点图标。`,type:`render function | any`,defaultValue:`-`}],He=e=>Array.isArray(e)?e:e.checked,Ue=(e,t)=>Array.isArray(e)?t?.halfCheckedKeys??[]:e.halfChecked,q=e=>`${typeof e}:${String(e)}`,J=e=>e.map(e=>({...e,children:Array.isArray(e.children)?J(e.children):e.children})),Y=(e,t)=>{let n=q(t);for(let r=0;r<e.length;r+=1){let i=e[r];if(q(i.key)===n){let[t]=e.splice(r,1);return t??null}if(Array.isArray(i.children)){let e=Y(i.children,t);if(e)return e}}return null},X=(e,t,n,r)=>{let i=q(n);for(let a=0;a<e.length;a+=1){let o=e[a];if(q(o.key)===i){if(r===0){let e=Array.isArray(o.children)?[...o.children]:[];e.push(t),o.children=e}else e.splice(r<0?a:a+1,0,t);return!0}if(Array.isArray(o.children)&&X(o.children,t,n,r))return!0}return!1},Z=(e,t)=>{let n=J(e),r=Y(n,t.dragNode.key);return r&&(X(n,r,t.node.key,t.dropPosition)||n.push(r)),n},We=(e,t,n)=>{let r=q(t);return e.map(e=>q(e.key)===r?n(e):Array.isArray(e.children)?{...e,children:We(e.children,t,n)}:e)},Ge=e=>e.reduce((e,t)=>!Array.isArray(t.children)||!t.children.length?e:e+1+Ge(t.children),0),Ke=r=>{let{isOpen:i,isFolder:a,toggle:o,addChild:c,changeType:l}=T(`useSetup:0:0`,()=>S(()=>{let e=T(`computed:1:0`,()=>m(()=>!!r.model.open)),t=T(`computed:1:1`,()=>m(()=>!!r.model.children&&r.model.children.length>0)),n=t=>{t?.stopPropagation(),r.model.open=!e.get()},i=e=>{e?.stopPropagation(),r.model.children||(r.model.children=[]),r.model.children.push({id:`${r.model.id}-new-${r.model.children.length}`,name:`new stuff`}),r.model.open=!0};return{isOpen:e,isFolder:t,toggle:n,addChild:i,changeType:e=>{e?.stopPropagation(),t.get()||(r.model.children=[],i(),r.model.open=!0)}}}));return v(f=>{let m=e(`li`,f);g(m,`list-none`);let y=e(`button`,m);d(m,y),x(y,`type`,`button`),u(()=>{g(y,String(`flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm transition `+(a.get()?`font-semibold text-base-content`:`text-base-content/80 hover:bg-base-200/70`)))}),n(y,`click`,e=>o(e)),n(y,`dblclick`,e=>l(e));let S=e(`span`,y);d(y,S),g(S,`inline-flex size-5 items-center justify-center rounded-md bg-base-200/80 text-[11px] text-base-content/55`);let T=ee(S);d(S,T),u(()=>{b(T,a.get()?i.get()?`−`:`+`:`•`)});let D=e(`span`,y);d(y,D);let O=p(`rue:slot:anchor`);d(D,O),u(()=>{let e=r.model.name;t(()=>C(e,D,O))});let k=p(`rue:slot:anchor`);return d(m,k),u(()=>{let o=a.get()&&i.get()?v(()=>{let t=s(),i=e(`ul`,t);d(t,i),g(i,`mt-1 grid gap-1 pl-5`);let a=p(`rue:list:start`),o=p(`rue:list:end`);d(i,a),d(i,o);let l=new Map;u(()=>{l=E({items:r.model.children||[],getKey:(e,t)=>e.id,elements:l,parent:i,before:o,start:a,renderItem:(e,t,n,r,i)=>{h(w(Ke,{key:e.id,model:e}),t,n,r)}})});let f=e(`li`,i);d(i,f),g(f,`list-none`);let m=e(`button`,f);return d(f,m),x(m,`type`,`button`),g(m,`btn btn-ghost btn-xs rounded-full text-emerald-600`),n(m,`click`,e=>c(e)),d(m,_(`+ add child`)),t}):``;t(()=>C(o,m,k))}),m})},qe=()=>{let{basicSelectedKeys:n,directorySelectedKeys:r,directoryExpandAction:i,directoryToggleSelect:a,directoryRangeSelect:o,directoryRangeAppendSelectedKeys:f,directoryRangeReplaceSelectedKeys:h,directoryRangeTreeVersion:y,checkableSelectedKeys:b,checkedKeys:x,halfCheckedKeys:ee,disabledCheckedKeys:E,simpleSelectedKeys:j,asyncSelectedKeys:te,asyncExpandedKeys:M,dragTreeData:N,dragSummary:P,virtualSelectedKeys:F,asyncVirtualTreeData:I,asyncVirtualExpandedKeys:ne,asyncVirtualSelectedKeys:re,asyncTreeData:ie,legacyTree:ae,tabs:L,loadAsyncTree:R,loadAsyncVirtualTree:oe,resetDirectoryRangeDemo:z}=T(`useSetup:0:0:dup1`,()=>S(()=>{let e=T(`ref:1:2`,()=>c([`docs-api`])),t=T(`ref:1:3`,()=>c([`dir-app`])),n=T(`ref:1:4`,()=>c(`click`)),r=T(`ref:1:5`,()=>c(!0)),i=T(`computed:1:6`,()=>m(()=>r.value?`append`:!1)),a=T(`ref:1:7`,()=>c([])),o=T(`ref:1:8`,()=>c([])),s=T(`ref:1:9`,()=>c(0)),u=T(`ref:1:10`,()=>c([`release-control`])),d=T(`ref:1:11`,()=>c([`site-home`])),f=T(`ref:1:12`,()=>c([`release-control`,`release-site`])),p=T(`ref:1:13`,()=>c([`editable-assets`])),h=T(`ref:1:14`,()=>c([`workflow`])),g=T(`ref:1:15`,()=>c([])),_=T(`ref:1:16`,()=>c([])),v=T(`ref:1:17`,()=>c(J(Oe))),y=T(`ref:1:18`,()=>c(`folder 支持放入；file 只允许插前和插后，悬停时会显示明确占位态。`)),b=T(`ref:1:19`,()=>c([`virtual-3`])),x=T(`ref:1:20`,()=>c(J(Ae))),S=T(`ref:1:21`,()=>c([])),C=T(`ref:1:22`,()=>c([])),w=T(`ref:1:23`,()=>c([{title:`发布总线`,key:`release-bus`,isLeaf:!1}]));return{basicSelectedKeys:e,directorySelectedKeys:t,directoryExpandAction:n,directoryToggleSelect:r,directoryRangeSelect:i,directoryRangeAppendSelectedKeys:a,directoryRangeReplaceSelectedKeys:o,directoryRangeTreeVersion:s,checkableSelectedKeys:u,checkedKeys:d,halfCheckedKeys:f,disabledCheckedKeys:p,simpleSelectedKeys:h,asyncSelectedKeys:g,asyncExpandedKeys:_,dragTreeData:v,dragSummary:y,virtualSelectedKeys:b,asyncVirtualTreeData:x,asyncVirtualExpandedKeys:S,asyncVirtualSelectedKeys:C,asyncTreeData:w,legacyTree:T(`reactive:1:24`,()=>l({id:`root`,name:`My Tree`,open:!0,children:[{id:`hello`,name:`hello`},{id:`world`,name:`world`},{id:`branch`,name:`child folder`,open:!0,children:[{id:`branch-1`,name:`design review`},{id:`branch-2`,name:`release note`}]}]})),tabs:{basic:T(`ref:1:25`,()=>c(`preview`)),directory:T(`ref:1:26`,()=>c(`preview`)),directoryRange:T(`ref:1:27`,()=>c(`preview`)),checkable:T(`ref:1:28`,()=>c(`preview`)),checkableDisabled:T(`ref:1:29`,()=>c(`preview`)),simple:T(`ref:1:30`,()=>c(`preview`)),async:T(`ref:1:31`,()=>c(`preview`)),drag:T(`ref:1:32`,()=>c(`preview`)),virtual:T(`ref:1:33`,()=>c(`preview`)),virtualAsync:T(`ref:1:34`,()=>c(`preview`)),legacy:T(`ref:1:35`,()=>c(`preview`))},loadAsyncTree:async e=>{e.key===`release-bus`&&(w.value=[{title:`发布总线`,key:`release-bus`,isLeaf:!1,children:[{title:`桌面端`,key:`desktop`,children:[{title:`Windows`,key:`desktop-win`},{title:`macOS`,key:`desktop-mac`}]},{title:`移动端`,key:`mobile`,children:[{title:`iOS`,key:`mobile-ios`},{title:`Android`,key:`mobile-android`}]}]}])},loadAsyncVirtualTree:async e=>{e.children.length||(x.value=We(x.value,e.key,e=>({...e,children:Array.from({length:8},(t,n)=>({title:`${String(e.title)} / Module ${n+1}`,key:`${String(e.key)}-child-${n}`,isLeaf:n%3!=0}))})))},resetDirectoryRangeDemo:()=>{a.value=[],o.value=[],s.value+=1}}}));return v(c=>{let l=s(),m=p(`rue:component:anchor`);return d(l,m),C(w(k,{children:v(()=>{let c=s(),l=e(`div`,c);d(c,l),g(l,`max-w-none prose prose-sm md:prose-base`);let m=e(`h1`,l);d(l,m),d(m,_(`Tree 树控件`));let v=e(`p`,l);d(l,v),d(v,_(`Rue 的 Tree 补上了独立树组件这块空白：保留 TreeView 示例里递归数据直改的灵活性，同时把 树控件常用的展开、选中、勾选、简单模式、异步加载和自定义标题一次补齐。 视觉上继续沿用 Rue 现有的卡片、badge 和 base 色阶体系，不照搬其他组件库的外观。`));let S=e(`div`,l);d(l,S),g(S,`not-prose mt-6 grid gap-3 md:grid-cols-3`);let T=e(`div`,S);d(S,T),g(T,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let k=e(`div`,T);d(T,k),g(k,`text-xs uppercase tracking-[0.2em] text-base-content/45`),d(k,_(`Node Model`));let B=e(`div`,T);d(T,B),g(B,`mt-2 text-base font-semibold`),d(B,_(`选择、勾选、展开三条状态线`));let se=e(`p`,T);d(T,se),g(se,`mt-2 mb-0 text-sm text-base-content/68`),d(se,_(`目录树、权限树、发布树都能直接套进来。`));let V=e(`div`,S);d(S,V),g(V,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let ce=e(`div`,V);d(V,ce),g(ce,`text-xs uppercase tracking-[0.2em] text-base-content/45`),d(ce,_(`DirectoryTree`));let le=e(`div`,V);d(V,le),g(le,`mt-2 text-base font-semibold`),d(le,_(`目录树快捷 API`));let ue=e(`p`,V);d(V,ue),g(ue,`mt-2 mb-0 text-sm text-base-content/68`),d(ue,_(`支持 click / doubleClick 展开，以及更接近文件浏览器的多选交互。`));let H=e(`div`,S);d(S,H),g(H,`rounded-[1.4rem] border border-base-300 bg-gradient-to-br from-base-100 to-base-200/40 p-4 shadow-sm`);let de=e(`div`,H);d(H,de),g(de,`text-xs uppercase tracking-[0.2em] text-base-content/45`),d(de,_(`Heavy Interaction`));let fe=e(`div`,H);d(H,fe),g(fe,`mt-2 text-base font-semibold`),d(fe,_(`拖拽排序与虚拟滚动`));let pe=e(`p`,H);d(H,pe),g(pe,`mt-2 mb-0 text-sm text-base-content/68`),d(pe,_(`长列表和拖拽改序终于能落在同一个 Tree 上了。`));let me=p(`rue:component:anchor`);d(l,me),u(()=>{let e=w(A,{title:`基础选中与整行交互`,summary:`默认 Tree 就是一个纯浏览 + 选中容器；blockNode 和 showIcon 让它更像配置面板里的主导航。`,tab:L.basic,code:je,preview:D(`div`,{className:`space-y-4 not-prose`,children:[O(G,{treeData:Se,selectedKeys:n.value,defaultExpandAll:!0,showIcon:!0,blockNode:!0,onSelect:e=>{n.value=e}}),D(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:n.value.length?n.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`未选择`})})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`推荐场景`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`组件目录、文档导航、资源分类`})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`状态模型`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:`selectedKeys / expandedKeys 分离，便于受控更新。`})]})]})]})});t(()=>C(e,l,me))});let he=p(`rue:component:anchor`);d(l,he),u(()=>{let e=w(A,{title:`DirectoryTree 目录树快捷 API`,summary:`Tree.DirectoryTree 默认补上目录图标、整行可点和 click 展开；这里先只看 expandAction 和 toggleSelect 这两个基础交互开关。`,tab:L.directory,code:Ie,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G.DirectoryTree,{treeData:Ee,selectedKeys:r.value,multiple:!0,expandAction:i.value,toggleSelect:a.value,rangeSelect:o.get(),onSelect:e=>{r.value=e}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`快捷属性`}),D(`div`,{className:`mt-3 flex flex-wrap gap-2`,children:[O(`button`,{type:`button`,className:i.value===`click`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{i.value=`click`},children:`click 展开`}),O(`button`,{type:`button`,className:i.value===`doubleClick`?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{i.value=`doubleClick`},children:`doubleClick 展开`}),O(`button`,{type:`button`,className:i.value===!1?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{i.value=!1},children:`只选中不展开`})]}),D(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:[O(`button`,{type:`button`,className:a.value?`btn btn-primary btn-xs`:`btn btn-ghost btn-xs`,onClick:()=>{a.value=!0},children:`ctrl/meta 追加`}),O(`button`,{type:`button`,className:a.value?`btn btn-ghost btn-xs`:`btn btn-primary btn-xs`,onClick:()=>{a.value=!1},children:`关闭追加选择`})]})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:r.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e)))})]}),D(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前组合是 expandAction=`,O(`strong`,{children:String(i.value)}),`、toggleSelect=`,O(`strong`,{children:String(a.value)}),`、rangeSelect=`,O(`strong`,{children:String(o.get())}),`。`,O(`div`,{className:`mt-3`,children:`普通点击会落成单选；打开追加后，meta / ctrl 会追加或移除选中，shift 也会启用区间选择。关闭追加时，这两类补充选择都会停用；append / replace 的差异放到下面的对照示例里单独演示。`})]})]})]})});t(()=>C(e,l,he))});let ge=p(`rue:component:anchor`);d(l,ge),u(()=>{let e=w(A,{title:`shift append vs shift replace`,summary:`这两个模式只有在“先做一次非连续多选，再用 shift 选区间”时才会分出差异；左边保留旧选择，右边只保留新区间。`,tab:L.directoryRange,code:Le,preview:D(`div`,{className:`space-y-4 not-prose`,children:[D(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[O(`div`,{children:`操作顺序：先单击 beta.ts，再按住 Cmd / Ctrl 单击 epsilon.ts，最后按住 Shift 单击 delta.ts。`}),O(`div`,{className:`mt-2`,children:`append 会保留 beta.ts；replace 只保留 delta.ts 到 epsilon.ts 这一段。`}),O(`button`,{type:`button`,className:`btn btn-ghost btn-xs mt-3`,onClick:z,children:`重置两边示例`})]}),D(`div`,{className:`grid gap-4 xl:grid-cols-2`,children:[D(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[D(`div`,{className:`flex items-center justify-between gap-3`,children:[D(`div`,{children:[O(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="append"`}),O(`div`,{className:`text-xs text-base-content/55`,children:`保留原先的非连续选择，再并入新的 shift 区间。`})]}),O(`span`,{className:`badge badge-outline badge-sm`,children:`append`})]}),O(G.DirectoryTree,{treeData:De,selectedKeys:f.value,multiple:!0,toggleSelect:!0,rangeSelect:`append`,onSelect:e=>{f.value=e}},`append-${y.value}`),D(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:f.value.length?f.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]}),D(`div`,{className:`space-y-3 rounded-[1.4rem] border border-base-300 bg-base-100 p-4 shadow-sm`,children:[D(`div`,{className:`flex items-center justify-between gap-3`,children:[D(`div`,{children:[O(`div`,{className:`text-sm font-semibold`,children:`rangeSelect="replace"`}),O(`div`,{className:`text-xs text-base-content/55`,children:`只保留新的 shift 区间，旧的非连续选择会被替换掉。`})]}),O(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:`replace`})]}),O(G.DirectoryTree,{treeData:De,selectedKeys:h.value,multiple:!0,toggleSelect:!0,rangeSelect:`replace`,onSelect:e=>{h.value=e}},`replace-${y.value}`),D(`div`,{className:`rounded-box border border-base-300 bg-base-100 px-4 py-3 text-sm text-base-content/70`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前选择`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:h.value.length?h.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`还没有选择`})})]})]})]})]})});t(()=>C(e,l,ge))});let _e=p(`rue:component:anchor`);d(l,_e),u(()=>{let e=w(A,{title:`父子联动与半选态`,summary:`这一块只看级联勾选和 halfChecked，不再混入 disabled / disableCheckbox，点击父节点时能直接看到整棵子树联动。`,tab:L.checkable,code:Me,preview:D(`div`,{className:`space-y-4 not-prose`,children:[O(G,{treeData:Ce,selectedKeys:b.value,checkedKeys:x.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onSelect:e=>{b.value=e},onCheck:(e,t)=>{x.value=He(e),ee.value=Ue(e,t)}}),D(`div`,{className:`grid gap-3 md:grid-cols-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:b.value.length?b.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`当前没有选中节点`})})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`checkedKeys`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:x.value.map(e=>O(`span`,{className:`badge badge-primary badge-outline badge-sm`,children:String(e)},String(e)))})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`halfCheckedKeys`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:ee.value.length?ee.value.map(e=>O(`span`,{className:`badge badge-ghost badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`当前没有半选`})})]})]})]})});t(()=>C(e,l,_e))});let ve=p(`rue:component:anchor`);d(l,ve),u(()=>{let e=w(A,{title:`禁用节点与禁用复选框`,summary:`把 disabled 和 disableCheckbox 单独拆出来看：前者整节点只读，后者只禁用勾选框，不再干扰联动示例。`,tab:L.checkableDisabled,code:Ne,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G,{treeData:we,checkedKeys:E.value,checkable:!0,defaultExpandAll:!0,showLine:!0,blockNode:!0,onCheck:e=>{E.value=He(e)}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前勾选`}),O(`div`,{className:`mt-2 flex flex-wrap gap-2`,children:E.value.length?E.value.map(e=>O(`span`,{className:`badge badge-outline badge-sm`,children:String(e)},String(e))):O(`span`,{className:`text-sm text-base-content/55`,children:`当前没有勾选`})})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[O(`div`,{className:`font-medium text-base-content`,children:`disabled`}),O(`div`,{className:`mt-2`,children:`整节点不可展开、不可选中、不可勾选，适合只读目录或冻结配置。`})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm text-sm text-base-content/75`,children:[O(`div`,{className:`font-medium text-base-content`,children:`disableCheckbox`}),O(`div`,{className:`mt-2`,children:`节点仍能展示和展开，但复选框不会参与交互，适合“只可浏览不可授权”的条目。`})]})]})]})});t(()=>C(e,l,ve))});let ye=p(`rue:component:anchor`);d(l,ye),u(()=>{let e=w(A,{title:`Simple Mode + Search`,summary:`扁平数据直入后，内置搜索会保留命中节点的祖先链，不会把层级上下文切断。`,tab:L.simple,code:Pe,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G,{treeData:Te,treeDataSimpleMode:{id:`nodeId`,pId:`parentId`,rootPId:0},fieldNames:{title:`name`,key:`code`},selectedKeys:j.value,allowSearch:!0,defaultExpandAll:!0,onSelect:e=>{j.value=e}}),D(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:[`当前选中：`,O(`code`,{children:JSON.stringify(j.value)}),O(`div`,{className:`mt-3`,children:`这类 simple mode 很适合后端直接给 id / pId 的菜单、流程节点和权限项，不需要再先做一遍树转换。`})]})]})});t(()=>C(e,l,ye))});let be=p(`rue:component:anchor`);d(l,be),u(()=>{let e=w(A,{title:`Async Load 与自定义标题`,summary:`第一次展开时再拉子节点，同时用 titleRender 和 icon 把状态信息塞回每一行。`,tab:L.async,code:Fe,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,26rem),1fr] lg:items-start`,children:[O(G,{treeData:ie.value,selectedKeys:te.value,expandedKeys:M.value,loadData:R,showLine:!0,showIcon:!0,blockNode:!0,titleRender:({node:e,loading:t})=>D(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[O(`span`,{className:`truncate`,children:e.title}),O(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`branch`:`leaf`})]}),onSelect:e=>{te.value=e},onExpand:e=>{M.value=e}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`expandedKeys`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(M.value)})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`selectedKeys`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(te.value)})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`展开 release-bus 后才会注入桌面端和移动端节点，适合远端目录、超大权限树和发布范围配置。`})]})]})});t(()=>C(e,l,be))});let U=e(`div`,l);d(l,U),g(U,`not-prose mt-10 space-y-2`);let W=e(`h2`,U);d(U,W),g(W,`text-2xl font-semibold`),d(W,_(`更重交互`));let Oe=e(`p`,U);d(U,Oe),g(Oe,`text-sm text-base-content/70`),d(Oe,_(`当 Tree 既要承载拖拽整理，又要承载超长数据时，draggable 和 virtual 就是两个最关键的控制面。`));let Ae=p(`rue:component:anchor`);d(l,Ae),u(()=>{let e=w(A,{title:`allowDrop 策略与拖拽占位`,summary:`allowDrop 可以把 folder / file 的落点规则写清楚；hover 时 Tree 会直接给出插前、插后或放入占位提示。`,tab:L.drag,code:Re,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G,{treeData:N.value,draggable:!0,blockNode:!0,defaultExpandAll:!0,allowDrop:({dropNode:e,dropToGap:t})=>t||e.raw.kind!==`file`,titleRender:({node:e})=>D(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[O(`span`,{className:`truncate`,children:e.title}),O(`span`,{className:e.raw.kind===`folder`?`badge badge-ghost badge-xs`:`badge badge-outline badge-xs`,children:e.raw.kind})]}),onDrop:e=>{N.value=Z(N.value,e),P.value=`${String(e.dragNode.key)} -> ${String(e.node.key)} (${e.dropToGap?e.dropPosition<0?`before`:`after`:`inside`})`}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`最近一次拖拽`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:P.value})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`allowDrop 规则`}),D(`div`,{className:`mt-2 grid gap-2 text-sm text-base-content/75`,children:[O(`div`,{children:`folder：允许放入，也允许插前 / 插后。`}),O(`div`,{children:`file：只允许插前 / 插后，不允许作为 inside 目标。`})]})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`拖到 folder 正中央会看到“放入”，拖到行的上沿或下沿则会出现“插前 / 插后”；如果目标是 file，inside 落点会被 allowDrop 直接拦掉。`})]})]})});t(()=>C(e,l,Ae))});let q=p(`rue:component:anchor`);d(l,q),u(()=>{let e=w(A,{title:`Virtual Scroll`,summary:`长列表下只渲染可见窗口，height 和 itemHeight 负责限定视口和估算切片范围。`,tab:L.virtual,code:K,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G,{treeData:ke,selectedKeys:F.value,height:320,itemHeight:42,virtual:!0,blockNode:!0,onSelect:e=>{F.value=e}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`数据量`}),O(`div`,{className:`mt-2 text-2xl font-semibold`,children:ke.length})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前选中`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(F.value)})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`对文档页目录、埋点树、批量资源目录这种长列表场景，虚拟滚动能显著降低初始渲染压力。`})]})]})});t(()=>C(e,l,q))});let J=p(`rue:component:anchor`);d(l,J),u(()=>{let e=w(A,{title:`Virtual + Async Load 场景页`,summary:`把 virtual、height、itemHeight 和 loadData 合在一起，就能接超长目录或资源树，只在展开分支时再注入子节点。`,tab:L.virtualAsync,code:ze,preview:D(`div`,{className:`grid gap-4 not-prose lg:grid-cols-[minmax(0,24rem),1fr] lg:items-start`,children:[O(G,{treeData:I.value,selectedKeys:re.value,expandedKeys:ne.value,height:340,itemHeight:40,virtual:!0,showIcon:!0,blockNode:!0,loadData:oe,titleRender:({node:e,loading:t})=>D(`div`,{className:`flex min-w-0 items-center justify-between gap-3`,children:[O(`span`,{className:`truncate`,children:e.title}),O(`span`,{className:`badge badge-ghost badge-xs`,children:t?`loading`:e.children.length?`loaded`:e.isLeaf?`leaf`:`lazy`})]}),onSelect:e=>{re.value=e},onExpand:e=>{ne.value=e}}),D(`div`,{className:`space-y-3`,children:[D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`根节点数量`}),O(`div`,{className:`mt-2 text-2xl font-semibold`,children:I.value.length})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`已加载分支`}),O(`div`,{className:`mt-2 text-2xl font-semibold`,children:Ge(I.value)})]}),D(`div`,{className:`rounded-2xl border border-base-300 bg-base-100 px-4 py-3 shadow-sm`,children:[O(`div`,{className:`text-xs text-base-content/45`,children:`当前展开`}),O(`div`,{className:`mt-2 text-sm text-base-content/75`,children:JSON.stringify(ne.value)})]}),O(`div`,{className:`rounded-box border border-dashed border-base-300 bg-base-100/80 p-4 text-sm text-base-content/70`,children:`先滚动到较深位置再展开节点也没问题：视口外的行不会真正渲染，只有命中的 branch 才会触发 loadData 注入子节点。`})]})]})});t(()=>C(e,l,J))});let Y=p(`rue:component:anchor`);d(l,Y),u(()=>{let e=w(A,{title:`保留原始递归 Demo`,summary:`旧的 TreeView 行为没有删掉，只是并进 design 页面里，方便对比“直接改数据”这类递归写法。`,tab:L.legacy,code:Be,preview:O(`div`,{className:`card border border-base-200/80 bg-base-100 shadow-sm not-prose`,children:D(`div`,{className:`card-body grid gap-4 lg:grid-cols-[minmax(0,1fr),18rem] lg:items-start`,children:[O(`ul`,{className:`m-0 grid gap-1 p-0`,children:O(Ke,{model:ae})}),O(`div`,{className:`rounded-box border border-base-300 bg-base-200/40 p-4 text-sm text-base-content/70`,children:`单击切换展开，双击叶子节点会把它转换成 folder，并在当前层直接追加一个新子节点。`})]})})});t(()=>C(e,l,Y))});let X=e(`div`,l);d(l,X),g(X,`not-prose mt-10 space-y-4`);let We=e(`h2`,X);d(X,We),g(We,`text-2xl font-semibold`),d(We,_(`API`));let qe=p(`rue:component:anchor`);return d(X,qe),u(()=>{let e=w(xe,{rows:Ve});t(()=>C(e,X,qe))}),c})}),l,m),l})};export{qe as default};