...
]`})));return u(r=>{let p=n(),g=o(`rue:component:anchor`);return a(p,g),m(h(S,{children:u(()=>{let r=n(),p=e(`div`,r);a(r,p),c(p,`max-w-none prose prose-sm md:prose-base`);let g=e(`h1`,p);a(p,g),a(g,l(`Accordion 手风琴`));let S=e(`p`,p);a(p,S),c(S,`text-sm mt-3 mb-3`),a(S,l(`Accordion 现在保留 Rue 原本的轻量视觉风格，但 API 不再只是静态包装。你可以继续用`));let N=e(`code`,S);a(S,N),a(N,l(`Accordion.Title`)),a(S,l(`和`));let P=e(`code`,S);a(S,P),a(P,l(`Accordion.Content`)),a(S,l(`组合单个面板，也可以直接用`));let F=e(`code`,S);a(S,F),a(F,l(`items`)),a(S,l(`走数据驱动，接入受控 key、多开、禁用和富标题信息。`));let I=e(`h2`,p);a(p,I),a(I,l(`何时使用`));let L=e(`ul`,p);a(p,L);let K=e(`li`,L);a(L,K),a(K,l(`需要 FAQ、设置说明、任务面板这类“标题 + 可折叠内容”的信息组织方式。`));let q=e(`li`,L);a(L,q),a(q,l(`需要在单开和多开之间切换，或把当前展开项接到页面状态里。`));let J=e(`li`,L);a(L,J),a(J,l(`需要在标题里补充状态、说明、标签，而不想为每个面板手写结构。`));let Y=e(`li`,L);a(L,Y),a(Y,l(`需要让浏览器能搜索折叠内容时，使用`));let X=e(`code`,Y);a(Y,X),a(X,l(`use="details"`)),a(Y,l(`。`));let Z=e(`div`,p);a(p,Z),c(Z,`not-prose my-6 grid gap-3 md:grid-cols-2 xl:grid-cols-4`);let ee=o(`rue:list:start`),te=o(`rue:list:end`);a(Z,ee),a(Z,te);let ne=new Map;i(()=>{ne=_({items:H||[],getKey:(e,t)=>e.title,elements:ne,parent:Z,before:te,singleRoot:!0,trackIndex:!1,start:ee,renderItem:(r,s,d,p,h)=>{m(u(()=>{let s=n(),u=e(`div`,s);a(s,u),i(()=>{f(u,`key`,String(r.title))}),c(u,`card border border-base-300 bg-base-100 shadow-sm`);let d=e(`div`,u);a(u,d),c(d,`card-body gap-2 p-4`);let p=e(`div`,d);a(d,p),c(p,`text-xs uppercase tracking-[0.2em] text-base-content/50`),a(p,l(`Capability`));let h=e(`div`,d);a(d,h),c(h,`text-sm font-semibold`);let g=o(`rue:slot:anchor`);a(h,g),i(()=>{let e=r.title;t(()=>m(e,h,g))});let _=e(`p`,d);a(d,_),c(_,`m-0 text-sm opacity-70`);let v=o(`rue:slot:anchor`);return a(_,v),i(()=>{let e=r.desc;t(()=>m(e,_,v))}),s}),s,d)}})});let re=o(`rue:component:anchor`);a(p,re),i(()=>{let e=h(z,{title:`Accordion using radio inputs`,summary:`保留单开分组，同时额外开启 collapsible，方便在文档页里反复点按查看开合状态。`,tab:s,preview:()=>G(`accordion-radio-demo`,{collapsible:!0}),code:`<Accordion className="bg-base-100 border border-base-300" name="accordion-radio-demo" defaultOpen collapsible>
...
</Accordion>`});t(()=>m(e,p,re))});let ie=o(`rue:component:anchor`);a(p,ie),i(()=>{let e=h(z,{title:`Accordion using details`,summary:`保留 details 结构，适合需要原生语义和浏览器搜索能力的内容区。`,tab:d,preview:()=>G(`accordion-details-demo`,{use:`details`}),code:`<Accordion use="details" className="bg-base-100 border border-base-300" name="accordion-details-demo" defaultOpen>
...
</Accordion>`});t(()=>m(e,p,ce))});let le=o(`rue:component:anchor`);a(p,le),i(()=>{let e=h(z,{title:`Accordion with plus/minus icon`,summary:`保留 plus/minus 方案，并开启 collapsible，方便直接验证开合反馈。`,tab:T,preview:()=>G(`accordion-plus-demo`,{icon:`plus`,collapsible:!0}),code:`<Accordion icon="plus" className="bg-base-100 border border-base-300" name="accordion-plus-demo" defaultOpen collapsible>
  <Accordion.Title className="font-semibold">How do I create an account?</Accordion.Title>
  <Accordion.Content className="text-sm opacity-80">
    Click the "Sign Up" button in the top right corner and follow the registration process.
  </Accordion.Content>
...
</div>`});t(()=>m(e,p,ue))});let de=o(`rue:component:anchor`);a(p,de),i(()=>{let e=h(z,{title:`Accordion using items array (radio)`,summary:`保留 items 数组写法，并开启 collapsible，方便直接验证数据驱动下的收起逻辑。`,tab:D,preview:()=>y(R,{collapsible:!0,className:`bg-base-100 border border-base-300`,name:`accordion-array-radio-demo`,items:V.map((e,t)=>({key:e.key,title:e.title,content:e.content,open:t===0}))}),code:`${M}
...
<Accordion
  ...
  items={items}
/>`});t(()=>m(e,p,fe))});let Q=e(`h2`,p);a(p,Q),f(Q,`id`,`accordion-api`),a(Q,l(`API`));let pe=e(`p`,p);a(p,pe),a(pe,l(`Accordion 现在分成两套用法：children 模式适合局部排版，items 模式适合数据驱动和受控状态。 两套模式共用同一套视觉类名，因此迁移旧示例时通常只需要把结构收敛到更清晰的语义层。`));let me=e(`h3`,p);a(p,me),a(me,l(`Accordion Props`));let he=o(`rue:component:anchor`);a(p,he),i(()=>{let e=h(B,{rows:U});t(()=>m(e,p,he))});let $=e(`h3`,p);a(p,$),c($,`mt-6`),a($,l(`AccordionDataItem`));let ge=o(`rue:component:anchor`);return a(p,ge),i(()=>{let e=h(B,{rows:W});t(()=>m(e,p,ge))}),r})}),p,g),p})};export{K as default};